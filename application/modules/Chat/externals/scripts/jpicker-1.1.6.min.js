(function(e, a) {
    ...
    e.fn.jPicker.defaults = {
        ...
        images: {
            clientPath: "application/modules/Chat/externals/images/",
            colorMap: {
                width: 256,
                height: 256,
                arrow: {
        ...
        localization: {
            text: {
                title: en4.core.language.translate("Drag Markers To Pick A Color"),
                newColor: en4.core.language.translate("new"),
                currentColor: en4.core.language.translate("current"),
                ok: en4.core.language.translate("OK"),
