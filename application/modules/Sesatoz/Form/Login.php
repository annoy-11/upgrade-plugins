...
class Sesatoz_Form_Login extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    $this->setAttrib('id', 'sesatoz_form_login');
   ...
   //SES Work For Show and Hide Password
    $this->addElement('dummy', 'showhidepassword', array(
      'decorators' => array(array('ViewScript', array(
        'viewScript' => 'application/modules/Sesatoz/views/scripts/showhidepassword.tpl',
      ))),
			'tabindex' => $tabindex++,			
    ));
		//SES Work For Show and Hide Password
