...
class Sesatoz_Form_Admin_Global extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', "sesatoz_licensekey", array(
        'label' => 'Enter License key',
        'description' => $descriptionLicense,
        'allowEmpty' => false,
        'required' => true,
        'value' => $settings->getSetting('sesatoz.licensekey'),
    ));
    $this->getElement('sesatoz_licensekey')->getDecorator('Description')->setOptions(array('placement' => 'PREPEND', 'escape' => false));
