 ...
 * @version    $Id: Browse.php  2019-03-14 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sespagenote_Form_Admin_Browse extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('MultiCheckbox', "show_criteria", array(
        'label' => "Choose from below the details that you want to show for page notes in this widget.",
        'multiOptions' => array(
            'title' => 'Note Title',
            'by' => 'Owner Name',
