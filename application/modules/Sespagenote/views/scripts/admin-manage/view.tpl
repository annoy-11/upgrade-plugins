 ...
 * @version    $Id: view.tpl  2019-03-14 00:00:00 SocialEngineSolutions $
  ...
  <table>
    ...
    <td><?php if(!is_null($this->item->getTitle()) && $this->item->getTitle() != '') {
  	...
  	<tr>
    	...
    	<td>
    		<?php
        	$event = Engine_Api::_()->getItem('sespage_page',$this->item->parent_id); ?>
   ...
   <?php if(isset($this->item->ip_address)){ ?>
    ...
    <?php } ?>
    <?php if(isset($this->item->location) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo_enable_location', 1)){ ?>
    <tr>
