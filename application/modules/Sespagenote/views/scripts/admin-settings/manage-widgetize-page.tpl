 ...
 * @version    $Id: manage-widgetize-page.tpl  2019-03-14 00:00:00 SocialEngineSolutions $
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <?php if($corePages->name != 'sespagenote_index_view' && $corePages->name != 'sespagenote_index_edit' && $corePages->name != 'sespagenote_index_create'):?>
                |
