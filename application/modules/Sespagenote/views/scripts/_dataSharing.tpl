 ...
 * @version    $Id: _dataSharing.tpl  2019-03-14 00:00:00 SocialEngineSolutions $
...
<?php } ?>
<?php $allowShare = Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagenote.allow.share', '1'); ?>
<?php  if(isset($this->socialSharingActive) || isset($this->likeButtonActive) || $this->favouriteButtonActive){  ?>
  <span class="sespagenote_social_share">
    ...
    <?php } ?>
    <?php if($viewerId) { ?>
      <?php $canComment = Engine_Api::_()->authorization()->isAllowed('pagenote', $viewer, 'comment');?>
      <?php if(isset($this->likeButtonActive) && $canComment && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagenote.enable.like', 1)):?>
      ...
      <?php endif;?>
      <?php if(isset($this->favouriteButtonActive) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagenote.enable.favourite', 1)):?>
        ...
        <a href="javascript:;" data-contenttype="<?php echo $item->getType(); ?>" data-type="favourite_view" data-url="<?php echo $item->getIdentity() ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn sespagenote_favourite_<?php echo $item->getIdentity() ?> sespage_likefavfollow <?php echo ($favouriteStatus) ? 'button_active' : '' ; ?>"><i class="fa fa-heart"></i><span><?php echo $item->favourite_count;?></span></a>
      <?php endif;?>
    <?php } ?>
  </span>
<?php } ?>
