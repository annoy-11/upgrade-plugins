 ...
 * @version    $Id: _dataStatics.tpl  2019-03-14 00:00:00 SocialEngineSolutions $
...
<div class="sespagenote_profile_footer">
  <p class="sespagenote_profile_labels">
    <span>
      <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagenote.enable.like', '1') && isset($this->likecountActive) && isset($item->like_count)) { ?>
      ...
      <?php } ?>
      <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagenote.enable.favourite', '1') && isset($this->favouritecountActive)) { ?>
