...
class Sespagenote_Widget_ProfileTagsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->sespagenote()->tagCloudItemCore('', $subject_id);
