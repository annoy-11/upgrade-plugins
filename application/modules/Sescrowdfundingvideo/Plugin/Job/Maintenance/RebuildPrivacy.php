 ...
 * @version    $Id: RebuildPrivacy.php 2018-07-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescrowdfundingvideo_Plugin_Job_Maintenance_RebuildPrivacy extends Core_Plugin_Job_Abstract {

  protected function _execute() {
    // Start custom prepare
    $table = Engine_Api::_()->getItemTable('crowdfundingvideo');
