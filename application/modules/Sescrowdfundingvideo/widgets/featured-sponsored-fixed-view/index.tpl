...
?>
<style>
#sescrowdfundingvideo_heighted_view_<?php echo $randonNumber; ?> .sescrowdfundingvideo_listing_in_grid{
	height:<?php echo str_replace(array('px','%'),'',$this->height).'px'; ?>;
}
#sescrowdfundingvideo_heighted_view_<?php echo $randonNumber; ?> .sescrowdfundingvideo_listing_in_grid:first-child{
	height:<?php echo str_replace(array('px','%'),'',$this->heightmain).'px'; ?>;
}
</style>
<div class="sescrowdfundingvideo_heighted_view sesbasic_clearfix sesbasic_bxs" id="sescrowdfundingvideo_heighted_view_<?php echo $randonNumber; ?>">
  <?php 
  if($this->categoryItem == 'chanels'){
    ...
    $photoURL = $item->getPhotoUrl('thumb.main'); ?>
      <div class="sescrowdfundingvideo_listing_in_grid">
        <div class="sescrowdfundingvideo_listing_in_grid_thumb sescrowdfundingvideo_thumb sescrowdfundingvideo_play_btn_wrap">
        <?php 
        ...
        <a class="<?php echo $item->getType() == 'crowdfundingvideo' ? 'sescrowdfundingvideo_thumb_img' : 'sescrowdfundingvideo_thumb_nolightbox' ?>" href="<?php echo $item->getHref(); ?>"> 
          ...
          <a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sesbasic_animation sescrowdfundingvideo_play_btn fa fa-play-circle sescrowdfundingvideo_thumb_img">
          ...
          <?php if(isset($this->featured) || isset($this->sponsored) || isset($this->hot)){ ?>
            <p class="sescrowdfundingvideo_labels sesbasic_animation">
           ...
           <?php if(isset($this->watchlater) && (isset($item->watchlater_id)) && Engine_Api::_()->user()->getViewer()->getIdentity() != '0'){ ?>
              ...
              <a href="javascript:;" class="sescrowdfundingvideo_watch_later_btn sesbasic_animation sescrowdfundingvideo_watch_later <?php echo !is_null($watchLaterId)  ? 'selectedWatchlater' : '' ?>" title = "<?php echo !is_null($watchLaterId)  ? $this->translate('Remove from Watch Later') : $this->translate('Add to Watch Later') ?>" data-url="<?php echo $item->crowdfundingvideo_id ; ?>"></a>
          <?php } ?>
          <?php 
          ...
          <?php } ?>
            ...
            <?php if(isset($this->like) || isset($this->comment) || isset($this->view) || isset($this->title) || isset($this->rating) || isset($this->favouriteCount) || isset($this->downloadCount)  || isset($this->by) || isset($this->videoCount)){ ?>
              <div class="sescrowdfundingvideo_listing_in_grid_info clear sesbasic_animation">
                <?php if(isset($this->title)) { ?>
                  <div class="sescrowdfundingvideo_listing_in_grid_title">
                ...
                <?php if(isset($this->by)) { ?>
                  <div class="sescrowdfundingvideo_listing_in_grid_date sescrowdfundingvideo_list_stats sesbasic_text_light floatL">
                    <span>
                ...
                <div class="sescrowdfundingvideo_listing_in_grid_date sescrowdfundingvideo_list_stats sesbasic_text_light clear floatL">
