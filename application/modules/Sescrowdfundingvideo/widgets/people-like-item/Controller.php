 ...
 */
class Sescrowdfundingvideo_Widget_peopleLikeItemController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->sescrowdfundingvideo()->likeItemCore($param);
