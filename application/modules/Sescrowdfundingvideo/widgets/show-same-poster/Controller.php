...
class Sescrowdfundingvideo_Widget_ShowSamePosterController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('videos', 'sescrowdfundingvideo')->getVideo(array('not_crowdfundingvideo_id'=>$subject->getIdentity(),'user_id'=>$subject->owner_id));
