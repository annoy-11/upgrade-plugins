 ...
 */
class Sescrowdfundingvideo_Widget_PopularityVideosController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('videos', 'sescrowdfundingvideo')->getVideo(array('status' => 1, 'watchLater' => true, 'popularCol' => $popularity, 'criteria' => $criteria));
