...
?>
<?php if($this->title == ''){ ?>
<h3><?php echo $this->translate('People Favourite This %s',ucfirst(str_replace('sescrowdfundingvideo_','',$this->subject->getType()))); ?></h3>
<?php } ?>
...
function getFavData(value,title){
	if(value){
		url = en4.core.staticBaseUrl+'sescrowdfundingvideo/index/favourite-item/item_id/'+value+'/title/'+title+'/item_type/<?php echo $this->subject()->getType(); ?>';
