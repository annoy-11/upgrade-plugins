 ...
 */
class Sescrowdfundingvideo_Widget_TabbedWidgetVideoController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $show_criterias = isset($params['show_criterias']) ? $params['show_criterias'] : $this->_getParam('show_criteria', array('like', 'comment', 'rating', 'by', 'title', 'featuredLabel', 'sponsoredLabel', 'watchLater', 'category', 'description_list','description_grid','description_pinboard', 'duration', 'hotLabel', 'favouriteButton', 'likeButton', 'socialSharing', 'view'));
    ...
    $paginator = Engine_Api::_()->getDbTable('videos', 'sescrowdfundingvideo')->getVideo($value);
    ...
    if ($is_ajax)
      ...
      if ($paginator->getTotalItemCount() <= 0) {
        $checkVideoCount = Engine_Api::_()->getDbTable('videos', 'sescrowdfundingvideo')->countVideos();
