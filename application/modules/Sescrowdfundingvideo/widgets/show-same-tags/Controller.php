...
class Sescrowdfundingvideo_Widget_ShowSameTagsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$this->getElement()->getTitle()) {
      $this->getElement()->setTitle('Similar '.ucwords(str_replace('sescrowdfundingvideo_','',$subject->getType())));
    }
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('videos', 'sescrowdfundingvideo')->getVideo(array('sameTagresource_id'=>$subject->getIdentity(),'sameTagTag_id'=>$tags,'sameTag'=>'sameTag'));
