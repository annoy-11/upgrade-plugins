 ...
 */
class Sescrowdfundingvideo_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    $this->view->type = $type = $this->_getParam('ofTheDayType', 'crowdfundingvideo');
    ...
    $paginator = Engine_Api::_()->getDbTable('videos', 'sescrowdfundingvideo')->getVideo(array('widgetName' => 'oftheday'));
