 ...
 */
class Sescrowdfundingvideo_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = Engine_Api::_()->getDbTable('videos', 'sescrowdfundingvideo')->getVideo($value);
