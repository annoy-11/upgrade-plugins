...
<?php $this->headScript()->appendFile($baseUrl . 'application/modules/Sesbasic/externals/scripts/PeriodicalExecuter.js')
      ...
      $this->headLink()->appendStylesheet($baseUrl . 'application/modules/Sescrowdfundingvideo/externals/styles/carousel.css'); 
      $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescrowdfundingvideo/externals/styles/styles.css');
 ?>
<style type="text/css">
.sescrowdfundingvideo_carousel_wrapper_<?php echo $randonNumber; ?>.sescrowdfundingvideo_carousel_h_wrapper{
	background-color:<?php echo '#'.str_replace('#','',$this->bgColor) ?>;
	padding:<?php echo str_replace(array('px','%'),array(''),$this->spacing).'px'; ?> 0;
}
.sescrowdfundingvideo_carousel_wrapper_<?php echo $randonNumber; ?>.sescrowdfundingvideo_carousel_h_wrapper .sescrowdfundingvideo_grid_info *{
	color:<?php echo '#'.str_replace('#','',$this->textColor) ; ?>
}
#sescrowdfundingvideo_slider_<?php echo $randonNumber; ?> {
	position: relative;
	height:<?php echo is_numeric($this->height_main) ? $this->height_main.'px' : $this->height_main ?>;
	overflow: hidden;
}
/*.sescrowdfundingvideo_carousel_wrapper_<?php echo $randonNumber; ?>.sescrowdfundingvideo_carousel_h_wrapper .sescrowdfundingvideo_carousel_nav a{top:<?php echo $this->height/2; ?>px;}*/
</style>
<div class="sescrowdfundingvideo_carousel_wrapper clearfix sesbasic_bxs sesbasic_clearfix sesbm <?php echo $this->align == 'vertical' ? 'sescrowdfundingvideo_carousel_v_wrapper' : 'sescrowdfundingvideo_carousel_h_wrapper'; ?> sescrowdfundingvideo_carousel_wrapper_<?php echo $randonNumber; ?>">
  <div id="sescrowdfundingvideo_slider_<?php echo $randonNumber; ?>">
    <?php 
    ...
    $allowRating = Engine_Api::_()->getApi('settings', 'core')->getSetting('video.chanel.rating',1);
      ...
      $photoURL = $item->getPhotoUrl('thumb.normalmain'); ?>
        <div class="sescrowdfundingvideo_listing_grid" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;height:<?php echo is_numeric($this->height_main) ? $this->height_main.'px' : $this->height_main ?>;">
        	<div class="sescrowdfundingvideo_grid_thumb sescrowdfundingvideo_thumb sescrowdfundingvideo_play_btn_wrap" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
          <?php 
          $photoURL=$item->getPhotoUrl(); ?>
          <a class="<?php echo $item->getType() == 'crowdfundingvideo' ? 'sescrowdfundingvideo_thumb_img' : 'sescrowdfundingvideo_thumb_nolightbox' ?>" href="<?php echo $item->getHref(); ?>"> 
            ...
            <?php 
              ...
              <span class="sescrowdfundingvideo_thumb_btns">
                <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sescrowdfundingvideo.enable.socialshare', 1) && isset($this->socialSharing)){ ?>
                  
                  <?php  echo $this->partial('_socialShareIcons.tpl','sesbasic',array('resource' => $item, 'socialshare_enable_plusicon' => $this->socialshare_enable_plusicon, 'socialshare_icon_limit' => $this->socialshare_icon_limit)); ?>

                  <?php } 
                    if($item->crowdfundingvideo_id){
                  ...
                  <?php $LikeStatus = Engine_Api::_()->sescrowdfundingvideo()->getLikeStatusVideo($item->$getId,$item->getType()); ?>
                   <a href="javascript:;" data-url="<?php echo $item->$getId ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sescrowdfundingvideo_like_<?php echo $itemtype; ?><?php echo ($LikeStatus) ? ' button_active' : '' ; ?>"> <i class="fa fa-thumbs-up"></i><span><?php echo $item->like_count; ?></span></a>
                    <?php }
                    if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sescrowdfundingvideo.enable.favourite', 1) && Engine_Api::_()->user()->getViewer()->getIdentity() !=0 && isset($this->favouriteButton)){
                    $favStatus = Engine_Api::_()->getDbtable('favourites', 'sescrowdfundingvideo')->isFavourite(array('resource_type'=>$itemtype,'resource_id'=>$item->$getId)); ?>
              ...
              <?php if(isset($this->like) || isset($this->comment) || isset($this->view) || isset($this->title) || isset($this->rating) || isset($this->favouriteCount) || isset($this->downloadCount)  || isset($this->by) || isset($this->videoCount)){ ?>
                <div class="sescrowdfundingvideo_grid_info clear">
                  ...
                  <?php } ?>
                  	...
                  	<div class="sescrowdfundingvideo_grid_date sescrowdfundingvideo_list_stats sesbasic_text_light floatL">
                      <span>
                  ...
                  <?php }?>
                  <div class="sescrowdfundingvideo_grid_date sescrowdfundingvideo_list_stats sesbasic_text_light clear floatL">
                 ...
                 <?php } ?>
                 <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sescrowdfundingvideo.enable.favourite', 1) && isset($this->favouriteCount)) { ?>
                 ...
                 <?php if($item->getType() == 'sescrowdfundingvideo_chanel'){ 
  ...
  <?php if($this->align == 'horizontal'): ?>
    <div class="tabs_<?php echo $randonNumber; ?> sescrowdfundingvideo_carousel_nav">
      <a class="sescrowdfundingvideo_carousel_nav_pre" href="#page-p"><i class="fa fa-angle-left"></i></a>
      <a class="sescrowdfundingvideo_carousel_nav_nxt" href="#page-p"><i class="fa fa-angle-right"></i></a>
    </div>  
  <?php else: ?>
    <div class="tabs_<?php echo $randonNumber; ?> sescrowdfundingvideo_carousel_nav">
      <a class="sescrowdfundingvideo_carousel_nav_pre" href="#page-p"><i class="fa fa-angle-up"></i></a>
      <a class="sescrowdfundingvideo_carousel_nav_nxt" href="#page-p"><i class="fa fa-angle-down"></i></a>
    </div>  
  <?php endif; ?>
</div>
	...
	window.addEvent('domready', function () {
		var duration = <?php echo $this->durationSlide; ?>,
			...
			carousel = new Carousel.Extra({
				...
				container: 'sescrowdfundingvideo_slider_<?php echo $randonNumber; ?>',
				circular: true,
				current: 1,
