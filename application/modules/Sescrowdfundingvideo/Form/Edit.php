 ...
 * @version    $Id: Edit.php 2018-07-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescrowdfundingvideo_Form_Edit extends Engine_Form {
  ...
  public function init() {
    ...
    if (Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable('seslock') && Engine_Api::_()->authorization()->getPermission($viewer, 'crowdfundingvideo', 'video_locked')) {
