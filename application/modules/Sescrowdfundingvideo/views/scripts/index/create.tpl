...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    ...
    var validationUrl = '<?php echo $this->url(array('module' => 'sescrowdfundingvideo', 'controller' => 'index', 'action' => 'validation'), 'default', true) ?>';
...
//       } 
        ...
        return;
				...
				<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sescrowdfundingvideo.direct.video', 0)){ 
        ...
        // if there is crowdfundingvideo_id that means this form is returned from uploading 
...
<div class="tip"> <span> <?php echo $this->translate('You have already uploaded the maximum number of videos allowed.');?> <?php echo $this->translate('If you would like to upload a new video, please <a href="%1$s">delete</a> an old one first.', $this->url(array('action' => 'manage'), 'sescrowdfundingvideo_general'));?> </span> </div>
