...
<?php if($this->allowVideo && $this->canUpload && !$this->is_ajax){ ?>
  ...
  <div class="sesbasic_profile_tabs_top sesbasic_clearfix">
    ...
    <a class="sesbasic_button fa fa-plus" href="<?php echo $this->url(array('module' => 'sescrowdfundingvideo', 'action' => 'create', 'parent_id' => $this->parent_id), 'sescrowdfundingvideo_general', true); ?>">
            ...
            <?php } ?>
                 ...
                 <?php if(isset($this->enableCommentPinboardActive)){ ?>
                    ...
                    <?php //if((@$itemType != '')){  ?>
                    	...
                    	<?php echo Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesadvancedcomment') ? $this->action('list', 'comment', 'sesadvancedcomment', array('type' => 'crowdfundingvideo', 'id' => $item->getIdentity(),'page'=>'')) : $this->action("list", "comment", "sesbasic", array("item_type" => 'crowdfundingvideo', "item_id" =>  $item->crowdfundingvideo_id,"widget_identity"=>$randonNumber)); ?>
