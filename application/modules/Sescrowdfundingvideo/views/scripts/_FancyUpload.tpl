 ...
 * @version    $Id: _FancyUpload.tpl 2018-07-04 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
	...
	up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
      ...
      url: "<?php  echo $this->url(array('module' => 'sescrowdfundingvideo', 'controller' => 'index', 'action' => 'create'), 'default', true); ?>?ul=1",
      ...
      onFileSuccess: function(file, response) {
        ...
        if (json.get('status') == '1') {
          ...
          $('id').value=json.get('crowdfundingvideo_id');
          $('form-upload').submit();
        } else {
...
<div id="demo-status" class="hide">
  ...
  <div>
    <a class="buttonlink sescrowdfundingvideo_icon_video_add" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Video');?></a>
  </div>
...
<div><br/>
  <a class="buttonlink" href="javascript:startUpload();" id="demo-upload" style='display:none; background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sescrowdfundingvideo/externals/images/new.png);'><?php echo $this->translate('Post Video');?></a>
</div>
