 ...
 * @version    $Id: external.tpl 2018-07-04 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  var crowdfundingvideo_id = <?php echo $this->video->crowdfundingvideo_id;?>;
...
<div class="sescrowdfundingvideo_video_view_container clear sesbasic_clearfix sesbasic_bxs sescrowdfundingvideo_external_video_preview sesbm">
  <?php if( $this->video->type == 3 ): ?>
    <div id="video_embed" class="sescrowdfundingvideo_view_embed clear sesbasic_clearfix"></div>
  <?php else: ?>
  ...
  <?php endif; ?> 
<?php if(!$this->isMap){ ?>
  <div class="sescrowdfundingvideo_external_video_btn_cont clear sesbasic_clearfix">   
    <h2 class="sescrowdfundingvideo_view_title sesbasic_clearfix">
    ...
    <div class="sescrowdfundingvideo_view_statics">
      <div id="album_rating" class="sesbasic_rating_star sescrowdfundingvideo_view_rating">
    ...
    <div class="sescrowdfundingvideo_view_meta sescrowdfundingvideo_list_stats sesbasic_text_light clear sesbasic_clearfix">
    ...
    <?php /*
      <div class='sescrowdfundingvideo_view_options sescrowdfundingvideo_options_buttons'>
        <?php if( $this->can_edit ): ?>
          <?php echo $this->htmlLink(array(
            ...
            'controller' => 'index',
            'action' => 'edit',
            'crowdfundingvideo_id' => $this->video->crowdfundingvideo_id
      ...
      <?php echo $this->action("list", "comment", "sesadvancedcomment", array("type" => "video", "id" => $this->video->getIdentity(),'is_ajax_load'=>true)); 
        }else{ echo $this->action("list", "comment", "core", array("type"=>"video", "id"=>$this->video->crowdfundingvideo_id)); } ?>
     * 
     */ ?>
    </div>
<?php } ?>
