 ...
 */
class Sescrowdfundingvideo_Bootstrap extends Engine_Application_Bootstrap_Abstract {
    ...
    if (strpos(str_replace('/', '', $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']), str_replace('/', '', $_SERVER['SERVER_NAME'] . 'admin')) === FALSE) {
      ...
      $headScript->appendFile($baseURL . 'application/modules/Sescrowdfundingvideo/externals/scripts/core.js');
