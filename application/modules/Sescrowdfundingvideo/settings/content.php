 ...
 * @version    $Id: content.php 2018-07-04 00:00:00 SocialEngineSolutions $
...
return array(
  array(
    'title' => 'SES - Crowdfunding Videos Extension - Page Profile Videos',
    'description' => 'Displays a page\'s videos on page profile page. The recommended page for this widget is "Page Profile Page".',
    'category' => 'SES - Crowdfunding Videos Extension',
    'type' => 'widget',
    'name' => 'sescrowdfundingvideo.profile-videos',
    'autoEdit' => true,
    'adminForm' => 'Sescrowdfundingvideo_Form_Admin_Settings_Profilevideos',
  ),
  array(
      'title' => "SES - Crowdfunding Videos Extension - Owner's Photo",
      'description' => 'This widget display on "SES - Crowdfunding Videos Extension - Video View Page".',
      'category' => 'SES - Crowdfunding Videos Extension',
      'type' => 'widget',
      'autoEdit' => true,
      'name' => 'sescrowdfundingvideo.owner-photo',
      'defaultParams' => array(
          'title' => '',
      ),
      'adminForm' => array(
		...
		array(
        'title' => 'SES - Crowdfunding Videos Extension - Featured / Sponsored Videos Carousel',
		...
		array(
        'title' => 'SES - Crowdfunding Videos Extension - Featured / Sponsored Videos Fixed View',
        'description' => "Disaplys Featured or Sponsored Carousel of Videos.",
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'autoEdit' => true,
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Browse Videos Page Button',
        'description' => 'This widget displays a button clicking on which users will be redirected to the "SES - Crowdfunding Videos Extension - Browse videos Page".',
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'autoEdit' => true,
        'name' => 'sescrowdfundingvideo.browse-video-button',
    ),
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Video Browse Search',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Popular / Featured / Sponsored Videos',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Recently Viewed Videos',
        ...
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'name' => 'sescrowdfundingvideo.recently-viewed-item',
        'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
								array(
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Video of the Day',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Quick AJAX based Search',
        'description' => 'Displays a quick search box to enable users to quickly search Videos of their choice.',
        'category' => 'SES - Crowdfunding Videos Extension',
        'autoEdit' => true,
        'type' => 'widget',
        'name' => 'sescrowdfundingvideo.search',
    ),

    array(
        'title' => 'SES - Crowdfunding Videos Extension - Breadcrumb for Video View Page',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Tabbed Widget',
        ...
        'requirements' => array(
            'subject' => 'crowdfundingvideo',
        ),
        'adminForm' => 'Sescrowdfundingvideo_Form_Admin_Settings_Tabbed',
    ),

    array(
        'title' => 'SES - Crowdfunding Videos Extension - Video Home No Video Message',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Video People Also Liked',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Other Videos From Member',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Similar Videos',
		...
		array(
        'title' => 'SES - Crowdfunding Videos Extension - Video Labels ',
        'description' => 'Displays a featured, sponsored , verified and hot on a video on it\'s profile.',
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'name' => 'sescrowdfundingvideo.video-label',
				'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
						 array(
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - People favourite Video',
        'description' => 'Placed on  a video\'s view page.',
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'name' => 'sescrowdfundingvideo.people-favourite-item',
        'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
                array(
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - People like Video',
        'description' => 'Placed on  a video\'s view page.',
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'name' => 'sescrowdfundingvideo.people-like-item',
        'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
                array(
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Video View Page',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Popularity Videos Widget',
        'description' => 'Displays a videos according to popularity.',
        'category' => 'SES - Crowdfunding Videos Extension',
        'type' => 'widget',
        'name' => 'sescrowdfundingvideo.popularity-videos',
        'adminForm' => array(
        'elements' => array(
                array(
                    'Select',
    ...
    array(
        'title' => 'SES - Crowdfunding Videos Extension - Video Browse Page Widget',
