...
class Sesvideo_Model_Chanel extends Core_Model_Item_Abstract {
  ...
  function getPhotoUrl($type = null) {
    ...
    $defaultImage = 'application/modules/Sesvideo/externals/images/nochanelthumb.png';
    if (!$thumbnail_id && !$this->adult) {
      return Engine_Api::_()->sesvideo()->getFileUrl(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesvideo_chanel_default_image', $defaultImage));
    }
    $viewer = Engine_Api::_()->user()->getViewer();
		if(!Engine_Api::_()->getApi('core', 'sesbasic')->checkAdultContent(array('module'=>'video')) && $this->adult && $this->owner_id != $viewer->getIdentity()){
