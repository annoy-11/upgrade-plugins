    ...
    if ($photo_id) {
      ...
      if ($file)
        return $file->map();
			...
			return	Engine_Api::_()->sesvideo()->getFileUrl(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesvideo_playlist_default_image', "application/modules/Sesvideo/externals/images/nophoto_playlist_thumb_profile.png"));
  }
