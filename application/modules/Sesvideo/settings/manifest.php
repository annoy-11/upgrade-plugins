...
return array(
    'package' => array(
        ...
        'title' => 'SES - Advanced Videos & Channels Plugin',
        'description' => 'SES - Advanced Videos & Channels Plugin',
    ...
    // Items ---------------------------------------------------------------------
    'items' => array(
        'video', 'sesvideo_video', 'sesvideo_category', 'sesvideo_chanel', 'sesvideo_playlist', 'watchlater','chanelphoto','sesvideo_chanelphoto', 'sesvideo_playlistvideo', 'sesvideo_chanelvideo', 'sesvideo_artist', 'sesvideo_artists', 'sesvideo_gallery', 'sesvideo_slide', 'sesvideo_samplevideo', 'samplevideo', 'sesvideo_integrateothermodule',
    ),
    // Hooks ---------------------------------------------------------------------
    'hooks' => array(
        array(
    ...
    'routes' => array(
        'sesvideo_general' => array(
            ...
            'reqs' => array(
                'action' => '(welcome|home|index|browse|create|list|manage|view|share|tags|locations|edit|delete|browse-pinboard|remove-playlist-video)',
            )
        ),
        //lightbox all videos
