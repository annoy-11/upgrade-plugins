 ...
 * @version    $Id: RebuildPrivacysample.php 2015-10-11 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesvideo_Plugin_Job_Maintenance_RebuildPrivacysample extends Core_Plugin_Job_Abstract {

  protected function _execute() {
    // Start custom prepare
    $table = Engine_Api::_()->getItemTable('sesvideo_samplevideo');
