    ...
    <div class="sesvideo_channel_cover_cont sesbasic_clearfix">
      <div class="sesvideo_channel_cover_cont_inner">
        ...
        <div class="sesvideo_channel_cover_info">
          ...
          <?php if($this->allowRateOwn && in_array('rating',$this->option) && (($this->getAllowRating == 0 && $this->allowShowRating == 1 && $this->total_rating_average != 0 ) || ($this->getAllowRating == 1) )){ ?>
       ...
       <div class="sesvideo_channel_cover_footer">
        ...
        <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0){ ?>
          ...
          <div class="sesvideo_channel_cover_buttons sesbasic_clearfix">
            <?php if(in_array('addVideo',$this->option)){ ?>
           <?php if($this->can_edit){ ?>
          ...
          <?php } ?> 
           ...
           <?php } ?>
            ...
            ?>
              ...
              <?php } ?>              
             <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesvideo.allowfavc', 1) && in_array('favourite',$this->option) &&  isset($this->subject->favourite_count) && Engine_Api::_()->user()->getViewer()->getIdentity() != '0'){ ?>
            ...
            <?php } ?>
          <?php if(in_array('report',$this->option) && ($this->viewer_id != $this->subject->owner_id)){ ?>
