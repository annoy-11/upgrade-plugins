...
class Sesvideo_Widget_BrowseChanelController extends Engine_Content_Widget_Abstract {
  ...
  $params = array('height' => $height, 'width' => $width, 'category_limit' => $category_limit, 'video_limit' => $video_limit, 'count_chanel' => $count_chanel, 'seemore_text' => $seemore_text, 'allignment_seeall' => $allignment_seeall, 'socialshare_icon_limit' => $socialshare_icon_limit, 'pagging' => $loadOptionData, 'show_criterias' => $show_criterias, 'title_truncation' => $title_truncation, 'description_truncation' => $description_truncation, 'chanel_limit' => $chanel_limit, 'criteria' => $criteriaData, 'tag' => $value['tag'],'alphabet' => $value['alphabet'],'view_channel_type'=>$view_channel_type, 'socialshare_enable_plusicon' => $socialshare_enable_plusicon);
