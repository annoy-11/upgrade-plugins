...
class Sesvideo_Widget_otherModulesProfileVideosController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'other-modules-profile-videos';
    ...
    if ($popularCol == 'my_videos') {
      ...
      $paginator = $profileVideo = Engine_Api::_()->getDbTable('videos', 'sesvideo')->getVideo(array('parent_id' => $parent_id, 'parent_type' => $parent_type));
    } 
