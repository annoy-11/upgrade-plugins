 ...
 */
class Sesvideo_Widget_FeaturedSponsoredLpWidgetController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if($value['category'] == 'videos')
      ...
      $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('playlists', 'sesvideo')->getPlaylistPaginator($value,true);
    else
      return $this->setNoRender();
