...
class Sesvideo_Widget_ProfileArtistController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if ($showRating) {
      $this->view->canRate = $canRate = $authorizationApi->isAllowed('sesvideo_video', $viewer, 'rating_artist');
