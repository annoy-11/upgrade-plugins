...
class Sesvideo_PlaylistController extends Core_Controller_Action_Standard {
  ...
  public function editAction() {
    ...
    $this->view->message = Zend_Registry::get('Zend_Translate')->_('The selected playlist has been edited.');
  ...
  public function addAction() {
    ...
    if (!$this->_helper->requireAuth()->setAuthParams('video', null, 'addplayl_video')->isValid())
      return;
