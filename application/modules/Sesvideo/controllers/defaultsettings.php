...
if (empty($slideContent)) {
		...
		( ".$gallery_id.", 'We make videos worth watching', 'FFFFFF', 'Rxplore the world’s best videos from our community!!', 'FFFFFF','0', 'mp4', '0', 0, 1, 0, 'FFFFFF', 'EEEEEE', 'Login', '0295FF', '0295FF', '067FDE', 'Signup', 'FFFFFF', 'F25B3B', 'EA350F', 'Browse All Videos', 'FFFFFF', 'videos/browse',  '".date('Y-m-d H:i:s')."', '".date('Y-m-d H:i:s')."', 0)");
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $main_middle_id,
      'order' => $widgetOrder++,
      'params' => '{"paginationType":"0","information":["showfavourite","showrating"],"height":"275","width":"303","itemCount":"9","title":"","nomobile":"0","name":"sesvideo.browse-artists"}',
  ));
