...
<div id="profile_options">
  <ul>
    ...
    <?php } ?>
    <li> 
    	<a class="buttonlink smoothbox sesbasic_icon_share" href="<?php echo $this->url(array('module'=> 'activity', 'controller' => 'index', 'action' => 'share', 'route' => 'default', 'type' => 'sesvideo_chanel', 'id' => $this->subject->chanel_id, 'format' => 'smoothbox'),'default',true); ?>"><?php echo $this->translate("Share This Channel"); ?></a>
    </li>
