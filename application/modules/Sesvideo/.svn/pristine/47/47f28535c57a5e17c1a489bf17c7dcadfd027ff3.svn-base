   ...
   $this->addElement('Text', "height_grid", array(
    ...
    $this->addElement('MultiCheckbox', "manage_video_tabbed_option", array(
        ...
        'multiOptions' => array(
            ...
            'likedSPchannels' => 'Liked Channels',
            'favouriteSPchannels' => 'Favourite Channels',
            'featuredSPchannels' => 'Featured Channels',
            'sponsoredSPchannels' => 'Sponsord Channels',
            'hotSPchannels' => 'Hot Channels',
