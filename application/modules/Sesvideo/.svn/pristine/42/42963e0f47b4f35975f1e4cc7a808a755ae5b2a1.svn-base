...
<?php if($this->editOverview){ ?>
  ...
  <div class="sesbasic_profile_tabs_top sesbasic_clearfix">
    <a href="<?php echo $this->url(array('chanel_id' =>$this->subject->chanel_id,'action'=>'overview'),'sesvideo_chanel'); ?>" class="smoothbox sesbasic_button"><i class="fa fa-plus"></i><span><?php echo  $overviewtext; ?></span></a>
  </div>
<?php } ?>
