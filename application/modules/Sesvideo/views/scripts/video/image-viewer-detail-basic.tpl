  ...
  en4.core.runonce.add(function() {
    ...
    var rating_over_viewer = window.rating_over_viewer = function(rating) {
      if( rated_viewer == 1 ) {
        ...
        for(var x=1; x<=5; x++) {
          if(x <= rating) {
            $('rate_viewer_'+x).set('class', 'rating_star_big_generic rating_star_big');
          } else {
            $('rate_viewer_'+x).set('class', 'rating_star_big_generic rating_star_big_disabled');
          }
        }
      }
    }
    ...
    var rating_out_viewer = window.rating_out_viewer = function() {
     ...
     var set_rating_viewer = window.set_rating_viewer = function() {
      ...
      if (remainder <= 0.5 && remainder !=0){
        ...
        $('rate_viewer_'+last).set('class', 'rating_star_big_generic rating_star_big_half');
      }
    }
     ...
     <?php  } ?>
      <?php if(($this->getAllowRating == 0 && $this->allowShowRating == 1 && $this->total_rating_average != 0 ) || ($this->getAllowRating == 1) ){ ?>
        <div id="album_rating" class="sesbasic_rating_star ses_media_lightbox_item_rating" onmouseout="rating_out_viewer();">
          <span id="rate_viewer_1" class="rating_star_big_generic" <?php  if ($this->viewer_id && $this->ratedAgain && $this->allowMine &&  $this->allowRating):?>onclick="rate_viewer(1);"<?php  endif; ?> onmouseover="rating_over_viewer(1);"></span>
          <span id="rate_viewer_2" class="rating_star_big_generic" <?php if ( $this->viewer_id && $this->ratedAgain && $this->allowMine && $this->allowRating):?>onclick="rate_viewer(2);"<?php endif; ?> onmouseover="rating_over_viewer(2);"></span>
          <span id="rate_viewer_3" class="rating_star_big_generic" <?php if ( $this->viewer_id && $this->ratedAgain  && $this->allowMine && $this->allowRating):?>onclick="rate_viewer(3);"<?php endif; ?> onmouseover="rating_over_viewer(3);"></span>
          <span id="rate_viewer_4" class="rating_star_big_generic" <?php if ($this->viewer_id && $this->ratedAgain && $this->allowMine && $this->allowRating):?>onclick="rate_viewer(4);"<?php endif; ?> onmouseover="rating_over_viewer(4);"></span>
          <span id="rate_viewer_5" class="rating_star_big_generic" <?php if ($this->viewer_id && $this->ratedAgain  && $this->allowMine && $this->allowRating):?>onclick="rate_viewer(5);"<?php endif; ?> onmouseover="rating_over_viewer(5);"></span>
