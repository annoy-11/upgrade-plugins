...
<p>In this page, you can enable the creation of Browse Videos Page in other plugins. Below you can add the integration with any plugin using “Add New Plugin” button.<br /><br />
