...
function createStatusbar(obj,file)
{
     ...
     if(rowCount %2 ==0) row ="even";
			this.objectInsert = sesJqueryObject('<div class="sesalbum_upload_item sesbm sesbasic_bg '+row+'"></div>');
			...
			this.option = sesJqueryObject('<div class="sesalbum_upload_item_options clear sesbasic_clearfix"><a class="edit_image_upload" href="javascript:void(0);"><i class="fas fa-edit"></i></a><a class="delete_image_upload" href="javascript:void(0);"><i class="fa fa-trash"></i></a></div>').appendTo(this.objectInsert);
