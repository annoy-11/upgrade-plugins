...
//   
//   $fromURL = (bool) in_array('url',$is_allowed_option) ? 1 : 0;
//   $embedcode = (bool) in_array('embedcode',$is_allowed_option) ? 1 : 0;
//   $fbembedcode = (bool) in_array('facebook',$is_allowed_option) ? 1 : 0;
//   $twitterembedcode = (bool) in_array('twitter',$is_allowed_option) ? 1 : 0;
//   $streamableembedcode = (bool) in_array('streamable',$is_allowed_option) ? 1 : 0;
