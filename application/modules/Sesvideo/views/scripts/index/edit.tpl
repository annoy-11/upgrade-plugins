  ...
  var previous_mapped_level = 0;
   function showFields(cat_value, cat_level,type,isLoad,resets) {
    if(typeof type == 'undefined'){
       type = getProfileType(sesJqueryObject('#category_id').val())+','+getProfileType(sesJqueryObject('#subcat_id').val())+','+getProfileType(sesJqueryObject('#subsubcat_id').val());
    }
    if (cat_level == 1 || (previous_mapped_level >= cat_level && previous_mapped_level != 1) || (profile_type == null || profile_type == '' || profile_type == 0)) {
      ...
      changeFields($(defaultProfileFieldId),null,isLoad,type,resets);
    }
  }
