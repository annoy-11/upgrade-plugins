 ...
 * @version    $Id: install.php  2018-11-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Otpsms_Installer extends Engine_Package_Installer_Module {
...
//   }
  ...
  public function onDisable(){
	  $db = $this->getDb();
	  $db->query("UPDATE engine4_user_signup SET enable = '0' WHERE class = 'Otpsms_Plugin_Signup_Otpsms'");
	  parent::onDisable();
  }

  public function onEnable(){
	  $db = $this->getDb();
	  $db->query("UPDATE engine4_user_signup SET enable = '1' WHERE class = 'Otpsms_Plugin_Signup_Otpsms'");
	  parent::onEnable();
  }
}
