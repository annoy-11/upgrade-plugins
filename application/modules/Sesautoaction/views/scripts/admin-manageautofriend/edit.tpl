...
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesautoaction', 'controller' => 'manageautofriend', 'action' => 'index'), "Back to Manage Auto Friend Settings", array('class'=>'sesbasic_icon_back buttonlink')) ?>
<br /><br />
