...
<div class="sesbasic_search_reasult">
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesautoaction', 'controller' => 'manageautofriend', 'action' => 'index'), $this->translate("Back to Manage Auto Friend Settings") , array('class'=>'sesbasic_icon_back buttonlink')); ?>
</div>
<div class='clear'>
