 ...
 * @version    $Id: gifcontent.tpl  2017-12-06 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<div class="gif_content ses_emoji_container sesbasic_bxs _gif_content notclose" id="emoji_close">
