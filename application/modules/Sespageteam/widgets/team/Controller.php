 ...
 */
class Sespageteam_Widget_TeamController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = Engine_Api::_()->getDbTable('teams', 'sespageteam')->getTeamMemers(array('page_id' => $subject->getIdentity(), 'widgettype' => 'widget'));
  }
