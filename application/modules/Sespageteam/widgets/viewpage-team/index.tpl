...
<?php $user = $this->team;  ?>
<div class="sespageteam_member_profile_wrapper clear sesbasic_clearfix">
  <?php if($user->type == 'sitemember') { ?>
    <?php $userItem = Engine_Api::_()->getItem('user', $user->user_id); ?>
  <?php } ?>
  <div class="sespageteam_member_profile_left">
    <div class="sespageteam_member_profile_photo">
      <?php if(!empty($this->infoshow) && in_array('profilePhoto', $this->infoshow)): ?>
        <div class="sespageteam_member_profile_photo_inner">
          <?php if($user->type == 'sitemember') { ?>
    ...
    <div class="sespageteam_member_profile_contact_info">
    ...
    <div class="sespageteam_member_profile_social_icon sespageteam-social-icon">
      <?php if($user->email && in_array('email', $this->infoshow)): ?>
