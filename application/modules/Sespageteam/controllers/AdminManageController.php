 ...
 */
class Sespageteam_AdminManageController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    $this->view->subNavigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sespageteam_admin_main', array(), 'sespageteam_admin_main_manage');

    //$this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sespageteam_admin_main', array(), 'sespageteam_admin_main_manage');
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('teams', 'sespageteam')->getTeamMemers();
  ...
  public function deleteAction() {
    ...
    if ($this->getRequest()->isPost()) {
      ...
      $db->beginTransaction();
      try {
        Engine_Api::_()->getDbtable('teams', 'sespageteam')->delete(array('team_id =?' => $this->_getParam('team_id')));
        $db->commit();
      } catch (Exception $e) {
        $db->rollBack();
        throw $e;
    ...
    if ($this->getRequest()->isPost()) {
      ...
      foreach ($values as $key => $value) {
        if ($key == 'delete_' . $value) {
          $sesteam_teams = Engine_Api::_()->getItem('sespageteam_team', (int) $value);
  ...
  public function enabledAction() {
    ...
    if (!empty($id)) {
      $item = Engine_Api::_()->getItem('sespageteam_team', $id);
      $item->enabled = !$item->enabled;
      $item->save();
    }
    $this->_redirect('admin/sespageteam/manage/');
  }
  ...
  public function designationsAction() {
    ...
    $this->view->subNavigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sespageteam_admin_main', array(), 'sespageteam_admin_main_managedesignation');

    $designations_table = Engine_Api::_()->getDbTable('designations', 'sespageteam');
  ...
  public function adddesignationAction() {
    ...
    //Render Form
    $this->view->form = $form = new Sespageteam_Form_Admin_Adddesignation();
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      try {
        ...
        if ($row->designation_id)
          $db->update('engine4_sespageteam_designations', array('order' => $row->designation_id), array('designation_id = ?' => $row->designation_id));
      } catch (Exception $e) {
        $db->rollBack();
        throw $e;
      }
  ...
  public function editdesignationAction() {
    ...
    $designationItem = Engine_Api::_()->getItem('sespageteam_designations', $this->_getParam('designation_id'));
    $this->_helper->layout->setLayout('admin-simple');
    $form = $this->view->form = new Sespageteam_Form_Admin_Editdesignation();
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      $db->beginTransaction();
      try {
        //$db->update('engine4_sespageteam_teams', array('designation' => $values["designation"]), array('designation_id = ?' => $this->_getParam('designation_id')));
  ...
  public function deletedesignationAction() {
    ...
    if ($this->getRequest()->isPost()) {
      ...
      try {
        ...
        $db->update('engine4_sespageteam_teams', array('designation_id' => '', 'designation' => ''), array('designation_id = ?' => $this->_getParam('designation_id')));
        Engine_Api::_()->getDbtable('designations', 'sespageteam')->delete(array('designation_id =?' => $this->_getParam('designation_id')));
    ...
    if ($this->getRequest()->isPost()) {
      ...
      foreach ($values as $key => $value) {
        if ($key == 'delete_' . $value) {
          ...
          $slideImage = Engine_Api::_()->getItem('sespageteam_designations', $explodedKey[1]);
          $slideImage->delete();
        }
      }
    }
  ...
  public function orderAction() {
    ...
    $table = Engine_Api::_()->getDbtable('designations', 'sespageteam');
