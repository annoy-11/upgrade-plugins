 ...
 * @version    $Id: _teamtemplate3.tpl  2018-11-14 00:00:00 SocialEngineSolutions $
...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespageteam/externals/styles/template3.css');
?>

<div class="sespageteam_temp3_wrap">
  <div class="sespageteam_temp3_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
      ...
      <div class="team_box">
        <div class="team_box_inner">
          ...
          <?php endif; ?>
            ...
            <?php endif; ?>
            <?php if(!empty($this->content_show) && ($user->email || $user->phone || $user->location )): ?>
