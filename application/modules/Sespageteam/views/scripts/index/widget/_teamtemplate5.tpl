...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespageteam/externals/styles/template5.css');
?>

<div class="sespageteam_temp5_wrap">
  <div class="sespageteam_temp5_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
