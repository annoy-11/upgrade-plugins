...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespageteam/externals/styles/template6.css');
?>

<div class="sespageteam_temp6_wrap">
  <div class="sespageteam_temp6_list">
    <table>
        ...
        <tr>
          ...
          <?php if(!empty($this->content_show)): ?>
            <td class="sespageteam-social-icon <?php if(empty($this->sespageteam_social_border)): ?>bordernone<?php endif; ?>">
