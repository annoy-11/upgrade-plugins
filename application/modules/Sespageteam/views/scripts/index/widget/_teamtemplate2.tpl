...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespageteam/externals/styles/template2.css');
?>

<div class="sespageteam_temp2_wrap">
  <div class="sespageteam_temp2_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
      ...
      <div class="team_box" style="width:<?php echo $this->width ?>px;">
        <div class="team_box_inner">
          ...
          <?php if(!empty($this->content_show) && ($user->website || $user->facebook || $user->twitter || $user->linkdin || $user->googleplus)): ?>
            <div class="sespageteam-social-links team_member_info">
