...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespageteam/externals/styles/template4.css');
?>

<div class="sespageteam_temp4_wrap">

  <div class="sespageteam_temp4_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
