...
function validateTeamform() {
  ...
  sesJqueryObject('.sespageteam_formcheck input, .sespageteam_formcheck select, .sespageteam_formcheck checkbox, .sespageteam_formcheck textarea, .sespageteam_formcheck radio').each(
    function(index){
...
sesJqueryObject(document).on('submit', '#sespageteam_addteam', function(e) {
  e.preventDefault();
  addTeam(this);
});

sesJqueryObject(document).on('submit', '#sespageteam_adddesignation', function(e) {
  e.preventDefault();
  addDesignation(this);
});
