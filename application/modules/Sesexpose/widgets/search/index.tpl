...
<div class="header_searchbox">
  ...
  <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesexpose.searchleftoption', 1) && count($this->types) > 0): ?>
    <div class="header_searchbox_selectbox">
      <div class="exp_select">
        <span id="<?php echo $counter."_"; ?>exp_select_value"><?php echo $this->translate('All');?><i class="fa fa-angle-down"></i></span>
	      ...
	      <li class="sesbasic_clearfix <?php if(isset($_GET['type']) && ($_GET['type'] == $key)):?> selected <?php endif;?> " id="<?php echo $counter."_"; ?>show_type_<?php echo $key;?>" onclick="typevalue<?php echo $counter."_"; ?>('<?php echo $key;?>', '<?php echo $this->translate($title);?>')">
	        ...
	        <?php else: ?>
	          <?php if($explodedType[0] == 'ITEM_TYPE_VIDEO'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/video.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_ALBUM'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/album.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_ALBUM_PHOTO'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/photo.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_USER'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/user.png'; ?>" align="left" alt="">
					  <?php elseif($explodedType[0] == 'ITEM_TYPE_BLOG'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/blog.png'; ?>" align="left" alt="">
					  <?php elseif($explodedType[0] == 'ITEM_TYPE_BLOG'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/blog.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_CLASSIFIED'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/classified.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_EVENT'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/event.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_GROUP'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/group.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_FORUM_POST'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/topic.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_FORUM_TOPIC'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/topic.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_MUSIC_PLAYLIST'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/music-album.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_MUSIC_PLAYLIST_SONG'): ?>
							<img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search-icons/song.png'; ?>" align="left" alt="">
	          <?php else: ?>
						  <img src="<?php echo $base_url.'application/modules/Sesexpose/externals/images/search.png'; ?>" align="left" alt="">
					  <?php endif;?>
					<?php endif;?>
  ...
  <div class="header_searchbox_input">
      <input placeholder="<?php echo $this->translate('Search'); ?>" id="<?php echo $counter."_"; ?>sesexpose_title" type="text" name="name" />
  </div>
</div>
<input type="hidden" id="<?php echo $counter."_"; ?>exp_type_value" value="">
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    searchAutocomplete = new Autocompleter.Request.JSON('<?php echo $counter."_"; ?>sesexpose_title', "<?php echo $this->url(array('module' => 'sesexpose', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
      'postVar': 'text',
      'delay' : 250,      
      'minLength': 1,
      'selectMode': 'pick',
  ...
  function showAllSearchResults() {
    ...
    if($('<?php echo $counter."_"; ?>exp_type_value').value != 'Everywhere' && typeof $('<?php echo $counter."_"; ?>exp_type_value').value != 'undefined') {
      window.location.href= '<?php echo $this->url(array("controller" => "search"), "default", true); ?>' + "?query=" + $('<?php echo $counter."_"; ?>sesexpose_title').value+'&type='+$('<?php echo $counter."_"; ?>exp_type_value').value;
    }
    else
    window.location.href= '<?php echo $this->url(array("controller" => "search"), "default", true); ?>' + "?query=" + $('<?php echo $counter."_"; ?>sesexpose_title').value;
  }
  ...
  function typevalue<?php echo $counter."_"; ?>(value, mainValue) {
    ...
    document.getElementById('<?php echo $counter."_"; ?>exp_select_value').innerHTML = mainValue+'<i class="fa fa-angle-down"></i>';
  ...
  if($('<?php echo $counter."_"; ?>exp_select_value')) {
    $('<?php echo $counter."_"; ?>exp_select_value').addEvent('click', function(event){
      event.stop();
      //if($('<?php echo $counter."_"; ?>exp_select_option')) {
        if($('<?php echo $counter."_"; ?>exp_select_option').hasClass('show-options'))
          $('<?php echo $counter."_"; ?>exp_select_option').removeClass('show-options');
      //} else {
        if($('<?php echo $counter."_"; ?>exp_select_option'))
          $('<?php echo $counter."_"; ?>exp_select_option').addClass('show-options');
      //}
      return false;
    });
  }
  ...
  sesJqueryObject(document).ready(function() {
    sesJqueryObject('#<?php echo $counter."_"; ?>sesexpose_title').keydown(function(e) {
      if (e.which === 13) {
