...
class Sesexpose_Widget_MenuMainController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->max = $settings->getSetting('sesexpose.limit', 5);
    $this->view->moreText = $settings->getSetting('sesexpose.moretext', "More");
    if($headerview == 3) {
      $this->view->max = 100;
      $this->view->moreText = '';
    }
