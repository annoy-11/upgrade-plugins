...
<div class="header_right clearfix">
    ...
    <?php if($this->show_mini):?>
   	<div class="header_minimenu">
    	<?php echo $this->content()->renderWidget("sesexpose.menu-mini"); ?>
    </div>
    <?php endif; ?>
  ...
  <?php if($this->show_logo):?>
    <div class="header_logo">
      <?php echo $this->content()->renderWidget('sesexpose.menu-logo'); ?>
    </div>
  <?php endif; ?>
      ...
      <div class="minimenu_search_box" id="minimenu_search_box">
        ...
        echo $this->content()->renderWidget("sesexpose.search");
        }
        ?>
      </div>
    <?php endif; ?>
  ...
  <?php if($this->show_menu):?>
    <div class="main_menu_bar">
      ...
      <?php } else { ?>
        <?php echo $this->content()->renderWidget("sesexpose.menu-main"); ?>
      <?php } ?>
    </div>
	<?php endif; ?>
</div>
...
<?php elseif($this->headerview == '3'): ?>
  ...
  <script type="text/javascript">
      ...
      <?php if($this->headerview == 3): ?>
        $(document).getElement('body').addClass('sesexp_footer_none')
      <?php endif; ?>
