...
<?php if($this->viewer->getIdentity() == 0) : ?>
  <script type="text/javascript" src="<?php echo $baseUrl; ?>application/modules/Sesexpose/externals/scripts/jquery-latest.min.js"></script>
  <script>var ses = $.noConflict();</script>
  <script src="<?php echo $baseUrl; ?>application/modules/Sesexpose/externals/scripts/jquery.magnific-popup.js"></script>
  <link href="<?php echo $baseUrl; ?>application/modules/Sesexpose/externals/styles/magnific-popup.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
  <div id="small-dialog" class="zoom-anim-dialog mfp-hide expose_quick_popup expose_quick_login_popup sesbasic_bxs">
    <div class="expose_popup_header clearfix">
    	<div class="expose_popup_header_title"><?php echo $this->translate("Sign In");?></div>  
    </div>
    ...
    <?php if(Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')): ?>
      ...
      <div class="expose_social_login_btns <?php if($numberOfLogin < 3):?>social_login_btns_label<?php endif;?>">
        <?php  echo $this->partial('_socialLoginIcons.tpl','sessociallogin',array()); ?>
      </div>
    <?php endif; ?>
    <div class="expose_popup_content clearfix">
      <?php if(!empty($showSeparator) && !Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
        <div class="expose_quick_popup_social">
          ...
          <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
            <a href="<?php echo $href;?>" id="fbLogin" class="expose_facebook_btn expose_social_btn"><span><i class="fa fa-facebook"></i>Sign in with Facebook</span></a>
          <?php endif;?>
          <?php if ('none' != $settings->getSetting('core_twitter_enable', 'none') && $settings->core_twitter_secret):?>
            ...
            <a href="<?php echo $href;?>" id="googleLogin" class="expose_twitter_btn expose_social_btn"><span><i class="fa fa-twitter"></i>Sign in with Twitter</span></a>
          <?php endif;?>
        </div>
      <?php endif;?>
      <div class="expose_quick_popup_form">
        <?php echo $this->content()->renderWidget("sesexpose.login-or-signup")?>
      </div>

    </div>
    <div class="expose_popup_footer clearfix">
  ...
  <?php if($controllerName != 'signup'){ ?>
    <div id="user_signup_form" class="zoom-anim-dialog mfp-hide expose_quick_popup sesbasic_bxs expose_quick_signup_popup">
      <div class="expose_popup_header clearfix">
      	<div class="expose_popup_header_title"><?php echo $this->translate("Sign Up");?></div>  
      </div>
      <?php if(Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
        <?php $numberOfLogin = Engine_Api::_()->sessociallogin()->iconStyle();?>
        <div class="expose_social_login_btns <?php if($numberOfLogin < 3):?>social_login_btns_label<?php endif;?>">
         ...
         <?php if(!empty($showSeparator) && !Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
          <div class="expose_quick_popup_social">
            <?php if ('none' != $settings->getSetting('core_facebook_enable', 'none') && $settings->core_facebook_secret):?>
              ...
              <?php endif;?>
              <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
              <a href="<?php echo $href;?>" id="fbLogin" class="expose_facebook_btn expose_social_btn"><span><i class="fa fa-facebook"></i>Sign Up with Facebook</span></a>
            <?php endif;?>
  
            <?php if ('none' != $settings->getSetting('core_twitter_enable', 'none') && $settings->core_twitter_secret):?>
              <?php $href = Zend_Controller_Front::getInstance()->getRouter() ->assemble(array('module' => 'user', 'controller' => 'auth', 'action' => 'twitter'), 'default', true);?>
              <a href="<?php echo $href;?>" id="googleLogin" class="expose_twitter_btn expose_social_btn"><span><i class="fa fa-facebook"></i>Sign Up with Twitter</span></a>
            <?php endif;?>
          </div>
        <?php endif;?>
        <div class="expose_quick_popup_form">
          <?php if($this->poupup && $controllerName != 'auth' && $actionName != 'login'){ ?>
            <?php echo $this->action("index", "signup", defined('sesquicksignup') ? "quicksignup" : "sesexpose", array('disableContent'=>true)) ?>
          <?php } ?>
          <div class="expose_popup_footer clearfix">
...
<div id='core_menu_mini_menu'>
  ...
  ?>
  <ul class="expose_minimenu_links">
    <?php foreach( $this->navigation as $item ): ?>
      <?php if(end(explode(' ', $item->class)) == 'core_mini_signup'):?>
        <li class="expose_minimenu_link expose_minimenu_signup">
          <?php if($controllerName != 'signup'){ ?>
      ...
      <?php elseif(end(explode(' ', $item->class)) == 'core_mini_auth' && $this->viewer->getIdentity() == 0):?>
        ...
        <li class="expose_minimenu_link expose_minimenu_login">
        ...
        <?php elseif(end(explode(' ', $item->class)) == 'core_mini_friends'):?>
           <?php $friendRequestIcon = Engine_Api::_()->sesexpose()->getMenuIcon('core_mini_friends');?>
           <?php if($this->viewer->getIdentity()):?>
             <li class="expose_minimenu_request expose_minimenu_icon" title="<?php echo $this->translate('Friends Invitation');?>">
            <?php if($this->requestCount):?>
              <span id="request_count_new" class="expose_minimenu_count"><?php echo $this->requestCount ?></span>
            <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'friendrequest');" style="display:block;" class="friends_pulldown">
            <div id="friend_request" class="expose_pulldown_contents_wrapper">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="expose_pulldown_header">
                <?php echo $this->translate('Requests'); ?>
              </div>
              <div id="expose_friend_request_content" class="expose_pulldown_contents">
        ...
        <?php $notificationIcon = Engine_Api::_()->sesexpose()->getMenuIcon('core_mini_notification');?>
        <?php if($this->viewer->getIdentity()):?>
          <li id='core_menu_mini_menu_update' class="expose_minimenu_updates expose_minimenu_icon" title="<?php echo $this->translate('Notifications');?>">
              <?php if($this->notificationCount):?>
                <span id="notification_count_new" class="expose_minimenu_count">
            ...
            <span onclick="toggleUpdatesPulldown(event, this, '4', 'notifications');" style="display:block;" class="updates_pulldown">
              <div class="expose_pulldown_contents_wrapper">
                <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                <div class="expose_pulldown_header">
                  <?php echo $this->translate('Notifications'); ?>
                </div>
                <div class="expose_pulldown_contents pulldown_content_list">
      ...
      <?php elseif(end(explode(' ', $item->class)) == 'core_mini_profile'):?>
        <li class="expose_minimenu_profile" title="<?php echo $this->translate('My Profile');?>">
      ...
      <?php elseif(end(explode(' ', $item->class)) == 'core_mini_settings'):?>
        <?php $settingIcon = Engine_Api::_()->sesexpose()->getMenuIcon('core_mini_settings');?>
        <li class="expose_minimenu_setting expose_minimenu_icon" title="<?php echo $this->translate('Settings');?>">
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'settings');" style="display:block;" class="settings_pulldown">
            <div id="user_settings" class="expose_pulldown_contents_wrapper expose-mini-menu-settings-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="expose_pulldown_header">
                <?php echo $this->translate('Account & Settings');?>
              </div>
              <div id="expose_user_settings_content" class="expose_pulldown_contents">
      ...
      <?php elseif(end(explode(' ', $item->class)) == 'core_mini_messages'):?>
        <?php $messageIcon = Engine_Api::_()->sesexpose()->getMenuIcon('core_mini_messages');?>
        <li class="expose_minimenu_message expose_minimenu_icon" title="<?php echo $this->translate('Messages');?>">
          <?php if($this->messageCount):?>
            <span id="message_count_new" class="expose_minimenu_count"><?php echo $this->messageCount ?></span>
          <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'message');" style="display:block;" class="messages_pulldown">
            <div id="expose_user_messages" class="expose_pulldown_contents_wrapper expose-mini-menu-messages-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="expose_pulldown_header">
              ...
              <div id="expose_user_messages_content" class="expose_pulldown_contents">
                <div class="pulldown_loading">
                  <img src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Core/externals/images/loading.gif' alt="<?php echo $this->translate('Loading'); ?>" />
                </div>
              </div>
    ...
    <?php if($this->show_search && $this->headerview != 1): ?>
      <li class="minimenu_search_button expose_minimenu_icon">
...
<script type='text/javascript'>
  ...
  var toggleUpdatesPulldown = function(event, element, user_id, menu) {
    ...
    if(event.target.className == 'expose_pulldown_header')
    return;
  ...
  var showNotifications = function() {
    ...
    abortRequest = new Request.HTML({
      'url' : en4.core.baseUrl + 'sesexpose/notifications/pulldown',
      'data' : {
        'format' : 'html',
        'page' : 1
      },
      'onComplete' : function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        document.getElementById('notification_count_new').removeClass('expose_minimenu_count');
      }
  ...
  function showSettings() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sesexpose/index/general-setting',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       document.getElementById('expose_user_settings_content').innerHTML = responseHTML;
      }
    });
    en4.core.request.send(abortRequest, {
    'force': true
  ...
  function showMessages() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sesexpose/index/inbox',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       document.getElementById('expose_user_messages_content').innerHTML = responseHTML;
       document.getElementById('message_count_new').innerHTML = '';
       document.getElementById('message_count_new').removeClass('expose_minimenu_count');
      }
    }); 
    en4.core.request.send(abortRequest, {
    'force': true
  ...
  function showFriendRequests() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sesexpose/index/friendship-requests',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       if(responseHTML) {
         document.getElementById('expose_friend_request_content').innerHTML = responseHTML;
         document.getElementById('request_count_new').innerHTML = '';
         document.getElementById('request_count_new').removeClass('expose_minimenu_count');
       }
       else {
  ...
  if('<?php echo $this->viewer->getIdentity();?>' == 0) {
    ...
    <?php $forcehide =  Engine_Api::_()->getApi('settings', 'core')->getSetting('sesexpose.popupfixed', false);    ?>
   ...
   var day = '<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesexpose.popup.day', 5);?>';
   if(day != 0)
...
window.addEvent('domready', function() {
      ...
      if(event.target.id != 'show_message' && event.target.id != 'show_request' && event.target.id != 'updates_toggle' &&  event.target.id != 'show_settings' && event.target.className != 'expose_pulldown_header' && event.target.className != 'pulldown_loading' && event.target.id != 'minimenu_search_box') {
...
//         }
  ...
  function newFriendRequests() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesexpose/index/new-friend-requests',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.requestCount && $("request_count_new") ) {
          ...
          $("request_count_new").style.display = 'block';
         		...
         		$("request_count_new").addClass('expose_minimenu_count');
...
function newUpdates() {
  en4.core.request.send(new Request.JSON({
    url : en4.core.baseUrl + 'sesexpose/index/new-updates',
    method : 'POST',
    data : {
      format : 'json'
    },
    onSuccess : function(responseJSON) 
    {
      if( responseJSON.notificationCount && $("notification_count_new") ) {
        ...
        $("notification_count_new").innerHTML = responseJSON.notificationCount;
        	...
        	$("notification_count_new").addClass('expose_minimenu_count');
      }
    }
  }));
}  
  function newMessages() {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesexpose/index/new-messages',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.messageCount && $("message_count_new") ) {
          ...
          $("message_count_new").style.display = 'block';
        	...
        	$("message_count_new").addClass('expose_minimenu_count');
