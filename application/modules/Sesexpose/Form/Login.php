...
class Sesexpose_Form_Login extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    $this->setAttrib('id', 'sesexpose_form_login');
    ...
    $this->addElement('dummy', 'showhidepassword', array(
      'decorators' => array(array('ViewScript', array(
        'viewScript' => 'application/modules/Sesexpose/views/scripts/showhidepassword.tpl',
      ))),
			'tabindex' => $tabindex++,
    ));
		//SES Work For Show and Hide Password
