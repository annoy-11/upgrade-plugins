 ...
 */
class Epetition_Widget_PetitionLocationController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (isset($value['getParamSort'])) {
      switch ($value['getParamSort']) {
        case 'open':
          $value['popularCol'] = 'open';
          break;
        case 'close':
          $value['popularCol'] = 'close';
          break;
        case 'only_victory':
          $value['popularCol'] = 'victory';
          break;
        case 'most_viewed':
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('epetitions', 'epetition')->getEpetitionsPaginator($value, true);
    $paginator->setItemCountPerPage($limit);
    $paginator->setCurrentPageNumber(1);
    $this->view->widgetName = 'petition-location';
  }
