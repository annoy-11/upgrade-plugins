...
class Epetition_Widget_OfTheDayController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $show_criterias = $this->_getParam('show_criteria', array('like', 'comment', 'view', 'open', 'close', 'by', 'title', 'socialSharing', 'favourite', 'featuredLabel', 'sponsoredLabel', 'verifiedLabel', 'favouriteButton', 'likeButton'));
    ...
    $petitionId = Engine_Api::_()->getDbTable('epetitions', 'epetition')->getOfTheDayResults();
    $this->view->epetition_id = $petitionId;
