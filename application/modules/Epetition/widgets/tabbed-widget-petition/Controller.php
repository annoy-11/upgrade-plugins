...
class Epetition_Widget_tabbedWidgetPetitionController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $epetition_tabbed = Zend_Registry::isRegistered('epetition_tabbed') ? Zend_Registry::get('epetition_tabbed') : null;
    ...
    $this->view->can_create = Engine_Api::_()->authorization()->isAllowed('epetition_petition', null, 'create');
    ...
    $this->view->widgetName = 'tabbed-widget-petition';			
    ...
    $this->view->paginator = $paginator;
	  $this->view->total_page_count=count($paginator);
