...
class Epetition_Widget_TopPetitionsController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
		...
		$this->view->widgetName = 'top-petitions';
		...
		$this->view->photo_type = $this->_getParam('photoviewtype');

    foreach ($show_criterias as $show_criteria) {
      $this->view->{$show_criteria . 'Active'} = $show_criteria;
    }
		$this->view->paginator = $paginator = Engine_Api::_()->epetition()->getPetitions();
