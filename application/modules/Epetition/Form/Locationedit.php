 ...
 * @version    $Id: Locationedit.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Epetition_Form_Locationedit extends Engine_Form {

  public function init() {
    $action = Zend_Controller_Front::getInstance()->getRequest()->getParams();
    if ($action['action'] == 'edit-location')
      $this->setTitle('Edit Location')->setDescription("Here you can manage your petition\'s location. This page will display location of the petition. The saved location will display on petiton profile page.");
    else
