 ...
 * @version    $Id: Search.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Epetition_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'epetition', 'controller' => 'index', 'action' => 'browse'), 'default', true));
    ...
    if ($this->_locationSearch == 'yes' && $this->getSearchFor() == 'petition') {
      /*Location Elements*/
    ...
    if ($this->getHasPhoto() != 'no') {
      $this->addElement('Checkbox', 'has_photo', array(
          'label' => 'Only Petitions With Photos',
