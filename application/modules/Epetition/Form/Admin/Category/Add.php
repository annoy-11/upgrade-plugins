 ...
 * @version    $Id: Add.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Epetition_Form_Admin_Category_Add extends Engine_Form
{
  ...
  public function init()
  {
    ...
    if (isset($category) && $category->cat_icon) {
      ...
      if (isset($path) && !empty($path)) {
        $this->addElement('Image', 'cat_icon_psignature', array(
          'src' => $path,
          'width' => 100,
          'height' => 100,
        ));
    ...
    if (isset($category) && $category->thumbnail) {
      ...
      if (strpos($img_path, 'http') === FALSE)
        ...
        $path = $img_path;
      if (isset($path) && !empty($path)) {
        $this->addElement('Image', 'cat_thumbnail_psignature', array(
          'src' => $path,
          'width' => 100,
          'height' => 100,
        ));
