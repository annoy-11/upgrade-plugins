...
<div class="epetition_edit_location_popup">
...
<script type="text/javascript">
  ...
  sesJqueryObject('#ses_location_data_list').html('<?php echo $this->epetition->location; ?>');
  sesJqueryObject('#ses_location-wrapper').css('display','none');
  <?php if($this->type == 'epetition_location'){ ?>
  ...
  sesJqueryObject( window ).load(function() {
      editSetMarkerOnMapListPetition();
  });
</script>