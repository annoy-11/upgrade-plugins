 ...
 * @version    $Id: _formEditImage.tpl 2019-11-07 00:00:00 socialnetworking.solutions $
...
<?php if ($this->subject()->photo_id !== null): ?>
  ...
  ?>
    ...
    <br/>
    <div style="display:none;" id="psignature-thumbnail" class="psignature-thumbnail">
      <?php echo $this->itemPhoto($this->subject(), 'thumb.icon', "", array('id' => 'psignatureimage')) ?>
    </div>
    ...
    <script type="text/javascript">
        ...
        var lassoStart = function () {
            if (!orginalThumbSrc) orginalThumbSrc = $('psignatureimage').src;
            ...
            $('psignatureimage').src = $('lassoImg').src;
            //$('psignature-thumbnail').innerHTML = '<img id="psignatureimage" src="'+sourceImg+'"/>';
        ...
        var lassoCancel = function () {
            $('psignature-thumbnail').innerHTML = '<img id="psignatureimage" src="' + orginalThumbSrc + '"/>';
