 ...
 * @version    $Id: view.tpl 2019-11-07 00:00:00 socialnetworking.solutions $
...
<div class="sesbasic_view_stats_popup">
  ...
  <table>
    ...
    <?php } ?>
    <?php if(isset($this->item->location) && Engine_Api::_()->getApi('settings', 'core')->getSetting('epetition_enable_location', 1)){ ?>
    <tr>
