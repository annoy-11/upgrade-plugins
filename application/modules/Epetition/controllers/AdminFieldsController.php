 ...
 * @version    $Id: AdminFieldsController.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Epetition_AdminFieldsController extends Fields_Controller_AdminAbstract
{
  protected $_requireProfileType = true;
  protected $_fieldType = 'epetition';
  ...
  public function indexAction()
  {
    ...
    $this->view->subNavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('epetition_admin_categories', array(), 'epetition_admin_main_subfields');
    parent::indexAction();
  }
  ...
  public function fieldEditAction()
  {
    ...
    if ($linkCount >= 2) {
      $form->addNotice($this->view->translate(array(
        ...
        $linkCount - 1
      ), $this->view->locale()->toNumber($linkCount - 1)));
    }
  ...
  public function typeCreateAction()
  {
    ...
    // Create form
    $this->view->form = $form = new Epetition_Form_Admin_Settings_Type();
    ...
    if ($form->getValue('duplicate') != 'null' && $form->getValue('duplicate')) {
      // Create New Option in engine4_epetition_contactus_fields_options
      ...
      $field_meta_array = $db->select()
        ->from('engine4_epetition_fields_meta')
  ...
  public function typeDeleteAction()
  {
    ...
    if (!empty($option_id)) {
      Engine_Api::_()->getDbtable('categories', 'epetition')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));
    }
