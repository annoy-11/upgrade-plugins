 ...
 * @version    $Id: Photos.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Epetition_Model_DbTable_Photos extends Engine_Db_Table
{
  protected $_rowClass = 'Epetition_Model_Photo';
  ...
  public function getPhotoSelect($params = array())
  {
    ...
    if (!empty($params['album']) && $params['album'] instanceof Epetition_Model_Album) {
