 ...
 * @version    $Id: Photo.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Epetition_Model_Photo extends Core_Model_Item_Collectible
{

  protected $_parent_type = 'epetition_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'epetition_album';
  ...
  {
    return Engine_Api::_()->getItem('epetition_album', $this->album_id);
  }
  ...
  public function getAlbumPhotoUrl($type = null)
  {
    ...
    if (!$photo_id) {
      return 'application/modules/Epetition/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
  ...
  public function getEpetition()
  {
    return Engine_Api::_()->getItem('epetition', $this->epetition_id);
  ...
  {
    return $this->getParent('epetition');
  }
  ...
  public function setPhoto($photo)
  {
    if ($photo instanceof Zend_Form_Element_File) {
      ...
      throw new Epetition_Model_Exception('invalid argument passed to setPhoto');
    }
  ...
  protected function _postDelete()
  {
    ...
    try {
      ...
      $petitionItem = Engine_Api::_()->getItem("epetition", $this->epetition_id);
      if ((int)$album->photo_id == (int)$this->getIdentity()) {
        if ($this->getNextCollectible())
          $album->photo_id = $this->getNextCollectible()->getIdentity();
        $album->save();
      }
      if (isset($petitionItem)) {
        $photoItem = Engine_Api::_()->getItem("epetition_photo", $petitionItem->photo_id);
        if (!$photoItem) {
          $petitionItem->photo_id = 0;
          $petitionItem->save();
        }
      }
    } catch (Exception $e) {
