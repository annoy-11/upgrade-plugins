 ...
 * @version    $Id: Album.php 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */


class Epetition_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'epetition';

  protected $_owner_type = 'epetition';

  protected $_children_types = array('epetition_photo');

  protected $_collectible_type = 'epetition_photo';

    public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'epetition_specific_album',
        'reset' => true,
				'action'=>'view',
    ...
    if (empty($this->photo_id)) {
      $photoTable = Engine_Api::_()->getItemTable('epetition_photo');
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Epetition/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $epetitionPhoto ) {
      $epetitionPhoto->delete();
    }
