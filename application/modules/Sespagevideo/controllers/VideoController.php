...
class Sespagevideo_VideoController extends Core_Controller_Action_Standard {
  ...
  public function externalAction() {
    ...
    $this->view->rating_count = Engine_Api::_()->getDbtable('ratings', 'sespagevideo')->ratingCount($video->getIdentity(), 'pagevideo');
