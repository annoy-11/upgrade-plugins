...
class Sespagevideo_Form_Browsesearch extends Engine_Form {
  ...
  public function init() {
    parent::init();
		...
		if($this->getSearchFor() == 'video')
			$searchFor =$view->url(array('controller' => 'index', 'action' => 'browse','module'=>'sespagevideo'), 'sespagevideo_general', true);
    $this
            ->setAttribs(array(
                'id' => 'filter_form',
    ...
    $this->addElement('Button', 'submit', array(
		...
		$this->addElement('Dummy','loading-img-sespagevideo', array(
        'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="sespagevideo-category-widget-img" alt="Loading" />',
   ));
  }
