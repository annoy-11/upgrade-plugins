...
class Sespagevideo_Form_Edit extends Engine_Form {
  ...
  public function init() {
    ...
    if (Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable('seslock') && Engine_Api::_()->authorization()->getPermission($viewer, 'pagevideo', 'video_locked')) {
