...
<div class="sespagevideo_video_view_container clear sesbasic_clearfix sesbasic_bxs sespagevideo_external_video_preview sesbm">
  <?php if( $this->video->type == 3 ): ?>
    <div id="video_embed" class="sespagevideo_view_embed clear sesbasic_clearfix"></div>
  <?php else: ?>
  ...
  <?php endif; ?> 
<?php if(!$this->isMap){ ?>
  <div class="sespagevideo_external_video_btn_cont clear sesbasic_clearfix">   
    <h2 class="sespagevideo_view_title sesbasic_clearfix">
    ...
    <div class="sespagevideo_view_statics">
      <div id="album_rating" class="sesbasic_rating_star sespagevideo_view_rating">
    ...
    <div class="sespagevideo_view_meta sespagevideo_list_stats sesbasic_text_light clear sesbasic_clearfix">
    ...
    <?php /*
      <div class='sespagevideo_view_options sespagevideo_options_buttons'>
