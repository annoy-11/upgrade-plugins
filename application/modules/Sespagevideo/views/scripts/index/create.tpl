 ...
 * @version    $Id: create.tpl 2018-07-04 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    ...
    var validationUrl = '<?php echo $this->url(array('module' => 'sespagevideo', 'controller' => 'index', 'action' => 'validation'), 'default', true) ?>';
...
//       } 
        ...
        return;
				...
				<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo.direct.video', 0)){ 
...
<div class="tip"> <span> <?php echo $this->translate('You have already uploaded the maximum number of videos allowed.');?> <?php echo $this->translate('If you would like to upload a new video, please <a href="%1$s">delete</a> an old one first.', $this->url(array('action' => 'manage'), 'sespagevideo_general'));?> </span> </div>

<br/>

<?php else:?>

	<div class="sespagevideo_video_form">
