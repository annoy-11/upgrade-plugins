...
<div class="sespage_profile_tab_wrapper sespage_profile_videos sesbasic_bxs">
  ...
  <div class="sespage_profile_content_search sesbasic_clearfix">
    ...
    <?php if($this->allowVideo && $this->canUpload){ ?>
        ...
        <a class="sesbasic_button sesbasic_icon_add sespage_cbtn" href="<?php echo $this->url(array('module' => 'sespagevideo', 'action' => 'create', 'parent_id' => $this->parent_id), 'sespagevideo_general', true); ?>">
...
<?php if(!$this->is_ajax){ ?>
  ...
  <div class="sesbasic_view_type sesbasic_clearfix clear" style="display:<?php echo $this->bothViewEnable ? 'block' : 'none'; ?>;height:<?php echo $this->bothViewEnable ? '' : '0px'; ?>">
    ...
    <?php if(is_array($this->optionsEnable) && in_array('list',$this->optionsEnable)){ ?>
      ...
      <a href="javascript:;" rel="list" id="sespagevideo_list_view_<?php echo $randonNumber; ?>" class="listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list') { echo 'active'; } ?>" title="<?php echo $this->translate('List View') ; ?>"></a>

    <?php } ?>

    <?php if(is_array($this->optionsEnable) && in_array('grid',$this->optionsEnable)){ ?>

    	<a href="javascript:;" rel="grid" id="sespagevideo_grid_view_<?php echo $randonNumber; ?>" class="gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid') { echo 'active'; } ?>" title="<?php echo $this->translate('Grid View'); ?>"></a>

    <?php } ?>

    <?php if(is_array($this->optionsEnable) && in_array('pinboard',$this->optionsEnable)){ ?>

     	<a href="javascript:;" rel="pinboard" id="sespagevideo_pinboard_view_<?php echo $randonNumber; ?>" class="boardicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'pinboard') { echo 'active'; } ?>" title="<?php echo $this->translate('Pinboard View'); ?>"></a>
...
<?php if((isset($this->optionsListGrid['tabbed']) || $this->loadJs || isset($this->optionsListGrid['profileTabbed'])) && !$this->is_ajax){ ?>
  ...
  <div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear prelative">
    ...
    <ul class="sespagevideo_video_listing sesbasic_clearfix clear" id="tabbed-widget_<?php echo $randonNumber; ?>" style="min-height:50px;">
...
<?php } ?>
      ...
      <?php foreach( $this->paginator as $item ):
        ...
        if(isset($this->getVideoItem) && $this->getVideoItem == 'getVideoItem'){
         ...
         $oldItem = $item;
           ...
           $item = Engine_Api::_()->getItem('pagevideo', $item->video_id);

          else if(isset($item->resource_id))

           $item = Engine_Api::_()->getItem('pagevideo', $item->resource_id);

          else

           $item = Engine_Api::_()->getItem('pagevideo', $item->file_id);
      ...
      ?>
        ...
        <li class="sespagevideo_listing_in_grid2" style="width:<?php echo is_numeric($this->width_grid) ? $this->width_grid.'px' : $this->width_grid ?>;height:<?php echo is_numeric($this->height_grid) ? $this->height_grid.'px' : $this->height_grid ?>;">

          <div class="sespagevideo_listing_in_grid2_thumb sespagevideo_thumb sespagevideo_play_btn_wrap">
            ...
            <a href="<?php echo $href; ?>" data-url = "<?php echo $item->getType() ?>" class="sespagevideo_thumb_img">

              <span style="background-image:url(<?php echo $imageURL; ?>);"></span>

            </a>

            <?php  if($item->getType() == 'pagevideo') { ?>

            <a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sespagevideo_play_btn fa fa-play-circle sespagevideo_thumb_img">
            ...
            <?php if(isset($this->durationActive) && isset($item->duration) && $item->duration ): ?>
              ...
              <span class="sespagevideo_length">
           ...
           ?>
            ...
            <?php $watchLaterId = isset($watchlater_watch_id_exists) ? $watchlater_watch_id : $item->watchlater_id; ?>
              ...
              <a href="javascript:;" class="sespagevideo_watch_later_btn sespagevideo_watch_later <?php echo !is_null($watchLaterId)  ? 'selectedWatchlater' : '' ?>" title = "<?php echo !is_null($watchLaterId)  ? $this->translate('Remove from Watch Later') : $this->translate('Add to Watch Later') ?>" data-url="<?php echo $item->video_id ; ?>"></a>
            ...
            <?php } ?>
          		...
          		$urlencode = urlencode(((!empty($_SERVER["HTTPS"]) &&  strtolower($_SERVER["HTTPS"]) == 'on') ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . $item->getHref()); ?>
           		...
           		<div class="sespagevideo_thumb_btns"> 

              	<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo.enable.socialshare', 1) && isset($this->socialSharingActive)){ ?>
                ...
                if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 ){
                  ...
                  <?php $LikeStatus = Engine_Api::_()->sespagevideo()->getLikeStatusVideo($item->$getId,$item->getType()); ?>

                    <a href="javascript:;" data-url="<?php echo $item->$getId ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sespagevideo_like_<?php echo $itemtype; ?> <?php echo ($LikeStatus) ? 'button_active' : '' ; ?>"> <i class="fa fa-thumbs-up"></i><span><?php echo $item->like_count; ?></span></a>

                    <?php } ?>

                     <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo.enable.favourite', 1) && isset($this->favouriteButtonActive) && isset($item->favourite_count)){ ?>

                    <?php $favStatus = Engine_Api::_()->getDbtable('favourites', 'sespagevideo')->isFavourite(array('resource_type'=>$itemtype,'resource_id'=>$item->$getId)); ?>

                    <a href="javascript:;" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn sespagevideo_favourite_<?php echo $itemtype; ?> <?php echo ($favStatus)  ? 'button_active' : '' ?>"  data-url="<?php echo $item->$getId ; ?>"><i class="fa fa-heart"></i><span><?php echo $item->favourite_count; ?></span></a>
          ...
          <?php if(isset($this->titleActive) ){ ?>
            ...
            <div class="sespagevideo_listing_in_grid2_title_show sespagevideo_animation">
          ...
          <div class="sespagevideo_listing_in_grid2_info clear sespagevideo_animation">

          	<?php if(isset($this->titleActive) ){ ?>

            <div class="sespagevideo_listing_in_grid2_title">
            ...
            <?php if(isset($this->byActive)){ ?>
              ...
              <div class="sespagevideo_listing_in_grid2_date sespagevideo_list_stats sesbasic_text_light">
             ...
             <?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo_enable_location', 1)){ ?>

            	<div class="sespagevideo_listing_in_grid2_date sespagevideo_list_stats sespagevideo_list_location sesbasic_text_light">

                <span>

                  <i class="fa fa-map-marker"></i>

                  <a href="javascript:;" onclick="openURLinSmoothBox('<?php echo $this->url(array("module"=> "sespagevideo", "controller" => "index", "action" => "location",  "video_id" => $item->getIdentity(),'type'=>'video_location'),'default',true); ?>');return false;"><?php echo $item->location; ?></a>
            ...
            <div class="sespagevideo_listing_in_grid2_date sespagevideo_list_stats sesbasic_text_light">
              ...
              <?php } ?>
                ...
                <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo.enable.favourite', 1) && isset($this->favouriteActive) && isset($item->favourite_count)) { ?>
                ...
                <div class="sesvideo_listing_in_grid2_date sesbasic_text_light">
                  ...
                  <div class="sesvideo_listing_options_pulldown">
                    ...
                    <?php if($this->can_edit){ 
                      ...
                      echo $this->htmlLink(array('route' => 'sespagevideo_general','module' => 'sespagevideo','controller' => 'index','action' => 'edit','video_id' => $item->video_id), $this->translate('Edit Video')) ; 

                    } ?>

                    <?php if ($item->status !=2 && $this->can_delete){

                      echo $this->htmlLink(array('route' => 'sespagevideo_general', 'module' => 'sespagevideo', 'controller' => 'index', 'action' => 'delete', 'video_id' => $item->video_id), $this->translate('Delete Video'), array('onclick' =>'opensmoothboxurl(this.href);return false;'));
                ...
                <?php if($item->status == 0):?>
                   ...
                   <div class="tip">
                     ...
                     <span>
                      ...
                      <?php echo $this->translate('Video conversion failed. Please try %1$suploading again%2$s.', '<a href="'.$this->url(array('action' => 'create','module'=>'sespagevideo','controller'=>'index'),'default',true).'/type/3'.'">', '</a>'); ?>
                   ...
                   <div class="tip">
                     ...
                     <span>
                      ...
                      <?php echo $this->translate('Video conversion failed. Video format is not supported by FFMPEG. Please try %1$sagain%2$s.', '<a href="'.$this->url(array('action' => 'create','module'=>'sespagevideo','controller'=>'index'),'default',true).'/type/3'.'">', '</a>'); ?>
                   ...
                   <div class="tip">
                     ...
                     <span>
                      ...
                      <?php echo $this->translate('Video conversion failed. Audio files are not supported. Please try %1$sagain%2$s.', '<a href="'.$this->url(array('action' => 'create','module'=>'sespagevideo','controller'=>'index'),'default',true).'/type/3'.'">', '</a>'); ?>
                   ...
                   <div class="tip">
                     ...
                     <span>
                      ...
                      <?php echo $this->translate('Video conversion failed. You may be over the site upload limit.  Try %1$suploading%2$s a smaller file, or delete some files to free up space.', '<a href="'.$this->url(array('action' => 'create','module'=>'sespagevideo','controller'=>'index'),'default',true).'/type/3'.'">', '</a>'); ?>
        ...
        <li class="sespagevideo_listing_grid" style="width:<?php echo is_numeric($this->width_grid) ? $this->width_grid.'px' : $this->width_grid ?>;">

          <div class="sespagevideo_grid_thumb sespagevideo_thumb sespagevideo_play_btn_wrap" style="height:<?php echo is_numeric($this->height_grid) ? $this->height_grid.'px' : $this->height_grid ?>;">
          ...
          <div class="sespagevideo_grid_info clear">

          	<?php if(isset($this->titleActive) ){ ?>

            <div class="sespagevideo_grid_title">
            ...
            <?php if(isset($this->byActive)){ ?>
              ...
              <div class="sespagevideo_grid_date sespagevideo_list_stats sesbasic_text_light">
             ...
             <?php } ?>
              ...
              <?php if(isset($this->locationActive) && isset($item->location) && $item->location  && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo_enable_location', 1)){ ?>
            	...
            	<div class="sespagevideo_grid_date sespagevideo_list_stats sesbasic_text_light sespagevideo_list_location">
            ...
            <?php  if(isset($this->descriptiongridActive)){ ?>
              ...
              <div class="sespagevideo_list_des">
            ...
            <?php if(1){ ?>
              ...
              <?php if($this->can_edit  &&  $item->status !=2 && $this->can_delete && $item->owner_id == Engine_Api::_()->user()->getViewer()->getIdentity()) { ?>
                ...
                <div class="sespagevideo_grid_date sesbasic_text_light">

                  <span class="sespagevideo_list_option_toggle fa fa-ellipsis-v sesbasic_text_light"></span>

                  <div class="sespagevideo_listing_options_pulldown">
              ...
              <div class="sespagevideo_manage_status_tip">
        ...
        <?php }else if($this->view_type == 'list'){ ?>
        		...
        		<li class="sespagevideo_listing_list sesbasic_clearfix clear">

              <div class="sespagevideo_list_thumb sespagevideo_thumb sespagevideo_play_btn_wrap" style="height:<?php echo is_numeric($this->height_list) ? $this->height_list.'px' : $this->height_list ?>;width:<?php echo is_numeric($this->width_list) ? $this->width_list.'px' : $this->width_list ?>;">
            ...
            <div class="sespagevideo_list_info">

            	<?php  if(isset($this->titleActive)){ ?>

                <div class="sespagevideo_list_title">
              ...
              <?php if(isset($this->byActive)){ ?>
               ...
               <?php } ?>
            	...
            	<div class="sespagevideo_list_date sespagevideo_list_stats sesbasic_text_light sespagevideo_list_location">
            ...
            <?php } ?>
                ...
                <div class="sespagevideo_list_date sespagevideo_list_stats sesbasic_text_light">
                ...
                <div class="sespagevideo_options_buttons sespagevideo_list_options sesbasic_clearfix">
                  ...
                  <?php if($this->can_edit  &&  $item->status !=2 && $this->can_delete && $item->owner_id == Engine_Api::_()->user()->getViewer()->getIdentity()) { ?>
                    ...
                    <?php if($this->can_edit) { ?>
                    	...
                    	<a href="<?php echo $this->url(array('module' => 'sespagevideo', 'action' => 'edit', 'video_id' => $item->video_id), 'sespagevideo_general', true); ?>" class="sesbasic_icon_btn" title="<?php echo $this->translate('Edit Video'); ?>">
                    ...
                    <?php if ($item->status !=2 && $this->can_delete){ ?>
                   		...
                   		<a href="<?php echo $this->url(array('module' => 'sespagevideo', 'action' => 'delete', 'video_id' => $item->video_id), 'sespagevideo_general', true); ?>" class="sesbasic_icon_btn" title="<?php echo $this->translate('Delete Video'); ?>" onclick='opensmoothboxurl(this.href);return false;'>
        ...
        <?php }else if(isset($this->view_type) && $this->view_type == 'pinboard'){ ?>
              	...
              	<div class="sesbasic_pinboard_list_item sesbm">
                	...
                	<div class="sesbasic_pinboard_list_item_top sespagevideo_play_btn_wrap">

                  	<div class="sesbasic_pinboard_list_item_thumb">

                  		<a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sespagevideo_thumb_img">
            ...
            <?php } ?>
                 ...
                 <?php if(isset($this->enableCommentPinboardActive)){ ?>
                    ...
                    <?php //if((@$itemType != '')){ ?>
                    	...
                    	<?php echo Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesadvancedcomment') ? $this->action('list', 'comment', 'sesadvancedcomment', array('type' => $event->getType(), 'id' => $event->getIdentity(),'page'=>'')) : $this->action("list", "comment", "sesbasic", array("item_type" => 'pagevideo', "item_id" =>  $item->video_id,"widget_identity"=>$randonNumber)); ?>
              ...
              <div class="tip">
                ...
                <span>
                  ...
                  <?php if ($this->can_create):?>
                    ...
                    <?php echo $this->translate('Be the first to %1$spost%2$s one!', '<a href="'.$this->url(array('action' => 'create'), "sespagevideo_general").'">', '</a>'); ?>
   ...
   if((isset($this->optionsListGrid['paggindData']) || $this->loadJs) && $this->loadOptionData == 'pagging' && !isset($this->show_limited_data)){ ?>
 		 ...
 		 <?php echo $this->paginationControl($this->paginator, null, array("_pagging.tpl", "sespagevideo"),array('identityWidget'=>$randonNumber)); ?>
...
sesJqueryObject(document).on('click','.selectView_<?php echo $randonNumber; ?>',function(){
		...
		sesJqueryObject('#sespagevideo_grid_view_<?php echo $randonNumber; ?>').removeClass('active');

		sesJqueryObject('#sespagevideo_list_view_<?php echo $randonNumber; ?>').removeClass('active');

		sesJqueryObject('#sespagevideo_pinboard_view_<?php echo $randonNumber; ?>').removeClass('active');
      ...
      'url': en4.core.baseUrl + "widget/index/mod/sespagevideo/name/<?php echo $this->widgetName; ?>/openTab/" + defaultOpenTab,
		...
		if(valueTab){
			...
			if($('ses_pagging'))
			 ...
			 requestTab_<?php echo $randonNumber; ?> = new Request.HTML({
				...
				'url': en4.core.baseUrl+"widget/index/mod/sespagevideo/name/<?php echo $this->widgetName; ?>/openTab/"+valueTab,
 ...
 var searchParams<?php echo $randonNumber; ?> ;
  ...
  function viewMore_<?php echo $randonNumber; ?> (){
    ...
    requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
      ...
      'url': en4.core.baseUrl + "widget/index/mod/sespagevideo/name/<?php echo $this->widgetName; ?>/openTab/" + openTab_<?php echo $randonNumber; ?>,
      ...
      onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        if($('loading_images_browse_<?php echo $randonNumber; ?>'))
				...
				if($('loadingimgsespagevideo-wrapper'))

						sesJqueryObject('#loadingimgsespagevideo-wrapper').hide();
...
sesJqueryObject(document).on('click',function(){
	...
	sesJqueryObject('.sespagevideo_list_option_toggle').removeClass('open');
