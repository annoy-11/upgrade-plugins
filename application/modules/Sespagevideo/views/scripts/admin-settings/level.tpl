...
<?php include APPLICATION_PATH .  '/application/modules/Sespagevideo/views/scripts/dismiss_message.tpl';?>

<script type="text/javascript">
  var fetchLevelSettings = function(level_id) {
    window.location.href = en4.core.baseUrl + 'admin/sespagevideo/settings/level/id/' + level_id;
    //alert(level_id);
  }
</script>
