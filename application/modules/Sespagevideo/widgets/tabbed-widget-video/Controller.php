 ...
 */
class Sespagevideo_Widget_TabbedWidgetVideoController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $paginator = Engine_Api::_()->getDbTable('videos', 'sespagevideo')->getVideo($value);
    ...
    if ($is_ajax)
      ...
      if ($paginator->getTotalItemCount() <= 0) {
        $checkVideoCount = Engine_Api::_()->getDbTable('videos', 'sespagevideo')->countVideos();
