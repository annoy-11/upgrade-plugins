...
<div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">    
   ...
   <ul class="sespagevideo_cat_video_listing sesbasic_clearfix clear" id="tabbed-widget_<?php echo $randonNumber; ?>">
    ...
    <?php foreach($this->paginator as $key=>$video){  ?>
      ...
      <?php if(($this->paginator->getCurrentPageNumber() == 1 || $this->loadOptionData == 'pagging') && !$break && $totalCount >= $allowedLimit ){ ?>
        ...
        <div class="sesbasic_clearfix sesbasic_bxs clear">
      		...
      		<div class="sespagevideo_videolist_row clear sesbasic_clearfix">

      <?php } ?>

						<?php if($type == 1){ ?>

               <?php if(!$close){  ?><div class="sespagevideo_videolist_column_small floatL"> <?php } ?>

                    <div class="sespagevideo_cat_video_list">

                  <div class="sespagevideo_thumb">

                    <a href="<?php echo $href; ?>" data-url = "<?php echo $video->getType() ?>" class="sespagevideo_thumb_img">

                      <span class="sespagevideo_animation" style="background-image:url(<?php echo $imageURL; ?>);"></span>
                     ...
                     <?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive) || isset($this->hotLabelActive)){ ?>
                      ...
                      <div class="sespagevideo_cat_video_list_info sespagevideo_animation">

                        <div>

                          <div class="sespagevideo_cat_video_list_content">

                          <?php if(isset($this->titleActive)){ ?>

                            <div class="sespagevideo_cat_video_list_title">
                            ...
                            <div class="sespagevideo_cat_video_list_stats">
                            ...
                            <div class="sespagevideo_cat_video_list_stats sespagevideo_list_stats sesbasic_text_light">
                              ...
                              <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagevideo.enable.favourite', 1) && isset($this->favouriteActive) && isset($video->favourite_count)) { ?>
                            ...
                            <?php if(isset($this->watchnowActive)){ ?>
                             ...
                             <div class="sespagevideo_cat_video_list_button"><?php echo $this->translate('Watch now'); ?></div>
            ...
            <?php } ?>
             ...
             <div class="sespagevideo_videolist_column_big floatL">
     ...
     <?php if(($counter)%5 == 0){ ?>
      ...
      <?php }else{ ?>
   					   ...
   					   <li class="sespagevideo_cat_video_list" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
      ...
      <div class="tip">
        ...
        <span>
          ...
          <?php if (!$this->can_edit):?>
                    ...
                    <?php echo $this->translate('Be the first to %1$spost%2$s one in this category!', '<a href="'.$this->url(array('action' => 'create'), "sespagevideo_general").'">', '</a>'); ?>
...
function dynamicWidth(){
	...
	var objectClass = sesJqueryObject('.sespagevideo_cat_video_list_info');

	for(i=0;i<objectClass.length;i++){

			sesJqueryObject(objectClass[i]).find('div').find('.sespagevideo_cat_video_list_content').find('.sespagevideo_cat_video_list_title').width(sesJqueryObject(objectClass[i]).width());
