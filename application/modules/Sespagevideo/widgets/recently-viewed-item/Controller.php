...
class Sespagevideo_Widget_RecentlyViewedItemController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $params = array('type' => 'pagevideo', 'limit' => $limit, 'criteria' => $criteria);
		$this->view->res = true;
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('recentlyviewitems', 'sespagevideo')->getitem($params);
