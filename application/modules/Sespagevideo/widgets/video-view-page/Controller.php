...
class Sespagevideo_Widget_VideoViewPageController extends Engine_Content_Widget_Abstract {
    ...
    if ($showRating) {
      ...
      $this->view->ratedAgain = $rated;
		...
		if($viewer->getIdentity() != 0){
		  $this->view->resourceItem = $resourceItem = Engine_Api::_()->getItem('sespage_page', $video->parent_id);
