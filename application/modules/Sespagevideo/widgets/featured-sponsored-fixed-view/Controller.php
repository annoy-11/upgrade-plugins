 ...
 */
class Sespagevideo_Widget_FeaturedSponsoredFixedViewController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->socialshare_icon_limit = $this->_getParam('socialshare_icon_limit', 2);
	  ...
	  $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('videos', 'sespagevideo')->getVideo($value);
