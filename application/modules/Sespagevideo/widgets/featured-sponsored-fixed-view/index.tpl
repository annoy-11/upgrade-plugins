...
?>
<style>
#sespagevideo_heighted_view_<?php echo $randonNumber; ?> .sespagevideo_listing_in_grid{
	height:<?php echo str_replace(array('px','%'),'',$this->height).'px'; ?>;
}
#sespagevideo_heighted_view_<?php echo $randonNumber; ?> .sespagevideo_listing_in_grid:first-child{
	height:<?php echo str_replace(array('px','%'),'',$this->heightmain).'px'; ?>;
}
</style>
<div class="sespagevideo_heighted_view sesbasic_clearfix sesbasic_bxs" id="sespagevideo_heighted_view_<?php echo $randonNumber; ?>">
  <?php 
  if($this->categoryItem == 'chanels'){
    ...
    $photoURL = $item->getPhotoUrl('thumb.main'); ?>
      <div class="sespagevideo_listing_in_grid">
        <div class="sespagevideo_listing_in_grid_thumb sespagevideo_thumb sespagevideo_play_btn_wrap">
        <?php 
        ...
        <a class="<?php echo $item->getType() == 'pagevideo' ? 'sespagevideo_thumb_img' : 'sespagevideo_thumb_nolightbox' ?>" href="<?php echo $item->getHref(); ?>"> 
          ...
          <a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sesbasic_animation sespagevideo_play_btn fa fa-play-circle sespagevideo_thumb_img">
          ...
          <?php if(isset($this->featured) || isset($this->sponsored) || isset($this->hot)){ ?>
            <p class="sespagevideo_labels sesbasic_animation">
           ...
           <?php if(isset($this->watchlater) && (isset($item->watchlater_id)) && Engine_Api::_()->user()->getViewer()->getIdentity() != '0'){ ?>
              ...
              <a href="javascript:;" class="sespagevideo_watch_later_btn sesbasic_animation sespagevideo_watch_later <?php echo !is_null($watchLaterId)  ? 'selectedWatchlater' : '' ?>" title = "<?php echo !is_null($watchLaterId)  ? $this->translate('Remove from Watch Later') : $this->translate('Add to Watch Later') ?>" data-url="<?php echo $item->video_id ; ?>"></a>
          <?php } ?>
          <?php 
          ...
          <?php } ?>
            ...
            <?php if(isset($this->like) || isset($this->comment) || isset($this->view) || isset($this->title) || isset($this->rating) || isset($this->favouriteCount) || isset($this->downloadCount)  || isset($this->by) || isset($this->videoCount)){ ?>
              <div class="sespagevideo_listing_in_grid_info clear sesbasic_animation">
                <?php if(isset($this->title)) { ?>
                  <div class="sespagevideo_listing_in_grid_title">
                ...
                <?php if(isset($this->by)) { ?>
                  <div class="sespagevideo_listing_in_grid_date sespagevideo_list_stats sesbasic_text_light floatL">
                    <span>
                ...
                <div class="sespagevideo_listing_in_grid_date sespagevideo_list_stats sesbasic_text_light clear floatL">
