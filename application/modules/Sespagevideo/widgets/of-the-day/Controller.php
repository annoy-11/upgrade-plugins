 ...
 */
class Sespagevideo_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    $this->view->type = $type = $this->_getParam('ofTheDayType', 'pagevideo');
    ...
    $paginator = Engine_Api::_()->getDbTable('videos', 'sespagevideo')->getVideo(array('widgetName' => 'oftheday'));
