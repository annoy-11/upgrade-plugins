 ...
 */
class Sespagevideo_Widget_BrowseVideoController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    // Get videos
    $paginator = Engine_Api::_()->getDbTable('videos', 'sespagevideo')->getVideo(array_merge($value,array('search'=>1)));
