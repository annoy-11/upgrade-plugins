...
Composer.Plugin.Sespagevideo = new Class({
...
// 		}
    ...
    if (this.options.allowed == 1 && this.options.type != 'message' && this.options.myComputerCheck == 1){
      ...
      this.elements.previewDescription = new Element('div', {
        ...
        'html' : this._lang('To upload a video from your device, please use our <a href="'+en4.core.baseUrl+'sespagevideo/create/type/3">full uploader</a>.'),
        'style': 'display:none;'
      }).inject(this.elements.body);
    }
    else{
    if (this.options.allowed == 1 && this.options.type != 'message' && this.options.myComputerCheck == 1){
      ...
      this.elements.previewDescription = new Element('div', {
        'id' : 'compose-video-upload',
        'class' : 'compose-video-upload',
        'html' : this._lang('To upload a video from your computer, please use our <a href="'+en4.core.baseUrl+'sespagevideo/create/type/3">full     uploader</a>.'),
        'style': 'display:none;'
      }).inject(this.elements.body);
    }
  ...
  deactivate : function() {
    ...
    if (this.params.video_id)
      new Request.JSON({
        url: en4.core.basePath + 'sespagevideo/index/delete',
        data: {
          format: 'json',
