...
function initializeSesPageVideoMapList () {
  ...
  if(mapLoad){
	...
	if(mapLoad){
		google.maps.event.addDomListener(window, 'load', initializeSespageVideoMapList);
	}
}
...
sesJqueryObject(document).on('click','#openPageVideoInLightbox',function(){
	...
	videoURLsesbasic = videoURLsespagevideo;
	moduleName = 'sespagevideo';
	itemType = 'pagevideo';
	...
	var image = sesJqueryObject('#sespagevideo_image_video_url').attr('data-src');
...
function checkFunctionEmbed(){
	if( typeof flashembed == 'function'){
		//silence
		 ...
		 if(sesJqueryObject('.sespagevideo_attachment_info').length){
				var href = sesJqueryObject('.sespagevideo_attachment_info').find('a').attr('href');
...
sesJqueryObject(document).on('click','.sespagevideo_list_option_toggle',function(){
...
sesJqueryObject(document).on('click','.sespagevideo_watch_later',function(){
		var that = this;
		...
		if(sesJqueryObject(this).hasClass('selectedWatchlater')){
		 ...
		 (new Request.HTML({
      method: 'post',
      'url':  en4.core.baseUrl + 'sespagevideo/watchlater/add/',
      'data': {
        format: 'html',
...
function sespagevideo_like_favourite_data(element,functionName,itemType,likeNoti,unLikeNoti,className){
		...
		if(sesJqueryObject(element).hasClass('button_active')){
		 ...
		 (new Request.HTML({
      method: 'post',
      'url':  en4.core.baseUrl + 'sespagevideo/index/'+functionName,
      'data': {
        format: 'html',
...
sesJqueryObject(document).on('click','.sespagevideo_favourite_pagevideo',function(){
	sespagevideo_like_favourite_data(this,'favourite','pagevideo','<i class="fa fa-heart"></i><span>'+(en4.core.language.translate("Video added as Favourite successfully"))+'</span>','<i class="fa fa-heart"></i><span>'+(en4.core.language.translate("Video Unfavourited successfully"))+'</span>','sesbasic_favourites_notification');
});
sesJqueryObject(document).on('click','.sespagevideo_like_pagevideo',function(){
	sespagevideo_like_favourite_data(this,'like','pagevideo','<i class="fa fa-thumbs-up"></i><span>'+(en4.core.language.translate("Video Liked successfully"))+'</span>','<i class="fa fa-thumbs-up"></i><span>'+(en4.core.language.translate("Video Unliked successfully"))+'</span>','sesbasic_liked_notification');
});
sesJqueryObject(document).on("click", '.sespagevideo_thumb_img', function (e) {
