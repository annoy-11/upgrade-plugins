...
return array(
  array(
    'title' => 'SES - Page Videos Extension - Page Profile Videos',
    'description' => 'Displays a page\'s videos on page profile page. The recommended page for this widget is "Page Profile Page".',
    'category' => 'SES - Page Videos Extension',
    'type' => 'widget',
    'name' => 'sespagevideo.profile-videos',
    'autoEdit' => true,
    'adminForm' => 'Sespagevideo_Form_Admin_Settings_Profilevideos',
  ),
  array(
      'title' => "SES - Page Videos Extension - Owner's Photo",
      'description' => 'This widget display on "SES - Page Videos Extension - Video View Page".',
      'category' => 'SES - Page Videos Extension',
      'type' => 'widget',
      'autoEdit' => true,
      'name' => 'sespagevideo.owner-photo',
      'defaultParams' => array(
          'title' => '',
      ),
      'adminForm' => array(
		...
		array(
        'title' => 'SES - Page Videos Extension - Featured / Sponsored Videos Carousel',
		...
		array(
        'title' => 'SES - Page Videos Extension - Featured / Sponsored Videos Fixed View',
        'description' => "Disaplys Featured or Sponsored Carousel of Videos.",
        'category' => 'SES - Page Videos Extension',
        'type' => 'widget',
        'autoEdit' => true,
    ...
    array(
        'title' => 'SES - Page Videos Extension - Browse Videos Page Button',
        'description' => 'This widget displays a button clicking on which users will be redirected to the "SES - Page Videos Extension - Browse videos Page".',
        'category' => 'SES - Page Videos Extension',
        'type' => 'widget',
        'autoEdit' => true,
        'name' => 'sespagevideo.browse-video-button',
    ),
    array(
        'title' => 'SES - Page Videos Extension - Video Browse Search',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Popular / Featured / Sponsored Videos',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Recently Viewed Videos',
        ...
        'category' => 'SES - Page Videos Extension',
        'type' => 'widget',
        'name' => 'sespagevideo.recently-viewed-item',
        'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
								array(
    ...
    array(
        'title' => 'SES - Page Videos Extension - Video of the Day',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Quick AJAX based Search',
        'description' => 'Displays a quick search box to enable users to quickly search Videos of their choice.',
        'category' => 'SES - Page Videos Extension',
        'autoEdit' => true,
        'type' => 'widget',
        'name' => 'sespagevideo.search',
    ),

    array(
        'title' => 'SES - Page Videos Extension - Breadcrumb for Video View Page',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Tabbed Widget',
        ...
        'adminForm' => 'Sespagevideo_Form_Admin_Settings_Tabbed',
    ),

    array(
        'title' => 'SES - Page Videos Extension - Video Home No Video Message',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Video People Also Liked',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Other Videos From Member',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Similar Videos',
    ...
    array(
        'title' => 'SES - Page Videos Extension - People favourite Video',
        'description' => 'Placed on  a video\'s view page.',
        'category' => 'SES - Page Videos Extension',
        'type' => 'widget',
        'name' => 'sespagevideo.people-favourite-item',
        'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
                array(
    ...
    array(
        'title' => 'SES - Page Videos Extension - People like Video',
        'description' => 'Placed on  a video\'s view page.',
        'category' => 'SES - Page Videos Extension',
        'type' => 'widget',
        'name' => 'sespagevideo.people-like-item',
        'autoEdit' => true,
        'adminForm' => array(
            'elements' => array(
                array(
    ...
    array(
        'title' => 'SES - Page Videos Extension - Video View Page',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Popularity Videos Widget',
        'description' => 'Displays a videos according to popularity.',
        'category' => 'SES - Page Videos Extension',
        'type' => 'widget',
        'name' => 'sespagevideo.popularity-videos',
        'adminForm' => array(
        'elements' => array(
                array(
                    'Select',
    ...
    array(
        'title' => 'SES - Page Videos Extension - Video Browse Page Widget',
