 ...
 */
class Sespage_Form_BannerSearch extends Engine_Form {
  ...
  public function init() {
    $params = Engine_Api::_()->sespage()->getWidgetParams($this->getWidgetId());
    $show_criterias = $params['show_criteria'];
    $view = Zend_Registry::isRegistered('Zend_View') ? Zend_Registry::get('Zend_View') : null;
    $identity = $view->identity;
    $params = Engine_Api::_()->sespage()->getWidgetParams($identity);
    $this->setAttribs(array('id' => 'filter_form', 'class' => 'sespage_banner_search_form'))->setMethod('GET');
    $this->setAction($view->url(array('action' => 'browse'), 'sespage_general', true));
    ...
    if (in_array('location', $show_criterias)) {
      ...
      if (Engine_Api::_()->getApi('settings', 'core')->getSetting('sespage_enable_location', 1)) {
