 ...
 * @version    $Id: Tabbed.php  2018-04-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sespage_Form_Admin_Tabbed extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('MultiCheckbox', "enableTabs", array(
        ...
        'multiOptions' => array(
            'list' => 'List View',
            'advlist' => 'Advance List View',
            'grid' => 'Grid View',
            'simplegrid' => 'Simple Grid View',
    ...
    $this->addElement('Select', "openViewType", array(
        'label' => "Choose Default View Type (apply if more than 1 view type is selected.) (Note: In \"Tabbed widget for Manage Pages\" only List View will work.)",
        'multiOptions' => array(
            'list' => 'List View',
            'advlist' => 'Advance List View',
            'grid' => 'Grid View',
...
',
    ...
    $this->addElement('MultiCheckbox', "show_criteria", array(
        ...
        'multiOptions' => array(
            ...
            'rating' => 'Rating Star (Note: This setting will work only when you have installed page review extension on your website.)',
    ...
    $this->addElement('Select', "show_limited_data", array(
        'label' => 'Show only the number of pages entered in the setting for Count of each view. [If you choose No, then you can choose how do you want to show more pages in this widget.]',
        'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
