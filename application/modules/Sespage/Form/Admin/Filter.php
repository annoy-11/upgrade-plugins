 ...
 */
class Sespage_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbTable('categories', 'sespage')->getCategory(array('column_name' => '*'));
    ...
    if (SESPAGEPACKAGE == 1) {
      $packages = Engine_Api::_()->getDbTable('packages', 'sespagepackage')->getPackage(array('default' => true));
