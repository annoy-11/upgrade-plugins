 ...
 */
class Sespage_Form_Admin_Categorywidget extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($banner_options) > 1) {
      $this->addElement('Select', 'sespage_categorycover_photo', array(
          'label' => 'Page Category Default Cover Photo',
          'description' => 'Choose a default cover photo for the page categories on your website. [Note: Add a new photo from the "File & Media Manager" section. For default cover photo, leave the field blank.]',
    ...
    $this->addElement('Select', "show_popular_pages", array(
        'label' => "Do you want to show popular pages in this widget",
    ...
    $this->addElement('Text', "title_pop", array(
        'label' => "Enter the title for pages section.",
        'value' => 'Popular Pages',
    ));
    ...
    $this->addElement('Text', 'height_advgrid', array(
        'label' => 'Enter the height of page (in pixels)',
        'value' => '180',
        'validators' => array(
            array('Int', true),
            array('GreaterThan', true, array(0)),
