 ...
 */
class Sespage_Form_Dashboard_Notification extends Engine_Form {

  public function init() {
    $this->setTitle('Manage Notifications')
            ->setAttrib('id', 'manage_page')
            ->setDescription('Here, you can select the activities on your Page for which you want to receive notifications.')
            ->setMethod("POST")
    ...
    $notification['content_create_user'] = "New Photo Album created in Page";
    $notification['new_mention_page'] = "New Mention of Page";
    $notification['new_tagging_page'] = "New Tagging of Page";
    //$notification['new_review'] = "New Reviews";
    $notification['new_comment'] = "New Comments on Page Directory post";
    ...
    //$notification['new_share'] = "New Shares on Page Directory posts";
