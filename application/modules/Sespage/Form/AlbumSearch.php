 ...
 */
class Sespage_Form_AlbumSearch extends Engine_Form {
  ...
  public function init() {
    ...
    $searchFor = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'sespage','controller'=>'album','action'=>'browse'));
    ...
    $this->addElement('Button', 'submit', array(
      ...
      'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="sespage-category-widget-img" alt="Loading" />',
   ));
  }
}