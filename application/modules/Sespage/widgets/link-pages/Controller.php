...
class Sespage_Widget_LinkPagesController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    $pageId = (isset($_POST['page_id']) ? $_POST['page_id'] : 0);
    if ($pageId) {
      $subject = Engine_Api::_()->getItem('sespage_page', $pageId);
    } else {
    ...
    $this->view->page_id = $subject->page_id;
    ...
    $this->view->widgetName = 'link-pages';
    ...
    $value['search'] = 1;
    $value['draft'] = "1";
    $value['link_page_id'] = $subject->page_id;
