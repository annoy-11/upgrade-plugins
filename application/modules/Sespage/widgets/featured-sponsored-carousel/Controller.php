 ...
 */
class Sespage_Widget_FeaturedSponsoredCarouselController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = Engine_Api::_()->getDbTable('pages', 'sespage')->getPageSelect($value);
