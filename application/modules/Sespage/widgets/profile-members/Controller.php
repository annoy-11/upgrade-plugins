 ...
 */
class Sespage_Widget_ProfileMembersController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!empty($page->member_title_singular))
      $this->view->singularTitle = $page->member_title_singular;
    $this->view->pluralTitle = 'members';
    if (!empty($page->member_title_plural))
      $this->view->pluralTitle = $page->member_title_plural;
