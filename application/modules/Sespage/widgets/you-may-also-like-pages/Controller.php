...
class Sespage_Widget_YouMayAlsoLikePagesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = $results = Engine_Api::_()->getDbTable('pages', 'sespage')->getPageSelect($value);
