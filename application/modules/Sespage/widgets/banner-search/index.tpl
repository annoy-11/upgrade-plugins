...
?>
<div class="sespage_banner_search_wrapper sesbasic_clearfix sesbasic_bxs _iscategorybox <?php if($this->params['show_full_width'] == 'yes'):?>isfullwidth<?php endif;?>">
  <section class="_mainsection" style="height:<?php echo is_numeric($this->params['height_image']) ? $this->params['height_image'].'px' : $this->params['height_image'];?>">
    <div class="_mainsectionimg" style="height:<?php echo is_numeric($this->params['height_image']) ? $this->params['height_image'].'px' : $this->params['height_image']?>;background-image:url(application/modules/Sespage/externals/images/search-banner-bg.jpg);">
    ...
    <section class="_catsection">
      <div class="_cont">
        ...
        <div class="_categorycontainer">
          <div class="sespage_banner_categories sespage_banner_cat_<?php echo $this->identity;?>">
            <?php foreach($this->categories as $category):?>
              <div class="_catitem _isthumb">
                <a href="<?php echo $category->getHref();?>">
                  ...
                  <?php else:?>
                    <span class="sesbasic_animation" style="background-image:url(application/modules/Sespage/externals/images/category-thumb.png);"></span>
                  <?php endif;?>
                  <div class="_catitem_holder">
                    ...
                    <?php else:?>
                      <i class="_caticon"><img src="application/modules/Sespage/externals/images/category-icon.png" /></i>
                    <?php endif;?>
...
<script type="application/javascript">
  sespageJqueryObject('.sespage_banner_cat_<?php echo $this->identity;?>').owlCarousel({
    nav :true,
    loop:false,
    items:5,
    autoplay:false,
