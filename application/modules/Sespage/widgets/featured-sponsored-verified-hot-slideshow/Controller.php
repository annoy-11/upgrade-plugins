...
class Sespage_Widget_FeaturedSponsoredVerifiedHotSlideshowController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->pages = $pages = Engine_Api::_()->getDbTable('pages', 'sespage')->getPageSelect($value);
    if (count($pages) <= 0)
