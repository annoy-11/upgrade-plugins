 ...
 */
class Sespage_Widget_AlbumTabbedWidgetController extends Engine_Content_Widget_Abstract {
    ...
    $paginator->setCurrentPageNumber($page);
		if($is_ajax)
			...
			if( $paginator->getTotalItemCount() <= 0 ) {
				...
				$checkAlbumCount = Engine_Api::_()->getDbTable($albumPhotoOption.'s', 'sespage')->$nameFunction();
