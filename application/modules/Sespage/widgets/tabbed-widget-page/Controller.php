...
class Sespage_Widget_TabbedWidgetPageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
      ...
      foreach ($defaultOptionsArray as $key => $defaultValue) {
        ...
        if ($this->_getParam($defaultValue . '_label'))
          ...
          if ($defaultValue == 'open')
            $valueLabel = 'Open Pages';
          elseif ($defaultValue == 'close')
            $valueLabel = 'Closed Pages';
    ...
    $this->view->widgetName = 'tabbed-widget-page';
