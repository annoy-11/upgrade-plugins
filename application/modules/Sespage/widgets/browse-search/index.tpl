...
?>
  ...
  <?php $class = '.sespage_page_listing';?>
  <?php if($actionName == 'all-results'): ?>
  <?php $pageName = 'advancedsearch_index_sespage_page';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php  elseif($actionName == 'manage'):?>
  <?php $pageName = 'sespage_index_manage';?>
  <?php $widgetName = 'sespage.manage-pages';?>
  <?php elseif($actionName == 'pinboard'):?>
  <?php $pageName = 'sespage_index_pinboard';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php elseif($actionName == 'featured'):?>
  <?php $pageName = 'sespage_index_featured';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php elseif($actionName == 'sponsored'):?>
  <?php $pageName = 'sespage_index_sponsored';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php elseif($actionName == 'verified'):?>
  <?php $pageName = 'sespage_index_verified';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php elseif($actionName == 'browse-locations'):?>
  <?php $pageName = 'sespage_index_browse-locations';?>
  <?php $widgetName = 'sespage.browse-locations-pages';?>
  <?php elseif($actionName == 'top-pages'):?>
  <?php $pageName = 'sespage_index_top-pages';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php else:?>
  <?php $pageName = 'sespage_index_browse';?>
  <?php $widgetName = 'sespage.browse-pages';?>
  <?php endif;?>
...
<script type="application/javascript">
  function showHideOptions<?php echo $this->identity; ?>(display){
    var elem = sesJqueryObject('.sespage_widget_advsearch_hide_<?php echo $this->identity; ?>');
    if(elem.length == 0){
