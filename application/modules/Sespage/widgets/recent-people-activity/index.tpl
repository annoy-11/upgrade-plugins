...
<div class="sesbasic_sidebar_block sesbasic_clearfix sesbasic_bxs">
  ...
  <?php if(isset($this->likeActive)):?>
    <?php if(count($this->likeMembers)):?>
      <div class="sespage_people_like_field sesbasic_clearfix">
        <div class="sespage_people_like_title sesbasic_clearfix">
        ...
        <ul class="sesbasic_clearfix">
          <?php foreach($this->likeMembers as $member):?>
            ...
            <li class="sespage_people_like_list">
              <div class="sespage_people_like_list_img" style="height:<?php echo is_numeric($this->params['height'])? $this->params['height'].'px':$this->params['height'];?>;width:<?php echo is_numeric($this->params['width'])? $this->params['width'].'px':$this->params['width'];?>;">
...
<script type='text/javascript'>
  function getLikeData(value){
    if(value){
      url = en4.core.staticBaseUrl+'sespage/ajax/like-page/page_id/'+value;
  ...
  function getFavouriteData(value){
    if(value){
      url = en4.core.staticBaseUrl+'sespage/ajax/favourite-page/page_id/'+value;
      openURLinSmoothBox(url);	
      return;
    }
  } 
  function getFollowerData(value){
    if(value){
      url = en4.core.staticBaseUrl+'sespage/ajax/follow-page/page_id/'+value;
      openURLinSmoothBox(url);	
      return;
    }
  } 
