...
<?php } ?>
    <ul style="margin-bottom:10px;">
      ...
      <?php if(SESPAGEPACKAGE == 1):?>
        <div class="sespage_manage_package_btn">
          <a href="<?php echo $this->url(array('action' => 'package'),'sespage_general',true);?>" class="sesbasic_link_btn"><?php echo $this->translate("My Packages"); ?></a>
        </div>
      <?php endif;?>
     </div>
