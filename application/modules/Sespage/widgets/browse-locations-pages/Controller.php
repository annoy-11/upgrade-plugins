 ...
 */
class Sespage_Widget_BrowseLocationsPagesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_ajax) {
      $defaultSearchParams = Engine_Api::_()->sespage()->getSearchWidgetParams($widgetId);
    ...
    $this->view->widgetName = 'browse-locations-pages';
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('pages', 'sespage')->getPagePaginator($params);
