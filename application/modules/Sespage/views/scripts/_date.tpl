 ...
 * @version    $Id: _date.tpl  2018-04-23 00:00:00 SocialEngineSolutions $
...
<?php $date = new Zend_Date(strtotime($page->creation_date), false, $locale);?>
<span class="_date sesbasic_text_light" title=""><?php echo $date->toString('jS M');?>,&nbsp;<?php echo date('Y', strtotime($page->creation_date));?></span>