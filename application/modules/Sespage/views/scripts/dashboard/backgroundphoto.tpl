...
<?php } ?>
  <div class="sespage_dashboard_form sespage_dashboard_photo_form">
...
<script type="application/javascript">
  sesJqueryObject  (document).ready(function() {
	...
	sesJqueryObject('#page_main_photo_preview-element').append('<div id="removeimage-wrapper">'+removehtml+'</div>');
...
<?php
if ($this->page->background_photo_id !== null && $this->page->background_photo_id){ 
 $backgroundImage =	Engine_Api::_()->storage()->get($this->page->background_photo_id, '')->getPhotoUrl();?>
 ShowhandleFileBackgroundUpload('<?php echo $backgroundImage ?>','page_main_photo_preview');
<?php }else{ ?>
sesJqueryObject  (document).ready(function()
{
