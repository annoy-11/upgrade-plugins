...
<script type="text/javascript">
  ...
  function makeEditorRich() {
    ...
    <div class="sespage_dashboard_content_btns">
      <a href="<?php echo $this->url(array('page_id' => $this->page->custom_url,'action'=>'post-announcement'), 'sespage_dashboard', true); ?>" class="sessmoothbox sesbasic_button"><i class="fa fa-bullhorn"></i><span><?php echo $this->translate("Post New Announcement");?></span></a>
    </div>  
  <?php if($this->paginator->getTotalItemCount()!=0): ?>
    <div class="sespage_dashboard_results"><?php echo $this->translate('%d announcements total', $this->paginator->getTotalItemCount()) ?></div>
  <?php endif;?>
  <?php echo $this->paginationControl($this->paginator); ?>
<?php if( count($this->paginator) ): ?>
  <div class="sespage_dashboard_table">
