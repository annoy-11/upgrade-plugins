 ...
 * @version    $Id: open-hours.tpl  2018-04-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespage/externals/styles/jquery.timepicker.min.css'); ?>
...
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sespage/externals/scripts/jquery.timepicker.min.js'); ?>
...
?><?php $hoursData = $this->hoursData; ?>
  <div class="sespage_db_manage_hours sespage_dashboard_form">
  	<form class="global_form" method="post">
    	<div>
          ...
          <div class="form-elements">
            ...
            <div class="form-wrapper sespage_choose_day_wrapper">
...
sesJqueryObject('input[type=radio][name=hours]').change(function() {
  ...
  if(value != "selected"){
     sesJqueryObject('.sespage_choose_day_wrapper').hide();
  }else{
     sesJqueryObject('.sespage_choose_day_wrapper').show();
  }
});
...
sesJqueryObject(document).on('click','.addbtn',function(e){
  ...
  parent.append(html);
  sespageTimePickerJqueryObject('input.timepicker').timepicker();
});
