...
<?php } ?>
  <div class="sespage_dashboard_content_header"> 
    <h3><?php echo $this->translate("Page Locations")?></h3>
    <p><?php echo $this->translate("Here, you can add multiple locations to your Page. You can configure each location by entering the address, pincode, photos for each location, etc. You can also make any location as Primary location for your Page.");?></p> 
  </div>
  <?php //if(Engine_Api::_()->getApi('settings', 'core')->getSetting('ses.mapApiKey', '')){ ?>
  <div class="sespage_dashboard_content_btns">
    <a href="<?php echo $this->url(array('page_id' => $this->page->custom_url,'action'=>'add-location'),'sespage_dashboard',true);?>" class="sessmoothbox sesbasic_button"><i class="fa fa-plus"></i><span><?php echo $this->translate("Add Location");?></span></a>
  </div>
  <?php //}else{ ?>
<!--    <div class="tip">
      ...
      <div class="sespage_locations_item sesbasic_clearfix">
        ...
        <div class="_cont">
          <div class="_title sesbasic_clearfix">
            ...
            <span>
              <a href="<?php echo $this->url(array('page_id' => $this->page->custom_url,'location_id' => $location->location_id,'action'=>'edit-location'),'sespage_dashboard',true);?>" title='<?php echo $this->translate("Edit Location");?>' class="sessmoothbox fa fa-pencil"></a>
              <a href="<?php echo $this->url(array('page_id' => $this->page->custom_url,'location_id' => $location->location_id,'action'=>'delete-location'),'sespage_dashboard',true);?>" title='<?php echo $this->translate("Delete Location");?>' class="sessmoothbox fa fa-trash"></a>
              <a href="<?php echo $this->url(array('page_id' => $this->page->custom_url,'location_id' => $location->location_id,'action'=>'add-photos'),'sespage_dashboard',true);?>" title='<?php echo $this->translate("Add Photos");?>' class="sessmoothbox fa fa-plus"></a>
            </span>
          </div>
          <div class="_info">
            <div class="_infof">
          ...
          <div class="_photos sesbasic_clearfix sesbasic_horrizontal_scroll">
              ...
              <?php foreach($locationPhotos as $photo):?>
                <div class="_thumb" id="sespage_locationphoto_<?php echo $photo->locationphoto_id;?>">
                  ...
                  <a href="javascript:void(0);" onclick="removePageLcationPhoto(<?php echo $photo->locationphoto_id;?>);" class="fa fa-times"></a>
                </div>
              <?php endforeach;?>
            </div>
          </div>
