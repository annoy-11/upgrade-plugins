...
<br />	
<form id="sespage_change_owner" action="<?php echo $this->url(array('module' => 'sespage', 'controller' => 'manage','action'=>'change-owner','id' => $this->page->page_id),'admin_default', true); ?>" method="post">
