 ...
 */
class Sespage_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'sespage_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'sespage_album';

  public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'sespage_photo_view',
        'reset' => true,
        'controller' => 'photo',
        'action' => 'view',
  ...
  public function getAlbum() {
    return Engine_Api::_()->getItem('sespage_album', $this->album_id);
  }
  
  public function getPage() {
    return Engine_Api::_()->getItem('sespage_page', $this->page_id);
  }
  ...
  public function getAuthorizationItem() {
    return $this->getParent('sespage_page');
  }
