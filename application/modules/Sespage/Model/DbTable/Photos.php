 ...
 */
class Sespage_Model_DbTable_Photos extends Engine_Db_Table {

  protected $_rowClass = 'Sespage_Model_Photo';
	public function getPhotoSelect($params = array())
  {
    ...
    if( !empty($params['album']) && $params['album'] instanceof Sespage_Model_Album ) {
