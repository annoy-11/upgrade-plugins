 ...
 */
class Sespage_Model_Album extends Core_Model_Item_Collection {

  protected $_parent_type = 'sespage_page';
  protected $_owner_type = 'sespage_page';
  protected $_children_types = array('sespage_photo');
  protected $_collectible_type = 'sespage_photo';
  ...
  public function getAuthorizationItem() {
    return Engine_Api::_()->getItem('sespage_page',$this->page_id) ? $this->getParent('sespage_page') : false;
  }
  ...
  protected function _delete() {
    ...
    foreach ($photoTable->fetchAll($photoSelect) as $pagePhoto) {
      $pagePhoto->delete();
    }
  ...
  public function getPhotoUrl($type = null,$status = false) {
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sespage/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
    ...
    if (!$file_id) {
      ...
      if (!$file_id) {
        if(!$status)
          return 'application/modules/Sespage/externals/images/nophoto_album_thumb_normal.pngc=direct';
        else
          return '';
      }
    }
