  ...
  public function indexAction() {
    ...
    if ($this->view->uploadDefaultCover) {
      ...
      $this->view->defaultCoverMessage = Zend_Registry::get('Zend_Translate')->_(sprintf(
        'Here, you can upload and set default event cover photo for ' . $levelsAssoc[$this->view->level_id] .
          '. %s to go to event\'s profile page.',
        "<a href='". $event->getHref() . "'>Click here</a>"
      ));
    }
