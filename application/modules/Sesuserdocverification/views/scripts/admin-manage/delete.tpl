...
<form method="post" class="global_form_popup">
  <div>
    <h3><?php echo $this->translate("Delete Document Type?") ?></h3>
    <p>
      <?php echo $this->translate("Are you sure that you want to delete this document type? It will not be recoverable after being deleted.") ?>
    </p>
    <br />
    <p>
