...
class Sesariana_NotificationsController extends Core_Controller_Action_Standard {
  ...
  public function pulldownAction() {
    ...
    $this->view->notifications = $notifications = Engine_Api::_()->getDbtable('notifications', 'sesariana')->getNotificationsPaginator($viewer);
    ...
    Engine_Api::_()->getApi('message', 'sesariana')->setUnreadNotification($viewer);
