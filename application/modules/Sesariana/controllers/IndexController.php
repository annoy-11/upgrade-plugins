 ...
 * @version    $Id: IndexController.php 2016-11-22 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesariana_IndexController extends Core_Controller_Action_Standard {
  ...
  public function inboxAction() {
    ...
    Engine_Api::_()->getApi('message', 'sesariana')->setUnreadMessage($viewer);
  }
  ...
  public function friendshipRequestsAction() {
    ...
    $this->view->friendRequests = $newFriendRequests = Engine_Api::_()->getDbtable('notifications', 'sesariana')->getFriendrequestPaginator($viewer);
    $newFriendRequests->setCurrentPageNumber($this->_getParam('page'));
    Engine_Api::_()->getApi('message', 'sesariana')->setUnreadFriendRequest($viewer);
  ...
  public function newMessagesAction() {
    $this->view->messageCount = Engine_Api::_()->getApi('message', 'sesariana')->getMessagesUnreadCount(Engine_Api::_()->user()->getViewer());
  }
