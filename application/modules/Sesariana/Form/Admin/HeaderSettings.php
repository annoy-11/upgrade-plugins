 ...
 * @version    $Id: HeaderSettings.php 2016-11-22 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesariana_Form_Admin_HeaderSettings extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Select', 'sesariana_logo', array(
        ...
        'escape' => false,
        'value' => $settings->getSetting('sesariana.logo', ''),
    ));
    $this->sesariana_logo->addDecorator('Description', array('placement' => Zend_Form_Decorator_Abstract::PREPEND, 'escape' => false));

    
    $this->addElement('MultiCheckbox', 'sesariana_header_loggedin_options', array(
        ...
        'value' => $settings->getSetting('sesariana.header.loggedin.options',array('search','miniMenu','mainMenu','logo')),
    ));
    
    $this->addElement('MultiCheckbox', 'sesariana_header_nonloggedin_options', array(
        ...
        'value' => $settings->getSetting('sesariana.header.nonloggedin.options', array('search','miniMenu','mainMenu','logo')),
    ));
      
      $this->addElement('Select', 'sesariana_header_design', array(
        ...
        'value' =>  Engine_Api::_()->sesariana()->getContantValueXML('sesariana_header_design'),
    ));
    
    $this->addElement('Select', 'sesariana_header_transparent', array(
      ...
      'value' => $settings->getSetting('sesariana.header.transparent', 0),
    ));

    $this->addElement('Text', 'sesariana_limit', array(
        'label' => 'Menu Count',
        'description' => 'Choose number of menu items to be displayed before â€œMoreâ€? dropdown menu occurs?',
        'value' => $settings->getSetting('sesariana.limit', 4),
    ));

    $this->addElement('Text', 'sesariana_moretext', array(
        'label' => '"More" Button Text',
        'description' => 'Enter "More" Button Text',
        'value' => $settings->getSetting('sesariana.moretext', 'More'),
    ));
    $this->addElement('Select', 'sesariana_submenu', array(
        'label' => 'Show Plugin Navigation Menu',
        'description' => 'Do you want to show plugin navigation menu for the Main Menus?',
        'multiOptions'=>array('1'=>'Yes','0'=>'No'),
        'value' => $settings->getSetting('sesariana.submenu', '1'),
    ));
    
    $this->addElement('Select', 'sesariana_sidepanel_effect', array(
        ...
        'value' =>  Engine_Api::_()->sesariana()->getContantValueXML('sesariana_sidepanel_effect'),
    ));
    
    $this->addElement('Select', 'sesariana_sidepanel_showhide', array(
        ...
        'value' =>  $settings->getSetting('sesariana.sidepanel.showhide', '0'),
    ));
		
    $this->addElement('Select', 'sesariana_menuinformation_img', array(
        ...
        'multiOptions' => $banner_options,
        'escape' => false,
        'value' => $settings->getSetting('sesariana.menuinformation.img', ''),
    ));
    $this->sesariana_menuinformation_img->addDecorator('Description', array('placement' => Zend_Form_Decorator_Abstract::PREPEND, 'escape' => false));
      	
    $this->addElement('Select', 'sesariana_menu_img', array(
        ...
        'multiOptions' => $banner_options,
        'escape' => false,
        'value' => $settings->getSetting('sesariana.menu.img', ''),
    ));
    $this->sesariana_menu_img->addDecorator('Description', array('placement' => Zend_Form_Decorator_Abstract::PREPEND, 'escape' => false));
