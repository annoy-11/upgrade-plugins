 ...
 * @version    $Id: landing-page-settings.tpl 2016-11-22 00:00:00 SocialEngineSolutions $
...
<br />
<div class='sesariana_lp_settings_wrapper'>
    <div class="sesariana_lp_settings_tabs">
      <ul class="nav_cnt">
    ...
    <div class="landing_page_widget_container sesariana_lp_settings_content sesbasic_admin_form">
      <div class="container" id="banner_widget">
        <form action="admin/sesariana/manage/landing-page-settings/param/banner" method="post">
         ...
         <div class="settings">
          <div class="form-wrapper">
            ...
            <div class="form-element">
            	...
            	<?php if(count($banner_options)){ ?>
            		<select name="sesariana_banner_bgimage">
                  <?php foreach($banner_options as $key=>$banner_option){ ?>
                  <option value="<?php echo $key; ?>" <?php if($settings->getSetting('sesariana.banner.bgimage', '') == $key){ echo "selected"; } ?>><?php echo $banner_option; ?></option>
                	<?php } ?>
            		</select>
           		<?php } ?>
          	</div> 
          ...
          <div class="form-wrapper">
            ...
            <div class="form-element">
            	...
            	<?php if(count($banner_options)){ ?>
            		<select name="sesariana_banner_bannerupimage">
                  <?php foreach($banner_options as $key=>$banner_option){ ?>
                  <option value="<?php echo $key; ?>" <?php if($settings->getSetting('sesariana.banner.bannerupimage', 'public/admin/banner-img.png') == $key){ echo "selected"; } ?>><?php echo $banner_option; ?></option>
                	<?php } ?>
            		</select>
           		<?php } ?>
          	</div> 
          ...
          <div class="form-wrapper">
            ...
            <div class="form-element">
              <p class="description">Enter the caption to be shown on the banner image.</p>
            	<input type="text" name="sesariana_staticcontent" value="<?php echo $settings->getSetting('sesariana.staticcontent', ''); ?>">
            </div>  
          </div>
          <div class="form-wrapper">
            ...
            <div class="form-element">
              ...
              <div class="input_field_banner_txt" id="menu_list">
                <?php $sesariana_banner_content = $settings->getSetting('sesariana.banner.content', ''); ?>
                <?php if(!$sesariana_banner_content){ ?>
                  <div style="cursor:move" class="item_label">
                    <input type="text" name="sesariana_banner_content[]">
                    <span><a href="javascript:;" class="delete_input_field_banner_txt fa fa-trash"></a></span>
                  </div>
                <?php }else{ 
                  $sesariana_banner_contents = explode(',',$sesariana_banner_content);
                  foreach($sesariana_banner_contents as $sesariana_banner_content){
                ?>
                  <div style="cursor:move" class="item_label">
                    <input type="text" name="sesariana_banner_content[]" value="<?php echo $sesariana_banner_content; ?>">
      ...
      <div style="display:none;" id="featured_widget" class="container">
        <form action="admin/sesariana/manage/landing-page-settings/param/featuredwidget" method="post">
          ...
          <div class="settings">
            ...
            <div class="form-wrapper">
              ...
              <div class="form-element">
                <p>Enter the title of this block.</p>
              	<input type="text" name="sesariana_feature_heading" value="<?php echo $settings->getSetting('sesariana.feature.heading', ''); ?>">
              </div>  
            </div>
            ...
            <div class="form-wrapper">
              ...
              <div class="form-element">
                <p>Enter the description of this block.</p>
              	<input type="text" name="sesariana_feature_caption" value="<?php echo $settings->getSetting('sesariana.feature.caption', ''); ?>">
              </div>
            </div>
            <div class="form-wrapper">
              <div class="form-label">
              ...
              <p class="form-description">Choose from below the main background image which will be shown in the center of this block. [Note: You can add a new photo from the "File & Media Manager" section from here: <a href="<?php echo $fileLink ?>" target="_blank">File & Media Manager</a>.</p>
                <?php if(count($banner_options)){ ?>
                  <select name="sesariana_feature_bgimage">
                    <?php foreach($banner_options as $key=>$banner_option){ ?>
                      <option value="<?php echo $key; ?>" <?php if($settings->getSetting('sesariana.feature.bgimage', '') == $key){ echo "selected"; } ?>><?php echo $banner_option; ?></option>
                    <?php } ?>
                  </select>
                <?php } ?>
             	</div>
            ...
            <div class="form-sub-heading form-wrapper">
             ...
             <div class="sesariana_feature_content_container" id="menu_list_feature">
               <?php $featureContent = $settings->getSetting('sesariana.feature.content', ''); 
                if(!$featureContent){
             ...
             ?>
               <div style="cursor:move;" class="item_label_feature">
                <div class="form-wrapper">
                  <div class="form-label"><label>Title</label></div>
                   <div class="form-element">
                    <input type="text" name="sesariana_feature_content[<?php echo $key; ?>][caption]" value="<?php echo $content['caption']; ?>">
                   </div>
                 </div>
                 <div class="form-wrapper">
                  <div class="form-label"><label>Description</label></div>
                  <div class="form-element">
                    <input type="text" name="sesariana_feature_content[<?php echo $key; ?>][description]" value="<?php echo $content['description']; ?>">
                  </div>
                </div> 
								<div class="form-wrapper">
                	<div class="form-label"><label>URL</label></div>
                    <div class="form-element">
                    	<input type="text" name="sesariana_feature_content[<?php echo $key; ?>][url]" value="<?php echo $content['url']; ?>">
                    </div>
                 </div>
                 <div class="form-wrapper">
                  ...
                  <?php if(count($banner_options)){ ?>
                  <select name="sesariana_feature_content[<?php echo $key; ?>][iconimage]">
                    <?php foreach($banner_options as $key=>$banner_option){ ?>
             ...
             <?php 
             	...
             	<div style="cursor:move;" class="item_label_feature">
                   ...
                   <div class="form-label"><label>Title</label></div>
                   <div class="form-element">
                    <input type="text" name="sesariana_feature_content[0][caption]" value="">
                   </div>
                 </div> 
                 <div class="form-wrapper">
                  <div class="form-label">
                  ...
                  <div class="form-element">
                  	<input type="text" name="sesariana_feature_content[0][description]" value="">
                  </div>
                 </div>
                 <div class="form-wrapper">
                 	<div class="form-label">
                  ...
                  <div class="form-element">  
                 		<input type="text" name="sesariana_feature_content[0][url]" value="">
                  </div>
                </div>
                <div class="form-wrapper">
                	<div class="form-label">    
                 ...
                 <p class="description">Choose from below the logo image for your website. [Note: You can add a new photo from the "File & Media Manager" section from here: <a href="<?php echo $fileLink ?>" target="_blank">File & Media Manager</a>. Leave the field blank if you do not want to show logo.]</p>
                  <?php if(count($banner_options)){ ?>
                  <select name="sesariana_feature_content[0][iconimage]">
                    <?php foreach($banner_options as $key=>$banner_option){ ?>
      ...
      <div style="display:none;" id="membercloud_widget" class="container">
        <form action="admin/sesariana/manage/landing-page-settings/param/membercloud" method="post">
          ...
          <div class="settings">
            <div class="form-wrapper">
              ...
              <div class="form-element">
                <p><?php echo "Enter the caption to be shown on the member cloud block."; ?> </p>
              	<input type="text" name="sesariana_memeber_heading" value="<?php echo $settings->getSetting('sesariana.memeber.heading', ''); ?>">
              </div>  
            </div>
            <div class="form-wrapper">
            	<div class="form-label">
              ...
              <div class="form-element">
                <p><?php echo "Enter the descriptions to be shown on the member cloud block."; ?> </p>
              	<input type="text" name="sesariana_memeber_caption" value="<?php echo $settings->getSetting('sesariana.memeber.caption', ''); ?>">
              </div>  
            </div>
            <div class="form-wrapper">
            	<div class="form-label">
              ...
              <div class="form-element">
                <p><?php echo "Enter the height of the member profile photos."; ?> </p>
              	<input type="text" name="sesariana_memeber_height" value="<?php echo $settings->getSetting('sesariana.memeber.height', ''); ?>">
              </div>  
            </div>
            <div class="form-wrapper">
            	<div class="form-label">
              ...
              <div class="form-element">
                <p><?php echo "Enter the width of the member profile photos."; ?> </p>
              	<input type="text" name="sesariana_memeber_width" value="<?php echo $settings->getSetting('sesariana.memeber.width', ''); ?>">
                </div>
            </div>
            <div class="form-wrapper">
            	<div class="form-label">
              ...
              <div class="form-element">
              	...
              	<select name="sesariana_member_link">
                  <?php 
                  $designs = array('1'=>'Yes','2'=>'No');
                  foreach($designs as $key=>$link){ ?>
                    <option value="<?php echo $key; ?>" <?php if($settings->getSetting('sesariana.member.link', '') == $key){ echo "selected"; } ?>><?php echo $link; ?></option>
                  <?php } ?>
                </select>
              </div>  
            </div>
            <div class="form-wrapper">
              ...
              <div class="form-element">
              	...
              	<select name="sesariana_member_infotooltip">
                  <?php 
                  $designs = array('1'=>'Yes','2'=>'No');
                  foreach($designs as $key=>$link){ ?>
                    <option value="<?php echo $key; ?>" <?php if($settings->getSetting('sesariana.member.infotooltip', 1) == $key){ echo "selected"; } ?>><?php echo $link; ?></option>
                  <?php } ?>
                </select>
              </div>  
            </div>
...
<script type="application/javascript">
  ...
  sesJqueryObject('.add_feature_content').click(function(){
    ...
    var html = '<div style="cursor:move;" class="item_label_feature"><div class="form-wrapper"><div class="form-label"><label>Title</label></div><div class="form-element"><input type="text" name="sesariana_feature_content['+elementCounter+'][caption]" value=""></div></div><div class="form-wrapper"><div class="form-label"><label>Description</label></div><div class="form-element"><input type="text" name="sesariana_feature_content['+elementCounter+'][description]" value=""></div></div><div class="form-wrapper"><div class="form-label"><label>URL</label></div><div class="form-element"><input type="text" name="sesariana_feature_content['+elementCounter+'][url]" value=""></div></div><div class="form-wrapper"><div class="form-label"><label>Icon Image</label></div><div class="form-element"><p class="description">Choose from below the logo image for your website. [Note: You can add a new photo from the "File & Media Manager" section from here: <a href="<?php echo $fileLink ?>" target="_blank">File & Media Manager</a>. Leave the field blank if you do not want to show logo.]</p><?php if(count($banner_options)){ ?><select name="sesariana_feature_content['+elementCounter+'][iconimage]"><?php foreach($banner_options as $key=>$banner_option){ ?><option value="<?php echo $key; ?>"><?php echo $banner_option; ?></option><?php } ?></select><?php } ?><div style="padding-top:10px;"><a href="javascript:;" class="delete_feature_content fa fa-trash">&nbsp;Delete</a></div></div></div></div>';
    elementCounter++;
    sesJqueryObject('.sesariana_feature_content_container').append(html);
  ...
  sesJqueryObject('.add_banner_widget').click(function(){
    var html = '<div style="cursor:move" class="item_label"><input type="text" name="sesariana_banner_content[]">&nbsp;<span><a href="javascript:;" class="delete_input_field_banner_txt fa fa-trash"></a></span></div>';
