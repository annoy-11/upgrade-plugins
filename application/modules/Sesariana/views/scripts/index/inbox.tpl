 ...
 * @version    $Id: inbox.tpl 2016-11-22 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesariana/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sesariana_messages_menu')){
          var message_children = $('sesariana_messages_menu').getChildren('li');
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesariana/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
