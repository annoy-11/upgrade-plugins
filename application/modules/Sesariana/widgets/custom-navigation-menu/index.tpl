 ...
 *
 * @category   Application_Sessesariana
 * @package    Sesariana
...
<div class="sesariana_banner_container sesbasic_bxs" style="height:<?php echo $this->height; ?>px;">
	<div class="sesariana_banner_inner" style="height:<?php echo $this->height; ?>px;background-image:url(<?php echo $this->backgroundimage; ?>);">
  	<div id="sesariana_custom_navigation_banner" <?php if($this->textalignment == 'center'): ?> class="_txtcenter" <?php endif; ?>></div>
  </div>  
 </div>
<?php
...
sesJqueryObject(document).ready(function(e){
    ...
    if(sesJqueryObject('.layout_<?php echo $moduleName; ?>_browse_menu').length) {
      ...
      sesJqueryObject ("body").addClass('sesariana_menubanner');
      ...
      sesJqueryObject('#sesariana_custom_navigation_banner').html(finalNavigationTitle);
      ...
      sesJqueryObject('.layout_sesariana_custom_navigation_menu').hide();
    }
});
</script>