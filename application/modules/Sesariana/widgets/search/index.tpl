...
<script>
  ...
  en4.core.runonce.add(function() {
    var searchAutocomplete = new Autocompleter.Request.JSON('text_search', "<?php echo $this->url(array('module' => 'sesariana', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
      'postVar': 'text',
      'delay' : 250,      
      'minLength': 1,
      'selectMode': 'pick',
