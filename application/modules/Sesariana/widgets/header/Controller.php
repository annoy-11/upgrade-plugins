...
class Sesariana_Widget_HeaderController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sesariana_header = Zend_Registry::isRegistered('sesariana_header') ? Zend_Registry::get('sesariana_header') : null;
    if(empty($sesariana_header)) {
