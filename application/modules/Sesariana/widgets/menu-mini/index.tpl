...
?>
<?php $enablePopUp = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesariana_popupsign', 1);  ?>
<?php $showPopup = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesariana.popup.enable', 1);?>
<?php $baseUrl = $this->layout()->staticBaseUrl; ?>
<?php if($this->viewer->getIdentity() == 0) : ?>
  <script type="text/javascript" src="<?php echo $baseUrl; ?>application/modules/Sesariana/externals/scripts/jquery-latest.min.js"></script>
  <script>var ses = $.noConflict();</script>
  <script src="<?php echo $baseUrl; ?>application/modules/Sesariana/externals/scripts/jquery.magnific-popup.js"></script>
  <link href="<?php echo $baseUrl; ?>application/modules/Sesariana/externals/styles/magnific-popup.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    <?php if(!empty($showSeparator)) { ?>
  	<div id="small-dialog" class="zoom-anim-dialog mfp-hide sesariana_quick_popup sesariana_quick_login_popup sesbasic_bxs">
    <?php } else { ?>
      <div id="small-dialog" class="zoom-anim-dialog mfp-hide sesariana_quick_popup sesariana_quick_login_popup sesbasic_bxs _nosbtns">
    <?php } ?>
    <div class="sesariana_popup_header clearfix">
      <?php if($this->loginsignup_logo): ?>
        <div class="sesariana_popup_header_logo">
          <img src="<?php echo $this->baseUrl() . '/'. $this->loginsignup_logo; ?>" alt="My Community">
        </div>
      <?php endif; ?>
      <div class="sesariana_popup_header_btns">
    ...
    <div class="sesariana_popup_content clearfix" style="background-image:url(<?php echo $this->loginsignupbgimage; ?>);">
    	<div class="sesariana_popup_content_left sesariana_popup_login">
        ...
        <?php if(Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
          ...
          <div class="sesariana_social_login_btns <?php if($numberOfLogin < 3):?>social_login_btns_label<?php endif;?>">
            <?php  echo $this->partial('_socialLoginIcons.tpl','sessociallogin',array()); ?>
          </div>
        <?php endif; ?>
        <?php echo $this->content()->renderWidget("sesariana.login-or-signup")?>
      </div>
      <?php if(!empty($showSeparator)):?>
        <div class="sesariana_popup_content_sep">
          <span><?php echo $this->translate("OR");?></span>
        </div>
        <div class="sesariana_popup_content_right">
          
          <?php if(!Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
            <span class="sesbasic_text_light"><?php echo $this->translate("Sign in with your social profile");?></span>
            <div class="sesariana_quick_popup_social">
              ...
              <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
                <a href="<?php echo $href;?>" id="fbLogin"><img src="application/modules/Sesariana/externals/images/facebook.png" alt="Facebook" /></a>
              <?php endif;?>
              <?php if ('none' != $settings->getSetting('core_twitter_enable', 'none') && $settings->core_twitter_secret):?>
                ...
                <a href="<?php echo $href;?>" id="googleLogin"><img src="application/modules/Sesariana/externals/images/twitter.png" alt="Twitter" /></a>
              <?php endif;?>
            </div>
          <?php endif; ?>
        </div>
  ...
  <?php if($controllerName != 'signup'){ ?>
  	<?php if(!empty($showSeparator)){?>
    	<div id="user_signup_form" class="zoom-anim-dialog mfp-hide sesariana_quick_popup sesbasic_bxs sesariana_quick_signup_popup">
    <?php } else { ?>
      <div id="user_signup_form" class="zoom-anim-dialog mfp-hide sesariana_quick_popup sesbasic_bxs sesariana_quick_signup_popup _nosbtns">
    <?php }; ?>
      <div class="sesariana_popup_header clearfix">
        <?php if($this->loginsignup_logo): ?>
          <div class="sesariana_popup_header_logo">
    	...
    	<div class="sesariana_popup_content clearfix" style="background-image:url(<?php echo $this->loginsignupbgimage ?>);">
      	<div class="sesariana_popup_content_left sesariana_popup_signup">
          <?php if($this->poupup && $controllerName != 'auth' && $actionName != 'login'){ ?>
          <?php echo $this->action("index", "signup",defined('sesquicksignup') ? "quicksignup" : "sesariana", array('disableContent'=>true)) ?>
          <?php } ?>
        </div>
        <?php if(!empty($showSeparator)):?>
          <div class="sesariana_popup_content_sep">
...
<div id='core_menu_mini_menu'>
  ...
  ?>
    <ul class="sesariana_minimenu_links">
    <?php foreach( $this->navigation as $item ):
      $className = explode(' ', $item->class);
    ?>
      <?php if(end($className) == 'core_mini_signup'):?>
        <li class="sesariana_minimenu_link sesariana_minimenu_signup">
          <?php if($controllerName != 'signup') { ?>
      ...
      <?php elseif(end($className) == 'core_mini_auth' && $this->viewer->getIdentity() == 0): ?>
        <?php if($controllerName != 'auth'  && $actionName != 'login'){ ?>
          <li class="sesariana_minimenu_link sesariana_minimenu_login">
      ...
      <?php elseif(end($className) == 'core_mini_friends'):?>
           <?php $friendRequestIcon = Engine_Api::_()->sesariana()->getMenuIcon('core_mini_friends');?>
          <?php if($this->viewer->getIdentity()):?>
             <li class="sesariana_minimenu_request sesariana_minimenu_icon">
            <?php if($this->requestCount):?>
              <span id="request_count_new" class="sesariana_minimenu_count"><?php echo $this->requestCount ?></span>
            <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'friendrequest');" style="display:block;" class="friends_pulldown">
            <div id="friend_request" class="sesariana_pulldown_contents_wrapper">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="sesariana_pulldown_header">
                <?php echo $this->translate('Requests'); ?>
              </div>
              <div id="sesariana_friend_request_content" class="sesariana_pulldown_contents clearfix">
            ...
            <?php else:?>
              <a href="javascript:void(0);" class="sesariana_mini_menu_friendrequest" id="show_request" title="<?php echo $this->translate("Friend Requests");?>"><i id="show_request"></i>
                <span><?php echo $this->translate('Friends Invitation');?></span>
              </a>
            <?php endif;?>
          </span>
        ...
        <?php if($this->viewer->getIdentity()):?>
          <li id='core_menu_mini_menu_update' class="sesariana_minimenu_updates sesariana_minimenu_icon">
              <?php if($this->notificationCount):?>
                <span id="notification_count_new" class="sesariana_minimenu_count">
            ...
            <span onclick="toggleUpdatesPulldown(event, this, '4', 'notifications');" style="display:block;" class="updates_pulldown">
              <div class="sesariana_pulldown_contents_wrapper">
                <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                <div class="sesariana_pulldown_header">
                  <?php echo $this->translate('Notifications'); ?>
                </div>
                <div class="sesariana_pulldown_contents pulldown_content_list">
              ...
              <?php else:?>
                <a href="javascript:void(0);" id="show_update" class="<?php if( $this->notificationCount ):?>new_updates<?php endif;?> sesariana_mini_menu_notification" title="<?php echo $this->translate("Notificatons");?>"><i id="show_update"></i>
      ...
      <?php elseif(end($className) == 'core_mini_settings'):?>
        <?php $minimenu_user_photo = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesariana.miniuserphotoround',1); ?>
        <?php $settingIcon = Engine_Api::_()->sesariana()->getMenuIcon('core_mini_settings');?>
        <li class="sesariana_minimenu_setting sesariana_minimenu_icon <?php if($minimenu_user_photo): ?> _isrounded <?php endif; ?>">
          <span style="display:block;" class="settings_pulldown" onclick="toggleUpdatesPulldown(event, this, '4', 'settings');">
            <div id="user_settings" class="sesariana_pulldown_contents_wrapper ariana-mini-menu-settings-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="sesariana_pulldown_header">
                <?php echo $this->translate('Account & Settings');?>
              </div>
              <div id="sesariana_user_settings_content" class="sesariana_pulldown_contents clearfix">
      ...
      <?php elseif(end($className) == 'core_mini_messages'):?>
        <?php $messageIcon = Engine_Api::_()->sesariana()->getMenuIcon('core_mini_messages');?>
        <li class="sesariana_minimenu_message sesariana_minimenu_icon">
          <?php if($this->messageCount):?>
            <span id="message_count_new" class="sesariana_minimenu_count"><?php echo $this->messageCount ?></span>
          <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'message');" style="display:block;" class="messages_pulldown">
            <div id="sesariana_user_messages" class="sesariana_pulldown_contents_wrapper ariana-mini-menu-messages-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="sesariana_pulldown_header">
              ...
              <div id="sesariana_user_messages_content" class="sesariana_pulldown_contents clearfix">
            ...
            <?php else:?>
              <a href="javascript:void(0);" class="sesariana_mini_menu_message" id="show_message" title="<?php echo $this->translate("Messages");?>"><i id="show_message"></i>
              	<span><?php echo $this->translate($item->getLabel());?></span>
              </a>
            <?php endif;?>
          </span>
      ...
      <?php elseif(end($className) == 'core_mini_admin'):?>
        <?php continue;?>
      <?php else:?>
        <li class="sesariana_minimenu_link">
...
<?php if($minimenu_notification_normal): ?>
  .sesariana_mini_menu_notification i {
    background-image:url('<?php echo $path; ?>');
  }
<?php endif; ?>

<?php if($minimenu_notification_mouseover): ?>
  .sesariana_mini_menu_notification:hover i,
	.updates_pulldown_active .sesariana_mini_menu_notification i  {
...
<?php endif; ?>
<?php if($minimenu_message_normal): ?>
  .sesariana_mini_menu_message i {
    background-image:url('<?php echo $path; ?>');
  }
<?php endif; ?>
<?php if($minimenu_message_mouseover): ?>
  .sesariana_mini_menu_message:hover i,
	.messages_pulldown_selected .sesariana_mini_menu_message i {
    background-image:url('<?php echo $path_1; ?>');
  }
<?php endif; ?>
<?php
...
<?php endif; ?>
<?php if($minimenu_frrequest_normal): ?>
  .sesariana_mini_menu_friendrequest i {
    background-image:url('<?php echo $path; ?>');
  }
<?php endif; ?>
<?php if($minimenu_frrequest_mouseover): ?>
  .sesariana_mini_menu_friendrequest:hover i,
	.friends_pulldown_selected .sesariana_mini_menu_friendrequest i {
    background-image:url('<?php echo $path_1; ?>');
  }
<?php endif; ?>
...
//    }
  ...
  var toggleUpdatesPulldown = function(event, element, user_id, menu) {
    ...
    if(event.target.className == 'sesariana_pulldown_header')
    return;
  ...
  var showNotifications = function() {
    ...
    abortRequest = new Request.HTML({
      'url' : en4.core.baseUrl + 'sesariana/notifications/pulldown',
      'data' : {
        'format' : 'html',
        'page' : 1
      },
      'onComplete' : function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        document.getElementById('notification_count_new').removeClass('sesariana_minimenu_count');
      }
  ...
  function showSettings() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sesariana/index/general-setting',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       document.getElementById('sesariana_user_settings_content').innerHTML = responseHTML;
      }
    });
    en4.core.request.send(abortRequest, {
    'force': true
  ...
  function showMessages() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sesariana/index/inbox',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       document.getElementById('sesariana_user_messages_content').innerHTML = responseHTML;
       document.getElementById('message_count_new').innerHTML = '';
       document.getElementById('message_count_new').removeClass('sesariana_minimenu_count');
      }
    }); 
    en4.core.request.send(abortRequest, {
    'force': true
  ...
  function showFriendRequests() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sesariana/index/friendship-requests',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       if(responseHTML) {
         document.getElementById('sesariana_friend_request_content').innerHTML = responseHTML;
         document.getElementById('request_count_new').innerHTML = '';
         document.getElementById('request_count_new').removeClass('sesariana_minimenu_count');
       }
       else {
  ...
  if('<?php echo $this->viewer->getIdentity();?>' == 0) {
    ses(document).ready(function() {
		<?php $forcehide =  Engine_Api::_()->getApi('settings', 'core')->getSetting('sesariana.popupfixed', false);    ?>
   ...
   var day = '<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesariana.popup.day', 5);?>';
   if(day != 0)
...
window.addEvent('domready', function() {
      ...
      if(event.target.id != 'show_message' && event.target.id != 'show_request' && event.target.id != 'show_update' &&  event.target.id != 'show_settings_img' && event.target.className != 'sesariana_pulldown_header' && event.target.className != 'pulldown_loading') {
        if($$(".updates_pulldown_active").length > 0)
        $$('.updates_pulldown_active').set('class', 'updates_pulldown');
  ...
  function newFriendRequests() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesariana/index/new-friend-requests',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.requestCount && $("request_count_new") ) {
          ...
          $("request_count_new").style.display = 'block';
         		...
         		$("request_count_new").addClass('sesariana_minimenu_count');
  ...
  function newUpdates() {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesariana/index/new-updates',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.notificationCount && $("notification_count_new") ) {
          ...
          if(responseJSON.notificationCount > 0 && responseJSON.notificationCount != '')
            $("notification_count_new").addClass('sesariana_minimenu_count');
        }
      }
    }));
  }
  ...
  function newMessages() {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesariana/index/new-messages',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.messageCount && $("message_count_new") ) {
          ...
          $("message_count_new").style.display = 'block';
        	...
        	$("message_count_new").addClass('sesariana_minimenu_count');
