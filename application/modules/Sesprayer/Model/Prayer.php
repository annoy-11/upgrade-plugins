 ...
 * @version    $Id: Prayer.php  2017-12-12 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesprayer_Model_Prayer extends Core_Model_Item_Abstract
{
  // Properties
  ...
  public function getRichContent($view = false, $params = array()) {
    ...
    if (!$view) {
      ...
      $view->prayer = $this;
      $videoEmbedded = $view->render('application/modules/Sesprayer/views/scripts/_prayer.tpl');
    }
