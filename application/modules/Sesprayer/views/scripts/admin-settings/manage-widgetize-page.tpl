 ...
 * @version    $Id: manage-widgetized-page.tpl  2017-12-12 00:00:00 SocialEngineSolutions $
...
<table class='admin_table'>
  ...
  <tbody>
    ...
    $corePages = Engine_Api::_()->sesprayer()->getwidgetizePage(array('name' => $item));
    ...
    <tr>
      ...
      <td>
        ...
        <?php if($item == 'sesprayer_index_view'): ?>
        <?php else: ?>
        |
