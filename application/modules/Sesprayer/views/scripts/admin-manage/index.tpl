...
{
  return confirm("<?php echo $this->translate('Are you sure you want to delete the selected prayer entries?');?>");
}
...
<p>
  <?php echo $this->translate("This page lists all of the prayers your users have created. You can use this page to monitor these prayers and delete offensive material if necessary. Entering criteria into the filter fields will help you find specific prayer. Leaving the filter fields blank will show all the prayers on your social network. ") ?>
</p>
<br />
...
<div class="sesbasic_search_reasult">
  <?php echo $this->translate(array('%s prayer found.', '%s prayers found.', $this->paginator->getTotalItemCount()), $this->locale()->toNumber($this->paginator->getTotalItemCount())) ?>
</div>
    ...
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        ...
        <td class="admin_table_centered">
          ...
          Engine_Api::_()->getDbtable('prayers', 'sesprayer')->update(array(
          'offtheday' => 0,
          'starttime' =>'',
          'endtime' =>'',
          ), array(
          ...
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesprayer', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->prayer_id, 'type' => 'prayer', 'param' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit Video of the Day'))), array('class' => 'smoothbox')); ?>
          <?php else: ?>
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesprayer', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->prayer_id, 'type' => 'prayer', 'param' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make Video of the Day'))), array('class' => 'smoothbox')) ?>
          <?php endif; ?>
        </td>
        ...
        <td>
          ...
          |
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesprayer', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->prayer_id), $this->translate("delete"), array('class' => 'smoothbox')); ?>
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no prayer entries posted by your members yet.") ?>
    </span>
  </div>
<?php endif; ?>
