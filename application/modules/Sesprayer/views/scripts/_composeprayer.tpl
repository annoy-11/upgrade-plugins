 ...
 * @version    $Id: _composeprayer.tpl  2017-12-12 00:00:00 SocialEngineSolutions $
...
?>
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sesprayer/externals/scripts/composer_prayer.js'); ?>
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    composeInstance.addPlugin(new Composer.Plugin.Prayer({
      title: '<?php echo $this->string()->escapeJavascript($this->translate('Prayer')) ?>',
