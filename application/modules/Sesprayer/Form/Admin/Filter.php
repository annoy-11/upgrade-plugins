...
class Sesprayer_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbtable('categories', 'sesprayer')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Hidden', 'prayer_id', array(
        'order' => 10003,
    ));
