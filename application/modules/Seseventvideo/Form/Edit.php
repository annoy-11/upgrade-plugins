 ...
 * @version    $Id: Edit.php 2016-07-28 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seseventvideo_Form_Edit extends Engine_Form {
  ...
  public function init() {
    ...
    if (Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable('seslock') && Engine_Api::_()->authorization()->getPermission($viewer, 'seseventvideo_video', 'video_locked')) {
