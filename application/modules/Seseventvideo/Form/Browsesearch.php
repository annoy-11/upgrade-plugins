...
class Seseventvideo_Form_Browsesearch extends Engine_Form {
  ...
  public function init() {
    parent::init();
		...
		if($this->getSearchFor() == 'video')
			$searchFor =$view->url(array('controller' => 'index', 'action' => 'location','module'=>'seseventvideo'), 'sesvideo_general', true);
    $this
            ->setAttribs(array(
                'id' => 'filter_form',
    ...
    if ($this->_searchTitle == 'yes') {
      ...
      $this->addElement('Text', 'search', array(
		...
		if ($this->_searchEventTitle == 'yes' || 1){
			 $valueD = Zend_Registry::get('Zend_Translate')->_('Event Title:');
    ...
    $this->addElement('Button', 'submit', array(
		...
		$this->addElement('Dummy','loading-img-seseventvideo', array(
        'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="seseventvideo-category-widget-img" alt="Loading" />',
   ));
  }
