 ...
 * @version    $Id: VideoController.php 2016-07-28 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seseventvideo_VideoController extends Core_Controller_Action_Standard {
  ...
  public function embedAction() {
    // Get subject
    $this->view->video = $video = Engine_Api::_()->core()->getSubject('seseventvideo_video');
  ...
  public function externalAction() {
    ...
    $this->view->rating_count = Engine_Api::_()->getDbtable('ratings', 'seseventvideo')->ratingCount($video->getIdentity(), 'seseventvideo_video');
