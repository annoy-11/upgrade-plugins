 ...
 * @version    $Id: Bootstrap.php 2016-07-28 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seseventvideo_Bootstrap extends Engine_Application_Bootstrap_Abstract {
    ...
    if (strpos(str_replace('/', '', $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']), str_replace('/', '', $_SERVER['SERVER_NAME'] . 'admin')) === FALSE) {
      ...
      $headScript->appendFile($baseURL . 'application/modules/Seseventvideo/externals/scripts/core.js');
