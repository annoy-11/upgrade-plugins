 ...
 * @version    $Id: dismiss_message.tpl 2016-07-28 00:00:00 SocialEngineSolutions $
...
<?php endif; ?>
<?php //if( !isset($_COOKIE["dismiss_seseventvideoplugin"])): ?>
<?php if(0): ?>
  <div id="dismiss_seseventvideoplugin" class="tip">
    <span>
      <?php echo "Can you rate our plugin on <a href='http://www.socialengine.com/customize/se4/mod-page?mod_id=1449' target='_blank'>socialengine.com</a> to support our plugin?  <a href='http://www.socialengine.com/customize/se4/mod-page?mod_id=1449' target='_blank'>Yes</a> or <a href='javascript:void(0);' onclick='dismiss(\"dismiss_seseventvideoplugin\")'>No, not now</a>.";
    ?>
    </span>
  </div>
<?php endif; ?>
<h2><?php echo $this->translate("Advanced Events - Videos Extension") ?></h2>

<div class="sesbasic_nav_btns">
	<a href="admin/sesevent/settings" class="back-btn">Go to Back Advanced Events Plugin</a>
...
<?php //if(Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventvideo.pluginactivated')): ?>
