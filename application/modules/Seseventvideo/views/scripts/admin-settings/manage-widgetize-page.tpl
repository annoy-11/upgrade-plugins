 ...
 * @version    $Id: manage-widgetize-page.tpl 2016-07-28 00:00:00 SocialEngineSolutions $
    ...
    <div class='sesbasic-form-cont'>
	    <div class='clear'>
			  <div class='settings sesbasic_admin_form'>
					...
					<p>
						<?php echo $this->translate('This page lists all the Widgetized Pages of this extension. From here, you can easily go to particular widgetized page in "Layout Editor" by clicking on "Widgetized Page" link. The user side link of the page can be viewed by clicking on "User Page" link.'); ?>
					</p>
					<br />
					<table class='admin_table'>
					  ...
					  <tbody>
					    ...
					    $corePages = Engine_Api::_()->seseventvideo()->getwidgetizePage(array('name' => $item));
