 ...
 * @version    $Id: create.tpl 2016-07-28 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    ...
    var validationUrl = '<?php echo $this->url(array('module' => 'seseventvideo', 'controller' => 'index', 'action' => 'validation'), 'default', true) ?>';
    ...
    var updateTextFields = window.updateTextFields = function() {
      ...
      if( video_element.value == 0 ) {
        ...
        return;
				...
				<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventvideo.direct.video', 0)){ 
								$show = 'hide';
							}else{
								$show="show";
							}
...
<div class="tip"> <span> <?php echo $this->translate('You have already uploaded the maximum number of videos allowed.');?> <?php echo $this->translate('If you would like to upload a new video, please <a href="%1$s">delete</a> an old one first.', $this->url(array('action' => 'manage'), 'seseventvideo_general'));?> </span> </div>
<br/>
<?php else:?>
	<div class="seseventvideo_video_form">
