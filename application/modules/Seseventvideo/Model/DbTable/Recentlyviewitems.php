 ...
 * @version    $Id: Recentlyviewitems.php 2016-07-28 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
class Seseventvideo_Model_DbTable_Recentlyviewitems extends Engine_Db_Table {
  protected $_name = 'seseventvideo_recentlyviewitems';
  protected $_rowClass = 'Seseventvideo_Model_Recentlyviewitem';
  public function getitem($params = array()) {

      $itemTable = Engine_Api::_()->getItemTable('seseventvideo_video');
    ...
    $select = $this->select()
            ...
            ->from(array('engine4_seseventvideo_recentlyviewitems' => $subquery))
            ->where($this->info('name') .'.resource_type = ?', $params['type'])
            ->order('engine4_seseventvideo_recentlyviewitems.creation_date DESC')
