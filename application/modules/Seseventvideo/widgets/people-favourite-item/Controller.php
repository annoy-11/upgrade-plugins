 ...
 */
class Seseventvideo_Widget_peopleFavouriteItemController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->width = $this->_getParam('width', '48');
		...
		$param['type'] = 'seseventvideo_'.str_replace('seseventvideo_','',$subject->getType());
		$param['resource_id'] = $subject->getIdentity();
   	$this->view->paginator = $paginator = Engine_Api::_()->getDbTable('videos', 'seseventvideo')->getFavourite($param);
