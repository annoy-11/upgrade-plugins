...
<div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">    
   <ul class="seseventvideo_cat_video_listing sesbasic_clearfix clear" id="tabbed-widget_<?php echo $randonNumber; ?>">
<?php } ?>
    ...
    <?php foreach($this->paginator as $key=>$video){  ?>
      ...
      <?php if(($this->paginator->getCurrentPageNumber() == 1 || $this->loadOptionData == 'pagging') && !$break && $totalCount >= $allowedLimit ){ ?>
        ...
        <div class="sesbasic_clearfix sesbasic_bxs clear">
      		<div class="seseventvideo_videolist_row clear sesbasic_clearfix">
      <?php } ?>
						<?php if($type == 1){ ?>
               <?php if(!$close){  ?><div class="seseventvideo_videolist_column_small floatL"> <?php } ?>
                    <div class="seseventvideo_cat_video_list">
                  <div class="seseventvideo_thumb">
                    <a href="<?php echo $href; ?>" data-url = "<?php echo $video->getType() ?>" class="seseventvideo_thumb_img">
                      <span class="seseventvideo_animation" style="background-image:url(<?php echo $imageURL; ?>);"></span>
                     <?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive) || isset($this->hotLabelActive)){ ?>
                      ...
                      <?php } ?>
                      <div class="seseventvideo_cat_video_list_info seseventvideo_animation">
                        <div>
                          <div class="seseventvideo_cat_video_list_content">
                          <?php if(isset($this->titleActive)){ ?>
                            <div class="seseventvideo_cat_video_list_title">
                              <?php echo $video->getTitle(); ?>
                            </div>
                            <?php } ?>
                            <?php if(isset($this->byActive)){ ?>
                            <div class="seseventvideo_cat_video_list_stats">
                              <?php
                            ...
                            <?php } ?>
                            <div class="seseventvideo_cat_video_list_stats seseventvideo_list_stats sesbasic_text_light">
                            ...
                            <?php if(isset($this->watchnowActive)){ ?>
                             <div class="seseventvideo_cat_video_list_button"><?php echo $this->translate('Watch now'); ?></div>
                            <?php } ?>
                          </div>
                        </div>
                      </div>
            ...
            <?php } ?>
						<?php if($type == 2){ ?>
             <div class="seseventvideo_videolist_column_big floatL">
             		<div class="seseventvideo_cat_video_list">
                   <div class="seseventvideo_thumb">
                    <a href="<?php echo $href; ?>" data-url = "<?php echo $video->getType() ?>" class="seseventvideo_thumb_img">
                      <span class="seseventvideo_animation" style="background-image:url(<?php echo $imageURL; ?>);"></span>
     ...
     <?php if(($counter)%5 == 0){ ?>
      ...
      ?>
      <?php }else{ ?>
   					   <li class="seseventvideo_cat_video_list" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
                <div class="seseventvideo_thumb">
                    <a href="<?php echo $href; ?>" data-url = "<?php echo $video->getType() ?>" class="seseventvideo_thumb_img">
                      <span class="seseventvideo_animation" style="background-image:url(<?php echo $imageURL; ?>);"></span>
                     <?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive) || isset($this->hotLabelActive)){ ?>
      ...
      <div class="tip">
        <span>
          ...
          <?php if (!$this->can_edit):?>
                    <?php echo $this->translate('Be the first to %1$spost%2$s one in this category!', '<a href="'.$this->url(array('action' => 'create'), "seseventvideo_general").'">', '</a>'); ?>
          <?php endif; ?>
        </span>
      </div>
    <?php } ?>    
...
function dynamicWidth(){
	var objectClass = sesJqueryObject('.seseventvideo_cat_video_list_info');
	for(i=0;i<objectClass.length;i++){
			sesJqueryObject(objectClass[i]).find('div').find('.seseventvideo_cat_video_list_content').find('.seseventvideo_cat_video_list_title').width(sesJqueryObject(objectClass[i]).width());
	}
}
dynamicWidth();
<?php } ?>
