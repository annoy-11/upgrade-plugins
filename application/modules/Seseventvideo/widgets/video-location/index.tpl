...
function initialize() {
	...
	?>
	<?php 
	$likeButton = $favouriteButton = $addToplaylist = $socialshare = '';
...
function callNewMarkersAjax(){
	 (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + "widget/index/mod/seseventvideo/name/<?php echo $this->widgetName; ?>",
      'data': {
        format: 'html',
				is_ajax : 1,
