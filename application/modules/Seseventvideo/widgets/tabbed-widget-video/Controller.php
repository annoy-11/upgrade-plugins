 ...
 */
class Seseventvideo_Widget_TabbedWidgetVideoController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    if ($is_ajax)
      ...
      if ($paginator->getTotalItemCount() <= 0) {
        $checkVideoCount = Engine_Api::_()->getDbTable('videos', 'seseventvideo')->countVideos();
