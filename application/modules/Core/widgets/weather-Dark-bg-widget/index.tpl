...
<!--Weather Middle bar Dark Bg block-->

  <div class="sesweather_Dark_bg_block sesweather_bxs">
    <!--Weather Middle bar Dark_bg top-bar-->
    ...
    <!--Weather Middle bar Dark_bg content section-->
    ...
    <!--Weather Middle bar Dark_bg bottom section-->
        ...
        <div class="sesweather_bottom_day_expand">
          <div class="non-expand">
            <div class="day_weather">
              ...
              <span><img src="./application/modules/Core/externals/images/measure2.png" class="" />&nbsp;30%</span>
            </div>
          </div>
          ...
          <div class="expand_desc">
            <div class="expand_list">
              <div class="desc_left">
                <img src="./application/modules/Core/externals/images/precipitation.png" class="" />
                <p>Precipitation-30%</p>
              </div>
            </div>
            <div class="expand_list">
              <div class="desc_left">
                <img src="./application/modules/Core/externals/images/wind.png" class="" />
                <p>Wind-9mph SSW</p>
              </div>
            </div>
            <div class="expand_list">
              <div class="desc_left">
                <img src="./application/modules/Core/externals/images/measure2.png" class="" />
                <p>Humidity-70%</p>
              </div>
            </div>
            <div class="expand_list">
              <div class="desc_left">
                <img src="./application/modules/Core/externals/images/sun.png" class="" />
                <p>UV-Very High</p>
              </div>
            </div>
          </div>
...
//hide show div on hover

// sesJqueryObject(document).ready(function() {
//   sesJqueryObject('.expand').hide();
// });
// sesJqueryObject(document).ready(function() {
//   sesJqueryObject('.sesweather_bottom_day').hover(function() {
//     sesJqueryObject('.expand').show();
//     },
//   function() {
//     sesJqueryObject('.normal').hide();
//     });
// });
