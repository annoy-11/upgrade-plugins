...
<?php if($controllerName == 'index' && $actionName == 'manage') { ?>

  <?php $identity = Engine_Api::_()->sesadvpoll()->getIdentityWidget('sesadvpoll.manage-polls','widget','sesadvpoll_index_manage'); ?>
