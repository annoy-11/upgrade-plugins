...
class Sesadvpoll_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        // Get form
        $this->view->form = $form = new Sesadvpoll_Form_Search(array('searchTitle'=>$this->_getParam('search_title')));
