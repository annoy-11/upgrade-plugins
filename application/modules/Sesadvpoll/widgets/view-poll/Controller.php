...
class Sesadvpoll_Widget_ViewPollController extends Engine_Content_Widget_Abstract {

    public function indexAction() {

        $coreApi = Engine_Api::_()->core();

        if (!$coreApi->hasSubject('sesadvpoll_poll'))
        ...
        $this->view->sesadvpoll = $poll = Engine_Api::_()->core()->getSubject('sesadvpoll_poll');
        ...
        $this->view->showPieChart = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvpoll.showpiechart', false);

        $this->view->canVote = $canvote = $poll->authorization()->isAllowed($viewer, 'vote');

        $this->view->canChangeVote = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvpoll.canchangevote', false);
