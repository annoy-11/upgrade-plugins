 ...
 * @version    $Id: Favourites.php  2018-12-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesadvpoll_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Sesadvpoll_Model_Favourite";
  ...
  public function getItemfav($resource_type, $itemId) {
    ...
    $viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity();
    $tableFav = Engine_Api::_()->getDbTable('favourites', 'sesadvpoll');
    $tableMainFav = $tableFav->info('name');
    $select = $tableFav->select()->from($tableMainFav)
