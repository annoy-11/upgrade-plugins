 ...
 * @version    $Id: Polls.php  2018-12-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesadvpoll_Model_DbTable_Polls extends Core_Model_Item_DbTable_Abstract
{
  protected $_rowClass = 'Sesadvpoll_Model_Poll';
  public function getPollSelect($params = array())
  {
    ...
    $table = Engine_Api::_()->getItemTable('sesadvpoll_poll');
