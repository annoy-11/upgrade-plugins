 ...
 * @version    $Id: Create.php  2018-12-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesadvpoll_Form_Create extends Engine_Form
{
  public function init()
  {
    ...
    // Init profile view
    $viewOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('sesadvpoll_poll', $user, 'auth_view');
    ...
    $commentOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('sesadvpoll_poll', $user,
      'auth_comment');
