 ...
 * @version    $Id: edit.tpl  2018-12-26 00:00:00 SocialEngineSolutions $
...
$optionsDiv .=  '<div class="pollOptionInput" id="'.$pollOptionId.'"><input type="hidden" name="optionIds[]" value="'.$pollOptionId.'"><input type="text"  class = "option_text" name="optionsArray[]" value="'.$pollOption.'"><div class="sesadvpoll_uploadmedia"><span class="sesadvpoll_add_photo"  style="'.$InputStyle.'"><a href="javascript:void(0)" title="'.$this->translate('Attach a Photo').'"><input type="file" name="optionsImage[]"    style="'.$InputStyle.'" class="'.$text.$counter.'"  onchange ="previewFile(this,'.$counter.')"></a></span>';
        ...
        $optionsDiv .= '</div><span class="sesadvpoll_upload_img"><a href="javascript:void(0)" style = "'.$imagestyle.';" id="remove-image'.$counter.'" class="fa fa-close remove-image"></a><img src="'.$imageUrl.'"  imageType = "'.$imageType.'" class="uploadPreviewImage" style="'.$imagestyle.'" id="'.$text.$counter.'" ></span><span class="sesadvpoll_upload_img"><a href="javascript:void(0)" style = "'.$gifStyle.'" id="remove-gif'.$counter.'" class="fa fa-close remove-gif"></a><img   src="'.$gifUrl.'"   imageType = "'.$imageType.'" class="uploadPreviewGif" style="'.$gifStyle.'" id="'.$gif.$counter.'" ></span>' ;
...
<?php }	?>
  ...
  function append(){
    var optionsDiv = "";
      ...
      optionsDiv += '</div><span class="sesadvpoll_upload_img"><a href="javascript:void(0)" style = "display:none;" id="remove-image'+counter+'" class="fa fa-close remove-image"></a>' +
                    '<img src="" class="uploadPreviewImage" imageType ="0" style="display:none;" id="'+text+counter+'" ></span>';
      optionsDiv += '<span class="sesadvpoll_upload_img"><a href="javascript:void(0)" style = "display:none;" id="remove-gif'+counter+'" class="fa fa-close remove-gif"></a>' +
      ...
      sesJqueryObject.ajax({
        ...
        success: function(data) {
         ...
         var response = jQuery.parseJSON(data);
          if(response.status) {
            window.location.href = en4.core.baseUrl+'<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvpoll.poll.manifest', 'pagepoll'); ?>/view/'+response.id;
          }else{
