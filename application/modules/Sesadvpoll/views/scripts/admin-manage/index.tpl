    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          ...
          <td>
            <a href="<?php echo $this->url(array('poll_id' => $item->poll_id), 'sesadvpoll_view') ?>">
              <?php echo $this->translate("view") ?>
            </a>
            |
            <?php echo $this->htmlLink(
                array('route' => 'default', 'module' => 'sesadvpoll', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->poll_id),
