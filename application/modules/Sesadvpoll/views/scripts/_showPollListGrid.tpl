 ...
 * @version    $Id: _showPollListGrid.tpl  2018-12-26 00:00:00 SocialEngineSolutions $
...
<?php foreach($this->paginator as $poll):?>
 <li id="poll-item-<?php echo $poll->poll_id ?>" <?php if($this->gridlist) { ?> style="height:<?php echo $this->height ?>px;width:<?php echo $this->width ?>px;" <?php } ?>>
		...
		<div class="_btnsleft">
		  <?php if($viewerId ):?>
			...
			<?php  if($canComment && in_array("likeButton", $this->show_criteria)):?>
			  ...
			  <a href="javascript:;" data-type="like_view" data-url="<?php echo $poll->poll_id ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sesadvpoll_like_<?php echo $poll->poll_id ?> sesadvpoll_likefavfollow <?php echo ($likeStatus) ? 'button_active' : '' ; ?>"><i class="fa fa-thumbs-up"></i><span><?php echo $poll->like_count;?></span></a>
			<?php endif;?>
  ...
  <?php if(@$this->params['pagging'] != 'pagging'){ ?>
    ...
    function viewMore_<?php echo $randonNumber; ?> (){
      ...
      requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
        method: 'post',
        'url': en4.core.baseUrl + "widget/index/mod/sesadvpoll/id/<?php echo $this->widgetId; ?>/name/<?php echo $this->widgetName; ?>/openTab/" + openTab_<?php echo $randonNumber; ?>,
        'data': {
          format: 'html',
        ...
        onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
          ...
          if(!isSearch) {
            ...
            document.getElementById('tabbed-widget_<?php echo $randonNumber; ?>').innerHTML = document.getElementById('tabbed-widget_<?php echo $randonNumber; ?>').innerHTML + responseHTML;
            var totalPage= sesJqueryObject('#tabbed-widget_<?php echo $randonNumber; ?>').find("#paginator_count_ajax_sesadvpoll_entry");
            sesJqueryObject('.sesbasic_view_type_<?php echo $randonNumber; ?>').find('#paginator_count_sesadvpoll').html(totalPage.html());
            totalPage.remove();
            isSearch = false;
          }
