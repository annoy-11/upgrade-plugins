 ...
 * @version    $Id: gifcontent.tpl  2018-12-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<div class="gif_pagepoll_content ses_emoji_container sesbasic_bxs _gif_pagepoll_content notclose">
