 ...
 * @version    $Id: _activity_poll.tpl  2018-12-26 00:00:00 SocialEngineSolutions $
...
<?php 
  ...
  $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sesadvpoll/externals/scripts/core.js');
  
  $this->headTranslate(array('Show Questions', 'Show Results', '%1$s%%', '%1$s vote'));
  
  $isvoteShow = true; //in_array("vote_count", @$this->show_criteria)?true:false;
?>
      ...
      ?>
		...
		<div class="_btnsleft">
		  <?php $viewer = Engine_Api::_()->user()->getViewer();?>
            ...
            <?php endif;?>
            <?php if( Engine_Api::_()->getApi('settings', 'core')->getSetting('sesadvpoll.allow.favourite', 1)):?>
