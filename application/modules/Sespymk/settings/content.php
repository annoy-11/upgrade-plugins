 ...
 */
$interests = array();
if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesinterest') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesinterest.pluginactivated',0)) {
    $interests =  array(
        'Select',
        'interestbased',
        array(
            'label' => "Do you want to show member based on interests based?",
            'multiOptions' => array(
                '1' => 'Yes',
                '0' => 'No',
            ),
...
return array(
  ...
  array(
    ...
    'adminForm' => array(
	  ...
	  array(
    'title' => 'SES - PYMK - Display Received Friend Requests in Sidebar',
    'description' => 'This widget displays the friend requests received by the user who is viewing the widget in sidebar. This widget can be placed anywhere on your website.',
    'category' => 'SES - People You May Know Plugin',
    'type' => 'widget',
    'name' => 'sespymk.friend-requests-sidebar',
    'autoEdit' => true,
    'adminForm' => array(
      'elements' => array(
	    array(
