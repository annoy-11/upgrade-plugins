  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        |
        <?php if($item == 'sespymk_index_requests'): ?>
          <a href="findfriends" target="_blank"><?php echo $this->translate("User Page") ?></a>
        <?php else: ?>
          <a href="friends/requests/" target="_blank"><?php echo $this->translate("User Page") ?></a>
        <?php endif; ?>
      </td>
    </tr>
    <?php $results = ''; ?>
