  ...
  <?php endif; ?>
      ...
      <?php if (!empty($this->peopleyoumayknow) && $this->peopleyoumayknow->count() > 1): ?>
        <?php if ($this->peopleyoumayknow->getCurrentPageNumber() < $this->peopleyoumayknow->count()): ?>
          ...
          <div class="sesbasic_load_btn" id="view_more_sent" onclick="loadMoreSent();" >
            <a href="javascript:void(0);" class="sesbasic_animation sesbasic_link_btn" id="feed_viewmore_link_sent"><i class="fa fa-repeat"></i><span><?php echo $this->translate('View More');?></span></a>
          </div>  
