 ...
 * @version    $Id: AdminReportController.php  2018-10-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesshoutbox_AdminManageReportController extends Core_Controller_Action_Admin {
  ...
  {
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesshoutbox_admin_main', array(), 'sesshoutbox_admin_main_managereport');
    // Make form
