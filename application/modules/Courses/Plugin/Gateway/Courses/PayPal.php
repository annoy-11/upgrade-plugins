...
class Courses_Plugin_Gateway_Courses_PayPal extends Engine_Payment_Plugin_Abstract
{
  ...
  public function getGateway()
  {
    if( null === $this->_gateway ) {
      ...
      $gateway = new $class(array(
        ...
        'currency' => Engine_Api::_()->courses()->defaultCurrency(),
      ));
   ...
   *
	*/
  public function createOrderTransaction($order,$course,array $params = array())
  {
  ...
  {
    return new Courses_Form_Admin_Gateway_PayPal();
  }
