...
<?php if($this->view_type == 'list'): ?>
  <ul id="widget_courses_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block sesbasic_sidebar_block courses_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php else: ?>
  <ul id="widget_courses_<?php echo $randonnumber; ?>" class="courses_listing sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php endif; ?>
  <div class="sesbasic_loading_cont_overlay" id="courses_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php include APPLICATION_PATH . '/application/modules/Courses/views/scripts/_sidebarWidgetData.tpl'; ?>
