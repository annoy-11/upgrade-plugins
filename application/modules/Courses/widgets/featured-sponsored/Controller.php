 ...
 */
class Courses_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $show_criterias = isset($params['show_criterias']) ? $params['show_criterias'] : $this->_getParam('show_criteria', array('like', 'comment', 'title', 'socialSharing', 'view', 'featuredLabel', 'sponsoredLabel', 'verifiedLabel', 'rating', 'ratingStar', 'classroomName', 'creationDate', 'favourite','category'));
    ...
    $this->view->results = $paginator = Engine_Api::_()->getDbTable('courses', 'courses')->getCoursePaginator($value);
