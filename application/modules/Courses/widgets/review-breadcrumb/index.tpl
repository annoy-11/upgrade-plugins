...
<div class="sesbasic_breadcrumb">
  <?php if($dontShow): ?>
    <a href="<?php echo $this->url(array('action' => 'home'), 'courses_general'); ?>"><?php echo $this->translate("Course Home");?></a>&nbsp;&raquo;
    <a href="<?php echo $this->url(array('action' => 'browse-review'), 'courses_general'); ?>"><?php echo $this->translate("Course Review"); ?></a>&nbsp;&raquo;
  <?php endif; ?> 
  <?php if($this->subject->getType() == 'courses_review' && $isValid):?>
    <?php if($item): ?>
