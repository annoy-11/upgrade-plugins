...
<?php elseif($actionName == 'browse-courses'):?>
  <?php $pageName = 'courses_index_'.$this->page_id;?>
  <?php $widgetName = 'courses.browse-courses';?>
<?php elseif($actionName == 'manage'):?>
  <?php $pageName = 'courses_index_manage';?>
  <?php $widgetName = 'courses.manage-courses';?>
<?php elseif($actionName == 'hot'):?>
  <?php $pageName = 'courses_index_hot';?>
  <?php $widgetName = 'courses.browse-courses';?>
<?php elseif($actionName == 'verified'):?>
  <?php $pageName = 'courses_index_verified';?>
  <?php $widgetName = 'courses.browse-courses';?>
<?php elseif($actionName == 'featured'):?>
  <?php $pageName = 'courses_index_featured';?>
  <?php $widgetName = 'courses.browse-courses';?>
<?php elseif($actionName == 'sponsored'):?>
  <?php $pageName = 'courses_index_sponsored';?>
  <?php $widgetName = 'courses.browse-courses';?>
<?php else: ?>
  <?php $pageName = 'courses_index_browse';?>
  <?php $widgetName = 'courses.browse-courses';?>
...
<script type="application/javascript">
  ...
  var Searchurl = "<?php echo $this->url(array('module' =>'courses','controller' => 'index', 'action' => 'get-courses'),'default',true); ?>";
