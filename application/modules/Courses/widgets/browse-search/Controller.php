...
class Courses_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract
{
  public function indexAction() {
    ...
    $page_id = Engine_Api::_()->courses()->getWidgetPageId($this->view->identity);
    if($page_id) {
