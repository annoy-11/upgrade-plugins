...
class Courses_Widget_TestListViewController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if (!Engine_Api::_()->core()->hasSubject())
     ...
     $this->view->isPurchesed =  Engine_Api::_()->courses()->getUserPurchesedCourse($course->course_id);
    if(empty($course))
