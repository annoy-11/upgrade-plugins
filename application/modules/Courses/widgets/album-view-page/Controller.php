 ...
 */
class Courses_Widget_AlbumViewPageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if(Engine_Api::_()->core()->hasSubject()){
      ...
      $classroom =  Engine_Api::_()->getItem('courses_classroom', $album->classroom_id);
    } else {
      $album =  Engine_Api::_()->getItem('courses_album', $_POST['album_id']);
      $classroom =  Engine_Api::_()->getItem('courses_album', $_POST['classroom_id']);
    }
    ...
    $photoTable = Engine_Api::_()->getItemTable('courses_photo');
    // Do other stuff
    $this->view->mine = $mine  = true;
    $this->view->viewer = $viewer = Engine_Api::_()->user()->getViewer();
    $this->view->viewer_id = $viewer->getIdentity();
    if($viewer->getIdentity() > 0) {
        $classroomApi = Engine_Api::_()->courses();
