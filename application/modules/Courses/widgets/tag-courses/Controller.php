...
class Courses_Widget_tagCoursesController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->tagCloudData  = Engine_Api::_()->courses()->tagCloudItemCore('fetchAll','',$show_count);
