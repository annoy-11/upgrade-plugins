 ...
 */
class Courses_Widget_WishlistOfTheDayController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $wishlist = Engine_Api::_()->getDbTable('wishlists', 'courses')->getOfTheDayResults(false,array('wishlist_id'));
