 ...
 */
class Courses_Widget_OtherModulesProfileCoursesController extends Engine_Content_Widget_Abstract { 
  public function indexAction() { 
    ...
    if (!$is_ajax && is_array($defaultOptionsArray)) {
      foreach ($defaultOptionsArray as $key => $defaultValue) {
        ...
        if ($this->_getParam($defaultValue.'_label'))
          ...
          else if ($defaultValue == 'priceHigh')
            $valueLabel = 'Price High To Low'. '||' . $defaultValue;
          else if ($defaultValue == 'priceLow')
            $valueLabel = 'Price Low To High'. '||' . $defaultValue;
        }
    ...
    $courses_tabbed = Zend_Registry::isRegistered('courses_tabbed') ? Zend_Registry::get('courses_tabbed') : null;
    ...
    switch ($defaultOpenTab) {
      ...
      case 'mostSPlecture':
        ...
        break;
      case 'priceHigh':
        $popularCol = 'price_high';
        $type = 'price_high';
        break;
      case 'priceLow':
        $popularCol = 'price_low';
        $type = 'price_low';
        break;
      case 'featured':
        $popularCol = 'featured';
    ...
    $this->view->widgetName = 'other-modules-profile-courses';
