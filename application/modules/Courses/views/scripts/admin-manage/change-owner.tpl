...
<p>
  <?php echo $this->translate('Here you can transfer the ownership of this Course to some other site member. [Note: You cannot revert this action, so we suggest you to take this action only if you are pretty much sure about this.]') ?>
</p>
<br />	
<form id="courses_change_owner" action="<?php echo $this->url(array('module' => 'courses', 'controller' => 'manage','action'=>'change-owner','id' => $this->classroom->classroom_id),'admin_default', true); ?>" method="post">
...
<script type='text/javascript'>
 var Searchurl = "<?php echo $this->url(array('classroom_id' => $this->classroom->custom_url,'action'=>'search-member'), 'classroom_dashboard', true); ?>";
