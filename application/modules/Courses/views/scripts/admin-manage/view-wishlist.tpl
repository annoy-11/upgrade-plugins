 ...
 * @version    $Id: view-wishlist.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
...
<div class="sesbasic_view_stats_popup">
  ...
  <table>
  	<tr>
        <?php $photo = Engine_Api::_()->getItem('storage_file', $this->item->photo_id);
            if($photo) 
            $photo = $photo->map(); ?>
			<td colspan="1"><img src="<?php echo $photo; ?>" style="height:75px; width:75px;"/></td>
			<td>
				<?php if(!is_null($this->item->title) && $this->item->title != ''):?>
