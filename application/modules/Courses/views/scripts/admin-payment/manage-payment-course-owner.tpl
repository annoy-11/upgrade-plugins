        ...
        <table class='admin_table'>
          <thead>
            <tr>
              ...
              <th><?php echo $this->translate("Course Title") ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="<?php echo $course->getHref(); ?>" target="_blank"><?php echo $course->getTitle(); ?></a></td>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'courses', 'controller' => 'admin-payment', 'action' => 'view-paymentrequest', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
