...
?>
<?php $reviewParameters = Engine_Api::_()->getDbtable('parameters', 'courses')->getParameterResult(array('category_id'=>$this->item->category_id));?>
<?php if(count($reviewParameters)):?>
  <?php foreach($reviewParameters as $value):?>
    <div class="form-wrapper courses_form_review_star">
      <div class="form-label"><label><?php echo $this->translate($value['title']); ?></label></div>
      <div id="courses_review_rating" class="sesbasic_rating_parameter courses_rating_star_element" onmouseout="rating_out_review(<?php echo $value['parameter_id'] ?>);">
...
<script type="text/javascript">
  ...
  window.addEvent('domready', function() { 
    var countExistsParam = sesJqueryObject('.courses_review_values');
