    ...
    <div class="_cont">
      <div class="sesbasic_pulldown_wrapper _option">
        ...
        <div class="sesbasic_pulldown_options">
          <ul class="_isicon">
            <li><a href="<?php echo $this->url(array('classroom_id' => $item->classroom_id,'service_id' => $item->service_id, 'action'=>'editservice'),'classroom_dashboard',true);?>" class="sessmoothbox sesbasic_icon_edit"><?php echo $this->translate("Edit");?></a></li>
            <li><a href="<?php echo $this->url(array('classroom_id' => $item->classroom_id,'service_id' => $item->service_id,'action'=>'deleteservice'),'classroom_dashboard',true);?>" class="sessmoothbox sesbasic_icon_delete"><?php echo $this->translate("Delete");?></a></li>
          </ul>
        </div>
      </div>
