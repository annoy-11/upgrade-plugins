 ...
 * @version    $Id: create-slide.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
...
<div class="courses_search_reasult">
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'courses', 'controller' => 'manage-offer', 'action' => 'manage','id'=>$this->offer_id), $this->translate("Back to Manage Custom Offers") , array('class'=>'sesbasic_icon_back buttonlink')); ?>
</div>
<br />
<div class='clear'>
  <div class='settings courses_admin_form'>
