 ...
 * @version    $Id: profile-field.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
...
<?php } ?>
    <div class="courses_dashboard_form <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('courses.create.form', 1)):?>courses_create_form<?php endif;?>">
