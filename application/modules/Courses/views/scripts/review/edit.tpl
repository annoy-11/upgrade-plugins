...
?>
<div id="courses_review_rate"></div>
  <li class="sesbasic_clearfix courses_reviews">
    ...
    <div class="courses_review_listing_desc sesbasic_clearfix">
      ...
      <?php endif; ?>
      <p class="courses_review_listing_recommended"> <b><?php echo $this->translate('Recommended');?><i class="<?php if($this->review->recommended):?>fa fa-check<?php else:?>fa fa-times<?php endif;?>"></i></b></p>
      ...
      <?php  echo $this->partial('_reviewOptions.tpl','courses',array('subject'=>$this->review,'viewer'=> Engine_Api::_()->user()->getViewer(),'stats'=>$this->stats)); ?>
  </li>
<div class="rating_params">
  ...
  <div id="courses_review_create_form" class="" style="display:none;position:relative;">
