 ...
 * @version    $Id: course-reviews.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
      ...
      <div class='settings courses_Reviews_form'>
            ...
            <div class="sesbasic_tip clearfix">
              ...
              <span class="sesbasic_text_light">
                <?php echo $this->translate('You have not posted any review on courses.') ?>
              </span>
            </div>
          <?php endif; ?>
          <?php  if(($this->paginator->getTotalItemCount() == 0) && $this->is_search_ajax):  ?>
...
sesJqueryObject('#courses-search-order-img').hide();
 sesJqueryObject(document).on('submit','#filter_form',function(event){
  ...
  new Request.HTML({
			method: 'get',
			url :  en4.core.baseUrl + 'courses/manage-account/course-reviews/',
			data : {
				format : 'html',
