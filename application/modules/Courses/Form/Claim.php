...
class Courses_Form_Claim extends Engine_Form
{
  public function init() {
    $this->setTitle('Claim For Course')
      ->setDescription('')
      ->setAttrib('name', 'courses_calim')
      ->setAttrib('id', 'courses_claim_create');
    $viewer = Engine_Api::_()->user()->getViewer();
    $translate = Zend_Registry::get('Zend_Translate');
    $this->addElement('Text', 'title', array(
      'label' => $translate->translate('Title'),
      'placeholder' => $translate->translate('Enter Course Title'),
      'allowEmpty' => false,
      'required' => true,
      'filters' => array(
