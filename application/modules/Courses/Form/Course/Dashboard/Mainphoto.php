 ...
 */
class Courses_Form_Course_Dashboard_Mainphoto extends Engine_Form {
  ...
  public function init() {
    ...
    $mainPhotoEnable = Engine_Api::_()->getApi('settings', 'core')->getSetting('courses.mainPhoto.mandatory', '1');
