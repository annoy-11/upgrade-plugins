...
class Courses_Form_Course_Dashboard_Viewdesign extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('Profile Classroom Layouts')
            ...
            ->setMethod("POST");
    $chooselayoutVal = json_decode(Engine_Api::_()->authorization()->getPermission($viewer->level_id, 'classroom', 'cls_slstyle'));
    $designoptions = array();
