...
class Courses_Form_Course_Dashboard_Policy extends Engine_Form {

  public function init() {
    $this->setTitle('Change Course Policies')
    ...
    $this->addElement('TinyMce', 'term_and_condition', array(
        ...
        'description' => 'Compose the “Terms and Conditions” for your Course.',
     ...
     $this->addElement('TinyMce', 'return_policy', array(
        'label' => 'Return Policy',
        'description' => 'Compose the Policy for your Course.',
        'placeholder'=>'Start writing your course policy.',
        'editorOptions' => $editorOptions,
    ));
