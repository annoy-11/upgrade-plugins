 ...
 * @version    $Id: CategoryIcon.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Courses_Form_Admin_Classroom_CategoryIcon extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', 'titleC', array(
        'label' => 'Enter title for this block.',
        'value' => 'What are you in the mood for?',
    ));
    $this->addElement('Select', 'criteria', array(
        'label' => "Choose the order of the categories to be shown in this widget.",
        'multiOptions' => array(
    ...
    $this->addElement('Select', 'show_bg_color', array(
        ...
        'multiOptions' => array(
            1 => 'Yes,  show chosen color.(Choose background color below).',
