...
class Courses_Form_Admin_Classroom_Browse extends Engine_Form {
  ...
  public function init() {
    ...
    if (1) {
      $categories = Engine_Api::_()->getDbTable('categories', 'courses')->getCategoriesAssoc(array('type'=>'classroom'));
    ...
    $this->addElement('Select','show_item_count',array(
        'label' => 'Do you want to show Classrooms count in this widget?',
