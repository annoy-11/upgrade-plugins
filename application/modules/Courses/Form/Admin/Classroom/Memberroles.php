 ...
 */
class Courses_Form_Admin_Classroom_Memberroles extends Engine_Form {
  ...
  public function init() {
    ...
    $classroomRoles['create_sub_classroom'] = 'Allow to Create Sub Classrooms.';
    $classroomRoles['allow_schedult_post'] = 'Allow to Schedule Posts.';

    $classroomRoles['manage_promotions'] = 'Allow to View Dashboard and Manage Classroom Promotions.';
