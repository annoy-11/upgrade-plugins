 ...
 */
class Courses_Form_Admin_Classroom_Categorywidget extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($banner_options) > 1) {
      $this->addElement('Select', 'eclassroom_categorycover_photo', array(
          'label' => 'Course Category Default Cover Photo',
          'description' => 'Choose a default cover photo for the Classrooms categories on your website. [Note: Add a new photo from the "File & Media Manager" section. For default cover photo, leave the field blank.]',
    ...
    $this->addElement('Select', "show_popular_classroom", array(
        'label' => "Do you want to show popular classrooms in this widget?",
        'multiOptions' => array('1' => 'Yes,want to show popular classrooms', 0 => 'No,don\'t want to show popular classrooms'),
        'value' => 1,
    ));
    $this->addElement('Text', "title_pop", array(
        'label' => "Enter the title for classroom section.",
        'value' => 'Popular Classroom',
    ));
...
//     ));
    ...
    $this->addElement('Text', 'height_advgrid', array(
        'label' => 'Enter the height of classroom (in pixels)',
        'value' => '180',
        'validators' => array(
            array('Int', true),
            array('GreaterThan', true, array(0)),
