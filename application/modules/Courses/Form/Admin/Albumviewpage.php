 ...
 * @version    $Id: Albumviewpage.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Courses_Form_Admin_Albumviewpage extends Engine_Form {
  ...
  public function init() {
        ...
        $this->addElement('Select', "fixHover", array(
            ...
            'multiOptions' => array('fix' => 'Always','hover' => 'On Mouse-over'),
            'value' => 'fix',
        ));
