 ...
 * @version    $Id: CourseFieldValueLoop.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Courses_View_Helper_CoursesFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function coursesFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'courses' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
