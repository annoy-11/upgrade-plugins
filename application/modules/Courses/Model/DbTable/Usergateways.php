 ...
 * @version    $Id: Usergateways.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Courses_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_rowClass = 'Courses_Model_Usergateway';
  ...
  public function getEnabledGatewayCount()
  {
	...
	public function getUserGateway($params = array()){
			$select = $this->select()->from($this->info('name'))->where('course_id =?',$params['course_id']);
