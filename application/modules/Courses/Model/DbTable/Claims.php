...
class Courses_Model_DbTable_Claims extends Engine_Db_Table {
  protected $_rowClass = "Courses_Model_Claim";
   ...
   */
  public function getCourseClaimsPaginator($params = array()) {
    $paginator = Zend_Paginator::factory($this->getCourseClaimsSelect($params));
   ...
   */
  public function getCourseClaimsSelect($params = array()) {
