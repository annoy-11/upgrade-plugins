 ...
 * @version    $Id: SeslistingFieldValueLoop.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslisting_View_Helper_SeslistingFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function seslistingFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'seslisting' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
