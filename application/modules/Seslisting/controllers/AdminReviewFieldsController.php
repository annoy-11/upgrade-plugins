 ...
 * @version    $Id: AdminReviewFieldsController.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_AdminReviewFieldsController extends Fields_Controller_AdminAbstract {
  ...
  public function indexAction() {
    ...
    $this->view->subsubNavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('seslisting_admin_main_revwcat', array(), 'seslisting_admin_main_review_subfields');
  ...
  public function fieldCreateAction() {
    ...
    if ($content_type == 'seslisting_category') {
      $content_type = 'seslisting';
    }
