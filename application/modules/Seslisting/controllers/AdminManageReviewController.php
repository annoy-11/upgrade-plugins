 ...
 * @version    $Id: AdminManageReviewController.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_AdminManageReviewController extends Core_Controller_Action_Admin {
  ...
  public function reviewSettingsAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('seslisting_admin_main_rwsettings', array(), 'seslisting_admin_main_subreviewsettings');
  ...
  public function manageAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('seslisting_admin_main_rwsettings', array(), 'seslisting_admin_main_submanagereview');
