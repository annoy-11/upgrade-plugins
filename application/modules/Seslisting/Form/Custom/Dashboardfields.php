 ...
 * @version    $Id: Dashboardfields.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslisting_Form_Custom_Dashboardfields extends Engine_Form {
  /* Custom */
  ...
  public function generate() {
    ...
    $orderIndex = 0;
		$package = Engine_Api::_()->getItem('seslistingpackage_package',$this->getItem()->package_id);
