 ...
 * @version    $Id: Search.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'seslisting', 'controller' => 'index', 'action' => 'browse'), 'default', true));
    ...
    if ($this->_locationSearch == 'yes' && $this->getSearchFor() == 'listing') {
      /*Location Elements*/
