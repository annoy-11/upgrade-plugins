 ...
 * @version    $Id: OtherModulesTabbed.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_Form_Admin_OtherModulesTabbed extends Engine_Form {

  public function init() {

    $this->addElement('MultiCheckbox', "enableTabs", array(
      'label' => "Choose the View Type for Listings.",
      'multiOptions' => array(
      'list' => 'List View',
   ...
   $categories = array('' => '') + $categories;
    ...
    $this->addElement('Select', "show_limited_data", array(
			'label' => 'Show only the number of listings entered in above setting. [If you choose No, then you can choose how do you want to show more listings in this widget.]',
			 'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
 ...
 //      'label' => 'Count for Grid Views 4 (number of listings to show).',
 //      'value' => 10,
 //      'validators' => array(
	// array('Int', true),
	// array('GreaterThan', true, array(0)),
