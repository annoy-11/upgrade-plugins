 ...
 * @version    $Id: SidebarTabbed.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_Form_Admin_SidebarTabbed extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', "limit_data_list", array(
      'label' => 'Count for List Views (number of listings to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
    ...
    $this->addElement('Text', "limit_data_grid", array(
      'label' => 'Count for Grid Views (number of listings to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
