 ...
 * @version    $Id: Filter.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbtable('categories', 'seslisting')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Select', 'verified', array(
		...
		$isEnablePackage = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('seslistingpackage') && Engine_Api::_()->getApi('settings', 'core')->getSetting('seslistingpackage.enable.package', 1);
		if($isEnablePackage){
				$packages = Engine_Api::_()->getDbTable('packages','seslistingpackage')->getPackage(array('default' => true));
				$packagesArray = array(''=>'');
