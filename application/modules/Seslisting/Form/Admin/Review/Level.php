...
class Seslisting_Form_Admin_Review_Level extends Authorization_Form_Admin_Level_Abstract {
    ...
    $this->setTitle('Member Level Settings')
	   ...
	   // Element: view
		$this->addElement('Radio', 'view', array(
			...
			'description' => 'Do you want to let members view reviews on listings?',
			'multiOptions' => array(
      ...
      $this->addElement('Radio', 'create', array(
          ...
          'description' => 'Do you want to let members write reviews on listings?',
          'multiOptions' => array(
