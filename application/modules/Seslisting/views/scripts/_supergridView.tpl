 ...
 * @version    $Id: _supergridView.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<li class="seslisting_new_grid_block sesbasic_bxs <?php if((isset($this->my_listings) && $this->my_listings)){ ?>isoptions<?php } ?>" style="width:<?php echo is_numeric($this->width_supergrid) ? $this->width_supergrid.'px' : $this->width_supergrid ?>;">
		...
		<?php if(isset($this->categoryActive)): ?>
		  <?php if($item->category_id != '' && intval($item->category_id) && !is_null($item->category_id)):?> 
			  <?php $categoryItem = Engine_Api::_()->getItem('seslisting_category', $item->category_id);?>
				<?php if($categoryItem):?>
			    <div class="seslisting_grid_info_title"><a href="<?php echo $categoryItem->getHref(); ?>"><?php echo $categoryItem->category_name; ?></a></div>
			  <?php endif;?>
			<?php endif;?>
		<?php endif; ?>
		<div class="seslisting_grid_thumb seslisting_thumb" style="height:<?php echo is_numeric($this->height_supergrid) ? $this->height_supergrid.'px' : $this->height_supergrid ?>;">
      ...
      <?php if(isset($this->verifiedLabelActive) && $item->verified == 1):?>
		...
		<div class="seslisting_grid_info clear clearfix sesbm">
		  <?php if(isset($this->creationDateActive)){ ?>
				<div class="seslisting_grid_date_listing">
			...
			<?php if(isset($this->titleActive)): ?>
				<div class="seslisting_second_grid_info_title">
			...
			<?php } ?>
			<div class="seslisting_comment_list seslisting_list_stats sesbasic_text_dark">
		...
		<?php if(isset($this->readmoreActive)):?>
			<div class="seslisting_second_readmore_link">
