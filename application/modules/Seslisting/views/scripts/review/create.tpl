 ...
 */
 ...
 ?>
<style>
.seslisting_review_form .global_form div.form-label label.requiredstart:after{content: " *";color: #f00;}
</style>
...
<?php 
	...
	$profile_type = 2;
  echo $this->partial('_customFields.tpl', 'seslisting', array()); 
?>

<?php $tab_id = Engine_Api::_()->sesbasic()->getWidgetTabId(array('name' => 'seslisting.listing-reviews'));?>
<div class="clear seslisting_order_view_top" style="margin:10px;">
	<a href="<?php echo $this->item->getHref().'/tab/'.$tab_id; ?>" class="buttonlink sesbasic_icon_back"><?php echo $this->translate("Back To Listing"); ?></a>
</div>
...
<script>
 ...
 function showFields(cat_value, cat_level,typed,isLoad) {
  ...
  var getProfileType = function(category_id) {
    var mapping = <?php echo Zend_Json_Encoder::encode(Engine_Api::_()->getDbTable('categories', 'seslisting')->getMapping(array('category_id', 'profile_type_review'))); ?>;
  ...
  en4.core.runonce.add(function() {
		sesJqueryObject('.seslisting_form_rating_star').find('label').addClass('requiredstart');
...
<div class="seslisting_review_form"> 
