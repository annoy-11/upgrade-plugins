 ...
 * @version    $Id: _sidebartabbedlist.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
...
<?php if(!$this->is_ajax){ ?>
  <div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">
    <ul class="seslisting_listing_listing sesbasic_clearfix clear" id="sidebar-tabbed-widget_<?php echo $randonNumber; ?>" style="min-height:50px;">
<?php } ?>
...
<?php foreach( $this->paginator as $item ): ?>
  ...
  <?php if($this->view_type == 'list'){ ?>
    <li class="seslisting_sidebar_listing_list sesbasic_clearfix">
			<div class="seslisting_sidebar_listing_list_img" style="height:<?php echo is_numeric($this->height_list) ? $this->height_list.'px' : $this->height_list ?>;width:<?php echo is_numeric($this->width_list) ? $this->width_list.'px' : $this->width_list ?>;">
      ...
      <div class="seslisting_sidebar_listing_list_cont">
        <div class="seslisting_sidebar_listing_list_title">
      ...
      <div class="seslisting_grid_thumb" style="height:<?php echo is_numeric($this->height_grid) ? $this->height_grid.'px' : $this->height_grid ?>;">
        ...
        <div class="seslisting_grid_hover_block">
          ...
          <div class="seslisting_grid_hover_block_footer">
            ...
            <div class="seslisting_grid_read_btn floatR"><a href="<?php echo $href; ?>">Read More...</a></div>
          </div>
        </div>
          ...
          <div class="seslisting_list_grid_thumb_btns">
            ...
            <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 ):?>
              ...
              <?php if(isset($this->likeButtonActive) && $canComment):?>
                ...
                <a href="javascript:;" data-url="<?php echo $item->listing_id ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn seslisting_like_seslisting_listing <?php echo ($LikeStatus) ? 'button_active' : '' ; ?>"> <i class="fa fa-thumbs-up"></i><span><?php echo $item->like_count; ?></span></a>
              <?php endif;?>
              <?php if(isset($this->favouriteButtonActive) && isset($item->favourite_count) && Engine_Api::_()->getApi('settings', 'core')->getSetting('seslisting.enable.favourite', 1)): ?>
                ...
                <a href="javascript:;" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn seslisting_favourite_seslisting_listing <?php echo ($favStatus)  ? 'button_active' : '' ?>"  data-url="<?php echo $item->listing_id ; ?>"><i class="fa fa-heart"></i><span><?php echo $item->favourite_count; ?></span></a>
              <?php endif;?>
            <?php endif;?>
          </div>
        </div>
...
<?php if(!$this->is_ajax){ ?>
  ...
  <?php if($this->loadOptionData != 'pagging' && !($this->show_limited_data)):?>
    <div class="sesbasic_view_more seslisting_listing_listing_more" id="view_more_<?php echo $randonNumber;?>" onclick="viewMore_<?php echo $randonNumber; ?>();" > <?php echo $this->htmlLink('javascript:void(0);', $this->translate('View More'), array('id' => "feed_viewmore_link_$randonNumber", 'class' => 'buttonlink fa fa-arrow-circle-o-down')); ?> </div>
