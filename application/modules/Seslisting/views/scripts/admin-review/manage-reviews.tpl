 ...
 * @version    $Id: manage-reviews.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
				    ...
				    <table class='admin_table'>
				      ...
				      <tbody>
				        ...
				        <tr>
				          ...
				          <td>
				            <?php $contentItem = Engine_Api::_()->getItem('seslisting', $item->listing_id); ?>
				            <?php if($contentItem) { ?>
				            <?php echo $this->htmlLink($contentItem->getHref(), $this->translate(Engine_Api::_()->sesbasic()->textTruncation($contentItem->getTitle(),16)), array('title' => $contentItem->getTitle(), 'target' => '_blank')) ?>
				             <?php } else { ?>
                      <?php echo "---"; ?>
				             <?php } ?>
                  </td>
				          ...
				          <td><?php echo $this->htmlLink($item->getOwner()->getHref(), $this->translate(Engine_Api::_()->sesbasic()->textTruncation($item->getOwner()->getTitle(),16)), array('title' => $this->translate($item->getOwner()->getTitle()), 'target' => '_blank')) ?></td>
									<td class='admin_table_centered'>
										<?php echo ( $item->featured ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review', 'action' => 'featured', 'review_id' => $item->review_id), $this->htmlImage($baseURL . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Unmark as Featured'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review', 'action' => 'featured', 'review_id' => $item->review_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Mark Featured')))) ) ?>
									</td>
									<td class='admin_table_centered'>
										<?php echo ( $item->verified ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review', 'action' => 'verified', 'review_id' => $item->review_id), $this->htmlImage($baseURL . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Unmark as Verified'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review', 'action' => 'verified', 'review_id' => $item->review_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Mark Verified')))) ) ?>
									</td>
									<td class='admin_table_centered'>
										<?php if($item->oftheday == 1):?>  
											<?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seslisting', 'controller' => 'admin-review', 'action' => 'oftheday', 'id' => $item->review_id, 'param' => 0), $this->htmlImage($baseURL . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit Listing Review of the Day'))), array('class' => 'smoothbox')); ?>
										<?php else: ?>
											<?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seslisting', 'controller' => 'admin-review', 'action' => 'oftheday', 'id' => $item->review_id, 'param' => 1), $this->htmlImage($baseURL . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make Listing Review of the Day'))), array('class' => 'smoothbox')) ?>
										<?php endif; ?>
									</td>
				          <td>
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seslisting', 'controller' => 'admin-review', 'action' => 'view', 'id' => $item->review_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
				            |
				            <?php echo $this->htmlLink($item->getHref(), $this->translate("View"), array('class' => '')); ?>
				            |
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seslisting', 'controller' => 'admin-review', 'action' => 'delete-review', 'id' => $item->review_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
				          </td>
				        </tr>
				        <?php endforeach; ?>
				      </tbody>
