          ...
          <table class='admin_table' style="width: 100%;">
            <thead>
              <tr>
               ...
               <!--  <th> echo // $this->translate("Profile Type")</th> -->
            ...
            <tbody>
              ...
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-article-id="<?php echo $category->category_id; ?>">
                ...
                <?php $reviewParameter = Engine_Api::_()->getDbtable('parameters', 'seslisting')->getParameterResult(array('category_id'=>$category->category_id)); ?>
                <td>
                <?php 
                $titleEAC = 'Add';
                if(count($reviewParameter)){ 
                	$titleEAC = 'Edit';
                ?>
                <ul class="seslisting_parameters_list">
                ...
                <!--<td>  echo // $category->profile_type_review && isset($this->profiletypes[$category->profile_type_review]) ? $this->profiletypes[$category->profile_type_review] : '-' ; </td>-->
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review-categories', 'action' => 'edit-category', 'id' => $category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review-categories', 'action' => 'review-parameter', 'id' => $category->category_id), $this->translate($titleEAC.' Parameter'), array('class'=>'smoothbox')); ?>
              </tr>
              	<?php if($category->category_id == 0): ?>
                    <?php continue; ?>
                    <?php endif; ?>
              <?php //Subcategory Work
                    $subcategory = Engine_Api::_()->getDbtable('categories', 'seslisting')->getModuleSubcategory(array('column_name' => "*", 'category_id' => $category->category_id));              foreach ($subcategory as $sub_category):  ?>
              <tr id="categoryid-<?php echo $sub_category->category_id; ?>" data-article-id="<?php echo $sub_category->category_id; ?>">
                ...
                <?php $reviewParameter = Engine_Api::_()->getDbtable('parameters', 'seslisting')->getParameterResult(array('category_id'=>$sub_category->category_id)); ?>
                <td>
                <?php $titleEASC = 'Add';
                	if(count($reviewParameter)){ 
                  $titleEASC = 'Edit';
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review-categories', 'action' => 'edit-category', 'id' => $sub_category->category_id), $this->translate('Edit'), array()) ?> 	| <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review-categories', 'action' => 'review-parameter', 'id' => $sub_category->category_id), $this->translate($titleEASC.' Parameter'), array('class'=>smoothbox)) ?>  	</td>
              </tr>
              <?php 
                		//SubSubcategory Work
                    $subsubcategory = Engine_Api::_()->getDbtable('categories', 'seslisting')->getModuleSubsubcategory(array('column_name' => "*", 'category_id' => $sub_category->category_id));
              ...
              <tr id="categoryid-<?php echo $subsub_category->category_id; ?>" data-article-id="<?php echo $subsub_category->category_id; ?>">
                ...
                <?php $reviewParameter = Engine_Api::_()->getDbtable('parameters', 'seslisting')->getParameterResult(array('category_id'=>$subsub_category->category_id)); ?>
                <td>
                <?php 
                $titleEASSC = 'Add';
                if(count($reviewParameter)){ 
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review-categories', 'action' => 'edit-category', 'id' => $subsub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslisting', 'controller' => 'review-categories', 'action' => 'review-parameter', 'id' => $subsub_category->category_id), $this->translate($titleEASSC.' Parameter'), array('class'=>smoothbox)) ?>  
              </tr>
              <?php endforeach; ?>
              <?php endforeach; ?>
              <?php endforeach; ?>
