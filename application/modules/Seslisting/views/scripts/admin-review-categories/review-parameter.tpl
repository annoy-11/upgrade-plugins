 ...
 * @version    $Id: review-parameter.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
...
<div class='clear'>
  <div class='settings global_form_popup seslisting_review_parameter_popup'>
    <?php echo $this->form->render($this); ?>
  </div>
</div>

<script type="application/javascript">
var alreadyaddedParameter = sesJqueryObject('.seslisting_review_added_parameter');
if(alreadyaddedParameter.length > 0){
	for(var i=0;i<alreadyaddedParameter.length;i++){
		var id = sesJqueryObject(alreadyaddedParameter[i]).attr('id').replace('seslisting_review_','');
