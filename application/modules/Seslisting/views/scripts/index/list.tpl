 ...
 * @version    $Id: list.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
...
<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
  <ul class='seslistings_entrylist'>
...
<?php elseif( $this->category || $this->tag ): ?>
  <div class="tip">
    <span>
      <?php echo $this->translate('%1$s has not published a listing entry with that criteria.', $this->owner->getTitle()); ?>
    </span>
  </div>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate('%1$s has not written a listing entry yet.', $this->owner->getTitle()); ?>
    </span>
  </div>
<?php endif; ?>
