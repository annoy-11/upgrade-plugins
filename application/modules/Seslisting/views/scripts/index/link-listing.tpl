 ...
 * @version    $Id: link-listing.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    var id = '<?php echo $this->listing_id; ?>';
    
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'seslisting/index/link-listing/listing_id/' + id ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate('Events in which you can link to listing') ?>
...
<?php endif; ?>
    ...
    <?php if (count($this->paginator) > 0) : ?>
      <form id='link_listing' name="link_listing" method="post" action="<?php echo $this->url();?>">
