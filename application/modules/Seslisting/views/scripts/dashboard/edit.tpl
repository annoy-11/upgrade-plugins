 ...
 * @version    $Id: edit.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
...
<?php if(!$this->is_ajax){ ?>
  <?php
  echo $this->partial('dashboard/left-bar.tpl', 'seslisting', array(
  'listing' => $this->listing,
  ));	
  ?>
  <div class="sesbasic_dashboard_content sesbm sesbasic_clearfix">
<?php } ?>
<div class="sesbasic_dashboard_form seslisting_create_form sesbasic_bxs">
...
<?php echo $this->partial('_customFields.tpl', 'seslisting', array()); ?>

<script type="text/javascript">
  en4.core.runonce.add(function()
  {
    showHideHeight('<?php echo $this->listing->cotinuereading; ?>');
...
//prlisting form submit on enter
...
var counter = 0;
  function validateForm(){
    ...
    jqueryObjectOfSes('#seslistings_edit input, #seslistings_edit select,#seslistings_edit checkbox,#seslistings_edit textarea,#seslistings_edit radio').each(
      function(index){
  ...
  jqueryObjectOfSes('#seslistings_edit').submit(function(e){
    var validationFm = validateForm();
		if(!validationFm && sesJqueryObject('#seslisting_schedule_time').length > 0 ) {
