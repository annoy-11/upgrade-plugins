 ...
 * @version    $Id: review-rating.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<div class="form-wrapper seslisting_form_rating_star">
  <div class="form-label"><label><?php echo $this->translate("Overall Rating"); ?></label></div>
  <div id="seslisting_review_rating" class="sesbasic_rating_star seslisting_rating_star_element" onmouseout="rating_out();">
...
function validateForm(){
		...
		counter = 0;
		sesJqueryObject('#seslisting_review_form input, #seslisting_review_form select,#seslisting_review_form checkbox,#seslisting_review_form textarea,#seslisting_review_form radio').each(
				function(index){
			...
			en4.core.runonce.add(function()
				{
			sesJqueryObject('#seslisting_review_form').submit(function(e){
					var validationFm = validateForm();
					if(!sesJqueryObject('#rate_value').val()){
						alert('<?php echo $this->translate("Please fill the red mark fields"); ?>');
						 var errorFirstObject = sesJqueryObject('#seslisting_review_rating').parent();
