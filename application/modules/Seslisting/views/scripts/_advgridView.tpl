 ...
 * @version    $Id: _advgridView.tpl  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<li class="seslisting_last_grid_block sesbasic_bxs <?php if((isset($this->my_listings) && $this->my_listings)){ ?>isoptions<?php } ?>" style="width:<?php echo is_numeric($this->width_advgrid) ? $this->width_advgrid.'px' : $this->width_advgrid ?>;">
		<div class="seslisting_grid_inner">
			<div class="seslisting_gird-top_listing">
			  <?php if(isset($this->categoryActive)){ ?>
			    <?php if($item->category_id != '' && intval($item->category_id) && !is_null($item->category_id)):?> 
			      <?php $categoryItem = Engine_Api::_()->getItem('seslisting_category', $item->category_id);?>
					  <?php if($categoryItem):?>
							<div class="seslisting_grid_info_title floatL"><a href="<?php echo $categoryItem->getHref(); ?>"><?php echo $categoryItem->category_name; ?></a></div>
					  <?php endif;?>
					<?php endif;?>
				<?php } ?>
				<?php if(isset($this->creationDateActive)){ ?>
					<div class="seslisting_grid_date_listing floatR">
		...
		<div class="seslisting_grid_thumb seslisting_thumb" style="height:<?php echo is_numeric($this->height_advgrid) ? $this->height_advgrid.'px' : $this->height_advgrid ?>;">
		...
		<div class="seslisting_grid_info clear clearfix sesbm">
			<div class="seslisting_grid_meta_block">
				...
				<?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('seslisting.enable.location', 1)){ ?>
					<div class="seslisting_list_stats seslisting_list_location sesbasic_text_dark">
						<span>
			...
			<?php if(Engine_Api::_()->getApi('core', 'seslisting')->allowReviewRating() && isset($this->ratingStarActive)):?>
					<?php echo $this->partial('_listingRating.tpl', 'seslisting', array('rating' => $item->rating, 'class' => 'seslisting_list_rating seslisting_list_view_ratting floatR', 'style' => 'margin:0px;'));?>
				<?php endif;?>
      <?php if(isset($this->titleActive)): ?>
				<div class="seslisting_grid_three_info_title">
			...
			<?php if(isset($this->readmoreActive)):?>
				<div class="seslisting_second_readmore_link floatR">
