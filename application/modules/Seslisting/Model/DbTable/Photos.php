...
class Seslisting_Model_DbTable_Photos extends Engine_Db_Table
{
  protected $_rowClass = 'Seslisting_Model_Photo';

  	public function getPhotoSelect($params = array())
  {
    $select = $this->select();

    if( !empty($params['album']) && $params['album'] instanceof Seslisting_Model_Album ) {
