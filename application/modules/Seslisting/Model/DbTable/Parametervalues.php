 ...
 * @version    $Id: Parametervalues.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslisting_Model_DbTable_Parametervalues extends Engine_Db_Table {
  protected $_rowClass = 'Seslisting_Model_Parametervalue';
	protected $_name  = 'seslisting_review_parametervalues';
	public function getParameters($params = array()){
		$pTable = Engine_Api::_()->getDbtable('parameters', 'seslisting');
  ...
  public function getRating($parameter_id) {
    $rating_sum = $this->select()
            ...
            ->fetchColumn(0)
    ;
    $total = $this->ratingCount($parameter_id, $resource_type = 'seslisting_event');
    if ($total)
