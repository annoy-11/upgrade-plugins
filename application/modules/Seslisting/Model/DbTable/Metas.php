 ...
 * @version    $Id: Metas.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslisting_Model_DbTable_Metas extends Engine_Db_Table {

  protected $_name = 'seslistingreview_fields_meta';
  protected $_rowClass = 'Seslisting_Model_Meta';

	public function getMetaData($options_id = null){
		if(!$options_id)
			return null;
		$tableName = $this->info('name');
		$mapTableName = Engine_Api::_()->getDbTable('maps','seslisting')->info('name');
  ...
  public function profileFieldId() {
	...
	public function reviewProfileFieldId() {
	  $table = Engine_Api::_()->fields()->getTable('seslistingreview', 'metas');
		return $table->select()
