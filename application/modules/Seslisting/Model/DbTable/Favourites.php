 ...
 * @version    $Id: Favourites.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslisting_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Seslisting_Model_Favourite";
  ...
  public function isFavourite($params = array()) {
    ...
    $viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity();
     $select = $this->select()
		...
		$tableFav = Engine_Api::_()->getDbtable('favourites', 'seslisting');
