 ...
 * @version    $Id: Photo.php  2019-04-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslisting_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'seslisting_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'seslisting_album';
...
//   }
  ...
  public function getAlbum() {
    return Engine_Api::_()->getItem('seslisting_album', $this->album_id);
  }
  ...
  public function getAlbumPhotoUrl($type = null) {
    ...
    if (!$photo_id) {
      return 'application/modules/Seslisting/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
  ...
  public function getAuthorizationItem() {
    return $this->getParent('seslisting');
  }
  ...
  protected function _postDelete() {
    ...
    try {
      ...
      $listingItem = Engine_Api::_()->getItem("seslisting", $this->listing_id);
      ...
      if (isset($listingItem)) {
        $photoItem = Engine_Api::_()->getItem("seslisting_photo", $listingItem->photo_id);
        if (!$photoItem) {
          $listingItem->photo_id = 0;
          $listingItem->save();
        }
      }
    } catch (Exception $e) {
