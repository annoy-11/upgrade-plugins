...
class Seslisting_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'seslisting';

  protected $_owner_type = 'seslisting';

  protected $_children_types = array('seslisting_photo');

  protected $_collectible_type = 'seslisting_photo';

//   public function getHref($params = array())
//   {
//     return $this->getSeslisting()->getHref($params);
//   }
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Seslisting/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $seslistingPhoto ) {
      $seslistingPhoto->delete();
    }
