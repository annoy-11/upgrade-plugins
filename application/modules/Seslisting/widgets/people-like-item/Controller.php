 ...
 */
class Seslisting_Widget_PeopleLikeItemController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!Engine_Api::_()->core()->hasSubject('seslisting'))
      return $this->setNoRender();
		...
		if(Engine_Api::_()->core()->hasSubject('seslisting'))
   	 $this->view->subject = $subject = Engine_Api::_()->core()->getSubject('seslisting');
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->seslisting()->likeItemCore($param);
