 ...
 */
class Seslisting_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = $paginator = Engine_Api::_()->getDbTable('seslistings', 'seslisting')->getSeslistingsPaginator($value);
