...
<?php if($this->view_type == 'list'): ?>
  <ul id="widget_seslisting_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block sesbasic_sidebar_block seslisting_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php else: ?>
  <ul id="widget_seslisting_<?php echo $randonnumber; ?>" class="seslisting_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php endif; ?>
  <div class="sesbasic_loading_cont_overlay" id="seslisting_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php include APPLICATION_PATH . '/application/modules/Seslisting/views/scripts/_sidebarWidgetData.tpl'; ?>
