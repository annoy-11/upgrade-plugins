...
if($this->params['bgimage']) { 
  ...
  $bgimage = 'application/modules/Seslisting/externals/images/search-banner-bg.jpg';
}
?>
<div class="seslisting_banner_search_wrapper sesbasic_clearfix sesbasic_bxs _iscategorybox <?php if($this->params['show_full_width'] == 'yes'):?>isfullwidth<?php endif;?>">
    ...
    <section class="_catsection">
      <div class="_cont">
        ...
        <div class="_categorycontainer">
          <div class="seslisting_banner_categories seslisting_banner_cat_<?php echo $this->identity;?>">
            <?php foreach($this->categories as $category):?>
              <div class="_catitem _isthumb">
                <a href="<?php echo $category->getHref();?>">
                  ...
                  <?php else:?>
                    <span class="sesbasic_animation" style="background-image:url(application/modules/Seslisting/externals/images/category-thumb.png);"></span>
                  <?php endif;?>
                  <div class="_catitem_holder">
                    ...
                    <?php else:?>
                      <i class="_caticon"><img src="application/modules/Seslisting/externals/images/category-icon.png" /></i>
                    <?php endif;?>
...
<script type="application/javascript">
  seslistingJqueryObject('.seslisting_banner_cat_<?php echo $this->identity;?>').owlCarousel({
    nav :true,
    loop:false,
    items:5,
    autoplay:false,
