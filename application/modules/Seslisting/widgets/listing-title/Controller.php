...
class Seslisting_Widget_ListingTitleController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listing = Engine_Api::_()->getItem('seslisting', $listing_id);
    else
    $this->view->listing = Engine_Api::_()->core()->getSubject();
  }
