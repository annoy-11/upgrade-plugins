 ...
 */
class Seslisting_Widget_OtherModulesProfileSeslistingsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'other-modules-profile-seslistings';
