 ...
 */
class Seslisting_Widget_ListingsSlideshowController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->socialshare_icon_limit = $this->_getParam('socialshare_icon_limit', 2);
		...
		$this->view->leftListing = $this->_getParam('leftListing', 1);
    ...
    $value['fetchAll'] = true;
		$value['limit'] = 3;
    $this->view->paginatorLeft = $paginatorLeft = Engine_Api::_()->getDbTable('seslistings', 'seslisting')->getSeslistingsSelect($value);
    ...
    $this->view->paginatorRight = $paginatorRight = Engine_Api::_()->getDbTable('seslistings', 'seslisting')->getSeslistingsSelect($valueRight);
  }
}
