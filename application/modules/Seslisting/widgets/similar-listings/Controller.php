...
class Seslisting_Widget_SimilarListingsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_ajax) {
      ...
      if(!$category_id)
		...
		$this->view->widgetName = 'similar-listings';
    ...
    $value['widgetName'] = 'Similar Listings';
