...
<?php if(!$this->is_ajax): ?>
  <div class="ses_member_img_view" id="scrollHeightDivSes_<?php echo $randonNumber; ?>">
    <ul id="listing_contributors_<?php echo $randonNumber; ?>" style="position:relative;">
<?php endif;?>
    ...
    function viewMore_<?php echo $randonNumber; ?> (){
      ...
      requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
        ...
        onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
          ...
          document.getElementById('listing_contributors_<?php echo $randonNumber; ?>').innerHTML = document.getElementById('listing_contributors_<?php echo $randonNumber; ?>').innerHTML + responseHTML;
    ...
    function paggingNumber<?php echo $randonNumber; ?>(pageNum){
      ...
      requestViewMore_<?php echo $randonNumber; ?> = (new Request.HTML({
        ...
        onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
          ...
          document.getElementById('listing_contributors_<?php echo $randonNumber; ?>').innerHTML =  responseHTML;
        }
      }));
      requestViewMore_<?php echo $randonNumber; ?>.send();
      return false;
