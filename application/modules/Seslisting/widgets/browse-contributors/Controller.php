 ...
 */
class Seslisting_Widget_BrowseContributorsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $select = $userTable->select()
            ...
            ->join($listingTableName, $listingTableName . '.owner_id = ' . $userTableName . '.user_id ', array("COUNT($listingTableName.listing_id) as listing_count"))
    ...
    if (isset($value['info'])) {
      switch ($value['info']) {
        ...
        case 'most_contributors':
          $select->order('listing_count DESC');
          break;
        case 'most_liked':
