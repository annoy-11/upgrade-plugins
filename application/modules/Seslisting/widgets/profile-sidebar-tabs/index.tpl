...
?>
<div class="seslisting_sidebar_tabs seslisting_profile_tabs sesbasic_bxs"></div>
...
if (matchMedia('only screen and (min-width: 767px)').matches) {
	...
	sesJqueryObject('.seslisting_sidebar_tabs').html(tabs);
	//sesJqueryObject('.seslisting_sidebar_tabs').find('.tabs_alt', '.tabs_parent' ).removeClass();
});
