...
class Seslisting_Widget_TopListinggersController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
		...
		$this->view->widgetName = 'top-listinggers';
    ...
    $this->view->{$show_criteria . 'Active'} = $show_criteria;
		$this->view->paginator = $paginator = Engine_Api::_()->seslisting()->getListinggers();
