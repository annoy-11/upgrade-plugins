 ...
 */
class Seslisting_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $listingId = Engine_Api::_()->getDbTable('seslistings', 'seslisting')->getOfTheDayResults();
    $this->view->listing_id = $listingId ;
