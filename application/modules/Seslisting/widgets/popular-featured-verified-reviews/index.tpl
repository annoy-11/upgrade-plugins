...
<ul class="sesbasic_sidebar_block seslisting_review_sidebar_block sesbasic_bxs sesbasic_clearfix"  id="widget_seslisting_<?php echo $randonnumber; ?>" style="position:relative;">
	<div class="sesbasic_loading_cont_overlay" id="seslisting_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php include APPLICATION_PATH . '/application/modules/Seslisting/views/scripts/_reviewsidebarWidgetData.tpl'; ?>
</ul>
