 ...
 */
class Seslisting_Widget_tabbedWidgetListingController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $seslisting_tabbed = Zend_Registry::isRegistered('seslisting_tabbed') ? Zend_Registry::get('seslisting_tabbed') : null;
    ...
    $this->view->widgetName = 'tabbed-widget-listing';
    $params = array_merge($params, $value);

    // Get Listings
    $paginator = Engine_Api::_()->getDbtable('seslistings', 'seslisting')->getSeslistingsPaginator($params);
