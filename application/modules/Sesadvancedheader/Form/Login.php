 ...
 * @version    $Id: Login.php  2019-02-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesadvancedheader_Form_Login extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    $this->setAttrib('id', 'sesadvancedheader_form_login');
    ...
    $this->addElement('dummy', 'showhidepassword', array(
      'decorators' => array(array('ViewScript', array(
        'viewScript' => 'application/modules/Sesadvancedheader/views/scripts/showhidepassword.tpl',
      ))),
			'tabindex' => $tabindex++,			
    ));
		//SES Work For Show and Hide Password
