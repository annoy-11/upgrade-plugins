 ...
 * @version    $Id: friendship-requests.tpl  2019-02-16 00:00:00 SocialEngineSolutions $
...
<?php endif;?>
<?php if(count($this->peopleyoumayknow) > 0): ?>
  <div class="sesadvheader_pulldown_header"><?php echo $this->translate("People You May Know"); ?></div>
...
<script type="text/javascript">
  ...
  function redirectPage(event) {
    ...
    if(current_link.get('href') == null && $(current_link).get('tag')!='img') {
      ...
      new Request.JSON({
        url : en4.core.baseUrl + 'sesadvancedheader/notifications/markreadmention',
        data : {
          format     : 'json',
