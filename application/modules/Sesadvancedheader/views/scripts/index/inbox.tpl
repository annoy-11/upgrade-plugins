 ...
 * @version    $Id: inbox.tpl  2019-02-16 00:00:00 SocialEngineSolutions $
...
<?php if( count($this->paginator) ): ?>
  <div class="pulldown_content_list">
    <ul id="sesadvancedheader_messages_menu">
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesadvancedheader/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sesadvancedheader_messages_menu')){
          var message_children = $('sesadvancedheader_messages_menu').getChildren('li');
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesadvancedheader/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
