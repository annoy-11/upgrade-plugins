 ...
 * @version    $Id: manage-search.tpl  2019-02-16 00:00:00 SocialEngineSolutions $
						...
						<div style="width:20%;" class="admin_table_centered">
						  ...
						  <?php else: ?>
							  <?php if($options == 'ITEM_TYPE_VIDEO'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/video.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_ALBUM'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/album.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_ALBUM_PHOTO'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/photo.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_USER'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/user.png'; ?>" alt="">
							  <?php elseif($options == 'ITEM_TYPE_BLOG'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/blog.png'; ?>" alt="">
							  <?php elseif($options == 'ITEM_TYPE_BLOG'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/blog.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_CLASSIFIED'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/classified.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_EVENT'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/event.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_GROUP'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/group.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_FORUM_POST'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/topic.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_FORUM_TOPIC'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/topic.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_MUSIC_PLAYLIST'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/music-album.png'; ?>" alt="">
								<?php elseif($options == 'ITEM_TYPE_MUSIC_PLAYLIST_SONG'): ?>
									<img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search-icons/song.png'; ?>" alt="">
			          <?php else: ?>
								  <img src="<?php echo $base_url.'application/modules/Sesadvancedheader/externals/images/search.png'; ?>" alt="">
							  <?php endif;?>
							<?php endif;?>
						</div>
				    <div style="width:20%;" class="admin_table_centered">
				      <?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesadvancedheader', 'controller' => 'settings', 'action' => 'enabled', 'managesearchoption_id' => $item->managesearchoption_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disabled'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesadvancedheader', 'controller' => 'settings', 'action' => 'enabled', 'managesearchoption_id' => $item->managesearchoption_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enabled')))) ) ?>
						</div>
						<div style="width:20%;">
						  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesadvancedheader', 'controller' => 'settings', 'action' => 'edit-search', 'id' => $item->managesearchoption_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?>
              <?php if(!empty($item->file_id)):?>
		          | 
		          <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesadvancedheader', 'controller' => 'settings', 'action' => 'delete-search-icon', 'file_id' => $item->file_id, 'id' => $item->managesearchoption_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
		          <?php endif;?>
            </div>
          </li>
        <?php endforeach; ?>
