...
class Sessubscribeuser_Model_Usergateway extends Core_Model_Item_Abstract
{
  ...
  public function getPlugin($is_sponsorship = 'user')
  {
    if( null === $this->_plugin ) {
      $class = 'Sessubscribeuser_Plugin_Gateway_Refund_PayPal';
      Engine_Loader::loadClass('Sessubscribeuser_Plugin_Gateway_Refund_PayPal');
