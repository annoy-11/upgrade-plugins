...
class Sessubscribeuser_IpnController extends Core_Controller_Action_Standard {
  ...
  public function __call($method, array $arguments) {
    ...
    // Log ipn
    $ipnLogFile = APPLICATION_PATH . '/temporary/log/sessubscribeuser-ipn.log';
    ...
    try {
      ...
      //Get gateways
      $gatewayTable = Engine_Api::_()->getDbtable('gateways', 'sessubscribeuser');
