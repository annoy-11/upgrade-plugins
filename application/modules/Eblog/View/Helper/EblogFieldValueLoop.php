 ...
 * @version    $Id: EblogFieldValueLoop.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Eblog_View_Helper_EblogFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function eblogFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'eblog' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
