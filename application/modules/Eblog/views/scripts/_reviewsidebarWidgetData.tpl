...
<?php if($this->view_type == 'list'){ ?>
  <li class="eblog_review_sidebar_list  <?php if($this->image_type == 'rounded'):?>eblog_sidebar_image_rounded<?php endif;?> sesbasic_clearfix">
    <?php echo $this->htmlLink($reviewOwner, $this->itemPhoto($reviewOwner, 'thumb.icon')); ?>
    <div class="eblog_review_sidebar_list_info">
    	<?php  if(isset($this->titleActive)){ ?>
      	<div class="eblog_review_sidebar_list_title">
      ...
      <?php } ?>
        ...
        <div class="eblog_review_sidebar_list_stat sesbasic_text_light">
      ...
      <?php endif;?>  
			<div class="eblog_list_stats eblog_review_sidebar_list_stat">
      ...
      <?php if(isset($this->ratingActive)): ?>
        <div class="eblog_list_rating eblog_review_sidebar_list_stat clear">
    ...
    <?php endif;?>
     <?php if(isset($this->featuredLabelActive) || ($review->featured)  ||  ($this->verifiedLabelActive) || ($review->verified)):?>
        <div class="eblog_review_sidebar_featured_list">
...
<?php }else{ ?>
  <li class="eblog_review_grid sesbasic_clearfix sesbasic_bxs eblog_grid_btns_wrap">
    <div class="eblog_review_grid_thumb floatL" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
      <?php $href = $reviewOwner->getHref();$imageURL = $reviewOwner->getPhotoUrl('thumb.profile');?>
      <a href="<?php echo $href; ?>" class="eblog_review_grid_thumb_img floatL">
      ...
      <div class="eblog_review_grid_thumb_cont">
      	<?php if(isset($this->titleActive) ){ ?>
          <div class="eblog_review_grid_title">
            <?php if(strlen($review->getTitle()) > $this->title_truncation){ 
            ...
            <i class="eblog_verified_sign fa fa-check-circle" title="<?php echo $this->translate('Verified');?>"></i>
            <?php } ?>
          </div>
      	<?php } ?>
      </div>
      ...
      <?php } ?>
		...
		<div class="eblog_review_grid_info sesbasic_clearfix clear">
			<?php $reviewCrator = Engine_Api::_()->getItem('user', $review->owner_id);?> 
			<?php $reviewTaker = Engine_Api::_()->getItem('eblog_blog', $review->blog_id);?> 
			<div class="eblog_review_grid_stat eblog_sidebar_image_rounded floatL sesbasic_text_light">
				<?php echo $this->htmlLink($reviewTaker, $this->itemPhoto($reviewTaker, 'thumb.icon'), array('class' => 'eblog_reviw_prof_img floatL')); ?>
