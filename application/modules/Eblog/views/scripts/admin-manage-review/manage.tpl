				    ...
				    <table class='admin_table'>
				      ...
				      <tbody>
				        ...
				        <tr>
				          ...
				          <td>
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'eblog', 'controller' => 'admin-manage-review', 'action' => 'view', 'id' => $item->review_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
				            |
				            <?php echo $this->htmlLink($item->getHref(), $this->translate("View"), array('class' => '')); ?>
				            |
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'eblog', 'controller' => 'admin-manage-review', 'action' => 'delete-review', 'id' => $item->review_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
				          </td>
				        </tr>
				        <?php endforeach; ?>
				      </tbody>
