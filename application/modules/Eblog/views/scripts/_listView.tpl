...
<li class="eblog_list_blog_view sesbasic_clearfix clear eblog_list_text_center">
	<div class="eblog_list_thumb eblog_thumb" style="height:<?php echo is_numeric($this->height_list) ? $this->height_list.'px' : $this->height ?>;width:<?php echo is_numeric($this->width_list) ? $this->width_list.'px' : $this->width_list ?>;">
	...
	<div class="eblog_list_info">
		<div class="eblog_admin_list">
			...
			<?php if(isset($this->categoryActive)){ ?>
				<?php if($item->category_id != '' && intval($item->category_id) && !is_null($item->category_id)):?> 
					...
					<?php if($categoryItem):?>
						<div class="eblog_stats_list sesbasic_text_light">
							<span>
							 in <a href="<?php echo $categoryItem->getHref(); ?>"><?php echo $categoryItem->category_name; ?></a>
							</span>
						</div>
					<?php endif;?>
				<?php endif;?>
      	...
      	<!--	<?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.enable.location', 1)){ ?>
			<div class="eblog_stats_list sesbasic_text_dark eblog_list_location">
				<span>
