...
<li class="eblog_list_fourth_blog sesbasic_clearfix clear">
  <div class="eblog_list_full_thumb eblog_list_thumb eblog_thumb">
    ...
    <img src="<?php echo $imageURL; ?>" alt="" align="left" style="max-height:350px;" /></a>
    ...
    <div class="eblog_list_fourth_blog_meta">
      <ul>       			
        <?php if(isset($this->byActive)){ ?>
         <li class="eblog_list_fourth_blog_meta_owner">
        ...
        <?php if(isset($this->categoryActive)){ ?>
          <li class="eblog_list_fourth_blog_meta_category">
        ...
        <?php } ?>
       	<?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.enable.location', 1)){ ?>
        	<li class="eblog_list_fourth_blog_meta_location">
        ...
        <?php } ?>
        <li class="eblog_list_fourth_blog_meta_read">
          <div class="eblog_list_stats sesbasic_text_light">
              <span>
    ...
    <div class="eblog_list_new_full_contant_blog">
