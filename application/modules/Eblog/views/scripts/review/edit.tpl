...
?>
<style>
.eblog_review_form .global_form div.form-label label.requiredstart:after{content: " *";color: #f00;}
</style>
...
<?php 
	...
	$profile_type = 2;
  echo $this->partial('_customFields.tpl', 'eblog', array()); 
?>
...
<script>
 ...
 function showFields(cat_value, cat_level,typed,isLoad) {
  ...
  var getProfileType = function(category_id) {
    var mapping = <?php echo Zend_Json_Encoder::encode(Engine_Api::_()->getDbTable('categories', 'eblog')->getMapping(array('category_id', 'profile_type_review'))); ?>;
  ...
  en4.core.runonce.add(function() {
		sesJqueryObject('.eblog_form_rating_star').find('label').addClass('requiredstart');
