...
<?php echo $this->partial('dashboard/left-bar.tpl', 'eblog', array('blog' => $this->blog));?>
	<div class="eblog_dashboard_content sesbm sesbasic_clearfix">
<?php } ?>
...
<form id="eblog_change_owner" action="<?php echo $this->url(array('blog_id' => $this->blog->custom_url, 'action'=>'change-owner'), 'eblog_dashboard', true); ?>" method="post">
...
<script type='text/javascript'>
 var Searchurl = "<?php echo $this->url(array('blog_id' => $this->blog->custom_url,'action'=>'search-member'), 'eblog_dashboard', true); ?>";
