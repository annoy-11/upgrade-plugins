 ...
 * @version    $Id: edit.tpl 2016-07-23 00:00:00 SocialEngineSolutions $
...
<?php } ?>
<div class="sesbasic_dashboard_form eblog_create sesbasic_bxs">
...
var counter = 0;
  function validateForm(){
    ...
    jqueryObjectOfSes('#eblogs_edit input, #eblogs_edit select,#eblogs_edit checkbox,#eblogs_edit textarea,#eblogs_edit radio').each(
      function(index){
  ...
  jqueryObjectOfSes('#eblogs_edit').submit(function(e){
    var validationFm = validateForm();
		if(!validationFm && sesJqueryObject('#eblog_schedule_time').length > 0 ) {
