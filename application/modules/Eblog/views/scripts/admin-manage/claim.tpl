  ...
  <table class='admin_table'>
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          <?php $item = Engine_Api::_()->getItem('eblog_blog', $item->blog_id);?>
          ...
          <td class="admin_table_centered">
            ...
            <?php else: ?>
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'eblog', 'controller' => 'admin-manage', 'action' => 'approve-claim', 'id' => $item->claim_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Approve Claim Request'))), array('class' => 'smoothbox')) ?>
            <?php endif; ?>
          </td> 
          <td><?php echo date('Y-m-d H:i:s',strtotime($item->creation_date)) ?></td>
          <td><?php echo $this->htmlLink(array('route' => 'default', 'module' => 'eblog', 'controller' => 'admin-manage', 'action' => 'show-detail', 'id' => $item->claim_id), $this->translate("Details"), array('class' => 'smoothbox')) ?>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
