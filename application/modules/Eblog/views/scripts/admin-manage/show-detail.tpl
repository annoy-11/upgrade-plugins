...
?>
<div class="eblog_view_stats_popup">
  <div class="eblog_view_popup_con">
    <?php $blogItem = Engine_Api::_()->getItem('eblog_blog', $this->claimItem->blog_id);?>
    <?php $userItem = Engine_Api::_()->getItem('user', $this->claimItem->user_id);?>
    <div class="eblog_popup_img_blog">
    ...
    <div class="eblog_popup_owner_blog">
