 ...
 */
class Eblog_Widget_BlogsSlideshowController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $value['fetchAll'] = true;
		$value['limit'] = 3;
    $this->view->paginatorLeft = $paginatorLeft = Engine_Api::_()->getDbTable('blogs', 'eblog')->getEblogsSelect($value);
    ...
    $this->view->paginatorRight = $paginatorRight = Engine_Api::_()->getDbTable('blogs', 'eblog')->getEblogsSelect($valueRight);
  }
}