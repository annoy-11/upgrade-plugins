...
<?php  if(!$this->is_ajax): ?>
  ...
  <?php $this->headLink()->appendStylesheet($baseUrl . 'application/modules/Eblog/externals/styles/styles.css'); ?> 
...
<?php if(isset($this->defaultOptions) && count($this->defaultOptions) == 1): ?>
  <script type="application/javascript">
    en4.core.runonce.add(function() {
      sesJqueryObject('#tab-widget-eblog-<?php echo $randonNumber; ?>').parent().css('display', 'none');
      sesJqueryObject('.eblog_container_tabbed<?php echo $randonNumber; ?>').css('border', 'none');
    });
  </script>
<?php endif;?>
...
<?php if(!$this->is_ajax) { ?>
	<div class="sesbasic_view_type sesbasic_clearfix clear" style="display:<?php echo $this->bothViewEnable ? 'block' : 'none'; ?>;height:<?php echo $this->bothViewEnable ? '' : '0px'; ?>">
		...
		<?php if(!empty($allParams['show_item_count'])){ ?>
      <div class="sesbasic_clearfix sesbm eblog_search_result" style="display:<?php !$this->is_ajax ? 'block' : 'none'; ?>" id="<?php echo !$this->is_ajax ? 'paginator_count_eblog' : 'paginator_count_ajax_eblog' ?>"><span id="total_item_count_eblog" style="display:inline-block;"><?php echo $this->paginator->getTotalItemCount(); ?></span> <?php echo $this->paginator->getTotalItemCount() == 1 ?  $this->translate("blog found.") : $this->translate("blogs found."); ?></div>
		<?php } ?>
		...
		<div class="sesbasic_view_type_options sesbasic_view_type_options_<?php echo $randonNumber; ?>">
			<?php if(is_array($this->optionsEnable) && in_array('list1',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="list1" id="eblog_list_view_<?php echo $randonNumber; ?>" class="listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list1') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('List View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('list2',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="list2" id="eblog_simplelist_view_<?php echo $randonNumber; ?>" class="a-listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list2') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Simple List View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('list3',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="list3" id="eblog_advlist_view_<?php echo $randonNumber; ?>" class="s-listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list3') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Advanced List View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('list4',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="list4" id="eblog_advlist2_view_<?php echo $randonNumber; ?>" class="listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list4') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('List View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('grid1',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="grid1" id="eblog_grid_view_<?php echo $randonNumber; ?>" class="a-gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid1') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Grid View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('grid2',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="grid2" id="eblog_grid2_view_<?php echo $randonNumber; ?>" class="gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid2') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Grid View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('grid3',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="grid3" id="eblog_advgrid_view_<?php echo $randonNumber; ?>" class="gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid3') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Advanced Grid View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('grid4',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="grid4" id="eblog_supergrid_view_<?php echo $randonNumber; ?>" class="s-gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid4') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Super Advanced Grid View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('pinboard',$this->optionsEnable)){ ?>
				<a href="javascript:;" rel="pinboard" id="eblog_pinboard_view_<?php echo $randonNumber; ?>" class="boardicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'pinboard') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Pinboard View') : '' ; ?>"></a>
			<?php } ?>
			<?php if(is_array($this->optionsEnable) && in_array('map',$this->optionsEnable) && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog_enable_location', 1)){ ?>
				<a title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Map View') : '' ; ?>" id="eblog_map_view_<?php echo $randonNumber; ?>" class="mapicon map_selectView_<?php echo $randonNumber;?> selectView_<?php echo $randonNumber;?> <?php if($this->view_type == 'map') { echo 'active'; } ?>" rel="map" href="javascript:;"></a>
			<?php } ?>
		</div>
	</div>
<?php } ?>
...
<?php if(!$this->is_ajax){ ?>
  <div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">
    <ul class="eblog_blog_listing sesbasic_clearfix clear <?php if($this->view_type == 'pinboard'):?>sesbasic_pinboard_<?php echo $randonNumber;?><?php endif;?>" id="tabbed-widget_<?php echo $randonNumber; ?>" style="min-height:50px;">
<?php } ?>
...
<?php foreach( $this->paginator as $item ):?>
  ...
  <?php if($this->view_type == 'list1'){ ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_list1.tpl';?>
  <?php }else if($this->view_type == 'list2'){ ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_list2.tpl';?>
  <?php } else if($this->view_type == 'list3') { ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_list3.tpl';?>
  <?php }else if($this->view_type == 'list4') { ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_list4.tpl';?>
  <?php } else if($this->view_type == 'grid1'){ ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_grid1.tpl';?>
  <?php }elseif($this->view_type == 'grid2') { ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_grid2.tpl';?>
  <?php } else if($this->view_type == 'grid3') { ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_grid3.tpl';?>
  <?php }else if($this->view_type == 'grid4'){ ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/widgets-data/_grid4.tpl';?>
  <?php }else if(isset($this->view_type) && $this->view_type == 'pinboard'){ ?>
    <?php include APPLICATION_PATH .  '/application/modules/Eblog/views/scripts/_pinboardView.tpl';?>
   ...
   ?>
	...
	<?php if($blog->lat): ?>
		...
		<?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive) || isset($this->verifiedLabelActive)):?>
			<?php $labels .= "<div class=\"eblog_list_labels\">";?>
      <?php if(isset($this->sponsoredLabelActive) && $blog->sponsored == 1):?>
				<?php $labels .= "<p class=\"eblog_label_sponsored\">".$this->translate('SPONSORED')."</p>";?>
			<?php endif;?>
			<?php if(isset($this->featuredLabelActive) && $blog->featured == 1):?>
				<?php $labels .= "<p class=\"eblog_label_featured\">".$this->translate('FEATURED')."</p>";?>
			<?php endif;?>
      <?php if(isset($this->verifiedLabelActive) && $blog->verified == 1) :?>
			<?php $labels .= "<p class=\"eblog_label_verified\">".$this->translate('VERIFIED')."</p>";?>
		<?php endif;?>
			<?php $labels .= "</div>";?>
		<?php endif;?>
		<?php if(isset($this->locationActive) && $blog->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.enable.location', 1)):?>
			<?php $locationText = $this->translate('Location');?>
			<?php $locationvalue = $blog->location;?>
			<?php $location = "<div class=\"eblog_list_stats eblog_list_location sesbasic_text_light\">
			<span class=\"widthfull\">
			<i class=\"fa fa-map-marker\" title=\"$locationText\"></i>
			<span title=\"$locationvalue\"><a href='".$this->url(array('resource_id' => $blog->blog_id,'resource_type'=>'eblog_blog','action'=>'get-direction'), 'sesbasic_get_direction', true)."' class=\"opensmoothboxurl\">$locationvalue</a></span>
			</span>
			</div>";?>
		<?php endif;?>
		<?php $likeButton = '';?>
		...
		<?php $LikeStatus = Engine_Api::_()->sesbasic()->getLikeStatus($blog->blog_id,$blog->getType());?>
			...
			<?php $likeButton = '<a href="javascript:;" data-url="'.$blog->getIdentity().'" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn eblog_like_eblog_blog_'. $blog->blog_id.' eblog_like_eblog_blog '.$likeClass .'"> <i class="fa fa-thumbs-up"></i><span>'.$blog->like_count.'</span></a>';?>
		<?php endif;?>
		<?php $favouriteButton = '';?>
		<?php if(isset($this->favouriteButtonActive) && Engine_Api::_()->user()->getViewer()->getIdentity() != 0 &&  isset($blog->favourite_count) && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.enable.favourite', 1)){
			$favStatus = Engine_Api::_()->getDbtable('favourites', 'eblog')->isFavourite(array('resource_type'=>'eblog_blog','resource_id'=>$blog->blog_id));
			$favClass = ($favStatus)  ? 'button_active' : '';
			$favouriteButton = '<a href="javascript:;" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn  eblog_favourite_eblog_blog_'. $blog->blog_id.' eblog_favourite_eblog_blog '.$favClass .'" data-url="'.$blog->getIdentity().'"><i class="fa fa-heart"></i><span>'.$blog->favourite_count.'</span></a>';
		}?>
		<?php $ratings = '';?>
		<?php if(Engine_Api::_()->sesbasic()->getViewerPrivacy('sesmember_review', 'view') && Engine_Api::_()->getApi('core', 'eblog')->allowReviewRating() && isset($this->ratingStarActive)):?>
			<?php if( $blog->rating > 0 ): ?>
				<?php $ratings .= '<div class="eblog_list_grid_rating" title="'.$this->translate(array('%s rating', '%s ratings', $blog->rating), $this->locale()->toNumber($blog->rating)).'">';?>
		...
		<?php $stats = $ratings.'<div class="sesbasic_largemap_stats eblog_list_stats sesbasic_clearfix"><span class="widthfull">';
		...
		if(isset($this->favouriteActive) && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.enable.favourite', 1)){
		...
		if(isset($this->ratingActive) && Engine_Api::_()->sesbasic()->getViewerPrivacy('eblog_review', 'view')){
    ...
    <?php $socialshareIcons = $this->partial('_socialShareIcons.tpl','sesbasic',array('resource' => $blog, 'socialshare_enable_plusicon' => $this->socialshare_enable_mapviewplusicon, 'socialshare_icon_limit' => $this->socialshare_icon_mapviewlimit, 'params' => 'feed')); ?>
     <?php  $socialshare = '<div class="eblog_list_share_btns">'.$socialshareIcons.$likeButton.$favouriteButton.'</div>';?>
    <?php else:?>
			<?php $socialshare = $likeButton.$favouriteButton;?>
    <?php endif;?>
		<?php $owner = $blog->getOwner();
			$owner =  '<div class="eblog_grid_date eblog_list_stats sesbasic_text_light"><span><i class="fa fa-user"></i>'.$this->translate("by ") .$this->htmlLink($owner->getHref(),$owner->getTitle() ).'</span></div>';
...
<?php if($this->view_type == 'map'):?>
  ...
  <?php if(!$this->view_more || $this->is_search):?>
    <ul id="eblog_map_view_<?php echo $randonNumber;?>">
...
<?php  if(  $this->paginator->getTotalItemCount() == 0 &&  (empty($this->widgetType)) && $this->view_type != 'map'){  ?>
  <?php if( isset($this->category) || isset($this->tag) || isset($this->text) ):?>
	...
	<?php if ($this->can_create && empty($this->type)):?>
	  <?php echo $this->translate('Be the first to %1$spost%2$s one!', '<a href="'.$this->url(array('action' => 'create'), "eblog_general").'">', '</a>'); ?>
	<?php endif; ?>
      </span>
    </div>
  <?php else:?>
...
<?php }else if( $this->paginator->getTotalItemCount() == 0 && isset($this->tabbed_widget) && $this->tabbed_widget){?>
  <div class="tip">
	...
	<?php echo $this->translate('%1$spost%2$s one!', '<a href="'.$this->url(array('action' => 'create'), "eblog_general").'">', '</a>'); ?>
      <?php endif; ?>
    </span>
  </div>
<?php } ?>
...
<?php if(!$this->is_ajax){ ?>
  ...
  <script type="text/javascript">
    ...
    sesJqueryObject(document).on('click','.selectView_<?php echo $randonNumber; ?>',function(){
      ...
      sesJqueryObject('#eblog_grid_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_grid2_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_supergrid_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_advgrid_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_list_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_simplelist_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_advlist_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_advlist2_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_map_view_<?php echo $randonNumber; ?>').removeClass('active');
      sesJqueryObject('#eblog_pinboard_view_<?php echo $randonNumber; ?>').removeClass('active');
      ...
      requestTab_<?php echo $randonNumber; ?> = (new Request.HTML({
				method: 'post',
				'url': en4.core.baseUrl + "widget/index/mod/eblog/name/<?php echo $this->widgetName; ?>/openTab/" + defaultOpenTab,
				'data': {
					format: 'html',
					page: 1,
		...
		<?php if($this->loadOptionData != 'pagging'){ ?>
			...
			function viewMore_<?php echo $randonNumber; ?> (){
				...
				requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
					method: 'post',
					'url': en4.core.baseUrl + "widget/index/mod/eblog/name/<?php echo $this->widgetName; ?>/openTab/" + openTab_<?php echo $randonNumber; ?>,
					'data': {
						format: 'html',
					...
					onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
						...
						if(document.getElementById('map-data_<?php echo $randonNumber;?>') && sesJqueryObject('.sesbasic_view_type_options_<?php echo $randonNumber; ?>').find('.active').attr('rel') == 'map') {
							if(document.getElementById('eblog_map_view_<?php echo $randonNumber;?>'))	
							document.getElementById('eblog_map_view_<?php echo $randonNumber;?>').style.display = 'block';
...
<?php if(!$this->is_ajax): ?>
	...
	<script type="application/javascript">
		sesJqueryObject(document).on('click',function(){
			sesJqueryObject('.eblog_list_option_toggle').removeClass('open');
		});
		...
		function newMarkerLayout_<?php echo $randonNumber?>(dataLenth){
			...
			for(i=0;i<markerArrayData_<?php echo $randonNumber?>.length;i++){
				var images = '<div class="image eblog_map_thumb_img"><img src="'+markerArrayData_<?php echo $randonNumber?>[i]['image_url']+'"  /></div>';		
				...
				var allowBlounce = <?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.enable.bounce', 1); ?>;
				...
				'</div>' +
				'<div class="large map_large_marker"><div class="eblog_map_thumb eblog_grid_btns_wrap">' +
				images + socialshare+vlabel+labels+
				'</div><div class="sesbasic_large_map_content eblog_large_map_content sesbasic_clearfix">' +
