 ...
 */
class Eblog_Widget_CategoryCarouselController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->paginator = Engine_Api::_()->getDbTable('categories', 'eblog')->getCategory($params);
