...
?>
<div class='eblog_owner_contact_details sesbasic_clearfix sesbasic_bxs'>
  <ul>
    <?php if( in_array('name',$this->info) && $this->subject->blog_contact_name): ?>
      <li class="sesbasic_clearfix eblog_owner_contact_name">
    ...
    <?php endif ?>
    <li class="eblog_owner_contact_social" style="display: none;">
      <?php if( in_array('facebook',$this->info) && $this->subject->blog_contact_facebook): ?>
        <a target="_blank" href='<?php echo parse_url($this->subject->blog_contact_facebook, PHP_URL_SCHEME) === null ? 'https://' . $this->subject->blog_contact_facebook : $this->subject->blog_contact_facebook; ?>' title='<?php echo $this->translate("Facebook URL"); ?>'><i class="fa fa-facebook-square"></i></a>
      <?php endif ?>
      <?php if( in_array('website',$this->info) && $this->subject->blog_contact_website): ?>
