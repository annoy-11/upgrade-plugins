...
class Eblog_Widget_PopularFeaturedVerifiedReviewsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = $paginator = Engine_Api::_()->getDbTable('reviews', 'eblog')->getBlogReviewSelect($value, array());
