 ...
 */
class Eblog_Widget_tabbedWidgetBlogController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $eblog_tabbed = Zend_Registry::isRegistered('eblog_tabbed') ? Zend_Registry::get('eblog_tabbed') : null;
    ...
    // Get Blogs
    $paginator = Engine_Api::_()->getDbtable('blogs', 'eblog')->getEblogsPaginator($params);
