 ...
 */
class Eblog_Widget_OtherModulesProfileEblogsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'other-modules-profile-eblogs';			
    $params = array_merge($params, $value);

    // Get Blogs
    $paginator = Engine_Api::_()->getDbtable('blogs', 'eblog')->getEblogsPaginator($value);
