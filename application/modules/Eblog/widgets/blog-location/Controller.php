 ...
 */
class Eblog_Widget_BlogLocationController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('blogs', 'eblog')->getEblogsPaginator($value, true);
