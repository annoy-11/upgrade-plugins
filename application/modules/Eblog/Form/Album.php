...
class Eblog_Form_Album extends Engine_Form
{
  public function init()
  {
    ...
    $blogId = Zend_Controller_Front::getInstance()->getRequest()->getParam('blog_id', null);
		...
		if($albumId){
			$blog =  Engine_Api::_()->getItem('eblog_album', $albumId)->getParent();
			$blogId = Engine_Api::_()->getItem('eblog_album', $albumId)->blog_id;
  ...
  public function saveValues() {
    ...
    if( ($values['album'] == 0) ) {
      ...
      $params['search'] = 1;
      $album = Engine_Api::_()->getDbtable('albums', 'eblog')->createRow();
      ...
      if (!isset($album)) {
        $album = Engine_Api::_()->getItem('eblog_album', $values['album']);
      }
    }
