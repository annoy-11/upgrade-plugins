...
class Eblog_Form_Admin_Manage_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbTable('categories', 'eblog')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Select', 'verified', array(
		...
		$isEnablePackage = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('eblogpackage') && Engine_Api::_()->getApi('settings', 'core')->getSetting('eblogpackage.enable.package', 1);
		if($isEnablePackage){
      $packages = Engine_Api::_()->getDbTable('packages','eblogpackage')->getPackage(array('default' => true));
      $packagesArray = array(''=>'');
