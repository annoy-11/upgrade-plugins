...
class Eblog_Form_Admin_Level_Level extends Authorization_Form_Admin_Level_Abstract {
  ...
  public function init() {
    ...
    if($this->isPublic() )
    {
      ...
      $this->addElement('Radio', 'commenting', array(
        'label' => 'Allow Commenting on Blogs?',
        'description' => 'Do you want to let members of this level to comment on blogs? If set to Yes, then members of this level can view “comments post” box and will get redirected to the login page of your website if try to do commenting on the blogs.',
        'multiOptions' => array(
    ...
    if( !$this->isPublic() ) {
      ...
      $this->addElement('radio', 'eblog_enblogdes', array(
        ...
        'onchange' => "enableblogdesignview()",
        'value' => 1,
      ));

      $this->addElement('MultiCheckbox', 'eblog_chooselay', array(
      ...
      $this->addElement('Radio', 'eblog_defaultlay', array(
