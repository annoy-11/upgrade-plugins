 ...
 * @version    $Id: AddParameter.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
class Eblog_Form_Admin_Review_AddParameter extends Engine_Form {
  ...
  public function init() {
    ...
    if(count($reviewParameters)) {
			...
			foreach($reviewParameters as $val){
				$this->addElement('Text', 'eblog_review_'.$val['parameter_id'], array(
          'label' => '',
					'class'=>'eblog_added_parameter',
          'allowEmpty' => true,
					'value'=>$val['title'],
          'required' => false,
          'maxlength' => "255",
