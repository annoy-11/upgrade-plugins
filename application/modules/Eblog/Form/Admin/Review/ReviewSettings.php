...
class Eblog_Form_Admin_Review_ReviewSettings extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Radio', 'eblog_allow_review', array(
        'label' => 'Allow Reviews',
        ...
        'value' => $settings->getSetting('eblog.allow.review', 1),
    ));

    $this->addElement('Radio', 'eblog_allow_owner', array(
        ...
        'value' => $settings->getSetting('eblog.allow.owner', 1),
    ));

    $this->addElement('Radio', 'eblog_show_pros', array(
        ...
        'value' => $settings->getSetting('eblog.show.pros', 1),
    ));

    $this->addElement('Radio', 'eblog_show_cons', array(
        ...
        'value' => $settings->getSetting('eblog.show.cons', 1),
    ));

    $this->addElement('Radio', 'eblog_review_summary', array(
        ...
        'value' => $settings->getSetting('eblog.review.summary', 1),
    ));

    $this->addElement('Radio', 'eblog_show_tinymce', array(
        ...
        'value' => $settings->getSetting('eblog.show.tinymce', 1),
    ));

    $this->addElement('Radio', 'eblog_show_recommended', array(
        ...
        'value' => $settings->getSetting('eblog.show.recommended', 1),
    ));

    $this->addElement('Radio', 'eblog_allow_share', array(
        ...
        'value' => $settings->getSetting('eblog.allow.share', 1),
    ));

    $this->addElement('Radio', 'eblog_show_report', array(
        ...
        'value' => $settings->getSetting('eblog.show.report', 1),
    ));
    
    /* text for rating starts */
    $this->addElement('Text', "eblog_rating_stars_one", array(
        ...
        'value' => $settings->getSetting('eblog.rating.stars.one', 'terrible'),
    ));
    $this->addElement('Text', "eblog_rating_stars_two", array(
        ...
        'value' => $settings->getSetting('eblog.rating.stars.second', 'poor'),
    ));
    $this->addElement('Text', "eblog_rating_stars_three", array(
        ...
        'value' => $settings->getSetting('eblog.rating.stars.three', 'average'),
    ));
    $this->addElement('Text', "eblog_rating_stars_four", array(
        ...
        'value' => $settings->getSetting('eblog.rating.stars.four', 'very good'),
    ));
    $this->addElement('Text', "eblog_rating_stars_five", array(
        ...
        'value' => $settings->getSetting('eblog.rating.stars.five', 'excellent'),
    ));
