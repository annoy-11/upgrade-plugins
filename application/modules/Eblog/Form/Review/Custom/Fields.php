...
class Eblog_Form_Review_Custom_Fields extends Engine_Form {
  ...
  public function isValid($data) {
    ...
    if (isset($_POST['category_id']) && $_POST['category_id'] != 0) {
      $category_map_id_data = Engine_Api::_()->getDbtable('categories', 'eblog')->getMapId($_POST['category_id'],'profile_type_review');
    ...
    if (isset($_POST['subcat_id']) && $_POST['subcat_id'] != 0) {
      $subcategory_map_id_data = Engine_Api::_()->getDbtable('categories', 'eblog')->getSubCatMapId($_POST['subcat_id'],'profile_type_review');
    ...
    if (isset($_POST['subsubcat_id']) && $_POST['subsubcat_id'] != 0) {
      $subsubcategory_map_id_data = Engine_Api::_()->getDbtable('categories', 'eblog')->getSubSubCatMapId($_POST['subsubcat_id'],'profile_type_review');
