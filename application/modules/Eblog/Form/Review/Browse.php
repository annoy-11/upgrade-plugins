...
class Eblog_Form_Review_Browse extends Engine_Form {
  ...
  public function init() {
    ...
    if($blog_id)
    $this->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array('blog_id' => $blog_id), 'eblog_entry_view', true));
    else
    $this->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array(), 'eblog_review', true));
    ...
    $this->addElement('Dummy', 'loading-img-eblog-review', array(
