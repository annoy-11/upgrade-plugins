...
if(Engine_Api::_()->getApi('settings', 'core')->getSetting('eblog.pluginactivated')) {
  $categories = Engine_Api::_()->getDbtable('categories', 'eblog')->getCategoriesAssoc(array('module'=>true));
}
...
return array(
  ...
  array(
    ...
    'adminForm' => 'Eblog_Form_Admin_Tabbed',
  ),
	array(
		...
		'type' => 'widget',
		'autoEdit' => true,
		'name' => 'eblog.other-modules-profile-eblogs',
		'requirements' => array(
			'subject' => 'user',
		),
		'defaultParams' => array(
		...
		'adminForm' => 'Eblog_Form_Admin_OtherModulesTabbed',
	),
	array(
        ...
        $adminTitle,
          ...
          array(
            ...
            'multiOptions' => array(
              ...
              'readmore' => 'Read More Button (except List View 3, Grid View 1)',
              'creationDate' => 'Creation Date (except List View 4, Grid View 1)',
              'location'=> 'Location',
  ...
  array(
    ...
    'description' => 'Displays a search form in the blog browse page as configured by you.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
  ...
  array(
    'title' => 'SNS - EBlog - Blog Categories Main Navigation Menu',
    ...
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.category-browse-menu',
    'requirements' => array(
      'no-subject',
    ),
    'adminForm' => array(
      'elements' => array (
        array(
            ...
            'description' => 'How many categories do you want to show in the Main Navigation Menu of your website?',
            'multiOptions' => array(
              1 => 1,
              2 => 2,
              3 => 3,
  ...
  array(
    ...
    'description' => 'Displays a navigation menu bar in the EBlog\'s pages for Blogs Home, Browse Blogs, Browse Categories, etc pages.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
  ...
  array(
      'title' => 'SNS Eblogs - Categories Cloud / Hierarchy View',
      ...
      'autoEdit' => true,
      'adminForm' => 'Eblog_Form_Admin_Tagcloudcategory',
  ),
  array(
  ...
  array(
      'title' => 'SNS Eblogs - Blog Profile - Tags',
  ...
  array(
      'title' => 'SNS Eblogs - Tags Cloud / Tab View',
      ...
      'autoEdit' => true,
      'adminForm' => 'Eblog_Form_Admin_Tagcloudblog',
  ),
  array(
      'title' => 'SNS Eblogs - Browse All Tags',
      ...
      'category' => 'SNS - Advanced Blog',
      'type' => 'widget',
      'name' => 'eblog.tag-albums',
  ),
  array(
		'title' => 'SNS Eblogs - Top Blog Posters',
  ...
  array(
    ...
    'autoEdit' => true,
    'adminForm' => 'Eblog_Form_Admin_Share',
  ),
  array(
    'title' => 'SNS Eblogs - Blog of the Day',
  ...
  array(
	...
	array(
     ...
     array(
      'title' => 'SNS Eblogs - Album View Page - Options',
      ...
      'adminForm' => 'Eblog_Form_Admin_Layout_Albumviewpage',
    ),

    		array(
        'title' => 'SNS Eblogs - Photo View Page - Options',
...
//   ),
  array(
    ...
    'description' => 'Displays videos on blog profile page. The recommended page for this widget is "SNS - Advanced Blog - Blog Profile Page".',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.profile-videos',
    'autoEdit' => true,
    'adminForm' => 'Eblog_Form_Admin_Profilevideos',
  ),
array(
  ...
  array(
    'title' => 'SNS Eblogs - Categories Icon View',
  ...
  array(
    ...
    'description' => 'Displays breadcrumb for Blog. This widget should be placed on the Eblog - View page of the selected content type.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    ...
    'description' => 'Displays blog custom fields for Blog. This widget should be placed on the Eblog - View page of blog.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.blog-info',
		'defaultParams' => array(
      'title' => "Custom Fields",
    ),
    'autoEdit' => false,
...
//   ),
 array(
    ...
    'type' => 'widget',
    'autoEdit' => true,
    'name' => 'eblog.profile-sidebar-tabs',
  ),
  array(
    ...
    'adminForm' => 'Eblog_Form_Admin_SidebarTabbed',
  ),
  array(
    ...
    'name' => 'eblog.view-blog',
        ...
        $adminTitle,
				...
				array(
                    ...
                    'heightss',
                    array(
                        'label' => 'Enter the height of blog image(in pixels12).',
                        'value' => '500',
                    )
                ),
			),
	...
	array(
    'title' => 'SNS - Advanced Blog - Blog Profile - Description',
    'description' => 'Displays blog content according to the design choosen by the blog poster while creating or editing the blog. The recommended page for this widget is "SNS - Advanced Blog - Blog Profile Page".',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.view-blog-description',
		'adminForm' => array(
			'elements' => array(
        $adminTitle,
				array(
...
array(
		...
		'adminForm' => 'Eblog_Form_Admin_Categorywidget',
	),
	array(
...
',
	...
	array(
      ...
      array(
        ...
        'name' => 'eblog.blog-location',
				'autoEdit' => true,
    		'adminForm' => 'Eblog_Form_Admin_Location',
    ),
  ...
  array(
    ...
    'requirements' => array(
      ...
      array(
        ...
        'requirements' => array(
    	  ...
    	  array(
    'title' => 'SNS - Advanced Blog - Css Blog Widget',
    'description' => 'Displays a blog title widget. You can place this widget on blog profile page only on your site.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.css-blog',
    'requirements' => array(
      'subject' => 'blog',
        ...
        'type' => 'widget',
        'autoEdit' => true,
        'name' => 'eblog.blog-contact-information',
        'adminForm' => array(
            'elements' => array(
                $adminTitle,
                array(
        ...
        'type' => 'widget',
        'autoEdit' => true,
        'name' => 'eblog.browse-contributors',
        'adminForm' => array(
            'elements' => array(
                $adminTitle,
                array(
  ...
  array(
    'title' => 'SNS Eblogs - Double Blog Slideshow',
    'description' => 'This widget displays 2 types of blogs. The one section of this widget will be slideshow and the other will show 3 blogs based on the criterion chosen in this widget.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.blogs-slideshow',
    'autoEdit' => true,
    'adminForm' => array(
      'elements' => array(
        $adminTitle,
        array(
          ...
          'criteria',
          array(
            'label' => "Content for 3 blogs display in left side.",
            'multiOptions' => array(
              '5' => 'All including Featured and Sponsored',
              '1' => 'Only Featured',
              '2' => 'Only Sponsored',
        ...
        array(
          ...
          'leftBlog',
          array(
            'label' => "Do you want to enable the 3 Blogs in left side?",
            'multiOptions' => array(
              '1' => 'Yes',
              '0' => 'No',
            ),
        ...
        array(
          ...
          'order',
          array(
            'label' => 'Duration criteria for the 3 blogs to be shown in this widget in left side.',
            'multiOptions' => array(
              '' => 'All Blogs',
              'week' => 'This Week Blogs',
              'month' => 'This Month Blogs',
        ...
        array(
          ...
          'info',
          array(
            'label' => 'Choose popularity criteria for the 3 blogs to be displayed in left side.',
            'multiOptions' => array(
              "recently_created" => "Recently Created",
              "most_viewed" => "Most Viewed",
              "most_liked" => "Most Liked",
        ...
        array(
          ...
          'order_right',
          array(
            'label' => 'Duration criteria for the blogs to be shown in the slideshow of this widget in right side',
            'multiOptions' => array(
              '' => 'All Blogs',
              'week' => 'This Week Blogs',
              'month' => 'This Month Blogs',
        ...
        array(
          ...
          'info_right',
          array(
            'label' => 'Choose popularity criteria for the blogs to be displayed in the slideshow in right side.',
            'multiOptions' => array(
              "recently_created" => "Recently Created",
              "most_viewed" => "Most Viewed",
              "most_liked" => "Most Liked",
        ...
        array(
          ...
          'autoplay',
          array(
            'label' => "Do you want to enable the autoplay of blogs slideshow?",
            'multiOptions' => array(
              1=>'Yes',
              0=>'No'
            ),
        ...
        array(
          ...
          'speed',
            array(
            'label' => 'Enter the delay time for the next blog to be displayed in slideshow. (work if autoplay is enabled.)',
            'value' => '2000',
            'validators' => array(
              array('Int', true),
              array('GreaterThan', true, array(0)),
        ...
        array(
          ...
          'limit_data',
          array(
            'label' => 'Count for the blogs to be displayed in slideshow.',
            'value' => 5,
            'validators' => array(
              array('Int', true),
              array('GreaterThan', true, array(0)),
  ...
  array(
    'title' => 'SNS - Advanced Blog - Popular / Featured / Sponsored / Verified Blogs Crawl',
    'description' => '',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    'name' => 'eblog.blogs-crawl',
    'autoEdit' => true,
    'adminForm' => array(
      'elements' => array(
        $adminTitle,
        array(
          ...
          'criteria',
          array(
            'label' => "Content for blogs display in this widget.",
            'multiOptions' => array(
              '5' => 'All including Featured and Sponsored',
              '1' => 'Only Featured',
              '2' => 'Only Sponsored',
        ...
        array(
          ...
          'info',
          array(
            'label' => 'Choose popularity criteria for the blogs to be displayed in this widget.',
            'multiOptions' => array(
              "recently_created" => "Recently Created",
              "most_viewed" => "Most Viewed",
              "most_liked" => "Most Liked",
