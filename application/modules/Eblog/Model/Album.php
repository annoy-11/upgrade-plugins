...
class Eblog_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'eblog_blog';

  protected $_owner_type = 'eblog_blog';

  protected $_children_types = array('eblog_photo');

  protected $_collectible_type = 'eblog_photo';

//   public function getHref($params = array())
//   {
//     return $this->getEblog()->getHref($params);
//   }
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Eblog/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $eblogPhoto ) {
      $eblogPhoto->delete();
    }
