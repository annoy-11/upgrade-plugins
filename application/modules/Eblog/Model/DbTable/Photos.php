...
class Eblog_Model_DbTable_Photos extends Engine_Db_Table
{
  protected $_rowClass = 'Eblog_Model_Photo';
  
  	public function getPhotoSelect($params = array())
  {
    $select = $this->select();
    
    if( !empty($params['album']) && $params['album'] instanceof Eblog_Model_Album ) {
