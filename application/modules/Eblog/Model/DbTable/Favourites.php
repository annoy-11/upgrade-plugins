 ...
 */
class Eblog_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Eblog_Model_Favourite";
  ...
  public function isFavourite($params = array()) {
    ...
    $viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity();
     $select = $this->select()
		...
		$tableFav = Engine_Api::_()->getDbtable('favourites', 'eblog');
