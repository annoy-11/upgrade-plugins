...
class Eblog_AdminFieldsReviewController extends Fields_Controller_AdminAbstract {
  ...
  public function indexAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('eblog_admin_main_reviewsettings', array(), 'eblog_admin_main_subreviewparameters');
