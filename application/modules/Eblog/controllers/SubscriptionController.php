 ...
 * @version    $Id: SubscriptionController.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Eblog_SubscriptionController extends Core_Controller_Action_Standard {
  ...
  public function init() {
    ...
    if( !$this->_helper->requireAuth()->setAuthParams('eblog_blog', $viewer, 'view')->isValid() ) {
      return;
    }

    // Get subject
    if( ($eblog_id = $this->_getParam('blog_id')) &&
        ($eblog = Engine_Api::_()->getItem('eblog_blog', $eblog_id)) instanceof Eblog_Model_Blog ) {
      $subject = $eblog->getOwner('user');
