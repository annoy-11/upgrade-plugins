...
class Eblog_AdminManageImportsController extends Core_Controller_Action_Admin {

  public function indexAction() {
    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('eblog_admin_main', array(), 'eblog_admin_main_manageimport');
  }
  ...
  public function importAction() {
    ...
    $this->view->form = $form = new Eblog_Form_Admin_Import_Import();
  ...
  public function saveBlog($values) {
    ...
    try {
      ...
      if(isset($values['body']))
        $values['readtime'] = Engine_Api::_()->eblog()->estimatedReadingTime(addslashes($values['body']));
      ...
      if (isset($blog->package_id) && Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('eblogpackage')) {
      ...
      $value = Engine_Api::_()->getDbTable('blogs', 'eblog')->checkCustomUrl($blog->getSlug());
      if(empty($value))
  ...
  public function downloadAction() {
    ...
    $filepath = APPLICATION_PATH . DIRECTORY_SEPARATOR . 'application' . DIRECTORY_SEPARATOR . 'modules' . DIRECTORY_SEPARATOR . 'Eblog' . DIRECTORY_SEPARATOR . "settings" .DIRECTORY_SEPARATOR.'default_template.csv';
