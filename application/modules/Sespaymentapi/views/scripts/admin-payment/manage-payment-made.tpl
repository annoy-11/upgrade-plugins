...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <p><?php echo $this->translate('This page lists all the payments made to the users on your website from the Payment Requests section of this plugin. You can use this page to monitor these payments made. Entering criteria into the filter fields will help you find specific payment detail. Leaving the filter fields blank will show all the payments made to users on your social network.'); ?></p>
    <br />
        ...
        <table class='admin_table'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sespaymentapi', 'controller' => 'payment', 'action' => 'viewpaymentmade', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
