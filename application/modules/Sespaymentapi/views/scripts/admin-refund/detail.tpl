...
<?php $defaultCurrency = Engine_Api::_()->sespaymentapi()->defaultCurrency(); ?>
  <h3> <?php echo $this->translate("Refund Details"); ?> </h3>
  <table class="sesbm">   
<!--  	<tr>
    ...
    <tr>
    	<?php $user = Engine_Api::_()->getItem('user', $this->item->user_id); ?>
      <td><?php echo $this->translate('Owner Name') ?>:</td>
      <td><?php echo $this->htmlLink($user->getHref(), $user->getTitle(), array('target'=>'_blank')); ?></td>
    </tr>
     <tr>
      <td><?php echo $this->translate('Request Id') ?>:</td>
      <td><?php echo $this->item->refundrequest_id ; ?></td>
    </tr>
    <tr>
      <td><?php echo $this->translate('Total Amount') ?>:</td>
      <td><?php echo Engine_Api::_()->sespaymentapi()->getCurrencyPrice($this->item->total_amount,$defaultCurrency); ?></td>
    </tr>
    <tr>
