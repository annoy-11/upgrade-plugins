...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <h3><?php echo $this->translate("Refunds Made to Users") ?></h3>
    <p><?php echo $this->translate('This page lists all of the refunds made to the users on your website. You can use this page to monitor these refund made. Entering criteria into the filter fields will help you find specific payment detail. Leaving the filter fields blank will show all the refunds made to users on your social network.'); ?></p>
    <br />
    ...
    <?php if( count($this->paginator) ): ?>
      ...
      <form id='multidelete_form' method="post" action="<?php echo $this->url();?>" onSubmit="return multiDelete()">
        ...
        <table class='admin_table'>
          <thead>
            <tr>
              <th class='admin_table_short'><a href="javascript:void(0);" onclick="javascript:changeOrder('refundrequest_id', 'DESC');"><?php echo $this->translate("ID") ?></a></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sespaymentapi', 'controller' => 'refund', 'action' => 'viewrefundmade', 'id' => $item->refundrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
