...
class Sespaymentapi_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_rowClass = 'Sespaymentapi_Model_Usergateway';
  ...
  public function getEnabledGatewayCount()
  {
    ...
    $select = $this->select()->from($this->info('name'))->where('user_id =?',$params['user_id']);
