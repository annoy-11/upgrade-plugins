...
return array(
    'package' => array(
        ...
        'title' => 'SES - Professional Music Plugin',
        'description' => 'SES - Professional Music Plugin',
    ...
    // Items ---------------------------------------------------------------------
    'items' => array(
        'sesmusic_artist', 'sesmusic_artists', 'sesmusic_categories', 'sesmusic_albums', 'sesmusic_albumsongs', 'sesmusic_album', 'sesmusic_albumsong', 'sesmusic_playlistsongs', 'sesmusic_playlist', 'sesmusic_favourites', 'sesmusic_category'
    ),
    // Routes --------------------------------------------------------------------
    'routes' => array(
        ...
        'sesmusic_general_home' => array(
            'route' => 'music/album/home/*',
            'defaults' => array(
                'module' => 'sesmusic',
                'controller' => 'index',
                'action' => 'home',
        ...
        'sesmusic_songgeneral' => array(
            'route' => 'music/album/create/upload/song',
            'defaults' => array(
                'module' => 'sesmusic',
                'controller' => 'index',
                'action' => 'create',
        ...
        'sesmusic_general_welcome' => array(
            'route' => 'music/album/welcome/*',
            'defaults' => array(
                'module' => 'sesmusic',
                'controller' => 'index',
                'action' => 'welcome',
