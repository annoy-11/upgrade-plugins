...
class Sesmusic_Plugin_Menus {
  ...
  public function onMenuInitialize_SesmusicMainUploadsong($row) {
    ...
    //Must be able to create playlists
    if (!Engine_Api::_()->authorization()->isAllowed('sesmusic_album', $viewer, 'uploadsong'))
      return false;

    // Modify params
    return array(
      'label' => 'Upload Song',
      'route' => 'sesmusic_songgeneral',
    );
  }
