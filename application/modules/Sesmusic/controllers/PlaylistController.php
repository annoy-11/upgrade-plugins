...
//    $this->view->showAlbumSongRating = $showRating;
  ...
  public function deleteCookiesAction() {
    ...
    $cookiesData = $_COOKIE["sesmusic_playlists"];
    $cookiesData = explode(",",$cookiesData);
    $cookiesData = array_diff($cookiesData, array($deleteId));
    $cookiesData = implode(",",$cookiesData);
    setcookie('sesmusic_playlists', '', -100, "/");
    setcookie('sesmusic_playlists', $cookiesData, time() + 86400, "/");
    echo "Success";
    die;
