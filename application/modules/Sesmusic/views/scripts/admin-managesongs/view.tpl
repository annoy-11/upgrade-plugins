...
<?php $categoriesTable = Engine_Api::_()->getDbTable('categories', 'sesmusic'); ?>
<?php $catName = $categoriesTable->getColumnName(array('column_name' => 'category_name', 'category_id' => $this->item->category_id)); ?>
<?php $subcatName = $categoriesTable->getColumnName(array('column_name' => 'category_name', 'category_id' => $this->item->subcat_id)); ?>
<?php $subsubcatName = $categoriesTable->getColumnName(array('column_name' => 'category_name', 'category_id' => $this->item->subsubcat_id)); ?>
<div class="sesbasic_view_stats_popup">
  ...
  <table>
    ...
    <tr>
      ...
      <td><?php if($this->album->upload_param == 'album') { ?><?php echo $this->htmlLink($this->album->getHref(), $this->album->getTitle(), array('title' => $this->translate($this->album->getTitle()), 'target' => '_blank')) ?><?php } else { ?><?php echo "---"; ?><?php } ?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><?php echo $this->translate('Sub Category') ?>:</td>
      <td><?php  if($subcatName): ?>
        <p><?php echo $subsubcatName; ?></p>
        <?php else: ?> 
        <p>-</p>
        <?php endif; ?>
      </td>
    ...
    <tr>
      <td><?php echo $this->translate('Sub Sub Category') ?>:</td>
      <td><?php  if($subsubcatName): ?>
        <p><?php echo $subsubcatName; ?></p>
        <?php else: ?> 
        <p>-</p>
        <?php endif; ?>
