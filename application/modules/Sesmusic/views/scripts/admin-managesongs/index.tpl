      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if($album->upload_param == 'album') { ?>
            <?php echo $this->htmlLink($album->getHref(), $this->translate(Engine_Api::_()->sesbasic()->textTruncation($album->getTitle(),10)), array('title' => $this->translate($album->getTitle()), 'target' => '_blank')) ?>
          <?php } else { ?>
            <?php echo "---"; ?>
          <?php } ?>
          </td> 
