 ...
 */
class Sesmusic_Model_DbTable_Songmetas extends Engine_Db_Table {

  protected $_name = 'sesmusic_albumsongs_fields_meta';
  protected $_rowClass = 'Sesmusic_Model_Songmeta';
	
	public function getMetaData($options_id = null){
		if(!$options_id)
			return null;
		$tableName = $this->info('name');
		$mapTableName = Engine_Api::_()->getDbTable('songmaps','sesmusic')->info('name');
