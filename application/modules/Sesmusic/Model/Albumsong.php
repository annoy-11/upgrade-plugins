...
class Sesmusic_Model_Albumsong extends Core_Model_Item_Abstract {
  ...
  public function getPhotoUrl($type = NULL) {
    ...
    $defaultphoto = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesmusic.songdefaultphoto','/application/modules/Sesmusic/externals/images/nophoto_albumsong_thumb_main.png');
    if (empty($photo_id) && $defaultphoto) {
      ...
      return '/application/modules/Sesmusic/externals/images/nophoto_albumsong_thumb_main.png';  
    }
  }
