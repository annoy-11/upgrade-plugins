...
//  }
  ...
  public function addSong($file_id, $params = array()) {
    ...
    if ($file) {
      ...
      $albumSongs->photo_id = $this->photo_id;
      $albumSongs->song_cover = $this->album_cover;
      ...
      //Single Song Upload
      if(isset($params['uploadCheck']) && !empty($params['uploadCheck'])) {
        $albumSongs->upload_param = 'song';
      }
  ...
  public function getPhotoUrl($type = NULL) {
    ...
    $defaultphoto = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesmusic.albumdefaultphoto','/application/modules/Sesmusic/externals/images/nophoto_album_thumb_main.png');
    if (empty($photo_id) && $defaultphoto) {
      ...
      return '/application/modules/Sesmusic/externals/images/nophoto_album_thumb_main.png';
