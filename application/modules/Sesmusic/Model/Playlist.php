...
class Sesmusic_Model_Playlist extends Core_Model_Item_Abstract {
  ...
  public function getPhotoUrl($type = NULL) {
    ...
    $defaultphoto = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesmusic.playistdefaultphoto','/application/modules/Sesmusic/externals/images/nophoto_playlist_thumb_profile.png');
    if (empty($photo_id) && $defaultphoto) {
      ...
      return "/application/modules/Sesmusic/externals/images/nophoto_playlist_thumb_profile.png" ; 
    }
  }
  ...
  public function getSongs($file_id = null, $params = array()) {
    ...
    if(!empty($params['paginator'])){
      $select->order('playlistsong_id DESC');
