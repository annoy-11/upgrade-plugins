          ...
          <ul class="sesmusic_tracks_list playlist_<?php echo $playlist->getIdentity() ?>">
            ...
            <li class="sesbasic_clearfix">     
              <div class="sesmusic_tracks_list_photo">
                ...
                <?php $path = Engine_Api::_()->sesmusic()->songImageURL($albumSongs); ?>
                ...
                <a href="javascript:void(0);" onclick="play_music('<?php echo $albumSongs->albumsong_id ?>', '<?php echo $URL; ?>', '<?php echo $songTitle; ?>', '', '<?php echo $path; ?>');" class="sesmusic_songslist_playbutton"><i class="fa fa-play-circle"></i></a>
                <?php else: ?>
                <a href="javascript:void(0);" class="sesmusic_songslist_playbutton"><i class="fa fa-play-circle"></i></a>
                <?php endif; ?>
                <?php else: ?>
                  <?php if($albumSongs->store_link): ?>
                    <?php $storeLink = !empty($albumSongs->store_link) ? (preg_match("#https?://#", $albumSongs->store_link) === 0) ? 'http://'.$albumSongs->store_link : $albumSongs->store_link : ''; ?>
                    <a href="javascript:void(0);" onclick="play_music('<?php echo $albumSongs->albumsong_id ?>', '<?php echo $albumSongs->getFilePath(); ?>', '<?php echo $songTitle; ?>', '<?php echo $storeLink ?>', '<?php echo $path; ?>');" class="sesmusic_songslist_playbutton"><i class="fa fa-play-circle"></i></a>
                  <?php else: ?>
                    <a href="javascript:void(0);" onclick="play_music('<?php echo $albumSongs->albumsong_id ?>', '<?php echo $albumSongs->getFilePath(); ?>', '<?php echo $songTitle; ?>', '', '<?php echo $path; ?>');" class="sesmusic_songslist_playbutton"><i class="fa fa-play-circle"></i></a>
                  <?php endif; ?>
                <?php endif; ?>
              </div>
