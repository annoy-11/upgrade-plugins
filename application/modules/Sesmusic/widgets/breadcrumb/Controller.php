...
class Sesmusic_Widget_BreadcrumbController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->resource_type = Zend_Controller_Front::getInstance()->getRequest()->getParam('resource_type');
    $this->view->resource_id = Zend_Controller_Front::getInstance()->getRequest()->getParam('resource_id');
