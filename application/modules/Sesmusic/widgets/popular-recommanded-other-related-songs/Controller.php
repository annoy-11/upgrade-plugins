...
class Sesmusic_Widget_PopularRecommandedOtherRelatedSongsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $params['column'] = array('albumsong_id', 'album_id', 'title', 'photo_id', 'lyrics', 'view_count', 'like_count', 'comment_count', "download_count", 'featured', 'hot', 'sponsored', 'rating', 'artists', 'file_id', 'track_id', 'song_url', 'upcoming', 'play_count', 'store_link');
