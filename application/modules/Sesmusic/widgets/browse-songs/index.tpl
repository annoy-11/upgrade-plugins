...
<?php if(count($this->paginator) > 0): ?>
  <?php if (empty($this->viewmore)): ?>
    ...
    <?php if($this->viewType == 'listview'): ?>
      <ul class="clear sesmusic_artist_view_wrapper sesmusic_playlist_view clear " id= "results_data">
    <?php else: ?>
          ...
          <div class="sesmusic_songslist_songdetail">
            ...
            <?php if(!empty($this->information) && in_array('postedby', $this->information)): ?>
              <div class="sesmusic_artist_songslist_author sesbasic_text_light">
                ...
                <?php echo $this->translate('by %s', $this->htmlLink($album->getOwner(), $album->getOwner()->getTitle())) ?><?php echo $this->translate(' on %s', $this->timestamp($song->creation_date)); ?><?php if($song->upload_param == 'album') { ?><?php echo $this->translate(' in %s', $this->htmlLink($album->getHref(), $album->getTitle())); ?><?php } ?>
              </div>
            <?php endif; ?>
        ...
        <div class="sesmusic_artist_songslist_info_bottom">
          ...
          <div class="sesmusic_artist_songslist_info_dropdown">
            ...
            <?php $viewer = Engine_Api::_()->user()->getViewer();
					 ...
					 ?>
						<?php if($addstore_link && $song->store_link && $this->information && in_array('storeLink', $this->information)): ?>
							<?php $storeLink = !empty($song->store_link) ? (preg_match("#https?://#", $song->store_link) === 0) ? 'http://'.$song->store_link : $song->store_link : ''; ?>
