  ...
  public function init() {
    ...
    if (!$this->isModerator()) {
      unset($this->view->options[2]);
		...
		if($this->isPublic()){
			$this->addElement('Radio', 'download_song', array(
    ...
    if (!$this->isPublic()) {
      ...
      //Element: upload single song
      $this->addElement('Radio', 'uploadsong', array(
          'label' => 'Allow Upload Single Song',
          'description' => 'Do you want to allow members to upload single song on your website? [Note: Members would be able to upload signgle songs, if they are allowed to create Music Albums]',
          'multiOptions' => array(
              1 => 'Yes, allow members to upload single song.',
              0 => 'No, do not allow members to upload single song.',
          ),
          'value' => 0,
      ));
      ...
      $this->addElement('Radio', 'playlist_album', array(
      ...
      $this->addElement('Radio', 'playlist_song', array(
      ...
      $this->addElement('Radio', 'favourite_song', array(
      ...
      //Add Store URL in album and song create from
      $this->addElement('Radio', 'addstore_link', array(
          'label' => 'Allow URL to Create Albums and Songs?',
          'description' => 'Allow add a URL link to create new Music Album and Song to direct them to a sale page?',
          'multiOptions' => array(
              1 => 'Yes, allow a URL link for Albums and Songs.',
              0 => 'No, do not allow a URL link for Albums and Songs.'
          ),
          'value' => 0,
      ));
