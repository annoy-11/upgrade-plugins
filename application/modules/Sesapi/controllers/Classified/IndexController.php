...
//     }
    ...
    if($price) {
      $classified_content['price'] = $price;
    }
    //Location and Price profile field values
    
    // Get category
    if( !empty($classified->category_id) ) {
      $category_name = $this->getCategoryName(array('column_name' => 'category_name', 'category_id' => $classified->category_id)); // Engine_Api::_()->getItem('classified_category', $classified->category_id);
