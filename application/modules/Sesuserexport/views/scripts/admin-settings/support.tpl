 ...
 * @version    $Id: support.tpl  2018-11-17 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<?php include APPLICATION_PATH .  '/application/modules/Sesuserexport/views/scripts/dismiss_message.tpl';?>
<div class="sesbasic_support_links">
  ...
  <a href="https://socialenginesolutions.us16.list-manage.com/subscribe?u=70b1c9baba63dcf30fec2c66d&id=3c72ee2249" target="_blank">
    ...
    <p>Do you want know more about "Auto Actions Plugin" and it's features? If Yes, then click here to subscribe to our newsletter and stay updated.</p>
  </a>
