...
<?php endif; ?>
<h3>Pages Verification Requests</h3>
<p>
  <?php echo $this->translate('This page lists all the page verification requests made on your website which are waiting for admin approval. From here, you can take necessary action by approving, rejecting or deleting requests. Entering criteria into the filter fields will help you find specific request. Leaving the filter fields blank will show all the request on your website awaiting your action.<br /><br />Once an action is taken, the request will be removed from this page.<br /><br />Approved pages will display in the "Manage Verified Pages" section.'); ?>
</p>
<br />
...
<div class='sesbasic_search_result'>
  ...
  <?php echo $this->translate(array("%s page verification request found.", "%s page verification requests found.", $count),
...
<div class="admin_table_form sespageveroth_manage_requests">
<form>
