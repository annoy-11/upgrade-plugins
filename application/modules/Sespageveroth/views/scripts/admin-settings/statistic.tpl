...
<?php endif; ?>
<h3>Statistics</h3>
<p>This page list the total number of Verifications, Pages Verified and Pages Verifiers.</p><br />
<div class='settings'>
...
<!--          <tr>
            <td><strong class="bold"><?php //echo "Total Pages Verified:" ?></strong></td>
            <td><?php //echo '0'; ?></td>
          </tr>-->
          <tr>
            <td><strong class="bold"><?php echo "Total Pages Verifiers:" ?></strong></td>
