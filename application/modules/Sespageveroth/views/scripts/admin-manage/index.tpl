...
<h3>Manage Verified Pages</h3>

<p>

  <?php echo $this->translate('This page lists all the pages verified by the members on your website. You can use this page to monitor these verified Pages and delete offensive material if necessary. Entering criteria into the filter fields will help you find specific page. Leaving the filter fields blank will show all the pages on your social network.'); ?>
...
<div class='sesbasic_search_result'>
  ...
  <?php echo $this->translate(array("%s page found.", "%s page found.", $count),
...
<div class="admin_table_form sespageveroth_manage_members">
    ...
    <tbody>
      ...
      <?php if( count($this->paginator) ): ?>
        ...
        <?php foreach( $this->paginator as $item ):
          ...
          $resource = $this->item('sespage_page', $item->resource_id);
...
<div class="tip">
  ...
  <span>
    ...
    <?php echo "Currently, there are no verified pages on your website.";?>
