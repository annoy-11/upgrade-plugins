...
<dl class="payment_transaction_details">
  ...
  <dt>
    <?php echo $this->locale()->toNumber($this->transaction->getIdentity()) ?>
  </dt>
  ...
  <dt>
    	<a href="<?php echo $this->item->getHref(); ?>"  target='_blank' title="<?php echo  ucfirst($this->item->getTitle()) ?>">
  ...
  <dd>
    <?php echo $this->translate('Gateway Transaction ID/Profile Id') ?>
  </dd>
  <dt>
