<form method="get" action="<?php echo $this->escape($this->url(array('blog_id'=>$this->blog_id), 'sesblog_dashboard', true)) ?>" class="global_form" enctype="application/x-www-form-urlencoded">
  <div>
    <div>
      ...
      <?php if( $this->status == 'pending' ): ?>
        ...
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
            <button type="submit">
              <?php echo $this->translate('Back to Dashboard') ?>
            </button>
          </div>
        </div>
      ...
      <?php elseif( $this->status == 'active' ): ?>
        ...
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
            <button type="submit">
              <?php echo $this->translate('Continue to Dashboard') ?>
            </button>
          </div>
        </div>
