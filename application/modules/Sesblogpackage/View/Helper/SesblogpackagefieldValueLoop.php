...
class Sesblogpackage_View_Helper_SesblogpackageFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function sesblogpackageFieldValueLoop($subject, $partialStructure) {
