...
class Sesblogpackage_Plugin_Gateway_2Checkout extends Engine_Payment_Plugin_Abstract
{
  ...
  public function getGateway()
  {
    if( null === $this->_gateway ) {
      ...
      $gateway = new $class(array(
        ...
        'currency' => Engine_Api::_()->sesblog()->getCurrentCurrency(),
      ));
  ...
  {}
	...
	function createBlogTransaction(User_Model_User $user,
      Zend_Db_Table_Row_Abstract $item,
      Sesblogpackage_Model_Package $package,
      array $params = array()){
		// Do stuff to params
    $params['fixed'] = true;
