...
{
  return confirm("<?php echo $this->translate('Are you sure you want to delete the selected quote entries?');?>");
}
...
<h3>Manage Quotes</h3>
<p>
  <?php echo $this->translate("This page lists all of the quotes your users have created. You can use this page to monitor these quotes and delete offensive material if necessary. Entering criteria into the filter fields will help you find specific quote. Leaving the filter fields blank will show all the quotes on your social network. ") ?>
</p>
<br />
...
<div class="sesbasic_search_reasult">
  <?php echo $this->translate(array('%s quote found.', '%s quotes found.', $this->paginator->getTotalItemCount()), $this->locale()->toNumber($this->paginator->getTotalItemCount())) ?>
</div>
    ...
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        ...
        <td class="admin_table_centered">
          ...
          Engine_Api::_()->getDbtable('quotes', 'sesquote')->update(array(
          'offtheday' => 0,
          'starttime' =>'',
          'endtime' =>'',
          ), array(
          ...
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesquote', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->quote_id, 'type' => 'quote', 'param' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit Video of the Day'))), array('class' => 'smoothbox')); ?>
          <?php else: ?>
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesquote', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->quote_id, 'type' => 'quote', 'param' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make Video of the Day'))), array('class' => 'smoothbox')) ?>
          <?php endif; ?>
        </td>
        ...
        <td>
          ...
          |
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesquote', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->quote_id), $this->translate("delete"), array('class' => 'smoothbox')); ?>
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no quote entries posted by your members yet.") ?>
    </span>
  </div>
<?php endif; ?>
