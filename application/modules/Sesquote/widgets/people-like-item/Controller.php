 ...
 */
class Sesquote_Widget_PeopleLikeItemController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->sesquote()->likeItemCore($param);
