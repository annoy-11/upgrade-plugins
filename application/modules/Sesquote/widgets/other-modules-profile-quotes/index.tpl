    ...
    <?php if (empty($this->viewmore)): ?>
      <div class="sesgroup_profile_content_search sesbasic_clearfix">
          <?php if( $this->can_create ): ?>
            <div>
              <a class="sesbasic_button sesbasic_icon_add sesgroup_cbtn sessmoothbox" href="<?php echo $this->url(array('action' => 'create', 'resource_type' => $this->resource_type, 'resource_id' => $this->resource_id), "sesquote_general"); ?>"><?php echo $this->translate("Write New Quote"); ?></a>
            </div>
          <?php endif; ?>
      </div>
...
<?php else:?>
  <div class="sesbasic_tip">
    ...
    <span>
      ...
      <?php if($this->can_create): ?>
          <a class="sessmoothbox" href="<?php echo $this->url(array('action' => 'create', 'resource_type' => $this->resource_type, 'resource_id' => $this->resource_id), "sesquote_general"); ?>"><?php echo $this->translate("Write New Quote"); ?></a>
      <?php endif; ?>
    </span>
  </div>
<?php endif; ?>
...
<?php if($allParams['pagging'] == 'auto_load'): ?>
  <script type="text/javascript">    
     //Take refrences from: http://mootools-users.660466.n2.nabble.com/Fixing-an-element-on-group-scroll-td1100601.html
