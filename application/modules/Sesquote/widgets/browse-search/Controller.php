...
class sesquote_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $sesquote_browsesearch = Zend_Registry::isRegistered('sesquote_browsesearch') ? Zend_Registry::get('sesquote_browsesearch') : null;
    if(empty($sesquote_browsesearch)) {
