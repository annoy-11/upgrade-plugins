 ...
 * @version    $Id: Quote.php  2017-12-12 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesquote_Model_Quote extends Core_Model_Item_Abstract
{
  // Properties
  ...
  public function getRichContent($view = false, $params = array()) {
    ...
    if (!$view) {
      ...
      $view->quote = $this;
      $videoEmbedded = $view->render('application/modules/Sesquote/views/scripts/_quote.tpl');
    }
