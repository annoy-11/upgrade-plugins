...
class Sespagepackage_Installer extends Engine_Package_Installer_Module {
  ...
  public function onPreinstall() {
    ...
    if(!empty($sespage_Check) && !empty($event_activate[0]['value'])) {
