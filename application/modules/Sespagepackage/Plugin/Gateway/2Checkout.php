...
class Sespagepackage_Plugin_Gateway_2Checkout extends Engine_Payment_Plugin_Abstract {
  ...
  function createPageTransaction(User_Model_User $user, Zend_Db_Table_Row_Abstract $item, Sespagepackage_Model_Package $package, array $params = array()) {
    // Do stuff to params
    $params['fixed'] = true;
