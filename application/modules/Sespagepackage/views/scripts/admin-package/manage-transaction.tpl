...
<h3><?php echo $this->translate("Manage Page Package Payment Transactions") ?></h3>
<p><?php echo $this->translate('This page list all the payment transactions of the page packages that Page Owners have made on your site.  You can use this page to monitor these package transactions. Entering criteria into the filter fields will help you find specific transaction. Leaving the filter fields blank will show all the transactions on your social network.'); ?></p>
<br />
