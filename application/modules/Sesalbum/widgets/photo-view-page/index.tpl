...
?>
<?php if(!$this->is_ajax){ ?>
 <div id="photo_content" <?php if(!empty($this->locked)) { ?> style="display:none" <?php } ?>>
 <?php } ?>
...
function doResizeForButton(){
	...
	<?php } ?>
	 var width = sesJqueryObject('.sesalbum_view_photo_container').width();
  ...
  <section>
    ...
    ?>
      <div class="sesbasic_clearfix sesalbum_photo_view_btns">
        ...
        <a title="<?php echo $this->translate('Share'); ?>" href="<?php echo $this->url(array("action" => "share", "type" => "album_photo", "photo_id" => $this->photo->getIdentity(),"format" => "smoothbox"), 'sesalbum_general', true); ?>" class="sesalbum_photo_view_share_button smoothbox"><i class="fa fa-share"></i></a>     
