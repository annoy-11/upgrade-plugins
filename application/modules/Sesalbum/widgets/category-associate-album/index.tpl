  ...
  <?php foreach( $this->paginatorCategory as $item): ?>
  	<div class="sesalbum_categories_albums_listing clear sesbasic_clearfix">
    	<div class="sesalbum_categories_albums_listing_title clear sesbasic_clearfix">
      	<a class="sesbasic_linkinherit" href="<?php echo $item->getBrowseCategoryHref(); ?>?category_id=<?php echo $item->category_id ?>" title="<?php echo $this->translate($item->category_name); ?>"><?php echo $this->translate($item->category_name); ?><?php if(isset($this->count_album) && $this->count_album == 1){ ?><?php echo "(".$item->total_album_categories.")"; ?><?php } ?></a>
            ...
            <div class="sesalbum_categories_albums_item_stat sesalbum_list_stats sesbasic_clearfix sesbasic_text_light"> 
              ...
              <?php if(isset($this->albumCountActive)){ ?>
                <span title="<?php echo $this->translate(array('%s photo', '%s photos', $albumData->total_photos), $this->locale()->toNumber($albumData->total_photos)); ?>">
                  <i class="far fa-images"></i> <?php echo $albumData->total_photos ; ?>
                </span>
              <?php } ?>
             ...
             <?php } ?>
             <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesalbum.allowfavourite', 1) && isset($this->favouriteActive)) { ?>
             ...
             <?php if(isset($this->viewActive)) { ?>
              ...
              <?php } ?>
             	<?php if(isset($this->resultArray['photos'][$item->category_id])  && !$albumData->adult){ ?>
            ...
            <div>
              ...
              <?php if(isset($this->titleActive)){ ?>
                ...
                <div class="sesalbum_cat_album_list_stats sesalbum_list_stats sesbasic_text_light">
                  ...
                  <?php } ?>
                   <?php  if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesalbum.allowfavourite', 1) && isset($this->favouriteActive) && isset($itemAlbum->favourite_count)) { ?>
                  ...
                  <?php } ?>
                  <?php  if(isset($this->albumCountActive)) { ?>
                    <span title="<?php echo $this->translate(array('%s photo', '%s photos', $itemAlbum->count()), $this->locale()->toNumber($itemAlbum->count()))?>"><i class="far fa-images"></i><?php echo $itemAlbum->count(); ?></span>
                  <?php } ?>
                </div>
