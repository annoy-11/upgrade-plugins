                        ...
                        <div>
                          ...
                          <?php if(isset($this->titleActive)){ ?>
                            ...
                            <div class="sesalbum_cat_album_list_stats sesalbum_list_stats sesbasic_text_light">
                              ...
                              <?php } ?>
                              <?php  if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesalbum.allowfavourite', 1) && isset($this->favouriteActive) && isset($item->favourite_count)) { ?>
                              ...
                              <?php  if(isset($this->photoActive)) { ?>
                                <span title="<?php echo $this->translate(array('%s photo', '%s photos', $item->count()), $this->locale()->toNumber($item->count()))?>"><i class="far fa-images"></i><?php echo $item->count(); ?></span>
                              <?php } ?>
                            </div>
