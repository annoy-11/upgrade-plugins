...
class Sesalbum_Widget_OfTheDayController extends Engine_Content_Widget_Abstract
{
  ...
  {  
		...
		$this->view->socialshare_enable_plusicon = $socialshare_enable_plusicon =$this->_getParam('socialshare_enable_plusicon', 1);
		$this->view->socialshare_icon_limit = $socialshare_icon_limit =$this->_getParam('socialshare_icon_limit', 2);
