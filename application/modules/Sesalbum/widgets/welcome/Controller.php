  ...
  public function indexAction()
  {
		...
		if(isset($criteria_slide)){
			if($criteria_slide == 'featured')
				$fixedDataPhoto = 'engine4_sesalbum_photos.is_featured = 1';
			else if($criteria_slide == 'sponsored')
				$fixedDataPhoto = 'engine4_sesalbum_photos.is_sponsored = 1';
			else if($criteria_slide == 'featuredSPSponsored')
				$fixedDataPhoto = 'engine4_sesalbum_photos.is_featured = 1 && engine4_sesalbum_photos.is_sponsored = 1';
      ...
      return $this->setNoRender();
		...
		if(isset($criteria_slide_album)){
			if($criteria_slide_album == 'featured')
				$fixedDataAlbum = 'engine4_sesalbum_albums.is_featured = 1';
			else if($criteria_slide_album == 'sponsored')
				$fixedDataAlbum = 'engine4_sesalbum_albums.is_sponsored = 1';
			else if($criteria_slide_album == 'featuredSPSponsored')
				$fixedDataAlbum = 'engine4_sesalbum_albums.is_featured = 1 && engine4_sesalbum_albums.is_sponsored = 1';
