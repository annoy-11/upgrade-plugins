...
<div class="sesbasic_clearfix">
  <ul class="sesalbum_category_grid_listing sesbasic_clearfix clear sesbasic_bxs <?php echo ($this->allign_content == 'left' ? 'gridleft' : ($this->allign_content == 'right' ? 'gridright' : '')) ?>">
