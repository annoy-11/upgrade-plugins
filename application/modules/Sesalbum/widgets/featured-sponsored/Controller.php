...
class Sesalbum_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract
{
  ...
  {  
		...
		$value['socialshare_enable_plusicon'] = $this->view->socialshare_enable_plusicon = $this->_getParam('socialshare_enable_plusicon', 1);
		$value['socialshare_icon_limit'] = $this->view->socialshare_icon_limit = $this->_getParam('socialshare_icon_limit', 2);
