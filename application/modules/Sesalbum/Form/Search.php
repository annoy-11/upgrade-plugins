 ...
 public function setLocationSearch($title) {
  ...
  public function init() {
    ...
    if (count($categories) > 0) {
     ...
     if((Engine_Api::_()->getApi('settings', 'core')->getSetting('enableglocation', 1)) && ($this->_locationSearch == 'yes' && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesalbum_enable_location', 1))){
		/*Location Elements*/
