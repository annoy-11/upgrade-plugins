...
foreach( $files as $file ) {
  $banner_options[$file->storage_path] = $file->name;
      ...
      $this->addElement('Radio', 'sesalbum_add_tags', array(
          'label' => 'Tags',
          'description' => 'Do you want to enable the Tag Feature  in the lightbox?',
          'multiOptions' => array(
              1 => 'Yes',
              0 => 'No'
          ),
      ...
      $this->addElement('Radio', 'sesalbum_add_profilepic', array(
          ...
          'description' => 'Do you want to enable the "Make Profile Photo" Option for the light box?',
          'multiOptions' => array(
              1 => 'Yes',
              0 => 'No'
          ),
      ...
      $this->addElement('Radio', 'sesalbum_add_download', array(
          'label' => 'Download',
          'description' => 'Do you want to enable the Download button in the lightbox?',
          'multiOptions' => array(
              1 => 'Yes',
              0 => 'No'
          ),
      ...
      $this->addElement('Text', "sesalbum_iconlimit", array(
          ...
          'description' => 'Enter the number of social networking sites to be shown while sharing the photos. (If you enable More Icon, then other social site icons will display on clicking the more icon. (Works only if you have advanced social sharing.)',
