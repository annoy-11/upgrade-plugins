 ...
 * @version    $Id: OtherModulesProfilealbums.php 2015-06-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesalbum_Form_Admin_OtherModulesProfilealbums extends Engine_Form
{
    ...
    //Social Share Plugin work
		...
		$this->addElement('MultiCheckbox', "search_type", array(
			...
			'multiOptions' => array(
					...
					'albumCreate' => 'Create Album Button', 
			),
    ));
		...
		$this->addElement('Text', "albumCreate_order", array(
			'label' =>'Add Album Button',
			'value' => '4',
    ));
