...
function executeTaggerFn(){
   taggerInstanceSES = window.taggerInstanceSES = new Tagger('media_photo_next_ses_lightbox', {
      ...
      'cropOptions' : {
        'container' : $('media_photo_next_ses_lightbox')
      },
    ...
    var rating_out_viewer = window.rating_out_viewer = function() {
      if (new_text_viewer != ''){
        ...
        if ('<?php echo ($this->rating_count) > 1 ?>')
          ...
          var rateVal = 'rating';
        $('rating_text_viewer').innerHTML = "<?php echo $this->locale()->toNumber($this->rating_count); ?>"+" "+rateVal;        
      }
      ...
      (new Request.JSON({
        ...
        'onSuccess' : function(responseJSON, responseText)
        {
          ...
          if(responseJSON[0].total > 1)
            ...
            var rateVal = 'rating';
          $('rating_text_viewer').innerHTML = responseJSON[0].total+" "+rateVal;
