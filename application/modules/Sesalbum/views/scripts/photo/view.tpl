...
<div style="color: red;text-align: center;padding-top: 20px;font-size:17px;"><?php echo $this->translate('This photo is marked as adult, allow adult content to view this adult photo');?></div>
<?php } ?>