  ...
  <div class="ses_media_lightbox_options">
    ...
    <?php } ?>
      ...
      <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesalbum.add.share',1) == 1){ ?>
      	<a href="javascript:;" class='smoothbox sesbasic_icon_btn' onclick="openURLinSmoothBox('<?php echo $this->url(array("action" => "share", "type" => "album_photo", "photo_id" => $this->photo->getIdentity(),"format" => "smoothbox"), 'sesalbum_general', true); ?>')" title="<?php echo $this->translate('Share'); ?>"><i class="fa fa-share"></i></a>
      <?php } ?>
    </div>
