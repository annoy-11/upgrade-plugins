...
$db->insert('engine4_core_content', array(
  ...
  public function setLandingPageAction(){
    ...
    $form->setTitle("Set This Page As Landing Page?");
      $form->setDescription('Are you sure want to set the Welcome Page of this plugin as the Landing page of your website? For old landing page you will have to manually make changes in the Landing page from Layout Editor. Backup page of your current landing page will get created with the name "SES - Advanced Photos - Backup - Landing Page".');
 ...
 // Insert top
  ...
  $db->insert('engine4_core_content', array(
      ...
      if ($newbakpage_id) {
        ...
        $db->query('UPDATE `engine4_core_pages` SET `displayname` = "SES - Advanced Photos - Backup - Landing Page" WHERE `engine4_core_pages`.`name` = "sesalbum_index_sesbackuplandingppage";');
      }
    }
          }
        } catch (Exception $e) {
