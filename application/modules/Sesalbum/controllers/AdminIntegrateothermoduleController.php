...
class Sesalbum_AdminIntegrateothermoduleController extends Core_Controller_Action_Admin {
  public function indexAction() {
    ...
    $select = Engine_Api::_()->getDbtable('integrateothermodules', 'sesbasic')->select()->where('type =?', 'lightbox');
  ...
  public function addmoduleAction() {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      $is_module_exists= $integrateothermoduleTable->fetchRow(array('type = ?' => 'lightbox', 'content_type = ?' => $values['content_type'], 'module_name = ?' => $values['module_name']));
