...
<br />
        ...
        <table class='admin_table'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php $event = Engine_Api::_()->getItem('sesgroup_group',$item->group_id); ?>
              ...
              <td class="admin_table_centered"><?php echo Engine_Api::_()->egroupjoinfees()->getCurrencyPrice(round($item->total_amount,2),$defaultCurrency); ?></td>
              <td class="admin_table_centered">
                <?php echo date('Y-m-d',strtotime($item->creation_date)); ?>
              </td>
              <td>
                <?php echo $this->htmlLink($this->url(array('group_id' => $event->custom_url,'action'=>'view','order_id'=>$item->order_id), 'egroupjoinfees_order', true).'?order=view', $this->translate("View Order"), array('title' => $this->translate("View Order"), 'class' => 'smoothbox')); ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
    ...
    <?php else:?>
      <div class="tip">
        <span>
          <?php echo $this->translate('No one has joined a paid group on your website yet.') ?>
        </span>
      </div>
    <?php endif; ?>
    </div>
