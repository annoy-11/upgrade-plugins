 ...
 */
class Egroupjoinfees_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_rowClass = 'Egroupjoinfees_Model_Usergateway';
 //protected $_name = 'payment_gateways';
  ...
  public function getEnabledGatewayCount()
  {
	...
	public function getUserGateway($params = array()){
			$select = $this->select()->from($this->info('name'))->where('group_id =?',$params['group_id']);
