...
class Sesgrouppackage_Plugin_Gateway_2Checkout extends Engine_Payment_Plugin_Abstract {
  ...
  function createGroupTransaction(User_Model_User $user, Zend_Db_Table_Row_Abstract $item, Sesgrouppackage_Model_Package $package, array $params = array()) {
    // Do stuff to params
    $params['fixed'] = true;
