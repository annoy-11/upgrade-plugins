...
class Sesgrouppackage_Model_DbTable_Transactions extends Engine_Db_Table {

  protected $_rowClass = 'Sesgrouppackage_Model_Transaction';
  ...
  public function getBenefitStatus(User_Model_User $user = null) {
    // Get benefit setting
    $benefitSetting = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgrouppackage.payment.mod.enable');
