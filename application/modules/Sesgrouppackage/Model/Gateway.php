 ...
 */
class Sesgrouppackage_Model_Gateway extends Core_Model_Item_Abstract
{
  ...
  public function getPlugin()
  {
    if( null === $this->_plugin ) {
      ...
      if($this->plugin == "Sesadvpmnt_Plugin_Gateway_Stripe"):
        $class = str_replace('Sesadvpmnt','Sesgrouppackage',$class);
      elseif($this->plugin == "Epaytm_Plugin_Gateway_Paytm"):
        $class = str_replace('Epaytm','Sesgrouppackage',$class);
      else:
        $class = str_replace('Payment','Sesgrouppackage',$class);
      endif;
