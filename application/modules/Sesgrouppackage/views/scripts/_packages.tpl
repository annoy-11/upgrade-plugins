 ...
 */
 ...
 <li class="sesgroup_packages_table_item <?php echo ($package->highlight) ? 'active' : '' ?>">
  <section>
    ...
    <div class="_cont">
      <ul class="package_capabilities">
        ...
        <?php if(in_array('featured',$showinfo)){ ?>	
          <li class="sesbasic_clearfix <?php echo ($enableModules['group_featured']) ? 'yes' : 'no'; ?>">
        ...
        <?php if(in_array('sponsored',$showinfo)){ ?>  
          <li class="sesbasic_clearfix <?php echo ($enableModules['group_sponsored']) ? 'yes' : 'no'; ?>">
        ...
        <?php if(in_array('verified',$showinfo)){ ?>  
          <li class="sesbasic_clearfix <?php echo ($enableModules['group_verified']) ? 'yes' : 'no'; ?>">
        ...
        <?php if(in_array('hot',$showinfo)){ ?>  
          <li class="sesbasic_clearfix <?php echo ($enableModules['group_hot']) ? 'yes' : 'no'; ?>">
