 ...
 * @version    $Id: _packagesHorizontal.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
   ...
   <div class="_top sesbasic_clearfix">
    ...
    <div class="_btns sesbasic_clearfix">
      <?php if($existing && !$package->isOneTime()):?>
        <div class="_left">
          <a href="<?php echo $this->url(array('action' => 'cancel','package_id' => $package->package_id),'sesgrouppackage_general',true);?>" class="sesgroup_packages_cancel_btn smoothbox"><?php echo $this->translate("Cancel");?></a>
      ...
      <div class="_right">
        <?php if($existing):?>
          <a class="sesgroup_packages_create_btn sesbasic_animation" href="<?php echo $this->url(array('action' => 'create', 'existing_package_id' => $packageleft->getIdentity()),'sesgroup_general',true); ?>"><?php echo $this->translate('Create Group');?></a>
        <?php else:?>
          <a class="sesgroup_packages_create_btn sesbasic_animation" href="<?php echo $this->url(array('action' => 'create', 'package_id' => $package->package_id),'sesgroup_general',true); ?>"><?php echo $this->translate('Create Group');?></a>
        <?php endif;?>
      </div>
    </div>
  </section>
