...
<div class="sesbasic_search_result">
  <?php echo $this->htmlLink($this->url(array('module' => 'sesgrouppackage', 'controller' => 'package','action'=>'index')), $this->translate("Back to Manage Packages"), array('class' => 'buttonlink sesbasic_icon_back')); ?>
</div><br />
...
<script type="application/javascript">
  ...
  window.addEvent('domready', function() {
   ...
   var valueStyle = sesJqueryObject('input[name=gorup_choose_style]:checked').val();
    if(valueStyle == 1) {
      sesJqueryObject('#group_chooselayout-wrapper').show();
      sesJqueryObject('#group_style_type-wrapper').hide();
    }
