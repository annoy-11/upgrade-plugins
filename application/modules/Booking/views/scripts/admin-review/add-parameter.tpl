 ...
 * @version    $Id: add-parameter.tpl  2019-03-19 00:00:00 SocialEngineSolutions $
...
<script type="application/javascript">
  var alreadyaddedParameter = sesJqueryObject('.estore_added_parameter');
  if(alreadyaddedParameter.length > 0){
    for(var i=0;i<alreadyaddedParameter.length;i++){
      var id = sesJqueryObject(alreadyaddedParameter[i]).attr('id').replace('estore_review_','');
