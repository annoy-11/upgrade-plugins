...
<div class="sesbasic_view_stats_popup">
  ...
  <table>
    <tr>
      <?php $professionalItem = Engine_Api::_()->getDbtable('professionals', 'booking')->getProfessioanlId($this->item->professional_id); ?>
      <?php $professional = Engine_Api::_()->getItem('professional', $professionalItem->professional_id); ?>
      <td><?php echo $this->translate('Professional') ?>:</td>
      <td><?php if(!is_null($professional->name) && $professional->name != '') { ?>
       <a href="<?php echo $professional->getHref(); ?>" target="_blank"><?php echo $professional->name ?></a>
       <?php
        } else { 
        echo "-";
        } ?>
    ...
    <tr>
      ...
      <?php  $owner = Engine_Api::_()->getItem('user', $professionalItem->user_id); ?>
      <td><a href="<?php echo $owner->getHref(); ?>" target="_blank"><?php echo $owner->displayname ?></a></td>
    </tr>
    <tr>
