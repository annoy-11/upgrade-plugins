...
<script type="text/javascript">
  ...
  function multiDelete() {
    return confirm("<?php echo $this->translate('Are you sure you want to delete the selected transection?');?>");
  }
  function selectAll() {
    var i;
...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <?php endif; ?>
    <h3><?php echo $this->translate("Payments Made to Event Owners") ?></h3>
    <p><?php echo $this->translate('This page lists all of the payments made to the event owners on your website. You can use this page to monitor these payments made. Entering criteria into the filter fields will help you find specific payment detail. Leaving the filter fields blank will show all the payments made to event owners on your social network.'); ?></p>
    <br />
        ...
        <table class='admin_table'>
          <thead>
            <tr>
              ...
              <th><?php echo $this->translate("Professional Name") ?></th>
            ...
            <?php foreach ($this->paginator as $item): ?>
              <?php $owner = Engine_Api::_()->getItem('user', $item->owner_id);
                if(!$owner)
                  continue;
              ?>
              <?php $professionalItem = Engine_Api::_()->getDbtable('professionals', 'booking')->getProfessioanlId($item->owner_id); ?>
              <?php $professional = Engine_Api::_()->getItem('professional', $professionalItem->professional_id); ?>
            <tr>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'booking', 'controller' => 'manage-orders', 'action' => 'view-paymentrequest', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
