 ...
 * @version    $Id: Category.php  2019-03-19 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Booking_Model_Category extends Core_Model_Item_Abstract {
  ...
  public function getTable() {
    if (is_null($this->_table)) {
      $this->_table = Engine_Api::_()->getDbtable('categories', 'booking');
    }
  ...
  public function getBrowseCategoryHref($params = array()) {
	...
	public function getPhotoUrl($type = NULL) {
		if(!$this)
			return 'application/modules/Booking/externals/images/nophoto_event_thumb_profile.png';
