...
class Booking_Plugin_Gateway_Stripe extends Engine_Payment_Plugin_Abstract
{
  ...
  public function orderBookingTransactionReturn($order, $transaction)
  {
  ...
  public function createBookingOrderTransaction($param = array()) {
      ...
      $currencyValue = $param['change_rate'] ? $param['change_rate'] : 1;
        try {
          ...
          $this->_session->errorMessage = $body['error'];
            ...
            throw new Engine_Payment_Plugin_Exception($e->getMessage());
