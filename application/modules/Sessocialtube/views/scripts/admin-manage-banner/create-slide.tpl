 ...
 * @version    $Id: create-slide.tpl 2016-04-18 00:00:00 SocialEngineSolutions $
...
<div class="sesbasic_search_reasult">
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sessocialtube', 'controller' => 'manage-banner', 'action' => 'manage','id'=>$this->banner_id), $this->translate("Back to Manage Photos") , array('class'=>'sesbasic_icon_back buttonlink')); ?>
</div>
<div class='clear'>
