 ...
 */
?>
<?php $showPopup = Engine_Api::_()->getApi('settings', 'core')->getSetting('sessocialtube.popup.enable', 1);
...
<script type="text/javascript">
  sesJqueryObject(document).on('click','#sessocialtube_header_searchbox_toggle',function(){
    if(sesJqueryObject (this).hasClass('active')){
     sesJqueryObject (this).removeClass('active');
     sesJqueryObject ('.header_search').removeClass('open_search');
    }else{
     sesJqueryObject (this).addClass('active');
     sesJqueryObject ('.header_search').addClass('open_search');
    }
 });
</script>
<div id='core_menu_mini_menu'>
  ...
  ?>
    <ul class="socialtube_minimenu_links">
    <?php if($this->header_template == 6): ?>
    	<li class="socialtube_minimenu_search socialtube_minimenu_icon">
      	<a href="javascript:void(0);" id="sessocialtube_header_searchbox_toggle"></a>
      </li>
    <?php endif; ?>
    <?php foreach( $this->navigation as $item ): ?>
      <?php if(end((explode(' ', $item->class))) == 'core_mini_signup'):  ?>
        <?php if(empty($popShow)): ?>
		      <li class="socialtube_minimenu_link socialtube_minimenu_link_signup">
      ...
      <?php elseif(end((explode(' ', $item->class))) == 'core_mini_auth' && $this->viewer->getIdentity() == 0): ?>
        <?php if(empty($popShow)): ?>
	        <li class="socialtube_minimenu_link socialtube_minimenu_link_login">
        ...
        <?php  elseif(end((explode(' ', $item->class))) == 'core_mini_friends'): ?>
           <?php $friendRequestIcon = Engine_Api::_()->getApi('menus', 'sessocialtube')->getIconsMenu('core_mini_friends');?>
           <?php if($this->viewer->getIdentity()):?>
             <li class="socialtube_minimenu_request socialtube_minimenu_icon" title="<?php echo $this->translate('Friends Invitation');?>">
            <?php if($this->requestCount):?>
              <span id="request_count_new" class="socialtube_minimenu_count"><?php echo $this->requestCount ?></span>
            <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'friendrequest');" style="display:block;" class="friends_pulldown">
            <div id="friend_request" class="socialtube_pulldown_contents_wrapper">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="socialtube_pulldown_header">
                <?php echo $this->translate('Requests'); ?>
              </div>
              <div id="socialtube_friend_request_content" class="socialtube_pulldown_contents">
        ...
        <?php $notificationIcon = Engine_Api::_()->getApi('menus', 'sessocialtube')->getIconsMenu('core_mini_notification');?>
        <?php if($this->viewer->getIdentity()):?>
          <li id='core_menu_mini_menu_update' class="socialtube_minimenu_updates socialtube_minimenu_icon" title="<?php echo $this->translate('Notifications');?>">
              <?php if($this->notificationCount):?>
                <span id="notification_count_new" class="socialtube_minimenu_count">
            ...
            <span onclick="toggleUpdatesPulldown(event, this, '4', 'notifications');" style="display:block;" class="updates_pulldown">
              <div class="socialtube_pulldown_contents_wrapper">
                <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                <div class="socialtube_pulldown_header">
                  <?php echo $this->translate('Notifications'); ?>
                </div>
                <div class="socialtube_pulldown_contents pulldown_content_list">
                ...
                <div class="socialtube_pulldown_options">
      ...
      <?php elseif(end((explode(' ', $item->class))) == 'core_mini_profile'):?>
        <li class="socialtube_minimenu_profile" title="<?php echo $this->translate('My Profile');?>">
      ...
      <?php elseif(end((explode(' ', $item->class))) == 'core_mini_settings'):?>
        <?php $settingIcon = Engine_Api::_()->getApi('menus', 'sessocialtube')->getIconsMenu('core_mini_settings');?>
        <li class="socialtube_minimenu_setting socialtube_minimenu_icon" title="<?php echo $this->translate('Settings');?>">
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'settings');" style="display:block;" class="settings_pulldown">
            <div id="user_settings" class="socialtube_pulldown_contents_wrapper sm-mini-menu-settings-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="socialtube_pulldown_header">
                <?php echo $this->translate('Account & Settings');?>
              </div>
              <div id="socialtube_user_settings_content" class="socialtube_pulldown_contents">
      ...
      <?php elseif(end((explode(' ', $item->class))) == 'core_mini_messages'):?>
        <?php $messageIcon = Engine_Api::_()->getApi('menus', 'sessocialtube')->getIconsMenu('core_mini_messages');?>
        <li class="socialtube_minimenu_message socialtube_minimenu_icon" title="<?php echo $this->translate('Messages');?>">
          <?php if($this->messageCount):?>
            <span id="message_count_new" class="socialtube_minimenu_count"><?php echo $this->messageCount ?></span>
          <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'message');" style="display:block;" class="messages_pulldown">
            <div id="socialtube_user_messages" class="socialtube_pulldown_contents_wrapper sm-mini-menu-messages-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="socialtube_pulldown_header">
              ...
              <div id="socialtube_user_messages_content" class="socialtube_pulldown_contents">
      ...
      <?php elseif(end((explode(' ', $item->class))) == 'core_mini_admin'):?>
        <?php continue;?>
      <?php else:?>
        <li class="socialtube_minimenu_link">
...
<script type='text/javascript'>
  ...
  en4.core.runonce.add(function(){
    ...
    (new Request.JSON({
      'url' : en4.core.baseUrl + 'sessocialtube/notifications/hide'
    })).send();
  ...
  var toggleUpdatesPulldown = function(event, element, user_id, menu) {
    ...
    if(event.target.className == 'socialtube_pulldown_header')
    return;
    ...
    if(menu == 'notifications' && hideNotification == 0) {
      ...
      if( element.className=='settings_pulldown' ) {
        ...
        document.getElementById('socialtube_user_settings_content').style.display = 'block';
      } 
      else {
  ...
  var showNotifications = function() {
    ...
    abortRequest = new Request.HTML({
      'url' : en4.core.baseUrl + 'sessocialtube/notifications/pulldown',
      'data' : {
        'format' : 'html',
        'page' : 1
      },
      'onComplete' : function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        document.getElementById('notification_count_new').removeClass('socialtube_minimenu_count');
      }
  ...
  function showSettings() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sessocialtube/index/general-setting',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       document.getElementById('socialtube_user_settings_content').innerHTML = responseHTML;
      }
    });
    en4.core.request.send(abortRequest, {
    'force': true
  ...
  function showMessages() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sessocialtube/index/inbox',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       document.getElementById('socialtube_user_messages_content').innerHTML = responseHTML;
       document.getElementById('message_count_new').innerHTML = '';
       document.getElementById('message_count_new').removeClass('socialtube_minimenu_count');
      }
    }); 
    en4.core.request.send(abortRequest, {
    'force': true
  ...
  function showFriendRequests() {
    ...
    abortRequest = new Request.HTML({
      url : en4.core.baseUrl + 'sessocialtube/index/friendship-requests',
      data : {
        format : 'html'
      },
      onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
      {
       if(responseHTML) {
         document.getElementById('socialtube_friend_request_content').innerHTML = responseHTML;
         document.getElementById('request_count_new').innerHTML = '';
         document.getElementById('request_count_new').removeClass('socialtube_minimenu_count');
       }
       else {
  ...
  if('<?php echo $this->viewer->getIdentity();?>' == 0) {
			...
			jqueryObjectOfSes.magnificPopup.instance.close = function () {
				var day = '<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sessocialtube.popup.day', 5);?>';
				if(day != 0)
...
window.addEvent('domready', function() {
  $(document.body).addEvent('click', function(event){
    if(event.target.id != 'show_message' && event.target.id != 'show_request' && event.target.id != 'updates_toggle' &&  event.target.id != 'show_settings' && event.target.className != 'socialtube_pulldown_header' && event.target.className != 'pulldown_loading') {
      if($$(".updates_pulldown_active").length > 0)
      $$('.updates_pulldown_active').set('class', 'updates_pulldown');
...
jqueryObjectOfSes(document).ready(function(e){
	jqueryObjectOfSes('#signup_account_form input,#signup_account_form input[type=email], #user_form_login input,#user_form_login input[type=email]').each(
    function(index){
...
jqueryObjectOfSes(document).ready(function(e){
	jqueryObjectOfSes('#sessocialtube_form_login input,#sessocialtube_form_login input[type=email]').each(
    function(index){
        var input = jqueryObjectOfSes(this);
        if(jqueryObjectOfSes(this).closest('div').parent().css('display') != 'none' && jqueryObjectOfSes(this).closest('div').parent().find('.form-label').find('label').first().length && jqueryObjectOfSes(this).prop('type') != 'hidden' && jqueryObjectOfSes(this).closest('div').parent().attr('class') != 'form-elements'){	
          if(jqueryObjectOfSes(this).prop('type') == 'email' || jqueryObjectOfSes(this).prop('type') == 'text' || jqueryObjectOfSes(this).prop('type') == 'password'){
...
<?php endif; ?>
  ...
  function newFriendRequests() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sessocialtube/index/new-friend-requests',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.requestCount && $("request_count_new") ) {
          ...
          $("request_count_new").style.display = 'block';
         		...
         		$("request_count_new").addClass('socialtube_minimenu_count');
...
function newUpdates() {
  en4.core.request.send(new Request.JSON({
    url : en4.core.baseUrl + 'sessocialtube/index/new-updates',
    method : 'POST',
    data : {
      format : 'json'
    },
    onSuccess : function(responseJSON) 
    {
      if( responseJSON.notificationCount && $("notification_count_new") ) {
        ...
        $("notification_count_new").innerHTML = responseJSON.notificationCount;
        	...
        	$("notification_count_new").addClass('socialtube_minimenu_count');
      }
    }
  }));
}  
  function newMessages() {
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sessocialtube/index/new-messages',
      method : 'POST',
      data : {
        format : 'json'
      },
      onSuccess : function(responseJSON) 
      {
        if( responseJSON.messageCount && $("message_count_new") ) {
          ...
          $("message_count_new").style.display = 'block';
        	...
        	$("message_count_new").addClass('socialtube_minimenu_count');
