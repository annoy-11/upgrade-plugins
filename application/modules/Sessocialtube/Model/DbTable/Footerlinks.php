...
class Sessocialtube_Model_DbTable_Footerlinks extends Engine_Db_Table {

  protected $_rowClass = "Sessocialtube_Model_Footerlink";

  public function getInfo($params = array()) {

    $socialTable = Engine_Api::_()->getDbTable('footerlinks', 'sessocialtube');
