...
<?php if($this->type == 1): ?>
  ...
  <div class="sescontentcoverphoto_cover_stats sesbasic_clearfix clear">
    ...
    <?php } ?>
    <?php if(in_array('playcount',$this->option)){ ?>
      <div title="<?php echo $this->translate(array('%s play', '%s plays', $subject->play_count), $this->locale()->toNumber($subject->play_count))?>">
        <span class="sescontentcoverphoto_cover_stat_count"><?php echo $subject->play_count ?></span>
        <span class="sescontentcoverphoto_cover_stat_txt"> <?php echo str_replace(',','',preg_replace('/[0-9]+/','',$this->translate(array('%s Play', '%s Plays', $subject->play_count), $this->locale()->toNumber($subject->play_count)))); ?></span>
      </div>
    <?php } ?>
  </div>
    ...
    <ul>
      ...
      <?php if(in_array('playcount',$this->option)){ ?>
        <li>
          ...
          <?php echo $subject->play_count; ?><?php echo str_replace(',','',preg_replace('/[0-9]+/', '', $this->translate(array('%s Play', '%s Plays', $subject->play_count), $this->locale()->toNumber($subject->play_count)))); ?>
        </li>     
      <?php } ?>
    </ul>
  </div>
