...
<?php if($this->type == 1): ?>
  ...
  <?php if(in_array('category',$this->option) && $subject->category_id): 
    $category = Engine_Api::_()->video()->getCategory($subject->category_id); ?>
    <div class="sescontentcoverphoto_cover_field sesbasic_clearfix"> 
      <i class="fa fa-folder"></i>
      <span>
        <?php echo $this->translate("Category: "); ?>
        <?php echo $this->htmlLink(array('route' => 'video_general', 'action' => 'browse', 'category_id' => $subject->category_id), $this->translate((string)$category->category_name)) ?>
      </span>
    </div>
  <?php endif; ?>
  ...
  <div class="sescontentcoverphoto_cover_stats sesbasic_clearfix clear">
    ...
    <?php if(in_array('commentcount',$this->option)){ ?>
      <div title="<?php echo $this->translate(array('%s comment', '%s comment', $subject->comment_count), $this->locale()->toNumber($subject->comment_count))?>">
    ...
    <ul>
      ...
      <?php if(in_array('commentcount',$this->option)){ ?>
        <li>
          ...
          <?php echo $subject->comment_count ?><?php echo str_replace(',','',preg_replace('/[0-9]+/','',$this->translate(array('%s Comment', '%s Comments', $subject->comment_count), $this->locale()->toNumber($subject->comment_count)))); ?></span>
        </li>
      <?php } ?>
    </ul>
  </div>
<?php elseif($this->type == 4): ?>
  ...
  <?php if(in_array('category',$this->option) && $subject->category_id): 
    ...
    <p class="sescontentcoverphoto_cover_field"> 
      ...
      <span>
        <?php echo $this->translate("Category: "); ?>
        <?php echo $this->htmlLink(array('route' => 'event_general', 'action' => 'browse', 'category_id' => $subject->category_id), $this->translate((string)$category->category_name)) ?>
      </span>
    </p>
  <?php endif; ?>
  <div class="sescontentcoverphoto_cover_stats sesbasic_clearfix clear">
