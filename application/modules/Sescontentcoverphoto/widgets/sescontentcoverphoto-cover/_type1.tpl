 ...
 * @version    $Id: _type1.tpl 2016-06-020 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescontentcoverphoto/externals/styles/cover_layout1.css'); ?>
<div class="sescontentcoverphoto_cover_wrapper sesbasic_bxs sesusercover_cover_type1 <?php if($this->is_fullwidth){?>sescontentcoverphoto_cover_wrapper_full<?php } ?>" style="height:<?php echo $this->height; ?>px">
  <div class="sescontentcoverphoto_cover_container sesbasic_bxs <?php echo $this->tab == 'inside' ? 'sescontentcoverphoto_cover_tabs_wrap' : '' ?> " style="height:<?php echo $this->height; ?>px">
    <!--Cover Photo-->
    <?php 
    ...
    ?>
    <div id="sescontentcoverphoto_cover_default" class="sescontentcoverphoto_cover_thumbs" style="display:<?php echo !$memberCover ? 'block' : 'none'; ?>;"></div>
    <div class="sescontentcoverphoto_cover_image">
    ...
    <span class="sescontentcoverphoto_cover_fade"></span>
...
<!--    <div class="sesusercover_cover_labels">
    ...
    <div class="sescontentcoverphoto_cover_inner">
      <div class="sescontentcoverphoto_cover_cont sesbasic_clearfix">
        <div class="sescontentcoverphoto_cover_cont_inner">
          <!--Main Photo-->     
          <?php
          ...
          <?php if(in_array('photo',$this->option)){ ?>      
            <div class="sescontentcoverphoto_cover_main_photo">
                ...
                <?php if($this->can_edit && $typeArray['uploadprofilePhoto']) { ?>
                  ...
                  <input type="file" id="uploadFileMainCoverPhoto" name="main_photo_cvr" onchange="uploadFileMainCoverPhoto(this);"  style="display:none" />
                    ...
                    <div class="sescontentcoverphoto_change_cover_options_main sesbasic_option_box">
                      <i class="sescontentcoverphoto_change_cover_options_main_arrow"></i>
                      <a href="javascript:;" id="change_main_cvr_pht"><i class="fa fa-plus"></i>
                      <?php echo $photo_id  ?  $this->translate("Change Profile Photo") : $this->translate("Add Profile Photo"); ?>
                      </a>
          ...
          <div class="sescontentcoverphoto_cover_info">
          ...
          <div class="sescontentcoverphoto_cover_footer">
            <div class="sescontentcoverphoto_cover_footer_inner">     
              <?php if($this->tab == 'inside'){ ?>
                <div class="sescontentcoverphoto_tabs sescontentcoverphoto_cover_tabs"></div>
              <?php } ?>
            </div>
          </div>
        </div>
...
<?php if($typeArray['insideOutsideCheck']): ?>
  <?php if($this->tab == 'inside'){ ?>
  <style type="text/css">
  ...
  var tabs = sesJqueryObject('.layout_core_container_tabs').find('.tabs_alt').get(0).outerHTML;
  	//sesJqueryObject('.layout_core_container_tabs').find('.tabs_alt').remove();
		...
		sesJqueryObject('.sescontentcoverphoto_tabs').html(tabs);
  });
...
sesJqueryObject('#sescontentcoverphoto_main_photo_reposition').click(function(){
		...
		sesJqueryObject('.sescontentcoverphoto_cover_inner').hide();
...
sesJqueryObject('#cancelreposition').click(function(){
	...
	sesJqueryObject('.sescontentcoverphoto_cover_inner').show();
...
function uploadFileToServerMain(files){
	...
	sesJqueryObject('.sescontentcoverphoto_cover_main_photo').append('<div id="sescontentcoverphoto_cover_loading_main" class="sescoverpphoto_overlay" style="display:block;"><div class="sescover_loading"><div class="sescover_loading_bar"></div><div class="sescover_loading_bar"></div><div class="sescover_loading_bar"></div><div class="sescover_loading_bar"></div></div></div></div>');
	<?php }else{ ?>
		sesJqueryObject('.sescontentcoverphoto_cover_main_photo').append('<div id="sescontentcoverphoto_cover_loading_main" class="sescoverpphoto_overlay" style="display:block;"><div class="sescover_loading"><div class="sescover_loading_bar"></div><div class="sescover_loading_bar"></div><div class="sescover_loading_bar"></div><div class="sescover_loading_bar"></div></div></div>');
	<?php } ?>
	var formData = new FormData();
...
function take_coverphotosnapshot() {
	...
	Webcam.snap(function(data_uri) {
		...
		sesJqueryObject('#sescontentcoverphoto_cover_photo_loading').show();
		// upload results
		 Webcam.upload( data_uri, en4.core.staticBaseUrl+'sescontentcoverphoto/index/edit-coverphoto/user_id/<?php echo $user_id; ?>/resource_id/<?php echo $this->resource_id; ?>/resource_type/<?php echo $this->resource_type; ?>' , function(code, text) {
...
function removeCoverPhoto(){
		...
		uploadURL = en4.core.staticBaseUrl+'sescontentcoverphoto/index/remove-cover/user_id/<?php echo $user_id; ?>/resource_id/<?php echo $this->resource_id; ?>/resource_type/<?php echo $this->resource_type; ?>';
		var jqXHR=sesJqueryObject.ajax({
			url: uploadURL,
			type: "POST",
			contentType:false,
