 ...
 * @version    $Id: _type3.tpl 2016-06-020 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescontentcoverphoto/externals/styles/cover_layout3.css'); ?>
<div class="sesusercover_main_container sesusercover_cover_type3 sesbasic_bxs <?php if($this->is_fullwidth){?>sescontentcoverphoto_cover_wrapper_full<?php } ?>">
    ...
    <div class="sescontentcoverphoto_cover_information_block sesbasic_clearfix">
      <div class="sescontentcoverphoto_cover_information_block_inner sesbasic_clearfix">
        <?php if(in_array('photo',$this->option)){ ?>
          ...
          ?>
          <div class="sescontentcoverphoto_profile_img <?php if($this->userphotoround == 1): ?> isround <?php endif; ?>">
        ...
        <?php //User Cover Photo Button Work ?>
        ...
        <?php //End User Cover Photo Button Work ?>
      </div>
      <?php //if($this->module == 'user' && $this->controller == 'profile' && $this->action == 'index'): ?>
        <?php if($this->tab == 'inside'){ ?>
          <div class="sesmember_tabs sescontentcoverphoto_cover_tabs"></div>
        <?php } ?>
      <?php //endif; ?>
    </div>
  </div>
...
window.addEvent('domready',function(){
  var heightin = sesJqueryObject('.sescontentcoverphoto_cover_information_block').height();
  var givht = '<?php echo $this->height; ?>';
