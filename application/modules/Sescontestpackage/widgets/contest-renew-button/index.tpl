...
<div class="sescontest_package_details sesbasic_bxs">
  ...
  <?php }else{ ?>
    ...
    <?php }else{  ?>
      <div>
        <a href="<?php echo $this->url(array('contest_id' => $item->contest_id,'action'=>'index'), 'sescontestpackage_payment', true); ?>" class="sescontest_payment_btn sesbasic_animation"><i class="fa fa-money"></i><span><?php echo $this->translate("Make Payment"); ?></span></a>
      </div>
    <?php } ?>
  <?php } ?>
</div>  