...
class Sescontestpackage_Plugin_Gateway_2Checkout extends Engine_Payment_Plugin_Abstract {
  ...
  function createContestTransaction(User_Model_User $user, Zend_Db_Table_Row_Abstract $item, Sescontestpackage_Model_Package $package, array $params = array()) {
    // Do stuff to params
    $params['fixed'] = true;
  ...
  public function cancelContest($transactionId) {
    return $this;
  }
