...
class Sescontestpackage_Plugin_Gateway_Paytm extends Engine_Payment_Plugin_Abstract
{
...
//     // One-time
    ...
    public function onIpnTransaction($subscription){
      ...
      if ($order) {
        ...
        if ($order->source_type == 'contest') {
          $this->onContestTransactionIpn($order, $response);
          $ipnProcessed = true;
        }
  ...
  public function onContestTransactionIpn(Payment_Model_Order $order,  $rawData) { 
