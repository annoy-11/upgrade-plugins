 ...
 * @version    $Id: inbox.tpl  2018-09-21 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesdating/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sesdating_messages_menu')){
          var message_children = $('sesdating_messages_menu').getChildren('li');
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesdating/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
