...
<script type="application/javascript">
  ...
  sesJqueryObject('.add_feature_content').click(function(){
    ...
    var html = '<div style="cursor:move;" class="item_label_feature"><div class="form-wrapper"><div class="form-label"><label>Title</label></div><div class="form-element"><input type="text" name="sesdating_feature_content['+elementCounter+'][caption]" value=""></div></div><div class="form-wrapper"><div class="form-label"><label>Description</label></div><div class="form-element"><input type="text" name="sesdating_feature_content['+elementCounter+'][description]" value=""></div></div><div class="form-wrapper"><div class="form-label"><label>URL</label></div><div class="form-element"><input type="text" name="sesdating_feature_content['+elementCounter+'][url]" value=""></div></div><div class="form-wrapper"><div class="form-label"><label>Icon Image</label></div><div class="form-element"><p class="description">Choose from below the logo image for your website. [Note: You can add a new photo from the "File & Media Manager" section from here: <a href="<?php echo $fileLink ?>" target="_blank">File & Media Manager</a>. Leave the field blank if you do not want to show logo.]</p><?php if(count($banner_options)){ ?><select name="sesdating_feature_content['+elementCounter+'][iconimage]"><?php foreach($banner_options as $key=>$banner_option){ ?><option value="<?php echo $key; ?>"><?php echo $banner_option; ?></option><?php } ?></select><?php } ?><div style="padding-top:10px;"><a href="javascript:;" class="delete_feature_content fa fa-trash">&nbsp;Delete</a></div></div></div></div>';
    elementCounter++;
    sesJqueryObject('.sesdating_feature_content_container').append(html);
