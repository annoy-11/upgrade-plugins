    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          ...
          <?php $photos = Engine_Api::_()->getDbtable('slides', 'sesdating')->getSlides($item->banner_id, 'show_all'); ?>
          ...
          <td>
          	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesdating', 'controller' => 'manage-banner', 'action' => 'manage', 'id' => $item->banner_id), $this->translate("Manage Photos"), array()) ?>
            |
            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesdating', 'controller' => 'manage-banner', 'action' => 'create-banner', 'id' => $item->banner_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?>
            |
            <?php echo $this->htmlLink(
                array('route' => 'admin_default', 'module' => 'sesdating', 'controller' => 'manage-banner', 'action' => 'delete-banner', 'id' => $item->banner_id),
