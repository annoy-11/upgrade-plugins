 ...
 */
class Sespagepoll_Widget_TabbedWidgetPollController extends Engine_Content_Widget_Abstract {
  ...
  $this->view->identityForWidget = $this->view->identityObject = empty($_POST['identityObject']) ? $this->view->identity : $_POST['identityObject'];
	...
	$this->view->page_id = $pageId = isset($_POST['page_id']) ? $_POST['page_id'] : $this->_getParam('page_id','');
   ...
   // foreach ($show_criterias as $show_criteria)
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('polls', 'sespagepoll')
