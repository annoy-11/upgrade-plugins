 ...
 */
class Sespagepoll_Widget_ListPopularPollsController extends Engine_Content_Widget_Abstract
{
...
//    echo '<pre>';print_r($params);die;
    ...
    $paginator = Engine_Api::_()->getDbTable('polls', 'sespagepoll')->getPollsPaginator($values);
