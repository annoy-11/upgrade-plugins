...
<script type="application/javascript">
 var searchPageUrl = "<?php echo $this->url(array('module' =>'sespagepoll','controller' => 'index', 'action' => 'get-page'),'default',true); ?>";
  en4.core.runonce.add(function()
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('searchpage', searchPageUrl, {
      'postVar': 'text',
      'minLength': 1,
      'selectMode': 'pick',
...
var Searchurl = "<?php echo $this->url(array('module' =>'sespagepoll','controller' => 'index', 'action' => 'get-poll'),'default',true); ?>";</script>

<?php if($controllerName == 'index' && $actionName == 'browse'){ ?>
	<?php $identity = Engine_Api::_()->sespage()->getIdentityWidget('sespagepoll.browse-polls','widget','sespagepoll_index_browse'); ?>
	  <?php if(@$identity) { ?>
      <script type="application/javascript">
      sesJqueryObject(document).ready(function(){
        ...
        sesJqueryObject('#filter_form').submit(function(e){
          e.preventDefault();
          if(sesJqueryObject('.sespagepoll_poll_listing').length > 0){
            ...
            sesJqueryObject('#loadingimgsespagepoll-wrapper').show();
