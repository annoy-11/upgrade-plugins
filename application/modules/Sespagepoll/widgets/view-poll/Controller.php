...
class Sespagepoll_Widget_ViewPollController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sespagepoll = $poll = Engine_Api::_()->core()->getSubject('sespagepoll_poll');
    $this->view->owner = $owner = $poll->getOwner();
    $this->view->viewer = $viewer = Engine_Api::_()->user()->getViewer();
    $this->view->pollOptions = $poll->getOptions();
    $this->view->hasVoted = $poll->viewerVoted();
    $this->view->showPieChart = Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.showpiechart', false);
    $this->view->canVote=$canvote = $poll->authorization()->isAllowed($viewer, 'vote');
    $this->view->canChangeVote = Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.canchangevote', false);
