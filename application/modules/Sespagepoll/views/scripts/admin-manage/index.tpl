...
<?php include APPLICATION_PATH .  '/application/modules/Sespagepoll/views/scripts/dismiss_message.tpl';?>
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          ...
          <td>
            <a href="<?php echo $this->url(array('poll_id' => $item->poll_id), 'sespagepoll_view') ?>">
              <?php echo $this->translate("view") ?>
            </a>
            |
            <?php echo $this->htmlLink(
                array('route' => 'default', 'module' => 'sespagepoll', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->poll_id),
