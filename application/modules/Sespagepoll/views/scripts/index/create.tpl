 ...
 * @version    $Id: create.tpl  2018-10-25 00:00:00 SocialEngineSolutions $
...
<?php 
  ...
  <?php  $viewUrl = Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.poll.manifest', 'pagepoll'); ?>
...
<?php }	?>
	...
	function append(){
      var optionsDiv =  '<div class= "pollOptionInput">' +
		...
		optionsDiv +='</div>' +
		'<span class="sespagepoll_upload_img"><a href="javascript:void(0)" style = "display:none;" id="remove-image'+counter+'" class="fa fa-close ' +
        'remove-image"></a><img src="#" ' +
        'class="uploadPreviewImage" style="display:none;" id="'+text+counter+'" ></span>' +
        '<span class="sespagepoll_upload_img"><a href="javascript:void(0)" style = "display:none;" id="remove-gif'+counter+'" class="fa fa-close remove-gif"></a>' +
