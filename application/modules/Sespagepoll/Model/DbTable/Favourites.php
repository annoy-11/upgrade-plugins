 ...
 * @version    $Id: Favourites.php  2018-10-25 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sespagepoll_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Sespagepoll_Model_Favourite";
  ...
  public function getItemfav($resource_type, $itemId) {
    $tableFav = Engine_Api::_()->getDbTable('favourites', 'sespagepoll');
