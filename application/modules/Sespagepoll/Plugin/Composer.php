 ...
 * @version    $Id: Composer.php  2018-10-25 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sespagepoll_Plugin_Composer extends Core_Plugin_Abstract {
  public function onAttachSespagepoll($data) {
    $subject = $_POST['subject'];
    $values['page_id'] = $pageId =  substr($subject, 13);
