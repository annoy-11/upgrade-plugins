 ...
 * @version    $Id: IndexController.php  2018-10-25 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sespagepoll_IndexController extends Core_Controller_Action_Standard{
  ...
  public function getPollAction() {
    ...
    $value['search'] = 1;
    $polls = Engine_Api::_()->getDbtable('polls', 'sespagepoll')->getPollsPaginator($value);
  ...
  public function createAction(){
    ...
    $this->view->form = $form = new Sespagepoll_Form_Create();
