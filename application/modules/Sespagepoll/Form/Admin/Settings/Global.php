 ...
 * @version    $Id: Global.php  2018-10-25 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sespagepoll_Form_Admin_Settings_Global extends Engine_Form
{
  public function init()
  {
    ...
    if(!Engine_Api::_()->sesbasic()->isSkuExists('sespagepoll')) {
      $this->addElement('Text', "sespagepoll_licensekey", array(
          'label' => 'Enter License key',
          'description' => $descriptionLicense,
          'allowEmpty' => false,
          'required' => true,
          'value' => $settings->getSetting('sespagepoll.licensekey'),
      ));
      $this->getElement('sespagepoll_licensekey')->getDecorator('Description')->setOptions(array('placement' => 'PREPEND', 'escape' => false));
    }
	
     
    if (Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.pluginactivated')) {
		
		 $this->addElement('Text', 'polls_manifest', array(
          'label' => 'Plural "pagepolls" Text in URL',
          'description' => 'Enter the text which you want to show in place of "pagepolls" in the URLs of this plugin.',
          'value' => $settings->getSetting('sespagepoll.polls.manifest', 'pagepolls'),
      ));
      $this->addElement('Text', 'poll_manifest', array(
          'label' => 'Singular "pagepoll" Text in URL',
          'description' => 'Enter the text which you want to show in place of "pagepoll" in the URLs of this plugin.',
          'value' => $settings->getSetting('sespagepoll.poll.manifest', 'pagepoll'),
      ));
        ...
        $this->addElement('Radio', 'canchangevote', array(
            ...
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.canchangevote', 1),
        ));
        $this->addElement('Select', 'allow_favourite', array(
            ...
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.allow.favourite', 1),
            'multiOptions' => array(
                '1' => 'Yes',
                '0' => 'No',
            ),
        ...
        $this->addElement('Radio', "allow_share", array(
            ...
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagepoll.allow.share', 1),
        ));
