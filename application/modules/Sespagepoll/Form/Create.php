 ...
 * @version    $Id: Create.php  2018-10-25 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sespagepoll_Form_Create extends Engine_Form
{
  public function init()
  {
    ...
    // Init profile view
    $viewOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('sespagepoll_poll', $user, 'auth_view');
    ...
    $commentOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('sespagepoll_poll', $user,
      'auth_comment');
