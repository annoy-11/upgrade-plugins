...
<div class="seslp_blocks_wrapper sesbasic_clearfix sesbasic_bxs seslp_des4wid2_wrapper">
	<div class="seslp_blocks_container">
    <?php if($this->title) { ?>
      <div class="seslp_des4wid2_head"><h2><?php echo $this->title; ?></h2></div>
  	<?php } ?>
  	<?php if($this->description) { ?>
      <div class="seslp_des4wid2_des"><p><?php echo $this->description; ?></p></div>
    <?php } ?>
		<div class="seslp_des4wid2_features_list sesbasic_clearfix">
		
      <?php if($contents['title1']) { ?>
        <div class="seslp_des4wid2_feature_item">
          <article class="seslp_animation sesbasic_clearfix">
             <div class="seslp_des4wid2_feature_item_icon">
            ...
            <div class="seslp_des4wid2_feature_item_cont clear">
