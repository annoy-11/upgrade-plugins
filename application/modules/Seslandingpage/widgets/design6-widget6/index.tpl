...
<div class="seslp_blocks_wrapper sesbasic_clearfix sesbasic_bxs seslp_des6wid6_wrapper">
	<div class="seslp_blocks_container">
    <?php if($this->title) { ?>
      <h2 class="seslp_des6_head"><?php echo $this->title; ?></h2>
    <?php } ?>
    <div class="seslp_des6wid6_listing sesbasic_clearfix">
      <?php foreach($this->paginator as $user) { ?>
        ...
        <?php endif; ?>
        <div class="seslp_des6wid6_list_item">
          <a href="<?php echo $user->getHref(); ?>" title="<?php echo $user->getTitle(); ?>">
            <span class="seslp_des6wid6_list_item_img seslp_animation" style="background-image:url(<?php echo $photo_url ?>);"></span>
            <span class="seslp_des6wid6_list_item_thumb_overlay seslp_animation"></span>
          </a>
        </div>
      <?php } ?>
    </div>
