...
class Seslandingpage_Widget_Design8Widget5Controller extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->readmorebuttontext = $this->_getParam('readmorebuttontext', null);
