...
class Seslandingpage_Widget_Design6Widget4Controller extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if(!$this->view->resourcetype)
      return $this->setNoRender();
  
    $this->getElement()->removeDecorator('Title');
    $this->view->title = $this->_getParam('title', null);
    $this->view->showstats = $this->_getParam('showstats', array());
    $this->view->descriptiontruncation = $this->_getParam('descriptiontruncation', 70);
    
    $limit = 3; //$this->_getParam('limit', 6);
