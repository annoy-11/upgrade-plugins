...
<div class="seslp_language_wrapper seslp_blocks_wrapper sesbasic_bxs seslp_section_spacing" style="background-image:url(<?php echo Engine_Api::_()->seslandingpage()->getFileUrl($this->backgroundimage); ?>);">
