...
class Seslandingpage_Widget_Design2Widget3Controller extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->backgroundimage = $this->_getParam('backgroundimage', null);
    $this->view->videourl = $this->_getParam('videourl', null);
