...
<div class="seslp_blocks_wrapper sesbasic_clearfix sesbasic_bxs seslp_des2wid6_wrapper">
	<div class="seslp_des2wid6_container">
    <div class="seslp_des2wid6_members_listings">
    ...
    <div class="seslp_des2wid6_content">
      <?php if($this->title): ?>
      <h2><?php echo $this->title; ?></h2>
      <?php endif; ?>
      <?php if($this->loginbutton || $this->signupbutton) { ?>
        <p class="seslp_des2wid6_btns">
