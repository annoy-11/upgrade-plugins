...
<div class="seslp_blocks_wrapper sesbasic_clearfix sesbasic_bxs seslp_des4wid6_wrapper">
	<div class="seslp_blocks_container">
    <?php if($this->title) {  ?>
      <h2 class="seslp_des4wid6_head"><?php echo $this->title; ?></h2>
  	<?php } ?>
    <div class="seslp_des4wid6_listings sesbasic_clearfix">
      <?php foreach($this->results as $result) { ?>
        <div class="seslp_des4wid6_listing_item">
          <article class="sesbasic_clearfix">
            <div class="seslp_des4wid6_listing_item_thumb">
              <a href="<?php echo $result->getHref(); ?>">
                <span class="seslp_animation seslp_des4wid6_listing_item_thumb_img" style="background-image:url(<?php echo $result->getPhotoUrl() ?>);"></span>
                <?php if(in_array('showoverlay', $this->showstats)) { ?>
                  <span class="seslp_animation seslp_des4wid6_listing_item_thumb_overlay"><i class="fa fa-link"></i></span>
                <?php } ?>
              </a>
            </div>
            <?php if($this->showstats) { ?>
              <div class="seslp_des4wid6_listing_item_info sesbasic_clearfix">
                <?php if(in_array('title', $this->showstats)) { ?>
                  <div class="seslp_des4wid6_listing_item_title">
                    <a href="<?php echo $result->getHref(); ?>"><?php echo $result->getTitle(); ?></a>
                  </div>
                <?php } ?>
                <div class="seslp_des4wid6_listing_item_date sesbasic_clearfix">
                  <p class="seslp_des4wid6_listing_item_stats">
                    <?php if(isset($result->owner_id) && in_array('ownername', $this->showstats)) { ?>
                      <?php $user = Engine_Api::_()->getItem('user', $result->owner_id); ?>
                      <span class="sesbasic_text_light"><i class="fa fa-user"></i><span><a href="<?php echo $user->getHref(); ?>"><?php echo $user->getTitle(); ?></a></span></span>
                ...
                <?php if(in_array('description', $this->showstats)) { ?>
                  <div class="seslp_des4wid6_listing_item_des">
                    <p>
                      <?php
