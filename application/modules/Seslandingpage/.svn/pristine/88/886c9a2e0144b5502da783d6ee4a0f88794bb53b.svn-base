...
<div class="seslp_blocks_wrapper sesbasic_clearfix sesbasic_bxs seslp_des7wid2_wrapper">
	<div class="seslp_blocks_container">
    <div class="sesbasic_clearfix seslp_des7wid2_features">
    	<?php if($contents['title1']) { ?>
        <div class="seslp_des7wid2_feature_item">
          <article>
            <div class="seslp_des7wid2_feature_item_icon">
            ...
            <div class="seslp_des7wid2_feature_item_cont">
