...
<div class="seslp_blocks_wrapper sesbasic_clearfix sesbasic_bxs seslp_des7wid4_wrapper">
	<div class="seslp_blocks_container">
  	<div class="seslp_des7wid4_left">
      <?php if($this->title) { ?>
        ...
        <a class="seslp_animation _seeall" href="<?php echo $this->seeallbuttonurl; ?>"><?php echo $this->seeallbuttontext; ?></a>	
      <?php } ?>
    </div>
    <div class="seslp_des7wid4_right">
    	<div class="seslp_des7wid4_listing sesbasic_clearfix">
        <?php foreach($this->results as $result) { ?>
          <div class="seslp_des7wid4_list_item">
            <article>
              <div class="seslp_des7wid4_list_item_thumb">
                <a href="<?php echo $result->getHref(); ?>"><span class="seslp_animation" style="background-image:url(<?php echo $result->getPhotoUrl() ?>);"></span></a>
              </div>
              <div class="seslp_des7wid4_list_item_cont">
                <?php if(in_array('title', $this->showstats)) { ?>
                  <h3><a href="<?php echo $result->getHref(); ?>"><?php echo $result->getTitle(); ?></a></h3>
                <?php } ?>
                <p class="seslp_des7wid4_list_item_stat">
