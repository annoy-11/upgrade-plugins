...
?>
<form method="get" action="<?php echo $this->escape($this->url(array('id'=>$this->user->getIdentity()), 'user_profile', true)) ?>" class="global_form" enctype="application/x-www-form-urlencoded">
  <div>
    <div>
