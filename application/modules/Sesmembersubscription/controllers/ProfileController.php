...
class Sesmembersubscription_ProfileController extends Core_Controller_Action_Standard {
  ...
  public function indexAction() {
    ...
    $this->view->package = Engine_Api::_()->getItem('sespaymentapi_package', $getPackageId);
    
    $this->view->adminMessage = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesmembersubscription.message', "This member is enabled subscription for their profile. So, if you want to view his profile, you can subscribe this member.");
