<?php
class Sesultimateslide_Form_Admin_Slideshow_Addslideshow extends Engine_Form
{
  public function init()
  {
    ...
    $this
     ...
     // 'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sesultimateslide_license'),
    ));
