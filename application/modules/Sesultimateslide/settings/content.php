 ...
 */
$data = array('' => '');
$galleryTable = Engine_Api::_()->getDbtable('galleries', 'sesultimateslide');
...
return array(
    array(
        'title' => 'SES - Ultimate Banner Slideshow',
        ...
        'category' => 'SES - Ultimate Banner Slideshow',
        'type' => 'widget',
		'autoEdit' => true,
        'name' => 'sesultimateslide.slideshow',
        'adminForm' => array(
            'elements' => array(
                array('text', 'title',
                    array(
