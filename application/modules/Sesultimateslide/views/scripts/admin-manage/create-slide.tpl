...
<div class="sesbasic_search_reasult">
    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesultimateslide', 'controller' => 'manage', 'action' => 'manage','id'=>$this->gallery_id), $this->translate("Back to Manage Slides") , array('class'=>'sesbasic_icon_back buttonlink')); ?>
</div>
<div class='clear'>
