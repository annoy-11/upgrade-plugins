...
You can add and manage any number of Photo Slides in each Banner Slideshow. Each slide is highly configurable and you
    can add title and description to each banner. Use “Create New Slideshow” link below to create new banner.<br>You can configure banner in the “SES - Ultimate Banner Slideshow” widget from the Layout Editor.") ?>
</p>
<br class="clear" />
<div class="sesbasic_search_reasult">
    
    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesultimateslide', 'controller' => 'manage', 'action' => 'create-gallery'), $this->translate("Create New Slideshow"), array('class'=>'smoothbox sesbasic_icon_add buttonlink')) ?>
</div>
        ...
        <tbody>
            ...
            <tr>
			   ...
			   <td style="width:10%;" class="admin_table_centered">
                ...
                <td>
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesultimateslide', 'controller' => 'manage', 'action' => 'create-gallery','id' => $item->gallery_id), $this->translate("Edit"),array('class' => 'smoothbox')) ?>
                    |
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesultimateslide', 'controller' => 'manage', 'action' => 'manage','id' => $item->gallery_id), $this->translate("Manage Slides")) ?>
                    |
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesultimateslide', 'controller' => 'manage', 'action' => 'delete-gallery','id' => $item->gallery_id), $this->translate("Delete"),array('class' => 'smoothbox')) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
