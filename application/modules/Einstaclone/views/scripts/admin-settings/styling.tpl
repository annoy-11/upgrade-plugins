 ...
 * @version    $Id: styling.tpl 2019-12-30 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
 
?>
<?php 
$this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Einstaclone/externals/scripts/jscolor/jscolor.js');
...
<div class='clear'>
  <div class='settings einstaclone_color_schemes_form'>
    <?php echo $this->form->render($this); ?>
  </div>
</div>
<?php $theme_color = Engine_Api::_()->einstaclone()->getContantValueXML('theme_color'); ?>
<script type="text/javascript">
  ...
  function getThemeColor(value) {
    var URL = en4.core.staticBaseUrl+'einstaclone/admin-settings/getcustomthemecolors/';
    (new Request.HTML({
      method: 'post',
      'url': URL ,
      'data': {
    ...
    getThemeColor(value);
      ...
      if(value > 3) {
        ...
        <?php if(empty($this->customtheme_id)): ?>
          history.pushState(null, null, 'admin/einstaclone/settings/styling/customtheme_id/'+value);
          scriptJquery('#edit_custom_themes').attr('href', 'einstaclone/admin-settings/add-custom-theme/customtheme_id/'+value);
          scriptJquery('#delete_custom_themes').attr('href', 'einstaclone/admin-settings/delete-custom-theme/customtheme_id/'+value);
        <?php else: ?>
          scriptJquery('#edit_custom_themes').attr('href', 'einstaclone/admin-settings/add-custom-theme/customtheme_id/'+value);
