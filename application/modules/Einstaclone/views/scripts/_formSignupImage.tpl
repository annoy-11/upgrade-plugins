 ...
 * @version    $Id: _formSignupImage.tpl 2019-12-30 00:00:00 socialnetworking.solutions $
...
<?php
  $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'externals/moolasso/Lasso.js')
