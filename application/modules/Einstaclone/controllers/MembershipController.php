 ...
 * @version    $Id: MembershipController.php 2019-12-30 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Einstaclone_MembershipController extends Core_Controller_Action_Standard {
  ...
  public function addFriendAction() {
    ...
    try {
      ...
      if($parambutton == 'button') {
        $showData =  $this->view->partial('_addfriend_button.tpl','einstaclone',array('subject' => $user,'viewer'=>$viewer,'is_ajax'=>true));
      } else {
        $showData =  $this->view->partial('_addfriend.tpl','einstaclone',array('subject' => $user,'viewer'=>$viewer,'is_ajax'=>true));
      }
