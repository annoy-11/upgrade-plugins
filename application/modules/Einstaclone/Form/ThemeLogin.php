 ...
 * @version    $Id: ThemeLogin.php 2019-12-30 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Einstaclone_Form_ThemeLogin extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    $this->setAttrib('class', 'global_form einstaclonelogin_form');
    ...
    //if(Engine_Api::_()->getDbTable('modules', 'core')->isModuleEnabled('sestoz')) {
        ...
        $this->addElement('dummy', 'showhidepassword', array(
            'decorators' => array(array('ViewScript', array(
                'viewScript' => 'application/modules/Einstaclone/views/scripts/showhidepassword.tpl',
            ))),
            'tabindex' => $tabindex++,
        ));
    //}
