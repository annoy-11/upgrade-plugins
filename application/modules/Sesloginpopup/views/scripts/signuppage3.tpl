...
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesloginpopup/externals/styles/magnific-page3.css'); ?>
   ...
   <div class="sesloginpopup_loginpage">
      <div class="sesloginpopup_loginbox">
          <div class="loginbox_head" style="background:url(<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesloginpoup.page.photo', ''); ?>);"><h2><?php echo $this->translate("SIGN UP");?></h2></div>
          <div class="loginbox_form signup_page_three">
