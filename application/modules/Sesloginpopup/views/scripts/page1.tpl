 ...
 * @version    $Id: page1.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesloginpopup/externals/styles/magnific-page1.css'); ?>

<div class="sesloginpopup_loginpage">
   <div class="sesloginpopup_loginbox">
      <div class="loginbox_img" style="background-image:url(<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesloginpoup.page.photo', ''); ?>);">
         <div class="loginbox_img_content">
            <h4><?php echo $this->translate("Login");?></h4>
            <p><?php echo $this->translate("Get Access to your Account now by logging in with your details.");?></p>
         </div>
      </div>
      <div class="loginbox_form">
          ...
          <div class="sesloginpage_top">
           <img src="application/modules/Sesloginpopup/externals/images/enter.png">
