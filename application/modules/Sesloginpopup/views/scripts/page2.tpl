 ...
 * @version    $Id: page2.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesloginpopup/externals/styles/magnific-page2.css'); ?>

<div class="sesloginpopup_loginbg">
</div>
   <div class="sesloginpopup_loginpage">
      <div class="sesloginpopup_loginbox">
          <div class="loginbox_form" style="background-image:url(<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesloginpoup.page.photo', ''); ?>);">
            ...
            <div class="sesloginpopup_popup_content_left sesloginpopup_popup_signup">
              ...
              <h2><?php echo $this->translate("Log In to your Account");?></h2>
              </div>
...
sesJqueryObject(document).ready(function(){
  ...
  htmlElement.addClass('sesloginpopup_page_two');
