 ...
 * @version    $Id: Login.php  2019-02-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesloginpopup_Form_Login extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    $this->setAttrib('id', 'sesariana_form_login');
    ...
    $this->addElement('dummy', 'showhidepassword', array(
      'decorators' => array(array('ViewScript', array(
        'viewScript' => 'application/modules/Sesloginpopup/views/scripts/showhidepassword.tpl',
      ))),
			'tabindex' => $tabindex++,
    ));
		//SES Work For Show and Hide Password
