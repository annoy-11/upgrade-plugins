 ...
 * @version    $Id: popup9.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup9.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    <?php if(!empty($showSeparator)) { ?>
  	<div id="small-dialog" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesloginpopup_quick_login_popup sesbasic_bxs sesbasic_clearfix">
    <?php } else { ?>
      <div id="small-dialog" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesloginpopup_quick_login_popup sesbasic_bxs sesbasic_clearfix _nosbtns">
    <?php } ?>
    ...
    <div class="sesloginpopup_popup_content clearfix" style="background-image:url(<?php echo $this->loginsignupbgimage; ?>);">
     <div class="popup_header_heading">
      ...
      <?php if(!empty($showSeparator)):?>
        <div class="sesloginpopup_popup_content_sep">
          <span><?php echo $this->translate("Or Login Using");?></span>
        </div>
    ...
    <div class="sesloginpopup_popup_header_btns">
        ...
        <?php if($controllerName != 'signup'){ ?>
        	<p><?php echo $this->translate("Don't have an account? ");?><a class="popup-with-move-anim tab-link" href="#user_signup_form"><?php echo $this->translate("Sign Up");?></a></p>
        <?php } ?>
      </div>
  </div>
  ...
  <?php if($controllerName != 'signup') { ?>
  	<?php if(!empty($showSeparator)){?>
    	<div id="user_signup_form" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesbasic_bxs sesloginpopup_quick_signup_popup sesbasic_clearfix">
    <?php } else { ?>
      <div id="user_signup_form" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesbasic_bxs sesloginpopup_quick_signup_popup _nosbtns sesbasic_clearfix">
    <?php }; ?>
      <div class="sesloginpopup_popup_header clearfix">
        <?php if($this->loginsignup_logo): ?>
          <div class="sesloginpopup_popup_header_logo">
          ...
          <div class="sesloginpopup_popup_content_right">
            ...
            <div class="sesloginpopup_quick_popup_social">
              <?php  if ('none' != $settings->getSetting('core_facebook_enable', 'none') && $settings->core_facebook_secret):?>
                ...
                <?php  endif;?>
                <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
                <a href="<?php echo $href;?>" id="fbLogin"><i class="fa fa-facebook"></i><?php echo $this->translate(" Facebook");?></a>
              <?php endif;?>
              <?php if ('none' != $settings->getSetting('core_twitter_enable', 'none')
               && $settings->core_twitter_secret):?>
                ...
                ->assemble(array('module' => 'user', 'controller' => 'auth',
                'action' => 'twitter'), 'default', true);?>
                <a href="<?php echo $href;?>" id="googleLogin"><i class="fa fa-twitter"></i><?php echo $this->translate(" Twitter");?></a>
              <?php endif;?>
            </div>
          </div>  
        <?php endif;?>
      ...
      <div class="sesloginpopup_popup_header_btns">
          <?php if($controllerName != 'auth' && $actionName != 'login') { ?>
            <p><?php echo $this->translate("You have already account ");?><a class="popup-with-move-anim tab-link" href="#small-dialog"><?php echo $this->translate("Sign In");?></a></p>
          <?php } ?>
          <?php if($controllerName != 'signup') { ?>
