 ...
 * @version    $Id: popup1.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup1.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    <?php if(!empty($showSeparator)) { ?>
  	<div id="small-dialog" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesbasic_bg sesloginpopup_quick_login_popup sesbasic_bxs">
    <?php } else { ?>
    ...
    <div class="sesloginpopup_popup_content clearfix">
    	<p class="popup-dis"><?php echo $this->translate("Enter your email and password ");?><b><?php echo $this->translate("to sign in");?></b></p>
          ...
          <?php if(!Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
            <div class="sesloginpopup_quick_popup_social">
              ...
              <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
                <a href="<?php echo $href;?>" id="fbLogin"><i class="fa fa-facebook"></i> <span><?php echo $this->translate("Sign in with ");?><b><?php echo $this->translate("Facebook");?></b></span></a>
              <?php endif;?>
              <?php if ('none' != $settings->getSetting('core_twitter_enable', 'none') && $settings->core_twitter_secret):?>
                ...
                <a href="<?php echo $href;?>" id="googleLogin"><i class="fa fa-twitter"></i><span><?php echo $this->translate("Sign in with ");?><b><?php echo $this->translate("Twitter");?></b></span></a>
              <?php endif;?>
            </div>
          <?php endif; ?>
        </div>
  ...
  <?php if($controllerName != 'signup') { ?>
  	<?php if(!empty($showSeparator)){?>
    	<div id="user_signup_form" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesbasic_bg sesbasic_bxs sesloginpopup_quick_signup_popup">
    <?php } else { ?>
