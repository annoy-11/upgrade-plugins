 ...
 * @version    $Id: popup7.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup7.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    ...
    <?php } else { ?>
      <div id="small-dialog" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesloginpopup_quick_login_popup sesbasic_bxs sesbasic_clearfix _nosbtns"  style="background-image:url(<?php echo $this->loginsignupbgimage; ?>);">
    <?php } ?>
    <div class="sesloginpopup_popup_header clearfix">
      ...
      <div class="popup_header_heading">
      	<h4><?php echo $this->translate("Log In");?></h4>
      </div>  
    </div>
