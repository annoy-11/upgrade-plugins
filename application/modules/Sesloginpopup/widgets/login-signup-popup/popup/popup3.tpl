 ...
 * @version    $Id: popup3.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup3.css" rel="stylesheet" />
<?php endif;?>
    ...
    <div class="sesloginpopup_popup_header clearfix">
      ...
      <div class="sesloginpopup_popup_header_btns">
        ...
        <?php if($controllerName != 'signup'){ ?>
        	<p><?php echo $this->translate("NOT REGISTERD? ");?><a class="popup-with-move-anim tab-link" href="#user_signup_form"><?php echo $this->translate("Sign Up");?></a></p>
        <?php } ?>
      </div>  
    </div>
    ...
    <?php }; ?>
      <div class="sesloginpopup_popup_header clearfix">
        ...
        <div class="sesloginpopup_popup_header_btns">
          ...
          <?php } ?>
          <?php if($controllerName != 'auth' && $actionName != 'login') { ?>
            <p><?php echo $this->translate("ALREADY ACCOUNT ");?><a class="popup-with-move-anim tab-link" href="#small-dialog"><?php echo $this->translate("Sign In");?></a></p>
          <?php } ?>
        </div>  
      </div>
