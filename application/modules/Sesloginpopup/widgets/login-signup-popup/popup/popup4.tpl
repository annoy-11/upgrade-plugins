 ...
 * @version    $Id: popup4.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup4.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    ...
    <div class="sesloginpopup_popup_header clearfix">
      ...
      <div class="popup_left_img" style="background-image:url(<?php echo $this->loginsignupbgimage ?>);"></div>
