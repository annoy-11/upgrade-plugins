 ...
 * @version    $Id: popup10.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup10.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    ...
    <div class="sesloginpopup_popup_header clearfix" style="background-image:url(<?php echo $this->loginsignupbgimage; ?>);">
      ...
      <div class="popup_header_heading">
      	<img src="application/modules/Sesloginpopup/externals/images/user.png" />
      	<h4><?php echo $this->translate("Welcome");?></h4>
        <p><?php echo $this->translate("Sign in to your account!");?></p>
      </div>  
    </div>
    ...
    <div class="sesloginpopup_popup_header_btns">
        ...
        <?php if($controllerName != 'signup'){ ?>
        	<p>Don't have an account <a class="popup-with-move-anim tab-link" href="#user_signup_form"><?php echo $this->translate("Sign Up");?></a></p>
        <?php } ?>
      </div>
  </div>
    ...
    <?php }; ?>
      <div class="sesloginpopup_popup_header clearfix">
        ...
        <div class="popup_header_heading">
      	<img src="application/modules/Sesloginpopup/externals/images/user.png" />
      	<h4><?php echo $this->translate("Welcome");?></h4>
        <p><?php echo $this->translate("Create an account");?></p>
      </div>
          ...
          <div class="sesloginpopup_popup_content_right">
            ...
            <div class="sesloginpopup_quick_popup_social">
              <?php  if ('none' != $settings->getSetting('core_facebook_enable', 'none') && $settings->core_facebook_secret):?>
                ...
                <?php  endif;?>
                <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
                <a href="<?php echo $href;?>" id="fbLogin"><i class="fa fa-facebook"></i> <span><?php echo $this->translate("Facebook");?></a>
              <?php endif;?>
      ...
      <div class="sesloginpopup_popup_header_btns">
          <?php if($controllerName != 'auth' && $actionName != 'login') { ?>
            <p>you have already created an account <a class="popup-with-move-anim tab-link" href="#small-dialog"><?php echo $this->translate("Sign In");?></a></p>
          <?php } ?>
          <?php if($controllerName != 'signup') { ?>
