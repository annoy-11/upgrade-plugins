 ...
 * @version    $Id: popup2.tpl  2019-02-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<?php $enablePopUp = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesloginpopup_popupsign', 1);  ?>
...
<?php if($this->viewer->getIdentity() == 0) : ?>
  ...
  <link href="<?php echo $baseUrl; ?>application/modules/Sesloginpopup/externals/styles/magnific-popup2.css" rel="stylesheet" />
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
    <?php if(!empty($showSeparator)) { ?>
  	<div id="small-dialog" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesbasic_bg sesloginpopup_quick_login_popup sesbasic_bxs sesbasic_clearfix">
    <?php } else { ?>
      <div id="small-dialog" class="zoom-anim-dialog mfp-hide sesloginpopup_quick_popup sesbasic_bg sesloginpopup_quick_login_popup sesbasic_bxs sesbasic_clearfix _nosbtns">
    <?php } ?>
    <div class="sesloginpopup_popup_header clearfix"  style="background-image:url(<?php echo $this->loginsignupbgimage; ?>);">
      ...
      <?php endif; ?>
      <div class="popup_header_heading">
      	<h4><?php echo $this->translate("New here?");?></h4>
        <p><?php echo $this->translate("Sign Up and Discover great amount of new opportunities!");?></p>
      </div>
    ...
    <div class="google_ads_section">
    	<p><?php echo $this->translate("Google ads");?></p>
    </div>
    <div class="sesloginpopup_popup_content clearfix">
    	<p class="popup-dis"><?php echo $this->translate("Welcome");?></p>
          ...
          <?php if(!Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
            <div class="sesloginpopup_quick_popup_social">
              ...
              <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
                <a href="<?php echo $href;?>" id="fbLogin"><i class="fa fa-facebook"></i> <span><?php echo $this->translate("Sign in with Facebook");?></span></a>
              <?php endif;?>
              <?php if ('none' != $settings->getSetting('core_twitter_enable', 'none') && $settings->core_twitter_secret):?>
                ...
                <a href="<?php echo $href;?>" id="googleLogin"><i class="fa fa-twitter"></i><span><?php echo $this->translate("Sign in with Twitter");?></span></a>
              <?php endif;?>
            </div>
          <?php endif; ?>
        </div>
  ...
  <?php if($controllerName != 'signup') { ?>
    ...
    <?php }; ?>
      <div class="sesloginpopup_popup_header clearfix" style="background-image:url(<?php echo $this->loginsignupbgimage; ?>);">
        ...
        <?php endif; ?>
        <div class="popup_header_heading">
      	<h4><?php echo $this->translate("New User?");?></h4>
        <p><?php echo $this->translate("Sign In and Discover great amount of new opportunities!");?></p>
      </div>
        <div class="sesloginpopup_popup_header_btns">
          <?php if($controllerName != 'auth' && $actionName != 'login') { ?>
      ...
      <div class="google_ads_section">
    	...
    	<div class="sesloginpopup_popup_content clearfix">
      	<p class="popup-dis"><?php echo $this->translate("Enter your details ");?><b><?php echo $this->translate("to sign up");?></b></p>
          ...
          <div class="sesloginpopup_popup_content_right">
            ...
            <div class="sesloginpopup_quick_popup_social">
              <?php  if ('none' != $settings->getSetting('core_facebook_enable', 'none') && $settings->core_facebook_secret):?>
                ...
                <?php  endif;?>
                <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
                <a href="<?php echo $href;?>" id="fbLogin"><i class="fa fa-facebook"></i> <span><?php echo $this->translate("Sign up with ");?>S<b><?php echo $this->translate("Facebook");?></b></a>
              <?php endif;?>
