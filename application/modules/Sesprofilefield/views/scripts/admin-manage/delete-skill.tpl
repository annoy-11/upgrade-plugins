...
<form method="post" class="global_form_popup">
  <div>
    <h3><?php echo $this->translate("Delete Skill?") ?></h3>
    <p><?php echo $this->translate("Are you sure that you want to delete this skill. It will not be recoverable after being deleted.") ?></p>
    <br />
    <p>
