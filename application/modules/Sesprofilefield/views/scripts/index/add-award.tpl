 ...
 * @version    $Id: add-award.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
...
//         }
  ...
  function submitCompliment(formObject) {
    ...
    sesJqueryObject.ajax({
      url: "sesprofilefield/index/add-award/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
...
<div class="sesprofilefield_add_details_form add_award_form">
