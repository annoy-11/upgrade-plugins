 ...
 * @version    $Id: add-project.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
 ...
 ?>
  <script>
    ...
    function addProject(formObject) {
      ...
      var validationFm = validateForm('sesprofilefield_addproject');
      if(validationFm) {
    ...
    function submitCompliment(formObject) {
      ...
      sesJqueryObject.ajax({
        url: "sesprofilefield/index/add-project/",
        type: "POST",
        contentType:false,
        processData: false,
        cache: false,
  ...
  <div class="sesprofilefield_add_details_form add_project_form">
