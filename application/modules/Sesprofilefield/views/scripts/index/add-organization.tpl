 ...
 * @version    $Id: add-organization.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
 ...
 ?>
  <script>
    ...
    function addOrganization(formObject) {
      ...
      var validationFm = validateForm('sesprofilefield_addorganization');
      if(validationFm) {
    ...
    function submitCompliment(formObject) {
      ...
      sesJqueryObject.ajax({
        url: "sesprofilefield/index/add-organization/",
        type: "POST",
        contentType:false,
        processData: false,
        cache: false,
  ...
  <div class="sesprofilefield_add_details_form add_organization_form">
