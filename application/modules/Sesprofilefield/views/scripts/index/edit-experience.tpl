 ...
 * @version    $Id: edit-experience.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
...
<script>
  ...
  en4.core.runonce.add(function() {
    <?php if($this->experience->currentlywork) { ?>
  ...
  function submitCompliment(formObject) {
    ...
    sesJqueryObject.ajax({
      url: "sesprofilefield/index/edit-experience/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
...
<div class="sesprofilefield_add_details_form edit_experience_form">
