 ...
 * @version    $Id: edit-certification.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
...
<script>
  ...
  en4.core.runonce.add(function() {
    <?php if($this->certification->notexpire) { ?>
...
//     
    ...
    sesJqueryObject.ajax({
      url: "sesprofilefield/index/edit-certification/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
...
<div class="sesprofilefield_add_details_form edit_certification_form">
