 ...
 * @version    $Id: add-course.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
...
//         }
  ...
  function submitCompliment(formObject) {
    ...
    sesJqueryObject.ajax({
      url: "sesprofilefield/index/add-course/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
...
<div class="sesprofilefield_add_details_form add_course_form">
