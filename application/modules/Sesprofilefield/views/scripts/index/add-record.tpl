 ...
 * @version    $Id: add-record.tpl  2019-02-06 00:00:00 SocialEngineSolutions $
...
<script>
  ...
  function submitCompliment(formObject) {
    ...
    sesJqueryObject.ajax({
      url: "sesprofilefield/index/add-record/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
...
<div class="sesprofilefield_add_details_form sesprofilefield_add_record_form">
