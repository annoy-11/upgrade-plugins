 ...
 * @version    $Id: blocked.tpl 2016-04-30 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    ...
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter.Request.JSON('to', '<?php echo $this->url(array('module' => 'sesprofilelock', 'controller' => 'index', 'action' => 'getmember'), 'default', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
