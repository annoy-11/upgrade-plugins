...
class Sesfaq_Widget_BrowseFaqsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $limit = isset($params['itemCount']) ? $params['itemCount'] : $this->_getParam('limitdatafaq', 10);
    ...
    $this->view->gridblockheight = $gridblockheight = isset($params['gridblockheight']) ? $params['gridblockheight'] : $this->_getParam('gridblockheight', 250);
		...
		$this->view->faqtitlelimit = $faqtitlelimit = isset($params['faqtitlelimit']) ? $params['faqtitlelimit'] : $this->_getParam('faqtitlelimit', 60);

		$this->view->faqdescriptionlimit = $faqdescriptionlimit = isset($params['faqdescriptionlimit']) ? $params['faqtitlelimit'] : $this->_getParam('faqdescriptionlimit', 200);
		...
		$this->view->all_params = $values = array('gridblockheight' => $gridblockheight, 'viewtype' => $viewtype, 'showinformation' => $showinformation, 'itemCount' => $limit, 'faqtitlelimit' => $faqtitlelimit, 'faqdescriptionlimit' => $faqdescriptionlimit, 'showinformation' => $showinformation, 'showicons' => $showicons, 'itemCount' => $limit);
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('faqs', 'sesfaq')->getFaqPaginator($values);
