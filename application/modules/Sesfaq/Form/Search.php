...
class Sesfaq_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    if ($moduleName == 'sesfaq' && $controllerName == 'index' && $actionName == 'browse') {
      $this->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array()));
    } else {
      $this->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array('action' => 'browse'), 'sesfaq_general', true));
    }
    ...
    //Category Work
    $categories = Engine_Api::_()->getDbtable('categories', 'sesfaq')->getCategory(array('column_name' => '*'));
