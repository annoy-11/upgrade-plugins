...
class Sesfaq_AdminManageImportsController extends Core_Controller_Action_Admin {

  public function indexAction() {

    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesfaq_admin_main', array(), 'sesfaq_admin_main_manageimport');
  }
  ...
  public function importAction() {
    ...
    $this->view->form = $form = new Sesfaq_Form_Admin_Import();
    ...
    if ($this->getRequest()->isPost()) {
      ...
      foreach($importedData as $faqs) {

        if(isset($faqs['title']) && !empty($faqs['title'])) {
          ...
          $values['title'] = $faqs['title'];
          $values['description'] = $faqs['description'];
          $values['category_id'] = $faqs['category_id'];
          $values['subcat_id'] = $faqs['subcat_id'];
          $values['subsubcat_id'] = $faqs['subsubcat_id'];
  ...
  public function downloadAction() {
    ...
    $filepath = APPLICATION_PATH . DIRECTORY_SEPARATOR . 'application' . DIRECTORY_SEPARATOR . 'modules' . DIRECTORY_SEPARATOR . 'Sesfaq' . DIRECTORY_SEPARATOR . "settings" .DIRECTORY_SEPARATOR.'default_template.csv';
