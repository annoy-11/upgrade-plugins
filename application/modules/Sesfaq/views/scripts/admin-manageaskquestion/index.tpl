...
<h3><?php echo $this->translate("Manage Ask Questions") ?></h3>
<p><?php echo $this->translate('This page lists all the Questions asked by the users of your website. Below, you can answer any question or make them FAQs by clicking in the appropriate links in Options section.'); ?></p>
<br />
      ...
      <table class='admin_table'>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <?php if($item->faq_id) { ?>
                <?php $faq = Engine_Api::_()->getItem('sesfaq_faq', $item->faq_id); ?>
                <a href="<?php echo $faq->getHref(); ?>">View FAQ</a>
              <?php } else { ?>
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesfaq', 'controller' => 'admin-manage', 'action' => 'create', 'askquestion_id' => $item->askquestion_id), $this->translate("Make FAQ"), array('class' => '')) ?>
              <?php } ?>
              |
              <?php if($item->reply) { ?>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesfaq', 'controller' => 'admin-manageaskquestion', 'action' => 'answerquestion', 'askquestion_id' => $item->askquestion_id), $this->translate("Answered"), array('class' => 'smoothbox')) ?>
              <?php } else { ?>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesfaq', 'controller' => 'admin-manageaskquestion', 'action' => 'answerquestion', 'askquestion_id' => $item->askquestion_id), $this->translate("Answer"), array('class' => 'smoothbox')) ?>
              <?php } ?>
              |
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesfaq', 'controller' => 'admin-manageaskquestion', 'action' => 'delete', 'id' => $item->askquestion_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
...
<?php else:?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no asked questions yet.") ?>
    </span>
  </div>
<?php endif; ?>
<script type="text/javascript">
