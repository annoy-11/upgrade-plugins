      ...
      var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
        ...
        onFileRemove: function(file) {
          ...
          request = new Request.JSON({
            'format' : 'json',
            'url' : '<?php echo $this->url(array('action' => 'remove-song'), 'seseventmusic_general') ?>',
            'data': {
              'format': 'json',
...
<?php endif; ?> 
  ...
  <div>
    <a class="buttonlink icon_seseventmusic_new" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Select Songs') ?></a>
