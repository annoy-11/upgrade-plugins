...
<?php
  $this->headScript()
    ...
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Seseventmusic/externals/scripts/composer_music.js')
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    ...
    composeInstance.addPlugin(new Composer.Plugin.Music({
      ...
      requestOptions : {
        'url'  : en4.core.baseUrl + 'seseventmusic/album/add-song/format/json?ul=1'+'&type='+type
      },
      fancyUploadOptions : {
        'url'  : en4.core.baseUrl + 'seseventmusic/album/add-song/format/json?ul=1'+'&type='+type,
