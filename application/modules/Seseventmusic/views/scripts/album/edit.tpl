...
<div class='seseventmusic_upload_form'>
 ...
 var maxOptions = 100;
  window.addEvent('domready', function() {
    ...
    var addAnotherOption = window.addAnotherOption = function (dontFocus, label) {
      ...
      var optionElement = new Element('input', {
        'type': 'text',
        'name': 'optionsArray[]',
        'class': 'seseventmusic_soundcloud',
        'value': label,
        'id': soundId,
      ...
      var loadingimg = new Element('div', {
        ...
        'class' : 'seseventmusic_upload_loading',
        'styles': {'display': 'none'},
      }).inject(optionElement, 'after');
  ...
  function songupload(soundId) {
   ...
   document.getElementById('loading_image_'+idsongURL[1]).style.display ='';	
    (new Request.JSON({
      url: en4.core.baseUrl + 'seseventmusic/index/soundcloudint',
      data: {
        format: 'json',
        'song_url': song_url,
      },
  ...
  function soundDelete(file_id, id) {
    ...
    en4.core.request.send(new Request.JSON({
      url: en4.core.baseUrl + 'seseventmusic/index/soundcloud-song-delete',
      data: {
        format: 'json',
        'file_id': file_id,
      },
...
<script type="text/javascript">  
  ...
  en4.core.runonce.add(function(){
    ...
    new Sortables('demo-list', {
      ...
      onComplete: function(){
        new Request.JSON({
          url: '<?php echo $this->url(array('controller'=>'album','action'=>'sort'), 'seseventmusic_extended') ?>',
          noCache: true,
          data: {
            'format': 'json',
    ...
    $$('a.song_action_rename').addEvent('click', function(){
      ...
      if (newTitle && newTitle.length > 0) {
        ...
        new Request({
          url: '<?php echo $this->url(array('controller'=>'song','action'=>'rename'), 'seseventmusic_extended') ?>',
          data: {
            'format': 'json',
    ...
    $$('a.song_action_remove').addEvent('click', function(){
      ...
      new Request.JSON({
        url: '<?php echo $this->url(array('controller'=>'song','action'=>'delete'), 'seseventmusic_extended') ?>',
        data: {
          'format': 'json',
          'albumsong_id': song_id,
          'album_id': <?php echo $this->album->album_id ?>
