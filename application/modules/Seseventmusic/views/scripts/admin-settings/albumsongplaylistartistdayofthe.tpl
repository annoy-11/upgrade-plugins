...
<script type="text/javascript">
  ...
  function oftheday(value) {
    setCookie("seseventmusic_oftheday", value, 1);
  }
  ...
  en4.core.runonce.add(function() {
    setCookie("seseventmusic_oftheday", "", - 3600);    
    var album_id = getParams('page');
    $('album_id-wrapper').style.display = 'none';
    var contentAutocomplete = new Autocompleter.Request.JSON('album_title', "<?php echo $this->url(array('module' => 'seseventmusic', 'controller' => 'settings', 'action' => 'get-albums'), 'admin_default', true) ?>/album_id/" + album_id, {
      'delay' : 250,
      'postVar': 'text',
      'minLength': 1,
      'selectMode': 'pick',
