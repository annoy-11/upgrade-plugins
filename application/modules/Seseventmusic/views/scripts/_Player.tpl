...
<div id="seseventmusic_player_<?php echo $random ?>" class="seseventmusic_tracks_container sesbasic_custom_scroll">
  <ul class="clear seseventmusic_tracks_list playlist_<?php echo $playlist->getIdentity() ?>">
