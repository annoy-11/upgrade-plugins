...
<?php if($this->content_type == 'seseventmusic_album'): ?>
...
<ul class="seseventmusic_side_block seseventmusic_browse_listing">
  ...
  <li class="seseventmusic_sidebar_list">
    <?php echo $this->htmlLink($item->getHref(), $this->itemPhoto($item, 'thumb.icon'), array('class' => 'seseventmusic_sidebar_list_thumb')) ?>
    <div class="seseventmusic_sidebar_list_info">
      <div class="seseventmusic_sidebar_list_title">
        <?php echo $this->htmlLink($item->getHref(), $item->getTitle()) ?>
      </div>
      <?php if(!empty($this->information) && in_array('postedby', $this->information)): ?>
        <div class="seseventmusic_sidebar_list_stats sesbasic_text_light">
      ...
      <?php endif; ?>
      <div class="seseventmusic_sidebar_list_stats seseventmusic_list_stats sesbasic_text_light">
  ...
  <li class="seseventmusic_item_grid" style="width:<?php echo $this->width ?>px;">
...
<?php endif; ?>
<?php elseif($this->content_type == 'seseventmusic_albumsong'): ?>
<?php if(count($this->results) > 0) :?>
<ul class="seseventmusic_side_block seseventmusic_browse_listing">
  <?php foreach( $this->results as $album ): ?>
  <?php $item = Engine_Api::_()->getItem($album['resource_type'], $album['resource_id']); ?>
  <?php if($item && $this->viewType == 'listView'): ?>
  <li class="seseventmusic_sidebar_list">
    <div class="seseventmusic_sidebar_list_thumb">
    ...
    <div class="seseventmusic_sidebar_list_info">
      <div class="seseventmusic_sidebar_list_title seseventmusic_sidebar_list_song_title">
        ...
        <?php if($item->track_id): ?>
           ...
           <a class="seseventmusic_sidebar_list_playbutton seseventmusic_songslist_playbutton" href="javascript:void(0);" onclick="play_music('<?php echo $item->albumsong_id ?>', '<?php echo $URL; ?>', '<?php echo $songTitle; ?>');"><i class="fa fa-play"></i></a>
           <?php else: ?>
           <a class="seseventmusic_sidebar_list_playbutton seseventmusic_songslist_playbutton" href="javascript:void(0);"><i class="fa fa-play"></i></a>
           <?php endif; ?>
         <?php else: ?>
           <a class="seseventmusic_sidebar_list_playbutton seseventmusic_songslist_playbutton"  href="javascript:void(0);" onclick="play_music('<?php echo $item->albumsong_id ?>', '<?php echo $item->getFilePath(); ?>', '<?php echo $songTitle; ?>');"><i class="fa fa-play"></i></a>
         <?php endif; ?>
        <?php echo $this->htmlLink($item->getHref(), $item->getTitle()) ?>
      </div>
      ...
      <?php if($this->showAlbumSongRating && !empty($this->information) && in_array('ratingCount', $this->information)): ?>
        <div class="seseventmusic_sidebar_list_stats sesbasic_text_light" title="<?php echo $this->translate(array('%s rating', '%s ratings', $item->rating), $this->locale()->toNumber($item->rating)); ?>">
          <?php if( $item->rating > 0 ): ?>
          <?php for( $x=1; $x<= $item->rating; $x++ ): ?>
          <span class="sesbasic_rating_star_small fa fa-star"></span>
          <?php endfor; ?>
