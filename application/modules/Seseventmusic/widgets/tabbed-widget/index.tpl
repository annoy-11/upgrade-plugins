...
<?php endif; ?>
  ...
  <div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix">    
    <ul class="seseventmusic_browse_listing" id="tabbed-widget_<?php echo $randonNumber; ?>">
    <?php } ?>
                ...
                <div class="hover_box">
                  ...
                  <div class="hover_box_options">
                    ...
                    <?php if(!empty($this->albumlink) && in_array('share', $this->albumlink) && $this->information && in_array('share', $this->information)): ?>
                      <a class="share-white" title="Share" href="javascript:void(0);" onclick="showPopUp('<?php echo $this->escape($this->url(array('module'=>'activity', 'controller'=>'index', 'action'=>'share', 'route'=>'default', 'type'=>'seseventmusic_album', 'id' => $item->album_id, 'format' => 'smoothbox'), 'default' , true)); ?>'); return false;" ><i class="fa fa-share"></i></a>
                    <?php endif; ?>
                    <?php endif; ?>
                  </div>
                </div>
...
<script type="text/javascript">
        ...
        if(document.getElementById("view_more_<?php echo $randonNumber; ?>"))
          document.getElementById("view_more_<?php echo $randonNumber; ?>").style.display = 'none';
			 ...
			 requestTab_<?php echo $randonNumber; ?> = new Request.HTML({
				method: 'post',
				'url': en4.core.baseUrl + 'widget/index/mod/seseventmusic/name/tabbed-widget/openTab/' + valueTab,
				'data': {
					format: 'html',
					page:  1,    
  ...
  function viewMore_<?php echo $randonNumber; ?> () {
    ...
    en4.core.request.send(new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'widget/index/mod/seseventmusic/name/tabbed-widget/openTab/' + openTab_<?php echo $randonNumber; ?>,
      'data': {
        format: 'html',
