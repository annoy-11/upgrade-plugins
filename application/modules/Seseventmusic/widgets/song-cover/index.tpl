  ...
  <script type="text/javascript">
    ...
    en4.core.runonce.add(function() {
      ...
      var rate = window.rate = function(rating) {
        ...
        (new Request.JSON({
          'format': 'json',
          'url' : '<?php echo $this->url(array('module' => 'seseventmusic', 'controller' => 'album', 'action' => 'rate'), 'default', true) ?>',
          'data' : {
            'format' : 'json',
            'rating' : rating,
...
<?php else: ?>
  ...
  <?php else: ?>
  <?php 
  $photoUrl = $this->baseUrl() . '/application/modules/Seseventmusic/externals/images/banner/cover.jpg';
  $songCoverPhoto = "<img src='$photoUrl' height='" . $this->height. "px;' alt='' align='left' />";
  ?>
<?php endif; ?>
<?php endif; ?>
  <div class="seseventmusic_cover" style="background-image:url(<?php echo $photoUrl ?>); height:<?php echo $this->height; ?>px;">
    <div class="seseventmusic_cover_inner">
      <?php if($this->information && in_array('photo', $this->information)): ?>
        <div class="seseventmusic_cover_music_artwork" style="height:<?php echo $this->mainPhotoHeight; ?>px;width:<?php echo $this->mainPhotowidth; ?>px;">
          ...
          <?php elseif(Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventmusic.songdefaultphoto')): ?>
            <?php $defaultPhoto = Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventmusic.songdefaultphoto');
            $path = $this->baseUrl() . '/' . $defaultPhoto;
            ?>
            <span style="background-image:url(<?php echo $path ?>)"></span>
          <?php else: ?>
            <?php $path = $this->baseUrl() . '/application/modules/Seseventmusic/externals/images/nophoto_albumsong_thumb_main.png';  ?>
            <span style="background-image:url(<?php echo $path ?>)"></span>
          <?php endif; ?>
      ...
      <?php endif; ?>
      <div class="seseventmusic_cover_content">
        <div class="seseventmusic_cover_title">
          <?php echo $this->albumsong->getTitle() ?>
        </div>
        <p class="seseventmusic_item_view_stats">
        ...
        <?php if($this->showRating == 1 && !empty($this->information) && in_array('ratingStars', $this->information)):  ?>
          <div id="album_rating" class="sesbasic_rating_star seseventmusic_cover_rating" onmouseout="rating_out();">
      ...
      <div class="seseventmusic_cover_options seseventmusic_options_buttons">
        ...
        <?php if($this->album->owner_id == $this->viewer_id): ?>
          <?php  if ($this->canEdit && $this->information && in_array('editButton', $this->information))
          echo $this->htmlLink($album->getHref(array('route' => 'seseventmusic_albumsong_specific', 'action' => 'edit', 'albumsong_id' => $this->albumsong->albumsong_id)), $this->translate(''), array('class'=>'fa fa-pencil', 'title' => $this->translate('Edit Song'))); ?> 
          <?php if($this->canDelete && $this->information && in_array('deleteButton', $this->information))
          echo $this->htmlLink(array('route' => 'seseventmusic_albumsong_specific', 'module' => 'seseventmusic', 'controller' => 'song', 'action' => 'delete', 'albumsong_id' => $this->albumsong->albumsong_id, 'format' => 'smoothbox'), $this->translate(''), array('class' => 'smoothbox fa fa-trash', 'title' => $this->translate('Delete Song'))); ?>
        <?php endif; ?>
        ...
        <?php if($this->albumsong->download && !$this->albumsong->track_id && !$this->albumsong->song_url && $this->downloadAlbumSong && $this->viewer()->getIdentity() && $this->information && in_array('downloadButton', $this->information)): ?>
          <?php echo $this->htmlLink(array('route' => 'seseventmusic_albumsong_specific', 'action' => 'download-song', 'albumsong_id' => $this->albumsong->albumsong_id), $this->translate(""), array('class' => 'fa fa-download', 'title' => $this->translate("Download"))); ?>                             
        ...
        <?php if($this->viewer()->getIdentity() && $this->albumsong->lyrics && $this->information && in_array('printButton', $this->information)): ?>
          <?php echo $this->htmlLink(array('action' => 'print', 'route' => 'seseventmusic_albumsong_specific', 'albumsong_id' => $this->albumsong->albumsong_id), $this->translate(''), array('class' => 'fa fa-print', 'title' => $this->translate('Print'))); ?>         
        <?php endif; ?>
        ...
        <?php if($this->viewer()->getIdentity() && $this->songlink && in_array('share', $this->songlink) && $this->information && in_array('share', $this->information)): ?>
          <?php echo $this->htmlLink(array('module'=>'activity', 'controller'=>'index', 'action'=>'share', 'route'=>'default', 'type'=>'seseventmusic_albumsong', 'id' => $this->albumsong->getIdentity(), 'format' => 'smoothbox'), $this->translate(""), array('class' => 'smoothbox fa fa-share', 'title' => $this->translate("Share"))); ?>
        <?php endif; ?>
        ...
        <?php if ($this->addfavouriteAlbumSong && !empty($this->viewer_id) && $this->information && in_array('addFavouriteButton', $this->information)): ?>
          <a class="fa fa-heart seseventmusic_favourite" id="seseventmusic_albumsong_unfavourite_<?php echo $this->albumsong->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "inline-block" : "none" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->albumsong->getIdentity(); ?>', 'seseventmusic_albumsong');" title="<?php echo $this->translate('Remove from Favorites') ?>"></a>
          <a class="fa fa-heart" id="seseventmusic_albumsong_favourite_<?php echo $this->albumsong->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "none" : "inline-block" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->albumsong->getIdentity(); ?>', 'seseventmusic_albumsong');" title="<?php echo $this->translate('Add to Favorite') ?>"></a>
          <input type="hidden" id="seseventmusic_albumsong_favouritehidden_<?php echo $this->albumsong->getIdentity(); ?>" value='<?php echo $this->isFavourite ? $this->isFavourite : 0; ?>' />
        <?php endif; ?> 
      </div>
    </div>
  </div>
<?php else: ?>
  <div class="seseventmusic_item_view_top">
    <div class="seseventmusic_item_view_artwork">
      <?php if($this->albumsong->photo_id): ?>
      ...
      <?php endif; ?>
      <div class="seseventmusic_item_info_label">
        <span class="seseventmusic_label_hot">HOT</span>
        <span class="seseventmusic_label_featured">FEATURED</span>
        <span class="seseventmusic_label_sponsored">SPONSORED</span>
      </div>
    </div>
    <div class="seseventmusic_item_view_info">
      <div class="seseventmusic_item_view_title">
        <?php echo $this->albumsong->getTitle() ?>
      </div>
      <p class="seseventmusic_item_view_stats sesbasic_text_light">
        <?php if($this->information && in_array('postedBy', $this->information)): ?>
      ...
      <div class="seseventmusic_options_buttons seseventmusic_item_view_options">
        ...
        <?php if($this->album->owner_id == $this->viewer_id || $this->viewer->level_id == 1): ?>
          <?php  if ($this->canEdit && $this->information && in_array('editButton', $this->information))
          echo $this->htmlLink($album->getHref(array('route' => 'seseventmusic_albumsong_specific', 'action' => 'edit', 'albumsong_id' => $this->albumsong->albumsong_id)), $this->translate('Edit Song'), array('class'=>'fa fa-pencil' )); ?> 

          <?php if($this->canDelete && $this->information && in_array('deleteButton', $this->information))
          echo $this->htmlLink(array('route' => 'seseventmusic_albumsong_specific', 'module' => 'seseventmusic', 'controller' => 'song', 'action' => 'delete', 'albumsong_id' => $this->albumsong->albumsong_id, 'format' => 'smoothbox'), $this->translate('Delete Song'), array('class' => 'smoothbox fa fa-trash')); ?>
        <?php endif; ?>
        ...
        <?php echo $this->htmlLink(array('route' => 'seseventmusic_albumsong_specific', 'action' => 'download-song', 'albumsong_id' => $this->albumsong->albumsong_id), $this->translate("Download"), array('class' => ' fa fa-download')); ?>
        <?php else: ?>
          <?php $file = Engine_Api::_()->getItem('storage_file', $this->albumsong->file_id); ?>
          <?php if($file->mime_minor && $this->downloadAlbumSong): ?>
          <?php $consumer_key =  Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventmusic.scclientid');
        ...
        <?php if($this->albumsong->lyrics && $this->information && in_array('printButton', $this->information)): ?>
          <?php echo $this->htmlLink(array('action' => 'print', 'route' => 'seseventmusic_albumsong_specific', 'albumsong_id' => $this->albumsong->albumsong_id), $this->translate('Print'), array('class' => '')); ?>         
        <?php endif; ?>

        <?php if($this->songlink && in_array('share', $this->songlink) && $this->information && in_array('share', $this->information)): ?>
          <?php echo $this->htmlLink(array('module'=>'activity', 'controller'=>'index', 'action'=>'share', 'route'=>'default', 'type'=>'seseventmusic_albumsong', 'id' => $this->albumsong->getIdentity(), 'format' => 'smoothbox'), $this->translate("Share"), array('class' => 'smoothbox fa fa-share')); ?>
        <?php endif; ?>
        ...
        <?php if ($this->addfavouriteAlbumSong && !empty($this->viewer_id) && $this->information && in_array('addFavouriteButton', $this->information)): ?>
          <a class="fa fa-heart seseventmusic_favourite" id="seseventmusic_albumsong_unfavourite_<?php echo $this->albumsong->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "inline-block" : "none" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->albumsong->getIdentity(); ?>', 'seseventmusic_albumsong');"><?php echo $this->translate("Remove from Favorites") ?></a>
          <a class="fa fa-heart" id="seseventmusic_albumsong_favourite_<?php echo $this->albumsong->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "none" : "inline-block" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->albumsong->getIdentity(); ?>', 'seseventmusic_albumsong');"><?php echo $this->translate("Add to Favorite") ?></a>
          <input type="hidden" id="seseventmusic_albumsong_favouritehidden_<?php echo $this->albumsong->getIdentity(); ?>" value='<?php echo $this->isFavourite ? $this->isFavourite : 0; ?>' />
        <?php endif; ?> 
      </div>
    </div>
