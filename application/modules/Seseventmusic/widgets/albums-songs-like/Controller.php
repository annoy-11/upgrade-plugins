 ...
 */
class Seseventmusic_Widget_AlbumsSongsLikeController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if ($contentType == 'albums')
      $subject = $coreApi->getSubject('seseventmusic_album');
    elseif ($contentType == 'songs')
      $subject = $coreApi->getSubject('seseventmusic_albumsong');
    ...
    $this->view->results = $results = Engine_Api::_()->seseventmusic()->albumsSongsLikeResults(array('type' => $type, 'id' => $id, 'limit' => $limit, 'showUsers' => $this->view->showUsers));
