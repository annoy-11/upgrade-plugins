...
class Seseventmusic_Widget_BrowseAlbumsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->information = $information = isset($params['information']) ? $params['information'] : $this->_getParam('information', array('featured', 'sponsored', 'hot', 'likeCount', 'commentCount', 'viewCount', 'title', 'postedby', 'favourite', 'share', 'ratingStars'));
    ...
    //Can create?
    $this->view->canCreate = $authorizationApi->isAllowed('seseventmusic_album', $viewer, 'create');
    $this->view->canAddPlaylist = $authorizationApi->isAllowed('seseventmusic_album', $viewer, 'addplaylist_album');
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('albums', 'seseventmusic')->getPlaylistPaginator($values);
