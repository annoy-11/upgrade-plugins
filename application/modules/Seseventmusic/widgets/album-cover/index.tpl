...
<?php if($this->albumCover): ?>
  ...
  <?php else: ?>
    <?php $photoUrl = $this->baseUrl() . '/application/modules/Seseventmusic/externals/images/banner/cover.jpg'; ?>
  <?php endif; ?>
  <?php endif; ?>
  <div class="seseventmusic_cover" style="background-image:url(<?php echo $photoUrl ?>); height:<?php echo $this->height; ?>px;">
    <div class="seseventmusic_cover_inner">
      <?php if($this->information && in_array('photo', $this->information)): ?>
        <div class="seseventmusic_cover_music_artwork" style="height:<?php echo $this->mainPhotoHeight; ?>px;width:<?php echo $this->mainPhotowidth; ?>px;">
          <?php if($album->photo_id):   ?>
            ...
            $path = $img_path; 
          elseif(Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventmusic.albumdefaultphoto')):
           $defaultPhoto = Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventmusic.albumdefaultphoto');
           $path = $this->baseUrl() . '/' . $defaultPhoto  ?>
          <span style="background-image:url(<?php echo $path ?>)"></span>
          <?php else: 
            $path = $this->baseUrl() . '/application/modules/Seseventmusic/externals/images/nophoto_album_thumb_main.png';  ?>          
          <?php endif; ?>
          <span style="background-image:url(<?php echo $path ?>)"></span>
      ...
      <div class="seseventmusic_cover_content">
        ...
        <p class="seseventmusic_item_view_des">
      ...
      <div class="seseventmusic_cover_options seseventmusic_options_buttons">
        <?php if ($this->canEdit && $this->information && in_array('editButton', $this->information))
	        echo $this->htmlLink($album->getHref(array('route' => 'seseventmusic_album_specific', 'action' => 'edit')), $this->translate(''), array('class'=>'fa fa-pencil', 'title' => $this->translate('Edit Music Album'))); ?>
        
        <?php if($this->canDelete && $this->information && in_array('deleteButton', $this->information))
	        echo $this->htmlLink(array('route' => 'seseventmusic_general', 'module' => 'seseventmusic', 'controller' => 'index', 'action' => 'delete', 'album_id' => $album->getIdentity(), 'resource_id' => $album->resource_id, 'format' => 'smoothbox'), $this->translate(''), array('class' => 'smoothbox fa fa-trash', 'title' => $this->translate('Delete Music Album'))); ?>
        ...
        <?php if(!empty($this->viewer_id) && !empty($this->albumlink) && in_array('share', $this->albumlink) && $this->information && in_array('share', $this->information)): ?>
	        <?php echo $this->htmlLink(array('module'=>'activity', 'controller'=>'index', 'action'=>'share', 'route'=>'default', 'type'=>'seseventmusic_album', 'id' => $this->album->getIdentity(), 'format' => 'smoothbox'), $this->translate(""), array('class' => 'smoothbox fa fa-share', 'title' => $this->translate("Share"))); ?>
        <?php endif; ?>
        ...
        <?php if ($this->canAddFavourite && !empty($this->viewer_id) && $this->information && in_array('addFavouriteButton', $this->information)): ?>
	        <a class="fa fa-heart seseventmusic_favourite" id="seseventmusic_album_unfavourite_<?php echo $this->album->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "inline-block" : "none" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->album->getIdentity(); ?>', 'seseventmusic_album');" title="<?php echo $this->translate("Remove from Favorite") ?>"></a>
	        <a class="fa fa-heart" id="seseventmusic_album_favourite_<?php echo $this->album->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "none" : "inline-block" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->album->getIdentity(); ?>', 'seseventmusic_album');" title="<?php echo $this->translate("Add to Favorite") ?>"></a>
  ...
  <div class="seseventmusic_item_view_top">
    ...
    <div class="seseventmusic_item_view_info">
      ...
      <div class="seseventmusic_options_buttons seseventmusic_item_view_options">
        ...
        <?php if ($this->canEdit && $this->information && in_array('editButton', $this->information))
        echo $this->htmlLink($album->getHref(array('route' => 'seseventmusic_album_specific', 'action' => 'edit')), $this->translate('Edit Music Album'), array('class'=>'fa fa-pencil' )); ?>

        <?php if($this->canDelete && $this->information && in_array('deleteButton', $this->information))
        echo $this->htmlLink(array('route' => 'seseventmusic_general', 'module' => 'seseventmusic', 'controller' => 'index', 'action' => 'delete', 'album_id' => $album->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete Music Album'), array('class' => 'smoothbox fa fa-trash')); ?>

        <?php if(!empty($this->albumlink) && in_array('share', $this->albumlink) && $this->information && in_array('share', $this->information)): ?>
        <?php echo $this->htmlLink(array('module'=>'activity', 'controller'=>'index', 'action'=>'share', 'route'=>'default', 'type'=>'seseventmusic_album', 'id' => $this->album->getIdentity(), 'format' => 'smoothbox'), $this->translate("Share"), array('class' => 'smoothbox fa fa-share')); ?>
        <?php endif; ?>
        ...
        <?php //echo $this->htmlLink($album->getHref(array('route' => 'seseventmusic_album_specific', 'action' => 'download-zip')), $this->translate('Download All Songs'), array('class'=>'fa fa-download' )); ?>
        <?php endif; ?>

        <?php if ($this->canAddFavourite && !empty($this->viewer_id) && $this->information && in_array('addFavouriteButton', $this->information)): ?>

        <a class="fa fa-heart seseventmusic_favourite" id="seseventmusic_album_unfavourite_<?php echo $this->album->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "inline-block" : "none" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->album->getIdentity(); ?>', 'seseventmusic_album');"><?php echo $this->translate("Remove from Favorite") ?></a>
        <a class="fa fa-heart" id="seseventmusic_album_favourite_<?php echo $this->album->getIdentity(); ?>" style ='display:<?php echo $this->isFavourite ? "none" : "inline-block" ?>' href = "javascript:void(0);" onclick = "seseventmusicFavourite('<?php echo $this->album->getIdentity(); ?>', 'seseventmusic_album');"><?php echo $this->translate("Add to Favorite") ?></a>
        <input type="hidden" id="seseventmusic_album_favouritehidden_<?php echo $this->album->getIdentity(); ?>" value='<?php echo $this->isFavourite ? $this->isFavourite : 0; ?>' />
        <?php endif; ?>
      </div>
    </div>
