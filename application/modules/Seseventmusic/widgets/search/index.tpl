...
?>
<?php if( $this->form ): ?>
<div class="seseventmusic_global_search">
...
<script type="text/javascript">
  ...
  function typevalue(value) {    
    setCookie("seseventmusic_commonsearch", value, 1);
  }
  
  //Take refrences from "/application/modules/Blog/views/scripts/index/create.tpl"
  en4.core.runonce.add(function() {
    setCookie("seseventmusic_commonsearch", "", - 3600);
    var searchAutocomplete = new Autocompleter.Request.JSON('title', "<?php echo $this->url(array('module' => 'seseventmusic', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
      'postVar': 'text',
      'delay' : 250,      
      'minLength': 1,
      'selectMode': 'pick',
