 ...
 * @version    $Id: AlbumSongDayOfThe.php 2015-03-30 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seseventmusic_Form_Admin_Settings_AlbumSongDayOfThe extends Engine_Form {

  public function init() {

    $this->setTitle('Album / Song of the Day')
            ->setDescription('Displays the Album / Song of The day as selected by the admin from the edit setting of this widget.');
