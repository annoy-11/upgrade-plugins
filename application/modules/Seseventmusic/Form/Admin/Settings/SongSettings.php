 ...
 */
class Seseventmusic_Form_Admin_Settings_SongSettings extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('MultiCheckbox', 'seseventmusic_songlink', array(
        ...
        'value' => unserialize($settings->getSetting('seseventmusic.songlink', 'a:7:{i:0;s:6:"report";i:1;s:5:"share";}')),
    ));

    $this->addElement('Radio', 'seseventmusic_albumsong_rating', array(
        'label' => 'Allow Rating',
        ...
        'value' => $settings->getSetting('seseventmusic.albumsong.rating', 1),
    ));

    $this->addElement('Radio', 'seseventmusic_ratealbumsong_own', array(
        ...
        'value' => $settings->getSetting('seseventmusic.ratealbumsong.own', 1),
    ));
    
    $this->addElement('Radio', 'seseventmusic_ratealbumsong_again', array(
        ...
        'value' => $settings->getSetting('seseventmusic.ratealbumsong.again', 1),
    ));

    $this->addElement('Radio', 'seseventmusic_ratealbumsong_show', array(
        ...
        'value' => $settings->getSetting('seseventmusic.ratealbumsong.show', 1),
    ));
    ...
    if (count($banner_options) > 1) {
      $this->addElement('Select', 'seseventmusic_songdefaultphoto', array(
          ...
          'value' => $settings->getSetting('seseventmusic.songdefaultphoto'),
      ));
    } else {
    ...
    $this->addElement('Radio', 'seseventmusic_show_songcover', array(
        ...
        'value' => $settings->getSetting('seseventmusic.show.songcover', 1),
    ));


    if (count($banner_options) > 1) {
      $this->addElement('Select', 'seseventmusic_songcover_photo', array(
          ...
          'multiOptions' => $banner_options,
          'value' => $settings->getSetting('seseventmusic.songcover.photo'),
      ));
    } else {
