 ...
 */
class Seseventmusic_Model_DbTable_Albums extends Engine_Db_Table {

  protected $_rowClass = 'Seseventmusic_Model_Album';
  ...
  public function getPlaylistSelect($params = array()) {
    ...
    $albumSongsTableName = Engine_Api::_()->getDbTable('albumsongs', 'seseventmusic')->info('name');
  ...
  public function widgetResults($params = array()) {
    ...
    if (isset($params['popularity']) || isset($params['displayContentType'])) {
      ...
      if ($params['popularity'] == "You May Also Like") {
        $albumIds = Engine_Api::_()->seseventmusic()->likeIds(array('type' => 'seseventmusic_album', 'id' => $viewer_id));
