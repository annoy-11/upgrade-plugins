 ...
 */
class Seseventmusic_Model_DbTable_Recentlyviewitems extends Engine_Db_Table {

  protected $_name = 'seseventmusic_recentlyviewitems';
  protected $_rowClass = 'Seseventmusic_Model_Recentlyviewitem';

  public function getitem($params = array()) {

    if ($params['type'] == 'seseventmusic_albumsong') {
      $itemTable = Engine_Api::_()->getItemTable('seseventmusic_albumsong');
      $itemTableName = $itemTable->info('name');
      $fieldName = 'albumsong_id';
    } elseif ($params['type'] == 'seseventmusic_album') {
      $itemTable = Engine_Api::_()->getItemTable('seseventmusic_album');
      $itemTableName = $itemTable->info('name');
      $fieldName = 'album_id';
    }
