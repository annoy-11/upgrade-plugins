 ...
 */
class Seseventmusic_Model_DbTable_Ratings extends Engine_Db_Table {

  protected $_rowClass = "Seseventmusic_Model_Rating";
  ...
  public function setRating($resource_id, $user_id, $rating, $resource_type) {
    ...
    if (count($row) == 0) {
      //Create rating
      Engine_Api::_()->getDbTable('ratings', 'seseventmusic')->insert(array(
      ...
      Engine_Api::_()->getDbTable('ratings', 'seseventmusic')->update(array(
          'rating' => $rating,
              ), array(
          'resource_id = ?' => $resource_id,
          'user_id = ?' => $user_id,
