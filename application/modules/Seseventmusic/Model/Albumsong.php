 ...
 */
class Seseventmusic_Model_Albumsong extends Core_Model_Item_Abstract {
  ...
  public function getPhotoUrl($type = NULL) {
    ...
    $defaultphoto = Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventmusic.songdefaultphoto');
  ...
  public function getParent($recurseType = NULL) {
    return Engine_Api::_()->getItem('seseventmusic_albums', $this->album_id);
  }
  ...
  public function getRichContent($view = false, $params = array()) {
    ...
    if ($view == false) {
      ...
      $musicEmbedded = $desc . $view->render('application/modules/Seseventmusic/views/scripts/_Player.tpl');
    }
  ...
  public function setPhoto($photo, $param = null, $soundcloudImages = array()) {
    ...
    $params = array(
        'parent_type' => 'seseventmusic_albumsong',
