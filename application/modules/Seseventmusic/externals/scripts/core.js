...
en4.core.runonce.add(function() {
  ...
  //Preload pause button element as defined in CSS class '.seseventmusic_player_button_pause'
  new Element('div', {
    'id': 'pause_preloader',
    'class': 'seseventmusic_player_button_pause',
...
en4.music.player = {
  ...
  enablePlayers : function() {
    ...
    var players = $$('.seseventmusic_player_wrapper');
    //if( players.length > 0 ) {
    ...
    players.each(function(el) {
      ...
      if( matches && matches.length >= 2 && !el.hasClass('seseventmusic_player_active') ) {
        el.addClass('seseventmusic_player_active');
  ...
  createPlayer : function(id) {
    ...
    en4.music.player.getSoundManager().onready(function() {
      ...
      // show the short player first
        ...
        par.getElement('div.seseventmusic_player:not(div.sesplaylist_short_player)').hide();
