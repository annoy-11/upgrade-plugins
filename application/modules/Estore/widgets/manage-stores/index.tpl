...
<?php } ?>
    <ul style="margin-bottom:10px;">
      ...
      <?php if(ESTOREPACKAGE == 1):?>
        <div class="estore_manage_package_btn">
          <a href="<?php echo $this->url(array('action' => 'package'),'estore_general',true);?>" class="estore_link_btn"><?php echo $this->translate("My Packages"); ?></a>
        </div>
      <?php endif;?>
    </div>
