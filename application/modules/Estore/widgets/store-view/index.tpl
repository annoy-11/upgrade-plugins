...
<?php if($this->params['layout_type'] == 2): ?>
        ...
        <div class="estore_cover_content estore_cover_d2">
          ...
          <div class="_maincont sesbasic_clearfix">
            <div class="_cnw">
              ...
              <?php endif;?>
              <div class="_info">
                <?php if(isset($this->titleActive)):?><h1><?php echo $store->title;?><?php if(isset($this->verifiedLabelActive) && $this->store->verified):?><i class="estore_label_verified sesbasic_verified_icon" title='<?php echo $this->translate("Verified");?>'></i><?php endif;?></h1><?php endif;?>  
  ...
  <?php $favouriteText = ($favouriteStatus) ?  $this->translate('Favorited') : $this->translate('Add to Favourite');?>
        ...
        <?php if(isset($this->socialSharingActive) && $shareType):?>
          <div class="_sharebtn">
            <a href="javascript:void(0);" class="sesbasic_button sesbasic_animation estore_button_toggle"><i class="fa fa-share-alt"></i><span><?php echo $this->translate('Share');?></span></a>
            <div class="estore_listing_share_popup">
             <!-- <p><?php echo $this->translate("Share This Store");?></p> -->
              ...
              <?php endif;?>
              <a href="<?php echo $this->url(array('module' => 'activity','controller' => 'index','action' => 'share','type' => $store->getType(),'id' => $store->getIdentity(),'format' => 'smoothbox'),'default',true);?>" class="smoothbox sesbasic_icon_btn sesbasic_icon_share_btn" title='<?php echo $this->translate("Share on Site")?>'><i class="fa fa-share"></i></a>
            </div>
          </div>
        <?php endif;?>
        <?php if(isset($this->optionMenuActive)):?>
          <div class="_optionbtn"><a href="javascript:void(0);" class="sesbasic_button estore_cbtn" id="estore_cover_option_btn"><i class="fa fa-cog"></i></a></div>
        <?php endif;?>
      </div>
      <div class="_rightbtns">
        ...
        <?php if(isset($this->messageOwnerActive) && $viewerId != $this->store->owner_id):?>
          <div class="_mgsowner">
            <a href="<?php echo $this->url(array('owner_id' => $this->store->owner_id,'action'=>'contact'), 'estore_general', true); ?>" class="sessmoothbox sesbasic_button"><i class="fa fa-envelope"></i><span><?php echo $this->translate('Message Owner');?></span></a>
          </div>
        <?php endif;?>
  ...
  <div class="estore_cover_container sesbasic_clearfix sesbasic_bxs <?php if($this->params['show_full_width'] == 'yes'){ ?>estore_cover_container_full <?php } ?>" style="margin-top:-<?php echo is_numeric($this->params['margin_top']) ? $this->params['margin_top'].'px' : $this->params['margin_top']?>;">
    <div class="estore_cover" style="height:<?php echo $height ?>;">
      <div class="estore_cover_inner sesbasic_clearfix">
        ...
        <?php endif;?>
        <div class="estore_cover_content estore_cover_d1">
          <div class="estore_cover_labels sesbasic_animation">
            <?php if(isset($this->featuredLabelActive) && $store->featured):?>
              <span class="estore_label_featured"><?php echo $this->translate("Featured");?></span>
            <?php endif;?>
        ...
        <div class="_midbtns">
                <div class="_joinbtn">
                  <?php if($canJoin && isset($this->joinButtonActive)):?>
                    <div class="_listbuttons_join">
                      <?php if($viewerId):?>
                        <?php $row = $store->membership()->getRow($this->viewer());?>
                        <?php if(null === $row):?>
                          <?php if($store->membership()->isResourceApprovalRequired()):?>
                            <?php $action = 'request';?>
                          <?php else:?>
                            <?php $action = 'join';?>
                          <?php endif;?>
                          <a href="<?php echo $this->url(array('controller' => 'member','action' => $action,'store_id' => $store->store_id),'estore_extended',true);?>" class="smoothbox estore_button sesbasic_animation"><i class="fa fa-plus"></i><span><?php echo $this->translate('Join');?></span></a>
                        <?php else:?>
                          <?php if($row->active):?>
                ...
                <?php if(isset($this->messageOwnerActive) && $viewerId != $this->store->owner_id):?>
                  <div class="_mgsowner">
                    <a href="<?php echo $this->url(array('owner_id' => $this->store->owner_id,'action'=>'contact'), 'estore_general', true); ?>" class="sessmoothbox estore_button"><i class="fa fa-envelope"></i><span><?php echo $this->translate('Message Owner');?></span></a>
                  </div>
                <?php endif;?>
                <?php if(isset($this->addButtonActive)):?>
                  <div class="_contactbtn">
            ...
            <div class="_footer sesbasic_clearfix">
              <div class="_footerinner _cnw sesbasic_clearfix">
                <div class="estore_cover_social_btns">
                <?php if(isset($this->socialSharingActive) && $shareType == 2):?>
                  <?php echo $this->partial('_socialShareIcons.tpl','sesbasic',array('resource' => $store, 'socialshare_enable_plusicon' => $this->params["socialshare_enable_plusicon"], 'socialshare_icon_limit' => $this->params["socialshare_icon_limit"])); ?>
                <?php endif;?>  
                <?php if($store->is_approved):?>
                  <?php $canComment = Engine_Api::_()->authorization()->isAllowed('stores', $this->viewer(), 'create');?>
                  <?php if(isset($this->likeButtonActive) && $canComment):?>
                ...
                <?php endif;?>
                  <?php if(isset($this->optionMenuActive)):?>
                    <a href="javascript:void(0);" class="sesbasic_icon_btn" id="estore_cover_option_btn"><i class="fa fa-cog"></i></a>
                  <?php endif;?>
                </div>
                <?php if($this->params['tab_placement'] == 'in'):?>
                  <div class="estore_cover_tabs _tabs"></div>
                <?php endif;?>
              </div>  
            </div>
          </div>
  ...
  <?php if($this->params['tab_placement'] == 'in'):?>
    if (matchMedia('only screen and (min-width: 767px)').matches) {
        ...
        if(sesJqueryObject('.layout_core_container_tabs').length>0){
          ...
          sesJqueryObject('.estore_cover_tabs').html(tabs);
        }
      });
