...
class Estore_Widget_TabbedWidgetStoreController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->can_create = Engine_Api::_()->authorization()->isAllowed('stores', null, 'create');
      ...
      foreach ($defaultOptionsArray as $key => $defaultValue) {
        ...
        if ($this->_getParam($defaultValue . '_label'))
          ...
          if ($defaultValue == 'open')
            $valueLabel = 'Open Stores';
          elseif ($defaultValue == 'close')
            $valueLabel = 'Closed Stores';
    ...
    $this->view->widgetName = 'tabbed-widget-store  ';
