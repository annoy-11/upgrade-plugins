          ...
          <?php $store = Engine_Api::_()->getItem('stores', $data['store_id']);?>
          	<div class="estore_stores_slideshow_item sesbasic_clearfix">
                ...
                <div class="thumb_logo_slide">
                  <a href="<?php echo $store->getHref(); ?>" class="logo_is rounded">
                ...
                <?php if(isset($this->titleActive)):?>
                  ...
                  <div class="estore_stores_slideshow_cont">
                    ...
                    <div class="estore_slide_seller_info sesbasic_clearfix sesbasic_bxs">
                        ...
                        <div class="estore_slide_sharebtn sesbasic_clearfix sesbasic_bxs">
                            <?php include APPLICATION_PATH .  '/application/modules/Estore/views/scripts/_dataSharing.tpl';?>
                        </div>
                  	<?php endif;?>
                  	  <?php if(isset($this->priceActive)):?>
                        <div class="estore_slideshow_price sesbasic_clearfix sesbasic_bxs">
                  ...
                  <?php if(isset($this->totalProductActive)): ?>
                    <div class="sesbasic_clearfix estore_grid_product_img">
        ...
        <?php for($i=0;$i<count($leftData);$i++):?>
          ...
          <div class="estore_stores_slideshow_left_item">
            <div class="_thumb" style="height:<?php echo $height ?>px;">
              <a href="<?php echo $store->getHref(); ?>" class="_thumbimg">
            ...
            <div class="_cont">    
              ...
              <?php if(isset($this->categoryActive)):?>
                <div class="_stats sesbasic_clearfix">
                  ...
                  <span><a href="<?php echo $store->getHref();?>"><?php echo $category->category_name;?></a></span>
                </div>
              <?php endif;?>
            </div>  
          </div>
