 ...
 */
class Estore_Widget_BrowseStoresController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (isset($get_array)) {
      ...
      if (isset($params['tag_id']))
        ...
        //Hashtag page work
        $params['tag'] = Engine_Api::_()->getDbTable('tags', 'core')->getTagId($get_array['search']);
        $params['hashtagPage'] = 1;
      }
    }
    ...
    $this->view->widgetName = 'browse-stores';
    ...
    if (isset($params['search']) && empty($params['hashtagPage']))
