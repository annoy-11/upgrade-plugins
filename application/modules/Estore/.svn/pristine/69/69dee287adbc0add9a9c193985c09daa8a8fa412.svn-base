    ...
    sesJqueryObject.ajax({
      ...
      success: function(response) {
        ...
        if(result.status == 1) {
          ...
          sesJqueryObject('#sessmoothbox_container').html("<div id='servicesuccess_message' class='estoreservice_success_message servicesuccess_message'><i class='fa-check-circle-o'></i><span><?php echo $this->translate("Your service is successfully added."); ?></span></div>");
