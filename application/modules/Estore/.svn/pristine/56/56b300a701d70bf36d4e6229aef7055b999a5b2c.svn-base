...
class Estore_Widget_ProfilePhotosController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->canUpload = $canUpload = $getStoreRolePermission ? $getStoreRolePermission : $subject->authorization()->isAllowed($viewer, 'album');

    $this->view->store_album_count = $store_album_count = Engine_Api::_()->authorization()->getPermission($viewer->level_id, 'estore_store', 'store_album_count');
