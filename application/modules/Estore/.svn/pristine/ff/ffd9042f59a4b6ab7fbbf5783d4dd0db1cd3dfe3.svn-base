...
<div class="estore_view_detail_popup">
<?php $defaultCurrency = Engine_Api::_()->estore()->defaultCurrency(); ?>
  ...
  <table class="sesbm">   
      ...
      <td><a href="<?php echo $this->store->getHref(); ?>" target="_blank"><?php echo $this->store->title; ?></a>
     </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php echo Engine_Api::_()->estore()->getCurrencyPrice($this->item->requested_amount,$defaultCurrency); ?></td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <tr>
      ...
      <td><?php echo Engine_Api::_()->estore()->getCurrencyPrice($this->item->release_amount,$defaultCurrency); ?></td>
    </tr>
    <tr>
