...
<div class="layout_middle">
  ...
  <?php } ?>
    <div class="sesbasic_clearfix sesevent_order_complete_head">
      ...
      <div class="sesevent_order_share">
        ...
        <div class="" id="sesevent_host_follow_<?php echo $this->event->host; ?>" style ='display:<?php echo $isFollow ? "none" : "inline-block" ?>' >
          <a  class="estore_link_btn" href = "javascript:void(0);" onclick = "followButton('<?php echo $this->event->host; ?>', 'sesevent_host');">
    ...
    <div class="sesbasic_clearfix clear sesevent_order_btns">
    	<a href="<?php echo $this->url(array('action'=>'my-tickets'), 'sesevent_my_ticket', true); ?>" class="estore_link_btn floatL"><?php echo $this->translate("Go To My Ticket"); ?></a>
      <a href="<?php echo $this->event->getHref();?>" class="estore_link_btn floatL"><?php echo $this->translate("Go To Event"); ?></a>
    </div>
	</div>
	</div>
</div>
