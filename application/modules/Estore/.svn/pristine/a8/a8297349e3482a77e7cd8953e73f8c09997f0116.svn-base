 ...
 */
class Estore_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbTable('categories', 'estore')->getCategory(array('column_name' => '*'));
    ...
    if (ESTOREPACKAGE == 1) {
      $packages = Engine_Api::_()->getDbTable('packages', 'estorepackage')->getPackage(array('default' => true));
