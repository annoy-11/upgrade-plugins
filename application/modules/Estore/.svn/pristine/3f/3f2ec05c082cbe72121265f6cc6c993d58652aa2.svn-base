 ...
 */
class Estore_Form_AlbumSearch extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Button', 'submit', array(
      ...
      'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="estore-category-widget-img" alt="Loading" />',
   ));
  }
}
