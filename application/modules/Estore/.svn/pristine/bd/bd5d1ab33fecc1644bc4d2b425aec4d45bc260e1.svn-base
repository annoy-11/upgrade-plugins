 ...
 * @version    $Id: invite.tpl  2018-07-13 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'estore/member/invite/store_id/' + '<?php echo $this->store->store_id; ?>' ,
      'data': {
        format: 'html',
...
<?php if( $this->paginator->getTotalItemcount() > 0 ): ?>
  ...
  <form method="post" id="estoreinviteform" data-src="<?php echo $this->store->store_id; ?>">
    <div class="estore_invite_popup sesbasic_bxs">
      <div class="_header">
        <?php echo $this->translate('Invite Members') ?>
      </div>
      <div class="_content">
      <p class="_des"><?php echo $this->translate('Choose the people you want to invite to this store.') ?></p>
    ...
    <?php if (empty($this->viewmore)): ?>
          ...
          <?php if (!empty($this->paginator) && $this->paginator->count() > 1 && $this->paginator->getCurrentPageNumber() < $this->paginator->count()): ?>
            <div class="sesbasic_load_btn" id="view_more" onclick="viewMore();" >
               <a href="javascript:void(0);" class="sesbasic_animation estore_link_btn" id="feed_viewmore_link"><i class="fa fa-repeat"></i><span><?php echo $this->translate('View More');?></span></a>
            </div>
