...
<p>
  <?php echo $this->translate('Here you can transfer the ownership of this Store to some other site member. [Note: You cannot revert this action, so we suggest you to take this action only if you are pretty much sure about this.]') ?>
</p>
<br />	
<form id="estore_change_owner" action="<?php echo $this->url(array('module' => 'estore', 'controller' => 'manage','action'=>'change-owner','id' => $this->store->store_id),'admin_default', true); ?>" method="post">
...
<script type='text/javascript'>
 var Searchurl = "<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'search-member'), 'estore_dashboard', true); ?>";
