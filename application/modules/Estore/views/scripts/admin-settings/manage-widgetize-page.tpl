...
<table class='admin_table'>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <a title="<?php echo $this->translate('Reset Page'); ?>" href="<?php echo $this->url(array('module'=> 'estore', 'controller' => 'settings', 'action' => 'reset-page-settings', 'page_id' => $corePages->page_id, 'page_name' => $item,'format' => 'smoothbox'),'admin_default',true); ?>" class=" smoothbox"><?php echo $this->translate('Reset Page'); ?></a>
        </td>
    </tr>
    <?php $results = ''; ?>
    <?php endforeach; ?>
