...
<div class="estore_data_stats sesbasic_text_light">
  <?php if(isset($this->likeActive)):?>
    <span title="<?php echo $this->translate(array('%s Like', '%s Likes', $store->like_count), $this->locale()->toNumber($store->like_count)) ?>"><i class="far fa-thumbs-up"></i> <?php echo $store->like_count; ?></span>
  <?php endif;?>
  <?php if(isset($this->commentActive)):?>
    <span title="<?php echo $this->translate(array('%s Comment', '%s Comments', $store->comment_count), $this->locale()->toNumber($store->comment_count)) ?>"><i class="far fa-comment"></i> <?php echo $store->comment_count; ?></span>
  <?php endif;?>
  <?php if(isset($this->viewActive)):?>
    <span title="<?php echo $this->translate(array('%s View', '%s Views', $store->view_count), $this->locale()->toNumber($store->view_count)) ?>"><i class="far fa-eye"></i> <?php echo $store->view_count; ?></span>
  <?php endif;?>
  <?php if(isset($this->favouriteActive)):?>
    <span title="<?php echo $this->translate(array('%s Favourite', '%s Favourites', $store->favourite_count), $this->locale()->toNumber($store->favourite_count)) ?>"><i class="far fa-heart"></i> <?php echo $store->favourite_count; ?></span>
  <?php endif;?>
  ...
  <?php endif;?>
	...
	<?php if(isset($this->memberActive)): ?>
			<span title="<?php echo $this->translate(array('%s Member', '%s Member', $members->getTotalItemCount()), $this->locale()->toNumber($members->getTotalItemCount())) ?>"><i class="far fa-user"></i> <?php echo $members->getTotalItemCount(); ?></span>
	<?php endif;?>
