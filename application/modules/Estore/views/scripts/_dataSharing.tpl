      ...
      <div class="_listbuttons_share"> <a href="javascript:void(0);" class="estore_button sesbasic_animation estore_button_toggle"><i class="fa fa-share-alt"></i><span><?php echo $this->translate('Share');?></span></a>
        <div class="estore_listing_share_popup">
         <!-- <p><?php echo $this->translate("Share This Store");?></p>-->
          ...
          <?php endif;?>
          <a href="<?php echo $this->url(array('module' => 'activity','controller' => 'index','action' => 'share','type' => $store->getType(),'id' => $store->getIdentity(),'format' => 'smoothbox'),'default',true);?>" class="openSmoothbox sesbasic_icon_btn sesbasic_icon_share_btn" title='<?php echo $this->translate("Share on Site")?>'><i class="fa fa-share"></i></a>
      	</div>
      </div>
    <?php endif;?>
  </div>
