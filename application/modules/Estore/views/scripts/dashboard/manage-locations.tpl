                    ...
                    <tr>
                       ...
                       <td class="centerT">
                        ...
                        <td class="table_options centerT">
                            <?php echo $this->htmlLink($this->url(array('store_id' => $this->store->custom_url,'action'=>'create-location','id'=>$item->getIdentity()), 'estore_dashboard', true), $this->translate(""), array('class' => 'fa fa-edit openSmoothbox','title'=>$this->translate("Edit"))) ?>
