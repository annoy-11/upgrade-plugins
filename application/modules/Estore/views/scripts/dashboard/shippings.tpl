                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="table_options centerT">
                            <?php echo $this->htmlLink($this->url(array('store_id' => $this->store->custom_url,'action'=>'create-shipping','id'=>$item->getIdentity()), 'estore_dashboard', true), $this->translate(""), array('class' => 'fa fa-pencil estore_dashboard_nopropagate_content','title'=>$this->translate("Edit"))) ?>
