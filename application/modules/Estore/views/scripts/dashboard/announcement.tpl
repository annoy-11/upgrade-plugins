  ...
  function makeEditorRich() {
    ...
    <div class="estore_dashboard_content_header">
      <h3><?php echo $this->translate('Manage Announcements') ?></h3>
    	<p><?php echo $this->translate('Here, you can create announcements to post them on the Store Profile. You can also edit and delete the announcements listed on this Store.') ?></p>
    </div>
    <div class="estore_dashboard_content_btns">
      <a href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'post-announcement'), 'estore_dashboard', true); ?>" class="sessmoothbox sesbasic_button"><i class="fa fa-bullhorn"></i><span><?php echo $this->translate("Post New Announcement");?></span></a>
    </div>  
  <?php if($this->paginator->getTotalItemCount()!=0): ?>
    <div class="estore_dashboard_results"><?php echo $this->translate('%d announcements total', $this->paginator->getTotalItemCount()) ?></div>
  <?php endif;?>
  <?php echo $this->paginationControl($this->paginator); ?>
<?php if( count($this->paginator) ): ?>
  <div class="estore_dashboard_table">
