...
<script type="application/javascript">
  ...
  function submitService(formObject) {
    ...
    sesJqueryObject.ajax({
      url: "estore/dashboard/editservice/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
      ...
      success: function(response) {
        ...
        if(result.status == 1) {
          ...
          sesJqueryObject('#sessmoothbox_container').html("<div id='servicesuccess_message' class='estoreservice_success_message servicesuccess_message'><i class='far fa-check-circle'></i><span><?php echo $this->translate("Your service is successfully added."); ?></span></div>");
