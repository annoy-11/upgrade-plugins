      ...
      <div class="estore_locations_item sesbasic_clearfix">
        ...
        <div class="_cont">
          <div class="_title sesbasic_clearfix">
            ...
            <span>
              <a href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'location_id' => $location->location_id,'action'=>'edit-location'),'estore_dashboard',true);?>" title='<?php echo $this->translate("Edit Location");?>' class="sessmoothbox fa fa-pencil"></a>
