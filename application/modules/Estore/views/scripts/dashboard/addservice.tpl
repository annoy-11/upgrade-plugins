    ...
    sesJqueryObject.ajax({
      ...
      success: function(response) {
        ...
        if(result.status == 1) {
          ...
          sesJqueryObject('#sessmoothbox_container').html("<div id='servicesuccess_message' class='estoreservice_success_message servicesuccess_message'><i class='far fa-check-circle'></i><span>Your service is successfully added.</span></div>");
