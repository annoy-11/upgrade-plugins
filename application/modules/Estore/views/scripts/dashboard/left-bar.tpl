      ...
      <li class="sesbm">
        ...
        <ul class="sesbm">	
          ...
          <?php if($policy_store->enabled && Engine_Api::_()->getApi('settings', 'core')->getSetting('estore.allow.termncondition', 1)): ?>
            <li><a href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'policy'), 'estore_dashboard', true); ?>" class="dashboard_a_link"><i class="fa fa-file-text"></i><span><?php echo $this->translate($policy_store->title); ?></span></a></li>
          <?php endif; ?>
          <?php if((!empty($upgrade) && $upgrade->enabled && isset($params))): ?>
            <li><a href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'upgrade'), 'estore_dashboard', true); ?>" class="dashboard_a_link" ><i class="fa fa-refresh "></i> <?php echo $this->translate($upgrade->title); ?></a></li>
          <?php endif; ?>
          ...
          <?php if(@$postAttribution->enabled && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'seb_attribution') && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'auth_defattribut') == 1): ?>
            <li><a class="dashboard_a_link" href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'post-attribution'), 'estore_dashboard', true); ?>"><i class="fa fa-file-o"></i><span><?php echo $this->translate($postAttribution->title); ?></span></a></li>
          <?php endif; ?>
          <?php if(@$openHour->enabled && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'auth_close')): ?>
            <li><a class="dashboard_a_link" href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'open-hours'), 'estore_dashboard', true); ?>"><i class="fa fa-clock-o"></i><span><?php echo $this->translate($openHour->title); ?></span></a></li>
          <?php endif; ?>
           <?php if(@$profieFields->enabled): ?>
            <?php $countFields = Engine_Api::_()->estore()->getFieldsCount($this->store);?>
            <?php if($countFields):?>
              <li><a class="dashboard_a_link" href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'profile-field'), 'estore_dashboard', true); ?>"><i class="fa fa-file-text-o "></i><span><?php echo $this->translate($profieFields->title); ?></span></a></li>
            <?php endif;?>
          <?php endif; ?>
    ...
    <?php if(Engine_Api::_()->getDbTable('storeroles','estore')->toCheckUserStoreRole($this->viewer()->getIdentity(),$this->store->getIdentity(),'manage_payments')){ ?>
      <li class="sesbm">
        ...
        <ul class="sesbm">
          ...
          <li><a id="estore_search_member_search" href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'general-taxes'), 'estore_dashboard', true); ?>" class="estore_dashboard_nopropagate_content dashboard_a_link"><i class="fa fa-usd"></i><span><?php echo $this->translate($payment_general_taxes->title); ?></span></a></li>
          <?php endif; ?>
          ...
          <li><a id="estore_search_member_search" href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'taxes'), 'estore_dashboard', true); ?>" class="estore_dashboard_nopropagate_content dashboard_a_link"><i class="fa fa-money"></i><span><?php echo $this->translate($payment_taxes->title); ?></span></a></li>
          <?php endif; ?>
          ...
          <?php if($manage_orders->enabled): ?>
            <li><a id="estore_search_member_search" href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'manage-orders'), 'estore_dashboard', true); ?>" class="estore_dashboard_nopropagate_content dashboard_a_link"><i class="fa fa-user-circle-o"></i><span><?php echo $this->translate($manage_orders->title); ?></span></a></li>
          <?php endif; ?>
          ...
          <?php if($manage_orders->enabled): ?>
          <li><a id="estore_search_member_search" href="<?php echo $this->url(array('store_id' => $this->store->custom_url,'action'=>'sales-stats'), 'estore_dashboard', true); ?>" class="dashboard_a_link"><i class="fa fa-bar-chart"></i><span><?php echo $this->translate($manage_orders->title); ?></span></a></li>
          <?php endif; ?>
    ...
    <?php if(Engine_Api::_()->getDbTable('storeroles','estore')->toCheckUserStoreRole($this->viewer()->getIdentity(),$this->store->getIdentity(),'manage_promotions')){ ?>
      <li class="sesbm">
        ...
        <ul class="sesbm">	         
          ...
          <?php endif; ?>
          <?php if(@$contactStoreOwner->enabled && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'auth_contactgp')): ?>
          ...
          <?php if($seo->enabled && ((isset($params) && $params['store_seo']) || (!isset($params) && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'store_seo')))): ?>
            <li><a href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'seo'), 'estore_dashboard', true); ?>" class="estore_dashboard_nopropagate_content dashboard_a_link"><i class="fa fa-file-text"></i><span><?php echo $this->translate($seo->title); ?></span></a></li>
          <?php endif; ?>
          <?php if(@$overview->enabled && ((isset($params) && $params['store_overview']) || (!isset($params) && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'bs_overview')))):?>
            <li><a class="dashboard_a_link" href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'overview'), 'estore_dashboard', true); ?>"><i class="fa fa-file-text-o "></i><?php echo $this->translate($overview->title); ?></a></li>
          <?php endif; ?>  
          ...
          <?php endif; ?>
          <?php if(@$announcement->enabled && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'auth_announce')): ?>
            <li><a class="dashboard_a_link" href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'announcement'), 'estore_dashboard', true); ?>"><i class="fa fa-file-text-o"></i><span><?php echo $this->translate($announcement->title); ?></span></a></li>
          <?php endif; ?>
          <?php if(Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'store_service') && $storeservices->enabled): ?>
    ...
    <?php if(Engine_Api::_()->getDbTable('storeroles','estore')->toCheckUserStoreRole($this->viewer()->getIdentity(),$this->store->getIdentity(),'manage_apps')){ ?>
      <li class="sesbm">
        ...
        <ul class="sesbm">
          ...
          <?php } ?>
          <?php if(Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'store_service') && $storeservices->enabled && $estore_allow_service): ?>
            <li><a href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'manage-service'), 'estore_dashboard', true); ?>" class="dashboard_a_link"><i class="fa fa-cogs"></i><span><?php echo $this->translate($storeservices->title); ?></span></a>
            </li>
          <?php endif; ?>
      ...
      <li class="sesbm">  
        ...
        <ul class="sesbm">	
          ...
          <?php if(@$backgroundphoto->enabled && Engine_Api::_()->authorization()->isAllowed('stores', $levelId, 'store_bgphoto')): ?>
            <li><a class="dashboard_a_link" href="<?php echo $this->url(array('store_id' => $this->store->custom_url, 'action'=>'backgroundphoto'), 'estore_dashboard', true); ?>" ><i class="fa fa-photo"></i><span><?php echo $this->translate($backgroundphoto->title); ?></span></a></li>
          <?php endif; ?>
