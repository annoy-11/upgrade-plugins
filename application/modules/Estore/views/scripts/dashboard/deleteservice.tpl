  ...
  sesJqueryObject(document).on('submit', '#estoreservice_delete', function(e) {
    ...
    sesJqueryObject.ajax({
      ...
      success: function(response) {
        ...
        sesJqueryObject('#sessmoothbox_container').html("<div id='servicesuccess_message' class='estoreservice_success_message servicesuccess_message'><i class='far fa-check-circle'></i><span>Your service is successfully deleted entry.</span></div>");
