 ...
 * @version    $Id: like-store.tpl  2018-07-13 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'estore/ajax/like-store/store_id/' + id ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate('People who Liked this store') ?>
