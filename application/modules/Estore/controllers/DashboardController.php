...
//      }
  ...
  public function upgradeAction() {
    ...
    $this->view->upgradepackage = Engine_Api::_()->getDbTable('packages', 'estorepackage')->getPackage(array('show_upgrade' => 1, 'member_level' => $viewer->level_id, 'not_in_id' => $estore->package_id, 'price' => $price));
  }
