...
$db->query('DROP TABLE IF EXISTS `engine4_sesproduct_usergateways`;');
$db->query('CREATE TABLE IF NOT EXISTS `engine4_sesproduct_usergateways` (
...
("estore_reviewprofile", "standard", "SES - Stores Marketplace Plugin - Review Profile Options Menu");');
...
("sesproduct_review_product", "sesproduct", \'{item:$subject} has posted review on product {item:$object}:\', 1, 7, 1, 1, 1, 1),
("sesproduct_share_product", "sesproduct", \'{item:$subject} shared product {item:$object}:\', 1, 7, 1, 1, 1, 1),
("sesproduct_comment_product", "sesproduct", \'{item:$subject} commented on product {item:$owner}\', 1, 1, 1, 1, 1, 0),
("sesproduct_create_product", "sesproduct", \'{item:$subject} posted a product {item:$owner}\', 1, 1, 1, 1, 1, 0),
("sesproduct_upload_video", "sesproduct", \'{item:$subject} has posted a video in product {item:$object}:\', 1, 7, 1, 1, 1, 1);');
...
$db->query('INSERT IGNORE INTO `engine4_estore_countries` (`country_id`, `sortname`, `name`, `phonecode`) VALUES
(1, "AF", "Afghanistan", 93),
(2, "AL", "Albania", 355),
(3, "DZ", "Algeria", 213),
...
$db->query('INSERT IGNORE INTO `engine4_estore_states` (`state_id`, `name`, `country_id`) VALUES
...
// Insert content
 ...
 $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainMiddleId,
      'order' => $widgetOrder++,
      'params' => '{"category_id":"","show_criteria":["title","description","ownerPhoto","by","creationDate","category","price","location","socialSharing","contactDetail","likeButton","favouriteButton","followButton","joinButton","contactButton","like","comment","favourite","view","follow","member","statusLabel","featuredLabel","sponsoredLabel","verifiedLabel","hotLabel","rating"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","limit_data":"20","title_truncation":"50","description_truncation":"45","height":"200","width":"300","title":"Similar Stores","nomobile":"0","name":"estore.slideshow"}',
  ));
 ...
 $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainMiddleId,
      'order' => $widgetOrder++,
      'params' => '{"viewType":"list","showsubcategory":"1","showinformation":["description","caticon","subcaticon","socialshare"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","criteria":"alphabetical","title_truncation":"45","description_truncation":"45","mainblockheight":"300","mainblockwidth":"250","categoryiconheight":"122","categoryiconwidth":"122","subcaticonheight":"122","subcaticonwidth":"122","limit_data":"4","limitsubcat":"4","title":"Popular Categories","nomobile":"0","name":"estore.popular-categories"}',
  ));
...
// Insert middle
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"criteria":["photo","title","storeUrl","tab"],"limit_data":"5","height":"230","width":"260","title":"","nomobile":"0","name":"estore.profile-main-photo"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
...
// Insert left
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $topMiddleId,
      'order' => $widgetOrder++,
      'params' => '{"layout_type":"1","tab_placement":"in","show_criteria":["title","photo","by","category","socialSharing","likeButton","favouriteButton","followButton","joinButton","addButton","featuredLabel","sponsoredLabel","verifiedLabel","hotLabel","optionMenu"],"show_full_width":"yes","margin_top":"20","description_truncation":"150","cover_height":"400","main_photo_height":"120","main_photo_width":"120","socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","title":"","nomobile":"0","name":"estore.store-view"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"title":"","showTitle":"1","nomobile":"0","name":"estore.owner-photo"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"option":["featured","sponsored","verified","hot"],"title":"","nomobile":"0","name":"estore.store-labels"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'estore.you-may-also-like-stores',
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"title":"Stores You May Also Like","viewType":"listView","category_id":"","information":["title","category","member","like","comment","favourite","view","verifiedLabel"],"title_truncation":"45","socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","limit_data_list":"5","list_title_truncation":"45","list_description_truncation":"45","height_list":"50","width_list":"50","grid_data_list":"5","simplegrid_title_truncation":"45","simplegrid_description_truncation":"45","height_grid":"180","width_grid":"180","nomobile":"0","name":"estore.you-may-also-like-stores"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'estore.main-store-details',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"viewType":"list","category_id":"","criteria":"by_me","show_criteria":["title","category","member","like","comment","favourite","view","follow"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","title_truncation":"45","description_truncation":"45","height":"50","width":"50","width_pinboard":"300","limit_data":"4","title":"Recently Viewed Stores","nomobile":"0","name":"estore.recently-viewed-item"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'estore.store-liked',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainMiddleId,
      'order' => $widgetOrder++,
      'params' => '{"title":"","description":"","types":["addLocation","addCover","addProfilePhoto"],"nomobile":"0","name":"estore.profile-tips"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'core.container-tabs',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"title":"","name":"estore.like-button"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'estore.follow-button',
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"title":"","name":"estore.follow-button"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"title":"","name":"estore.favourite-button"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"advShareOptions":"","title":"","nomobile":"0","name":"estore.advance-share"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'estore.profile-info',
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"criteria":["owner","creationDate","categories","tag"],"title":"","nomobile":"0","name":"estore.profile-info"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
      'name' => 'estore.recent-people-activity',
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"criteria":["like","favourite","follow"],"height":"50","width":"50","view_more_like":"8","view_more_favourite":"8","view_more_follow":"8","title":"","nomobile":"0","name":"estore.recent-people-activity"}',
  ));
}
...
// Insert right
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"criteria":["photo","title","storeUrl"],"title":"","nomobile":"0","name":"estore.profile-main-photo"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"advShareOptions":["privateMessage","siteShare","quickShare","tellAFriend","addThis"],"title":"","nomobile":"0","name":"estore.advance-share"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"title":"Stores You May Also Like","viewType":"listView","category_id":"","information":["title","by","member","like","comment","favourite","view","follow","verifiedLabel"],"title_truncation":"45","socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","limit_data_list":"5","list_title_truncation":"45","list_description_truncation":"45","height_list":"50","width_list":"50","grid_data_list":"2","simplegrid_title_truncation":"45","simplegrid_description_truncation":"45","height_grid":"180","width_grid":"180","nomobile":"0","name":"estore.you-may-also-like-stores"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
      ...
      'parent_content_id' => $mainLeftId,
      'order' => $widgetOrder++,
      'params' => '{"viewType":"list","category_id":"","criteria":"by_me","show_criteria":["title","category","location","member","view","follow","sponsoredLabel"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","title_truncation":"45","description_truncation":"45","height":"50","width":"50","width_pinboard":"300","limit_data":"4","title":"Sponsored Stores","nomobile":"0","name":"estore.recently-viewed-item"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainMiddleId,
      'order' => $widgetOrder++,
      'params' => '{"layout_type":"2","tab_placement":"in","show_criteria":["title","by","category","socialSharing","likeButton","favouriteButton","followButton","joinButton","addButton","like","comment","favourite","view","member","featuredLabel","sponsoredLabel","verifiedLabel","hotLabel","optionMenu"],"show_full_width":"no","margin_top":"1","description_truncation":"150","cover_height":"300","main_photo_height":"400","main_photo_width":"400","socialshare_enable_plusicon":"1","socialshare_icon_limit":"1","title":"","nomobile":"0","name":"estore.store-view"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $tab_id,
      'order' => $widgetOrder++,
      'params' => '{"show_criteria":["info","date","description","overview","profilefield"],"title":"Details","nomobile":"0","name":"estore.store-info"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $tab_id,
      'order' => $widgetOrder++,
      'params' => '{"show_criteria":["storePhoto","title","likeButton","favouriteButton","joinButton"],"title":"","nomobile":"0","name":"estore.main-store-details"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
      ...
      'parent_content_id' => $tab_id,
      'order' => $widgetOrder++,
      'params' => '{"limit_data":"3","title":"Announcements","nomobile":"0","name":"estore.profile-announcements"}',
  ));
  $db->insert('engine4_core_content', array(
      'page_id' => $pageId,
      'type' => 'widget',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $mainRightId,
      'order' => $widgetOrder++,
      'params' => '{"criteria":["like","favourite","follow"],"height":"48","width":"52","view_more_like":"10","view_more_favourite":"10","view_more_follow":"10","title":"","nomobile":"0","name":"estore.recent-people-activity"}',
  ));
//   $db->insert('engine4_core_content', array(
//       'page_id' => $pageId,
//       'type' => 'widget',
...
if (!$pageId) {
 ...
 $db->insert('engine4_core_content', array(
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $topMiddleId,
      'order' => $widgetOrder++,
      'params' => '{"title_truncation":"45","description_truncation":"45","height":"150","width":"300","speed":"300","autoplay":"1","criteria":"alphabetical","show_criteria":["title","description","countStores"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","isfullwidth":"1","limit_data":"10","title":"Category Carousel","nomobile":"0","name":"estore.category-carousel"}',
  ));
  $db->insert('engine4_core_content', array(
      'type' => 'widget',
...
include_once APPLICATION_PATH . "/application/modules/Sesproduct/controllers/defaultsettings.php";
Engine_Api::_()->getApi('settings', 'core')->setSetting('sesproduct.pluginactivated', 1);
