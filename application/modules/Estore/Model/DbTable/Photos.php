 ...
 */
class Estore_Model_DbTable_Photos extends Engine_Db_Table {

    protected $_rowClass = 'Estore_Model_Photo';
	public function getPhotoSelect($params = array()) {
        ...
        if( !empty($params['album']) && $params['album'] instanceof Estore_Model_Album ) {
