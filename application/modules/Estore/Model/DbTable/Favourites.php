 ...
 */
class Estore_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Estore_Model_Favourite";
  ...
  public function getItemfav($resource_type, $itemId) {
    $tableFav = Engine_Api::_()->getDbTable('favourites', 'estore');
