 ...
 */
class Estore_Model_DbTable_Parametervalues extends Engine_Db_Table {

  protected $_rowClass = 'Estore_Model_Parametervalue';
  protected $_name = 'estore_review_parametervalues';

  public function getParameters($params = array()) {
    $pTable = Engine_Api::_()->getDbtable('parameters', 'estore');
