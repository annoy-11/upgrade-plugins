 ...
 */
class Estore_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'estore_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'estore_album';

  public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'estore_photo_view',
        'reset' => true,
        'controller' => 'photo',
        'action' => 'view',
  ...
  public function getParent() {
    return Engine_Api::_()->getItem('stores',$this->store_id);
  }
  public function getAlbum() {
    return Engine_Api::_()->getItem('estore_album', $this->album_id);
  }
  ...
  */
  public function getAlbumPhotoUrl($type = null) {
    ...
    if( !$photo_id ) {
      return 'application/modules/Estore/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
