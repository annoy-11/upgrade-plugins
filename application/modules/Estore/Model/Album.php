 ...
 */
class Estore_Model_Album extends Core_Model_Item_Collection {

  protected $_parent_type = 'stores';
  protected $_owner_type = 'stores';
  protected $_children_types = array('estore_photo');
  protected $_collectible_type = 'estore_photo';
  ...
  public function getAuthorizationItem() {
    $store = Engine_Api::_()->getItem('stores',$this->store_id);
    if(!$store)
      return false;
    else
    return $store;
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Estore/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
