    ...
    $this->addElement('MultiCheckbox', "show_criteria", array(
        ...
        'multiOptions' => array(
           'title' => 'Store Title',
            ...
            'like' => 'Likes Count (For List View and Map View)',
            'comment' => 'Comments Count (For List View and Map View)',
            'favourite' => 'Favourite Count (For List View and Map View)',
            'view' => 'Views Count (For List View and Map View)',
            'follow' => 'Follow Counts (For List View and Map View)',
            'member' => 'Members Count (For List View and Map View)',
            'featuredLabel' => 'Featured Label',
            'sponsoredLabel' => 'Sponsored Label',
            'verifiedLabel' => 'Verified Label',
            'hotLabel' => 'Hot Label',
            'newLabel' => 'New Label',
            'rating' => 'Reviews & Rating (Not Supported in Pinboard View)',
        ),
        'escape' => false,
    ));
