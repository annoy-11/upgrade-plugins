...
class Estore_Form_Dashboard_Style extends Engine_Form {
  public function init() {
    ...
    $this->addElement('Textarea', 'style', array(
        ...
        'description' => 'You can change the colors, fonts, and styles of your store by adding CSS code below. The contents of the text area below will be output between <style> tags on your event.'
    ));
