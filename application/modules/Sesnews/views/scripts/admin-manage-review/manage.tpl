 ...
 * @version    $Id: manage.tpl  2019-02-27 00:00:00 SocialEngineSolutions $
				      ...
				      <tbody>
				        ...
				        <tr>
				          ...
				          <td>
				            ...
				            |
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesnews', 'controller' => 'admin-manage-review', 'action' => 'delete-review', 'id' => $item->review_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
				          </td>
				        </tr>
				        <?php endforeach; ?>
				      </tbody>
