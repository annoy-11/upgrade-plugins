 ...
 * @version    $Id: like-item.tpl  2019-02-27 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  function viewMore() {
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesnews/index/like-item/item_id/<?php echo $this->item_id ?>/item_type/<?php echo $this->item_type; ?>',
      'data': {
        format: 'html',
