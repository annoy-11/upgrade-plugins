...
<div class="clear sesnews_order_view_top" style="margin:10px;">
...
<script type="text/javascript">
  ...
  jqueryObjectOfSes('#sesnews_create_form_tabs li a').on('click',function(){
...
function sendFileToServer(formData,status,file,isURL,i)
{
    ...
    var uploadURL =$('form-upload').action + '?ul=1'+url+'&news_id='+news_id; //Upload URL
