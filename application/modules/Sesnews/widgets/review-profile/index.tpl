...
<div class="sesnews_review_view sesnews_profile_review sesbasic_bxs sesbasic_clearfix">
  ...
  <?php if(in_array('pros', $this->stats) && $this->review->pros && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesnews.show.pros', 1)): ?>
    <div class="sesnews_review_view_cont_row"><b class="label"><?php echo $this->translate("Pros"); ?></b><?php echo $this->review->pros; ?></div>
  <?php endif; ?>
  <?php if(in_array('cons', $this->stats) && $this->review->cons && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesnews.show.cons', 1)): ?>
  ...
  <?php endif; ?>
  <?php if(in_array('description', $this->stats) && $this->review->description && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesnews.review.summary', 1)): ?>
