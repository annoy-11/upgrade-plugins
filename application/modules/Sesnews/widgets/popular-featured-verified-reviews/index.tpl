...
<ul class="sesbasic_sidebar_block sesnews_review_sidebar_block sesbasic_bxs sesbasic_clearfix"  id="widget_sesnews_<?php echo $randonnumber; ?>" style="position:relative;">
