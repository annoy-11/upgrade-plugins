	...
	function viewMore_<?php echo $randonNumber; ?> (){
		...
		en4.core.request.send(new Request.HTML({
			...
			onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
				document.getElementById('category-news-widget_<?php echo $randonNumber; ?>').innerHTML = document.getElementById('category-news-widget_<?php echo $randonNumber; ?>').innerHTML + responseHTML;
