	...
	<?php endif;?>
      ...
      <div class="sesnews_review_listing_right sesbasic_clearfix">
        ...
        <div class="sesnews_review_listing_top_info sesbasic_clearfix">
          <?php if(in_array('postedBy', $this->stats) && $reviewer): ?>
        ...
        <div class="sesnews_review_listing_desc sesbasic_clearfix">
          <?php if(in_array('pros', $this->stats) && $item->pros && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesnews.show.pros', 1)): ?>
          ...
          <?php endif; ?>
          <?php if(in_array('cons', $this->stats) && $item->cons && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesnews.show.cons', 1)): ?>
            <p class="sesnews_review_listing_body">
