 ...
 * @version    $Id: OtherModulesTabbed.php  2019-02-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesnews_Form_Admin_OtherModulesTabbed extends Engine_Form {
  ...
  public function init() {
   ...
   $categories = array('' => '') + $categories;
    ...
    $this->addElement('Select', "show_limited_data", array(
			'label' => 'Show only the number of news entered in above setting. [If you choose No, then you can choose how do you want to show more news in this widget.]',
			 'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
    ...
    $this->addElement('Text', "limit_data_grid2", array(
      'label' => 'Count for Grid Views 4 (number of news to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
      ...
      'label' => 'Count for List View 2 (number of news to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
      ...
      'label' => 'Count for List View 3 (number of news to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
      ...
      'label' => 'Count for Grid View 2 (number of news to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
      ...
      'label' => 'Count for Grid View 3 (number of news to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
