...
function showCategory(id) {  
	if($('subcategory_' + id)) {  
      ...
      $('sesnews_toggle_' + id).removeClass('cattoggel cattoggeldown');
      $('sesnews_toggle_' + id).addClass('cattoggel cattoggelright'); 
			$('subcategory_' + id).style.display = 'none';   
		} else {  
			$('sesnews_toggle_' + id).removeClass('cattoggel cattoggelright');
      $('sesnews_toggle_' + id).addClass('cattoggel cattoggeldown');
      $('subcategory_' + id).style.display = 'block';
		} 
	}    
	if($('subsubcategory_' + id)) {   
		if ($('subsubcategory_' + id).style.display == 'block') { 
			$('sesnews_subcat_toggle_' + id).removeClass('cattoggel cattoggeldown');
      $('sesnews_subcat_toggle_' + id).addClass('cattoggel cattoggelright');           
			$('subsubcategory_' + id).style.display = 'none';   
		} else {  
			$('sesnews_subcat_toggle_' + id).removeClass('cattoggel cattoggelright'); 
			$('sesnews_subcat_toggle_' + id).addClass('cattoggel cattoggeldown');  
