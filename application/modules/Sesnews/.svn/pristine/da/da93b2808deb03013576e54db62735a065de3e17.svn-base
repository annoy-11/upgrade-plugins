  ...
  public function getPhotoUrl($type = null) {
    ...
    if ($photo_id) {
      $file = Engine_Api::_()->getItemTable('storage_file')->getFile($this->photo_id, $type);
		...
		$defaultPhoto = Zend_Registry::get('StaticBaseUrl').$settings->getSetting('sesnews_news_default_photo', 'application/modules/Sesnews/externals/images/nophoto_news_thumb_profile.png');
		return $defaultPhoto;
  }
