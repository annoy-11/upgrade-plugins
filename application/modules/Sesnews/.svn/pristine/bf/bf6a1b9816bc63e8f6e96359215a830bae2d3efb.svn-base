          ...
          <?php if( $this->mine || $this->canEdit || $editItem || $deleteItem || $createItem): ?>
            <span class="sesnews_album_cover_user_options_drop_btn" id="sesnews_dropdown_btn">
              ...
              <div class="sesnews_album_option_box sesnews_album_option_box1">
                ...
                <?php } ?>
                <?php if($editItem){ ?>
                  <a href="<?php echo $this->url(array('module' => 'sesnews', 'action' => 'edit', 'album_id' => $this->album_id), 'sesnews_specific_album', true); ?>"><i class="fa fa-pencil"></i><?php echo $this->translate('Edit Settings'); ?></a>
                <?php } ?>
                <?php if($deleteItem){ ?>
