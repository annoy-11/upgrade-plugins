 ...
 * @version    $Id: _FancyUpload.tpl  2019-02-27 00:00:00 SocialEngineSolutions $
...
window.addEvent('domready', function() { // wait for the content
	...
	var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
		...
		url: en4.core.baseUrl + 'sesnews/photo/upload' + '?ul=1',
    ...
    onFileRemove: function(file) {
		  ...
		  file_id = file.photo_id;
                  request = new Request.JSON({
                   'format' : 'json',
                   'url' : en4.core.baseUrl+'sesnews/index/delete/photo_id/'+file_id,
...
<div id="demo-status" class="hide">
  ...
  <div>
    <a class="buttonlink sesnews_icon_photos_new" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Photos') ?></a>
