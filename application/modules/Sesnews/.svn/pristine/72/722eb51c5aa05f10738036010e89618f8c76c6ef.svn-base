...
<div class='sesnews_owner_contact_details sesbasic_clearfix sesbasic_bxs'>
  <ul>
    <?php if( in_array('name',$this->info) && $this->subject->news_contact_name): ?>
      <li class="sesbasic_clearfix sesnews_owner_contact_name">
        <?php echo nl2br($this->subject->news_contact_name) ?>
      </li>
    <?php endif ?>
    <?php if( in_array('email',$this->info) && $this->subject->news_contact_email): ?>
    ...
    <?php endif ?>
    <?php if( in_array('phone',$this->info) && $this->subject->news_contact_phone): ?>
    ...
    <?php endif ?>
    <?php if( in_array('facebook',$this->info) && $this->subject->news_contact_facebook): ?>
    ...
    <?php endif ?>
    <?php if( in_array('website',$this->info) && $this->subject->news_contact_website): ?>
      <li class="sesbasic_clearfix">
    ...
    <li class="sesnews_owner_contact_social" style="display: none;">
      <?php if( in_array('facebook',$this->info) && $this->subject->news_contact_facebook): ?>
        <a target="_blank" href='<?php echo parse_url($this->subject->news_contact_facebook, PHP_URL_SCHEME) === null ? 'https://' . $this->subject->news_contact_facebook : $this->subject->news_contact_facebook; ?>' title='<?php echo $this->translate("Facebook URL"); ?>'><i class="fa fa-facebook-square"></i></a>
      <?php endif ?>
      <?php if( in_array('website',$this->info) && $this->subject->news_contact_website): ?>
