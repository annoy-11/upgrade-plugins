    ...
    <div class="sesnews_pinboard_info_news sesbasic_clearfix">
      <div class="sesnews_pinboard_list_item_cont sesbasic_clearfix">
          ...
          <?php if(isset($this->creationDateActive)){ ?>
            <div class="sesnews_list_stats sesbasic_text_dirk">
              <?php if($item->publish_date): ?>
                <span><i class="fa fa-clock-o"></i> <a href="<?php echo $this->url(array('action'=>'browse'),'sesnews_general',true).'?date='.date('Y-m-d',strtotime($item->publish_date)); ?>"><b><?php echo date('M d',strtotime($item->publish_date));?></b></a></span>
              <?php else: ?>
                <span><i class="fa fa-clock-o"></i> <a href="<?php echo $this->url(array('action'=>'browse'),'sesnews_general',true).'?date='.date('Y-m-d',strtotime($item->creation_date)); ?>"><b><?php echo date('M d',strtotime($item->creation_date));?></b></a></span>
              <?php endif; ?>
            </div>
          <?php } ?>
        ...
        <?php if(isset($this->readmoreActive)):?>
              <div class="sesblock_pinboard_readmore"><a href="<?php echo $item->getHref();?>"><?php echo $this->translate('Read More');?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
            <?php endif;?>
