 ...
 * @version    $Id: Albumviewpage.php  2019-02-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesnews_Form_Admin_Albumviewpage extends Engine_Form
{
  public function init()
  {
		...
		$this->addElement('Select', "insideOutside", array(
			'label' => 'Choose where do you want to show the statistics of photos. (In Grid View Only)',
        'multiOptions' => array(
