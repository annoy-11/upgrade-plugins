...
function validateForm(){
		...
		counter = 0;
		sesJqueryObject('#sesnews_review_form input, #sesnews_review_form select,#sesnews_review_form checkbox,#sesnews_review_form textarea,#sesnews_review_form radio').each(
				function(index){
			...
			en4.core.runonce.add(function()
				{
			sesJqueryObject('#sesnews_review_form').submit(function(e){
					var validationFm = validateForm();
					if(!sesJqueryObject('#rate_value').val()){
						alert('<?php echo $this->translate("Please fill the red mark fields"); ?>');
						 var errorFirstObject = sesJqueryObject('#sesnews_review_rating').parent();
