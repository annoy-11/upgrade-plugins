 ...
 * @version    $Id: Favourites.php  2019-02-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesnews_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Sesnews_Model_Favourite";
  ...
  public function isFavourite($params = array()) {
    ...
    $viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity();
     $select = $this->select()
		...
		$tableFav = Engine_Api::_()->getDbtable('favourites', 'sesnews');
