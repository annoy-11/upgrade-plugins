...
class Sesnews_Form_CreateRss extends Engine_Form
{
  ...
  public function init()
  {
	...
	'content' => '<i class="fa fa-check" id="sesnews_custom_url_correct" style="display:none;"></i><i class="fa fa-times" id="sesnews_custom_url_wrong" style="display:none;"></i><span class="sesnews_check_availability_btn"><img src="application/modules/Core/externals/images/loading.gif" id="sesnews_custom_url_loading" alt="Loading" style="display:none;" /></span><p id="suggestion_tooltip" class="check_tooltip" style="display:none;">'.Zend_Registry::get('Zend_Translate')->translate("You can use letters, numbers and periods.").'</p>',
    ));
    }
