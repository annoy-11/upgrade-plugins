...
class Sesnews_Form_Create extends Engine_Form
{
  ...
  $translate = Zend_Registry::get('Zend_Translate');
	...
	'label' => 'Custom Url',
	'content' => '<input type="text" name="custom_url" id="custom_url" value="' . $custom_url_value . '"><i class="fa fa-check" id="sesnews_custom_url_correct" style="display:none;"></i><i class="fa fa-times" id="sesnews_custom_url_wrong" style="display:none;"></i><span class="sesnews_check_availability_btn"><img src="application/modules/Core/externals/images/loading.gif" id="sesnews_custom_url_loading" alt="Loading" style="display:none;" /><button id="check_custom_url_availability" type="button" name="check_availability" >Check Availability</button></span> <p id="suggestion_tooltip" class="check_tooltip" style="display:none;">'.$translate->translate("You can use letters, numbers and periods.").'</p>',
    ));
    ...
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('enableglocation', 1) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesnews.enable.location', 1)) {
      ...
      if (count($territories)) {
        ...
        if (isset($news)) {
          $itemlocation = Engine_Api::_()->getDbTable('locations', 'sesbasic')->getLocationData('news', $news->getIdentity());
          if ($itemlocation)
