 ...
 * @version    $Id: AdminReviewFieldsController.php  2019-02-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesnews_AdminReviewFieldsController extends Fields_Controller_AdminAbstract {
  ...
  public function indexAction() {
    ...
    $this->view->subsubNavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesnews_admin_main_reviewcat', array(), 'sesnews_admin_main_review_subfields');
  ...
  public function fieldCreateAction() {
    ...
    if ($content_type == 'sesnews_category') {
      $content_type = 'sesnews_news';
    }
