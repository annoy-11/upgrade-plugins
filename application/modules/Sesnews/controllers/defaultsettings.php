...
$db->query('ALTER TABLE `engine4_sesnews_news_fields_meta` ADD `icon` TEXT NULL DEFAULT NULL;');
$db->query('ALTER TABLE `engine4_sesnews_review_fields_meta` ADD `icon` TEXT NULL DEFAULT NULL;');
