 ...
 * @version    $Id: Menus.php  2019-01-25 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesmenu_Api_Menus extends Core_Api_Abstract
{
  private $orderByLabelMenus = array('sesmenu_admin_main_menus');
  public function getNavigation($name, $options = array(), $activeItem = null)
  {
  ...
  public function getMenuParams($name, $options = array(), $activeItem = null)
  {
    ...
    foreach( $menu as $key => $row ) {
      ...
      if(!in_array($level_id,explode(",", $row->privacy)) && $row->privacy !='') {
            continue;
      }
      // Plugin
      $page = null;
	  ...
	  if( !isset($page['design']) ) {
        $page['design_templete'] = $row->design;
      }
	   if( !isset($page['params']) ) {
        $page['params'] = $row->params;
      }
