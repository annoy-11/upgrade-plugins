...
<?php endif; ?>
<h3>Groups Verification Requests</h3>
<p>
  <?php echo $this->translate('This page lists all the group verification requests made on your website which are waiting for admin approval. From here, you can take necessary action by approving, rejecting or deleting requests. Entering criteria into the filter fields will help you find specific request. Leaving the filter fields blank will show all the request on your website awaiting your action.<br /><br />Once an action is taken, the request will be removed from this group.<br /><br />Approved groups will display in the "Manage Verified Groups" section.'); ?>
</p>
<br />
...
<div class='sesbasic_search_result'>
  ...
  <?php echo $this->translate(array("%s group verification request found.", "%s group verification requests found.", $count),
...
<div class="admin_table_form sesgroupveroth_manage_requests">
<form>
