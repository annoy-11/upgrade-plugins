...
class Sesgroupveroth_Model_DbTable_Verifications extends Engine_Db_Table {

  protected $_rowClass = 'Sesgroupveroth_Model_Verification';
  protected $_name = 'sesgroupveroth_verifications';
