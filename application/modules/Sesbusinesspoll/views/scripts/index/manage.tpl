 ...
 * @version    $Id: manage.tpl  2018-10-29 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  <?php else: // $this->polls is NOT empty ?>
    ...
    <ul class="sesbusinesspoll_poll_listing">
      <?php foreach( $this->paginator as $poll ): ?>
      <li id="Sesbusinesspoll-item-<?php echo $poll->poll_id ?>">
        <?php echo $this->htmlLink($poll->getHref(), $this->itemPhoto($this->owner, 'thumb.icon'), array('class' => 'sesbusinesspolls_browse_photo')) ?>
        
        <div class="sesbusinesspolls_browse_options">
         <a href="javascript:;" class="sesbasic_pulldown_toggle"><i class="fa fa-ellipsis-h"></i></a>
          ...
          echo $this->htmlLink(array( 'route' => 'sesbusinesspoll_specific', 'action' => 'edit', 'poll_id' =>
        ...
        <div class="sesbusinesspolls_browse_info">
          <h3 class="sesbusinesspolls_browse_info_title">
          ...
          <div class="sesbusinesspolls_browse_info_date sesbasic_text_light">
              <?php echo $this->translate('Posted by %s in <a href="#">Business</a>', $this->htmlLink($this->owner, $this->owner->getTitle())) ?>
              <?php echo $this->timestamp($poll->creation_date) ?>
           </div>
          <div class="sesbusinesspolls_counts sesbasic_text_light">
          <span> 
          ...
          <?php if( '' != ($description = $poll->getDescription()) ): ?>
            <div class="sesbusinesspolls_browse_info_desc sesbasic_text_light">
