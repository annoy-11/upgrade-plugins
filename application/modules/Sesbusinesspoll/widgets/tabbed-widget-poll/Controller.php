 ...
 */
class Sesbusinesspoll_Widget_TabbedWidgetPollController extends Engine_Content_Widget_Abstract {
  ...
  $this->view->identityForWidget = $this->view->identityObject = empty($_POST['identityObject']) ? $this->view->identity : $_POST['identityObject'];
	...
	$this->view->business_id = $businessId = isset($_POST['business_id']) ? $_POST['business_id'] : $this->_getParam('business_id',1);
  ...
  if(empty($sesbusinesspoll_widget))
   ...
   // foreach ($show_criterias as $show_criteria)
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('polls', 'sesbusinesspoll')
