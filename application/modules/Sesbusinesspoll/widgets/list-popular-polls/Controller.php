 ...
 */
class Sesbusinesspoll_Widget_ListPopularPollsController extends Engine_Content_Widget_Abstract
{
...
//    echo '<pre>';print_r($params);die;
    ...
    $this->view->height = 85;
    $this->view->width = 190;
    $this->view->show_criteria = $params['show_criteria']?$params['show_criteria']:$this->_getParam('show_criteria',array('like','in', 'comment','vote','by','favourite','title', 'favouriteButton', 'likeButton', 'socialSharing', 'view'));
    $values = array('browse' => true);
    $values['order'] = $params['popular_type'];
    $paginator = Engine_Api::_()->getDbTable('polls', 'sesbusinesspoll')->getPollsPaginator($values);
