...
<script type="application/javascript">
 var searchBusinessUrl = "<?php echo $this->url(array('module' =>'sesbusinesspoll','controller' => 'index', 'action' => 'get-business'),'default',true); ?>";
  en4.core.runonce.add(function()
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('searchbusiness', searchBusinessUrl, {
      'postVar': 'text',
      'minLength': 1,
      'selectMode': 'pick',
...
var Searchurl = "<?php echo $this->url(array('module' =>'sesbusinesspoll','controller' => 'index', 'action' => 'get-poll'),'default',true); ?>";</script>

<?php if($controllerName == 'index' && $actionName == 'browse'){ ?>
	<?php $identity = Engine_Api::_()->sesbusiness()->getIdentityWidget('sesbusinesspoll.browse-polls','widget','sesbusinesspoll_index_browse'); ?>
	  <?php if(@$identity) { ?>
      <script type="application/javascript">
      sesJqueryObject(document).ready(function(){
        ...
        sesJqueryObject('#filter_form').submit(function(e){
          e.preventDefault();
          if(sesJqueryObject('.sesbusinesspoll_poll_listing').length > 0){
            ...
            sesJqueryObject('#loadingimgsesbusinesspoll-wrapper').show();
