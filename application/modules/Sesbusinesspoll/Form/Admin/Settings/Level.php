 ...
 * @version    $Id: Level.php  2018-10-29 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesbusinesspoll_Form_Admin_Settings_Level extends Authorization_Form_Admin_Level_Abstract
{
  public function init()
  {
    ...
    if( !$this->isPublic() ) {
      ...
      $this->addElement('Radio', 'vote', array(
        ...
        'description' => 'POLL_FORM_ADMIN_LEVEL_DELETE_DESCRIPTION',
        'multiOptions' => array(
          2 => 'Yes, allow members to voting all polls.',
          1 => 'Yes, allow members to voting their own polls.',
          0 => 'No, do not allow members to voting their polls.',
        ),
        'value' => ( $this->isModerator() ? 2 : 1 ),
      ));
      if( !$this->isModerator() ) {
        unset($this->vote->options[2]);
      }
