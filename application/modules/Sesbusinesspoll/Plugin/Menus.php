 ...
 * @version    $Id: Menus.php  2018-10-29 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */ /*
class Sesbusinesspoll_Plugin_Menus
{
  public function canCreatePolls()
  {
    ...
    if( !Engine_Api::_()->authorization()->isAllowed('sesbusinesspoll_poll', $viewer, 'create') ) {
      return false;
    }
  ...
  public function canViewPolls()
  {
    ...
    if( !Engine_Api::_()->authorization()->isAllowed('sesbusinesspoll_poll', $viewer, 'view') ) {
      return false;
    }
  ...
  public function onMenuInitialize_PollGutterList($row)
  {
    ...
    } else if( $subject instanceof Sesbusinesspoll_Model_Poll ) {
  ...
  public function onMenuInitialize_PollGutterDelete($row)
  {
    ...
    $viewer = Engine_Api::_()->user()->getViewer();
    $poll = Engine_Api::_()->core()->getSubject('sesebusinesspoll_poll');
