 ...
 * @version    $Id: Polls.php  2018-10-29 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusinesspoll_Model_DbTable_Polls extends Core_Model_Item_DbTable_Abstract
{
  protected $_rowClass = 'Sesbusinesspoll_Model_Poll';
  ...
  public function getPollSelect($params = array())
  {
    ...
    $table = Engine_Api::_()->getItemTable('sesbusinesspoll_poll');
    ...
    if(isset($params['searchbusiness']) && !empty($params['searchbusiness'])){
      $select->join($businessTableName, $businessTableName . '.business_id = ' . $tableName . '.business_id',null)
        ->where($businessTableName.'.title LIKE ?','%' . $params['searchbusiness'] . '%');
    }
    if( isset($params['business_id']) && $params['business_id'] != null && $params['business_id'] >0 ) {
