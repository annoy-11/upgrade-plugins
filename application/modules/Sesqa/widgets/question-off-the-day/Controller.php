...
class Sesqa_Widget_QuestionOffTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->socialshare_enable_plusicon = $socialshare_enable_plusicon = isset($params['socialshare_enable_plusicon']) ? $params['socialshare_enable_plusicon'] :$this->_getParam('socialshare_enable_plusicon', 1);
		...
		$params = array('limit'=>$params['limit'],'category_id'=>$category_id,'locationEnable'=>$params['locationEnable'],'test'=>1);
		$params['offtheday'] = true;
    $params['fetchAll'] = 1;
    $params['limit'] = 1;
    $params['info'] = "random";
