        ...
        <div class="sesqa_viewpage_options">
            ...
            <ul class="_isicon">
              <?php if($this->can_edit){ ?>
                <li><a href="<?php echo $this->url(array('action' => 'edit','question_id' => $this->question->getIdentity()),'sesqa_dashboard'); ?>"><i class="fa fa-edit"></i><?php echo $this->translate("Dashboard"); ?></a></li>
								<?php if($this->question->open_close == 1): ?>
								<li><a href="<?php echo $this->url(array('action' => 'close','question_id' => $this->question->getIdentity()),'sesqa_general'); ?>" class="smoothbox"><i class="fa fa-lock"></i><?php echo $this->translate("Open"); ?></a></li>								
								<?php else: ?>
								<li><a href="<?php echo $this->url(array('action' => 'close','question_id' => $this->question->getIdentity()),'sesqa_general'); ?>" class="smoothbox"><i class="fa fa-lock"></i><?php echo $this->translate("Close"); ?></a></li>
								<?php endif; ?>
              <?php } ?>
              <?php if($this->can_delete){ ?>
                <li><a href="<?php echo $this->url(array('action' => 'delete','question_id' => $this->question->getIdentity()),'sesqa_general'); ?>" class="smoothbox"><i class="fa fa-trash"></i><?php echo $this->translate("SESDelete"); ?></a></li>
              <?php } ?>
            </ul>
       		</div>
       	</div>
    	...
    	<div class="sesqa_viewpage_footer">
          ...
          <div class="_stats sesbasic_text_light">
            ...
            <?php if(in_array('vote',$this->show_criteria)){ ?>
            	<span title="<?php echo $this->translate(array('%s vote', '%s votes', Engine_Api::_()->sesqa()->voteCount($this->question)), $this->locale()->toNumber(Engine_Api::_()->sesqa()->voteCount($this->question))); ?>"> <i class="far fa-hand-point-up"></i><?php echo Engine_Api::_()->sesqa()->voteCount($this->question) ?> </span>
            <?php } ?>
        ...
        <div class="_right">
          <div class="sesqa_view_question_info">
            ...
            <?php if(in_array('category',$this->show_criteria) && $this->question->category_id){ 
              ...
              if($category){
            ?>
            	<div><a href="<?php echo $category->getHref(); ?>" class="sesbasic_linkinherit" title='<?php echo $this->translate("Category"); ?>'><i class="fa fa-folder-open sesbasic_text_light"></i><span><?php echo $category->category_name; ?></span></a></div>
            <?php 
          		}
          	} ?>
...
<?php } ?>
    ...
    <?php if(empty($this->is_answer_ajax)){ ?>
      <?php if($this->question->enableAnswer){ ?>
        ...
        <div class="sesqa_view_ans_item_content">       
          <?php if($this->viewer()->getIdentity()  && $this->viewer()->getIdentity() == $answer->owner_id){ ?>
            <div class="sesqa_toggle_option">
              ...
              <div class="sesbasic_pulldown_options">
                <ul class="_isicon">
                  <li><a href="javascript:;" class="editanswersesqa" data-id="<?php echo $answer->getIdentity(); ?>"><i class="fa fa-edit"></i><?php echo $this->translate('SESEdit'); ?></a></li>
          ...
          <div class="question_description">
            ...
            <ul class="cancel_cnt edit_btns sesbasic_clearfix" style="display:none;">
              ...
              <li><a href="javascript:;" class="cancelanswersesqa" data-id="<?php echo $answer->getIdentity(); ?>"><i class="fa fa-times"></i><?php echo $this->translate('SESCancel'); ?></a></li>
            </ul>
