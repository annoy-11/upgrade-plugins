 ...
 * @version    $Id: _pagging.tpl  2018-10-15 00:00:00 SocialEngineSolutions $
...
<?php if ($this->pageCount && $this->pageCount > 1):
 ...
 ?>
<div id="ses_pagging_128738hsdkfj" class="sesqa_pagging">
...
<div class="sesbasic_paging clear sesbasic_clearfix sesbasic_bxs" id="ses_pagging">
  <ul>
    ...
    <?php if (isset($this->previous)): ?>
      <li><a href="javascript:;" onclick="<?php echo $idFunction ?>('<?php echo $this->previous; ?>')"  title="<?php echo $this->previous; ?>"> <?php echo $this->translate('SESPrevious') ?></a></li>
    <?php else: ?>
      <li class="sesbasic_paging_disabled"><span><?php echo $this->translate('SESPrevious') ?></span></li>
    <?php endif; ?>
    <?php 
    $pagingEcho = '';
    ...
    <?php if (isset($this->next)): ?>
      <li><a href="javascript:;" onclick="<?php echo $idFunction ?>('<?php echo $this->next; ?>')"  title="<?php echo $this->next; ?>"> <?php echo $this->translate('SESNext') ?> </a> </li>
      <?php else: ?>
      <li class="sesbasic_paging_disabled"><span><?php echo $this->translate('SESNext') ?></span></li>
  	<?php endif; ?>
  </ul>
</div>
</div>
