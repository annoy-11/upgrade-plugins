 ...
 * @version    $Id: _list2.tpl  2018-10-15 00:00:00 SocialEngineSolutions $
...
<?php if(!$this->is_ajax){ ?>
<div class="sesqa_list_view_container">
...
<?php } ?>
 <?php if(count($this->paginator)){ ?>
  <?php foreach($this->paginator as $question){ ?>
    <li class="sesqa_list2_item sesbasic_clearfix" style="<?php if($this->width){ ?>width:<?php echo $this->width.'px;'; ?> <?php } ?>">
      <article>
      	...
      	<div class="_top">
          <div class="sesqa_list2_item_content">
            <ul class="_info sesbasic_clearfix">
              ...
              <?php if(in_array('category',$this->showOptions) && $question->category_id){ 
                  ...
                  if($category){
                ?>
                  <li><a href="<?php echo $category->getHref(); ?>" title='<?php echo $this->translate("Category"); ?>'><i class="fa fa-folder-open-o sesbasic_text_light"></i><span><?php echo $category->category_name; ?></span></a></li>
                <?php } ?>
              <?php } ?>
            ...
            <?php if(in_array('answerCount',$this->showOptions)){ ?>
              <li class="<?php if($question->best_answer){ ?>sesqa_list_best<?php } ?>"><span class="_count"><?php echo $question->answer_count; ?></span><span class="_txt"><?php echo $question->answer_count == 1 ? $this->translate('Answer') : $this->translate('Answers'); ?></span></li>
            <?php } ?>
  ...
  <?php }else{ ?>
    <li class="sesqa_noquestion_tip_wrapper norecord<?php echo $this->widgetIdentity; ?>" id="norecord<?php echo $this->widgetIdentity; ?>">
      <div class="sesqa_noquestion_tip clearfix">
    		<img src="<?php echo Engine_Api::_()->sesqa()->getFileUrl(Engine_Api::_()->getApi('settings', 'core')->getSetting('qanda_notip_image', 'application/modules/Sesqa/externals/images/notip.png')); ?>" alt="" />
