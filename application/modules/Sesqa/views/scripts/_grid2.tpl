...
<?php } ?>
    ...
    <div class="sesqa_noquestion_tip_wrapper norecord<?php echo $this->widgetIdentity; ?>" id="norecord<?php echo $this->widgetIdentity; ?>">
      <div class="sesqa_noquestion_tip clearfix"> <img src="<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('qanda_notip_image', 'application/modules/Sesqa/externals/images/notip.png'); ?>" alt="" /> 
