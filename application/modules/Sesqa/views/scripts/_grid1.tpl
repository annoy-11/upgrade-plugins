        	...
        	<div class="sesqa_gridview_item_stats sesbasic_text_light">
          	...
          	<?php if(in_array('like',$this->showOptions)){ ?>
           	...
           	<?php if(in_array('vote',$this->showOptions)){ ?>
           		<span title="<?php echo $this->translate(array('%s vote', '%s votes', Engine_Api::_()->sesqa()->voteCount($question)), $this->locale()->toNumber(Engine_Api::_()->sesqa()->voteCount($question))); ?>"><i class="far fa-hand-point-up"></i><?php echo Engine_Api::_()->sesqa()->voteCount($question) ?></span>
           	<?php } ?>
