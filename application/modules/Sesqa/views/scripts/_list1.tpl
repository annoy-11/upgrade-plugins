            ...
            <div class="sesqa_list1_item_content">
              ...
              <ul class="_info sesbasic_clearfix">
                ...
                <?php if(in_array('category',$this->showOptions) && $question->category_id){ 
                    ...
                    if($category){
                  ?>
                  	<li><a href="<?php echo $category->getHref(); ?>" title='<?php echo $this->translate("SESCategory"); ?>'><i class="fa fa-folder-open sesbasic_text_light"></i><span><?php echo $category->category_name; ?></span></a></li>
                  <?php } ?>
                <?php } ?>
