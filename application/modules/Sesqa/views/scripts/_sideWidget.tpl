...
<ul class="sesqa_sidebar_listing sesbasic_bxs sesbasic_clearfix">
  ...
  <?php $pollOptions = count($result->getOptions()); ?>
    <li class="sesqa_sidebar_list_item">
        ...
        <?php } ?>
        <div class="sesqa_sidebar_right sesbasic_clearfix">
      ...
      <?php if(in_array('tags',$this->show_criterias)){ ?>
        ...
        <?php if(in_array('vote',$this->show_criterias)){ ?>
        	<span title="<?php echo $this->translate(array('%s vote', '%s votes',Engine_Api::_()->sesqa()->voteCount($result)), $this->locale()->toNumber(Engine_Api::_()->sesqa()->voteCount($result))); ?>"><i class="far fa-hand-point-up"></i><?php echo Engine_Api::_()->sesqa()->voteCount($result) ?></span>
        <?php } ?>
