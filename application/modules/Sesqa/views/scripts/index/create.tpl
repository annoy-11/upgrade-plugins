 ...
 * @version    $Id: create.tpl  2018-10-15 00:00:00 SocialEngineSolutions $
...
window.addEvent('domready', function() {
  ...
  if(!sesJqueryObject('#subsubcat_id').val() == 0 && sesJqueryObject('#subcat_id').val() == 0)
