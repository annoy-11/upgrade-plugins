  ...
  if($setting->getSetting('qanda.create.tags','1')){
    ...
    if(Engine_Api::_()->getApi('settings', 'core')->getSetting('qanda.enable.poll',1)){
     ...
     $allowedType = Engine_Api::_()->getApi('settings', 'core')->getSetting('qanda_create_mediaoptions',array('image','video'));
		 $option = array();
     if(in_array('video',$allowedType) && Engine_Api::_()->getApi('settings', 'core')->getSetting('core.iframely.secretIframelyKey')){
         $videoTrue = true;
         $option['2'] = 'Video';
     }
    ...
    //if(empty($question_id)) {
      ...
      if(Engine_Api::_()->getApi('settings', 'core')->getSetting('core.iframely.secretIframelyKey')  && !empty($videoTrue)) {
