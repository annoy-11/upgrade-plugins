...
<div class="sessocial_login_btns <?php if(empty($butttonSetting)):?>social_login_btns_label<?php endif;?>">
  <ul>
    <?php if(Engine_Api::_()->getDbtable('facebook', 'sessociallogin')->getApi()): ?>
      <li class="sessl_facebook"><a href="<?php echo $facebookHref; ?>"><i class="fa fa-facebook"></i><span><?php echo $this->translate('Log in with Facebook');?></span></a></li>
    <?php endif;?>
    <?php if( 'none' != $settings->getSetting('core_twitter_enable', 'none')
    && $settings->core_twitter_secret):?>
      <li class="sessl_twitter"><a href="<?php echo $twitterHref; ?>"><i class="fa fa-twitter"></i><span><?php echo $this->translate('Log in with Twitter');?></span></a></li>
    <?php endif;?>
    <?php if($linkedinApi && $likedinTable->isConnected()):?>
      <li class="sessl_linkedin"><a href="<?php echo $linkdinHref;?>"><i class="fa fa-linkedin "></i><span><?php echo $this->translate('Log in with Linkedin');?></span></a></li>
    <?php endif;?>
    <?php if($instagramTable->isConnected() && $instagram):?>
      <li class="sessl_instagram"><a href="<?php echo $instagramHref;?>"><i class="fa fa-instagram"></i><span><?php echo $this->translate('Log in with Instagram');?></span></a></li>
    <?php endif;?>
    <?php if($googleTable->isConnected()):?>
      <li class="sessl_google"><a href="<?php echo $googleHref;?>"><i class="fa fa-google-plus"></i><span><?php echo $this->translate('Log in with Google Plus');?></span></a></li>
    <?php endif;?>
    <?php if($pinterestTable->isConnected()):?>
      <li class="sessl_pinterest"><a href="<?php echo $pinterestHref;?>"><i class="fa fa-pinterest-p"></i><span><?php echo $this->translate('Log in with Pinterest');?></span></a></li>
    <?php endif;?>
