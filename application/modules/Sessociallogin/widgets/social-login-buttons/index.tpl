      ...
      <div class="sessl_buttons <?php if($this->label == 1){ echo '_islabel';}  ?> <?php if($this->design == 3){ echo '_plainlabel';}  ?> sesbasic_bxs">
        ...
        <ul class="sesbasic_clearfix">
          <?php if(Engine_Api::_()->getDbtable('facebook', 'sessociallogin')->getApi()):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_facebook"><a href="<?php echo $facebookHref; ?>"><i class="fa fa-facebook"></i><span><?php echo $this->translate($this->butontext, 'Facebook');?></span></a></li>
          <?php endif;?>
          <?php if( 'none' != $settings->getSetting('core_twitter_enable', 'none')
          && $settings->core_twitter_secret):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_twitter"><a href="<?php echo $twitterHref; ?>"><i class="fa fa-twitter"></i><span><?php echo $this->translate($this->butontext, 'Twitter');?></span></a></li>
          <?php endif;?>
          <?php if($linkedinApi && $likedinTable->isConnected()):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_linkedin"><a href="<?php echo $linkdinHref;?>"><i class="fa fa-linkedin "></i><span><?php echo $this->translate($this->butontext, 'Linkedin');?></span></a></li>
          <?php endif;?>
          <?php if($instagramTable->isConnected() && $instagram):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_instagram"><a href="<?php echo $instagramHref;?>"><i class="fa fa-instagram"></i><span><?php echo $this->translate($this->butontext, 'Instagram');?></span></a></li>
          <?php endif;?>
          <?php if($googleTable->isConnected()):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_google"><a href="<?php echo $googleHref;?>"><i class="fa fa-google-plus"></i><span><?php echo $this->translate($this->butontext, 'Google Plus');?></span></a></li>
          <?php endif;?>
          <?php if($pinterestTable->isConnected()):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_pinterest"><a href="<?php echo $pinterestHref;?>"><i class="fa fa-pinterest-p"></i><span><?php echo $this->translate($this->butontext, 'Pinterest');?></span></a></li>
          <?php endif;?>
          ...
          <?php if($flickrTable->isConnected()):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_flickr"><a href="<?php echo $flickrHref;?>"><i class="fa fa-flickr"></i><span><?php echo $this->translate($this->butontext, 'Flickr');?></span></a></li>
          <?php endif;?>
          <?php if($vkTable->isConnected()):?>
            <li <?php if($this->label == 1): ?> style="width:<?php echo $this->btnwidth ?>px;" <?php endif; ?> class="sessl_vk"><a href="<?php echo $vkHref;?>"><i class="fa fa-vk"></i><span><?php echo $this->translate($this->butontext, 'Vkontakte');?></span></a></li>
          <?php endif;?>
        </ul>
      </div>
    </div>  
...
<script>
	sesJqueryObject(document).ready(function(){
		var elem = sesJqueryObject('.layout_core_content').find('form').find('.form-elements');
    elem.find('#facebook-wrapper').hide();
    elem.find('#twitter-wrapper').hide();
		var html = sesJqueryObject('#sessl_buttons_wrapper').html();
		elem.append(html);
  })
</script>
<?php } else{ ?>
...
<script>
	sesJqueryObject(document).ready(function(){
		var elem = sesJqueryObject('.layout_core_content');
		var html = sesJqueryObject('#sessl_buttons_wrapper').html();
		elem.prepend(html);
  })
	sesJqueryObject(document).ready(function(){
    ...
    elem.find('#twitter-wrapper').hide();
		<?php if($this->position == 1){ ?>
			sesJqueryObject('.layout_core_content').addClass('sessl_buttons_right_wrapper fromleft');
		<?php } elseif($this->position == 2){ ?>
			sesJqueryObject('.layout_core_content').addClass('sessl_buttons_right_wrapper fromright');
		<?php } ?>
	})
</script>
<?php } ?>
      ...
      <ul class="sesbasic_clearfix">
        <?php if(Engine_Api::_()->getDbtable('facebook', 'sessociallogin')->getApi()):?>
          <li class="sessl_facebook" title="<?php echo $this->translate('Facebook');?>">
            <a href="<?php echo $facebookHref; ?>"><i class="fa fa-facebook"></i></a>
...
<script>
    ...
    elem.find('#twitter-wrapper').hide();
		...
		<?php if($this->position == 1){ ?>
			sesJqueryObject('.layout_core_content').addClass('sessl_buttons_box_wrapper fromleft');
		<?php } elseif($this->position == 2){ ?>
			sesJqueryObject('.layout_core_content').addClass('sessl_buttons_box_wrapper fromright');
		<?php } elseif($this->position == 3){ ?>
			sesJqueryObject('.layout_core_content').addClass('sessl_buttons_box_wrapper frombottom');
		<?php } ?>
	})
</script>
<?php }?>
