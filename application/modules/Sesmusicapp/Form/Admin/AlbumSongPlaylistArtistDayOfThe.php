 ...
 * @version    $Id: AlbumSongPlaylistArtistDayOfThe.php  2018-12-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesmusicapp_Form_Admin_AlbumSongPlaylistArtistDayOfThe extends Engine_Form {
  ...
  public function init() {
    ...
    // color 
		if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesmusicapp')){
			$this->addElement( 'Text','color',array(
				'label' => 'Enter the color code which you want to show as backgroud color of this widget in music app.',
				'value' => '#E74C3C'
			));
		}
		if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesmusicapp')){
			$this->addElement( 'Text','title_color',array(
				'label' => 'Enter the color code which you want to show as tiltle color of this widget in music app.',
				'value' => '#E74C3C'
			));
		}
