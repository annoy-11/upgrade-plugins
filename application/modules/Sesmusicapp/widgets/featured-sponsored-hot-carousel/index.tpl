  ...
  #slide_<?php echo $randonNumber; ?> {
    ...
    overflow: hidden;
	 ...
	 @media(max-width:767px){
      #slide_<?php echo $randonNumber; ?> {
    height:<?php echo $this->height + 1 ?>px;
  }
  }
</style>

<div class="slide sesmusic_carousel_wrapper sesbasic_clearfix sesbasic_bxs <?php if($this->viewType == 'horizontal'): ?> sesmusic_carousel_h_wrapper <?php else: ?> sesmusic_carousel_v_wrapper <?php endif; ?>">
          ...
          <div class="sesmusic_item_artwork_over_content sesmusic_animation">
            ...
            <div class="sesmusic_item_stats_info sesmusic_animation">
              <div class="sesmusic_item_info_stats">
                ...
                <?php endif; ?>
                <?php if ($this->contentType == 'albums' && !empty($this->information) && in_array('songsCount', $this->information)) : ?>
                  <span>
  ...
  <?php else: ?>
    <div class="tabs_<?php echo $randonNumber; ?> sesmusic_carousel_nav">
      <a class="sesmusic_carousel_nav_pre" href="#page-p"><i class="fa fa-angle-up"></i></a>
      <a class="sesmusic_carousel_nav_nxt" href="#page-p"><i class="fa fa-angle-down"></i></a>
    </div>  
  <?php endif; ?>
