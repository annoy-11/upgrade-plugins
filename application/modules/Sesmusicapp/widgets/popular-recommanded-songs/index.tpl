...
<ul class="sesmusic_browse_listing clear sesbasic_bxs">
  ...
  <li class="sesmusicapp_sidebar_list">
  <div class="sesmusicapp_sidebar_list_photo_block">
    ...
    <?php echo $this->htmlLink($item->getHref(), $this->itemPhoto($item, 'thumb.icon'), array('class' => 'sesmusic_sidebar_list_thumb')) ?>
    <?php endif; ?>
    <div class="sesmusicapp_sidebar_list_play_btn">
        ...
        <a class="sesmusicapp_sidebar_list_playbutton" href="javascript:void(0);" onclick="play_music('<?php echo $item->albumsong_id ?>', '<?php echo $URL; ?>', '<?php echo $songTitle; ?>', '', '<?php echo $path; ?>');"><i class="fa fa-play-circle"></i></a>
        <?php else: ?>
        <a class="sesmusicapp_sidebar_list_playbutton "  href="javascript:void(0);" onclick="play_music('<?php echo $item->albumsong_id ?>', '<?php echo $item->getFilePath(); ?>', '<?php echo $songTitle; ?>', '', '<?php echo $path; ?>');"><i class="fa fa-play-circle"></i></a>
        <?php endif; ?>
        <?php else: ?>
          <?php if($item->store_link): ?>
            ...
            <a class="sesmusicapp_sidebar_list_playbutton"  href="javascript:void(0);" onclick="play_music('<?php echo $item->albumsong_id ?>', '<?php echo $item->getFilePath(); ?>', '<?php echo $songTitle; ?>', '<?php echo $storeLink ?>', '<?php echo $path; ?>');"><i class="fa fa-play-circle"></i></a>
          <?php else: ?>
            <a class="sesmusicapp_sidebar_list_playbutton "  href="javascript:void(0);" onclick="play_music('<?php echo $item->albumsong_id ?>', '<?php echo $item->getFilePath(); ?>', '<?php echo $songTitle; ?>', '', '<?php echo $path; ?>');"><i class="fa fa-play-circle"></i></a>
          <?php endif; ?>
        <?php endif; ?>
    ...
    <div class="sesmusicapp_sidebar_list_info">
      <div class="sesmusicapp_sidebar_list_title sesmusic_sidebar_list_song_title">
      ...
      <div class="sesmusicapp_sidebar_list_stats sesbasic_text_light">
      ...
      <div class="sesmusicapp_sidebar_list_stats sesbasic_text_light" title="<?php echo $this->translate(array('%s rating', '%s ratings', $item->rating), $this->locale()->toNumber($item->rating)); ?>">
      ...
      <?php endif; ?>      
      <div class="sesmusicapp_sidebar_list_stats sesmusic_list_stats sesbasic_text_light">
