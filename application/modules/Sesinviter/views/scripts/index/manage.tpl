...
<script type="text/javascript">
  ...
  <form id="multidelete_form" action="<?php echo $this->url();?>" onSubmit="return multiDelete()" method="POST"  class="sesinviter_manage_ref_form">
    <table class='table'>
      <thead>
        <tr>
          ...
          <th align="center"><?php echo $this->translate('Recipent Email') ?></th>
