...
class Sesinviter_Widget_InviteFriendsController extends Engine_Content_Widget_Abstract {

  public function indexAction() {
    $viewer = $this->view->viewer();
    $viewerId = $viewer->getIdentity();
    $enableSignupReferral = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesinviter.affiliateforsingup', 1);
