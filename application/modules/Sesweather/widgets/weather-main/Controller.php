 ...
 */
class Sesweather_Widget_WeatherMainController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'weather-main';
    ...
    if (!$this->_getParam('weatherlat', false)) {
      ...
      $location = $this->_getParam('weatherlocation', false);
    }
