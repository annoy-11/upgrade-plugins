...
<?php if(!$this->is_ajax){ ?>
  <div class="edocument_small_tabs_container sesbasic_clearfix sesbasic_bxs sesbasic_sidebar_block">
    <div class="edocument_small_tabs sesbasic_clearfix" <?php if(count($this->defaultOptions) ==1){ ?> style="display:none" <?php } ?>> 
    	<ul id="tab-widget-edocument-<?php echo $randonNumber; ?>" class="sesbasic_clearfix">
        <?php 
...
<?php include APPLICATION_PATH . '/application/modules/Edocument/views/scripts/_sidebartabbedlist.tpl'; ?>
