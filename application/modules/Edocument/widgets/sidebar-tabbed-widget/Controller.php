...
class Edocument_Widget_sidebarTabbedWidgetController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $paginator->setItemCountPerPage($this->view->{'limit_data_'.$view_type});
