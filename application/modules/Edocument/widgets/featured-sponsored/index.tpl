...
<?php if($this->view_type == 'list'): ?>
  <ul id="widget_edocument_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block sesbasic_sidebar_block edocument_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php else: ?>
  <ul id="widget_edocument_<?php echo $randonnumber; ?>" class="edocument_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php endif; ?>

  <div class="sesbasic_loading_cont_overlay" id="edocument_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php if ($this->paginator->getTotalItemCount() > 0) { ?>
    <?php include APPLICATION_PATH . '/application/modules/Edocument/views/scripts/_sidebarWidgetData.tpl'; ?>
  <?php } ?>
