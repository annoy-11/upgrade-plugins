 ...
 */
class Edocument_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('edocuments', 'edocument')->getEdocumentsPaginator($value);
