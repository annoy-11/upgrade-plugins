...
<ul id="widget_edocument_<?php echo $randonnumber; ?>" class="edocument_related_documents sesbasic_clearfix sesbasic_bxs">
  <div class="sesbasic_loading_cont_overlay" id="edocument_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php foreach($this->paginator as $item):?>
		<li class="edocument_grid_inside sesbasic_clearfix" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
		  <div class="edocument_grid_inside_inner">
				<div class="edocument_grid_inside_thumb edocument_thumb" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height?>;">
					<a href="<?php echo $item->getHref();?>" class="edocument_thumb_img" >
...
<?php if(isset($this->widgetName)){ ?>
  <script type="application/javascript">
		var anchor_<?php echo $randonnumber ?> = sesJqueryObject('#widget_edocument_<?php echo $randonnumber; ?>').parent();
		...
		function widget_previous_<?php echo $randonnumber; ?>(){
			sesJqueryObject('#edocument_widget_overlay_<?php echo $randonnumber; ?>').show();
			new Request.HTML({
				url : en4.core.baseUrl + 'widget/index/mod/edocument/name/<?php echo $this->widgetName; ?>/content_id/' + <?php echo sprintf('%d', $this->identity) ?>,
				data : {
					format : 'html',
					is_ajax: 1,
				...
				onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
					...
					sesJqueryObject('#edocument_widget_overlay_<?php echo $randonnumber; ?>').hide();
					showHideBtn<?php echo $randonnumber ?> ();
				}
			}).send()
		};
