 ...
 */
class Edocument_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->edocument_id = Engine_Api::_()->getDbTable('edocuments', 'edocument')->getOfTheDayResults();
    if (empty($this->view->edocument_id))
