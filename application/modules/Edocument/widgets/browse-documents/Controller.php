 ...
 */
class Edocument_Widget_BrowseDocumentsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $form = new Edocument_Form_Search(array('searchTitle' => 'yes','browseBy' => 'yes','categoriesSearch' => 'yes','searchFor'=>'document','FriendsSearch'=>'yes','defaultSearchtype'=>'mostSPliked', 'hasPhoto' => 'yes'));
    ...
    $value['status'] = 1;
    $value['search'] = 1;
    $this->view->widgetName = 'browse-documents';
    $params = array_merge($params, $value,array('search'=>addslashes($text)));
    $value['draft'] = "0";
    $value['visible'] = "1";
    // Get documents
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('edocuments', 'edocument')->getEdocumentsPaginator($params, $form->getValues());
