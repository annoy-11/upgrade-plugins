 ...
 */
class Edocument_Widget_tabbedWidgetDocumentController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('edocuments', 'edocument')->getEdocumentsPaginator($params);
