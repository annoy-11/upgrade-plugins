...
class Edocument_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if(!Engine_Api::_()->getApi('settings', 'core')->getSetting('edocument.enable.favourite', 1))
    ...
    $searchForm->setMethod('get')->populate(Zend_Controller_Front::getInstance()->getRequest()->getParams());
  }
}
