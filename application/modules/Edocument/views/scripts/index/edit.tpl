...
<div class="headline">
  <h2>
    <?php echo $this->translate('Edocuments');?>
  </h2>
  <div class="tabs">
...
<div class="edocument_form"> <?php echo $this->form->render(); ?></div>
...
<script type="text/javascript">
  ...
  <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('edocument_enable_location', 1)){ ?>
    sesJqueryObject(document).ready(function(){
      ...
      initializeSesDocumentMap();
    });
    sesJqueryObject( window ).load(function() {
      editMarkerOnMapDocumentEdit();
    });
  <?php } ?>
</script>
