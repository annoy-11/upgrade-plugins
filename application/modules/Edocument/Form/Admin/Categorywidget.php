...
class Edocument_Form_Admin_Categorywidget extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($banner_options) > 1) {
      $this->addElement('Select', 'edocument_categorycover_photo', array(
          'label' => 'Document Category Default Cover Photo',
          'description' => 'Choose a default cover photo for the document categories on your website. [Note: You can add a new photo from the "File & Media Manager" section from here: File & Media Manager. Leave the field blank if you do not want to change document category default cover photo.]',
