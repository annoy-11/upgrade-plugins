 ...
 * @version    $Id: install.php  2018-11-05 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Edocument_Installer extends Engine_Package_Installer_Module {

//   public function onPreinstall() {
//
//     $db = $this->getDb();
//     $plugin_currentversion = '4.10.3p16';
//
...
//   }
  ...
  public function onInstall() {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Documents Sharing - Documents Home Page',
        'title' => 'Document Home',
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Documents Sharing - Browse Documents Page',
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Documents Sharing - Browse Categories Page',
    ...
    if( !$page_id ) {
        ...
        $db->insert('engine4_core_pages', array(
            ...
            'displayname' => 'SES - Documents Sharing - Manage Documents Page',
            'title' => 'My Documents',
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Documents Sharing - Document Create Page',
    ...
    if (!$page_id) {
        ...
        $db->insert('engine4_core_pages', array(
            ...
            'displayname' => 'SES - Documents Sharing - Browse Tags Page',
            'title' => 'Document Browse Tags',
    ...
    if( !$page_id ) {
        ...
        $db->insert('engine4_core_pages', array(
            ...
            'displayname' => 'SES - Documents Sharing - Document Profile Page',
            'title' => 'Document View',
            'description' => 'This page displays a document view.',
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Documents Sharing - Document Category View Page',
        'title' => 'Document Category View',
        'description' => 'This page lists document category view.',
        'custom' => 0,
    ));
    $page_id = $db->lastInsertId();
