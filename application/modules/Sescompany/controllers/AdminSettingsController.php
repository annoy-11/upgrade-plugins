...
class Sescompany_AdminSettingsController extends Core_Controller_Action_Admin {
  ...
  public function landingPageSettingAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sescompany_admin_main_landingpag', array(), 'sescompany_admin_main_landingpagesetting');
  ...
  public function contentsAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sescompany_admin_main_landingpag', array(), 'sescompany_admin_main_managecontents');
