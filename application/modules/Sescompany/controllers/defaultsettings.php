...
$db->query('INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES ("sescompany_admin_main_minimenu", "sescompany", "Mini Menu", "", \'{"route":"admin_default","module":"sescompany","controller":"menu"}\', "sescompany_admin_main", "", 3);');
...
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "Blogs", "", \'{\"uri\":\"#\",\"icon\":\"\",\"target\":\"\",\"enabled\":\"1\"}\', "sescompany_extra_menu", "", 1, 1, 999),
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "IOS App Link", "", \'{\"uri\":\"#\",\"icon\":\"\",\"target\":\"\",\"enabled\":\"1\"}\', "sescompany_extra_menu", "", 1, 1, 999),
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "Android App Link", "", \'{\"uri\":\"#\",\"icon\":\"\",\"target\":\"\",\"enabled\":\"1\"}\', "sescompany_extra_menu", "", 1, 1, 999),
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "Project", "", \'{\"uri\":\"pages\\/company-project\",\"icon\":\"\",\"target\":\"\",\"enabled\":\"1\"}\', "core_main", "", 1, 1, 2),
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "About Us", "", \'{\"uri\":\"pages\\/company-about\",\"icon\":\"\",\"target\":\"\",\"enabled\":\"1\"}\', "core_main", "", 1, 1, 3),
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "What We Do", "", \'{\"uri\":\"pages\\/company-whatwedo\",\"icon\":\"\",\"target\":\"\",\"enabled\":\"1\"}\', "core_main", "", 1, 1, 4),
("'.$menuId++.'", "custom_'.$menuId++.'", "core", "Cases", "", \'{\"uri\":\"pages\\/company-cases\"}\', "core_main", "", 1, 1, 5);');
