...
class Sescompany_AdminManageTestimonialsController extends Core_Controller_Action_Admin {
  ...
  public function indexAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sescompany_admin_main_landingpag', array(), 'sescompany_admin_main_landingpagetestimonials');
