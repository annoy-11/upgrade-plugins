...
<?php if($this->chooselandingdesign == 1) { ?>
  ...
  <div class="lp_section_box_main">
    <?php include APPLICATION_PATH .  '/application/modules/Sescompany/views/scripts/landing-page/_slider1.tpl'; ?>
  ...
  <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sescompany.rightsidenavigation', 1)) { ?>
    <div id="lp_nav" class="lp_nav_box_main sesbasic_clearfix">
      <ul>
        ...
        <?php if($la1aboutshow && $this->abouts->getTotalItemCount() > 0) { ?>
          <li><a href="#lp_about_us"><i class="fa fa-info-circle"></i></a>
        ...
        <?php } ?>
        <?php if($la1countershow && $this->counters->getTotalItemCount() > 0) { ?>
          <li><a href="#lp_statics"><i class="fa fa-bar-chart"></i></a>
  ...
  <script src="application/modules/Sescompany/externals/scripts/waypoints.min.js" type="text/javascript"></script> 
