...
class Sestutorial_Form_Askquestion extends Engine_Form {

  public function init() {
  
    $this->setTitle('Request for a Tutorial');
    ...
    $this->setAttrib('class', 'global_form')->setAttrib('id', 'sestutorial_ask_question');
