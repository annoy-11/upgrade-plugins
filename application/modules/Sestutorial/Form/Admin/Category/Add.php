 ...
 * @version    $Id: Add.php  2017-10-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */


class Sestutorial_Form_Admin_Category_Add extends Engine_Form {
...
//         'label' => 'Color',
//         'description' => 'This will be category color & will appear in Grid View of tutorials.',
// 				'class'=>'SEScolor',
//         'allowEmpty' => true,
//         'required' => false,
//     ));
...
//     }
    /* $parentArray[''] = 'None';
      $categorys = Engine_Api::_()->getDbtable('categories', 'sestutorial')->getCategory(array('column_name' => '*','profile_type'=>true));
      ...
      $subcategory = Engine_Api::_()->getDbtable('categories', 'sestutorial')->getModuleSubcategory(array('column_name' => "*", 'category_id' => $categoryData->category_id));          foreach ($subcategory as $sub_category){
...
// 					'description' => 'Map this category with the profile type, so that questions belonging to the mapped profile type will appear to users while creating / editing their tutorials when they choose the associated Category.',
// 					'allowEmpty' => true,
// 					'required' => false,
