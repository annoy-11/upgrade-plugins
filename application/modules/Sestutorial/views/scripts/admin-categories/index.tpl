...
<div class='sestutorial-form sestutorial-categories-form'>
  <div>
    ...
    <div class="sestutorial-form-cont">
      ...
      <div class="sestutorial-categories-add-form">
        ...
        <form id="addcategory" method="post" enctype="multipart/form-data">
          ...
          <div class="sestutorial-form-field">
            <div class="sestutorial-form-field-label">
...
<!--          <div class="sestutorial-form-field">
            ...
            <div class="sestutorial-form-field-element">
              ...
              <p>This will be category color & will appear in Grid View of tutorials.</p>
            </div>
          </div>-->
          <div class="sestutorial-form-field">
            <div class="sestutorial-form-field-label">
            ...
            <div class="sestutorial-form-field-element">
              <select name="parent" id="parent" class="postform">
               ...
               <?php foreach ($this->categories as $category): ?>
                ...
                <?php 
                  $subcategory = Engine_Api::_()->getDbtable('categories', 'sestutorial')->getModuleSubcategory(array('column_name' => "*", 'category_id' => $category->category_id));          foreach ($subcategory as $sub_category):  
                ?>
          ...
          <div class="submit sestutorial-form-field">
            <button type="button" id="submitaddcategory" class="upload_image_button button">Add New Category</button>
          </div>
        </form>
        <div class="sestutorial-categories-add-form-overlay" id="add-category-overlay" style="display:none"></div>
      </div>
      <div class="sestutorial-categories-listing">
          ...
          <table class='admin_table' style="width: 100%;">
            ...
            <tbody>
                ...
                <td>
                  <?php if($category->cat_icon): ?>
                    ...
                    if($icon) { 
                      ...
                      <img class="sestutorial-category-icon" src="<?php echo $icon; ?>" />
                    <?php } else { ?>
                      <?php echo "---"; ?>
                    <?php } ?>
                  <?php else: ?>
              ...
              <tr id="categoryid-<?php echo $sub_category->category_id; ?>" data-article-id="<?php echo $sub_category->category_id; ?>">
                ...
                <td>
                  <?php if($sub_category->cat_icon): ?>
                    ...
                    ?>
                      <img class="sestutorial-category-icon" src="<?php echo $catURL; ?>" />
                    <?php } else { ?>
                      <?php echo "---"; ?>
                    <?php } ?>
                  <?php else: ?>
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sestutorial', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $sub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$sub_category->category_id)) ?> 		</td>
              </tr>
              <?php 
                		//SubSubcategory Work
                    $subsubcategory = Engine_Api::_()->getDbtable('categories', 'sestutorial')->getModuleSubsubcategory(array('column_name' => "*", 'category_id' => $sub_category->category_id));
              ...
              <tr id="categoryid-<?php echo $subsub_category->category_id; ?>" data-article-id="<?php echo $subsub_category->category_id; ?>">
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sestutorial', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $subsub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subsub_category->category_id)) ?>
              </tr>
              <?php endforeach; ?>
              <?php endforeach; ?>
              <?php endforeach; ?>
...
ajaxurl = en4.core.baseUrl+"admin/sestutorial/categories/change-order";
