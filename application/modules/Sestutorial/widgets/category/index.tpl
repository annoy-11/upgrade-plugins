...
function showCategory(id) {
  if($('subcategory_' + id)) {
    if ($('subcategory_' + id).style.display == 'block') {
      $('sestutorial_toggle_' + id).removeClass('cattoggel cattoggeldown');
      $('sestutorial_toggle_' + id).addClass('cattoggel cattoggelright');
      $('subcategory_' + id).style.display = 'none';
    } else {
      $('sestutorial_toggle_' + id).removeClass('cattoggel cattoggelright');
      $('sestutorial_toggle_' + id).addClass('cattoggel cattoggeldown');
  ...
  if($('subsubcategory_' + id)) {
    if ($('subsubcategory_' + id).style.display == 'block') {
      $('sestutorial_subcat_toggle_' + id).removeClass('cattoggel cattoggeldown');
      $('sestutorial_subcat_toggle_' + id).addClass('cattoggel cattoggelright');      
      $('subsubcategory_' + id).style.display = 'none';
    } else {
      $('sestutorial_subcat_toggle_' + id).removeClass('cattoggel cattoggelright');
      $('sestutorial_subcat_toggle_' + id).addClass('cattoggel cattoggeldown');
