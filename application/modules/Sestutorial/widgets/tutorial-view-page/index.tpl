      ...
      <?php if($this->showinformation): ?>
        <div class="sestutorial_tutorial_view_stats sestutorial_text_light">
          ...
          <?php if(in_array('commentcount', $this->showinformation)): ?>
            <p><i class="fa fa-comment-o"></i><span><?php echo $this->translate(array('%s comment', '%s comments', $this->tutorial->comment_count), $this->locale()->toNumber($this->tutorial->comment_count)); ?></span></p>
          <?php endif; ?>
          <?php if(in_array('likecount', $this->showinformation)): ?>
            <p><i class="fa fa-thumbs-o-up"></i><span><?php echo $this->translate(array('%s like', '%s likes', $this->tutorial->like_count), $this->locale()->toNumber($this->tutorial->like_count)); ?></span></p>
          <?php endif; ?>
          <?php if(in_array('ratingcount', $this->showinformation)): ?>
            <p><i class="fa fa-star-o"></i><span><?php echo $this->translate(array('%s rating', '%s ratings', $this->tutorial->rating), $this->locale()->toNumber($this->tutorial->rating)); ?></span></p>
          <?php endif; ?>
          
          <?php if(in_array('category', $this->showinformation) && $this->tutorial->category_id) :?>
          ...
          <?php endif; ?>
          <?php if (in_array('tags', $this->showinformation) && count($this->tutorialTags )):?>
    ...
    <?php if(in_array('socialshare', $this->showinformation) || in_array('siteshare', $this->showinformation)): ?>
      ...
      <div class="sestutorial_tutorial_view_social">
        <?php if(in_array('socialshare', $this->showinformation)): ?>
          ...
          <?php } else { ?>
            <a href="<?php echo $facebookUrl; ?>" class="sestutorial_animation" onclick="return socialSharingPopUp(this.href,'Facebook');" title="<?php echo $this->translate('Facebook'); ?>"><i class='fa fa-facebook sestutorial_text_light'></i></a>
            <a href="<?php echo $twitterUrl; ?>" class="sestutorial_animation" onclick="return socialSharingPopUp(this.href,'Twitter');" title="<?php echo $this->translate('Twitter'); ?>"><i class='fa fa-twitter sestutorial_text_light'></i></a>
            <a href="<?php echo $pinterestUrl; ?>" class="sestutorial_animation" onclick="return socialSharingPopUp(this.href,'Pinterest');" title="<?php echo $this->translate('Pinterest'); ?>"><i class='fa fa-pinterest sestutorial_text_light'></i></a>
          <?php } ?>
      <?php endif; ?>
      <?php if($this->viewer()->getIdentity()) { ?>
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sestutorial.allowshare', 1) && in_array('siteshare', $this->showinformation)): ?>
          <?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesadvancedactivity')) { ?>
            <?php $module = 'sesadvancedactivity'; ?>
          <?php } else { ?>
            <?php $module = 'activity'; ?>
          <?php } ?>
          <a href="<?php echo $this->url(array('module' => $module, 'controller'=>'index', 'action'=>'share', 'route'=>'default', 'type'=>'sestutorial_tutorial', 'id' => $this->tutorial->getIdentity(), 'format' => 'smoothbox'), 'default', true); ?>" class="smoothbox sestutorial_animation" title="<?php echo $this->translate('Share'); ?>"><i class="fa fa-share sestutorial_text_light"></i></a>
        <?php endif; ?>
        ...
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sestutorial.allowreport', 1) && $this->viewer()->getIdentity() != $this->tutorial->user_id && in_array('report', $this->showinformation)): ?>
        ...
        <div id="helpful_tutorial">
          ...
          <div class="sestutorial_view_helpful_section_btns">
            <?php if(empty($checkHelpful)) { ?>
              <p class="sestutorial_helpfull_yes"><a href="javascript:void(0);" onclick="markasHelpful('1', '<?php echo $this->tutorial->tutorial_id; ?>')" class="sestutorial_animation"><i class="fa fa-thumbs-o-up"></i> <?php echo $this->translate("%s Yes", $helpfulCountforYes); ?></a></p>
              <p class="sestutorial_helpfull_no"><a href="javascript:void(0);" onclick="markasHelpful('2', '<?php echo $this->tutorial->tutorial_id; ?>')" class="sestutorial_animation"><i class="fa fa-thumbs-o-down"></i> <?php echo $this->translate("%s No", $helpfulCountforNo); ?></a></p>
            <?php } elseif($checkHelpful && $getHelpfulvalue == 1) { ?>
              <p class="disabled sestutorial_helpfull_yes"><a href="javascript:void(0);" class="sestutorial_animation"><i class="fa fa-thumbs-o-up"></i> <?php echo $this->translate("%s Yes", $helpfulCountforYes); ?></a></p>
              <p class="sestutorial_helpfull_no"><a href="javascript:void(0);" onclick="markasHelpful('2', '<?php echo $this->tutorial->tutorial_id; ?>')" class="sestutorial_animation"><i class="fa fa-thumbs-o-down"></i> <?php echo $this->translate("%s No", $helpfulCountforNo); ?></a></p>
            <?php } elseif($checkHelpful && $getHelpfulvalue == 2) { ?>
              <p class="sestutorial_helpfull_yes"><a href="javascript:void(0);" onclick="markasHelpful('1', '<?php echo $this->tutorial->tutorial_id; ?>')" class="sestutorial_animation"><i class="fa fa-thumbs-o-up"></i> <?php echo $this->translate("%s Yes", $helpfulCountforYes); ?></a></p>
              <p class="disabled sestutorial_helpfull_no"><a href="javascript:void(0);" class="sestutorial_animation"><i class="fa fa-thumbs-o-down"></i> <?php echo $this->translate("%s No", $helpfulCountforNo); ?></a></p>
            <?php } ?>
          </div>
...
function markasHelpful(helpfultutorial, tutorial_id) {
  ...
  if($('helpful_tutorial'))
    $('helpful_tutorial').style.disply = 'none';
  (new Request.HTML({
    method: 'post',              
