...
<div class="admin_theme_editor_wrapper">
  <form action="<?php echo $this->url(array('action' => 'save')) ?>" method="post">
    <div class="admin_theme_edit">
      <?php if( $this->writeable['sestwitterclone'] ): ?>
        <div class="admin_theme_editor_edit_wrapper">
          ...
          <?php echo $this->formHidden('file', 'sestwitterclone-custom.css', array()) ?>
          <?php echo $this->formHidden('theme_id', 'sestwitterclone', array()) ?>
        </div>
      <?php else: ?>
        <div class="admin_theme_editor_edit_wrapper">
          <div class="tip">
