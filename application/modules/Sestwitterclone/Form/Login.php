 ...
 * @version    $Id: Login.php 2019-06-15 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sestwitterclone_Form_Login extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    // Used to redirect users to the correct page after login with Twitter
    ...
    $this->setAttrib('id', 'sestwitterclone_form_login');
