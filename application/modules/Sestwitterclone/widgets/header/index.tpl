 ...
 */
 ...
 ?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sestwitterclone/externals/styles/component.css'); ?>

<?php if($this->viewer->getIdentity() == 0) : ?>
  <script type="text/javascript" src="<?php echo $baseUrl; ?>application/modules/Sestwitterclone/externals/scripts/jquery-latest.min.js"></script>
  <script>var ses = $.noConflict();</script>
  <script src="<?php echo $baseUrl; ?>application/modules/Sestwitterclone/externals/scripts/jquery.magnific-popup.js"></script>
  <link href="<?php echo $baseUrl; ?>application/modules/Sestwitterclone/externals/styles/magnific-popup.css" rel="stylesheet" />
<?php endif;?>

<?php $enablePopUp = Engine_Api::_()->getApi('settings', 'core')->getSetting('sestwitterclone.popupsign', 1);  ?>
<?php $showPopup = Engine_Api::_()->getApi('settings', 'core')->getSetting('sestwitterclone.popup.enable', 1);?>
...
<?php if($this->viewer->getIdentity() == 0): ?>
    <?php if(!empty($showSeparator)) { ?>
  	<div id="small-dialog" class="zoom-anim-dialog mfp-hide sestwitterclone_quick_popup sestwitterclone_quick_login_popup sesbasic_bxs">
    <?php } else { ?>
      <div id="small-dialog" class="zoom-anim-dialog mfp-hide sestwitterclone_quick_popup sestwitterclone_quick_login_popup sesbasic_bxs _nosbtns">
    <?php } ?>
    <div class="sestwitterclone_popup_header clearfix">
      <div class="sestwitterclone_popup_header_title"><?php echo $this->translate("Sign In");?></div>  
    </div>
    
    <div class="sestwitterclone_popup_content clearfix">
      <div class="sestwitterclone_popup_social">
          ...
          <div class="sestwitterclone_social_login_btns <?php if($numberOfLogin < 3):?>social_login_btns_label<?php endif;?>">
            <?php  echo $this->partial('_socialLoginIcons.tpl','sessociallogin',array()); ?>
          </div>
        <?php endif; ?>
        </div>
    	<div class="sestwitterclone_quick_popup_form sestwitterclone_popup_login">
        <?php echo $this->content()->renderWidget("sestwitterclone.login-or-signup") ?>
      </div>
    </div>
    <div class="sestwitterclone_popup_footer clearfix">
  ...
  <?php if($controllerName != 'signup'){ ?>
  	<?php if(!empty($showSeparator)){ ?>
    	<div id="user_signup_form" class="zoom-anim-dialog mfp-hide sestwitterclone_quick_popup sesbasic_bxs sestwitterclone_quick_signup_popup">
    <?php } else { ?>
      <div id="user_signup_form" class="zoom-anim-dialog mfp-hide sestwitterclone_quick_popup sesbasic_bxs sestwitterclone_quick_signup_popup _nosbtns">
    <?php }; ?>
      <div class="sestwitterclone_popup_header clearfix">
        <div class="sestwitterclone_popup_header_title"><?php echo $this->translate("Join Now");?></div>
      </div>
    	<div class="sestwitterclone_popup_content clearfix">
       <div class="sestwitterclone_popup_social">
           <?php if(Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
        ...
        <?php endif; ?>
      	...
      	<div class="sestwitterclone_quick_popup_form sestwitterclone_popup_signup">
          <?php if($this->poupup && $controllerName != 'auth' && $actionName != 'login'){ ?>
            <?php echo $this->action("index", "signup", defined('sesquicksignup') ? "quicksignup" : 'sestwitterclone', array('disableContent'=>true)) ?>
          <?php } ?>
          <div class="sestwitterclone_popup_footer clearfix">
...
<div class="header_menus sesbasic_bxs sesbasic_clearfix">
    <?php if($this->show_mini) { ?>
      <div class="menu_middle">
        <ul>
          <li class="active"><a href="" class="minimenu_home"><i class="fa fa-home"></i><span><?php echo $this->translate("Home") ;?></span></a></li>
        </ul>
      </div>
      <div class="menu_middle">
        <?php
        ...
        <ul>
          <?php foreach( $this->navigation as $item ) { ?>
            ...
            <?php if(end($className) == 'core_mini_signup'):?>
              <li class="sestwitterclone_minimenu_link sestwitterclone_minimenu_signup">
                <?php if($controllerName != 'signup') { ?>
            ...
            <?php elseif(end($className) == 'core_mini_auth' && $this->viewer->getIdentity() == 0): ?>
              <?php if($controllerName != 'auth'  && $actionName != 'login') { ?>
                <li class="sestwitterclone_minimenu_link sestwitterclone_minimenu_login">
            ...
            <?php elseif(end($className) == 'core_mini_friends'):?>
              <?php if($this->viewer->getIdentity()):?>
                <li class="sestwitterclone_minimenu_request sestwitterclone_minimenu_icon">
                  <?php if($this->requestCount):?>
                    <span id="request_count_new" class="sestwitterclone_minimenu_count"><?php echo $this->requestCount ?></span>
                  <?php else:?>
                  ...
                  <span onclick="toggleUpdatesPulldown(event, this, '4', 'friendrequest');" style="display:block;" class="friends_pulldown">
                    <div id="friend_request" class="sestwitterclone_pulldown_contents_wrapper">
                      <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                      <div class="sestwitterclone_pulldown_header">
                        <?php echo $this->translate('Requests'); ?>
                      </div>
                      <div id="sestwitterclone_friend_request_content" class="sestwitterclone_pulldown_contents clearfix">
                    ...
                    <?php if(empty($minimenu_frrequest_normal) && empty($minimenu_frrequest_mouseover)):?>
                      <a href="javascript:void(0);" id="show_request" class="fa fa-user-o" title="<?php echo $this->translate($item->getLabel());?>"><?php echo $this->translate($item->getLabel()); ?></a>
                    <?php else:?>
                      <a href="javascript:void(0);" class="sestwitterclone_mini_menu_friendrequest" id="show_request" title="<?php echo $this->translate($item->getLabel());?>"><span><?php echo $this->translate($item->getLabel()); ?></span></a>
                    <?php endif;?>
                  </span>
                </li>
              <?php endif;?>
             <?php elseif(end($className) == 'core_mini_messages'):?>
              <li class="sestwitterclone_minimenu_message sestwitterclone_minimenu_icon">
                <?php if($this->messageCount):?>
                  <span id="message_count_new" class="sestwitterclone_minimenu_count"><?php echo $this->messageCount ?></span>
                <?php else:?>
                ...
                <span onclick="toggleUpdatesPulldown(event, this, '4', 'message');" style="display:block;" class="messages_pulldown">
                  <div id="sestwitterclone_user_messages" class="sestwitterclone_pulldown_contents_wrapper ariana-mini-menu-messages-pulldown">
                    <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                    <div class="sestwitterclone_pulldown_header">
                    ...
                    <div id="sestwitterclone_user_messages_content" class="sestwitterclone_pulldown_contents clearfix">
                  ...
                  <?php if(empty($minimenu_message_normal) && empty($minimenu_message_mouseover)): ?>
                    <a href="javascript:void(0);" id="show_message" class="fa fa-envelope-o">
                       <?php echo $this->translate("Messages"); ?>
                    </a>
                  <?php else:?>
                    <a href="javascript:void(0);" class="sestwitterclone_mini_menu_message" id="show_message" title="<?php echo $this->translate($item->getLabel());?>"><i id="show_message"></i><span><?php echo $this->translate($item->getLabel()); ?></span></a>
                  <?php endif;?>
                </span>
              </li>
            <?php elseif(end($className) == 'core_mini_notification'):?>
              <?php if($this->viewer->getIdentity()):?>
                <li id='core_menu_mini_menu_update' class="sestwitterclone_minimenu_updates sestwitterclone_minimenu_icon">
                  <?php if($this->notificationCount):?>
                    <span id="notification_count_new" class="sestwitterclone_minimenu_count">
                  ...
                  <span onclick="toggleUpdatesPulldown(event, this, '4', 'notifications');" style="display:block;" class="updates_pulldown">
                    <div class="sestwitterclone_pulldown_contents_wrapper">
                      <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                      <div class="sestwitterclone_pulldown_header">
                        <?php echo $this->translate('Notifications'); ?>
                      </div>
                      <div class="sestwitterclone_pulldown_contents pulldown_content_list">
                    ...
                    <?php if(empty($minimenu_notification_normal) && empty($minimenu_notification_mouseover)):?>
                      <a href="javascript:void(0);"  id="show_update" class="fa fa-bell-o" title="<?php echo $this->translate($item->getLabel());?>">
                       <?php echo $this->translate($item->getLabel()); ?>
                      </a>
                    <?php else:?>
                      <a href="javascript:void(0);" id="show_update" class="<?php if( $this->notificationCount ):?>new_updates<?php endif;?> sestwitterclone_mini_menu_notification" title="<?php echo $this->translate($item->getLabel());?>"><i id="show_update"></i>
  ...
  <?php if($this->show_logo) { ?>
    ...
    <div class="header_searchbox">
      ...
      <?php  echo $this->content()->renderWidget("sestwitterclone.search"); ?>
      <?php } ?>
    </div>
        <?php } ?>
         <?php if($this->show_mini) { ?>
        ...
        <ul>
              <li class="sestwitterclone_minimenu_setting sestwitterclone_minimenu_icon">
                <span style="display:block;" class="settings_pulldown" onclick="toggleUpdatesPulldown(event, this, '4', 'settings');">
                  <div id="user_settings" class="sestwitterclone_pulldown_contents_wrapper ariana-mini-menu-settings-pulldown">
                    <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                    <div class="sestwitterclone_pulldown_header">
                      <?php echo $this->translate('Account & Settings');?>
                    </div>
                    <div id="sestwitterclone_user_settings_content" class="sestwitterclone_pulldown_contents clearfix">
                      <ul>
                ...
                <?php } ?>
                <span><i id='' class="fa fa-caret-down"></i></span></a>
                </span>
              </li>
        </ul>
      </div>
      ...
      <div class="menu_right">
        <ul>
          ...
          <li class="searc_icon">
            ...
            <div class="responsive_search" id="show_sestwitterclone_search" style="display:none;">
                <input autocomplete="off" placeholder="<?php echo $this->translate('Search'); ?>" id="sestwitterclone_search" type="text" name="name" />
        ...
        <?php if($this->viewer->getIdentity() == 0): ?>
          <?php if($controllerName != 'signup') { ?>
            <div class="menu_signup">
              <a id="popup-signup" <?php if($this->poupup){ ?> <?php if($this->poupup && $controllerName != 'auth' && $actionName != 'login'){ ?> class="popup-with-move-anim" <?php } ?> <?php } ?> href="<?php if($this->poupup && $controllerName != 'auth' && $actionName != 'login'){ ?>#user_signup_form<?php }else{ echo 'signup'; } ?>"><?php echo $this->translate("Sign Up");?></a>
            </div>
          <?php } ?>
        <?php endif; ?>
        <?php if($this->viewer->getIdentity() == 0): ?>
...
<nav class="st-menu st-effect-4" id="show_main_menu">
  <div class="menus_searh_close">
    <div class="menu_search_box">
      <input autocomplete="off" placeholder="<?php echo $this->translate('Search'); ?>" id="sestwittercloneside_search" type="text" name="name" />
      <a onclick="javascript:showAllSearchResultsSide();" href="javascript:void(0);"><i class="fa fa-search"></i></a>      
    </div>
...
<script type='text/javascript'>
  ...
  function scrollingsestwitterclone() {
  ...
  sesJqueryObject(document).ready(function(){
    scrollingsestwitterclone();
  });

  function showSearch() { 
    if(document.getElementById('show_sestwitterclone_search').style.display == 'block') {
      document.getElementById('show_sestwitterclone_search').style.display = 'none';
    }
    else {
      document.getElementById('show_sestwitterclone_search').style.display = 'block';
    }
  }
  ...
  function hideSidePanel() {
    ...
    <?php } ?>
		...
		window.addEvent('domready', function() {
			...
			$(document.body).addEvent('click', function(event) {
				...
				if(event.target.className != 'fa fa-bars' && event.target.id != 'sestwittercloneside_search' && event.target.className != 'menu_footer_links' && event.target.className != 'fa fa-bars' && event.target.id != 'language') {
	...
	<?php if($this->viewer_id){?>
		...
		var toggleUpdatesPulldown = function(event, element, user_id, menu) {
			...
			if(event.target.className == 'sestwitterclone_pulldown_header')
				return;
		...
		var showNotifications = function() {
			...
			abortRequest = new Request.HTML({
				'url' : en4.core.baseUrl + 'sesbasic/theme/pulldown',
				'data' : {
					'format' : 'html',
					'page' : 1
				},
				'onComplete' : function(responseTree, responseElements, responseHTML, responseJavaScript) {
					...
					document.getElementById('notification_count_new').removeClass('sestwitterclone_minimenu_count');
				}
			});
		...
		function showMessages() {
			...
			abortRequest = new Request.HTML({
				url : en4.core.baseUrl + 'sesbasic/theme/inbox',
				data : {
					format : 'html'
				},
				onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
				{
				 document.getElementById('sestwitterclone_user_messages_content').innerHTML = responseHTML;
				 document.getElementById('message_count_new').innerHTML = '';
				 document.getElementById('message_count_new').removeClass('sestwitterclone_minimenu_count');
				}
			}); 
			en4.core.request.send(abortRequest, {
			'force': true
		...
		function showFriendRequests() {
			...
			abortRequest = new Request.HTML({
				url : en4.core.baseUrl + 'sesbasic/theme/friendship-requests',
				data : {
					format : 'html'
				},
				onSuccess : function(responseTree, responseElements, responseHTML, responseJavaScript)
				{
				 if(responseHTML) {
					 document.getElementById('sestwitterclone_friend_request_content').innerHTML = responseHTML;
					 document.getElementById('request_count_new').innerHTML = '';
					 document.getElementById('request_count_new').removeClass('sestwitterclone_minimenu_count');
				 }
				 else {
		...
		window.addEvent('domready', function() {
			...
			$(document.body).addEvent('click', function(event) {
				...
				if(event.target.className != 'fa fa-search' && event.target.id != 'sestwitterclone_search') {
					if($('show_sestwitterclone_search').style.display == 'block') {
						$('show_sestwitterclone_search').style.display = 'none';
					}
				}
				
				if(event.target.id != 'show_message' && event.target.id != 'show_request' && event.target.id != 'show_update' &&  event.target.id != 'show_settings_img' && event.target.className != 'sestwitterclone_pulldown_header' && event.target.className != 'pulldown_loading' && event.target.className != 'fa fa-caret-down') {
					if($$(".updates_pulldown_selected").length > 0)
						$$('.updates_pulldown_selected').set('class', 'updates_pulldown');
		...
		function newFriendRequests() {
			...
			en4.core.request.send(new Request.JSON({
				url : en4.core.baseUrl + 'sesbasic/theme/new-friend-requests',
				method : 'POST',
				data : {
					format : 'json'
				},
				onSuccess : function(responseJSON) {
					if( responseJSON.requestCount && $("request_count_new") ) {
						...
						if(responseJSON.requestCount > 0 && responseJSON.requestCount != '')
							$("request_count_new").addClass('sestwitterclone_minimenu_count');
		...
		function newUpdates() {
			en4.core.request.send(new Request.JSON({
				url : en4.core.baseUrl + 'sesbasic/theme/new-updates',
				method : 'POST',
				data : {
					format : 'json'
				},
				onSuccess : function(responseJSON) {
					if( responseJSON.notificationCount && $("notification_count_new") ) {
						$('show_update').addClass('new_updates');
						...
						if(responseJSON.notificationCount > 0 && responseJSON.notificationCount != '')
							$("notification_count_new").addClass('sestwitterclone_minimenu_count');
					}
				}
			}));
		}
		...
		function newMessages() {
			en4.core.request.send(new Request.JSON({
				url : en4.core.baseUrl + 'sesbasic/theme/new-messages',
				method : 'POST',
				data : {
					format : 'json'
				},
				onSuccess : function(responseJSON) {
					...
					if( responseJSON.messageCount && $("message_count_new") ) {
						...
						$("message_count_new").addClass('sestwitterclone_minimenu_count');
		...
		//Search
		en4.core.runonce.add(function() {
			var searchAutocomplete = new Autocompleter.Request.JSON('sestwittercloneside_search', "<?php echo $this->url(array('module' => 'sestwitterclone', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
				'postVar': 'text',
				'delay' : 250,
				'minLength': 1,
				'selectMode': 'pick',
		...
		en4.core.runonce.add(function() {
			var searchAutocomplete = new Autocompleter.Request.JSON('sestwitterclone_search', "<?php echo $this->url(array('module' => 'sestwitterclone', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
				'postVar': 'text',
				'delay' : 250,
				'minLength': 1,
				'selectMode': 'pick',
		...
		function showAllSearchResults() {
			...
			window.location.href= '<?php echo $this->url(array("controller" => "search"), "default", true); ?>' + "?query=" + $('sestwitterclone_search').value;
		}
		
		function showAllSearchResultsSide() {
			if($('all'))
				$('all').removeEvents('click');
			window.location.href= '<?php echo $this->url(array("controller" => "search"), "default", true); ?>' + "?query=" + $('sestwittercloneside_search').value;
		}
		
		sesJqueryObject(document).ready(function() {
			sesJqueryObject('#sestwitterclone_search').keydown(function(e) {
				if (e.which === 13) {
					showAllSearchResults();
				}
			});
			sesJqueryObject('#sestwittercloneside_search').keydown(function(e) {
				if (e.which === 13) {
...
if('<?php echo $this->viewer->getIdentity();?>' == 0) {
    ses(document).ready(function() {
		<?php $forcehide =  Engine_Api::_()->getApi('settings', 'core')->getSetting('sestwitterclone.popupfixed', false);    ?>
   ...
   var day = '<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sestwitterclone.popup.day', 5);?>';
   if(day != 0)
  ...
  function setCookie(cname, cvalue, exdays) {
	...
	var twitterclone = "expires="+d.toGMTString();
    document.cookie = cname + "=" + cvalue + "; " + twitterclone;
} 
...
<?php $header_fixed = Engine_Api::_()->sestwitterclone()->getContantValueXML('sestwitterclone_header_fixed_layout');
if($header_fixed == '1'):
