...
<div class="header_searchbox">
  <div class="header_searchbox_input">
      <input placeholder="<?php echo $this->translate('Search'); ?>" id="<?php echo $counter."_"; ?>sestwitterclone_title" type="text" name="name" />
  </div>
  <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sestwitterclone.searchleftoption', 1) && count($this->types) > 0): ?>
	      ...
	      <li class="sesbasic_clearfix <?php if(isset($_GET['type']) && ($_GET['type'] == $key)):?> selected <?php endif;?> " id="<?php echo $counter."_"; ?>show_type_<?php echo $key;?>" onclick="typevalue<?php echo $counter."_"; ?>('<?php echo $key;?>', '<?php echo $this->translate($title);?>')">
	        ...
	        <?php else: ?>
	          <?php if($explodedType[0] == 'ITEM_TYPE_VIDEO'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/video.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_ALBUM'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/album.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_ALBUM_PHOTO'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/photo.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_USER'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/user.png'; ?>" align="left" alt="">
					  <?php elseif($explodedType[0] == 'ITEM_TYPE_BLOG'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/blog.png'; ?>" align="left" alt="">
					  <?php elseif($explodedType[0] == 'ITEM_TYPE_BLOG'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/blog.png'; ?>" align="left" alt="">
						...
						<?php elseif($explodedType[0] == 'ITEM_TYPE_EVENT'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/event.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_GROUP'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/group.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_FORUM_POST'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/topic.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_FORUM_TOPIC'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/topic.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_MUSIC_PLAYLIST'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/music-album.png'; ?>" align="left" alt="">
						<?php elseif($explodedType[0] == 'ITEM_TYPE_MUSIC_PLAYLIST_SONG'): ?>
							<img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-icons/song.png'; ?>" align="left" alt="">
            <?php elseif($explodedType[0] == 'ITEM_TYPE_SESJOB_JOB'): ?>
	          ...
	          <?php else: ?>
						  <img src="<?php echo $base_url.'application/modules/Sestwitterclone/externals/images/search-grey.png'; ?>" align="left" alt="">
					  <?php endif;?>
					<?php endif;?>
...
<script type="text/javascript">
  ...
  function typevalue<?php echo $counter."_"; ?>(value, mainValue) {
   ...
   // setCookieSestwitterclone("sestwitterclone_commonsearch", value, 1);
  ...
  en4.core.runonce.add(function() {
   // setCookieSestwitterclone("sestwitterclone_commonsearch", "", -3600);
    var searchAutocomplete = new Autocompleter.Request.JSON('<?php echo $counter."_"; ?>sestwitterclone_title', "<?php echo $this->url(array('module' => 'sestwitterclone', 'controller' => 'index', 'action' => 'search'), 'default', true) ?>", {
      'postVar': 'text',
      'delay' : 250,      
      'minLength': 1,
      'selectMode': 'pick',
  ...
  function showAllSearchResults() {
    ...
    if($('<?php echo $counter."_"; ?>sm_type_value').value != 'Everywhere' && typeof $('<?php echo $counter."_"; ?>sm_type_value').value != 'undefined') {
      window.location.href= '<?php echo $this->url(array("controller" => "search"), "default", true); ?>' + "?query=" + $('<?php echo $counter."_"; ?>sestwitterclone_title').value+'&type='+$('<?php echo $counter."_"; ?>sm_type_value').value;
    }
    else {
      window.location.href= '<?php echo $this->url(array("controller" => "search"), "default", true); ?>' + "?query=" + $('<?php echo $counter."_"; ?>sestwitterclone_title').value;
    }
  }
</script>
<script>
...
sesJqueryObject(document).ready(function() {
  sesJqueryObject('#<?php echo $counter."_"; ?>sestwitterclone_title').keydown(function(e) {
    if (e.which === 13) { 
  ...
  function setCookieSestwitterclone(cname, cvalue, exdays, ddd) {
    var d = new Date();
  ...
  function getCookieSestwitterclone(cname) {
    var name = cname + "=";
