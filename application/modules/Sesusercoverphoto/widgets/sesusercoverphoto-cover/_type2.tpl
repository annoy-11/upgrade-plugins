 ...
 * @version    $Id: _type2.tpl 2016-05-06 00:00:00 SocialEngineSolutions $
...
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesusercoverphoto/externals/styles/cover_layout2.css'); ?>

<div class="sesusercover_main_container sesusercover_cover_type2 sesbasic_bxs <?php if($this->is_fullwidth){?>sesusercoverphoto_cover_wrapper_full<?php } ?>">
  ...
  <div class="sesusercoverphoto_cover_information_block sesbasic_clearfix">
    ...
    <?php if(in_array('photo',$this->option)){ ?>
      ...
      ?>
    	<div class="sesusercoverphoto_profile_img">
   ...
   <?php if(in_array('title',$this->option)){ ?>   
      ...
      <div class="sesusercoverphoto_cover_content sesbasic_clearfix">
      	<div class="sesusercoverphoto_cover_content_left">
...
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesmember/externals/styles/styles.css'); ?>
            ...
            <?php } ?>
				...
				<div class="sesusercoverphoto_cover_stats sesbasic_clearfix">
     			<ul>
        ...
        <?php if(in_array('recentlyViewedBy',$this->option)  && $this->sesmemberenable){ ?>
          <div class="sesusercoverphoto_users floatR">
...
sesJqueryObject('#sesusercoverphoto_main_photo_reposition').click(function(){
		...
		sesJqueryObject('.sesusercoverphoto_cover_buttons').hide();
...
sesJqueryObject('#cancelreposition').click(function(){
	...
	sesJqueryObject('.sesusercoverphoto_cover_buttons').show();
