...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sespagereview/externals/styles/styles.css'); ?>
<ul class="sespagereview_block sesbasic_bxs sesbasic_clearfix">
  <?php foreach( $this->results as $review ):?>
    <?php $reviewParent = Engine_Api::_()->getItem('sespage_page', $review->page_id);?>
    <li class="sespagereview_oftheday sesbasic_clearfix sesbasic_bxs sespagereview_grid_btns_wrap" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
      <div class="reviewofday_header"></div>
      <div class="reviewofday_body">
        <div class="sespagereview_review_grid_thumb sesbasic_clearfix">
          <a href="<?php echo $reviewParent->getHref(); ?>" class="sespagereview_review_grid_thumb_img floatL">
          ...
          <div class="sespagereview_labels sesbasic_clearfix">
            <?php if(isset($this->featuredLabelActive) && $review->featured){ ?>
              <p class="sespagereview_label_featured"><?php echo $this->translate('FEATURED');?></p>
            <?php } ?>
          </div>
          <?php } ?>
          <?php if(isset($this->verifiedLabelActive) && $review->verified == 1){ ?>
            <div class="sespagereview_verified_label" title="<?php echo $this->translate("VERIFIED"); ?>" style="display:none;"><i class="fa fa-check"></i></div>
          <?php } ?>
          <?php if(isset($this->titleActive) ){ ?>
              <div class="sespagereview_review_grid_title">
                ...
                <?php } ?>
                <?php if(isset($this->verifiedLabelActive) && $review->verified == 1){ ?>
                <i class="sespagereview_verified_sign fa fa-check-circle" title="Verified"></i>
                <?php } ?>
              </div>
            <?php } ?>
          ...
          <div class="sesbasic_clearfix clear">
            ...
            <?php $reviewTaker = Engine_Api::_()->getItem('sespage_page', $review->page_id);?> 
            <div class="sespagereview_review_grid_stat sespagereview_sidebar_image_rounded floatL sesbasic_text_light">
              <div class="sespagereview_review_tittle_block">
                ...
                <div class="sespagereview_list_stats sespagereview_review_grid_stat clear">
                  ...
                  <?php } ?>
                  <?php if(Engine_Api::_()->getApi('core', 'sespagereview')->allowReviewRating() && $this->ratingActive){
            ...
            <?php if(isset($this->ratingActive)): ?>
              <div class="sespagereview_list_rating sespagereview_review_sidebar_list_stat floatR">
                <?php $ratingCount = $review->rating;?>
                <?php for($i=0; $i<5; $i++){?>
                  <?php if($i < $ratingCount):?>
                      <span id="" class="sespagereview_rating_star_small"></span>
                  <?php else:?>
                      <span id="" class="sespagereview_rating_star_small_half"></span>
                  <?php endif;?>
                <?php }?>
              </div>
            <?php endif ?> 
          ...
          <?php if(isset($this->descriptionActive)):?>
            <div class="sespagereview_review_sidebar_list_body clear">
          ...
          <?php endif;?>
          <div class="sespagereview_oftheday_btns">
            <?php if(isset($this->likeButtonActive) && $review->authorization()->isAllowed($this->viewer(), 'comment')): ?>
              <?php $likeStatus = Engine_Api::_()->sespagereview()->getLikeStatus($review->review_id,$review->getType()); ?>
              <div class="">
                <a href="javascript:;" data-type="like_view" data-url="<?php echo $review->review_id ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sespagereview_like_<?php echo $review->review_id ?> sespagereview_like <?php echo ($likeStatus) ? 'button_active' : '' ; ?>"><i class="fa fa-thumbs-up"></i><span><?php echo $review->like_count;?></span></a>
              </div>
            <?php endif;?>
            <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagereview.allow.share', 1) && $this->viewer()->getIdentity() && isset($this->socialSharingActive)): ?>
