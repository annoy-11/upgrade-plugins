...
class Sespagereview_Widget_ReviewOfTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = Engine_Api::_()->getDbTable('pagereviews', 'sespagereview')->getPageReviewSelect(array('widgetName' => 'oftheday', 'fetchAll' => true), array());
