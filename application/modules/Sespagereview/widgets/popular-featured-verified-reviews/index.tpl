...
?>
<ul class="sesbasic_sidebar_block sespagereview_review_sidebar_block sesbasic_bxs sesbasic_clearfix"  id="widget_sespagereview_<?php echo $randonnumber; ?>" style="position:relative;">
  <div class="sesbasic_loading_cont_overlay" id="sespagereview_widget_overlay_<?php echo $randonnumber; ?>"></div>
    ...
    <li class="sespagereview_review_sidebar_list <?php if($this->image_type == 'rounded'):?>sespagereview_sidebar_image_rounded<?php endif;?> sesbasic_clearfix">
      ...
      <div class="sespagereview_review_sidebar_list_info">
        ...
        <?php } ?>
          ...
          <?php if(isset($this->reviewOwnerNameActive) || isset($this->pageNameActive)):?>
...
<script type="application/javascript">
 		var anchor_<?php echo $randonnumber ?> = sesJqueryObject('#widget_sespagereview_<?php echo $randonnumber; ?>').parent();
    ...
    function widget_previous_<?php echo $randonnumber; ?>(){
			sesJqueryObject('#sespagereview_widget_overlay_<?php echo $randonnumber; ?>').show();
      new Request.HTML({
        url : en4.core.baseUrl + 'widget/index/mod/sespagereview/name/<?php echo $this->widgetName; ?>/content_id/' + <?php echo sprintf('%d', $this->identity) ?>,
        data : {
          format : 'html',
					is_ajax: 1,
          ...
          page : <?php echo sprintf('%d', $this->results->getCurrentPageNumber() - 1) ?>
				...
				<?php } ?>
					sesJqueryObject('#sespagereview_widget_overlay_<?php echo $randonnumber; ?>').hide();
					showHideBtn<?php echo $randonnumber ?> ();
				}
      }).send()
		};
