 ...
 */
class Sespagereview_Model_DbTable_Parametervalues extends Engine_Db_Table {

  protected $_rowClass = 'Sespagereview_Model_Parametervalue';
  protected $_name = 'sespagereview_review_parametervalues';

  public function getParameters($params = array()) {
    $pTable = Engine_Api::_()->getDbtable('parameters', 'sespagereview');
