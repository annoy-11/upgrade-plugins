...
<script type="text/javascript">
  ...
  function multiDelete() {
    return confirm("<?php echo $this->translate('SESPAGE Are you sure you want to delete the selected reviews?');?>");
  }
  function selectAll() {
    var i;
    ...
    <table class='admin_table'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php $contentItem = Engine_Api::_()->getItem('sespage_page', $item->page_id); ?>
	  ...
	  <td class='admin_table_centered'>
	    <?php if($item->oftheday == 1):?>  
	      <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sespagereview', 'controller' => 'admin-manage', 'action' => 'review-oftheday', 'id' => $item->review_id, 'param' => 0), $this->htmlImage($baseURL . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit Member Review of the Day'))), array('class' => 'smoothbox')); ?>
	    <?php else: ?>
	      <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sespagereview', 'controller' => 'admin-manage', 'action' => 'review-oftheday', 'id' => $item->review_id, 'param' => 1), $this->htmlImage($baseURL . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make Member Review of the Day'))), array('class' => 'smoothbox')) ?>
	    <?php endif; ?>
	  </td>
          <td>
            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sespagereview', 'controller' => 'admin-manage', 'action' => 'view', 'id' => $item->review_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
            |
            <?php echo $this->htmlLink($item->getHref(), $this->translate("View"), array('class' => '')); ?>
            |
            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sespagereview', 'controller' => 'admin-manage', 'action' => 'delete-review', 'id' => $item->review_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
