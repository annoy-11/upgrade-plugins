...
<?php if($this->view_type == 1){ ?>
  <li class="sespagereview_review_sidebar_list <?php if($this->image_type == 'rounded'):?>sespagereview_sidebar_image_rounded<?php endif;?> sesbasic_clearfix">
    <?php echo $this->htmlLink($reviewOwner, $this->itemPhoto($reviewOwner, 'thumb.icon')); ?>
    <div class="sespagereview_review_sidebar_list_info">
    	<?php  if(isset($this->titleActive)){ ?>
      	<div class="sespagereview_review_sidebar_list_title">
      ...
      <?php } ?>
        ...
        <?php if(isset($this->byActive)):?>
          <div class="sespagereview_review_sidebar_list_stat sesbasic_text_light">
        ...
        <?php endif;?>  
			<div class="sespagereview_list_stats sespagereview_review_sidebar_list_stat">
      ...
      <?php if(isset($this->ratingActive)): ?>
        <div class="sespagereview_list_rating sespagereview_review_sidebar_list_stat clear">
    ...
    <?php endif;?>
    <div class="sespagereview_review_sidebar_featured_list">
  ...
  <li class="sespagereview_oftheday sesbasic_clearfix sesbasic_bxs sespagereview_grid_btns_wrap" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
    ...
    <div class="reviewofday_body">
      <div class="sespagereview_review_grid_thumb sesbasic_clearfix">
        ...
        <a href="<?php echo $href; ?>" class="sespagereview_review_grid_thumb_img floatL">
