...
<script type="application/javascript">
  Sessmoothbox.css.push("<?php echo $this->layout()->staticBaseUrl . 'application/modules/Sespagereview/externals/styles/styles.css'; ?>");
...
<div class="sespagereview_editreview_popup">
...
<script type="application/javascript">
 ...
 en4.core.runonce.add(function() {
  // tinymce.execCommand('mceRemoveEditor',true, 'description');
   sesJqueryObject('#sespagereview_review_form').attr('action',sesJqueryObject('#sespagereview_review_form').attr('action').replace('?format=html&typesmoothbox=sessmoothbox',''));   
   tinymce.init({
