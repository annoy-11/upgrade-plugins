 ...
 */
 ...
 ?>
<li class="sesbasic_clearfix sespagereview_reviews">
        ...
        <?php if(in_array('postedBy', $this->stats) || in_array('creationDate', $this->stats)): ?>
          <p class="sespagereview_review_listing_stats sesbasic_text_light">
            ...
            <?php if(in_array('creationDate', $this->stats)): ?>
              <?php echo $this->translate('SESPAGE about');?>
  ...
  <div class="sespagereview_review_listing_desc sesbasic_clearfix">
    <?php if(in_array('pros', $this->stats) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagereview.show.pros', 1)): ?>
      <p class="sespagereview_review_listing_body">
        <b><?php echo $this->translate("SESPAGE Pros: "); ?></b>
    ...
    <?php if(in_array('cons', $this->stats) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sespagereview.show.cons', 1)): ?>
      <p class="sespagereview_review_listing_body">
        <b><?php echo $this->translate("SESPAGE Cons: "); ?></b>
    ...
    <?php if(in_array('description', $this->stats) && $this->review->description): ?>
      <p class='sespagereview_review_listing_body'>
        <b><?php echo $this->translate("SESPAGE Description: "); ?></b>
        <?php echo $this->string()->truncate($this->string()->stripTags($this->review->description), 300) ?>
      </p>
    <?php endif; ?>
    <p class="sespagereview_review_listing_recommended"> <b><?php echo $this->translate('SESPAGE Recommended');?><i class="<?php if($this->review->recommended):?>fa fa-check<?php else:?>fa fa-times<?php endif;?>"></i></b></p>
    <p class="sespagereview_review_listing_more">
      <a href="<?php echo $this->review->getHref(); ?>" class=""><?php echo $this->translate("SESPAGE Continue Reading"); ?> &raquo;</a>
    </p>
  </div>
  <?php  echo $this->partial('_reviewOptions.tpl','sespagereview',array('subject'=>$this->review,'viewer'=> Engine_Api::_()->user()->getViewer(),'stats'=>$this->stats,'updateReview' => 1)); ?> 
</li>
...
<div id="sespagereview_review_create_form" class="" style="display:none;position:relative;"> 
