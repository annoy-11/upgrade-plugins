 ...
 * @version    $Id: support.tpl 2019-11-07 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

?>
<?php include APPLICATION_PATH .  '/application/modules/Emessages/views/scripts/dismiss_message.tpl';?>
<div class="sesbasic_support_links">
    <a href="https://socialnetworking.solutions/professional-messages-plugin" target="_blank">
    ...
    <a href="https:///socialnetworking.solutions/plugins/professionalmessages/screenshots.html" target="_blank">
    ...
    <a href="https://help.socialnetworking.solutions/faqs/category/professional-messages-plugin" target="_blank">
    ...
    <a href="http://community.socialengine.com/profile/SocialNetworkingDOTSolutions" target="_blank">
    ...
    <a href="https://socialnetworking.solutions/blog/" target="_blank">
        ...
        <h4>Blog Updates</h4>
        <p>Checkout our Blog posts about new releases, announcements & upgrades.</p>
    </a>
    <a href="https://www.socialengine.com/store/product/professional-messages-plugin" target="_blank">
