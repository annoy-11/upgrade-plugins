 ...
 * @version    $Id: LetterAvatar.php  2017-12-28 00:00:00 SocialEngineSolutions $
...
class phptextClass {
	...
	public function phptext($text,$textColor,$backgroundColor='',$fontSize,$imgWidth,$imgHeight,$dir) {
		...
		$textFont = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesletteravatar.textfont', 'ABeeZee');
		
		$font = APPLICATION_PATH . DIRECTORY_SEPARATOR . 'application'.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.'Sesletteravatar'.DIRECTORY_SEPARATOR.'externals'.DIRECTORY_SEPARATOR.$textFont.'.ttf'; /*define font*/
