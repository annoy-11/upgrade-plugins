   ...
   <div class="_top sesbasic_clearfix">
    ...
    <div class="_btns sesbasic_clearfix">
      <?php if($existing && !$package->isOneTime()):?>
        <div class="_left">
          <a href="<?php echo $this->url(array('action' => 'cancel','package_id' => $package->package_id),'sesbusinesspackage_general',true);?>" class="sesbusiness_packages_cancel_btn smoothbox"><?php echo $this->translate("Cancel");?></a>
