...
<div class="sesbasic_search_result">
	<?php echo $this->htmlLink($this->url(array('module' => 'sesbusinesspackage', 'controller' => 'package','action'=>'index')), $this->translate("Back to Manage Package"), array('class' => 'buttonlink sesbasic_icon_back')); ?>
</div><br />
  ...
  window.addEvent('domready', function() {
   ...
   var valueStyle = sesJqueryObject('input[name=business_choose_style]:checked').val();
    if(valueStyle == 1) {
      ...
      sesJqueryObject('#businessstyle_type-wrapper').show();
      sesJqueryObject('#business_chooselayout-wrapper').hide();
   }
  });
</script>