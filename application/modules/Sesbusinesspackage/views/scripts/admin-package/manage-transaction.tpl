...
<h3><?php echo $this->translate("Manage Business Package Payment Transactions") ?></h3>
<p><?php echo $this->translate('This page list all the payment transactions of the business packages that Business Owners have made on your site.  You can use this page to monitor these package transactions. Entering criteria into the filter fields will help you find specific transaction. Leaving the filter fields blank will show all the transactions on your social network.'); ?></p>
<br />
...
<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
    ...
    <thead>
      <tr>
        ...
        <th >
          <a href="javascript:void(0);">
            <?php echo $this->translate("Business ID") ?>
          </a>
        </th>
        <th >
          <a href="javascript:void(0);">
            <?php echo $this->translate("Business Title") ?>
          </a>
        </th>
        <th >
          <a href="javascript:void(0);">
            <?php echo $this->translate("Business Owner") ?>
          </a>
        </th>
      ...
      <?php foreach( $this->paginator as $item ):
        ...
        <tr>
          <td><?php echo $item->transaction_id ?></td>
           ...
           <td>
            <?php if(isset($business)):?>
             <a href="<?php echo $business->getHref(); ?>"  target='_blank' title="<?php echo  ucfirst($business->getTitle()) ?>">
                         <?php echo $this->translate(Engine_Api::_()->sesbasic()->textTruncation($business->getTitle(),25)) ?></a>
            <?php endif;?>
           </td>
          ...
          <td class='admin_table_options'>
            <a class="smoothbox" href='<?php echo $this->url(array('action' => 'detail', 'transaction_id' => $item->transaction_id, 'business_id' => $item->business_id));?>'>
