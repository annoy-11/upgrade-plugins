 ...
 * @version    $Id: _customFields.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
...
<?php $options = Engine_Api::_()->getDbTable('options','sesbusiness')->getAllOptions();
	if(count($options)){ ?>
<div id="custom-fields-container" style="display:none;">
  <?php foreach($options as $valueOptions){
      ...
      $metaValues = Engine_Api::_()->getDbTable('metas','sesbusiness')->getMetaData($valueOptions['option_id']);
      if(!count($metaValues))
      	continue;
   ?>
   <div>
