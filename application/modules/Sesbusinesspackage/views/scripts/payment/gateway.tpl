...
<div class="layout_middle sesbusiness_dashboard_main_nav">
    ...
    <div class="headline">
      <h2>
        <?php echo $this->translate('Businesses');?>
      </h2>
...
<div class="layout_middle sesbasic_bxs">
	<div class="generic_layout_container">
    <div class="sesbusiness_package_payment_process">
      ...
      <?php  echo $this->partial('have_coupon.tpl','ecoupon',array('id'=>$this->package->package_id,'params'=>json_encode(array('resource_type'=>$this->item->getType(),'resource_id'=>$this->item->business_id,'is_package'=>1,'package_type'=>$this->package->getType(),'package_id'=>$this->package->package_id)))); ?> 
    <?php endif; ?>
    
     <?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sescredit')) { ?>
		  <?php  echo $this->partial('apply_credit.tpl','sescredit',array('id'=>$this->package->package_id,'moduleName'=>'sesbusinesspackage','item_price'=>$this->itemPrice,'item_id'=>$this->item->business_id)); ?> 
    <?php } ?>
</div>  
