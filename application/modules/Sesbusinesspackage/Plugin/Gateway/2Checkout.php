 ...
 * @version    $Id: 2Checkout.php  2018-10-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesbusinesspackage_Plugin_Gateway_2Checkout extends Engine_Payment_Plugin_Abstract {
  ...
  function createBusinessTransaction(User_Model_User $user, Zend_Db_Table_Row_Abstract $item, Sesbusinesspackage_Model_Package $package, array $params = array()) {
    // Do stuff to params
    $params['fixed'] = true;
  ...
  public function cancelBusiness($transactionId) {
    return $this;
  }
