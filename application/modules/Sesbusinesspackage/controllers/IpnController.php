 ...
 * @version    $Id: IpnController.php  2018-10-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusinesspackage_IpnController extends Core_Controller_Action_Standard {
  ...
  public function __call($method, array $arguments) {
    ...
    // Log ipn
    $ipnLogFile = APPLICATION_PATH . '/temporary/log/sesbusinesspackage-ipn.log';
    ...
    try {
      ...
      //Get gateways
      $gatewayTable = Engine_Api::_()->getDbtable('gateways', 'sesbusinesspackage');
