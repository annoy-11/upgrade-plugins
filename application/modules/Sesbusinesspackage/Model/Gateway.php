 ...
 * @version    $Id: Gateway.php  2018-10-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusinesspackage_Model_Gateway extends Core_Model_Item_Abstract
{
  ...
  public function getPlugin()
  {
    if( null === $this->_plugin ) {
      ...
      if($this->plugin == "Sesadvpmnt_Plugin_Gateway_Stripe"):
        $class = str_replace('Sesadvpmnt','Sesbusinesspackage',$class);
      elseif($this->plugin == "Epaytm_Plugin_Gateway_Paytm"):
        $class = str_replace('Epaytm','Sesbusinesspackage',$class);
      else:
        $class = str_replace('Payment','Sesbusinesspackage',$class);
      endif;
