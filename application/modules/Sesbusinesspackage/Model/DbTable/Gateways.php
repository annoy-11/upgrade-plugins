 ...
 * @version    $Id: Gateways.php  2018-10-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesbusinesspackage_Model_DbTable_Gateways extends Engine_Db_Table
{
	protected $_name = 'payment_gateways';
  protected $_rowClass = 'Sesbusinesspackage_Model_Gateway';
