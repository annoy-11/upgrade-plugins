 ...
 */
class Sesdbslide_Form_Admin_Createslide extends Authorization_Form_Admin_Level_Abstract {
    ...
    $slideId = Zend_Controller_Front::getInstance()->getRequest()->getParam('slide_id', null);
        $this
                ...
                ->setAttrib('name', 'sesdbslide_create_slide')
        ...
        $this->addElement('File', 'image_for_slide', array(
		 ...
		 if($slideId)
             $slide = Engine_Api::_()->getItem('sesdbslide_slide', $slideId);
        else
            $slide = '';
      ...
      if ($_POST['enable_double_slide'] == 1) {
        ...
        $this->addElement('Radio', 'dbslide_frame_for_slide', array(
            ...
            'description' => 'Choose from the frame for this slide.[Note: size for laptop:- width:382px;height:800px , For Ipad:- width:179px;height:800px]',
            'allowEmpty' => $allowEmptyframe,
            'required' =>  $reqframe,
            'multiOptions' => array(
                '_lp _lplight' => 'Light Desktop',
                '_lp _lpdark' => 'Dark Desktop',
     ...
     if(!empty($_POST) && $_POST['enable_double_slide'] == 1 && $slide && $slide->dbslide_frame_for_slide){
       ...
       $allowEmptyframe = true;
        ...
        $this->addElement('Select', 'fixed_caption_font_family', array(
            ...
            'value' => Engine_Api::_()->sesdbslide()->getContantValueXML('sesariana_body_fontfamily'),
        ));
