...
<?php if( count($this->paginator) ): ?>
  ...
  <div>
  	 <div class="sesbasic_search_reasult">
    	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesdbslide', 'controller' => 'manage', 'action' => 'index'), $this->translate("Back to Manage Slideshows"), array('class'=>'sesbasic_icon_back buttonlink')); ?>
      </div>
...
<br>To reorder the slides, click on their row and drag them up or down.") ?>	 </p>
        <br />
        <div>
         <div class="sesbasic_search_reasult"><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesdbslide', 'controller' => 'manage', 'action' => 'create-slide','id'=>$this->gallery_id), $this->translate("Upload New Slide"), array('class'=>'buttonlink sesbasic_icon_add')); ?>
        ...
        <?php if(count($this->paginator) > 0):?>
            ...
            <?php foreach ($this->paginator as $item) : ?>
              <li class="item_label" id="slide_<?php echo $item->slide_id ?>">
                ...
                <div style="width:20%;">          
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesdbslide', 'controller' => 'manage', 'action' => 'create-slide', 'slide_id' => $item->slide_id,'id'=>$this->gallery_id), $this->translate("Edit"), array()) ?>
            |
            <?php echo $this->htmlLink(
                array('route' => 'admin_default', 'module' => 'sesdbslide', 'controller' => 'manage', 'action' => 'delete-slide', 'id' => $item->slide_id, 'type' => strtolower($item->file_type) == 'jpeg' || strtolower($item->status) == 'jpg' || strtolower($item->file_type) == 'png' || strtolower($item->file_type) == 'gif' ? 'Photo' : 'Video'),
...
<style type="text/css">
.sesdbslide_manage_form_head > div,
.sesdbslide_manage_form_list li > div{
