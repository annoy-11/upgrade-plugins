...
class Seslink_Model_Link extends Core_Model_Item_Abstract
{
  // Properties
...
//       $view->link = $this;
//       $videoEmbedded = $view->render('application/modules/Seslink/views/scripts/_link.tpl');
//     }
// 
...
//   }
  ...
  public function setPhoto($photo)
  {
    if( $photo instanceof Zend_Form_Element_File ) {
      ...
      throw new Seslink_Model_Exception('Invalid argument passed to setPhoto: ' . print_r($photo, 1));
    }
