...
class Sesbusinessveroth_Model_DbTable_Verifications extends Engine_Db_Table {

  protected $_rowClass = 'Sesbusinessveroth_Model_Verification';
  protected $_name = 'sesbusinessveroth_verifications';
