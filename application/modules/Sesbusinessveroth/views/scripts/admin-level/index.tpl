...
<script type="text/javascript">
  var fetchLevelSettings =function(level_id){
    window.location.href= en4.core.baseUrl+'admin/sesbusinessveroth/level/index/id/'+level_id;
  }
</script>
...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <div class='sesbasic-form-cont'>
	    <div class='clear'>
			  <div class='settings sesbasic_admin_form sesbusinessveroth_ml_settings'>
