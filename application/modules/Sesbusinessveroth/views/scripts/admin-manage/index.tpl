...
<h3>Manage Verified Businesses</h3>

<p>

  <?php echo $this->translate('This page lists all the businesses verified by the members on your website. You can use this page to monitor these verified Businesses and delete offensive material if necessary. Entering criteria into the filter fields will help you find specific business. Leaving the filter fields blank will show all the businesses on your social network.'); ?>
...
<div class='sesbasic_search_result'>
  ...
  <?php echo $this->translate(array("%s business found.", "%s businesses found.", $count),
...
<div class="admin_table_form sesbusinessveroth_manage_members">
  ...
  <table class='admin_table' style="width:100%;">
    ...
    <thead>
      ...
      <tr>
        ...
        <th><?php echo $this->translate("Verified Business") ?></th>
...
<div class="tip">
  ...
  <span>
    ...
    <?php echo "Currently, there are no verified businesses on your website.";?>
