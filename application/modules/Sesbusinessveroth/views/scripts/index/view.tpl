...
<div class="sesbusinessveroth_details_popup sesbasic_bxs">
  ...
  <div class="_content">
      ...
      <?php foreach($this->allRequests as $requests) { ?>
        <li class="sesbasic_clearfix sesbusinessveroth_details_popup_item">
          ...
          <div class="_cont">
          	...
          	<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusinessveroth.enablecomment', 1) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusinessveroth.displaycomment', 1)) { ?>
