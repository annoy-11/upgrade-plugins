...
class Sesbusinessveroth_Installer extends Engine_Package_Installer_Module {
  ...
  public function onPreinstall() {
    ...
    if(!empty($sesbusiness_Check) && !empty($business_activate[0]['value'])) {
      $plugin_currentversion = '4.10.3p1';
