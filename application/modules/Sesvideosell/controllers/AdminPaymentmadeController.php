...
class Sesvideosell_AdminPaymentmadeController extends Core_Controller_Action_Admin {
  
  public function indexAction() {

    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesvideosell_admin_main', array(), 'sesvideosell_admin_paymentmade');

    $userTableName = Engine_Api::_()->getItemTable('user')->info('name');
    
    $sesvideosellTable = Engine_Api::_()->getDbTable('remainingpayments', 'sesvideosell');
