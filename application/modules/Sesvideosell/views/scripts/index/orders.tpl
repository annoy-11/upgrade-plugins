...
<div class="layout_middle sesbasic_bxs">
    ...
    <div class="sesvideosell_manage_tabs_content sesbasic_clearfix">  
      <?php if($this->paginator->getTotalItemCount() > 0): ?>
        <p><?php echo $this->translate('Please find below the list of all the videos you have purchased from this website.'); ?></p>
            ...
            <div class="sesvideosell_order_item sesbasic_clearfix">
              ...
              <div class="sesvideosell_order_item_cont sesbasic_clearfix">            	
                ...
                <div class="sesvideosell_order_item_details">
                  ...
                  <div class="sesvideosell_order_item_stat sesbasic_text_light">
                    <?php echo $this->translate("Owner "); ?><a href="<?php echo $video->getOwner()->getHref(); ?>"><?php echo $video->getOwner()->getTitle(); ?></a>
                  </div>
                  <div class="sesvideosell_order_item_btm">
                    <span class="floatL">
                      ...
                      <?php echo $this->translate("Price: %s", $currency); ?>
                    </span>
      ...
      <?php else: ?>
        <div class="tip">
          <span>
            <?php echo $this->translate("You have not purchased any videos yet.") ?>
          </span>
        </div>
      <?php endif; ?>
    </div>
