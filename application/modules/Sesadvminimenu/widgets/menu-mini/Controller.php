...
class Sesadvminimenu_Widget_MenuMiniController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesadvminimenu_mini');

    if ($viewer->getIdentity()) {
      $this->view->notificationCount = Engine_Api::_()->getDbtable('notifications', 'sesadvminimenu')->hasNotifications($viewer);
      $this->view->messageCount = Engine_Api::_()->getApi('message', 'sesadvminimenu')->getMessagesUnreadCount($viewer);
      $this->view->requestCount = Engine_Api::_()->getDbtable('notifications', 'sesadvminimenu')->hasNotifications($viewer, 'friend');
    }
    ...
    //LOGIN FORM WORK
//     $this->view->form = $form = new Sesadvminimenu_Form_Login();
