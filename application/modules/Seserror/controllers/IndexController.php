 ...
 * @version    $Id: IndexController.php 2017-05-18 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seserror_IndexController extends Core_Controller_Action_Standard {

  public function contactAction() {
  
    $translate = Zend_Registry::get('Zend_Translate');
    $this->view->form = $form = new Seserror_Form_Contact();
    ...
    try {
      ...
      $visitorsTable = Engine_Api::_()->getDbtable('visitors', 'seserror');
