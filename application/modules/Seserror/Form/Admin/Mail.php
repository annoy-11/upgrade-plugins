 ...
 * @version    $Id: Mail.php 2017-05-18 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seserror_Form_Admin_Mail extends Engine_Form {
  ...
  public function init() {
    ...
    $description = vsprintf($description.$moreinfo, array(
      'http://support.socialengine.com/questions/178/Admin-Panel-Manage-Email-All-Members',
    ));
