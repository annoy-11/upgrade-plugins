...
<div class="sesiosapp_nav_btns">
  <a href="<?php echo $this->url(array('module' => 'sesiosapp', 'controller' => 'settings', 'action' => 'support'),'admin_default',true); ?>" target = "_blank" class="help-btn">Help</a>
</div>
...
<img src="application/modules/Sesiosapp/externals/images/admin/oading.gif" style="display:none">
...
scriptJquery('.loading_img').click(function(e){
   en4.core.showError('<div class="sesact_img_preview_popup"><div class="sesact_img_preview_popup_img"><img src="application/modules/Sesiosapp/externals/images/admin/loading.gif"> </div><div class="sesact_img_preview_popup_btm"><button onclick="Smoothbox.close()">'+en4.core.language.translate("Close")+'</button></div></div>');
