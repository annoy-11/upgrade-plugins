 ...
 */
class Seseventreview_Widget_BreadcrumbController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    $coreApi = Engine_Api::_()->core();
    if (!$coreApi->hasSubject('eventreview'))
      return $this->setNoRender();
		if(!Engine_Api::_()->getApi('settings', 'core')->getSetting('seseventreview.allow.review', 1))
		return $this->setNoRender();
    $this->view->review = $review = $coreApi->getSubject('eventreview');
