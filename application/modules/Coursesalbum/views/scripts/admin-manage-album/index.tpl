        ...
        <?php foreach ($this->paginator as $item): ?>
          <tr>
            ...
            <?php if($item->course_id) { ?>
              ...
              <?php if($course) { ?>
              <td><?php echo $this->htmlLink($course->getHref(), $course->getTitle()); ?></td> 
              <?php } else { ?>
                <td><?php echo "---"; ?></td>
              <?php } ?>
            <?php } else { ?>
            ...
            <?php $countPhotos = Engine_Api::_()->getDbTable('photos', 'coursesalbum')->countAlbumPhotos($item->getIdentity()); ?>
            <td><?php echo $countPhotos; ?></td>
            <td class="admin_table_centered">
              <?php if($item->featured == 1):?>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'coursesalbum', 'controller' => 'admin-manage-album', 'action' => 'featuredalbum', 'id' => $item->getIdentity()), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Unmark as Featured')))) ?>
              <?php else: ?>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'coursesalbum', 'controller' => 'admin-manage-album', 'action' => 'featuredalbum', 'id' => $item->getIdentity()), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Featured')))) ?>
                <?php endif; ?>
            </td>
            <td class="admin_table_centered">
              <?php if($item->sponsored == 1):?>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'coursesalbum', 'controller' => 'manage-album', 'action' => 'sponsoredalbum', 'id' => $item->getIdentity()), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Unmark as Sponsored')))) ?>
              <?php else: ?>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'coursesalbum', 'controller' => 'manage-album', 'action' => 'sponsoredalbum', 'id' => $item->getIdentity()), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Sponsored')))) ?>
              <?php endif; ?>
            </td>
            <td>
              <a href="<?php echo $this->url(array('album_id' => $item->getIdentity()), 'coursesalbum_specific_album') ?>" target="_blank">
                <?php echo $this->translate('View') ?>
              </a>
              |
              <a href="<?php echo $this->url(array('module' => 'coursesalbum', 'action' => 'edit', 'album_id' => $item->album_id), 'coursesalbum_specific_album', true); ?>"><?php echo $this->translate('Edit'); ?></a>
              |
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'coursesalbum', 'controller' => 'admin-manage-album', 'action' => 'delete', 'id' => $item->album_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
            </td>
          </tr>
        <?php endforeach; ?>
    </tbody>
