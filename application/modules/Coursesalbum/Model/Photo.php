 ...
 * @version    $Id: Photo.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Coursesalbum_Model_Photo extends Core_Model_Item_Collectible {
  protected $_parent_type = 'coursesalbum_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'coursesalbum_album';
  
  public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'coursesalbum_photo_view',
        'reset' => true,
        'controller' => 'photo',
        'action' => 'view',
   ...
   public function setPhoto($photo) {
    if ($photo instanceof Zend_Form_Element_File) {
      ...
      throw new Eclassroom_Model_Exception('invalid argument passed to setPhoto');
    }
    if (!$fileName) {
  ...
  public function setAlbumPhoto($photo,$isURL = false,$isUploadDirect = false,$album = false) {
    ...
    try {
      ...
      if( $e->getCode() == Storage_Model_DbTable_Files::SPACE_LIMIT_REACHED_CODE ) {
				throw new Eclassroom_Model_Exception($e->getMessage(), $e->getCode());
      } else {
				throw $e;
      }
    }
  ...
  */
  public function getAlbumPhotoUrl($type = null) {
    ...
    if( !$photo_id ) {
      return 'application/modules/Coursesalbum/externals/images/nophoto_album_thumb_normal.png?c=direct';
    }
  ...
  public function getParent() {
      return Engine_Api::_()->getItem('courses',$this->course_id);
  }
  public function getAlbum() {
      return Engine_Api::_()->getItem('coursesalbum_album', $this->album_id);
  }
