 ...
 */
class Coursesalbum_Model_Album extends Core_Model_Item_Collection {

  protected $_parent_type = 'courses';
  protected $_owner_type = 'courses';
  protected $_children_types = array('coursesalbum_photo');
  protected $_collectible_type = 'coursesalbum_photo';
  public function getHref($params = array()) {
    $params = array_merge(array(
      'route' => 'coursesalbum_specific_album',
      'reset' => true,
      'action'=>'view',
  ...
  public function getPhotoUrl($type = null,$status = false) {
    ...
    if (!$file_id) {
      $albumTable = Engine_Api::_()->getItemTable('coursesalbum_photo');
  ...
  {
    $course_id = $this->course_id;
    $classroom = Engine_Api::_()->getItem('classroom', $course_id);
    return $classroom;
  }
  /**
