 ...
 */
class Coursesalbum_Widget_BrowseAlbumSearchController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $searchFor = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'coursesalbum','controller'=>'album','action'=>'browse'));
    $searchForm->setAction($searchFor);
