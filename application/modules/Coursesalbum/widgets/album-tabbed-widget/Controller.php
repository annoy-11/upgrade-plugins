 ...
 */
class Coursesalbum_Widget_AlbumTabbedWidgetController extends Engine_Content_Widget_Abstract {
    public function indexAction() {
        ...
        $showdefaultalbum = isset($params['showdefaultalbum']) ? $params['showdefaultalbum'] : $this->_getParam('showdefaultalbum', 0);
        ...
        $value['fixedData'] = 	isset($fixedData) ? $fixedData : '';
         $value['showdefaultalbum'] = $showdefaultalbum;
        ...
        if($is_ajax)
            ...
            if( $paginator->getTotalItemCount() <= 0 ) {
                ...
                $checkAlbumCount = Engine_Api::_()->getDbTable($albumPhotoOption.'s', 'coursesalbum')->$nameFunction();
