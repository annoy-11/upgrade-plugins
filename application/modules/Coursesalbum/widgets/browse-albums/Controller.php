 ...
 */
class Coursesalbum_Widget_BrowseAlbumsController extends Engine_Content_Widget_Abstract {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('albums', 'coursesalbum')->getAlbumSelect($value,array('*'));
