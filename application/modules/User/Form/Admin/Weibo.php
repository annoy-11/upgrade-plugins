 ...
 * @license    http://www.socialengine.com/license/
 */
class User_Form_Admin_Weibo extends Engine_Form
{
  public function init()
  {
    $this
      ->setTitle('Weibo Integration')
   ...
   // $settings = Engine_Api::_()->getApi('settings', 'core');
	...
	$moreinfo = $this->getTranslator()->translate( 
        '<br>More Info: <a href="http://support.socialengine.com/questions/166/Admin-Panel-Settings-Facebook-Integration" target="_blank"> KB Article</a>');
	} else {
	$moreinfo = $this->getTranslator()->translate( 
        '');
	}*/
    ...
    */
    ...
    $this->addElement('Text', 'WB_AKEY', array(
      'label' => 'Weibo App Key',
      'description' => '',
      'filters' => array(
        'StringTrim',
    ...
    $this->addElement('Text', 'WB_SKEY', array(
      'label' => 'Weibo App Secret',
      'description' => 'This is a 36 character string of letters and numbers ' . 
          'provided by weibo when you create an Application in your account.',
      'filters' => array(
        'StringTrim',
      ),
    ));
