 ...
 * @version    $Id: manage-widgetize-page.tpl  2018-12-18 00:00:00 SocialEngineSolutions $
...
<table class='admin_table'>
  ...
  <tbody>
    ...
    $corePages = Engine_Api::_()->sesdiscussion()->getwidgetizePage(array('name' => $item));
    ...
    <tr>
      ...
      <td>
        ...
        <?php if($item == 'sesdiscussion_index_view' || $item == 'sesdiscussion_index_edit' || $item == 'sesdiscussion_index_create'): ?>
        <?php else: ?>
        |
