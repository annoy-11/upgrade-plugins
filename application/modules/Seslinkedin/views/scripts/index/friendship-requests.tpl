 ...
 * @version    $Id: friendship-requests.tpl  2019-05-21 00:00:00 SocialEngineSolutions $
...
<?php if($this->peopleyoumayknow): ?>
  <div class="seslinkedin_pulldown_header"><?php echo $this->translate("People You May Know"); ?></div>
