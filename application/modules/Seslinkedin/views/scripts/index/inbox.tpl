 ...
 * @version    $Id: inbox.tpl  2019-05-21 00:00:00 SocialEngineSolutions $
...
<?php if( count($this->paginator) ): ?>
  <div class="pulldown_content_list">
    <ul id="seslinkedin_messages_menu">
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'seslinkedin/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('seslinkedin_messages_menu')){
          var message_children = $('seslinkedin_messages_menu').getChildren('li');
//           console.log(message_children);
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'seslinkedin/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
