 ...
 * @version    $Id: CustomTheme.php  2019-05-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslinkedin_Form_Admin_CustomTheme extends Engine_Form {
  ...
  public function init() {
    ...
    $getCustomThemes = Engine_Api::_()->getDbTable('customthemes', 'seslinkedin')->getCustomThemes(array('all' => 1));
