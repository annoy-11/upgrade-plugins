 ...
 * @version    $Id: HeaderSettings.php  2019-05-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslinkedin_Form_Admin_HeaderSettings extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Select', 'seslinkedin_headerlogo', array(
        'label' => 'Header Logo',
        ...
        'escape' => false,
        'value' => $settings->getSetting('seslinkedin.headerlogo', ''),
    ));
    $this->seslinkedin_headerlogo->addDecorator('Description', array('placement' => Zend_Form_Decorator_Abstract::PREPEND, 'escape' => false));

    $this->addElement('Radio', 'seslinkedin_sidepaneldesign', array(
      ...
      'value' => $settings->getSetting('seslinkedin.sidepaneldesign',1),
    ));

    $this->addElement('MultiCheckbox', 'seslinkedin_headerloggedinoptions', array(
      ...
      'value' => unserialize($settings->getSetting('seslinkedin.headerloggedinoptions', 'a:4:{i:0;s:6:"search";i:1;s:8:"miniMenu";i:2;s:8:"mainMenu";i:3;s:4:"logo";} ')),
    ));

    $this->addElement('MultiCheckbox', 'seslinkedin_headernonloggedinoptions', array(
      ...
      'multiOptions' => array(
          //'search' => 'Search',
          'miniMenu' => 'Login & Signup',
          'logo' =>'Logo',
      ),
      'value' => unserialize($settings->getSetting('seslinkedin.headernonloggedinoptions', 'a:3:{i:0;s:8:"miniMenu";i:1;s:8:"mainMenu";i:2;s:4:"logo";}')),
    ));

    $this->addElement('Radio', 'seslinkedin_footersidepanel', array(
      ...
      'value' => $settings->getSetting('seslinkedin.footersidepanel',1),
    ));
