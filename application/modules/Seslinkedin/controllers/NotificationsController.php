 ...
 * @version    $Id: NotificationsController.php  2019-05-21 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Seslinkedin_NotificationsController extends Core_Controller_Action_Standard {
  ...
  public function pulldownAction() {
    ...
    $viewer = Engine_Api::_()->user()->getViewer();
    $this->view->notifications = $notifications = Engine_Api::_()->getDbtable('notifications', 'seslinkedin')->getNotificationsPaginator($viewer);
    ...
    Engine_Api::_()->getApi('message', 'seslinkedin')->setUnreadNotification($viewer);
