...
<form method="post" class="global_form_popup">
  <div>    
    <h3><?php echo $this->translate("Delete Interest Title?") ?></h3>
    <p><?php echo $this->translate("Are you sure that you want to delete this interest title. It will not be recoverable after being deleted.") ?></p>
    <br />
    <p>
