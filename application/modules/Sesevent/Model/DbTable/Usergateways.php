 ...
 * @version    $Id: Usergateways.php 2016-07-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesevent_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_rowClass = 'Sesevent_Model_Usergateway';
  ...
  public function getEnabledGatewayCount()
  {
	...
	public function getUserGateway($params = array()){
			$select = $this->select()->from($this->info('name'))->where('event_id =?',$params['event_id']);
