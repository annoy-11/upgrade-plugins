        ...
        'adminForm' => array(
            'elements' => array(
                ...
                array(
                    ...
                    'limit_data',
                    array(
                        'label' => 'Total Count (number of event to show).',
                        'value' => 5,
                        'validators' => array(
                            array('Int', true),
                            array('GreaterThan', true, array(0)),
                ...
                array(
                    ...
                    'total_limit_data',
                    array(
                        'label' => 'Count (number of event to show at one time).',
                        'value' => 5,
                        'validators' => array(
                            array('Int', true),
                            array('GreaterThan', true, array(0)),
                ...
                array(
                    ...
                    'autoplay_speed',
                    array(
                        'label' => 'Autoplay Speed(In Milisecond)',
                        'value' => 1000,
                        'validators' => array(
                            array('Int', true),
                            array('GreaterThan', true, array(0)),
        ...
        'adminForm' => array(
            'elements' => array(
                ...
                array(
                    ...
                    'limit',
                    array(
                        'label' => 'Count (number of content to show at one time)',
                        'value' => 3,
                        'validators' => array(
                            array('Int', true),
                            array('GreaterThan', true, array(0)),
                ...
                array(
                    ...
                    'total_limit',
                    array(
                        'label' => 'Total Count (number of content to show)',
                        'value' => 3,
                        'validators' => array(
                            array('Int', true),
                            array('GreaterThan', true, array(0)),
