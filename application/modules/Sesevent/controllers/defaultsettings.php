...
if( !$page_id ) {
  ...
  foreach ($languageList as $key => $language) {
    ...
    $coulmnName = $language . '_bodysimple';
    $array[$coulmnName] = '<div style="text-align: center;margin-bottom:50px;margin-top:10px;"><a href="javascript:void(0);" onclick="chnageManifestUrl(\'upcoming\');"  target="_blank" class="sesbasic_animation" onmouseover="this.style.backgroundColor=\'#29A6AA\'" onmouseout="this.style.backgroundColor=\'#FF4C4C\'" style="padding: 10px 20px; font-size: 17px; color: rgb(255, 255, 255); font-weight: bold; text-decoration: none; border-radius: 3px; background-color: rgb(255, 76, 76);">See All Upcoming Events</a></div>
  ...
  foreach ($languageList as $key => $language) {
    ...
    $coulmnName = $language . '_bodysimple';
    $array[$coulmnName] = '<div style="text-align: center;margin-bottom:50px;margin-top:-50px;"><a href="javascript:void(0);" onclick="chnageManifestUrl(\'categories\');" target="_blank" class="sesbasic_animation" onmouseover="this.style.backgroundColor=\'#29A6AA\'" onmouseout="this.style.backgroundColor=\'#FF4C4C\'" style="padding: 10px 20px; font-size: 17px; color: rgb(255, 255, 255); font-weight: bold; text-decoration: none; border-radius: 3px; background-color: rgb(255, 76, 76);">Browse All Categories</a></div>
...
if (empty($info)) {
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $topmiddle_id,
      'order' => 4,
      'params' => '{"title_truncation_grid":"45","description_truncation_grid":"45","height":"100","speed":"300","width":"50","autoplay":"1","criteria":"most_event","show_criteria":["title","description","countEvents","socialshare"],"isfullwidth":"1","limit_data":"0","title":"Popular Categories","nomobile":"0","name":"sesevent.category-carousel"}',
  ));
...
if (empty($hasWidget)) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SES - Advanced Events - Event View Page',
...
$db->query('ALTER TABLE `engine4_sesevent_hosts`  MODIFY COLUMN `host_phone` bigint(11) NOT NULL;');

$db->query('INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES ("sesevent_admin_main_eventcreate", "sesevent", "Event Create Page Settings", "", \'{"route":"admin_default","module":"sesevent","controller":"settings", "action":"eventcreate"}\', "sesevent_admin_main", "", 1);');
