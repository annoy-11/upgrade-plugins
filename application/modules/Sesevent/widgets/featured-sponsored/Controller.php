 ...
 */
class Sesevent_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = Engine_Api::_()->getDbTable('events', 'sesevent')->getEventSelect($value);
