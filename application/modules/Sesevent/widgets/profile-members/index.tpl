...
?>
    ...
    <?php if($this->viewtype != 'pagging' && !$this->is_ajax):?>      
        <div class="sesbasic_load_btn" id="view_more_guest" onclick="viewMore_guest();" > <?php echo $this->htmlLink('javascript:void(0);', $this->translate('View More'), array('id' => "feed_viewmore_link_guest", 'class' => 'sesbasic_animation sesbasic_link_btn fa fa-repeat')); ?> </div>
