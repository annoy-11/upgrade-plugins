    ...
    <li class="sesevent_clist_item sesbasic_clearfix sesbm sesevent_grid_btns_wrap" style="width:<?php echo str_replace('px','',$this->width_lists); ?>px;">
      <div class="sesevent_clist_item_header sesbasic_clearfix">
        ...
        <div class="sesevent_clist_item_header_info">
          ...
          <?php if(!empty($this->information) && in_array('eventcount', $this->information)){ ?>
            <span title="<?php echo $this->translate(array('%s event', '%s events', $item->countEvents()), $this->locale()->toNumber($item->countEvents()))?>"><i class="fa fa-calendar"></i><?php echo $item->countEvents(); ?></span>
          <?php } ?>
     ...
     <?php } ?>
        ...
        <div class="sesbasic_option_box">
          <a href="<?php echo $this->url(array('action'=>'edit', 'list_id'=>$item->getIdentity(),'slug'=>$item->getSlug()),'sesevent_list_view',true) ?>" title="<?php echo $this->translate("Edit List") ?>"><i class="fa fa-pencil"></i><?php echo $this->translate("Edit List") ?></a>
        ...
        <?php } ?>
	      ...
	      $urlencode = urlencode(((!empty($_SERVER["HTTPS"]) &&  strtolower($_SERVER["HTTPS"]) == 'on') ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . $href); ?>
           ...
           <?php if($isDeleteHost || $isEditHost): ?>           
            ...
            <div class="sesbasic_option_box">
            <?php if($isEditHost): ?>
              <a href="<?php echo $this->url(array('action'=>'edit', 'host_id'=>$item->getIdentity()),'sesevent_host',true) ?>" title="<?php echo $this->translate("Edit Host") ?>"><i class="fa fa-pencil"></i><?php echo $this->translate("Edit Host") ?></a>
            <?php endif; ?>
           	<?php if($isDeleteHost): ?>
	    ...
	    <div class="sesevent_host_list_info sesbasic_clearfix">
	      ...
	      <div class="sesevent_host_list_stats sesevent_list_stats">
	        <?php if(isset($this->showEventsListActive) && isset($hostEventCount)) { ?>
		        <span title="<?php echo $this->translate(array('%s event host', '%s event hosted', $hostEventCount), $this->locale()->toNumber($hostEventCount))?>"><i class="fa fa-calendar-check-o sesbasic_text_light"></i><?php echo $hostEventCount; ?></span>
	        <?php } ?>
	        <?php if(isset($this->followActive) && isset($followCount)) { ?>
		        <span title="<?php echo $this->translate(array('%s follow', '%s followed', $followCount), $this->locale()->toNumber($followCount))?>"><i class="fa fa-users sesbasic_text_light"></i><?php echo $followCount; ?></span>
	        <?php } ?>
