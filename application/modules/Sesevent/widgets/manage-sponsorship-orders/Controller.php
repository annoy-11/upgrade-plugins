 ...
 */
class Sesevent_Widget_ManageSponsorshipOrdersController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_search_ajax) {
      $this->view->searchForm = $searchForm = new Sesevent_Form_Searchsponsorshiporder();
    }
    ...
    $this->view->orders = $orders = Engine_Api::_()->getDbtable('sponsorshiporders', 'sesevent')->manageSponsorshipOrders($value);
