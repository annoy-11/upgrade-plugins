<?php
class Sesevent_Widget_OtherModulesProfileEventsController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
        ...
        if(isset($subject->user_id) != $viewer->getIdentity()){
          $userObject = Engine_Api::_()->getItem('user', $subject->user_id);
          $profile = 'other';
          $userId = $subject->user_id;
				}
			} else if(isset($subject->owner_id)){
        if(isset($subject->owner_id) != $viewer->getIdentity()){
    ...
    $this->view->widgetName = 'other-modules-profile-events';
    $this->view->page = $page;
