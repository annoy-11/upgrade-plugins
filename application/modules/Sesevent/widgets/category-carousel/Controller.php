...
class Sesevent_Widget_CategoryCarouselController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->height = $this->_getParam('height', '100');
    $this->view->width = $this->_getParam('width', '50');
    ...
    $this->view->total_limit_data = $limit = $this->_getParam('total_limit_data', 15);
    $this->view->limit_data = $this->_getParam('limit_data', 15);
		if($limit)
			$params['limit'] = $limit;
    $params['order']  = $order;
