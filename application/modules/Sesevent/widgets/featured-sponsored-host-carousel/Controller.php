 ...
 */
class Sesevent_Widget_FeaturedSponsoredHostCarouselController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
   $this->view->limit_data = $value['limit'] = $this->_getParam('limit_data', 5);
  $this->view->total_limit_data = $this->_getParam('total_limit_data', 5);
