...
class Sesevent_Widget_CountryTabbedEventsController extends Engine_Content_Widget_Abstract {
  public function indexAction() {  
    ...
    if (isset($_POST['searchParams']) && $_POST['searchParams'])
		...
		$value['order'] =  isset($searchArray['criteria']) ? $searchArray['criteria'] : (!empty($params['criteria']) ? $params['criteria'] : (isset($_GET['criteria']) && ($_GET['criteria'] != '') ? $_GET['criteria'] : ($this->_getParam('criteria',false) ? $this->_getParam('criteria') : 'ongoing')));
