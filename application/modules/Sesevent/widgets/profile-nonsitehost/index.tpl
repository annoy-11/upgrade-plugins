    ...
    <div class="sesevent_host_profile_photo sesevent_grid_btns_wrap">
      ...
      <?php endif; ?>
        ...
        $itemtype = 'sesevent_host';
            $getId = 'host_id';
        if(in_array('likeButton', $this->infoshow) && isset($host->like_count)){ ?>
  ...
  <div class="sesevent_host_profile_info">
    <?php if(!empty($this->infoshow)): ?>
      ...
      <div class="sesevent_list_stats sesevent_host_profile_stats sesbasic_clearfix">
        ...
        <?php } ?>
        <?php if(in_array('like', $this->infoshow) && isset($host->like_count)) { ?>
          <span><i class="fa fa-thumbs-up sesbasic_text_light"></i><?php echo $this->translate(array('%s like', '%s likes', $host->like_count), $this->locale()->toNumber($host->like_count))?></span>
        <?php } ?>
