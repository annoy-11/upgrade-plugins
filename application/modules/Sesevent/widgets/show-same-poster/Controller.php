 ...
 */
class Sesevent_Widget_ShowSamePosterController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->title_truncation_grid = $this->_getParam('list_truncation_grid', '45');
    ...
    $values['not_event_id'] = $subject->getIdentity();
