 ...
 * @version    $Id: Owner.php 2016-07-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesevent_Plugin_Gateway_Sponsorship_Owner extends Engine_Payment_Plugin_Abstract
{
  ...
  public function getGateway()
  {
    if( null === $this->_gateway ) {
      ...
      $gateway = new $class(array(
        ...
        'currency' => Engine_Api::_()->sesevent()->defaultCurrency(),
      ));
  ...
  public function createOrderTransaction($order,$event,array $params = array())
  {
     ...
     $params['driverSpecificParams']['PayPal'] = array(
				...
				'ITEMS' => array(
				array(
					'NAME' => $event->title.' : Sponsorship Payment',
