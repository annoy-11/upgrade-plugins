...
Composer.Plugin.Seseventphoto = new Class({
  ...
  activate : function() {
    ...
    this.elements.formInput = new Element('input', {
      'id' : 'compose-seseventphoto-form-input',
    ...
    if( this.options.fancyUploadEnabled && this.options.fancyUploadOptions ) {
      ...
      this.elements.formFancyFile = new Element('a', {
        ...
        'id' : 'compose-seseventphoto-form-fancy-file',
        'class' : 'buttonlink',
  ...
  doRequest : function() {
    this.elements.iframe = new IFrame({
      'name' : 'composeseseventphotoFrame',
  ...
  doProcessResponse : function(responseJSON) {
    ...
    this.elements.preview = Asset.image(responseJSON.src, {
      'id' : 'compose-seseventphoto-preview-image',
  ...
  doImageLoaded : function() {
    //compose-seseventphoto-error
    if($('compose-seseventphoto-error')){
      $('compose-seseventphoto-error').destroy();
    }
