 ...
 * @version    $Id: backgroundphoto.tpl 2016-07-26 00:00:00 SocialEngineSolutions $
...
<?php
if ($this->event->background_photo_id !== null && $this->event->background_photo_id){ 
 $backgroundImage =	Engine_Api::_()->storage()->get($this->event->background_photo_id, '')->getPhotoUrl();?>
