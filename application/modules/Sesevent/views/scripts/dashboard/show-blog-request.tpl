 ...
 * @version    $Id: show-blog-request.tpl 2016-07-26 00:00:00 SocialEngineSolutions $
...
<?php } 
 ...
 echo $this->content()->renderWidget('sesevent.manage-blog-requests', array('event_id' => $this->event->event_id));
?>
<?php if(!$this->is_ajax){ ?>
	</div>
</div>
