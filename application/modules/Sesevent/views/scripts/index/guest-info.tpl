 ...
 * @version    $Id: guest-info.tpl 2016-07-26 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    if ($('view_more'))
    $('view_more').style.display = "<?php echo ( $this->paginator->count() == $this->paginator->getCurrentPageNumber() || $this->paginator->count() == 0 ? 'none' : '' ) ?>"; 
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesevent/index/guest-info/event_id/' + id+'/value/<?php echo $this->value; ?>' ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate($this->textVal); ?>
