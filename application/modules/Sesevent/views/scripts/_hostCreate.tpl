...
<div id="add_new_host" style="display:none;">
  ...
  <div id="removeimagehost-wrapper" class="form-wrapper" style="display:none">
    <div id="removeimagehost-element" class="form-element"><a class="icon_cancel form-link" id="removeimage1host" style="display:none; " href="javascript:void(0);" onclick="removeImagehost();"><i class="fa fa-trash"></i><?php echo $this->translate('Remove');?></a></div>
  </div>  
