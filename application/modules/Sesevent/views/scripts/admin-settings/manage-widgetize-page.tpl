  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <?php if(!in_array($item, array('seseventreview_index_view', 'sesevent_photo_view', 'sesevent_list_view', 'sesevent_album_view', 'sesevent_index_viewhost','sesevent_profile_index', 'sesevent_category_index'))) { ?>
        |
