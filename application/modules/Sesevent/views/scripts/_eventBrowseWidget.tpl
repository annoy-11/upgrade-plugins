  ...
  <?php foreach( $this->paginator as $event ): ?>
    ...
    <?php 
      ...
      if(isset($this->joinedcountActive)){
      	 ...
      	 $eventStartEndDate .=	"<div title=\"$guestCount\" class=\"sesevent_list_stats\"><span><i class=\"fa fa-users sesbasic_text_light\"></i>$guestCount</span></div>";
      }
    ...
    if((isset($this->socialSharingActive) || isset($this->likeButtonActive) || isset($this->favouriteButtonActive) || isset($this->listButtonActive)) && $event->is_approved) {
      ...
      if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') || $event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')) {
        ...
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') ){
          $shareOptionsListView  .='<a href="'.$this->url(array('event_id' => $event->custom_url,'action'=>'edit'), 'sesevent_dashboard', true).'"  title="'.$this->translate("Edit Event").'"><i class="fa fa-pencil"></i>'.$this->translate("Edit Event").'</a>';
        }    
    ...
    if((isset($this->socialSharingActive) || isset($this->likeButtonActive) || isset($this->favouriteButtonActive) || isset($this->listButtonActive)) && $event->is_approved) {
      ...
      if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') || $event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')) {
        ...
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') ){
          $shareOptionsGridView  .='<a href="'.$this->url(array('event_id' => $event->custom_url,'action'=>'edit'), 'sesevent_dashboard', true).'"  title="'.$this->translate("Edit Event").'"><i class="fa fa-pencil"></i>'.$this->translate("Edit Event").'</a>';
        }    
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')){
    ...
    if((isset($this->socialSharingActive) || isset($this->likeButtonActive) || isset($this->favouriteButtonActive) || isset($this->listButtonActive)) && $event->is_approved) {
      ...
      if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') || $event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')) {
        ...
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') ){
          $shareOptionsPinView  .='<a href="'.$this->url(array('event_id' => $event->custom_url,'action'=>'edit'), 'sesevent_dashboard', true).'"  title="'.$this->translate("Edit Event").'"><i class="fa fa-pencil"></i>'.$this->translate("Edit Event").'</a>';
        }    
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')){
    ...
    if((isset($this->socialSharingActive) || isset($this->likeButtonActive) || isset($this->favouriteButtonActive) || isset($this->listButtonActive)) && $event->is_approved) {
      ...
      if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') || $event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')) {
        ...
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') ){
          $shareOptionsmasonryView  .='<a href="'.$this->url(array('event_id' => $event->custom_url,'action'=>'edit'), 'sesevent_dashboard', true).'"  title="'.$this->translate("Edit Event").'"><i class="fa fa-pencil"></i>'.$this->translate("Edit Event").'</a>';
        }    
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')){
    ...
    $shareoptionsAdv = '';
      ...
      if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') || $event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')){
        ...
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit') ){
          $shareoptionsAdv  .='<a href="'.$this->url(array('event_id' => $event->custom_url,'action'=>'edit'), 'sesevent_dashboard', true).'"  title="'.$this->translate("Edit Event").'"><i class="fa fa-pencil"></i>'.$this->translate("Edit Event").'</a>';
        }    
        if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')){
    ...
    <?php $list = "<li class='sesevents_list_view sesbm sesbasic_clearfix sesbasic_bxs'>
     ...
     <?php
      ...
      $list .=	 "</div>";
		...
		<?php		
  if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'edit')){
     $list  .= '<div  class="sesevent_list_options"><a href="'.$this->url(array('event_id' => $event->custom_url,'action'=>'edit'), 'sesevent_dashboard', true).'"  title="'.$this->translate("Edit Event").'" class="sesbasic_button fa fa-pencil"></i>'.$this->translate("Edit Event").'</a>';
  }
	if($event->authorization()->isAllowed(Engine_Api::_()->user()->getViewer(), 'delete')){
  ...
  $category_id =  !empty($categoryItem->category_id) ? $categoryItem->category_id : 0;
    ...
    if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive) || isset($this->verifiedLabel)) {
     ...
     if(isset($this->joinedcountActive)){
      	 ...
      	 $joinedmember =	"<div title=\"$guestCount\" class=\"sesevent_list_stats\"><span><i class=\"fa fa-users sesbasic_text_light\"></i>$guestCount</span></div>";
      }
...
<?php elseif( preg_match("/category_id=/", $_SERVER['REQUEST_URI'] )): ?>
  ...
  <div class="sesevent_noevent_tip clearfix">
    <img src="<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesevent_event_no_photo', 'application/modules/Sesevent/externals/images/event-icon.png'); ?>" alt="" />
