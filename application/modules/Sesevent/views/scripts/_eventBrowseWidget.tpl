 ...
 ?>
  <?php 
   ...
   $stats .= '</div>';
    ...
    $advGrid = "<li class='sesbasic_item_grid sesevent_item_grid sesbasic_clearfix sesbasic_bxs sesbasic_item_grid_btns_wrap sesbm' style='width:$advgridWidth;height:$advgridHeight'>
    ...
    <?php
      ...
      '<a href="'.$event->getHref().'" class="sesbasic_item_grid_thumb_img floatL">
        ...
        <div class="sesbasic_item_grid_thumb_overlay"></div>
			...
			?>
      <?php $eventApi = Engine_Api::_()->sesevent(); ?>
     <?php if(!$event->draft){ 
      ...
      <div class="sesbasic_item_grid_date">
        <span class="day">'.$eventApi->dateFormat($event->starttime,$event->starttime,$event,'d',1).'</span>
        <span class="month">'.$eventApi->dateFormat($event->starttime,$event->starttime,$event,'M',1).'</span>
        <span class="year">'.$eventApi->dateFormat($event->starttime,$event->starttime,$event,'Y',1).'</span>
      </div>
    ...
    <div class="sesbasic_item_grid_info  sesbasic_clearfix">';?>    
      ...
      <?php if(isset($this->hostActive) && $host){ ?>
	     <?php
			 	$advGrid .= 
				'<div class="sesevent_list_stats">
    ...
    <?php $grid = "<li style='width:$photoWidth;' class='sesevent_grid1 sesbasic_bxs sesbm'>
      ...
      $grid .= "<div class='sesevent_list_host sesbasic_clearfix'>
       ...
       $grid .= $location.$eventStartEndDate
        ."
      	<div class='sesevent_list_stats'>$statstics </div></br></br>
        $showDescription 
  ...
  <?php if(isset($this->show_item_count) && $this->show_item_count){ ?>
   ...
   <?php } ?>
    ...
    <ul id="sesevent_grid_view_<?php echo $randonNumber;?>" class="sesevent_grid_view sesbasic_clearfix clear" <?php if($this->view_type != 'grid'):?> style="display:none;" <?php endif;?> >
