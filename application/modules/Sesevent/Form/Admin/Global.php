...
class Sesevent_Form_Admin_Global extends Engine_Form {
  ...
  public function init() {
    ...
    if ($settings->getSetting('sesevent.pluginactivated')) {
	    ...
	    $this->addElement('Radio', 'sesevent_enable_welcome_logged_in', array(
	          'label' => 'Event Main Menu Redirection For Logged In Users',
	          'description' => 'Choose from below where do you want to redirect logged in users when Event Menu item is clicked in the Main Navigation Menu Bar.',
	          'multiOptions' => array(
	              1 => 'Event Welcome Page',
	              0 => 'Event Home Page',
				  2 => 'Event Browse Page',
				  3 => 'Browse Lists Page',
				  4 => 'Browse Categories Page',
				  5 => 'Browse Hosts Page',
	          ),
	          'value' => $settings->getSetting('sesevent.enable.welcome.logged.in', 1),
	      ));
	    $this->addElement('Radio', 'sesevent_enable_welcome_nonlogged_in', array(
	          'label' => 'Event Main Menu Redirection For Non-Logged In Users',
	          'description' => 'Choose from below where do you want to redirect non-logged in users when Event Menu item is clicked in the Main Navigation Menu Bar.',
	          'multiOptions' => array(
	              1 => 'Event Welcome Page',
	              0 => 'Event Home Page',
				  2 => 'Event Browse Page',
	          ...
	          'value' => $settings->getSetting('sesevent.enable.welcome.nonlogged.in', 1),
	      ));
