...
class Sesevent_Form_Admin_EventCreatePageSettings extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('Event Create Page Settings')
		...
		$this->addElement('Radio', 'sesevent_show_tinymce', array(
        'label' => 'Enable WYSIWYG Editor for Description',
        'description' => 'Do you want to enable WYSIWYG Editor for description for event create page?',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('sesevent.show.tinymce', 1),
    ));
	    ...
	    $this->addElement('Select', 'sesevent_eevecremainphoto', array(
	     ...
	     $this->addElement('Radio', "page_popup_create_event", array(
            'label' => 'Page or Popup for "Create New Event"',
            'description' => "Do you want to open Page or Popup for Create New Event?",
            'multiOptions' => array(
                '1' => 'Yes',
                '0' => 'No',
            ),
            'value' => $settings->getSetting('page.popup.create.event', 0),
        ));     
