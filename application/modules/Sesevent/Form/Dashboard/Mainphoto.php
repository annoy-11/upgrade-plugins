...
class Sesevent_Form_Dashboard_Mainphoto extends Engine_Form {
    ...
    $sesevent = Engine_Api::_()->core()->getSubject();        
      ...
      $this->addElement('Dummy', 'removeimage', array(
        'content' => '<a class="icon_cancel form-link" id="removeimage1" style="display:none; "href="javascript:void(0);" onclick="removeImage();"><i class="fa fa-trash-o"></i>'.$translate->translate('Change Photo').'</a>',
      ));
