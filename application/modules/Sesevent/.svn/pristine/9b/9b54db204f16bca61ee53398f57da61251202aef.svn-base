          ...
          <?php if( $this->mine || $this->canEdit || $editItem || $deleteItem || $createItem): ?>
            <span class="sesevent_album_cover_user_options_drop_btn" id="sesevent_dropdown_btn">
              ...
              <div class="sesbasic_option_box sesevent_album_option_box1">
                <?php if($createItem){ ?>
                  <a href="<?php echo $this->url(array('module' => 'sesevent', 'action' => 'create', 'album_id' => $this->album_id), 'sesevent_specific_album', true); ?>">
                  	<i class="fa fa-plus"></i>
                    <?php echo $this->translate('Add More Photos'); ?>
                  </a>
                <?php } ?>
                <?php if($editItem){ ?>
                  <a href="<?php echo $this->url(array('module' => 'sesevent', 'action' => 'edit', 'album_id' => $this->album_id), 'sesevent_specific_album', true); ?>"><i class="fa fa-pencil"></i><?php echo $this->translate('Edit Settings'); ?></a>
                  <a href="<?php echo $this->url(array('module' => 'sesevent', 'action' => 'editphotos', 'album_id' => $this->album_id), 'sesevent_specific_album', true); ?>"><i class="fa fa-pencil"></i><?php echo $this->translate('Edit Photos'); ?></a>
                <?php } ?>
                <?php if($deleteItem){ ?>
                  <a class="smoothbox" href="<?php echo $this->url(array('module' => 'sesevent', 'action' => 'delete', 'album_id' => $this->album_id, 'format' => 'smoothbox'), 'sesevent_specific_album', true); ?>"><i class="fa fa-trash"></i><?php echo $this->translate('Delete Album'); ?></a>
                <?php } ?>
