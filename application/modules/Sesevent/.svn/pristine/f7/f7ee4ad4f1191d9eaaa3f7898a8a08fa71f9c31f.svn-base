      ...
      <div class="sesevent_mytickets_list_options">
        ...
        <div>
          <a target="_blank" href="<?php echo $this->url(array('action' => 'print-ticket', 'order_id' => $order->order_id, 'event_id' => $event->custom_url,'format'=>'smoothbox'), 'sesevent_order', true) ?>">
            <i class="fa fa-print sesbasic_text_light"></i><?php echo $this->translate("Print Ticket"); ?>
          </a>
        </div>
        <div>
        ...
        <div>
            <a href="<?php echo $this->url(array('action' => 'email-ticket', 'order_id' => $order->order_id, 'event_id' => $event->custom_url), 'sesevent_order', true) ?>"><i class="fa fa-envelope sesbasic_text_light"></i><?php echo $this->translate("Email Ticket"); ?></a>
        </div>
      </div>
    </div>
  </div>
