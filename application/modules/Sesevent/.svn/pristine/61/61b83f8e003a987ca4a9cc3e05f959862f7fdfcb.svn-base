...
<div id="cancel_new_host-wrapper" class="form-wrapper" style="display:none">
  <div id="cancel_new_host-element" class="form-element"><a class="host_new_detail form-link" href="javascript:;" id="cancel_new_host" type="button" name="cancel_new_host" ><i class="fa fa-close"></i><?php echo $this->translate("Cancel") ?></a> </span></div>
</div>
...
<div id="add_new_host" style="display:none;">
  ...
  <div id="removeimagehost-wrapper" class="form-wrapper" style="display:none">
    <div id="removeimagehost-element" class="form-element"><a class="icon_cancel form-link" id="removeimage1host" style="display:none; " href="javascript:void(0);" onclick="removeImagehost();"><i class="fa fa-trash-o"></i><?php echo $this->translate('Remove');?></a></div>
  </div>  
  ...
  <div id="social_share_options_host" class="sesevent_create_host_social_wrapper" style="display:none">
    <div id="facebook_url-wrapper" class="form-wrapper">
      <div id="facebook_url-label" class="form-label">
        <label for="facebook_url" class="optional"><i class="fa fa-facebook-square"></i><?php echo $this->translate("Host Facebook URL") ?></label>
      </div>
    ...
    <div id="twitter_url-wrapper" class="form-wrapper">
      <div id="twitter_url-label" class="form-label">
        <label for="twitter_url" class="optional"><i class="fa fa-twitter-square"></i><?php echo $this->translate("Host Twitter URL") ?></label>
      </div>
    ...
    <div id="linkdin_url-wrapper" class="form-wrapper">
      <div id="linkdin_url-label" class="form-label">
        <label for="linkdin_url" class="optional"><i class="fa fa-linkedin-square"></i><?php echo $this->translate("Host LinkedIn URL") ?></label>
      </div>
    ...
    <div id="googleplus_url-wrapper" class="form-wrapper">
      <div id="googleplus_url-label" class="form-label">
        <label for="googleplus_url" class="optional"><i class="fa fa-google-plus-square"></i><?php echo $this->translate("Host Google Plus URL") ?></label>
      </div>
