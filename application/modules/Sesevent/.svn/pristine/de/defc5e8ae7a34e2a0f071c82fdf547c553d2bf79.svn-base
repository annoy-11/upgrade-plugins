      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="table_options">
            ...
            <?php echo $this->htmlLink($this->url(array('action' => 'view', 'order_id' => $item->order_id, 'event_id' => $event->custom_url,'format'=>'smoothbox'), 'sesevent_order', true), $this->translate("Print Invoice"), array('class' => 'fa fa-print','target'=>'_blank')); ?>
            <?php echo $this->htmlLink($this->url(array('action' => 'print-ticket', 'order_id' => $item->order_id, 'event_id' => $event->custom_url,'format'=>'smoothbox'), 'sesevent_order', true), $this->translate("Print Ticket"), array('class' => 'fa fa-ticket','target'=>'_blank')); ?>
            <?php echo $this->htmlLink($this->url(array('event_id' => $event->custom_url,'action'=>'search-ticket','order_id'=>$item->order_id), 'sesevent_order', true), $this->translate("View Tickets"), array('class' => 'sesevent_search_ticket_search fa fa-eye','data-rel'=>$item->order_id)); ?>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
