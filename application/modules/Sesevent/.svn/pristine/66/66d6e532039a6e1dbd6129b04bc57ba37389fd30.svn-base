...
<div class='sesevent_owner_contact_details sesbasic_clearfix sesbasic_bxs'>
  <ul>
    ...
    <li class="sesevent_owner_contact_social" style="display: none;">
      <?php if( in_array('facebook',$this->info) && $this->subject->event_contact_facebook): ?>
        <a target="_blank" href='<?php echo parse_url($this->subject->event_contact_facebook, PHP_URL_SCHEME) === null ? 'https://' . $this->subject->event_contact_facebook : $this->subject->event_contact_facebook; ?>' title='<?php echo $this->translate("Facebook URL"); ?>'><i class="fa fa-facebook-square"></i></a>
      <?php endif ?>

      <?php if( in_array('linkedin',$this->info) && $this->subject->event_contact_linkedin): ?>
        <a target="_blank" href='<?php echo parse_url($this->subject->event_contact_linkedin, PHP_URL_SCHEME) === null ? 'https://' . $this->subject->event_contact_linkedin : $this->subject->event_contact_linkedin; ?>' title='<?php echo $this->translate("Linkedin URL"); ?>'><i class="fa fa-linkedin-square"></i></a>
      <?php endif ?>
      <?php if( in_array('twitter',$this->info) && $this->subject->event_contact_twitter): ?>
        <a target="_blank" href='<?php echo parse_url($this->subject->event_contact_twitter, PHP_URL_SCHEME) === null ? 'https://' . $this->subject->event_contact_twitter : $this->subject->event_contact_twitter; ?>' title='<?php echo $this->translate("Twitter URL"); ?>'><i class="fa fa-twitter-square"></i></a>
      <?php endif ?>
      <?php if( in_array('website',$this->info) && $this->subject->event_contact_website): ?>
