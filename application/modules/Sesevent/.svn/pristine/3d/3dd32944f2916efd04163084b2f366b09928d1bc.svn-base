          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table_options">
                <?php echo $this->htmlLink($this->url(array('event_id' => $this->event->custom_url,'action'=>'edit','id'=>$item->sponsorship_id), 'sesevent_sponsorship', true), $this->translate(""), array('title' => $this->translate("Edit Sponsorship"), 'class' => 'fa fa-pencil')) ?>
