          ...
          <tbody>
            ...
            <?php $ticketSold = Engine_Api::_()->sesevent()->purchaseTicketCount($this->event_id,$item->ticket_id) ?>
              ...
              <td class="table_options">
                <?php echo $this->htmlLink($this->url(array('event_id' => $this->event->custom_url,'action'=>'edit-ticket','ticket_id'=>$item->ticket_id), 'sesevent_dashboard', true), $this->translate(""), array('class' => 'fa fa-pencil','title'=>$this->translate("Edit Ticket"))) ?>
                <?php echo $this->htmlLink($this->url(array('event_id' => $this->event->custom_url,'action'=>'delete-ticket','ticket_id'=>$item->ticket_id), 'sesevent_dashboard', true), $this->translate(""), array('class' => 'sesevent_ajax_delete fa fa-trash','data-value'=>'Are you sure want to delete this ticket? It will not be recoverable after being deleted.','title'=>$this->translate("Delete Ticket"))) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
