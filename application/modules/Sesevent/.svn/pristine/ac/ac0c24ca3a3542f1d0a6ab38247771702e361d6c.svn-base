 ...
 * @version    $Id: manage-payment-event-owner.tpl 2016-07-26 00:00:00 SocialEngineSolutions $
        ...
        <table class='admin_table'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesevent', 'controller' => 'admin-tickets', 'action' => 'view-paymentrequest', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
