...
function sesTopicThank(resource_id, resource_type, topicuser_id) {
  ...
  en4.core.request.send(new Request.JSON({
    url: en4.core.baseUrl + 'sesgroupforum/index/thank',
    data: {
      format: 'json',
      'thank_id': thank_id,
