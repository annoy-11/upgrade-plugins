          ...
          <?php foreach ($this->paginator as $item): ?>
            <tr>
              ...
              <td>
                ...
                |
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesgroupforum', 'controller' => 'manage-topics', 'action' => 'delete', 'id' => $item->topic_id), $this->translate("delete"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
