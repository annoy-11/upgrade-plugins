 ...
 * @version    $Id: support.tpl 2019-06-05 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<?php include APPLICATION_PATH .  '/application/modules/Sesgroupforum/views/scripts/dismiss_message.tpl';?>
<div class="sesbasic_support_links">
  <a href="https://www.socialenginesolutions.com/social-engine/advanced-forum-plugin/" target="_blank">
    <img src="application/modules/Sesbasic/externals/images/support/details.png" />
    <h4>Detailed Description</h4>
    <p>Read all the details about this plugin on its description page.</p>
  </a>
  <a href="https://www.socialenginesolutions.com/plugins/advancedforums/screenshots.html" target="_blank">
    <img src="application/modules/Sesbasic/externals/images/support/screenshots.png" />
    <h4>Screenshots</h4>
    <p>View all the screenshots to know how this plugin look & work.</p>
  </a>
  <a href="https://www.help.socialenginesolutions.com/faqs/category/advanced-forums-plugin" target="_blank">
  ...
  <a href="https://www.socialenginesolutions.com/contact-us/" target="_blank">
    <img src="application/modules/Sesbasic/externals/images/support/custom.png" />
  ...
  <a href="http://community.socialengine.com/profile/SocialEngineSolutions" target="_blank">
    <img src="application/modules/Sesbasic/externals/images/support/help.png" />
  ...
  <a href="https://www.socialenginesolutions.com/tag/advancedforums/" target="_blank">
  ...
  <a href="https://www.socialengine.com/marketplace/app/advanced-forums-plugin-1" target="_blank">
...
<div class="sesbasic_support_social_buttons">
	<ul>
  	<li class="_facebook">
    	<a href="https://www.facebook.com/SocialEngineSolutions" target="_blank">
    ...
    <li class="_youtube">
    	<a href="https://www.youtube.com/playlist?list=PLgIsRqQfJN_F3xPPpKMQGTr-K6l7zorva" target="_blank">
...
<div class="sesbasic_support_contact_links">
    ...
    <li>
    	<i><img src="application/modules/Sesbasic/externals/images/support/ses-icon.png" /></i>
    	<span><a href="https://www.socialenginesolutions.com" target="_blank">SocialEngineSolutions</a></span>
    </li>
  </ul>
</div>
