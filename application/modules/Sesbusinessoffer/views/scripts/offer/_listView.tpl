...
<li class="sesbasic_bg sesbusinessoffer_list_item" id="sesbusinessoffer_manage_listing_item_<?php echo $item->getIdentity(); ?>">
  ...
  <article class="sesbasic_clearfix">
    ...
    <div class="_contleft">
      ...
      <div class="sesbusinessoffer_profile_inner">
        ...
        <a href="<?php echo $item->getHref();?>" class="sesbusinessoffer_profile_img"  style="width:<?php echo @$width ?>px;height:<?php echo @$height ?>px;"><span style="background-image:url(<?php echo $item->getPhotoUrl() ?>);"></span></a>
