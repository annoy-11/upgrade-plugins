 ...
 * @version    $Id: Search.php  2019-03-30 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusinessoffer_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'sesbusinessoffer', 'controller' => 'index', 'action' => 'index'), 'default', true));
