 ...
 */
class Sesbusinessoffer_Form_Admin_Settings_Level extends Authorization_Form_Admin_Level_Abstract
{
  public function init()
  {
    ...
    $this->addElement('Radio', 'view', array(
      ...
      'description' => 'Do you want to let members view offers? If set to no, some other settings on this business may not apply.',
      'multiOptions' => array(
    ...
    if( !$this->isPublic() ) {
      ...
      $this->addElement('Radio', 'create', array(
        ...
        'description' => 'Do you want to let members create offers? If set to no, some other settings on this business may not apply. This is useful if you want members to be able to view offers, but only want certain levels to be able to create offers.',
        'multiOptions' => array(
      ...
      $this->addElement('Radio', 'edit', array(
        ...
        'description' => 'Do you want to let members edit offers? If set to no, some other settings on this business may not apply.',
        'multiOptions' => array(
      ...
      $this->addElement('Radio', 'delete', array(
        ...
        'description' => 'Do you want to let members delete offers? If set to no, some other settings on this business may not apply.',
        'multiOptions' => array(
      ...
      $this->addElement('MultiCheckbox', 'auth_view', array(
        ...
        'description' => 'Your members can choose from any of the options checked below when they decide who can see their offer entries. These options appear on your members\' "Add Entry" and "Edit Entry" businesses. If you do not check any options, settings will default to the last saved configuration. If you select only one option, members of this level will not have a choice.',
        'multiOptions' => array(
          'everyone'            => 'Everyone',
