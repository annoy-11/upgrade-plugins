...
class Sesbusinessoffer_Form_Create extends Engine_Form {
  ...
  public function init()
  {
    ...
    // Element: auth_view
    $viewOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('businessoffer', $user, 'auth_view');
    ...
    $commentOptions = (array) Engine_Api::_()->authorization()->getAdapter('levels')->getAllowed('businessoffer', $user, 'auth_comment');
