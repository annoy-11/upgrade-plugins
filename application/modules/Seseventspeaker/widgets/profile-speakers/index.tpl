...
<script type="text/javascript">
  function loadMore() {
    ...
    en4.core.request.send(new Request.HTML({
      method: 'post',              
      'url': en4.core.baseUrl + 'widget/index/mod/seseventspeaker/name/profile-speakers',
      'data': {
        format: 'html',
...
<?php if(count($this->paginator) > 0): ?>
  ...
  <?php endif; ?>
  <?php foreach ($this->paginator as $speaker):
  $speaker = Engine_Api::_()->getItem('seseventspeaker_speakers', $speaker->speaker_id)
   ?>
    <li class="sesspeaker_list_item sesbasic_clearfix sesbasic_bxs sesevent_grid_btns_wrap" style="width:<?php echo $this->width ?>px;">
    	<div class="sesspeaker_list_item_inner prelative sesbasic_clearfix">
        <div class="sesspeaker_list_item_thumb prelative" style="height:<?php echo $this->height ?>px;">
        <span class="sesspeaker_list_item_thumb_img" style="background-image:url(<?php echo $speaker->getPhotoUrl(); ?>);"></span>
          <a class="sesspeaker_list_item_thumb_overlay" href="<?php echo $speaker->getHref(); ?>"></a>
        ...
        <div class="sesspeaker_list_item_details sesbasic_clearfix">
          <div class="sesspeaker_list_item_title">
            <?php echo $this->htmlLink($speaker->getHref(), $speaker->name); ?>
          </div>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate('There are currently no speakers.') ?>
    </span>
  </div>
<?php endif; ?>
