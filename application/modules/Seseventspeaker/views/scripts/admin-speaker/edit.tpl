 ...
 * @version    $Id: edit.tpl 2017-03-16 00:00:00 SocialEngineSolutions $
...
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seseventspeaker', 'controller' => 'speaker', 'action' => 'index'), $this->translate("Back to Manage Speaker"), array('class'=>'sesbasic_icon_back buttonlink')) ?>
<br class="clear" /><br />
