 ...
 * @version    $Id: Global.php 2017-03-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */


class Seseventspeaker_Form_Admin_Global extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('Global Settings')
		...
		$this->addElement('Text', "seseventspeaker_licensekey", array(
      'label' => 'Enter License key',
      'description' => $descriptionLicense,
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('seseventspeaker.licensekey'),
		));
		$this->getElement('seseventspeaker_licensekey')->getDecorator('Description')->setOptions(array('placement' => 'PREPEND', 'escape' => false));
		
		if ($settings->getSetting('seseventspeaker.pluginactivated')) {
      // Add submit button
