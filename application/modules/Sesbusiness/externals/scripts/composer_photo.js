...
Composer.Plugin.Sesbusinessphoto = new Class({

  Extends : Composer.Plugin.Interface,

  name : 'sesbusiness_photo',
  ...
  activate : function() {
    ...
    if(sesJqueryObject('#toValues-wrapper').length > 0){
      sesJqueryObject('#toValues-wrapper').append('<div><input type="hidden" value="1" id="messageAttachment" name="attachment[messageAttachment]"><input type="hidden" value="" id="fancyalbumuploadfileids" name="attachment[photo_id]"><input type="hidden" value="sesbusiness_photo" id="photosesbusiness" name="attachment[type]"></div>');  
    }else if(sesJqueryObject('#submit-wrapper').length > 0){
      sesJqueryObject('#body-wrapper').append('<div><input type="hidden" value="1" id="messageAttachment" name="attachment[messageAttachment]"><input type="hidden" value="sesbusiness_photo" id="photosesbusiness" name="attachment[type]"><input type="hidden" value="" id="fancyalbumuploadfileids" name="attachment[photo_id]"></div>');    
    }
  ...
  deactivate : function() {
    ...
    sesJqueryObject('#photosesbusiness').remove();
