 ...
 */
class Sesbusiness_Model_DbTable_Photos extends Engine_Db_Table {

  protected $_rowClass = 'Sesbusiness_Model_Photo';
	public function getPhotoSelect($params = array())
  {
    ...
    if( !empty($params['album']) && $params['album'] instanceof Sesbusiness_Model_Album ) {
