 ...
 * @version    $Id: Favourites.php  2018-07-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusiness_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Sesbusiness_Model_Favourite";
  ...
  public function getItemfav($resource_type, $itemId) {
    $tableFav = Engine_Api::_()->getDbTable('favourites', 'sesbusiness');
