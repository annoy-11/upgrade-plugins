 ...
 * @version    $Id: Photo.php  2018-07-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusiness_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'sesbusiness_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'sesbusiness_album';

  public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'sesbusiness_photo_view',
        'reset' => true,
        'controller' => 'photo',
        'action' => 'view',
  ...
  public function getParent() {
    return Engine_Api::_()->getItem('businesses',$this->business_id);
  }
  public function getAlbum() {
    return Engine_Api::_()->getItem('sesbusiness_album', $this->album_id);
  }
  ...
  public function getAuthorizationItem() {
    return $this->getParent('businesses');
  }
  ...
  */
  public function getAlbumPhotoUrl($type = null) {
    ...
    if( !$photo_id ) {
      return 'application/modules/Sesbusiness/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
