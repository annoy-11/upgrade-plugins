 ...
 */
class Sesbusiness_Model_Album extends Core_Model_Item_Collection {

  protected $_parent_type = 'businesses';
  protected $_owner_type = 'businesses';
  protected $_children_types = array('sesbusiness_photo');
  protected $_collectible_type = 'sesbusiness_photo';
  ...
  public function getAuthorizationItem() {
    $business = Engine_Api::_()->getItem('businesses',$this->business_id);
    if(!$business)
      return false;
    else
    return $business;
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sesbusiness/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
