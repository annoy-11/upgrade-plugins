 ...
 * @version    $Id: BusinessOfTheDay.php  2018-07-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusiness_Form_Admin_BusinessOfTheDay extends Engine_Form {

  public function init() {

    $this->setTitle('Business of the Day')
            ->setDescription('Displays the Business of The day as selected by the admin from the edit setting of this widget.');
