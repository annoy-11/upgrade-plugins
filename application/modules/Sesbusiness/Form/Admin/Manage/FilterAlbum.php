...
class Sesbusiness_Form_Admin_Manage_FilterAlbum extends Engine_Form
{

	protected $_creationDate;
	protected $_albumTitle;
	//protected $_businessTitle;

// 	public function setBusinessTitle($title) {
...
//   }
  ...
  public function init()
  {
    ...
    $businesstitlename = new Zend_Form_Element_Text('businesstitle');
    $businesstitlename
