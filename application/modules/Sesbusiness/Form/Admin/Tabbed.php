...
class Sesbusiness_Form_Admin_Tabbed extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Select', "openViewType", array(
        'label' => "Choose Default View Type (apply if more than 1 view type is selected.) (Note: In \"Tabbed widget for Manage Businesses\" only List View will work.)",
        'multiOptions' => array(
            'list' => 'List View',
            'advlist' => 'Advance List View',
            'grid' => 'Grid View',
...
',
    ...
    $this->addElement('Select', "show_limited_data", array(
        'label' => 'Show only the number of businesses entered in the setting for Count of each view. [If you choose No, then you can choose how do you want to show more businesses in this widget.]',
        'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
