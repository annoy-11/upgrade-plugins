 ...
 */
class Sesbusiness_Form_Admin_Categorywidget extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($banner_options) > 1) {
      $this->addElement('Select', 'sesbusiness_categorycover_photo', array(
          'label' => 'Business Category Default Cover Photo',
          'description' => 'Choose a default cover photo for the business categories on your website. [Note: Add a new photo from the "File & Media Manager" section. For default cover photo, leave the field blank.]',
    ...
    $this->addElement('Select', "show_popular_businesses", array(
        'label' => "Do you want to show popular businesses in this widget",
        'multiOptions' => array('1' => 'Yes,want to show popular business', 0 => 'No,don\'t want to show popular businesses'),
        'value' => 1,
    ));
    $this->addElement('Text', "title_pop", array(
        'label' => "Enter the title for businesses section.",
        'value' => 'Popular Businesses',
    ));
    $this->addElement('Select', 'order', array(
        'label' => "Choose criteria for businesses to be show in this widget.",
        'multiOptions' => array(
            '' => 'All Businesses',
            'open' => 'Open',
            'close' => 'Close',
    ...
    $this->addElement('Text', 'height_advgrid', array(
        'label' => 'Enter the height of business (in pixels)',
        'value' => '180',
        'validators' => array(
            array('Int', true),
            array('GreaterThan', true, array(0)),
