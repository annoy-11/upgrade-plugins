 ...
 * @version    $Id: AlbumSearch.php  2018-07-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusiness_Form_AlbumSearch extends Engine_Form {
  ...
  public function init() {
    ...
    $searchFor = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'sesbusiness','controller'=>'album','action'=>'browse'));
    ...
    $this->addElement('Button', 'submit', array(
      ...
      'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="sesbusiness-category-widget-img" alt="Loading" />',
   ));
  }
}
