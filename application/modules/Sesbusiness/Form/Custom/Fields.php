 ...
 * @version    $Id: Fields.php  2018-07-13 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesbusiness_Form_Custom_Fields extends Engine_Form {
  /* Custom */
  ...
  public function generate() {
    ...
    foreach ($struct as $fskey => $map) {
      ...
      //$params['options']['name'] = 'dsdad';
      $this->addElement($inflectedType, $key, $params['options']);

      $element = $this->getElement($key);
      $element->setAttrib('name', $finalKey);
  ...
  public function saveValues() {
    ...
    foreach ($fVals as $key => $value) {
      ...
      //echo "<pre>";var_dump($this->getElement($key)->toArray());
      // Array mode
