...
class Sesbusiness_Widget_LinkBusinessesController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    $businessId = (isset($_POST['business_id']) ? $_POST['business_id'] : 0);
    if ($businessId) {
      $subject = Engine_Api::_()->getItem('businesses', $businessId);
    } else {
    ...
    $this->view->business_id = $subject->business_id;
    ...
    $this->view->widgetName = 'link-businesses';
    ...
    $value['search'] = 1;
    $value['draft'] = "1";
    $value['link_business_id'] = $subject->business_id;
