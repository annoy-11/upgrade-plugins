...
<script type="text/javascript">
  ...
  <?php if(($this->popup || Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusiness.icon.open.smoothbox', 1)) && !Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusinesspackage.enable.package', 0)){ ?>
    ...
    sesJqueryObject('.sesbusiness_main_create').addClass('sessmoothbox');
  <?php } ?>
</script>
