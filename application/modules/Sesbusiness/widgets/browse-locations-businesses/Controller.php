 ...
 */
class Sesbusiness_Widget_BrowseLocationsBusinessesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'browse-locations-businesses';
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('businesses', 'sesbusiness')->getBusinessPaginator($params);
