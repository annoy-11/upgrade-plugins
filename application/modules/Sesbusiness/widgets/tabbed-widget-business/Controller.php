...
class Sesbusiness_Widget_TabbedWidgetBusinessController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'tabbed-widget-business  ';
