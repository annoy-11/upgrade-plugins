...
<?php endif;?>
<div class="sesbusiness_category_carousel_wrapper sesbusiness_carousel_h_wrapper ">
  <div class="slide sesbasic_clearfix sesbasic_bxs sesbusiness_slick_slider_container <?php echo $this->params['isfullwidth'] ? 'isfull_width' : '' ; ?>" style="height:<?php echo $this->params['height'] ?>px;display:none;">
    <div class="pageslide_<?php echo $this->identity; ?> sesbusiness_category_carousel">
      ...
      <?php endif;?>
      <div class="sesbusiness_category_carousel_item sesbasic_clearfix sesbusiness_grid_btns_wrap" style="height:<?php echo $this->params['height'] ?>px;width:<?php echo $this->params['width'] ?>px;">
        <div class="sesbusiness_category_carousel_item_thumb" style="height:<?php echo $this->params['height'] ?>px;width:<?php echo $this->params['width'] ?>px;">       
          <?php $href = $item->getHref(); $imageURL = $item->getPhotoUrl();?>
          <a href="<?php echo $href; ?>" class="sesbusiness_list_thumb_img">
          ...
          $urlencode = urlencode(((!empty($_SERVER["HTTPS"]) &&  strtolower($_SERVER["HTTPS"]) == 'on') ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . $item->getHref()); ?>
            <div class="sesbusiness_grid_btns"> 
          ...
          <div class="sesbusiness_category_carousel_item_info sesbasic_clearfix centerT">
            <?php if(isset($this->titleActive) ){ ?>
              <span class="sesbusiness_category_carousel_item_info_title">
            ...
            <?php } ?>
             ...
             <span class="sesbusiness_category_carousel_item_info_des">
            ...
            <?php } ?>
            <?php if(isset($this->countBusinessesActive) ){ ?>
              <span class="sesbusiness_category_carousel_item_info_stat">
                <?php echo $this->translate(array('%s Business', '%s Businesses',$item->total_business_categories), $this->locale()->toNumber($item->total_business_categories)); ?>
              </span>
            <?php } ?>
            <?php if($showFollowButton && isset($this->followButtonActive)):?>
              <span class="sesbusiness_category_carousel_item_info_button">
...
<script type="text/javascript">
  window.addEvent('domready', function () {
		<?php if($this->params['isfullwidth']){ ?>
			...
			htmlElement.addClass('sesbusiness_category_carousel');
		<?php } ?>
