...
class Sesbusiness_Widget_CategoryCarouselController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = Engine_Api::_()->getDbTable('categories', 'sesbusiness')->getCategory($value);
