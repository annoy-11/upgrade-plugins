...
class Sesbusiness_Widget_SubBusinessesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'sub-businesses';
    ...
    $value['search'] = 1;
    $value['draft'] = "1";
    $value['parent_id'] = $subject->business_id;
