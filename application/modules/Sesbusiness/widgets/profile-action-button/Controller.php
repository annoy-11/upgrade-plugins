...
class Sesbusiness_Widget_ProfileActionButtonController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    if($this->_getParam('businesses')){
     $subject = Engine_Api::_()->getItemByGuid($this->_getParam('businesses'));
    }else{
    ...
    $canCall = Engine_Api::_()->getDbTable('callactions','sesbusiness')->getCallactions(array('business_id'=>$subject->getIdentity()));
