...
<div id="sesbasic_popup_slide" class="well" style="display:none">
  <div class="sesbasic_popup sesbasic_bxs">
    <div class="sesbasic_popup_title">
       <?php echo $this->translate("Share This ".ucfirst(str_replace(array('sesbusiness_',''),'',$this->subject()->getType()))); ?>
...
<?php if(isset($_SESSION['newBusiness']) && $_SESSION['newBusiness']){ ?>
	var autoOpen = true;
<?php }else{ ?>
	var autoOpen = false;
<?php } ?>
...
<?php unset($_SESSION['newBusiness']); ?>
});
</script>
