...
<?php if($this->editOverview){ ?>
  ...
  <div class="sesbasic_profile_tabs_top sesbasic_clearfix">
    <a href="<?php echo $this->url(array('business_id' => $this->subject->custom_url, 'action'=>'overview'), 'sesbusiness_dashboard', true); ?>" class="sesbasic_button <?php echo $overviewicon; ?>">
