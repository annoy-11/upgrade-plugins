...
class Sesbusiness_Widget_RecentlyViewedItemController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $value['type'] = 'businesses';
    $this->view->businesses = $paginator = Engine_Api::_()->getDbTable('recentlyviewitems', 'sesbusiness')->getitem($value);
