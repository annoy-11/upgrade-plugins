...
<?php $date = new Zend_Date(strtotime($business->creation_date), false, $locale);?>
<span class="_date sesbasic_text_light" title=""><?php echo $date->toString('jS M');?>,&nbsp;<?php echo date('Y', strtotime($business->creation_date));?></span>
