...
<?php if(count($this->existingleftpackages)): ?>
    ...
    <div class="sesbusiness_packages_transactions_btn">
      <a href="<?php echo $this->url(array('action' => 'transactions'),'sesbusiness_general',true);?>" class="sesbusiness_packages_create_btn sesbasic_animation"><?php echo $this->translate("See All Transactions");?></a>
    </div>
...
<?php else: ?>
  <div class="sesbasic_tip clearfix">
    <img src="application/modules/Sesbusinesspackage/externals/images/package-icon.png" alt="">
