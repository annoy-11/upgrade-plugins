...
<script type="text/javascript">
  ...
  sesJqueryObject('input[type=radio][name=business_attribution]').change(function() {
   if(this.value == 1){
 ...
 sesJqueryObject(document).ready(function(){
  ...
  sesJqueryObject('input[type=radio][name=business_attribution]:checked').trigger('change');
  sesJqueryObject('input[type=radio][name=auth_defattribut]:checked').trigger('change');  
    var x = document.getElementsByClassName("business_package");
    var i;
