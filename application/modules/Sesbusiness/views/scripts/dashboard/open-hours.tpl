...
?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesbusiness/externals/styles/jquery.timepicker.min.css'); ?>
...
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sesbusiness/externals/scripts/jquery.timepicker.min.js'); ?>
...
?><?php $hoursData = $this->hoursData; ?>
  <div class="sesbusiness_db_manage_hours sesbusiness_dashboard_form">
  	<form class="global_form" method="post">
    	<div>
          ...
          <div class="form-elements">
            ...
            <div class="form-wrapper sesbusiness_choose_day_wrapper">
...
sesJqueryObject('input[type=radio][name=hours]').change(function() {
  ...
  if(value != "selected"){
     sesJqueryObject('.sesbusiness_choose_day_wrapper').hide();
  }else{
     sesJqueryObject('.sesbusiness_choose_day_wrapper').show();
  }
});
...
sesJqueryObject(document).on('click','.addbtn',function(e){
  ...
  parent.append(html);
  sesbusinessTimePickerJqueryObject('input.timepicker').timepicker();
});
...
})(sesbusinessTimePickerJqueryObject);
</script>
