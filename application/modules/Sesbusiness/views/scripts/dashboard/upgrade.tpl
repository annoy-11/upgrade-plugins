...
<div class="sesbusiness_packages_main sesbasic_clearfix sesbasic_bxs sesbusiness_packages_upgrade">
  <?php if($this->currentPackage){ 
    $package = Engine_Api::_()->getItem('sesbusinesspackage_package',$this->currentPackage->package_id);
    if($package){
  ?>
  	<div class="sesbusiness_packages_main_header">
    	<h2><?php echo $this->translate("Existing Package")?></h2>
    </div>
    <div class="sesbusiness_packages_table_container">
      <ul class="sesbusiness_packages_list">
         <?php $enableModules = json_decode($package->params,true);?>
         <li class="sesbusiness_packages_list_item <?php echo ($package->highlight) ? 'active' : '' ?>">
          <section>
           <div class="_top sesbasic_clearfix">
              ...
              <div class="_price">
                ...
                <?php }elseif($package->recurrence_type == 'forever'){ ?>
                  <span><?php echo sprintf($this->translate('One-time fee of %1$s'), Engine_Api::_()->sesbusinesspackage()->getCurrencyPrice($package->price,'','',true)); ?></span>
                <?php }else{ ?>
            ...
            <div class="_cont sesbasic_clearfix">
              <div class="package_capabilities _features">
                ...
                <?php if(in_array('featured',$showinfo)){ ?>	
                  <div class="sesbasic_clearfix <?php echo ($enableModules['business_featured']) ? 'yes' : 'no'; ?>">
                  	<div>
                ...
                <?php if(in_array('sponsored',$showinfo)){ ?>  
                  <div class="sesbasic_clearfix <?php echo ($enableModules['business_sponsored']) ? 'yes' : 'no'; ?>">
                  	<div>
                ...
                <?php if(in_array('verified',$showinfo)){ ?>  
                  <div class="sesbasic_clearfix <?php echo ($enableModules['business_verified']) ? 'yes' : 'no'; ?>">
                  	<div>
                ...
                <?php if(in_array('hot',$showinfo)){ ?>  
                  <div class="sesbasic_clearfix <?php echo ($enableModules['business_hot']) ? 'yes' : 'no'; ?>">
                  	<div>
  ...
  <?php if(count($this->upgradepackage)){ ?>
  	<div class="sesbusiness_packages_main_header">
        ...
        <p><?php echo $this->translate('Choose a higher package to create businesses on this website and get benefited with advance features and functionalities.');?></p>
    </div>
    <div class="sesbusiness_packages_table_container">
      <ul class="sesbusiness_packages_list">
           ...
           <li class="sesbusiness_packages_list_item <?php echo ($package->highlight) ? 'active' : '' ?>">
            <section>
             <div class="_top sesbasic_clearfix">
              ...
              <div class="_btns">
                <a href="<?php echo $this->url(array('business_id' => $this->business->business_id,'action'=>'confirm-upgrade','package_id'=>$package->package_id), 'sesbusinesspackage_general', true); ?>" class="smoothbox sesbusiness_packages_create_btn sesbasic_animation"><?php echo $this->translate('Upgrade Package');?></a>
              </div>
            </section>
           </li> 
      	<?php } ?>     
