...
<?php } ?>
  <div class="sesbusiness_dashboard_form sesbusiness_dashboard_photo_form">
...
<script type="application/javascript">
  sesJqueryObject  (document).ready(function() {
	...
	sesJqueryObject('#business_main_photo_preview-element').append('<div id="removeimage-wrapper">'+removehtml+'</div>');
    ...
    obj.on('drop', function (e) {
      ...
      e.preventDefault();
      var files = e.originalBusiness.dataTransfer;
...
<?php
if ($this->business->background_photo_id !== null && $this->business->background_photo_id){ 
 $backgroundImage =	Engine_Api::_()->storage()->get($this->business->background_photo_id, '')->getPhotoUrl();?>
 ShowhandleFileBackgroundUpload('<?php echo $backgroundImage ?>','business_main_photo_preview');
<?php }else{ ?>
sesJqueryObject  (document).ready(function()
{
...
function removePhotoBusiness(url) {
