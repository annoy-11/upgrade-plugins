 ...
 * @version    $Id: post-attribution.tpl  2018-07-13 00:00:00 SocialEngineSolutions $
...
<div class="sesbusiness_dashboard_form">
  <div class="sesbusiness_dashboard_post_attribution prelative">
...
var isRequestSend = false;
  sesJqueryObject('input[type=radio][name=attribution]').change(function() {
    ...
    isRequestSend = true;
    sesJqueryObject.post(sesJqueryObject('#sesbusiness_attr_form').attr('href'),{value:value},function(response){
      isRequestSend = false;
