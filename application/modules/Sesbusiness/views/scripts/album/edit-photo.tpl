 ...
 * @version    $Id: edit-photo.tpl  2018-07-13 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  sesJqueryObject(document).on('click','#execute',function(e){
    ...
    request = new Request.JSON({
      'format' : 'json',
      'url' : '<?php echo $this->url(Array('controller' => 'album', 'action' => 'save-information'), 'sesbusiness_extended',true) ?>/photo_id/'+photo_id,
      'data': {
        'photo_id' : photo_id,
