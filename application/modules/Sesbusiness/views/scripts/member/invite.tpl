...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesbusiness/member/invite/business_id/' + '<?php echo $this->business->business_id; ?>' ,
      'data': {
        format: 'html',
...
<?php if( $this->paginator->getTotalItemcount() > 0 ): ?>
  ...
  <form method="post" id="sesbusinessinviteform" data-src="<?php echo $this->business->business_id; ?>">
    <div class="sesbusiness_invite_popup sesbasic_bxs">
      <div class="_header">
        <?php echo $this->translate('Invite Members') ?>
      </div>
      <div class="_content">
      <p class="_des"><?php echo $this->translate('Choose the people you want to invite to this business.') ?></p>
