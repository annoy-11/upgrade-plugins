...
<li class="sesbusiness_hlist_item sesbasic_clearfix">
    ...
    <div class="_thumb sesbusiness_thumb" style="height:<?php echo is_numeric($height)?$height.'px':$height ?>;width:<?php echo is_numeric($width)?$width.'px':$width ?>;">
      <a href="<?php echo $business->getHref();?>" class="floatL sesbusiness_thumb_img"><span class="bg_item_photo" style="background-image:url(<?php echo $business->getPhotoUrl('thumb.profile'); ?>);"></span></a>
    ...
    <div class="_cont">
      ...
      <?php endif;?>
      <?php if(Engine_Api::_()->getDbTable('modules', 'core')->isModuleEnabled('sesbusinessreview') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesvreview.pluginactivated')):?>
