...
<div class="sesbasic_view_stats_popup">
  ...
  <table>
    <tr>
      ...
      ?>
      <?php else: ?>
      <?php $path = $this->baseUrl() . '/application/modules/Sesbusiness/externals/images/nophoto_business_thumb_icon.png'; ?>
      <?php endif; ?>
    ...
    <?php if(strtotime($this->item->enddate) < strtotime(date('Y-m-d')) && $this->item->offtheday == 1){ 
                    Engine_Api::_()->getDbTable('businesses', 'sesbusiness')->update(array(
                        'offtheday' => 0,
                        'startdate' =>'',
                        'enddate' =>'',
                      ), array(
