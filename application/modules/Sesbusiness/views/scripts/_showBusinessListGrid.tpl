 ...
 * @version    $Id: _showBusinessListGrid.tpl  2018-07-13 00:00:00 SocialEngineSolutions $
...
<?php } ?>
    <?php if(isset($this->params['show_item_count']) && $this->params['show_item_count']){ ?>
      <div class="sesbasic_clearfix sesbm sesbusiness_search_result" style="display:<?php !$this->is_ajax ? 'block' : 'none'; ?>" id="<?php echo !$this->is_ajax ? 'paginator_count_sesbusiness' : 'paginator_count_ajax_sesbusiness_entry' ?>"><span id="total_item_count_sesbusiness_entry" style="display:inline-block;"><?php echo $this->paginator->getTotalItemCount(); ?></span> <?php echo $this->paginator->getTotalItemCount() == 1 ?  $this->translate("business found.") : $this->translate("businesses found."); ?></div>
    <?php } ?>
<?php if(!$this->is_ajax){ ?>
    <div class="sesbasic_view_type_options sesbasic_view_type_options_<?php echo $randonNumber; ?>">
      <?php if(is_array($this->optionsEnable) && in_array('list',$this->optionsEnable)){ ?>
        <a href="javascript:;" rel="list" id="sesbusiness_list_view_<?php echo $randonNumber; ?>" class="listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('List View') : '' ; ?>"></a>
      <?php } ?>
      <?php if(is_array($this->optionsEnable) && in_array('advlist',$this->optionsEnable)){ ?>
        <a href="javascript:;" rel="advlist" id="sesbusiness_advlist_view_<?php echo $randonNumber; ?>" class="a-listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'advlist') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Advanced List View') : '' ; ?>"></a>
      <?php } ?>
      <?php if(is_array($this->optionsEnable) && in_array('grid',$this->optionsEnable)){ ?>
        <a href="javascript:;" rel="grid" id="sesbusiness_grid_view_<?php echo $randonNumber; ?>" class="gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Grid View') : '' ; ?>"></a>
      <?php } ?>
      <?php if(is_array($this->optionsEnable) && in_array('simplegrid',$this->optionsEnable)){ ?>
        <a href="javascript:;" rel="simplegrid" id="sesbusiness_simplegrid_view_<?php echo $randonNumber; ?>" class="s-gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'simplegrid') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Plain Grid View') : '' ; ?>"></a>
      <?php } ?>
      <?php if(is_array($this->optionsEnable) && in_array('advgrid',$this->optionsEnable)){ ?>
        <a href="javascript:;" rel="advgrid" id="sesbusiness_advgrid_view_<?php echo $randonNumber; ?>" class="a-gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'advgrid') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Advanced Grid View') : '' ; ?>"></a>
      <?php } ?>
      <?php if(is_array($this->optionsEnable) && in_array('pinboard',$this->optionsEnable)){ ?>
        <a href="javascript:;" rel="pinboard" id="sesbusiness_pinboard_view_<?php echo $randonNumber; ?>" class="boardicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'pinboard') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Pinboard View') : '' ; ?>"></a>
     <?php } ?>
     <?php if(is_array($this->optionsEnable) && in_array('map',$this->optionsEnable) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusiness_enable_location', 1)){ ?>
        <a href="javascript:;" rel="map" id="sesbusiness_map_view_<?php echo $randonNumber; ?>" class="mapicon map_selectView_<?php echo $randonNumber;?> selectView_<?php echo $randonNumber;?> <?php if($this->view_type == 'map') { echo 'active'; } ?>" title="<?php echo ((isset($this->htmlTitle) && !empty($this->htmlTitle)) || (empty($this->htmlTitle) && !isset($this->htmlTitle)) ) ? $this->translate('Map View') : '' ; ?>"></a>
     <?php } ?>
    </div>
  </div>
<?php } ?>
...
<div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">
  <ul class="sesbusiness_business_listing sesbasic_clearfix clear <?php if($this->view_type == 'pinboard'):?>sesbasic_pinboard_<?php echo $randonNumber;?><?php endif;?>" id="tabbed-widget_<?php echo $randonNumber; ?>" style="min-height:50px;">
<?php } ?>
<?php foreach($this->paginator as $business):?>
  ...
  <?php endif;?> 
  <?php if(isset($this->widgetName) && $this->widgetName == 'manage-businesses' ):?>
   	<?php $height = $this->params['height'];?>
    <?php $width = $this->params['width'];?>
    <?php $viewTypeClass = "sesbusiness_list_type";?>
    <?php include APPLICATION_PATH .  '/application/modules/Sesbusiness/views/scripts/business/_managelistView.tpl';?>
  <?php else:?>
    ...
    <?php elseif($this->view_type == 'advlist'):?>
      ...
      <?php $viewTypeClass = "sesbusiness_list_type";?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesbusiness/views/scripts/business/_advListView.tpl';?>
    <?php elseif($this->view_type == 'list'):?>
      <?php $height = $this->params['height'];?>
      <?php $width = $this->params['width'];?>
      <?php $viewTypeClass = "sesbusiness_list_type";?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesbusiness/views/scripts/business/_listView.tpl';?>
    <?php elseif($this->view_type == 'advgrid'):?>
      <?php $height = $this->params['height_advgrid'];?>
      <?php $width = $this->params['width_advgrid'];?>
      <?php $viewTypeClass = "sesbusiness_list_type sesbasic_animation";?>
    ...
    <?php elseif($this->view_type == 'map'):?>
      ...
      <?php if($business->lat): ?>
		...
		<?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive)):?>
          <?php $labels .= "<div class=\"sesbusiness_list_labels\">";?>
		  <?php if(isset($this->featuredLabelActive) && $business->featured == 1):?>
            <?php $labels .= "<span class=\"sesbusiness_label_featured\" title='".$this->translate('FEATURED')."'><i class='fa fa-star'></i></span>";?>
          <?php endif;?>
          <?php if(isset($this->sponsoredLabelActive) && $business->sponsored == 1):?>
            <?php $labels .= "<span class=\"sesbusiness_label_sponsored\" title='".$this->translate('SPONSORED')."'><i class='fa fa-star'></i></span>";?>
          <?php endif;?>
          <?php $labels .= "<span class=\"sesbusiness_label_hot\" title='".$this->translate('HOT')."'><i class='fa fa-star'></i></span>";?>
          <?php $labels .= "</div>";?>
		<?php endif;?>
		<?php $vlabel = '';?>
		<?php if(isset($this->verifiedLabelActive) && $business->verified == 1) :?>
          <?php $vlabel = "<i class=\"sesbusiness_label_verified sesbasic_verified_icon\" title=\"VERIFIED\"></i>";?>
		<?php endif;?>
		<?php if($business->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusiness.enable.location', 1)):?>
          <?php $locationText = $this->translate('Location');?>
          <?php $locationvalue = $business->location;?>
          <?php if(Engine_Api::_()->getApi('settings','core')->getSetting('sesbusiness.enable.map.integration', 1)):?>
           <?php $locationHref = "<a href='".$this->url(array('resource_id' => $business->business_id,'resource_type'=>'businesses','action'=>'get-direction'), 'sesbasic_get_direction', true)."' class=\"opensmoothboxurl\">$locationvalue</a>";?>
          <?php else:?>
		...
		<?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 &&  isset($this->likeButtonActive)):?>
          ...
          <?php $likeButton = '<a href="javascript:;" data-url="'.$business->getIdentity().'" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sesbusiness_like_sesbusiness_business_'. $business->business_id.' sesbusiness_like_sesbusiness_business '.$likeClass .'"> <i class="fa fa-thumbs-up"></i><span>'.$business->like_count.'</span></a>';?>
		<?php endif;?>
		<?php $favouriteButton = '';?>
		<?php if(isset($this->favouriteButtonActive) && Engine_Api::_()->user()->getViewer()->getIdentity() != 0 &&  isset($business->favourite_count) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusiness.enable.favourite', 1)){
          $favStatus = Engine_Api::_()->getDbTable('favourites', 'sesbusiness')->isFavourite(array('resource_type'=>'businesses','resource_id'=>$business->business_id));
        $favClass = ($favStatus)  ? 'button_active' : '';
        $favouriteButton = '<a href="javascript:;" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn  sesbusiness_favourite_sesbusiness_business_'. $business->business_id.' sesbusiness_favourite_sesbusiness_business '.$favClass .'" data-url="'.$business->getIdentity().'"><i class="fa fa-heart"></i><span>'.$business->favourite_count.'</span></a>';
		}?>
		<?php $urlencode = urlencode(((!empty($_SERVER["HTTPS"]) &&  strtolower($_SERVER["HTTPS"]) == 'on') ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . $business->getHref());?>
		<?php $stats = '<div class="_stats sesbasic_text_light">';
		if(isset($this->commentActive)){
          $stats .= '<span title="'.$this->translate(array('%s comment', '%s comments', $business->comment_count), $this->locale()->toNumber($business->comment_count)).'"><i class="fa fa-comment"></i>'.$business->comment_count.'</span>';
		}
		if(isset($this->favouriteActive) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusiness.enable.favourite', 1)){
          $stats .= '<span title="'.$this->translate(array('%s favourite', '%s favourites', $business->favourite_count), $this->locale()->toNumber($business->favourite_count)).'"><i class="fa fa-heart"></i>'. $business->favourite_count.'</span>';
		}
		if(isset($this->viewActive)){
			$stats .= '<span title="'. $this->translate(array('%s view', '%s views', $business->view_count), $this->locale()->toNumber($business->view_count)).'"><i class="fa fa-eye"></i>'.$business->view_count.'</span>';
		}
		if(isset($this->likeActive)){
			$stats .= '<span title="'.$this->translate(array('%s like', '%s likes', $business->like_count), $this->locale()->toNumber($business->like_count)).'"><i class="fa fa-thumbs-up"></i>'.$business->like_count.'</span> ';
		}
		?>
	  <?php $stats .= '</div>';?>
      <?php $socialshare = $this->partial('_dataSharing.tpl','sesbusiness',array('mapbusiness' => $business,'contactButton' => isset($this->contactButtonActive) ? 1 : 0, 'joinButton' => isset($this->joinButtonActive) ? 1 : 0, 'socialSharing' => isset($this->socialSharingActive) ? 1 : 0)); ?>
      <?php $buttons = '<div class="_btns sesbasic_animation">'.$likeButton.$favouriteButton.'</div>';?>
      <?php $date = $this->partial('_date.tpl','sesbusiness',array('mapbusiness' => $business)); ?>
      <?php $owner = $business->getOwner();
        ...
        $locationArray[$counter]['id'] = $business->getIdentity();
        ...
        $locationArray[$counter]['lat'] = $business->lat;
        $locationArray[$counter]['lng'] = $business->lng;
  $locationArray[$counter]['labels'] = $labels;
  $locationArray[$counter]['vlabel'] = $vlabel;
        $locationArray[$counter]['iframe_url'] = '';
        $locationArray[$counter]['image_url'] = $business->getPhotoUrl();
        $locationArray[$counter]['sponsored'] = $business->sponsored;
        $locationArray[$counter]['title'] = '<a href="'.$business->getHref().'">'.$business->getTitle().'</a>';  
        $counter++;?>
      <?php endif;?>
    <?php endif;?>
  <?php endif;?>
...
<?php if($this->view_type == 'map'):?>
  ...
  <?php if(!$this->view_more || $this->is_search):?>
    <li id="sesbusiness_map_view_<?php echo $randonNumber;?>" style="width:100%">
  ...
  <div id="browse-widget_<?php echo $randonNumber;?>" style="width:100%;">
    <div id="error-message_<?php echo $randonNumber;?>">
      <div class="sesbasic_tip clearfix">
        ...
        <?php if($viewerId && Engine_Api::_()->core()->hasSubject('businesses')):?>
          <?php $subject = Engine_Api::_()->core()->getSubject('businesses');?>
          <?php if((Engine_Api::_()->authorization()->getPermission($viewer->level_id, 'businesses', 'auth_subbusiness') && (!$subject->parent_id)) && Engine_Api::_()->getDbTable('businessroles','sesbusiness')->toCheckUserBusinessRole($viewer->getIdentity(),$subject->getIdentity(),'post_behalf_business')):?>
            <div class="_btn centerT">
              <a href="<?php echo $this->url(array('action' => 'create','parent_id' => $subject->getIdentity()),'sesbusiness_general',true);?>" class="sesbasic_link_btn"><?php echo $this->translate("Create New Associates Sub Business")?></a>
            </div>
          <?php endif;?>
        <?php endif;?>
      </div>
  ...
  sesJqueryObject(document).on('click','.selectView_<?php echo $randonNumber; ?>',function(){
    ...
    requestTab_<?php echo $randonNumber; ?> = (new Request.HTML({
      ...
      onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        var totalBusiness= sesJqueryObject('#tabbed-widget_<?php echo $randonNumber; ?>').find("#paginator_count_ajax_sesbusiness_entry");
  ...
  <?php if($this->params['pagging'] != 'pagging'){ ?>
    ...
    function viewMore_<?php echo $randonNumber; ?> (){
      ...
      requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
        method: 'post',
        'url': en4.core.baseUrl + "widget/index/mod/sesbusiness/id/<?php echo $this->widgetId; ?>/name/<?php echo $this->widgetName; ?>/openTab/" + openTab_<?php echo $randonNumber; ?>,
        'data': {
          format: 'html',
...
<!--Start Map Work on Business Load-->
<?php if(!$this->is_ajax): ?>
