...
class Sesbusinessreview_Form_Review_Browse extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAttribs(array('id' => 'filter_form', 'class' => 'global_form_box'))->setMethod('GET')
            ->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array(), 'sesbusinessreview_review', true));
    ...
    $this->addElement('Dummy', 'loading-img-sesbusinessreview-review', array(
