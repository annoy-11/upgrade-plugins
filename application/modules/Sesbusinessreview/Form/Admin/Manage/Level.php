 ...
 */
class Sesbusinessreview_Form_Admin_Manage_Level extends Authorization_Form_Admin_Level_Abstract {
  ...
  public function init() {
    ...
    $this->addElement('Radio', 'view', array(
        ...
        'description' => 'Do you want to let members to view reviews for the businesses?',
        'multiOptions' => array(
    ...
    if (!$this->isPublic()) {
      $this->addElement('Radio', 'create', array(
          ...
          'description' => 'Do you want to let members to write reviews for the Businesses?',
          'multiOptions' => array(
      ...
      $this->addElement('Radio', 'delete', array(
          ...
          'description' => 'Do you want to let members to delete reviews? If set to no, some other settings on this business may not apply.',
          'multiOptions' => array(
