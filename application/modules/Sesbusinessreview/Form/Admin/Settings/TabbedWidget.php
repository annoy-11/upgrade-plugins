...
class Sesbusinessreview_Form_Admin_Settings_TabbedWidget extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Radio', "pagging", array(
        'label' => "Do you want the reviews to be auto-loaded when users scroll down the business?",
        'multiOptions' => array(
            'button' => 'View more',
            'auto_load' => 'Auto Load',
            'pagging' => 'Pagination'
