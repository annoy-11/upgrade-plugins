...
class Sesbusinessreview_Widget_TabbedWidgetReviewController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $value = array();
    $select = Engine_Api::_()->getItemTable('businessreview')->getBusinessReviewSelect($params);
