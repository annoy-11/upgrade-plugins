...
?>
<ul class="sesbasic_sidebar_block sesbusinessreview_review_sidebar_block sesbasic_bxs sesbasic_clearfix"  id="widget_sesbusinessreview_<?php echo $randonnumber; ?>" style="position:relative;">
  <div class="sesbasic_loading_cont_overlay" id="sesbusinessreview_widget_overlay_<?php echo $randonnumber; ?>"></div>
    ...
    <li class="sesbusinessreview_review_sidebar_list <?php if($this->image_type == 'rounded'):?>sesbusinessreview_sidebar_image_rounded<?php endif;?> sesbasic_clearfix">
      ...
      <div class="sesbusinessreview_review_sidebar_list_info">
        ...
        <?php } ?>
          ...
          <?php if(isset($this->reviewOwnerNameActive) || isset($this->businessNameActive)):?>
...
<script type="application/javascript">
 		var anchor_<?php echo $randonnumber ?> = sesJqueryObject('#widget_sesbusinessreview_<?php echo $randonnumber; ?>').parent();
    ...
    function widget_previous_<?php echo $randonnumber; ?>(){
			sesJqueryObject('#sesbusinessreview_widget_overlay_<?php echo $randonnumber; ?>').show();
      new Request.HTML({
        url : en4.core.baseUrl + 'widget/index/mod/sesbusinessreview/name/<?php echo $this->widgetName; ?>/content_id/' + <?php echo sprintf('%d', $this->identity) ?>,
        data : {
          format : 'html',
					is_ajax: 1,
					params :'<?php echo json_encode($this->params); ?>', 
          business : <?php echo sprintf('%d', $this->results->getCurrentPageNumber() - 1) ?>
        },
				...
				<?php } ?>
					sesJqueryObject('#sesbusinessreview_widget_overlay_<?php echo $randonnumber; ?>').hide();
					showHideBtn<?php echo $randonnumber ?> ();
				}
      }).send()
		};
