 ...
 */
 ...
 ?>
<?php $reviewParameters = Engine_Api::_()->getDbtable('parameters', 'sesbusinessreview')->getParameterResult(array('category'=>$this->category_id));?>
<?php if(count($reviewParameters)):?>
  <?php foreach($reviewParameters as $value):?>
    <div class="form-wrapper sesbusinessreview_form_review_star">
      <div class="form-label"><label><?php echo $this->translate($value['title']); ?></label></div>
      <div id="sesbusinessreview_review_rating" class="sesbasic_rating_parameter sesbusinessreview_rating_star_element" onmouseout="rating_out_review(<?php echo $value['parameter_id'] ?>);">
	...
	<span id="rating_text_<?php echo $value['parameter_id'] ?>" class="sesbasic_rating_text"><?php echo $this->translate('SESBUSINESS click to rate');?></span>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    var countExistsParam = sesJqueryObject('.sesbusinessreview_review_values');
