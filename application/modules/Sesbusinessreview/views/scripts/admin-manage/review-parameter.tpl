    ...
    <div class="sesbasic-form-cont">
      ...
      <div class="sesbasic-categories-listing" style="width:100%">
		...
		<tr id="category-<?php echo $category->category_id; ?>" data-article-id="<?php echo $category->category_id; ?>">
		  ...
		  <?php $reviewParameter = Engine_Api::_()->getDbtable('parameters', 'sesbusinessreview')->getParameterResult(array('category'=>$category->category_id)); ?>
		  <td>
		    <?php $titleEAC = 'Add';?>
		    <?php if(count($reviewParameter)):?>
		      <?php $titleEAC = 'Edit';?>
		      <ul class="sesbusinessreview_parameters_list">
		  ...
		  <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesbusinessreview', 'controller' => 'manage', 'action' => 'add-parameter', 'id' => $category->category_id), $this->translate($titleEAC.' Parameter'), array('class'=> "smoothbox")); ?>
		</tr>
              <?php endforeach; ?>
            </tbody>
          </table>
