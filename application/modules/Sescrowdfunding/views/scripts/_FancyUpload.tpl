 ...
 * @version    $Id: _FancyUpload.tpl  2019-01-08 00:00:00 SocialEngineSolutions $
    ...
    onLoad: function() {
      ...
      $('demo-clear').addEvent('click', function() {
        up.remove(); // remove all files
				sesJqueryObject('#demo-list').html('');
...
<div id="demo-status" class="sesbasic_uploader_status hide">
  <div>
    <?php echo $this->translate('CORE_VIEWS_SCRIPTS_FANCYUPLOAD_ADDPHOTOS');?>
  </div>
  <div class="sesbasic_uploader_options sesbasic_clearfix">
    <a class="sesbasic_button fa fa-plus" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Photos');?></a>
    <a class="sesbasic_button fa fa-minus-circle" href="javascript:void(0);" id="demo-clear" style='display: none;'><?php echo $this->translate('Clear List');?></a>
  </div>
