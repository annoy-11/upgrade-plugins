 ...
 * @version    $Id: _sidebarWidgetData.tpl  2019-01-08 00:00:00 SocialEngineSolutions $
...
<?php foreach( $this->paginator as $result ): ?>
    ...
    <li class="sesbasic_clearfix sescf_sidebar_list">
      <div class="sescf_sidebar_list_img" style="height:<?php echo $this->height_list ?>px;width:<?php echo $this->width_list ?>px;">
        <img class="sescf_grid_item_img" src="<?php echo $result->getPhotoUrl('thumb.profile'); ?>" alt="" />
          ...
          <?php if($this->featuredLabelActive && $result->featured): ?>
            <p class="sescf_labels sesbasic_animation">
              <span class="sescf_label_featured"><i class="fa fa-star"></i></span>
            </p>
          <?php endif; ?>
            <?php if($this->sponsoredLabelActive && $result->sponsored): ?>
            <p class="sescf_labels sesbasic_animation">
              <span class="sescf_label_sponsored"><i class="fa fa-star"></i></span>
            </p>
          <?php endif; ?>
           <?php if($this->verifiedLabelActive && $result->verified): ?>
            <p class="sescf_labels sesbasic_animation">
              <span class="sescf_label_verified"><i class="fa fa-star"></i></span>
            </p>
          <?php endif; ?>
          </div>
      </div>
      <div class="sescf_sidebar_list_cont sesbasic_clearfix">
        <?php if($this->titleActive): ?>
          <div class="sescf_sidebar_list_title">
            <a href="<?php echo $result->getHref(); ?>"><?php echo $this->string()->truncate($this->string()->stripTags($result->getTitle()), $this->title_truncation_grid) ?></a>
          </div>
        <?php endif; ?>
        <?php if($this->byActive): ?>
          <div class="sescf_sidebar_list_date">
