 ...
 * @version    $Id: upgrade.tpl  2019-01-08 00:00:00 SocialEngineSolutions $
...
<?php $currentCurrency =  Engine_Api::_()->sescrowdfunding()->getCurrentCurrency(); ?>
...
<div class="sesblogpackage_blog_list sesbasic_clearfix sesbasic_bxs">
  ...
  <div class="package_catogery_list">
    ...
    <?php 
            ...
            $curruncySymbol = str_replace('.','',preg_replace('/\d+/u', '', Engine_Api::_()->sescrowdfunding()->getCurrencyPrice($package->price,$currentCurrency)));
     ?>
     ...
     ?>
    	<li class="<?php echo ($package->highlight) ? 'active' : '' ?>">
          ...
          <?php if(in_array('description',$showinfo)){ ?> 
            <p class="footer_discprition"><?php echo $this->translate($package->description); ?> </p>
          <?php } ?>
          <a href="<?php echo $this->url(array('blog_id' => $this->blog->blog_id,'action'=>'confirm-upgrade','package_id'=>$package->package_id), 'sesblogpackage_general', true); ?>" class="smoothbox">Upgrade Package</a>
          </div>
        </div>
      </li>      
    <?php } ?>
