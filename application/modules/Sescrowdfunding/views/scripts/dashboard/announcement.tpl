 ...
 * @version    $Id: announcement.tpl  2019-01-08 00:00:00 SocialEngineSolutions $
  ...
  function makeEditorRich() {
    ...
    <div class="sescrowdfunding_dashboard_content_header">
      <h3><?php echo $this->translate('Manage Announcements') ?></h3>
    	<p><?php echo $this->translate('Here, you can create announcements to post them on the Page Profile. You can also edit and delete the announcements listed on this Page.') ?></p>
    </div>
    <div class="sescrowdfunding_dashboard_content_btns">
      <a href="<?php echo $this->url(array('crowdfunding_id' => $this->crowdfunding->custom_url,'action'=>'post-announcement'), 'sescrowdfunding_dashboard', true); ?>" class="sessmoothbox sesbasic_button"><i class="fa fa-bullhorn"></i><span><?php echo $this->translate("Post New Announcement");?></span></a>
    </div>  
  <?php if($this->paginator->getTotalItemCount()!=0): ?>
    <div class="sescrowdfunding_dashboard_results"><?php echo $this->translate('%d announcements total', $this->paginator->getTotalItemCount()) ?></div>
  <?php endif;?>
