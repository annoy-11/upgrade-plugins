...
<h3><?php echo $this->translate("Payments Made to Crowdfunding Owners") ?></h3>
    ...
    <table class='admin_table'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo $crowdfunding->getHref(); ?>" target="_blank"><?php echo $crowdfunding->getTitle(); ?></a></td>
          ...
          <td>
            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sescrowdfunding', 'controller' => 'admin-paymentmade', 'action' => 'view-paymentrequest', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
