 ...
 * @version    $Id: mange-widgetize-page.tpl  2019-01-08 00:00:00 SocialEngineSolutions $
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <?php if($item != 'sescrowdfunding_category_index' && $item != 'sescrowdfunding_index_view_1' && $item != 'sescrowdfunding_index_view_2' && $item != 'sescrowdfunding_index_view_3' && $item != 'sescrowdfunding_index_view_4' && $item != 'sescrowdfunding_order_donate') { ?>
        |
