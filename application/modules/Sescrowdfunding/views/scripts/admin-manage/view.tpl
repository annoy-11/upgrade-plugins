 ...
 * @version    $Id: view.tpl  2019-01-08 00:00:00 SocialEngineSolutions $
...
<div class="sesbasic_view_stats_popup">
  ...
  <table>
    ...
    <?php if(isset($this->item->location) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sescrowdfunding.enable.location', 1)){ ?>
    <tr>
