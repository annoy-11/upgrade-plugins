 ...
 */
 ...
 ?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescrowdfunding/externals/styles/styles.css'); ?>
...
<?php } ?>
<div class="sescrowdfunding_sidebar_button">
...
<div id="sesbasic_popup_slide" class="well" style="display:none">
  <div class="sesbasic_popup sesbasic_bxs">
    <div class="sesbasic_popup_title">
       <?php echo $this->translate("Share This ".ucfirst(str_replace(array('sescrowdfunding_',''),'',$this->subject()->getType()))); ?>
    ...
    <div class="sesbasic_popup_content">
      <div class="sesbasic_share_popup_content_row clear sesbasic_clearfix">
        ...
        <?php if(in_array('tellAFriend',$this->allowAdvShareOptions)){ ?>
            <a href="javascript:void(0)" class="sesbasic_button" onClick="openSmoothBoxInUrl('<?php echo $this->url(array('module'=> 'sescrowdfunding', 'controller' =>'index','action' => 'tellafriend','crowdfunding_id' => $this->subject()->getIdentity()),'sescrowdfunding_general',true); ?>');return false;"> <?php echo $this->translate("Tell a friend"); ?></a>
          <?php } ?>
        </div>
      </div>
      <?php if($addThisCode && in_array('addThis',$this->allowAdvShareOptions)){ ?>
      ...
      <div class="sesbasic_share_popup_content_row">
          ...
          <div class="sesbasic_share_itme_preview_info">
            ...
            <div class="sesbasic_share_itme_preview_des">
             <?php if(strlen(strip_tags($this->subject()->description)) > 1000){ 
                  $description = mb_substr($this->subject()->description,0,1000).'...';
