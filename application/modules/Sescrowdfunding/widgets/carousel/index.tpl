...
<div class="sesbasic_clearfix sesbasic_bxs">
  <div class="sescf_cm_carousel sesbasic_clearfix sescf_carousel">
        ...
        <div class="sescf_grid_item_inner sesbasic_clearfix">
          ...
          <?php endif; ?>
            ...
            <p class="sescf_list_btns sesbasic_animation">
              ...
              <?php if(isset($this->socialSharingActive) && $enableShare == 2): ?>
            ...
            <div class="sescf_grid_item_thumb_stats sesbasic_clearfix sesbasic_animation centerT">
              ...
              <?php if(isset($this->viewActive)): ?>
                <p title="<?php echo $this->translate(array('%s views', '%s views', $result->view_count), $this->locale()->toNumber($result->view_count)); ?>"><i class="fa fa-eye"></i><span><?php echo $result->view_count; ?></span></p>
              <?php endif; ?>
  ...
  for(i=0;i<elem.length;i++) {
    sescfJqueryObject(elem[i]).owlCarousel({
      ...
      responsive: {
        ...
        1000: {
          items: <?php echo $this->slidesToShow ?>,
          nav: true,
          loop: false
        }
      }
