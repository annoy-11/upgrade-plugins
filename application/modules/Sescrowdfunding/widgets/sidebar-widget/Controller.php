 ...
 */
class Sescrowdfunding_Widget_SidebarWidgetController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
      ...
      $this->view->widgetName = 'sidebar-widget';
