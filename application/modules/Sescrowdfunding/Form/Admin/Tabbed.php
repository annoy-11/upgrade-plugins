 ...
 * @version    $Id: Tabbed.php  2019-01-08 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescrowdfunding_Form_Admin_Tabbed extends Engine_Form {

  public function init() {

    $this->addElement('MultiCheckbox', "enableTabs", array(
      'label' => "Choose the View Type for Crowdfunding.",
      'multiOptions' => array(
        'list' => 'List View',
        'grid' => 'Grid View',
      ),
   ...
   $categories = array('' => '') + $categories;
    ...
    $this->addElement('Select', "show_limited_data", array(
			'label' => 'Show only the number of crowdfundings entered in above setting. [If you choose No, then you can choose how do you want to show more crowdfundings in this widget.]',
			 'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
    ...
    $this->addElement('Radio', "pagging", array(
      'label' => "Do you want the crowdfundings to be auto-loaded when users scroll down the page?",
      'multiOptions' => array(
    ...
    $this->addElement('Text', "limit_data_list", array(
      'label' => 'Count for List Views (number of crowdfundings to show).',
      'value' => 10,
      'validators' => array(
        array('Int', true),
        array('GreaterThan', true, array(0)),
    ...
    $this->addElement('Text', "limit_data_grid", array(
      'label' => 'Count for Grid Views (number of crowdfundings to show).',
      'value' => 10,
      'validators' => array(
        array('Int', true),
        array('GreaterThan', true, array(0)),
    ...
    // setting for Recently Created
  	  ...
  	  // setting for Most Donated
		$this->addElement('Dummy', "dummy6", array(
			'label' => "<span style='font-weight:bold;'>Order and Title of 'Most Donated' Tab</span>",
    ));
		$this->getElement('dummy6')->getDecorator('Label')->setOptions(array('placement' => 'PREPEND', 'escape' => false));

		$this->addElement('Text', "mostSPdonated_order", array(
			'label' => "Order of this Tab.",
			'value' => '6',
    ));
		$this->addElement('Text', "mostSPdonated_label", array(
			'label' => 'Title of this Tab.',
			'value' => 'Most Donated',
    ));
