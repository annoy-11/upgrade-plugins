 ...
 * @version    $Id: Search.php  2019-01-08 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescrowdfunding_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'sescrowdfunding', 'controller' => 'index', 'action' => 'browse'), 'default', true));

    $viewer = Engine_Api::_()->user()->getViewer();

    if ($this->_searchTitle == 'yes') {
      $this->addElement('Text', 'search', array(
        'label' => 'Search Crowdfunding'
      ));
    }
    ...
    if ($this->_locationSearch == 'yes' && $this->getSearchFor() == 'crowdfunding') {
      /*Location Elements*/
