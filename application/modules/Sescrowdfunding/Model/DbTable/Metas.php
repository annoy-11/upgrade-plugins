 ...
 * @version    $Id: Metas.php  2019-01-08 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sescrowdfunding_Model_DbTable_Metas extends Engine_Db_Table {

  protected $_name = 'sescrowdfunding_crowdfunding_fields_meta';
  protected $_rowClass = 'Sescrowdfunding_Model_Meta';

	public function getMetaData($options_id = null){
		if(!$options_id)
			return null;
		$tableName = $this->info('name');
		$mapTableName = Engine_Api::_()->getDbTable('maps','sescrowdfunding')->info('name');
  ...
  public function profileFieldId() {
	...
	public function reviewProfileFieldId() {
	  $table = Engine_Api::_()->fields()->getTable('sescrowdfunding_review', 'metas');
		return $table->select()
