 ...
 * @version    $Id: Recentlyviewitems.php  2019-01-08 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sescrowdfunding_Model_DbTable_Recentlyviewitems extends Engine_Db_Table {

  protected $_name = 'sescrowdfunding_recentlyviewitems';
  protected $_rowClass = 'Sescrowdfunding_Model_Recentlyviewitem';

  public function getitem($params = array()) {

    if (isset($params['type']) && $params['type'] == 'sescrowdfunding_album') {
      $itemTable = Engine_Api::_()->getItemTable('sescrowdfunding_album');
      $fieldName = 'album_id';
    } else {
      $itemTable = Engine_Api::_()->getItemTable('crowdfunding');
      $fieldName = 'crowdfunding_id';
    }
    ...
    $select = $this->select()
            ->from(array('engine4_sescrowdfunding_recentlyviewitems' => $subquery))
