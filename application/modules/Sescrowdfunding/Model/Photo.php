 ...
 * @version    $Id: Photo.php  2019-01-08 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescrowdfunding_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'sescrowdfunding_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'sescrowdfunding_album';
...
//       'route' => 'sescrowdfunding_extended',
//       'reset' => true,
//       'controller' => 'photo',
//       'action' => 'view',
//       'crowdfunding_id' => $this->getCollection()->getOwner()->getIdentity(),
...
//   }
  ...
  public function setAlbumPhoto($photo,$isURL = false,$isUploadDirect = false) {
	...
	throw new User_Model_Exception('invalid argument passed to setPhoto');
      ...
      $fileName = time().'_sescrowdfunding';
   ...
   public function getAlbum() {
    return Engine_Api::_()->getItem('sescrowdfunding_album', $this->album_id);
  }
    //get next photo
  ...
  */
  public function getAlbumPhotoUrl($type = null) {
    ...
    if( !$photo_id ) {
      return 'application/modules/Sescrowdfunding/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
  ...
  public function getSescrowdfunding()
  {
    return Engine_Api::_()->getItem('crowdfunding', $this->crowdfunding_id);
  ...
  {
    return $this->getParent('sescrowdfunding');
  }
  ...
  public function setPhoto($photo,$isURL = false)
  {
    ...
    $params = array(
      'parent_type' => 'sescrowdfunding_photo',
      'parent_id' => $this->getIdentity(),
      'user_id' => $this->user_id,
      'name' => $fileName,
    );
