 ...
 */
class Sesjob_Form_BannerSearch extends Engine_Form {
  ...
  public function init() {
    $params = Engine_Api::_()->sesjob()->getWidgetParams($this->getWidgetId());
    $show_criterias = $params['show_criteria'];
    $view = Zend_Registry::isRegistered('Zend_View') ? Zend_Registry::get('Zend_View') : null;
    $identity = $view->identity;
    $params = Engine_Api::_()->sesjob()->getWidgetParams($identity);
    $this->setAttribs(array('id' => 'filter_form', 'class' => 'sesjob_banner_search_form'))->setMethod('GET');
    $this->setAction($view->url(array('action' => 'browse'), 'sesjob_general', true));
