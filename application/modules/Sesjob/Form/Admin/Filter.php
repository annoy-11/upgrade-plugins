 ...
 * @version    $Id: Filter.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbtable('categories', 'sesjob')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Select', 'verified', array(
		...
		$isEnablePackage = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesjobpackage') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesjobpackage.enable.package', 1);
		if($isEnablePackage){
				$packages = Engine_Api::_()->getDbTable('packages','sesjobpackage')->getPackage(array('default' => true));
				$packagesArray = array(''=>'');
