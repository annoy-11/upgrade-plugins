 ...
 * @version    $Id: Location.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_Form_Admin_Location extends Engine_Form {
  public function init() {
   ...
   $this->addElement('dummy', 'location-data', array(
		'decorators' => array(array('ViewScript', array(
				'viewScript' => 'application/modules/Sesjob/views/scripts/location.tpl',
		)))
  ));
  }
}
