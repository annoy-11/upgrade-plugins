 ...
 * @version    $Id: Categorywidget.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_Form_Admin_Categorywidget extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($banner_options) > 1) {
      $this->addElement('Select', 'sesjob_categorycover_photo', array(
          'label' => 'Job Category Default Cover Photo',
          'description' => 'Choose a default cover photo for the job categories on your website. [Note: You can add a new photo from the "File & Media Manager" section from here: File & Media Manager. Leave the field blank if you do not want to change job category default cover photo.]',
