 ...
 * @version    $Id: Type.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesjob_Form_Admin_Settings_Type extends Engine_Form {
  ...
  public function init() {
    ...
    $member_type_result = $db->select('option_id, label')
            ->from('engine4_sesjob_job_fields_options')
            ->where('field_id = ?', 1)
            ->query()
            ->fetchAll();
