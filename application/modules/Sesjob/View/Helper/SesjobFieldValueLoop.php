 ...
 * @version    $Id: SesjobFieldValueLoop.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_View_Helper_SesjobFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function sesjobFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'sesjob' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
