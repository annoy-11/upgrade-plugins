 ...
 */
class Sesjob_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'sesjob_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'sesjob_album';
...
//       'route' => 'sesjob_extended',
//       'reset' => true,
//       'controller' => 'photo',
//       'action' => 'view',
//       'job_id' => $this->getCollection()->getOwner()->getIdentity(),
...
//   }
  ...
  public function getAlbum() {
    return Engine_Api::_()->getItem('sesjob_album', $this->album_id);
  }
  ...
  public function getAlbumPhotoUrl($type = null) {
    ...
    if (!$photo_id) {
      return 'application/modules/Sesjob/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
  ...
  public function getSesjob() {
    return Engine_Api::_()->getItem('sesjob', $this->job_id);
  ...
  public function getAuthorizationItem() {
    return $this->getParent('sesjob_job');
  }
  ...
  protected function _postDelete() {
    ...
    try {
      ...
      $jobItem = Engine_Api::_()->getItem("sesjob_job", $this->job_id);
      ...
      if (isset($jobItem)) {
        $photoItem = Engine_Api::_()->getItem("sesjob_photo", $jobItem->photo_id);
        if (!$photoItem) {
          $jobItem->photo_id = 0;
          $jobItem->save();
        }
