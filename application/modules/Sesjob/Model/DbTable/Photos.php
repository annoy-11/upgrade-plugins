 ...
 * @version    $Id: Photos.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_Model_DbTable_Photos extends Engine_Db_Table
{
  protected $_rowClass = 'Sesjob_Model_Photo';

  	public function getPhotoSelect($params = array())
  {
    $select = $this->select();

    if( !empty($params['album']) && $params['album'] instanceof Sesjob_Model_Album ) {
