 ...
 * @version    $Id: Subscriptions.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_Model_DbTable_Subscriptions extends Engine_Db_Table {

  public function sendNotifications(Sesjob_Model_Job $sesjob) {

    if( !empty($sesjob->draft) || $sesjob->owner_type != 'user' ) {
      return $this;
    }

    // Get sesjob owner
    $owner = $sesjob->getOwner('user');
    ...
    foreach( $users as $user ) {
      //$notificationTable->addNotification($user, $owner, $sesjob, 'sesjob_subscribed_new');
    }
