 ...
 * @version    $Id: Metas.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesjob_Model_DbTable_Metas extends Engine_Db_Table {

  protected $_name = 'sesjob_job_fields_meta';
  protected $_rowClass = 'Sesjob_Model_Meta';

	public function getMetaData($options_id = null){
		if(!$options_id)
			return null;
		$tableName = $this->info('name');
		$mapTableName = Engine_Api::_()->getDbTable('maps','sesjob')->info('name');
