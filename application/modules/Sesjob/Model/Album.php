 ...
 * @version    $Id: Album.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesjob_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'sesjob_job';

  protected $_owner_type = 'sesjob_job';

  protected $_children_types = array('sesjob_photo');

  protected $_collectible_type = 'sesjob_photo';

//   public function getHref($params = array())
//   {
//     return $this->getSesjob()->getHref($params);
//   }
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sesjob/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $sesjobPhoto ) {
      $sesjobPhoto->delete();
    }
