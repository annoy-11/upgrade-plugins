 ...
 */
 ...
 ?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesjob/externals/styles/style_album.css'); ?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/styles/customscrollbar.css'); ?>
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/scripts/jquery.min.js'); ?>
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/scripts/customscrollbar.concat.min.js'); ?>
<div class="clear sesjob_order_view_top" style="margin:10px;">
      <a href="<?php echo $this->job->getHref(); ?>" class="buttonlink sesbasic_icon_back"><?php echo $this->translate("Back To Job"); ?></a>
    </div>
<div class="sesjob_album_form"> <?php echo $this->form->render($this) ?> </div>
...
<script type="text/javascript">
  ...
  jqueryObjectOfSes('#sesjob_create_form_tabs li a').on('click',function(){
...
function sendFileToServer(formData,status,file,isURL,i)
{
		...
		var url = '&isURL='+urlIs;
		var job_id = '<?php  echo $this->job_id;?>';
    var uploadURL =$('form-upload').action + '?ul=1'+url+'&job_id='+job_id; //Upload URL
...
jqueryObjectOfSes(document).on('click','.delete_image_upload',function(e){
    ...
    'format' : 'json',
    'url' : '<?php echo $this->url(Array('module' => 'sesjob', 'controller' => 'album', 'action' => 'remove'), 'default') ?>',
    'data': {
      'photo_id' : photo_id
    },
...
<?php } ?>
  function editImage(photo_id) {
    var url = '<?php echo $this->url(Array('module' => 'sesjob', 'controller' => 'album', 'action' => 'edit-photo'), 'default') ?>' + '/photo_id/'+ photo_id;
    Smoothbox.open(url);
  }
</script>
