 ...
 * @version    $Id: location.tpl  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<div class="sesjob_edit_location_popup">
...
<script type="text/javascript">
  ...
  sesJqueryObject('#ses_location_data_list').html('<?php echo $this->job->location; ?>');
  sesJqueryObject('#ses_location-wrapper').css('display','none');
  <?php if($this->type == 'job_location'){ ?>
