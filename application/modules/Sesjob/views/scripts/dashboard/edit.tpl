 ...
 * @version    $Id: edit.tpl  2019-03-27 00:00:00 SocialEngineSolutions $
...
<?php if(!$this->is_ajax){ ?>
  <?php
  echo $this->partial('dashboard/left-bar.tpl', 'sesjob', array(
  'job' => $this->job,
  ));	
  ?>
  <div class="sesbasic_dashboard_content sesbm sesbasic_clearfix">
<?php } ?>
<div class="sesjob_dashboard_form sesbasic_dashboard_form sesjob_create_form sesbasic_bxs">
...
<script type="text/javascript">
  ...
  {
    showHideHeight('<?php echo $this->job->cotinuereading; ?>');
...
var counter = 0;
  function validateForm(){
    ...
    jqueryObjectOfSes('#sesjobs_edit input, #sesjobs_edit select,#sesjobs_edit checkbox,#sesjobs_edit textarea,#sesjobs_edit radio').each(
      function(index){
  ...
  jqueryObjectOfSes('#sesjobs_edit').submit(function(e){
    var validationFm = validateForm();
		if(!validationFm && sesJqueryObject('#sesjob_schedule_time').length > 0 ) {
