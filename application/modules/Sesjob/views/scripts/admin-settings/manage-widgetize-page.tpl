 ...
 * @version    $Id: manage-widgetize-page.tpl  2019-03-27 00:00:00 SocialEngineSolutions $
...
<table class='admin_table'>
  ...
  <tbody>
    ...
    $corePages = Engine_Api::_()->sesjob()->getwidgetizePage(array('name' => $item));
    ...
    <tr>
      ...
      <td>
        ...
        <?php if($item == 'sesjob_index_view_1' || $item == 'sesjob_index_tags' || $item == 'sesjob_category_index'  || $item == 'sesjob_company_view'): ?>
        <?php else: ?>
        |
