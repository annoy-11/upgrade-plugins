...
<?php if($this->view_type == 'list'): ?>
  <ul id="widget_sesjob_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block sesbasic_sidebar_block sesjob_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php else: ?>
  <ul id="widget_sesjob_<?php echo $randonnumber; ?>" class="sesjob_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php endif; ?>
  <div class="sesbasic_loading_cont_overlay" id="sesjob_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php include APPLICATION_PATH . '/application/modules/Sesjob/views/scripts/_sidebarWidgetData.tpl'; ?>
