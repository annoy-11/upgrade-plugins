 ...
 */
class Sesjob_Widget_JobsSlideshowController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->socialshare_icon_limit = $this->_getParam('socialshare_icon_limit', 2);
		...
		$this->view->leftJob = $this->_getParam('leftJob', 1);
    ...
    $value['fetchAll'] = true;
		$value['limit'] = 3;
    $this->view->paginatorLeft = $paginatorLeft = Engine_Api::_()->getDbTable('jobs', 'sesjob')->getSesjobsSelect($value);
    ...
    $this->view->paginatorRight = $paginatorRight = Engine_Api::_()->getDbTable('jobs', 'sesjob')->getSesjobsSelect($valueRight);
  }
}
