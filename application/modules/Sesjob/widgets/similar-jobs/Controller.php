...
class Sesjob_Widget_SimilarJobsController extends Engine_Content_Widget_Abstract {
    ...
    if (!$is_ajax) {
      ...
      if(!$category_id)
        return $this->setNoRender();
			...
			$subject = Engine_Api::_()->getItem('sesjob_job', $params['job_id']);
      ...
      if(!$category_id)
		...
		$this->view->widgetName = 'similar-jobs';
