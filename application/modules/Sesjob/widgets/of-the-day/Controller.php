 ...
 */
class Sesjob_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $jobId = Engine_Api::_()->getDbTable('jobs', 'sesjob')->getOfTheDayResults();
    $this->view->job_id = $jobId ;
