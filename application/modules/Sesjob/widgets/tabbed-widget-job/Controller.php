 ...
 */
class Sesjob_Widget_tabbedWidgetJobController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sesjob_tabbed = Zend_Registry::isRegistered('sesjob_tabbed') ? Zend_Registry::get('sesjob_tabbed') : null;
    ...
    $this->view->widgetName = 'tabbed-widget-job';
