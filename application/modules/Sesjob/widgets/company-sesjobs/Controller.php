 ...
 */
class Sesjob_Widget_CompanySesjobsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if(Engine_Api::_()->core()->hasSubject()) {
        ...
        $value['company_id'] = $company_id = $company->getIdentity();
    }
    ...
    $this->view->company_id = $company_id = $value['company_id'] =isset($params['company_id']) ? $params['company_id'] : $company_id;

    //Need to Discuss
    $show_criterias = isset($params['show_criterias']) ? $params['show_criterias'] : $this->_getParam('show_criteria', array('like', 'comment', 'rating', 'by', 'title', 'featuredLabel','sponsoredLabel','verifiedLabel','hotLabel', 'category','description_list','description_grid','description_pinboard', 'favouriteButton','likeButton', 'socialSharing', 'view', 'creationDate', 'readmore'));
    ...
    $this->view->widgetName = $value['widgetName'] = 'company-sesjobs';
    $params = array_merge($params, $value);

    // Get Jobs
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('jobs', 'sesjob')->getSesjobsPaginator($value);
