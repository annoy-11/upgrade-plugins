...
<?php if(!$this->is_ajax){ ?>
  <div class="sesjob_small_tabs_container sesbasic_clearfix sesbasic_bxs sesbasic_sidebar_block">
    <div class="sesjob_small_tabs sesbasic_clearfix" <?php if(count($this->defaultOptions) ==1){ ?> style="display:none" <?php } ?>> 
    	<ul id="tab-widget-sesjob-<?php echo $randonNumber; ?>" class="sesbasic_clearfix">
       <?php 
...
<?php include APPLICATION_PATH . '/application/modules/Sesjob/views/scripts/_sidebartabbedlist.tpl'; ?>
