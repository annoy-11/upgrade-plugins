...
class Sesgroupalbum_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'group';

  protected $_owner_type = 'group';

  protected $_children_types = array('sesgroupalbum_photo');

  protected $_collectible_type = 'sesgroupalbum_photo';

//   public function getHref($params = array())
//   {
//     return $this->getSesgroupalbum()->getHref($params);
//   }
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sesgroupalbum/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
...
//   }
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $sesgroupalbumPhoto ) {
      $sesgroupalbumPhoto->delete();
    }
