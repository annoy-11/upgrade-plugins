...
class Sesgroupalbum_Widget_OfTheDayController extends Engine_Content_Widget_Abstract
{
  ...
  {  
		...
		if($type == 'albums')
			$paginator = Engine_Api::_()->getDbTable('albums', 'sesgroupalbum')->getOfTheDayResults($value);
		else
			$paginator = Engine_Api::_()->getDbTable('photos', 'sesgroupalbum')->getOfTheDayResults($value);
