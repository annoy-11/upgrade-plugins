...
class Sesgroupalbum_Form_Search extends Engine_Form {
  ...
  public function init() {
    parent::init();
		if($this->getSearchFor() == 'album')
			$searchFor = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'sesgroupalbum','controller'=>'index','action'=>'browse'));
		else
			$searchFor = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'sesgroupalbum','controller'=>'index','action'=>'browse-photo'));
    $this
            ->setAttribs(array(
                'id' => 'filter_form',
    ...
    $this->addElement('Select', 'sort', array(
      ...
      $this->addElement('Select', 'show', array(
		  ...
		  if ($this->_locationSearch == 'yes' && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum_enable_location', 1)) {
		/*Location Elements*/
    ...
    $this->addElement('Button', 'submit', array(
		...
		$this->addElement('Dummy','loading-img-sesgroupalbum', array(
        'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="sesgroupalbum-category-widget-img" alt="Loading" />',
   ));
  }
