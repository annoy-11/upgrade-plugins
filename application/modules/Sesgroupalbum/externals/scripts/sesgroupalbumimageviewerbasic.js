/* $Id: sesgroupalbumimageviewerbasic.js  2015-6-16 00:00:000 SocialEngineSolutions $ */
var dataCommentSes = '';
...
if (window.SESfullScreenApi.supportsFullScreen) {	
	document.addEventListener(SESfullScreenApi.fullScreenEventName, function() {
		if (SESfullScreenApi.isFullScreen()) {
			...
			sesJqueryObject('#gallery-img').attr('src',sesJqueryObject('#image-src-sesgroupalbum-lightbox-hidden').html());
