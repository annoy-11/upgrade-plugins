    ...
    <tbody>
        <?php foreach ($this->paginator as $item): ?>
          <tr>
            ...
            <td class="admin_table_centered"><?php  echo Engine_Api::_()->sesgroupalbum()->getPhotoCount($item->getIdentity()); ?></td>
            <td class="admin_table_centered"><?php echo $item->is_featured == 1 ?   $this->htmlLink(
                ...
                array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->album_id,'status' =>1,'category' =>'featured','param'=>'albums'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Featured')))) ; ?></td>
            <td class="admin_table_centered"><?php echo $item->is_sponsored == 1 ? $this->htmlLink(
                ...
                array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->album_id,'status' =>1,'category' =>'sponsored','param'=>'albums'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Sponsored'))))  ; ?></td>
            <td class="admin_table_centered">
            <?php if(strtotime($item->endtime) < strtotime(date('Y-m-d')) && $item->offtheday == 1){
            			Engine_Api::_()->getDbtable('albums', 'group')->update(array(
                      'offtheday' => 0,
                      'starttime' =>'',
                      'endtime' =>'',
                    ), array(
            ...
            <?php if($itemofftheday == 1):?>  
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->album_id, 'type' => 'sesgroupalbum_album', 'param' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit  Album of the Day'))), array('class' => 'smoothbox')); ?>
            <?php else: ?>
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->album_id, 'type' => 'sesgroupalbum_album', 'param' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make  Album of the Day'))), array('class' => 'smoothbox')) ?>
            <?php endif; ?>
          </td>
            <td>
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'view', 'type'=> 'group_album', 'id' => $item->album_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              |
              <a href="<?php echo $item->getHref(); ?>" target="_blank">
                <?php echo $this->translate('View') ?>
              </a>
              |
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->album_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
            </td>
          </tr>
        <?php endforeach; ?>
    </tbody>
