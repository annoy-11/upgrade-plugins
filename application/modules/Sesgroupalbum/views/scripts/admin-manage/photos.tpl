...
<h2><?php echo $this->translate('Group Albums Extension') ?></h2>
    ...
    <table class='admin_table'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php $album = Engine_Api::_()->getItem('group_album',$item->album_id) ?>
          ...
          <td class="admin_table_centered"><?php echo $item->is_featured == 1 ?   $this->htmlLink(
                  array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->photo_id,'status' =>0,'category' =>'featured','param'=>'photos'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Unmark as Featured')))) : $this->htmlLink(
                  array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->photo_id,'status' =>1,'category' =>'featured','param'=>'photos'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Featured')))) ; ?></td>
          <td class="admin_table_centered"><?php echo $item->is_sponsored == 1 ? $this->htmlLink(
                  ...
                  array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->photo_id,'status' =>1,'category' =>'sponsored','param'=>'photos'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Sponsored'))))  ; ?></td>
           <td class="admin_table_centered">
           <?php if(strtotime($item->endtime) < strtotime(date('Y-m-d')) && $item->offtheday == 1){ 
            			Engine_Api::_()->getDbtable('photos', 'group')->update(array(
                      'offtheday' => 0,
                      'starttime' =>'',
                      'endtime' =>'',
                    ), array(
            ...
            <?php if($itemofftheday == 1):?>  
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->photo_id, 'type' => 'group_photo', 'param' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit  Photo of the Day'))), array('class' => 'smoothbox')); ?>
            <?php else: ?>
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->photo_id, 'type' => 'group_photo', 'param' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make  Photo of the Day'))), array('class' => 'smoothbox')) ?>
            <?php endif; ?>
          </td>
          <td>
            <?php $photoURL = Engine_Api::_()->sesgroupalbum()->getHrefPhoto($item->photo_id,$item->album_id); ?>
            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'view', 'type'=> 'group_photo', 'id' => $item->photo_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
            | 
            <a href="<?php echo $photoURL; ?>" target="_blank"> <?php echo $this->translate('View') ?> </a>         
            |
            <?php echo $this->htmlLink(
                  array('route' => 'default', 'module' => 'sesgroupalbum', 'controller' => 'admin-manage', 'action' => 'delete-photo', 'id' => $item->photo_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
