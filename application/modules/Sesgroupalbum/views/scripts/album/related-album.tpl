...
<script type="text/javascript">
  function viewMore() {
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesgroupalbum/album/related-album/album_id/' + id ,
      'data': {
        format: 'html',
...
function relatedAlbumSave(id){
    ...
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesgroupalbum/album/save-related-album/album_id/<?php echo $this->album_id; ?>' ,
      'data': {
        format: 'html',
				id : id,
        data: updateStatus,
