     ...
     if($this->toArray){
       if(!$taggedUserMap){
        if(!empty($this->previousPhoto))
        	$previousURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref($this->previousPhoto[0],array_merge($this->params,$this->extraParamsPrevious));
          if(!empty($previousURL))
          $previousImageURL = $this->previousPhoto->getPhotoUrl('','',$this->stringD);
        }else{
         if(!empty($this->previousPhoto[0]['photo_id']))
        	$previousURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref(Engine_Api::_()->getItem('sesgroupalbum_photo',$this->previousPhoto[0]['photo_id']),array_merge($this->params,$this->extraParamsPrevious));
          if(!empty($previousURL))
          $previousImageURL = Engine_Api::_()->getItem('sesgroupalbum_photo',$this->previousPhoto[0]['photo_id'])->getPhotoUrl('','',$this->stringD);
        }
       }else{
       		if(!$taggedUserMap){
        if(!empty($this->previousPhoto))
        	$previousURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref($this->previousPhoto,array_merge($this->params,$this->extraParamsPrevious));
          if(!empty($previousURL))
          $previousImageURL = $this->previousPhoto->getPhotoUrl('','',$this->stringD);
        }else{
         if(!empty($this->previousPhoto->photo_id))
        	$previousURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref(Engine_Api::_()->getItem('sesgroupalbum_photo',$this->previousPhoto->photo_id),array_merge($this->params,$this->extraParamsPrevious));
          if(!empty($previousURL))
          $previousImageURL = Engine_Api::_()->getItem('sesgroupalbum_photo',$this->previousPhoto->photo_id)->getPhotoUrl('','',$this->stringD);
        }
       }
        ...
        if(isset($this->previousPhoto[0]))
          $imagePrevUrl =  Engine_Api::_()->getItem('sesgroupalbum_photo',$this->previousPhoto[0]['photo_id']) ;
        else
...
<?php } 
          ...
          if(!empty($this->nextPhoto))
	          $nextURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref($this->nextPhoto[0],array_merge($this->params,$this->extraParamsNext));
            if(!empty($nextURL))
            $nextImageURL  = $this->nextPhoto->getPhotoUrl('','',$this->stringD);
          }else{
          if(!empty($this->nextPhoto[0]['photo_id']))
  	        $nextURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref(Engine_Api::_()->getItem('sesgroupalbum_photo',$this->nextPhoto[0]['photo_id']),array_merge($this->params,$this->extraParamsNext));
            if(!empty($nextURL))
            $nextImageURL = Engine_Api::_()->getItem('sesgroupalbum_photo',$this->nextPhoto[0]['photo_id'])->getPhotoUrl('','',$this->stringD);
          }
         }else{
         		 if(!$taggedUserMap){
          if(!empty($this->nextPhoto))
	          $nextURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref($this->nextPhoto,array_merge($this->params,$this->extraParamsNext));
            if(!empty($nextURL))
            $nextImageURL  = $this->nextPhoto->getPhotoUrl('','',$this->stringD);
          }else{
          if(!empty($this->nextPhoto->photo_id))
  	        $nextURL = Engine_Api::_()->sesgroupalbum()->getImageViewerHref(Engine_Api::_()->getItem('sesgroupalbum_photo',$this->nextPhoto->photo_id),array_merge($this->params,$this->extraParamsNext));
            if(!empty($nextURL))
            $nextImageURL = Engine_Api::_()->getItem('sesgroupalbum_photo',$this->nextPhoto->photo_id)->getPhotoUrl('','',$this->stringD);
          }
         }
        if(!empty($nextURL)){
        if(isset($this->imagePrivateURL))
        ...
        if(isset($this->nextPhoto[0]))
          	$imageNextUrl =  Engine_Api::_()->getItem('sesgroupalbum_photo',$this->nextPhoto[0]['photo_id']) ;
        else
    ...
    <div id="flexcroll" >
      <div class="ses_pswp_info" id="ses_pswp_info">
        ...
        <div class="ses_pswp_location"> <span class="sesbasic_text_light" id="seslocationIn">
          ...
          <span>
            <a id="sesgroup_location_data" href="<?php echo $this->url(array("module"=> "sesgroupalbum", "controller" => "photo", "action" => "location", "type" => "location","album_id" =>$this->photo->album_id, "photo_id" => $this->photo->getIdentity()),'default',true); ?>" onclick="openGroupURLinkSmoothBox(this.href);return false;"><?php echo $this->photo->location; ?></a>
         </span>
        </div>
        <?php } ?>
      ...
      <?php } ?>
      <div class="ses_pswp_comments clear"> <?php echo $this->action("list", "comment", "core", array("type" => "sesgroupalbum_album", "id" => $this->photo->getIdentity())); ?> </div>
    </div>
  </div>
</div>
</div>
<div class="pswp__top-bar" style="display:none" id="imageViewerId"> 
  ...
  <a title="<?php echo $this->translate('Toggle Fullscreen'); ?>" onclick="toogle()" href="javascript:;" class="pswp__button sesgroupalbum_toogle_screen"></a>
  <a title="<?php echo $this->translate('Show Info'); ?>" id="pswp__button--groupalbuminfo-show" class="pswp__button pswp__button--info pswp__button--info-show"></a> 
  ...
  <div class="pswp__top-bar-action">
    <div class="pswp__top-bar-albumname"><?php echo $this->translate('In %1$s', $this->htmlLink( Engine_Api::_()->sesgroupalbum()->getHref($this->album->getIdentity()), $this->string()->truncate($this->album->getTitle(),Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.title.truncate',35)))); ?> </div>
    <div class="pswp__top-bar-tag">
      <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.tags',1) == 1 && $this->canTag){ ?>
    ...
    <div class="pswp__top-bar-share">
      <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.share',1) == 1){ ?>
      <a href="javascript:;" class='smoothbox' onclick="openGroupURLinkSmoothBox('<?php echo $this->url(array("action" => "share", "type" => "sesgroupalbum_photo", "photo_id" => $this->photo->getIdentity(),"format" => "smoothbox"), 'sesgroupalbum_general', true); ?>'); "><?php echo $this->translate('Share'); ?></a>
      <?php } ?>
    </div>
    <div class="pswp__top-bar-more"> <a href="javascript:;" class="optionGroupOpenImageViewer" id="overlay-model-class" class=""><?php echo $this->translate('Options') ?> <i class="fa fa-angle-down" id="overlay-model-class-down"></i></a>
      <div class="pswp__top-bar-more-tooltip" style="display:none">
        <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 && $this->canDelete){ ?>
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.delete',1) == 1){ ?>
        <a href="javascript:;" class='smoothbox' onclick="openGroupURLinkSmoothBox('<?php echo $this->url(array('reset' => false, 'action' => 'delete', 'format' => 'smoothbox')); ?>')"><?php echo $this->translate('Delete'); ?></a>
        <?php } ?>
        <?php } ?>
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.report',1) == 1 && Engine_Api::_()->user()->getViewer()->getIdentity() != 0){ ?>
        <a href="javascript:;" class='smoothbox' onclick="openGroupURLinkSmoothBox('<?php echo $this->url(array('module'=> 'core', 'controller' => 'report', 'action' => 'create', 'route' => 'default', 'subject' => $this->photo->getGuid(), 'format' => 'smoothbox'),'default',true); ?>')"><?php echo $this->translate('Report'); ?></a>
        <?php } ?>
        <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.profilepic',1) == 1){ ?>
        <a href="javascript:;" class='smoothbox' onclick="openGroupURLinkSmoothBox('<?php echo $this->url(array('route' => 'user_extended', 'controller' => 'edit', 'action' => 'external-photo', 'photo' => $this->photo->getGuid(), 'format' => 'smoothbox'),'user_extended',true); ?>')"><?php echo $this->translate('Make Profile Photo'); ?></a>
        <?php } ?>
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.download',1) == 1 && isset($this->canDownload) && $this->canDownload == 1){ ?>
        <a class="ses-album-photo-download" href="<?php echo $this->url(array('module' => 'sesgroupalbum', 'action' => 'download', 'photo_id' => $this->photo->photo_id,'type'=>'photo'), 'sesgroupalbum_general', true); ?>"><?php echo $this->translate('Download'); ?></a>
        <?php } ?>
        ...
        <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 && (Engine_Api::_()->user()->getViewer()->level_id == 1 || Engine_Api::_()->user()->getViewer()->level_id == 2)): ?>
            <?php echo $this->htmlLink(Array("module"=> "sesgroupalbum", "controller" => "index", "action" => "featured", "route" => "sesgroupalbum_extended", "photo_id" => $this->photo->getIdentity(),"type" =>"photos"),  $this->translate((($this->photo->is_featured == 1) ? "Unmark as Featured" : "Mark Featured")), array("class" => "sesgroupalbum_admin_featured")) ?>          <?php echo $this->htmlLink(Array("module"=> "sesgroupalbum", "controller" => "index", "action" => "sponsored", "route" => "sesgroupalbum_extended", "photo_id" => $this->photo->getIdentity(),"type" =>"photos"),  $this->translate((($this->photo->is_sponsored == 1) ? "Unmark as Sponsored" : "Mark Sponsored")), array("class" => "sesgroupalbum_admin_sponsored")) ?>
            <?php if(strtotime($this->photo->endtime) < strtotime(date("Y-m-d")) && $this->photo->offtheday == 1){$itemofftheday=0;}else{$itemofftheday = $this->photo->offtheday;}
                echo $this->htmlLink(Array("module"=> "sesgroupalbum", "controller" => "index", "action" => "offtheday", "route" => "sesgroupalbum_extended","id" => $this->photo->photo_id, "type" => "sesgroupalbum_photo", "param" => (($itemofftheday == 1) ? 0 : 1)),  $this->translate((($itemofftheday == 1) ? "Edit of the Day" : "Make of the Day")), array("class" => "smoothboxGroupOpen")); ?>
    	<?php endif; ?>
      </div>
    </div>
    <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0){ ?>
    <div class="pswp__top-bar-msg pswp__top-bar-btns">
    	<a class="sesbasic_icon_btn sesgroupalbum_icon_msg_btn smoothbox" href="<?php echo $this->url(array('module'=> 'sesgroupalbum', 'controller' => 'index', 'action' => 'message','photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'),'sesgroupalbum_extended',true); ?>" onclick="openGroupURLinkSmoothBox(this.href);return false;"><i class="fa fa-envelope"></i></a>      
     <?php if($this->canComment){ ?>
      ...
      <a href="javascript:;" data-src='<?php echo $this->photo->photo_id; ?>' id="sesgroupalbum_favourite" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn sesgroupalbum_photoFav<?php echo ($albumFavStatus)>0 ? 'button_active' : '' ; ?>"><i class="fa fa-heart"></i><span><?php echo $this->photo->favourite_count; ?></span></a>
      <?php } ?>
    </div>
    <?php } ?>
 ...
 <div id="media_photo_next_ses" style="display:inline;">
  ...
  <div id="sesgroupalbum_check_privacy_album" class="<?php echo $className; ?>"></div>
  <div id="sesgroupalbum_album_password" style="display:none;"><?php echo $this->password; ?></div>
  <div id="sesgroupalbum_album_title" style="display:none;"><?php echo $this->album->getTitle(); ?></div>
   <div id="sesgroupalbum_photo_id_data_org" data-src="<?php echo $this->photo->getPhotoUrl('','','string'); ?>" style="display:none;"></div>
   <div id="sesgroupalbum_album_album_id" data-src="<?php echo $this->photo->album_id; ?>" style="display:none;"></div>    
   <div id="sesgroupalbum_photo_id_data_src" data-src="<?php echo $this->photo->photo_id; ?>" style="display:none;"></div>
