  ...
  <div class="ses_media_lightbox_options">
    ...
    <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0){ ?>
     <div class="ses_media_lightbox_options_btns">
      <?php $LikeStatus = Engine_Api::_()->sesgroupalbum()->getLikeStatusPhoto($this->child_item->getIdentity(),$this->child_item->getType()); ?>
        <a href="javascript:void(0);" data-src="albumLike" id="sesLightboxLikeUnlikeButton" class="sesbasic_icon_btn sesbasic_icon_like_btn sesgroupalbum_othermodule_like_button nocount<?php echo $LikeStatus ? ' button_active' : '' ;  ?>"><i class="fa fa-thumbs-up"></i><span id="like_unlike_count"></span></a>
      </div>
    <?php } ?>
    ...
    <div class="ses_media_lightbox_options_btn ses_media_lightbox_more_btn">
      <div class="ses_media_lightbox_options_box">
        ...
        <?php } ?>
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupalbum.add.download',1) == 1){ ?>
