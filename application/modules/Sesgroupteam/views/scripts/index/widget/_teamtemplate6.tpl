...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesgroupteam/externals/styles/template6.css');
?>

<div class="sesgroupteam_temp6_wrap">
  <div class="sesgroupteam_temp6_list">
    <table>
        ...
        <tr>
          ...
          <?php if(!empty($this->content_show)): ?>
            <td class="sesgroupteam-social-icon <?php if(empty($this->sesgroupteam_social_border)): ?>bordernone<?php endif; ?>">
