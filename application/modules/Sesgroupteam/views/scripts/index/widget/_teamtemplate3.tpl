...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesgroupteam/externals/styles/template3.css');
?>

<div class="sesgroupteam_temp3_wrap">
  <div class="sesgroupteam_temp3_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
