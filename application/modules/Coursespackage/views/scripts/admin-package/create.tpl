...
<div class="sesbasic_search_result">
  <?php echo $this->htmlLink($this->url(array('module' => 'courses', 'controller' => 'package','action'=>'index')), $this->translate("Back to Manage Packages"), array('class' => 'buttonlink sesbasic_icon_back')); ?>
</div><br />
