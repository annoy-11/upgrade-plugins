 ...
 * @version    $Id: _packageHorizontal.tpl 2019-11-05 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
 
?>
 <li class="courses_packages_list_item <?php echo ($package->highlight) ? 'active' : '' ?>">
  <section>
   <div class="_top sesbasic_clearfix">
   		<div class="_title"><h5><?php echo $this->translate($package->title); ?></h5></div>
      <div class="_price">
        <?php if(!$package->isFree()){ ?>
          <span><?php echo Engine_Api::_()->courses()->getCurrencyPrice($package->price,'','',true); ?></span>
          <small>
            ...
            <?php elseif($package->recurrence_type == 'forever'): ?>
              <?php echo sprintf($this->translate('One-time fee of %1$s'), Engine_Api::_()->coursespackage()->getCurrencyPrice($package->price,'','',true)); ?>
            <?php else:?>
    ...
    <div class="_btns sesbasic_clearfix">
      <?php if($existing && !$package->isOneTime()):?>
        <div class="_left">
          <a href="<?php echo $this->url(array('action' => 'cancel','package_id' => $package->package_id),'coursespackage_general',true);?>" class="courses_packages_cancel_btn smoothbox"><?php echo $this->translate("Cancel");?></a>
