...
<p>
	<?php echo $this->translate("This page lists all the Banner Slideshows created by you. Here, you can also add and manage any number of banner slideshows on your website. You can place these banners anywhere on your website including the Landing Page and any other widgetized page of your choice.<br />You can add and manage any number of Photo Slides in each banner slideshow. Each photo slide is highly configurable and you can add title, description and additional button to each banner. Use “Create New Banner Slideshow” link below to create new banner slideshow.<br />These slideshows will display in the “UTube Clone Theme - Banner Slideshows” widget from the Layout Editor on the pages of your choice.”") ?>	
</p>
<br class="clear" />
<div class="sesbasic_search_reasult">
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesytube', 'controller' => 'manage-banner', 'action' => 'create-banner'), $this->translate("Create New Banner"), array('class'=>'smoothbox sesbasic_icon_add buttonlink')) ?>
</div>
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          ...
          <?php $photos = Engine_Api::_()->getDbtable('slides', 'sesytube')->getSlides($item->banner_id, 'show_all'); ?>
          <td><?php echo $photos->getTotalItemCount(); ?></td>
          <td><?php echo $item->creation_date; ?></td>          
          <td class="admin_table_centered"><?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesytube', 'controller' => 'manage-banner', 'action' => 'enabled', 'id' => $item->banner_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disable'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesytube', 'controller' => 'manage-banner', 'action' => 'enabled', 'id' => $item->banner_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enable')))) ) ?></td>
          <td>
          	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesytube', 'controller' => 'manage-banner', 'action' => 'manage', 'id' => $item->banner_id), $this->translate("Manage Photos"), array()) ?>
            |
            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesytube', 'controller' => 'manage-banner', 'action' => 'create-banner', 'id' => $item->banner_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?>
            |
            <?php echo $this->htmlLink(
                array('route' => 'admin_default', 'module' => 'sesytube', 'controller' => 'manage-banner', 'action' => 'delete-banner', 'id' => $item->banner_id),
