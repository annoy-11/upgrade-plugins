 ...
 * @version    $Id: friendship-requests.tpl  2019-02-01 00:00:00 SocialEngineSolutions $
...
<?php if(count($this->peopleyoumayknow) > 0): ?>
  <div class="sesytube_pulldown_header"><?php echo $this->translate("People You May Know"); ?></div>
...
<script type="text/javascript">
  ...
  function redirectPage(event) {
    ...
    if(current_link.get('href') == null && $(current_link).get('tag')!='img') {
      ...
      new Request.JSON({
        url : en4.core.baseUrl + 'sesytube/notifications/markreadmention',
        data : {
          format     : 'json',
