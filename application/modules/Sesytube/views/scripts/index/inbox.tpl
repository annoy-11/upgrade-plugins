 ...
 * @version    $Id: inbox.tpl  2019-02-01 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesytube/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sesytube_messages_menu')){
          var message_children = $('sesytube_messages_menu').getChildren('li');
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesytube/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
