 ...
 * @version    $Id: Login.php  2019-02-01 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesytube_Form_Login extends Engine_Form_Email
{
  protected $_mode;
  ...
  public function init()
  {
    ...
    $this->setAttrib('id', 'sesytube_form_login');
