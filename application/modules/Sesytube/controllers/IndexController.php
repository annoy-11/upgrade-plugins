 ...
 * @version    $Id: IndexController.php  2019-02-01 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesytube_IndexController extends Core_Controller_Action_Standard {
  ...
  public function inboxAction() {
    ...
    Engine_Api::_()->getApi('message', 'sesytube')->setUnreadMessage($viewer);
  }
  ...
  public function friendshipRequestsAction() {
    ...
    $this->view->friendRequests = $newFriendRequests = Engine_Api::_()->getDbtable('notifications', 'sesytube')->getFriendrequestPaginator($viewer);
    $newFriendRequests->setCurrentPageNumber($this->_getParam('page'));
    Engine_Api::_()->getApi('message', 'sesytube')->setUnreadFriendRequest($viewer);
  ...
  public function newMessagesAction() {
    $this->view->messageCount = Engine_Api::_()->getApi('message', 'sesytube')->getMessagesUnreadCount(Engine_Api::_()->user()->getViewer());
  }

  public function markallmessageAction() {

    $viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity();
    Engine_Api::_()->getDbtable('recipients', 'messages')->update(array('ytube_read' => 1,  'inbox_read' => 1), array('`user_id` = ?' => $viewer_id));
