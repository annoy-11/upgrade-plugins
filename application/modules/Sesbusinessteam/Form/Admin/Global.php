 ...
 */
class Sesbusinessteam_Form_Admin_Global extends Engine_Form {
  ...
  public function init() {
    ...
    $view = Zend_Registry::isRegistered('Zend_View') ? Zend_Registry::get('Zend_View') : null;
		...
		$this->addElement('Text', "sesbusinessteam_licensekey", array(
		'label' => 'Enter License key',
		'description' => $descriptionLicense,
		'allowEmpty' => false,
		'required' => true,
		'value' => $settings->getSetting('sesbusinessteam.licensekey'),
		));
		$this->getElement('sesbusinessteam_licensekey')->getDecorator('Description')->setOptions(array('placement' => 'PREPEND', 'escape' => false));

    if ($settings->getSetting('sesbusinessteam.pluginactivated')) {

      $this->addElement('Text', 'sesbusinessteam_urlmanifest', array(
          'label' => '"businessteam" Text in URL',
          'allowEmpty' => false,
          'required' => true,
          'description' => 'Enter the text which you want to show in place of “team” in the URL of Team Business of this plugin.',
          'value' => $settings->getSetting('sesbusinessteam.urlmanifest', "businessteam"),
      ));
