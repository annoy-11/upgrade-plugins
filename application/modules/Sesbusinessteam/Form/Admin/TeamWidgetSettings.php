...
class Sesbusinessteam_Form_Admin_TeamWidgetSettings extends Engine_Form {

  public function init() {

    $tempalte1 = 'http://demo.socialenginesolutions.com/businesss/teamdesigns';

    $this->addElement('Radio', 'sesteam_template', array(
        'label' => 'Choose the design for team business.',
        'multiOptions' => array(
