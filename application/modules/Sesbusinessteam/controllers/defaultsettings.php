...
if ($page_id) {
    ...
    'order' => 35,
    'params' => '{"sesteam_template":"1","sesteam_contentshow":["displayname","photo","designation","description","email","phone","location","website","facebook","linkdin","twitter","googleplus","viewMore"],"deslimit":"100","viewMoreText":"View Details","height":"200","width":"200","center_block":"1","center_description":"1","title":"Teams","nomobile":"0","name":"sesbusinessteam.team"}',
    ));
}
...
$page_id = $db->select()
        ->from('engine4_core_pages', 'page_id')
        ->where('name = ?', 'sesbusinessteam_index_view')
        ->limit(1)
        ->query()
        ->fetchColumn();
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      'name' => 'sesbusinessteam_index_view',
  ...
  $db->insert('engine4_core_content', array(
    'type' => 'widget',
    'name' => 'sesbusinessteam.viewpage-team',
    'page_id' => $page_id,
    'parent_content_id' => $main_middle_id,
    'order' => $widgetOrder++,
    'params' => '{"infoshow":["featured","sponsored","profilePhoto","displayname","designation","description","detaildescription","email","phone","location","website","facebook","linkdin","twitter","googleplus"],"title":"","nomobile":"0","name":"sesbusinessteam.viewpage-team"}',
  ));
}
