...
<form method="post" class="global_form_popup">
  <div>
    <h3><?php echo $this->translate("Remove Business Team Member?") ?></h3>
    <p>
      <?php echo $this->translate("Are you sure that you want to remove this entry as Business Team Member from your website? It will not be recoverable after being deleted.") ?>
    </p>
    <br />
    <p>
