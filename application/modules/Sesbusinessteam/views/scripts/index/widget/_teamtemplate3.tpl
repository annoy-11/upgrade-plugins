...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesbusinessteam/externals/styles/template3.css');
?>

<div class="sesbusinessteam_temp3_wrap">
  <div class="sesbusinessteam_temp3_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
