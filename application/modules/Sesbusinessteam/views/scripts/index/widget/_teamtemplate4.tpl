...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesbusinessteam/externals/styles/template4.css');
?>

<div class="sesbusinessteam_temp4_wrap">

  <div class="sesbusinessteam_temp4_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
