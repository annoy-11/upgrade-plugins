...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesbusinessteam/externals/styles/template1.css');
?>

<div class="sesbusinessteam_temp1_wrap">
  <div class="sesbusinessteam_temp1_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
     ...
     <div class="team_box" style="width:<?php echo $this->width ?>px;">
        <div class="team_box_inner">
          ...
          <div class="team_box_bottom">
            ...
            <?php endif; ?>
            <div class="sesbusinessteam-social-icon <?php if(empty($this->sesbusinessteam_social_border)): ?>bordernone<?php endif; ?>">
              <?php if($user->email && !empty($this->content_show) && in_array('email', $this->content_show)): ?>
                <a href="mailto:<?php echo $user->email ?>" title="<?php echo $user->email ?>">
                  <i class="fa fa-envelope sesbasic_text_light"></i>
                </a> 
