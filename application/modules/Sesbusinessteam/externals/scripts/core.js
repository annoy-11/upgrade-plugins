...
function validateTeamform() {
  ...
  sesJqueryObject('.sesbusinessteam_formcheck input, .sesbusinessteam_formcheck select, .sesbusinessteam_formcheck checkbox, .sesbusinessteam_formcheck textarea, .sesbusinessteam_formcheck radio').each(
    function(index){
...
sesJqueryObject(document).on('submit', '#sesbusinessteam_addteam', function(e) {
  e.preventDefault();
  addTeam(this);
});

sesJqueryObject(document).on('submit', '#sesbusinessteam_adddesignation', function(e) {
  e.preventDefault();
  addDesignation(this);
});
