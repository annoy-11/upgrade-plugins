 ...
 * @version    $Id: Metas.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesrecipe_Model_DbTable_Metas extends Engine_Db_Table {

  protected $_name = 'sesrecipe_recipe_fields_meta';
  protected $_rowClass = 'Sesrecipe_Model_Meta';
	
	public function getMetaData($options_id = null){
		if(!$options_id)
			return null;
		$tableName = $this->info('name');
		$mapTableName = Engine_Api::_()->getDbTable('maps','sesrecipe')->info('name');
  ...
  public function profileFieldId() {
	...
	public function reviewProfileFieldId() {
	  $table = Engine_Api::_()->fields()->getTable('sesrecipe_review', 'metas');
		return $table->select()
