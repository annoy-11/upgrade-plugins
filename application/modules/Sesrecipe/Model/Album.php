...
class Sesrecipe_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'sesrecipe_recipe';

  protected $_owner_type = 'sesrecipe_recipe';

  protected $_children_types = array('sesrecipe_photo');

  protected $_collectible_type = 'sesrecipe_photo';

//   public function getHref($params = array())
//   {
//     return $this->getSesrecipe()->getHref($params);
//   }
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sesrecipe/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $sesrecipePhoto ) {
      $sesrecipePhoto->delete();
    }
