 ...
 * @version    $Id: _simplelistView.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<li class="sesrecipe_list_second_recipe sesbasic_clearfix clear">
	<div class="sesrecipe_list_thumb sesrecipe_thumb" style="height:<?php echo is_numeric($this->height_simplelist) ? $this->height_simplelist.'px' : $this->height_simplelist ?>;width:<?php echo is_numeric($this->width_simplelist) ? $this->width_simplelist.'px' : $this->width_simplelist ?>;">
		...
		<?php if(isset($this->creationDateActive)){ ?>
			<div class="sesrecipe_list_second_recipe_date">
    ...
    <div class="sesrecipe_admin_list">
			<?php if(isset($this->byActive)){ ?>
				<div class="sesrecipe_stats_list admin_img sesbasic_text_dark">
			...
			<?php } ?>
		<div class="sesrecipe_stats_list sesbasic_text_dark sesrecipe_list_stats" style="">
    ...
    <div class="sesrecipe_list_contant">
		<?php if(isset($this->descriptionsimplelistActive)){ ?>
			<p class="sesrecipe_list_des">
				<?php echo $this->string()->truncate($this->string()->stripTags($item->body), $this->description_truncation_simplelist) ?>
			</p>
		<?php } ?>      
		</div>
		<?php if(isset($this->readmoreActive)):?>
			<div class="sesrecipe_list_readmore"><a class="sesrecipe_animation" href="<?php echo $item->getHref();?>"><?php echo $this->translate('Read More');?></a></div>
		<?php endif;?>
