 ...
 * @version    $Id: edit.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
...
<?php if(!$this->is_ajax){ ?>
  <?php
  echo $this->partial('dashboard/left-bar.tpl', 'sesrecipe', array(
  'recipe' => $this->recipe,
  ));	
  ?>
  <div class="sesbasic_dashboard_content sesbm sesbasic_clearfix">
<?php } ?>
<div class="sesbasic_dashboard_form sesrecipe_create sesbasic_bxs">
...
var counter = 0;
  function validateForm(){
    ...
    jqueryObjectOfSes('#sesrecipes_edit input, #sesrecipes_edit select,#sesrecipes_edit checkbox,#sesrecipes_edit textarea,#sesrecipes_edit radio').each(
      function(index){
  ...
  jqueryObjectOfSes('#sesrecipes_edit').submit(function(e){
    var validationFm = validateForm();
		if(!validationFm && sesJqueryObject('#sesrecipe_schedule_time').length > 0 ) {
