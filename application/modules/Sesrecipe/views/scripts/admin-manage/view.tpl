 ...
 * @version    $Id: view.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
...
<div class="sesbasic_view_stats_popup">
  ...
  <table>
    ...
    <?php } ?>
    <?php if(isset($this->item->location) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesrecipe_enable_location', 1)){ ?>
    <tr>
