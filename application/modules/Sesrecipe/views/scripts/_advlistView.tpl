 ...
 * @version    $Id: _advlistView.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<li class="sesrecipe_list_full_view sesbasic_clearfix clear">
  <?php if(isset($this->creationDateActive)){ ?>
		<div class="sesrecipe_list_full_date_recipe">
  ...
  <?php } ?>
		...
		<?php endif;?>
		<div class="sesrecipe_list_full_meta">
		...
		<div class="sesrecipe_list_full_border">
			<div class="sesrecipe_list_border_one floatL"></div>
			<div class="sesrecipe_list_border_two floatL"></div>
			<div class="sesrecipe_list_border_three floatL"></div>
		</div>
		<div class="sesrecipe_list_full_contant_recipe">
		...
		<div class="sesrecipe_list_full_stats">
