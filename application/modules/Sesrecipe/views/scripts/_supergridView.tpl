 ...
 * @version    $Id: _simplegridView.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<li class="sesrecipe_new_grid_block sesbasic_bxs <?php if((isset($this->my_recipes) && $this->my_recipes)){ ?>isoptions<?php } ?>" style="width:<?php echo is_numeric($this->width_supergrid) ? $this->width_supergrid.'px' : $this->width_supergrid ?>;">
		...
		<?php if(isset($this->categoryActive)): ?>
		  <?php if($item->category_id != '' && intval($item->category_id) && !is_null($item->category_id)):?> 
			  <?php $categoryItem = Engine_Api::_()->getItem('sesrecipe_category', $item->category_id);?>
				<?php if($categoryItem):?>
			    <div class="sesrecipe_grid_info_title"><a href="<?php echo $categoryItem->getHref(); ?>"><?php echo $categoryItem->category_name; ?></a></div>
			  <?php endif;?>
			<?php endif;?>
		<?php endif; ?>
		<div class="sesrecipe_grid_thumb sesrecipe_thumb" style="height:<?php echo is_numeric($this->height_supergrid) ? $this->height_supergrid.'px' : $this->height_supergrid ?>;">
      ...
      <?php if(isset($this->verifiedLabelActive) && $item->verified == 1):?>
		...
		<div class="sesrecipe_grid_info clear clearfix sesbm">
		  <?php if(isset($this->creationDateActive)){ ?>
				<div class="sesrecipe_grid_date_recipe">
			...
			<?php if(isset($this->titleActive)): ?>
				<div class="sesrecipe_second_grid_info_title">
			...
			<?php  if(isset($this->descriptionsupergridActive)){?>
				<div class="sesrecipe_grid_des clear">
					<?php echo $this->string()->truncate($this->string()->stripTags($item->body), $this->description_truncation_supergrid) ?>
					<span></span>
				</div>
			<?php } ?>
			<div class="sesrecipe_comment_list sesrecipe_list_stats sesbasic_text_dark">
		...
		<?php if(isset($this->readmoreActive)):?>
			<div class="sesrecipe_second_readmore_link">
