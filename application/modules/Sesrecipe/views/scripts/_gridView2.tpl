 ...
 * @version    $Id: _gridView2.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>

<li class="sesrecipe_new_grid" style="width:<?php echo is_numeric($this->width_advgrid2) ? $this->width_advgrid2.'px' : $this->width_advgrid2 ?>;">
  <div class="sesrecipe_new_grid_inner sesrecipe_thumb">
    <div class="sesrecipe_grid_thumb" style="height:<?php echo is_numeric($this->height_advgrid2) ? $this->height_advgrid2.'px' : $this->height_advgrid2 ?>;">
  ...
  <div class="sesrecipe_grid_info">
    <?php if(isset($this->categoryActive)){ ?>
    	<div class="sesrecipe_new_grid_category_title">
    ...
    <?php if(isset($this->titleActive) ){ ?>
    	<div class="sesrecipe_gird_title">
    ...
    <?php } ?>
    <div class="sesrecipe_grid_meta_tegs">
      <ul>
      	<?php if(isset($this->byActive)){ ?>
        	<li class="sesrecipe_grid_meta_owner">
        ...
        <?php if(isset($this->creationDateActive)): ?>
        	<li class="sesrecipe_grid_meta_date">
        ...
        <?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesrecipe.enable.location', 1)){ ?>
          <li class="sesrecipe_grid_meta_location">
    ...
    <?php  if(isset($this->descriptiongrid2Active)){?>
      <div class="sesrecipe_grid_contant">
        <?php echo $this->string()->truncate($this->string()->stripTags($item->body), $this->description_truncation_advgrid2) ?>
      </div>
    <?php } ?>
    <div class="sesrecipe_grid_stats">
      <ul>
        ...
        <?php if(isset($this->viewActive) && isset($item->view_count)) { ?>
          <li>
        	...
        	<?php } ?>
         <li><?php include APPLICATION_PATH .  '/application/modules/Sesrecipe/views/scripts/_recipeRatingStat.tpl';?></li>
      </ul>
      <p class="sesrecipe_grid_divider"></p>
    </div>
  </div>
</li>
