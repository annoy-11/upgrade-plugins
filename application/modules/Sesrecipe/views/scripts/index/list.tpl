 ...
 * @version    $Id: list.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
...
<?php elseif( $this->category || $this->tag ): ?>
  <div class="tip">
    <span>
      <?php echo $this->translate('%1$s has not published a recipe entry with that criteria.', $this->owner->getTitle()); ?>
    </span>
  </div>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate('%1$s has not written a recipe entry yet.', $this->owner->getTitle()); ?>
    </span>
  </div>
<?php endif; ?>
