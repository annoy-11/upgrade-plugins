...
<div class="headline">
  <h2>
    <?php echo $this->translate('Sesrecipes');?>
  </h2>
  <div class="tabs">
...
<div class="sesrecipe_recipe_form"> <?php echo $this->form->render(); ?></div>
...
<script type="text/javascript">
  ...
  <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesrecipe_enable_location', 1)){ ?>
