 ...
 * @version    $Id: link-recipe.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    var id = '<?php echo $this->recipe_id; ?>';
    
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesrecipe/index/link-recipe/recipe_id/' + id ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate('Events in which you can link to recipe') ?>
...
<?php endif; ?>
    ...
    <?php if (count($this->paginator) > 0) : ?>
      <form id='link_recipe' name="link_recipe" method="post" action="<?php echo $this->url();?>">
