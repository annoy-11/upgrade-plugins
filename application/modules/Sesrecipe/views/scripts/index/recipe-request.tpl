 ...
 * @version    $Id: recipe-request.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
    ...
    <table>
      ...
      <tbody>
	    ...
	    <a href="<?php echo $user->getHref(); ?>"><?php echo $user->getTitle(); ?></a>
           ...
           <td>
	    <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesrecipe', 'controller' => 'index', 'action' => 'approved', 'event_id' => $item->event_id, 'recipe_id' => $item->recipe_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Approve')))) ?>
          </td>
          <td class="table_options">
	    <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesrecipe', 'controller' => 'index', 'action' => 'reject-request', 'event_id' => $item->event_id, 'recipe_id' => $item->recipe_id), $this->translate('Reject Request')) ?>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
