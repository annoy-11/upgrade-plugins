 ...
 * @version    $Id: review-rating.tpl 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<div class="form-wrapper sesrecipe_form_rating_star">
  <div class="form-label"><label><?php echo $this->translate("Overall Rating"); ?></label></div>
  <div id="sesrecipe_review_rating" class="sesbasic_rating_star sesrecipe_rating_star_element" onmouseout="rating_out();">
...
function validateForm(){
		...
		counter = 0;
		sesJqueryObject('#sesrecipe_review_form input, #sesrecipe_review_form select,#sesrecipe_review_form checkbox,#sesrecipe_review_form textarea,#sesrecipe_review_form radio').each(
				function(index){
			...
			en4.core.runonce.add(function()
				{
			sesJqueryObject('#sesrecipe_review_form').submit(function(e){
					var validationFm = validateForm();
					if(!sesJqueryObject('#rate_value').val()){
						alert('<?php echo $this->translate("Please fill the red mark fields"); ?>');
						 var errorFirstObject = sesJqueryObject('#sesrecipe_review_rating').parent();
