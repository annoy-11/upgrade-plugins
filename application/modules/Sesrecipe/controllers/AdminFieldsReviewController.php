 ...
 * @version    $Id: AdminFieldsReviewController.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesrecipe_AdminFieldsReviewController extends Fields_Controller_AdminAbstract {
  ...
  public function indexAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesrecipe_admin_main_reviewsettings', array(), 'sesrecipe_admin_main_subreviewparameters');
  ...
  public function fieldEditAction() {
    ...
    // Create form
    $this->view->form = $form = new $adminFormClass();
    $form->setTitle('Edit Recipe Category Review Profile Question');
    $form->removeElement('show');
    $form->removeElement('search');
    $form->addElement('hidden', 'show', array('value' => 0));
    $form->removeElement('display');
  ...
  public function typeDeleteAction() {
    ...
    if (!empty($option_id)) {
      // Engine_Api::_()->getDbtable('categories', 'sesrecipe')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));
    }
