...
class Sesrecipe_Form_Fields extends Engine_Form
{
  ...
  public function init() {
    ...
    $this->setTitle('Custom Fields Entry')
      ->setDescription('Edit custom fields below, then click "Post Form" to publish the entry on your recipe.')->setAttrib('name', 'sesrecipes_fields');
    ...
    $user_level = Engine_Api::_()->user()->getViewer()->level_id;
      ...
      $customFields = new Sesrecipe_Form_Custom_Dashboardfields(array(
