 ...
 * @version    $Id: Location.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesrecipe_Form_Admin_Location extends Engine_Form {
  public function init() {    
   ...
   $this->addElement('dummy', 'location-data', array(
		'decorators' => array(array('ViewScript', array(
				'viewScript' => 'application/modules/Sesrecipe/views/scripts/location.tpl',
		)))
  ));
  }
}