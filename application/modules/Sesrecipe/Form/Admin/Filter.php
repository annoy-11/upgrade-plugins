 ...
 * @version    $Id: Filter.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesrecipe_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbtable('categories', 'sesrecipe')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Select', 'verified', array(
		...
		$isEnablePackage = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesrecipepackage') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesrecipepackage.enable.package', 1);
		if($isEnablePackage){
				$packages = Engine_Api::_()->getDbTable('packages','sesrecipepackage')->getPackage(array('default' => true));
				$packagesArray = array(''=>'');
