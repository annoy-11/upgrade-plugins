 ...
 * @version    $Id: OtherModulesTabbed.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesrecipe_Form_Admin_OtherModulesTabbed extends Engine_Form {

  public function init() {
  
    $this->addElement('MultiCheckbox', "enableTabs", array(
      'label' => "Choose the View Type for Recipes.",
      'multiOptions' => array(
      'list' => 'List View 1',
   ...
   $categories = array('' => '') + $categories;
    ...
    $this->addElement('Select', "show_limited_data", array(
			'label' => 'Show only the number of recipes entered in above setting. [If you choose No, then you can choose how do you want to show more recipes in this widget.]',
			 'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
    ...
    $this->addElement('Text', "limit_data_grid2", array(
      'label' => 'Count for Grid Views 4 (number of recipes to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
