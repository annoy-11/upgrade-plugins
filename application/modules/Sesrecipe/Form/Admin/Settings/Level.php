 ...
 * @version    $Id: Level.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesrecipe_Form_Admin_Settings_Level extends Authorization_Form_Admin_Level_Abstract
{
  public function init()
  {
    ...
    $this->addElement('Radio', 'view', array(
      ...
      'description' => 'Do you want to let members view recipes? If set to no, some other settings on this page may not apply.',
      'multiOptions' => array(
        2 => 'Yes, allow members to view all recipes, even private ones.',
        1 => 'Yes, allow members to view their own recipes.',
    ...
    if( !$this->isPublic() ) {
      ...
      $this->addElement('Radio', 'create', array(
        'label' => 'Allow Creation of Recipes?',
        'description' => 'Do you want to let members create recipes? If set to no, some other settings on this page may not apply. This is useful if you want members to be able to view recipes, but only want certain levels to be able to create recipes.',
        'multiOptions' => array(
          1 => 'Yes, allow creation of recipes.',
          0 => 'No, do not allow recipes to be created.'
        ),
        'value' => 1,
      ));
      ...
      $this->addElement('Radio', 'delete', array(
        ...
        'description' => 'Do you want to let members delete recipes? If set to no, some other settings on this page may not apply.',
        'multiOptions' => array(
      ...
      $this->addElement('Radio', 'comment', array(
        'label' => 'Allow Commenting on Recipes?',
        'description' => 'Do you want to let members of this level comment on recipes?',
        'multiOptions' => array(
          2 => 'Yes, allow members to comment on all recipes, including private ones.',
          1 => 'Yes, allow members to comment on recipes.',
          0 => 'No, do not allow members to comment on recipes.',
        ),
        'value' => ( $this->isModerator() ? 2 : 1 ),
      ));
      if( !$this->isModerator() ) {
      ...
      $this->addElement('Radio', 'recipe_approve', array(
        'description' => 'Do you want recipes created by members of this level to be auto-approved?',
        'label' => 'Auto Approve Recipes',
        'multiOptions' => array(
            1=>'Yes, auto-approve recipes.',
            0=>'No, do not auto-approve recipes.'
        ),
        'value' => 1,
       ));
      ...
      $this->addElement('MultiCheckbox', 'auth_view', array(
        ...
        'description' => 'Your members can choose from any of the options checked below when they decide who can see their recipe entries. These options appear on your members\' "Add Entry" and "Edit Entry" pages. If you do not check any options, settings will default to the last saved configuration. If you select only one option, members of this level will not have a choice.',
        'multiOptions' => array(
          'everyone'            => 'Everyone',
      ...
      $this->addElement('Radio', 'style', array(
        ...
        'description' => 'If you enable this feature, your members will be able to customize the colors and fonts of their recipes by altering their CSS styles.',
        'multiOptions' => array(
      ...
      $this->addElement('Radio', 'allow_claim', array(
          'label' => 'Allow Claim in Recipes',
          'description' => 'Do you want to let members claim in recipes?',
          'multiOptions' => array(
              1 => 'Yes, allow members to claim recipes.',
              0 => 'No, do not allow members to claim recipes.'
          ),
          'value' => 1,
      ));
      ...
      $this->addElement('Text', 'max', array(
        'label' => 'Maximum Allowed Recipe Entries?',
        'description' => 'Enter the maximum number of allowed recipe entries. The field must contain an integer between 1 and 999, or 0 for unlimited.',
        'validators' => array(
          array('Int', true),
