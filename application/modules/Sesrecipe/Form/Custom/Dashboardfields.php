 ...
 * @version    $Id: Dashboardfields.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesrecipe_Form_Custom_Dashboardfields extends Engine_Form {
  /* Custom */
  ...
  public function generate() {
    ...
    $orderIndex = 0;
		$package = Engine_Api::_()->getItem('sesrecipepackage_package',$this->getItem()->package_id);
