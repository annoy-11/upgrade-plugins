 ...
 * @version    $Id: Search.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
class Sesrecipe_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'sesrecipe', 'controller' => 'index', 'action' => 'browse'), 'default', true));
    ...
    if ($this->_locationSearch == 'yes' && $this->getSearchFor() == 'recipe') {
    ...
    if ($this->getHasPhoto() != 'no') {
      $this->addElement('Checkbox', 'has_photo', array(
          'label' => 'Only Recipes With Photos',
