 ...
 * @version    $Id: SesrecipeFieldValueLoop.php 2018-05-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesrecipe_View_Helper_SesrecipeFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function sesrecipeFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'sesrecipe' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
