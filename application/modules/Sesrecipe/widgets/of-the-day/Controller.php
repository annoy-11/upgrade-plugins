 ...
 */
class Sesrecipe_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {  
    ...
    $recipeId = Engine_Api::_()->getDbTable('recipes', 'sesrecipe')->getOfTheDayResults();
    $this->view->recipe_id = $recipeId ;
