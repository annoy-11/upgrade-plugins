...
<ul id="widget_sesrecipe_<?php echo $randonnumber; ?>" class="sesrecipe_related_recipes sesbasic_clearfix sesbasic_bxs">
  <div class="sesbasic_loading_cont_overlay" id="sesrecipe_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php foreach($this->paginator as $item):?>
		<li class="sesrecipe_grid_inside sesbasic_clearfix" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
		  <div class="sesrecipe_grid_inside_inner">
				<div class="sesrecipe_grid_inside_thumb sesrecipe_thumb" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height?>;">
					<a href="<?php echo $item->getHref();?>" class="sesrecipe_thumb_img" >
				...
				<div class="sesrecipe_grid_inside_info sesbasic_clearfix ">
				  <?php if(isset($this->categoryActive)): ?>
					...
					<?php if(Engine_Api::_()->getApi('core', 'sesrecipe')->allowReviewRating() && isset($this->ratingStarActive)):?>
						<?php echo $this->partial('_recipeRating.tpl', 'sesrecipe', array('rating' => $item->rating, 'class' => 'sesrecipe_list_rating sesrecipe_review_sidebar_list_stat', 'style' => ''));?>
					<?php endif;?>
