 ...
 */
class Sesrecipe_Widget_PeopleLikeItemController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!Engine_Api::_()->core()->hasSubject('sesrecipe_recipe'))
      return $this->setNoRender();
		...
		if(Engine_Api::_()->core()->hasSubject('sesrecipe_recipe'))
   	 $this->view->subject = $subject = Engine_Api::_()->core()->getSubject('sesrecipe_recipe');
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->sesrecipe()->likeItemCore($param);
