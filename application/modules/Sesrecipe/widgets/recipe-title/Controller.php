...
class Sesrecipe_Widget_RecipeTitleController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->recipe = Engine_Api::_()->getItem('sesrecipe_recipe', $recipe_id);
    else
    $this->view->recipe = Engine_Api::_()->core()->getSubject();
  }
