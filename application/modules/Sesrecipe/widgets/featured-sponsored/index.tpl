...
<?php if($this->view_type == 'list'): ?>
  <ul id="widget_sesrecipe_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block sesbasic_sidebar_block sesrecipe_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php else: ?>
  <ul id="widget_sesrecipe_<?php echo $randonnumber; ?>" class="sesrecipe_side_block sesbasic_bxs sesbasic_clearfix" style="position:relative;">
<?php endif; ?>
  <div class="sesbasic_loading_cont_overlay" id="sesrecipe_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php include APPLICATION_PATH . '/application/modules/Sesrecipe/views/scripts/_sidebarWidgetData.tpl'; ?>
