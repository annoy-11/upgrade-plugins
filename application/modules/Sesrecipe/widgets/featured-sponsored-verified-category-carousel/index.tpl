...
<div class="slide sesbasic_clearfix sesbasic_bxs sesrecipe_recipes_carousel_wrapper <?php echo $this->isfullwidth ? 'isfull_width' : '' ; ?>" style="height:<?php echo $this->height ?>px;display:none;" id="sesrecipe_carousel_<?php echo $this->identity; ?>">
  <div class="recipeslide_<?php echo $this->identity; ?>">
    <?php foreach( $this->paginator as $item): ?>
    <div class="sesrecipe_grid_inside sesrecipe_category_carousel_item sesbasic_clearfix sesrecipe_grid_btns_wrap" style="height:<?php echo $this->height ?>px;width:<?php echo $this->width ?>px;">
    	<div class="sesrecipe_grid_inside_inner">
      <div class="sesrecipe_category_carousel_item_thumb sesrecipe_thumb" style="height:<?php echo $this->height ?>px;">       
        <?php
        $href = $item->getHref();
		...
		<?php if((isset($this->socialSharingActive)  && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesrecipe.enable.sharing', 1)) || isset($this->likeButtonActive) || isset($this->favouriteButtonActive)):?>
			...
			<?php endif;?> 
				...
				<div class="sesrecipe_grid_inside_info sesbasic_clearfix ">
            ...
            <span class="sesrecipe_category_carousel_item_info_title">
              ...
              <?php } ?>
							<?php if(Engine_Api::_()->getApi('core', 'sesrecipe')->allowReviewRating() && isset($this->ratingStarActive)):?>
								<?php echo $this->partial('_recipeRating.tpl', 'sesrecipe', array('rating' => $item->rating, 'class' => 'sesrecipe_list_rating sesrecipe_list_view_ratting', 'style' => 'margin-bottom:0px; margin-top:5px;'));?>
							<?php endif;?>
            </span>
          <?php } ?>
      ...
      <?php if(isset($this->creationDateActive)){ ?>
				<div class="admin_teg sesrecipe_list_stats sesbasic_text_dark"><i class="fa fa-calendar"></i> <?php echo ' '.date('M d, Y',strtotime($item->publish_date));?></div>
			<?php } ?>
...
<script type="text/javascript">
  window.addEvent('domready', function () {
		<?php if($this->isfullwidth){ ?>
			...
			htmlElement.addClass('sesrecipe_recipes_carousel');
		<?php } ?>
