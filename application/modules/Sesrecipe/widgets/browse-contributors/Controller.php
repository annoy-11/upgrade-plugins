 ...
 */
class Sesrecipe_Widget_BrowseContributorsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $select = $userTable->select()
            ...
            ->join($recipeTableName, $recipeTableName . '.owner_id = ' . $userTableName . '.user_id ', array("COUNT($recipeTableName.recipe_id) as recipe_count"))
