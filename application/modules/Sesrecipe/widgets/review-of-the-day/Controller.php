...
class Sesrecipe_Widget_ReviewOfTheDayController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = Engine_Api::_()->getDbTable('reviews', 'sesrecipe')->getRecipeReviewSelect(array('widgetName' => 'oftheday', 'fetchAll' => true), array());
