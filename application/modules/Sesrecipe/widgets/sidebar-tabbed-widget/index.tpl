...
<?php if(!$this->is_ajax){ ?>
  <div class="sesrecipe_small_tabs_container sesbasic_clearfix sesbasic_bxs sesbasic_sidebar_block">
    <div class="sesrecipe_small_tabs sesbasic_clearfix" <?php if(count($this->defaultOptions) ==1){ ?> style="display:none" <?php } ?>> 
    	<ul id="tab-widget-sesrecipe-<?php echo $randonNumber; ?>" class="sesbasic_clearfix">
       <?php 
...
<?php include APPLICATION_PATH . '/application/modules/Sesrecipe/views/scripts/_sidebartabbedlist.tpl'; ?>
