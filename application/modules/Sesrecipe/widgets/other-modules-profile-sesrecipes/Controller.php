 ...
 */
class Sesrecipe_Widget_OtherModulesProfileSesrecipesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'other-modules-profile-sesrecipes';			
