 ...
 */
class Sesrecipe_Widget_tabbedWidgetRecipeController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sesrecipe_tabbed = Zend_Registry::isRegistered('sesrecipe_tabbed') ? Zend_Registry::get('sesrecipe_tabbed') : null;
    ...
    $this->view->can_create = Engine_Api::_()->authorization()->isAllowed('sesrecipe_recipe', null, 'create');
    ...
    $this->view->widgetName = 'tabbed-widget-recipe';			
    $params = array_merge($params, $value);

    // Get Recipes
    $paginator = Engine_Api::_()->getDbtable('recipes', 'sesrecipe')->getSesrecipesPaginator($params);
