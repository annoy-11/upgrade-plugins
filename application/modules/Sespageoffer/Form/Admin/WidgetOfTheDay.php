 ...
 */
class Sespageoffer_Form_Admin_WidgetOfTheDay extends Engine_Form {

  public function init() {

    $this->setTitle('SES - Page Offer Extension - Page Offer of the Day')
            ->setDescription('Displays the Page offer of The day as selected by the admin from the edit setting of this widget.');
