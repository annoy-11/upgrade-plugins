...
class Sespageoffer_Form_Admin_Tabbed extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Radio', "pagging", array(
        'label' => "Do you want the page offers to be auto-loaded when users scroll down the page?",
        'multiOptions' => array(
    ...
    $this->addElement('Select', "show_limited_data", array(
        'label' => 'Show only the number of page offers entered in the setting for Count of each view. [If you choose No, then you can choose how do you want to show more page offers in this widget.]',
        'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
