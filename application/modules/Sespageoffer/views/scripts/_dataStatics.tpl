...
<div class="sespageoffer_profile_footer">
  <p class="sespageoffer_profile_labels">
    <span>
      <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sespageoffer.enable.like', '1') && isset($this->likecountActive) && isset($item->like_count)) { ?>
