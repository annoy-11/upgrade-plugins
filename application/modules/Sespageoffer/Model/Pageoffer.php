 ...
 * @version    $Id: Pageoffer.php  2019-03-30 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sespageoffer_Model_Pageoffer extends Core_Model_Item_Abstract {

  // Properties
  protected $_parent_type = 'user';
  protected $_searchTriggers = array('title', 'body', 'search');
  protected $_parent_is_owner = true;
  protected $_type = 'pageoffer';
  ...
  public function getHref($params = array())
  {
    ...
    $params = array_merge(array(
      'route' => 'sespageoffer_view',
      'reset' => true,
      //'user_id' => $this->owner_id,
      'pageoffer_id' => $this->pageoffer_id,
      'slug' => $slug,
    ), $params);
    $route = $params['route'];
    $reset = $params['reset'];
  ...
  public function getPhotoUrl($type = NULL) {
    ...
    if ($photo_id) {
      ...
      $defaultPhoto = 'application/modules/Sespageoffer/externals/images/nophoto_pageoffer_thumb_profile.png';
    }
    return $defaultPhoto;
  }
  ...
  public function setPhoto($photo)
  {
    if( $photo instanceof Zend_Form_Element_File ) {
      ...
      throw new Sespageoffer_Model_Exception('Invalid argument passed to setPhoto: ' . print_r($photo, 1));
    }

    $name = basename($file);
    $path = APPLICATION_PATH . DIRECTORY_SEPARATOR . 'temporary';
    $params = array(
      'parent_type' => 'pageoffer',
