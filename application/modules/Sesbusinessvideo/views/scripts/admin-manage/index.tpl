			  ...
			  <div class='settings sesbasic_admin_form'>
					...
					function selectAll()
					{
					 ...
					 function killProcess(video_id) {
					    (new Request.JSON({
					      'format': 'json',
					      'url' : '<?php echo $this->url(array('module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'kill'), 'default', true) ?>',
					      'data' : {
					        'format' : 'json',
					        'video_id' : video_id
					      },
                      ...
                      <td><?php echo  $this->htmlLink($business->getHref(), $business->getTitle()); ?></td>
					            ...
					            <td class="admin_table_centered">
					              ...
					              <?php echo $item->is_featured == 1 ?   $this->htmlLink(
					                  array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->video_id,'status' =>0,'category' =>'featured','param'=>'videos'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Unmark as Featured')))) : $this->htmlLink(
					                  array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->video_id,'status' =>1,'category' =>'featured','param'=>'videos'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Featured')))) ; ?>
					              <?php }else{ echo "-";} ?>    
					              </td>
					              <td class="admin_table_centered">
					                <?php if($statusVideo){ ?>
					                <?php echo $item->is_sponsored == 1 ? $this->htmlLink(
					                  ...
					                  array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'feature-sponsored', 'id' => $item->video_id,'status' =>1,'category' =>'sponsored','param'=>'videos'),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Sponsored'))))  ; ?>
					                <?php }else{ echo "-";} ?>        
					              </td>
					             <td class="admin_table_centered">
					               <?php if($statusVideo){ ?>
					                <?php echo $item->is_hot == 1 ? $this->htmlLink(array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'hot', 'id' => $item->video_id,'status' =>0),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Unmark as Hot')))) : $this->htmlLink(array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'hot', 'id' => $item->video_id,'status' =>1),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Hot'))))  ; ?>
					                 <?php }else{ echo "-";} ?> 
					                </td>
					                <td class="admin_table_centered">
					                <?php if($statusVideo){ ?>
					              ...
					              <?php if($itemofftheday == 1):?>  
					                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->video_id, 'type' => 'businessvideo', 'param' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit Video of the Day'))), array('class' => 'smoothbox')); ?>
					              <?php else: ?>
					                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->video_id, 'type' => 'businessvideo', 'param' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make Video of the Day'))), array('class' => 'smoothbox')) ?>
					              <?php endif; ?>
					               <?php }else{ echo "-";} ?> 
					            </td>
					            <td class="admin_table_centered">
					              <?php echo $item->approve == 1 ? $this->htmlLink(
					                  array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'approve', 'id' => $item->video_id,'approve' =>0),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Unmark as Approved')))) : $this->htmlLink(
					                  array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'approve', 'id' => $item->video_id,'approve' =>1),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Approved'))))  ; ?>
					            
					            </td>
					            <td>
					              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'view', 'type'=> 'businessvideo', 'id' => $item->video_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
					              |
					              <a href="<?php echo $item->getHref(); ?>" target = "_blank" ><?php echo $this->translate("View") ?></a>
					              |
					              <?php echo $this->htmlLink(array('route' => 'sesbusinessvideo_general','module' => 'sesbusinessvideo','controller' => 'index','action' => 'edit','video_id' => $item->video_id), $this->translate('Edit'), array('target'=> "_blank")) ;?>
					              |
					              <?php echo $this->htmlLink(
					                  array('route' => 'default', 'module' => 'sesbusinessvideo', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->video_id),
