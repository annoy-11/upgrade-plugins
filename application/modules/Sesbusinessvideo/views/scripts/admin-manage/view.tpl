 ...
 * @version    $Id: view.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
  ...
  <table>
    ...
    <td><?php if(!is_null($this->item->getTitle()) && $this->item->getTitle() != '') {
  	...
  	<tr>
    	...
    	<td>
    		<?php
        	$event = Engine_Api::_()->getItem('businesses',$this->item->parent_id); ?>
   ...
   <?php } ?>
   <?php if($this->type != 'businessvideo'){ ?>
    <tr>
   ...
   <?php if(isset($this->item->ip_address)){ ?>
    ...
    <?php } ?>
    <?php if(isset($this->item->location) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusinessvideo_enable_location', 1)){ ?>
    <tr>
