 ...
 * @version    $Id: external.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
...
<div class="sesbusinessvideo_video_view_container clear sesbasic_clearfix sesbasic_bxs sesbusinessvideo_external_video_preview sesbm">
  <?php if( $this->video->type == 3 ): ?>
    <div id="video_embed" class="sesbusinessvideo_view_embed clear sesbasic_clearfix"></div>
  <?php else: ?>
  ...
  <?php endif; ?> 
<?php if(!$this->isMap){ ?>
  <div class="sesbusinessvideo_external_video_btn_cont clear sesbasic_clearfix">
    <h2 class="sesbusinessvideo_view_title sesbasic_clearfix">
    ...
    <div class="sesbusinessvideo_view_statics">
      <div id="album_rating" class="sesbasic_rating_star sesbusinessvideo_view_rating">
    ...
    <div class="sesbusinessvideo_view_meta sesbusinessvideo_list_stats sesbasic_text_light clear sesbasic_clearfix">
    ...
    <?php /*
      <div class='sesbusinessvideo_view_options sesbusinessvideo_options_buttons'>
