 ...
 * @version    $Id: last-element-data.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
...
<div class="ses_ml_more_popup_container sesbasic_clearfix">
  	<div class="ses_ml_more_popup_lb">
        ...
        <?php $type = $this->type == 'businessvideo' ? 'Recent' : 'Popular'; ?>
      	<span><?php echo $this->translate($type." ".ucfirst(str_replace('sesbusinessvideo_','',$this->type)).'s'); ?></span>
      </div>
      <div class="ses_ml_more_popup_bc sesbasic_clearfix">
      <?php 
      	 $albumItems = Engine_Api::_()->getItemTable('businessvideo')->getVideo(array('limit_data'=>6,'popularCol'=>'creation_date'),false);
     	
       	foreach($albumItems as $albumItem){ ?>
          <?php $imageURL = Engine_Api::_()->sesbusinessvideo()->getCustomLightboxHref($albumItem,array('type'=>$this->type,'item_id'=>$this->item_id)); ?>
    ...
    <div class="ses_ml_more_popup_rb">
      ...
      <div class="ses_ml_more_popup_bc sesbasic_clearfix">
      <?php  $videoItems = Engine_Api::_()->getDbTable('videos', 'sesbusinessvideo')->getVideo(array('limit_data'=>9,'popularCol'=>'view_count'),false);
        $count = 1;
