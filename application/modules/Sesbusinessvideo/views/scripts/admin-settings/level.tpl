...
<?php include APPLICATION_PATH .  '/application/modules/Sesbusinessvideo/views/scripts/dismiss_message.tpl';?>

<script type="text/javascript">
  var fetchLevelSettings = function(level_id) {
    window.location.href = en4.core.baseUrl + 'admin/sesbusinessvideo/settings/level/id/' + level_id;
    //alert(level_id);
  }
</script>
