 ...
 * @version    $Id: manage-widgetize-page.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
    ...
    <div class='sesbasic-form-cont'>
	    <div class='clear'>
			  <div class='settings sesbasic_admin_form'>
					<h3><?php echo $this->translate("Links to Widgetized Businesses") ?></h3>
					<p>
					...
					<table class='admin_table'>
					  ...
					  <tbody>
					    ...
					    $corePages = Engine_Api::_()->sesbusinessvideo()->getwidgetizePage(array('name' => $item));
