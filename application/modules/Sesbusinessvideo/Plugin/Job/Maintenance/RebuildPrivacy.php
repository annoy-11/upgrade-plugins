 ...
 * @version    $Id: RebuildPrivacy.php  2018-10-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesbusinessvideo_Plugin_Job_Maintenance_RebuildPrivacy extends Core_Plugin_Job_Abstract {

  protected function _execute() {
    // Start custom prepare
    $table = Engine_Api::_()->getItemTable('businessvideo');
