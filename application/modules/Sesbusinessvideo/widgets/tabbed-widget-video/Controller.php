 ...
 */
class Sesbusinessvideo_Widget_TabbedWidgetVideoController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $paginator = Engine_Api::_()->getDbTable('videos', 'sesbusinessvideo')->getVideo($value);
    ...
    if ($is_ajax)
      ...
      if ($paginator->getTotalItemCount() <= 0) {
        $checkVideoCount = Engine_Api::_()->getDbTable('videos', 'sesbusinessvideo')->countVideos();
