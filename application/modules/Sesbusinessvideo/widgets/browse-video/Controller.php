 ...
 */
class Sesbusinessvideo_Widget_BrowseVideoController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $textPage =  isset($searchArray['search_business']) ? $searchArray['search_business'] : (!empty($params['search_business']) ? $params['search_business'] : (isset($_GET['search_business']) && ($_GET['search_business'] != '') ? $_GET['search_business'] : ''));
    ...
    $this->view->textPage = $value['search_business']  = stripslashes($textPage);
    ...
    // Get videos
    $paginator = Engine_Api::_()->getDbTable('videos', 'sesbusinessvideo')->getVideo(array_merge($value,array('search'=>1)));
