...
<div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">    
   ...
   <ul class="sesbusinessvideo_cat_video_listing sesbasic_clearfix clear" id="tabbed-widget_<?php echo $randonNumber; ?>">
    ...
    <?php foreach($this->paginator as $key=>$video){  ?>
      ...
      <?php if(($this->paginator->getCurrentPageNumber() == 1 || $this->loadOptionData == 'pagging') && !$break && $totalCount >= $allowedLimit ){ ?>
        ...
        <div class="sesbasic_clearfix sesbasic_bxs clear">
      		...
      		<div class="sesbusinessvideo_videolist_row clear sesbasic_clearfix">

      <?php } ?>

						<?php if($type == 1){ ?>

               <?php if(!$close){  ?><div class="sesbusinessvideo_videolist_column_small floatL"> <?php } ?>

                    <div class="sesbusinessvideo_cat_video_list">

                  <div class="sesbusinessvideo_thumb">

                    <a href="<?php echo $href; ?>" data-url = "<?php echo $video->getType() ?>" class="sesbusinessvideo_thumb_img">

                      <span class="sesbusinessvideo_animation" style="background-image:url(<?php echo $imageURL; ?>);"></span>
                     ...
                     <?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive) || isset($this->hotLabelActive)){ ?>
                      ...
                      <div class="sesbusinessvideo_cat_video_list_info sesbusinessvideo_animation">

                        <div>

                          <div class="sesbusinessvideo_cat_video_list_content">

                          <?php if(isset($this->titleActive)){ ?>

                            <div class="sesbusinessvideo_cat_video_list_title">
                            ...
                            <div class="sesbusinessvideo_cat_video_list_stats">
                            ...
                            <div class="sesbusinessvideo_cat_video_list_stats sesbusinessvideo_list_stats sesbasic_text_light">
                              ...
                              <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesbusinessvideo.enable.favourite', 1) && isset($this->favouriteActive) && isset($video->favourite_count)) { ?>
                            ...
                            <?php if(isset($this->watchnowActive)){ ?>
                             ...
                             <div class="sesbusinessvideo_cat_video_list_button"><?php echo $this->translate('Watch now'); ?></div>
            ...
            <?php } ?>
             ...
             <div class="sesbusinessvideo_videolist_column_big floatL">
     ...
     <?php if(($counter)%5 == 0){ ?>
      ...
      <?php }else{ ?>
   					   ...
   					   <li class="sesbusinessvideo_cat_video_list" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
      ...
      <div class="tip">
        ...
        <span>
          ...
          <?php if (!$this->can_edit):?>
                    ...
                    <?php echo $this->translate('Be the first to %1$spost%2$s one in this category!', '<a href="'.$this->url(array('action' => 'create'), "sesbusinessvideo_general").'">', '</a>'); ?>
...
function dynamicWidth(){
	...
	var objectClass = sesJqueryObject('.sesbusinessvideo_cat_video_list_info');

	for(i=0;i<objectClass.length;i++){

			sesJqueryObject(objectClass[i]).find('div').find('.sesbusinessvideo_cat_video_list_content').find('.sesbusinessvideo_cat_video_list_title').width(sesJqueryObject(objectClass[i]).width());
