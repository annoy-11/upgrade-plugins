...
?>
<style>
#sesbusinessvideo_heighted_view_<?php echo $randonNumber; ?> .sesbusinessvideo_listing_in_grid{
	height:<?php echo str_replace(array('px','%'),'',$this->height).'px'; ?>;
}
#sesbusinessvideo_heighted_view_<?php echo $randonNumber; ?> .sesbusinessvideo_listing_in_grid:first-child{
	height:<?php echo str_replace(array('px','%'),'',$this->heightmain).'px'; ?>;
}
</style>
<div class="sesbusinessvideo_heighted_view sesbasic_clearfix sesbasic_bxs" id="sesbusinessvideo_heighted_view_<?php echo $randonNumber; ?>">
  <?php 
  if($this->categoryItem == 'chanels'){
    ...
    $photoURL = $item->getPhotoUrl('thumb.main'); ?>
      <div class="sesbusinessvideo_listing_in_grid">
        <div class="sesbusinessvideo_listing_in_grid_thumb sesbusinessvideo_thumb sesbusinessvideo_play_btn_wrap">
        <?php 
        ...
        <a class="<?php echo $item->getType() == 'businessvideo' ? 'sesbusinessvideo_thumb_img' : 'sesbusinessvideo_thumb_nolightbox' ?>" href="<?php echo $item->getHref(); ?>">
          ...
          <a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sesbasic_animation sesbusinessvideo_play_btn fa fa-play-circle sesbusinessvideo_thumb_img">
          ...
          <?php if(isset($this->featured) || isset($this->sponsored) || isset($this->hot)){ ?>
            <p class="sesbusinessvideo_labels sesbasic_animation">
           ...
           <?php if(isset($this->watchlater) && (isset($item->watchlater_id)) && Engine_Api::_()->user()->getViewer()->getIdentity() != '0'){ ?>
              ...
              <a href="javascript:;" class="sesbusinessvideo_watch_later_btn sesbasic_animation sesbusinessvideo_watch_later <?php echo !is_null($watchLaterId)  ? 'selectedWatchlater' : '' ?>" title = "<?php echo !is_null($watchLaterId)  ? $this->translate('Remove from Watch Later') : $this->translate('Add to Watch Later') ?>" data-url="<?php echo $item->video_id ; ?>"></a>
          <?php } ?>
          <?php 
          ...
          <?php } ?>
            ...
            <?php if(isset($this->like) || isset($this->comment) || isset($this->view) || isset($this->title) || isset($this->rating) || isset($this->favouriteCount) || isset($this->downloadCount)  || isset($this->by) || isset($this->videoCount)){ ?>
              <div class="sesbusinessvideo_listing_in_grid_info clear sesbasic_animation">
                <?php if(isset($this->title)) { ?>
                  <div class="sesbusinessvideo_listing_in_grid_title">
                ...
                <?php if(isset($this->by)) { ?>
                  <div class="sesbusinessvideo_listing_in_grid_date sesbusinessvideo_list_stats sesbasic_text_light floatL">
                    <span>
                ...
                <div class="sesbusinessvideo_listing_in_grid_date sesbusinessvideo_list_stats sesbasic_text_light clear floatL">
