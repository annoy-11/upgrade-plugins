...
class Sesbusinessvideo_Widget_ShowSamePosterController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('videos', 'sesbusinessvideo')->getVideo(array('not_video_id'=>$subject->getIdentity(),'user_id'=>$subject->owner_id));
