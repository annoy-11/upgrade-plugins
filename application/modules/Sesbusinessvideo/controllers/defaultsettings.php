...
$page_id = $db->select()
        ->from('engine4_core_pages', 'page_id')
        ->where('name = ?', 'sesbusinessvideo_index_browse')
        ->limit(1)
        ->query()
        ->fetchColumn();
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      'name' => 'sesbusinessvideo_index_browse',
      'displayname' => 'SES - Business Videos Extension - Browse Videos Page',
      'title' => 'Browse Videos',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'order' => $widgetOrder++,
      'params' => '{"search_for":"video","view_type":"vertical","search_type":["recentlySPcreated","mostSPviewed","mostSPliked","mostSPcommented","mostSPrated","mostSPfavourite","featured","sponsored","verified","hot"],"default_search_type":"mostSPliked","friend_show":"yes","search_title":"yes","browse_by":"yes","categories":"yes","location":"yes","kilometer_miles":"yes","title":"Search Videos","nomobile":"0","name":"sesbusinessvideo.browse-search"}',
  ));
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $main_right_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"grid","criteria":"5","info":"most_viewed","show_criteria":["like","comment","rating","favourite","view","title","by","category","duration","watchLater"],"title_truncation":"45","height":"130","width":"180","limit_data":"3","title":"Most Viewed Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
}
...
$select = $db->select()
        ...
        ->where('name = ?', 'sesbusinessvideo_index_home')
        ->limit(1);
$info = $select->query()->fetch();
if (empty($info)) {
  $widgetOrder = 1;
  $db->insert('engine4_core_pages', array(
      'name' => 'sesbusinessvideo_index_home',
      'displayname' => 'SES - Business Videos Extension - Video Home Page',
      'title' => 'Video Home',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $topmiddle_id,
      'order' => $widgetOrder++,
      'params' => '{"category":"videos","featured_sponsored_carosel":"featured","show_criteria":["title","socialSharing","duration","watchlater","likeButton","favouriteButton"],"heightMain":"450","height":"150","info":"most_liked","title_truncation":"45","limit_data":"7","title":"Featured Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored-fixed-view"}',
  ));
    ...
    $db->insert('engine4_core_content', array(
      ...
      'order' => $widgetOrder++,
      'params' => '{"ofTheDayType":"video","show_criteria":["like","comment","rating","view","title","by","socialSharing","likeButton","favouriteButton","favouriteCount","watchLater","songsListShow","duration"],"title_truncation":"22","height":"170","width":"180","title":"Video of the Day","nomobile":"0","name":"sesbusinessvideo.of-the-day"}',
  ));
      ...
      'parent_content_id' => $left_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"grid","criteria":"5","info":"most_rated","show_criteria":["like","comment","rating","favourite","view","title","by","duration","watchLater"],"title_truncation":"24","height":"100","width":"105","limit_data":"3","title":"Top Rated Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
        $db->insert('engine4_core_content', array(
      'page_id' => $page_id,
      'type' => 'widget',
      ...
      'parent_content_id' => $left_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"list","criteria":"5","info":"most_liked","show_criteria":["like","comment","favourite","view","title","by","duration","watchLater"],"title_truncation":"11","height":"80","width":"105","limit_data":"3","title":"Most Liked Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
      ...
      'parent_content_id' => $left_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"list","criteria":"5","info":"most_viewed","show_criteria":["like","comment","favourite","view","title","by","duration","watchLater"],"title_truncation":"11","height":"80","width":"105","limit_data":"3","title":"Most Viewed Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
    ...
    $db->insert('engine4_core_content', array(
      ...
      'order' => $widgetOrder++,
      'params' => '{"category":"videos","featured_sponsored_carosel":"hot","show_criteria":["title"],"duration":"200","bgColor":"#eee","textColor":"","spacing":"","heightMain":"200","height":"170","width":"217","info":"recently_created","title_truncation":"24","limit_data":"9","aliganment_of_widget":"1","title":"Hot Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored-carosel"}',
  ));
    ...
    $db->insert('engine4_core_content', array(
      ...
      'order' => $widgetOrder++,
      'params' => '{"category":"videos","featured_sponsored_carosel":"sponsored","show_criteria":["like","comment","rating","view","title","by","socialSharing","favouriteCount","duration","watchlater","likeButton","favouriteButton"],"duration":"300","bgColor":"","textColor":"","spacing":"","heightMain":"264","height":"200","width":"200","info":"most_liked","title_truncation":"24","limit_data":"8","aliganment_of_widget":"2","title":"Sponsored Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored-carosel"}',
  ));
      ...
      'parent_content_id' => $right_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"list","criteria":"6","info":"most_liked","show_criteria":["like","comment","favourite","view","title","by","duration","watchLater"],"title_truncation":"11","height":"80","width":"105","limit_data":"3","title":"Hot Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
      ...
      'parent_content_id' => $right_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"list","criteria":"5","info":"most_commented","show_criteria":["like","comment","favourite","view","title","by","duration","watchLater"],"title_truncation":"11","height":"80","width":"105","limit_data":"3","title":"Most Commented Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
      $db->insert('engine4_core_content', array(
      'page_id' => $page_id,
      'type' => 'widget',
      ...
      'parent_content_id' => $right_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"list","criteria":"5","info":"most_favourite","show_criteria":["like","comment","favourite","view","title","by","duration","watchLater"],"title_truncation":"11","height":"80","width":"105","limit_data":"3","title":"Most Favourite Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
      $db->insert('engine4_core_content', array(
      'page_id' => $page_id,
      'type' => 'widget',
      ...
      'parent_content_id' => $right_id,
      'order' => $widgetOrder++,
      'params' => '{"tableName":"video","type":"list","criteria":"5","info":"recently_created","show_criteria":["like","comment","favourite","view","title","by","duration","watchLater"],"title_truncation":"11","height":"80","width":"105","limit_data":"3","title":"Most Recent Videos","nomobile":"0","name":"sesbusinessvideo.featured-sponsored"}',
  ));
...
$page_id = $db->select()
        ->from('engine4_core_pages', 'page_id')
        ->where('name = ?', 'sesbusinessvideo_index_create')
        ->limit(1)
        ->query()
        ->fetchColumn();
if (!$page_id) {
 $widgetOrder = 1;
  // Insert page
  $db->insert('engine4_core_pages', array(
      'name' => 'sesbusinessvideo_index_create',
      'displayname' => 'SES - Business Videos Extension - Video Create Page',
      'title' => 'Video Create',
...
$page_id = $db->select()
        ->from('engine4_core_pages', 'page_id')
        ->where('name = ?', 'sesbusinessvideo_index_edit')
        ->limit(1)
        ->query()
        ->fetchColumn();
if (!$page_id) {
  ...
  // Insert page
  $db->insert('engine4_core_pages', array(
      'name' => 'sesbusinessvideo_index_edit',
      'displayname' => 'SES - Business Videos Extension - Video Edit Page',
      'title' => 'Video Edit',
...
$select
        ->from('engine4_core_pages')
        ->where('name = ?', 'sesbusinessvideo_index_view')
        ->limit(1);
$info = $select->query()->fetch();
if (empty($info)) {
  ...
  $widgetOrder = 1;
  $db->insert('engine4_core_pages', array(
      'name' => 'sesbusinessvideo_index_view',
      'displayname' => 'SES - Business Videos Extension - Video View Page',
      'title' => 'View Video',
  ...
  $db->insert('engine4_core_content', array(
      ...
      'parent_content_id' => $middle_id,
      'order' => $widgetOrder++,
      'params' => '{"viewPageType":"video","title":"","nomobile":"0","name":"sesbusinessvideo.breadcrumb"}',
  ));
...
// $page_id = $db->select()
//         ->from('engine4_core_pages', 'page_id')
//         ->where('name = ?', 'sesbusinessvideo_index_locations')
//         ->limit(1)
//         ->query()
//         ->fetchColumn();
// if (!$page_id) {
//   $widgetOrder = 1;
//   $db->insert('engine4_core_pages', array(
//       'name' => 'sesbusinessvideo_index_locations',
...
//       'parent_content_id' => $top_middle_id,
//       'order' => $widgetOrder++,
//       'params' => '{"search_for":"video","view_type":"horizontal","search_type":["recentlySPcreated","mostSPviewed","mostSPliked","mostSPcommented","mostSPrated","mostSPfavourite","featured","sponsored","verified","hot"],"default_search_type":"recentlySPcreated","friend_show":"yes","search_title":"yes","browse_by":"yes","categories":"yes","location":"yes","kilometer_miles":"yes","title":"","nomobile":"0","name":"sesbusinessvideo.browse-search"}',
//   ));
//
//     $db->insert('engine4_core_content', array(
//       'type' => 'widget',
//       'name' => 'sesbusinessvideo.video-location',
//       'page_id' => $page_id,
//       'parent_content_id' => $main_middle_id,
//       'order' => $widgetOrder++,
//       'params' => '{"location":"United Kingdom","lat":"56.6465227","lng":"-6.709638499999983","location-data":null,"title":"","nomobile":"0","name":"sesbusinessvideo.video-location"}',
//   ));
// }
...
if (function_exists('exec') && function_exists('shell_exec')) {
  ...
  $ffmpeg_path = $db->select()
          ...
          ->where('name = ?', 'sesbusinessvideo.ffmpeg.path')
          ->limit(1)
          ->query()
          ->fetchColumn(0);
  $output = null;
  ...
  if ($ffmpeg_path != $ffmpeg_path_original) {
    $count = $db->update('engine4_core_settings', array(
        ...
        'name = ?' => 'sesbusinessvideo.ffmpeg.path',
    ));
    if ($count === 0) {
      try {
...
foreach (Engine_Api::_()->getDbTable('levels', 'authorization')->fetchAll() as $level) {
  $form = new Sesbusinessvideo_Form_Admin_Settings_Level(array(
      'public' => ( in_array($level->type, array('public')) ),
      'moderator' => ( in_array($level->type, array('admin', 'moderator')) ),
  ));
  $values = $form->getValues();
  $valuesForm = $permissionsTable->getAllowed('businessvideo', $level->level_id, array_keys($form->getValues()));
  ...
  try {
    ...
    $permissionsTable->setAllowed('businessvideo', $level->level_id, $values, '', $nonBooleanSettings);
    // Commit
    $db->commit();
  } catch (Exception $e) {
    $db->rollBack();
