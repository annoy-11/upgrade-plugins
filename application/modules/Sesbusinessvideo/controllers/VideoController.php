...
class Sesbusinessvideo_VideoController extends Core_Controller_Action_Standard {
  ...
  public function embedAction() {
    // Get subject
    $this->view->video = $video = Engine_Api::_()->core()->getSubject('businessvideo');
  ...
  public function externalAction() {
    ...
    $this->view->rating_count = Engine_Api::_()->getDbtable('ratings', 'sesbusinessvideo')->ratingCount($video->getIdentity(), 'businessvideo');
