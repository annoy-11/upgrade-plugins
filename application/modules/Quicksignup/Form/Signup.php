 ...
 * @version    $Id: Signup.php  2018-11-26 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Quicksignup_Form_Signup_Account extends Engine_Form_Email
{  
  public function init()
  {
    ...
    $settings = Engine_Api::_()->getApi('settings', 'core');
     ...
     if($settings->getSetting('quicksignup_title', 0)){
         $this->setTitle($settings->getSetting('quicksignup_title_text','Create Account'));
     }


    $this->setDescription('Create Account');
...
class User_Form_Signup_Account extends Quicksignup_Form_Signup_Account{
