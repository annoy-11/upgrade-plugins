 ...
 * @version    $Id: Filter.php  2018-04-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesgroup_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbTable('categories', 'sesgroup')->getCategory(array('column_name' => '*'));
    ...
    if (SESGROUPPACKAGE == 1) {
      $packages = Engine_Api::_()->getDbTable('packages', 'sesgrouppackage')->getPackage(array('default' => true));
