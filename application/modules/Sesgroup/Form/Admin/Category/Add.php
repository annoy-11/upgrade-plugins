 ...
 */
class Sesgroup_Form_Admin_Category_Add extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', 'title', array(
        'label' => 'Title',
        'description' => 'Title will appear on the Category View Group of your site.',
        'allowEmpty' => true,
        'required' => false,
    ));
    ...
    $this->addElement('Textarea', 'description', array(
        'label' => 'Description',
        'description' => 'Description will appear on the Category View Group of your site.',
        'allowEmpty' => true,
        'required' => false,
    ));
