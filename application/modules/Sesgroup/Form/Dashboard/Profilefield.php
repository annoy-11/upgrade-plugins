...
class Sesgroup_Form_Dashboard_Profilefield extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('Category Based Profile Information')
            ->setDescription('Here, you can add additional information about your Group specific to its category to provide information about your Group to site members.')
