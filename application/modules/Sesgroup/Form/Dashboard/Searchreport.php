 ...
 * @version    $Id: Searchreport.php  2018-04-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesgroup_Form_Dashboard_Searchreport extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('')
            ->setAttrib('id', 'sesgroup_search_form_sale_report')
