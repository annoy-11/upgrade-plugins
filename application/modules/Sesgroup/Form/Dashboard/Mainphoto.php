 ...
 * @version    $Id: Mainphoto.php  2018-04-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesgroup_Form_Dashboard_Mainphoto extends Engine_Form {
  ...
  public function init() {
    ...
    $mainPhotoEnable = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroup.photo.mandatory', '1');
