 ...
 * @version    $Id: Photo.php  2018-04-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesgroup_Model_Photo extends Core_Model_Item_Collectible {

  protected $_parent_type = 'sesgroup_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'sesgroup_album';

  public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'sesgroup_photo_view',
        'reset' => true,
        'controller' => 'photo',
        'action' => 'view',
  ...
  public function getAlbum() {
    return Engine_Api::_()->getItem('sesgroup_album', $this->album_id);
  }
  
  public function getGroup() {
    return Engine_Api::_()->getItem('sesgroup_group', $this->group_id);
  }
  ...
  public function getAuthorizationItem() {
    return $this->getParent('sesgroup_group');
  }
  ...
  */
  public function getAlbumPhotoUrl($type = null) { 
    ...
    if( !$photo_id ) {
      return 'application/modules/Sesgroup/externals/images/nophoto_album_thumb_normal.pngc=direct';
    }
