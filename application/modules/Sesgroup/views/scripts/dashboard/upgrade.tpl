...
<div class="sesgroup_packages_main sesbasic_clearfix sesbasic_bxs sesgroup_packages_upgrade">
  <?php if($this->currentPackage){ 
    $package = Engine_Api::_()->getItem('sesgrouppackage_package',$this->currentPackage->package_id);
    if($package){
  ?>
    ...
    <div class="sesgroup_packages_table_container">
      <ul class="sesgroup_packages_list">
         ...
         <li class="sesgroup_packages_list_item <?php echo ($package->highlight) ? 'active' : '' ?>">
          <section>
           <div class="_top sesbasic_clearfix">
              ...
              <div class="_price">
                <?php if(!$package->isFree() && $package->recurrence_type != 'forever'){ ?>
                  <span><?php echo Engine_Api::_()->sesgrouppackage()->getCurrencyPrice($package->price,'','',true); ?></span>
                  <small>
                    <?php if($package->recurrence_type == 'day'):?>
                     ...
                     <?php elseif($package->recurrence_type == 'forever'): ?>
                       <?php echo sprintf($this->translate('One-time fee of %1$s'), Engine_Api::_()->sesgrouppackage()->getCurrencyPrice($package->price,'','',true)); ?>
                     <?php else:?>
                       <?php echo $this->translate('Free');?>
                     <?php endif;?>
                  </small>
                <?php }elseif($package->recurrence_type == 'forever'){ ?>
                  <span><?php echo sprintf($this->translate('One-time fee of %1$s'), Engine_Api::_()->sesgrouppackage()->getCurrencyPrice($package->price,'','',true)); ?></span>
                <?php }else{ ?>
            ...
            <div class="_cont sesbasic_clearfix">
              <div class="package_capabilities _features">
                ...
                <div class="sesbasic_clearfix">
                	<div>
                    <span class="_label"><?php echo $this->translate('Groups Count');?></span>
                ...
                <div class="sesbasic_clearfix">
                	<div>
                    <span class="_label"><?php echo $this->translate('Auto Approved Groups');?></span>
                    <span class="_value"><i class="_icon _<?php echo ($enableModules['group_approve']) ? 'yes' : 'no';?>"></i></span>
                	</div>
                </div>
                <?php if(in_array('featured',$showinfo)){ ?>	
                  <div class="sesbasic_clearfix <?php echo ($enableModules['group_featured']) ? 'yes' : 'no'; ?>">
                  	<div>
                      <span class="_label">Featured</span>
                      <span class="_value"><i class="_icon <?php echo ($enableModules['group_featured']) ? '_yes' : '_no'; ?>"></i></span>
                  	</div>
                  </div>
                <?php } ?>
                <?php if(in_array('sponsored',$showinfo)){ ?>  
                  <div class="sesbasic_clearfix <?php echo ($enableModules['group_sponsored']) ? 'yes' : 'no'; ?>">
                  	<div>
                      <span class="_label">Sponsored</span>
                      <span class="_value"><i class="_icon <?php echo ($enableModules['group_sponsored']) ? '_yes' : '_no'; ?>"></i></span>
                  	</div>
                  </div>
                <?php } ?>
                <?php if(in_array('verified',$showinfo)){ ?>  
                  <div class="sesbasic_clearfix <?php echo ($enableModules['group_verified']) ? 'yes' : 'no'; ?>">
                  	<div>
                      <span class="_label">Verified</span>
                      <span class="_value"><i class="_icon <?php echo ($enableModules['group_verified']) ? '_yes' : '_no'; ?>"></i></span>
                  	</div>
                  </div>
                <?php } ?>
                <?php if(in_array('hot',$showinfo)){ ?>  
                  <div class="sesbasic_clearfix <?php echo ($enableModules['group_hot']) ? 'yes' : 'no'; ?>">
                  	<div>
                      <span class="_label">Hot</span>
                      <span class="_value"><i class="_icon <?php echo ($enableModules['group_hot']) ? '_yes' : '_no'; ?>"></i></span>
                  	</div>
                  </div>
                <?php } ?>
                <div class="sesbasic_clearfix">
                    ...
                    <span class="_value"><i class="_icon <?php echo ($enableModules['group_bgphoto']) ? '_yes' : '_no'; ?>"></i></span>
                	</div>
                </div>
                <div class="sesbasic_clearfix">
                	<div>
                ...
                <div class="sesbasic_clearfix">
                    ...
                    <span class="_value"><i class="_icon <?php echo ($enableModules['group_choose_style']) ? '_yes' : '_no'; ?>"></i></span>
                	</div>
                </div>
              </div>
  ...
  <?php if(count($this->upgradepackage)){ ?>
  	<div class="sesgroup_packages_main_header">
        ...
        <p><?php echo $this->translate('Choose a higher package to create groups on this website and get benefited with advance features and functionalities.');?></p>
    </div>
    <div class="sesgroup_packages_table_container">
      <ul class="sesgroup_packages_list">
           ...
           <li class="sesgroup_packages_list_item <?php echo ($package->highlight) ? 'active' : '' ?>">
            <section>
             <div class="_top sesbasic_clearfix">
              ...
              <div class="_btns">
                <a href="<?php echo $this->url(array('group_id' => $this->group->group_id,'action'=>'confirm-upgrade','package_id'=>$package->package_id), 'sesgrouppackage_general', true); ?>" class="smoothbox sesgroup_packages_create_btn sesbasic_animation"><?php echo $this->translate('Upgrade Package');?></a>
              </div>
            </section>
           </li> 
      	<?php } ?>     
