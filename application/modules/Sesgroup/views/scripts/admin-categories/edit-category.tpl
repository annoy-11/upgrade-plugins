 ...
 * @version    $Id: edit-category.tpl  2018-04-23 00:00:00 SocialEngineSolutions $
...
<div class='clear sesbasic-form'>
  <div>
    ...
    <div class="sesbasic-form-cont">
     <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesgroup', 'controller' => 'categories', 'action' => 'index'), "Back to Manage Categories", array('class'=>'sesbasic_icon_back buttonlink')) ?>
      <br /><br />
