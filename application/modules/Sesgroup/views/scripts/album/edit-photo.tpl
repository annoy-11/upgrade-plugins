 ...
 * @version    $Id: edit-photo.tpl  2018-04-23 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  sesJqueryObject(document).on('click','#execute',function(e){
    ...
    request = new Request.JSON({
      'format' : 'json',
      'url' : '<?php echo $this->url(Array('controller' => 'album', 'action' => 'save-information'), 'sesgroup_extended',true) ?>/photo_id/'+photo_id,
      'data': {
        'photo_id' : photo_id,
