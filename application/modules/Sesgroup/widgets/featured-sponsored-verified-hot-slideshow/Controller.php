...
class Sesgroup_Widget_FeaturedSponsoredVerifiedHotSlideshowController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->groups = $groups = Engine_Api::_()->getDbTable('groups', 'sesgroup')->getGroupSelect($value);
    if (count($groups) <= 0)
