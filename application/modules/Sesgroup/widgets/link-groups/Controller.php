...
class Sesgroup_Widget_LinkGroupsController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    $groupId = (isset($_POST['group_id']) ? $_POST['group_id'] : 0);
    if ($groupId) {
      $subject = Engine_Api::_()->getItem('sesgroup_group', $groupId);
    } else {
    ...
    $this->view->group_id = $subject->group_id;
    ...
    $this->view->widgetName = 'link-groups';
    ...
    $value['search'] = 1;
    $value['draft'] = "1";
    $value['link_group_id'] = $subject->group_id;
