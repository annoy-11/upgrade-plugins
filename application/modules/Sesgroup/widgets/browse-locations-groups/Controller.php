 ...
 */
class Sesgroup_Widget_BrowseLocationsGroupsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_ajax) {
      $defaultSearchParams = Engine_Api::_()->sesgroup()->getSearchWidgetParams($widgetId);
    ...
    $this->view->view_type = $viewType = isset($_POST['type']) ? $_POST['type'] : (count($params['enableTabs']) > 1 ? 'list' : $params['enableTabs'][0]);
    ...
    $this->view->widgetName = 'browse-locations-groups';
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('groups', 'sesgroup')->getGroupPaginator($params);
