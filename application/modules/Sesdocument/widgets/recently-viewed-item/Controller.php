 ...
 */
class Sesdocument_Widget_RecentlyViewedItemController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
		...
		$show_criterias = isset($value['show_criterias']) ? $value['show_criterias'] : $this->_getParam('show_criteria', array('like', 'comment', 'by', 'title', 'socialSharing', 'view', 'featuredLabel', 'sponsoredLabel', 'verifiedLabel', 'likeButton'));
		...
		$params['type'] = 'sesdocument';
        $params['order'] = $order;

		$this->view->results = $paginator = Engine_Api::_()->getDbtable('recentlyviewitems', 'sesdocument')->getitem($params);
