 ...
 */
class Sesdocument_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->results = Engine_Api::_()->getDbTable('sesdocuments', 'sesdocument')->getDocumentSelect(array('widgetName' => 'oftheday', 'fetchAll' => true));
