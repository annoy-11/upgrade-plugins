 ...
 */
class Sesdocument_Widget_BrowseDocumentsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $form = new Sesdocument_Form_Filter_Browse(array('searchTitle' => 'yes','browseBy' => 'yes','categoriesSearch' => 'yes','searchFor'=>'document','FriendsSearch'=>'yes','defaultSearchtype'=>'mostSPliked','locationSearch' => 'yes','kilometerMiles' => 'yes','hasPhoto' => 'yes'));
    ...
    $paginator = Engine_Api::_()->getDbtable('sesdocuments', 'sesdocument')->getSesdocumentsPaginator($params, $form->getValues());
