 ...
 */
class Sesdocument_Widget_FeaturedSponsoredController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = Engine_Api::_()->getDbTable('sesdocuments', 'sesdocument')->getDocumentSelect($value);
