 ...
 */
class Sesdocument_Widget_ProfileSesdocumentsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'profile-sesdocuments';
