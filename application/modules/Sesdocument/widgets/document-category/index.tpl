...
<div class="sesbasic_clearfix">
  <ul class="sesdocument_category_grid_listing sesbasic_clearfix clear sesbasic_bxs <?php echo ($this->alignContent == 'left' ? 'gridleft' : ($this->alignContent == 'right' ? 'gridright' : '')) ?>">	
    <li class="sesdocument_catbase_list_head sesbm" style="display:none;"><?php echo $this->translate("All Categories"); ?></li>
    <?php foreach( $this->paginator as $item ): ?>
    <li class="sesdocument_category_grid sesbm" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
          ...
          <div>
            <div class="sesdocument_category_grid_details">
              ...
              <?php if(isset($this->countDocuments)){ ?>
                ...
                <span class="sesdocument_category_grid_stats"><?php echo $this->translate(array('%s document', '%s documents', $item->total_document_categories), $this->locale()->toNumber($item->total_document_categories))?></span>
              <?php } ?>
            </div>
          </div>
        </div>
