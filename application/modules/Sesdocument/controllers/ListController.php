...
class Sesevent_ListController extends Core_Controller_Action_Standard {
  ...
  public function init() {
    ...
    //Get subject
    if (null !== ($list_id = $this->_getParam('list_id')) && null !== ($list = Engine_Api::_()->getItem('sesdocument_list', $list_id)) && $list instanceof Sesevent_Model_List && !Engine_Api::_()->core()->hasSubject()) {
