...
class Sesdocument_Model_Category extends Core_Model_Item_Abstract {
  ...
  public function getTable() {
    if (is_null($this->_table)) {
      $this->_table = Engine_Api::_()->getDbtable('categories', 'sesdocument');
    }
  ...
  public function getHref($params = array()) {
    ...
    $params = array_merge(array(
        'route' => 'sesdocument_category_view',
        'reset' => true,
  ...
  public function getBrowseCategoryHref($params = array()) {
	...
	public function getPhotoUrl($type = NULL) {
		if(!$this)
			return 'application/modules/Sesdocument/externals/images/nophoto_document_thumb_profile.png';
