 ...
 * @version    $Id: Tabbed.php  2019-03-27 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesdocument_Form_Admin_Tabbed extends Engine_Form {

  public function init() {

    $this->addElement('MultiCheckbox', "enableTabs", array(
      'label' => "Choose the View Type for Documents.",
      'multiOptions' => array(
      'list' => 'List View',
      'grid' => 'Grid View',
      ),
   ...
   if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesdocument.pluginactivated')) {
   ...
   $categories = array('' => '') + $categories;
    ...
    $this->addElement('MultiCheckbox', "show_criteria", array(
      ...
      'multiOptions' => array(
        ...
        'griddescription' => 'Description (In Grid View)',
      ),
      'escape' => false,
    ));
...
// 			'label' => 'Show only the number of documents entered in above setting. [If you choose No, then you can choose how do you want to show more documents in this widget.]',
// 			 'multiOptions' => array(
//             'yes' => 'Yes',
//             'no' => 'No',
//         ),
...
//     ));
    ...
    $this->addElement('Text', "width_grid_photo", array(
