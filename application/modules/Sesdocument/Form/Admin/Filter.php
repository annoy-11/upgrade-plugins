...
class Sesdocument_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', 'creation_date', array(
		...
		$categories = Engine_Api::_()->getDbtable('categories', 'sesdocument')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Hidden', 'sesdocument_id', array(
        'order' => 10003,
    ));
