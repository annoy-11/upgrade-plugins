 ...
 */
class Sesdocument_Form_Admin_Category_Add extends Engine_Form {
...
//         'label' => 'Color',
//         'description' => 'This will be category color & will appear in Grid View of documents.',
// 				'class'=>'SEScolor',
//         'allowEmpty' => true,
//         'required' => false,
//     ));
    ...
    if (isset($category) && $category->cat_icon && Engine_Api::_()->storage()->get($category->cat_icon,'')) {
