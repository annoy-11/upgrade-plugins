...
class Sesforum_Form_Signature extends Engine_Form {

  public function init() {
   $this
      ->setMethod("POST")
      ->setAttrib('name', 'sesforum_edit_signature')
    ...
    if( !$allowHtml ) {
      ...
      $allowedTags = array_map('trim', explode(',', Engine_Api::_()->authorization()->getPermission($viewer->level_id, 'sesforum', 'commentHtml')));
