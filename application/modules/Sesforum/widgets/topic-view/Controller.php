 ...
 */
class Sesforum_Widget_TopicViewController extends Engine_Content_Widget_Abstract {

  public function indexAction() {
    if(!Engine_Api::_()->core()->hasSubject('sesforum_topic'))
        return $this->setNoRender();


    $this->view->viewer = $viewer = Engine_Api::_()->user()->getViewer();
    $this->view->viewer_id = Engine_Api::_()->user()->getViewer()->getIdentity();
    $this->view->topic = $topic = Engine_Api::_()->core()->getSubject('sesforum_topic');
    ...
    $this->view->rating_count = Engine_Api::_()->sesforum()->ratingCount($topic->getIdentity());
    $this->view->rated = Engine_Api::_()->sesforum()->checkRated($topic->getIdentity(), $viewer->getIdentity());
    ...
    $this->view->decode_bbcode = $settings->getSetting('sesforum_bbcode');
    ...
    // Make form
    if( $canPost ) {
      $this->view->form = $form = new Sesforum_Form_Post_Quick();
