...
class Sesforum_Widget_ProfileForumTopicsController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $this->view->title_truncation_limit = $params['title_truncation_limit'] = isset($params['title_truncation_limit']) ? $params['title_truncation_limit'] : $this->_getParam('title_truncation_limit',1);
    ...
    $params['show_criteria'] = $show_criterias = isset($params['show_criteria']) ? $params['show_criteria'] : $this->_getParam('show_criteria', array('rating', 'likeCount', 'creationDetails','viewsCount','repliesCount','latestPostDetails'));
    ...
    $this->view->paginator = $paginator = Zend_Paginator::factory($postsSelect);
     ...
     $this->view->widgetName = "profile-forum-topics";
