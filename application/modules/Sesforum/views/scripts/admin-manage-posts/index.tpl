      ...
      <table class='admin_table'>
        ...
        <tbody>
          <?php foreach ($this->paginator as $item): ?>
               <?php $topic = Engine_Api::_()->getItem('sesforum_topic', $item->topic_id); ?>
            <tr>
              ...
              <td>
                ...
                |
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesforum', 'controller' => 'manage-posts', 'action' => 'delete', 'id' => $item->post_id), $this->translate("delete"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
