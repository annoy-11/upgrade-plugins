 ...
 * @version    $Id: manage-page.tpl 2016-05-25 00:00:00 SocialEngineSolutions $
...
<br />	
<div>
  <?php echo $this->htmlLink(array('action' => 'create', 'reset' => false), $this->translate("Create New Member Home Page"),array('class' => 'buttonlink sesbasic_icon_add')) ?>
</div>
<br />
