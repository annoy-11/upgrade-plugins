 ...
 */
class Sesmember_Widget_RecentlyViewedByMeController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if ($this->_getParam('showLimitData', 1))
      $this->view->widgetName = 'recently-viewed-by-me';
    ...
    $this->view->results = $paginator = Engine_Api::_()->getDbTable('userviews', 'sesmember')->whoViewedMe(array('resources_id' => $viewerId, 'paginator' => true, 'view_by_me' => true));
