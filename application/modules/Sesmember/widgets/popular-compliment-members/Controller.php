 ...
 */
class Sesmember_Widget_PopularComplimentMembersController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if ($this->_getParam('showLimitData', 1))
      $this->view->widgetName = 'popular-compliment-members';
    ...
    $compliment = Engine_Api::_()->getItem('sesmember_compliment', $value['compliment']);
    $this->view->file_id = $compliment->file_id;
    $this->view->type = $compliment->title;
    if (empty($this->view->file_id))
      return $this->setNoRender();
