...
<?php
if($this->file_id) {
$photoUrl = Engine_Api::_()->storage()->get($this->file_id, '')->map();
?>            
<h3><?php echo '<img src="'.$photoUrl.'" class="sesmember_comp_title_img" />'; ?><?php echo $this->translate($this->title);?></h3>
<?php } ?>
...
?>
<?php if($this->results->getTotalItemCount() > 0):?>
...
<?php if($this->results->getTotalItemCount() <= 0):?>
  <div class="tip">
    <span><?php echo $this->translate('No one user have compliment with this type.');?></span>
  </div>
<?php endif;?>