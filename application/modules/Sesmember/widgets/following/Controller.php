 ...
 */
class Sesmember_Widget_FollowingController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->results = $paginator = Engine_Api::_()->getDbTable('members', 'sesmember')->following(array('user_id' => $subject->getIdentity(), 'paginator' => true));
