...
?>
<ul class="sesbasic_sidebar_block sesmember_review_sidebar_block sesbasic_bxs sesbasic_clearfix"  id="widget_sesmember_<?php echo $randonnumber; ?>" style="position:relative;">
	<div class="sesbasic_loading_cont_overlay" id="sesmember_widget_overlay_<?php echo $randonnumber; ?>"></div>
  <?php include APPLICATION_PATH . '/application/modules/Sesmember/views/scripts/_reviewsidebarWidgetData.tpl'; ?>
</ul>
