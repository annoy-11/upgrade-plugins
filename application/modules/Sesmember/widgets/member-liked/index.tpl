 ...
 */
?>
<h3><?php echo $this->translate(array('%s Person Like This', '%s People Like This', $this->likeCount), $this->locale()->toNumber($this->likeCount))?></h3>
...
var tabId_mlm8 = <?php echo $this->identity; ?>;
