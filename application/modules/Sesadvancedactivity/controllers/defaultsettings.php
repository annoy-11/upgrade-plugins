...
("sesadvancedactivity.countfriend", "3"),
...
("sesadvancedactivity.enablesocialshare", "1"),
...
$db->query('INSERT IGNORE INTO `engine4_activity_notificationtypes` (`type`, `module`, `body`, `is_request`, `handler`, `default`) VALUES ("sesadvancedcomment_tagged_item", "sesadvancedcomment", \'{item:$subject} tagged your {var:$itemurl} in a {var:$postLink}.\', "0", "", "1");');
...
$db->query("INSERT IGNORE INTO `engine4_core_settings` (`name`, `value`) VALUES ('sesadvancedactivity.notificationdaytext','<div style=\"padding: 20px 10px; font-size: 17px; font-weight: bold; position: relative;\"><span style=\"color: #f8b62d;\"> <img class=\"favicon\" style=\"margin-right: 10px; margin-top: 3px; float: left;\" src=\"http://localhost/favicon.ico\" alt=\"favicon\"> NOTIFICATION_TIME NOTIFICATION_USER! </span> <span style=\"position: absolute; right: 10px; bottom: 5px; top: 5px; text-align: right;\"> <img style=\"max-height: 100%;\" src=\"NOTIFICATION_IMAGE\" alt=\"Notification Image\"> </span></div>')");

//Indexing of columns

$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`file_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`parent_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`gif_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`emoji_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`reply_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`preview`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`showpreview`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`vote_up_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitycomments` ADD INDEX(`vote_down_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_activitylikes` ADD INDEX(`type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_buysells` ADD INDEX(`user_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_buysells` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_buysells` ADD INDEX(`is_sold`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_buysells` ADD INDEX(`buy`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`file_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`parent_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`gif_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`emoji_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`reply_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`preview`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`showpreview`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`vote_up_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corecomments` ADD INDEX(`vote_down_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_corelikes` ADD INDEX(`type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`commentable`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`schedule_time`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`sesapproved`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`reaction_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`sesresource_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`sesresource_type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`is_community_ad`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`vote_up_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`vote_down_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`feedbg_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`image_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`view_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`share_count`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_details` ADD INDEX(`posting_type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`date`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`active`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`file_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`recurring`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`creation_date`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`visibility`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`starttime`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_events` ADD INDEX(`endtime`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_feelingposts` ADD INDEX(`feeling_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_feelingposts` ADD INDEX(`feelingicon_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_feelingposts` ADD INDEX(`resource_type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_feelingposts` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_feelingposts` ADD INDEX(`feeling_custom`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_feelingposts` ADD INDEX(`feeling_customtext`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_files` ADD INDEX(`user_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_files` ADD INDEX(`item_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_filterlists` ADD INDEX(`module`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_filterlists` ADD INDEX(`active`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_filterlists` ADD INDEX(`is_delete`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_filterlists` ADD INDEX(`order`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_filterlists` ADD INDEX(`file_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_hashtags` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_hashtags` ADD INDEX(`title`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_hides` ADD INDEX(`resource_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_hides` ADD INDEX(`resource_type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_hides` ADD INDEX(`user_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_hides` ADD INDEX(`subject_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_links` ADD INDEX(`ses_aaf_gif`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_pinposts` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_pinposts` ADD INDEX(`resource_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_pinposts` ADD INDEX(`resource_type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_savefeeds` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_savefeeds` ADD INDEX(`user_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_tagitems` ADD INDEX(`resource_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_tagitems` ADD INDEX(`resource_type`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_tagitems` ADD INDEX(`user_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_tagitems` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_tagusers` ADD INDEX(`user_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_tagusers` ADD INDEX(`action_id`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`location_send`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`country_name`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`city_name`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`location_city`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`location_country`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`gender_send`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`age_min_send`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`age_max_send`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`lat`);');
$db->query('ALTER TABLE `engine4_sesadvancedactivity_targetpost` ADD INDEX(`lng`);');
