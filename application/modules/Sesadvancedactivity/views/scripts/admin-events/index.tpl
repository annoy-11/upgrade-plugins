...
<?php if( count($this->paginator) ): ?>
  ...
  <div>
        <?php if( count($this->paginator) ): ?>
 					 <div class="sesbasic_search_reasult">
    <?php echo $this->translate(array('%s Customs notification found.', '%s Customs notifications found.', $this->paginator->getTotalItemCount()), $this->locale()->toNumber($this->paginator->getTotalItemCount())) ?>
  </div>
  			<?php endif; ?>
