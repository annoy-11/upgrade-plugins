                  ...
                  <?php elseif( $attachment->meta->mode == 1 ): // Thumb/text/title type actions ?>
                    ...
                    <div>
                      ...
                      <div>
                        <div>
                          <?php 
                            if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesmember') && Engine_Api::_()->getApi('core', 'sesmember')->allowReviewRating() &&  $attachment && !empty($attachment->item->rating) && $attachment->item->rating){
                             $memberratingstar = $this->partial('_userRating.tpl', 'sesmember', array('rating' => $attachment->item->rating));
                            } echo $memberratingstar; ?>
                        </div>
                        <div class='feed_item_link_title'>
