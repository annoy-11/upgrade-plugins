 ...
 * @version    $Id: likes.tpl  2017-01-12 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
?>
<?php if(!$this->is_ajax){ ?>
<div class="advact_mlist_popup sesbasic_clearfix sesbasic_bxs">
 <div class="sesact_mlist_popup_tabs sesbasic_clearfix">
 ...
 <div class="sesact_mlist_popup_cont sesbasic_clearfix sesadvcmt_mlist_popup_cont">
<?php } ?>

<?php foreach($this->typesLikeData as $key=>$itemTypes){ ?>
 <div class="container_like_contnent_main sesact_mlist_popup_cont_inner" id="container_like_contnent_<?php echo $key; ?>" style="display:<?php echo $this->typeSelected == $key ? 'block' : 'none'; ?>">
