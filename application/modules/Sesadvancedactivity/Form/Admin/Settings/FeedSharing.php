...
class Sesadvancedactivity_Form_Admin_Settings_FeedSharing extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('Feed Sharing Settings')
		...
		$description = sprintf('Do you want to allow your users to share activity feeds from your website on other social networking websites (Facebook, Twitter, LinkedIn)?');
