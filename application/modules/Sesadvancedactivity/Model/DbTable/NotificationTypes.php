 ...
 * @version    $Id: NotificationTypes.php  2017-01-12 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */


class Sesadvancedactivity_Model_DbTable_NotificationTypes extends Engine_Db_Table
{
  /**
  ...
  {
    if( !is_array($values) ){
      throw new Sesadvancedactivity_Model_Exception('setDefaultNotifications requires an array of notifications');
    }
