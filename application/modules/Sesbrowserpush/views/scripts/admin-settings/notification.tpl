 ...
 * @version    $Id: notification.tpl 2019-06-05 00:00:00 SocialEngineSolutions $
...
<div class='settings sesbasic_admin_form sesbrowsepush_notification_form'>
  <?php echo $this->form->render($this); ?>
  </div>
<style>
#global_content_simple .sesbasic_admin_form form{
	width:600px;
}
#global_content_simple .sesbasic_admin_form form textarea{
	min-width:inherit;
	width:90%;
}
