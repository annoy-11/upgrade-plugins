...
class Seselegant_NotificationsController extends Core_Controller_Action_Standard {
  ...
  public function pulldownAction() {
    ...
    $this->view->notifications = $notifications = Engine_Api::_()->getDbTable('notifications', 'seselegant')->getNotificationsPaginator($viewer);
    ...
    Engine_Api::_()->getApi('message', 'seselegant')->setUnreadNotification($viewer);
