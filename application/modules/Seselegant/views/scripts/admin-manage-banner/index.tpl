...
<div class="sesbasic_search_reasult">
	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seselegant', 'controller' => 'manage-banner', 'action' => 'create-banner'), $this->translate("Create New Banner"), array('class'=>'smoothbox sesbasic_icon_add buttonlink')) ?>
</div>
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        <tr>
          ...
          <td class="admin_table_centered"><?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'seselegant', 'controller' => 'manage-banner', 'action' => 'enabled', 'id' => $item->banner_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disabled'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'seselegant', 'controller' => 'manage-banner', 'action' => 'enabled', 'id' => $item->banner_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enabled')))) ) ?></td>
          <td>
          	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seselegant', 'controller' => 'manage-banner', 'action' => 'manage', 'id' => $item->banner_id), $this->translate("Manage Photos"), array()) ?>
            |
            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seselegant', 'controller' => 'manage-banner', 'action' => 'create-banner', 'id' => $item->banner_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?>
            |
            <?php echo $this->htmlLink(
                array('route' => 'admin_default', 'module' => 'seselegant', 'controller' => 'manage-banner', 'action' => 'delete-banner', 'id' => $item->banner_id),
