...
<?php endif; ?>
<ul class="elegant_member_block sesbasic_clearfix sesbasic_bxs">
  <?php foreach( $this->paginator as $user ): ?>
    <li style="width:<?php echo $this->width ?>px;">
      <div class="elegant_member_block_thumb sesbasic_animation" style="height:<?php echo $this->height ?>px;"><?php echo $this->htmlLink($user->getHref(), $this->itemPhoto($user, 'thumb.profile')) ?></div>
