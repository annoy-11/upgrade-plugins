...
class Seselegant_Widget_MenuMiniController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if ($viewer->getIdentity()) {
      ...
      $this->view->messageCount = Engine_Api::_()->getApi('message', 'seselegant')->getMessagesUnreadCount($viewer);
