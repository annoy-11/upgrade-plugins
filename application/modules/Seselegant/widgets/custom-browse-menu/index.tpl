 ...
 */
?>
<div id="elegant_custom_menu_tab_container" class="elegant_browse_nav sesbasic_clearfix"><div id="elegant_custom_menu" class="elegant_browse_nav_inner"></div></div>
<?php
...
sesJqueryObject(document).ready(function(e){
	var elegant_menu_height = sesJqueryObject('.layout_<?php echo $moduleName; ?>_browse_menu').height() + 10;
	if(sesJqueryObject('.layout_<?php echo $moduleName; ?>_browse_menu').length){
		...
		sesJqueryObject('#elegant_custom_menu').html(sesJqueryObject('.layout_<?php echo $moduleName; ?>_browse_menu').html());
		sesJqueryObject('#elegant_custom_menu_tab_container').height(elegant_menu_height + 'px');
