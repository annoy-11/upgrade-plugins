...
class Sespagethm_Form_Admin_Paralex extends Engine_Form {
  ...
  public function init() {
    ...
    $contentText = '<h2 style="font-size: 35px; font-weight: normal; margin-bottom: 20px; text-transform: uppercase;">HELP US MAKE VIDEO BETTER</h2>
      ...
      //UPLOAD PHOTO URL
      $upload_url = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'sespagethm', 'controller' => 'manage', 'action' => "upload-photo"), 'admin_default', true);
