...
class Sespagethm_Form_Admin_Createimage extends Engine_Form {
  public function init() {
    ...
    $this->addElement('Cancel', 'cancel', array(
        ...
        'link' => true,
        'prependText' => ' or ',
        'href' => Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'sespagethm', 'controller' => 'manage', 'action' => 'manage-photos'), 'admin_default', true),
        'decorators' => array(
            'ViewHelper'
        )
    ));
