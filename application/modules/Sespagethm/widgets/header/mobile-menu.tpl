...
<a href="javascript:void;" class="sespagethm_mobile_menu_toggle" id="sespagethm_mobile_menu_toggle"><i class="fa fa-bars"></i></a>
<div class="sespagethm_mobile_menu_search"><i class="fa fa-search"></i>
  <?php
...
<div class="sespagethm_mobile_menu_container" id="sespagethm_mobile_menu_container">
  <?php if($this->show_logo):?>
      <div class="header_logo">
        <?php echo $this->content()->renderWidget('sespagethm.menu-logo'); ?>
      </div>
      <?php endif; ?>
  <div class="sespagethm_mobile_menu_links">
    <ul>
...
<script>
$('sespagethm_mobile_menu_toggle').addEvent('click', function(event){
	event.stop();
	if($('sespagethm_mobile_menu_container').hasClass('show-menu'))
		$('sespagethm_mobile_menu_container').removeClass('show-menu');
	else
		$('sespagethm_mobile_menu_container').addClass('show-menu');
	return false;
});
</script>
<script>
sesJqueryObject(document).ready(function(){
    sesJqueryObject(".sespagethm_mobile_menu_search > i").click(function(){
        sesJqueryObject(".sespagethm_mobile_menu_search .header_searchbox").toggle();
    });
});
</script>
