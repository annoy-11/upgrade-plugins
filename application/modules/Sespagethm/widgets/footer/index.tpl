 ...
 */
?>
<div class="sespagethm_footer_mini sesbasic_sesbasic_clearfix sesbasic_bxs">
  <div class="sespagethm_footer_mini_links">
   ...
   <?php if( 1 !== count($this->languageNameList) ): ?>
      <form method="post" action="<?php echo $this->url(array('controller' => 'utility', 'action' => 'locale'), 'default', true) ?>" class="sespagethm_footer_language">
...
<div class="sespagethm_footer_mini_socialicons sespagethm_footer_social_icons">
