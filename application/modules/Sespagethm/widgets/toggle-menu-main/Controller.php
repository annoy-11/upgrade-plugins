 ...
 */
class Sespagethm_Widget_ToggleMenuMainController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $header_teamplate = Engine_Api::_()->sespagethm()->getContantValueXML('sespagethm_header_design');
    if($header_teamplate == 3) {
	    $this->view->max = 0;
    } else {
	    $this->view->max = $settings->getSetting('sespagethm.limit', 4);
    }
    $this->view->moreText = $settings->getSetting('sespagethm.moretext', 'More');
