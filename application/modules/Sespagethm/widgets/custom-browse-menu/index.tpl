 ...
 */
?>
<div id="sespagethm_custom_menu_tab_container" class="sespagethm_browse_nav sesbasic_clearfix"><div id="sespagethm_custom_menu" class="sespagethm_browse_nav_inner"></div></div>
<?php
...
sesJqueryObject(document).ready(function(e){
	...
	if(sesJqueryObject('.layout_<?php echo $moduleName; ?>_browse_menu').length){
		...
		sesJqueryObject('#sespagethm_custom_menu').html(sesJqueryObject('.layout_<?php echo $moduleName; ?>_browse_menu').html());
		sesJqueryObject('#sespagethm_custom_menu_tab_container').height(elegant_menu_height + 'px');
