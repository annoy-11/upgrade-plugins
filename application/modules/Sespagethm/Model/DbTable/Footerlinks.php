...
class Sespagethm_Model_DbTable_Footerlinks extends Engine_Db_Table {

  protected $_rowClass = "Sespagethm_Model_Footerlink";

  public function getInfo($params = array()) {

    $socialTable = Engine_Api::_()->getDbTable('footerlinks', 'sespagethm');
