 ...
 * @version    $Id: detail.tpl  2019-02-02 00:00:00 SocialEngineSolutions $
...
<dl class="payment_transaction_details">
  ...
  <dt>
    <?php if( $this->user && $this->user->getIdentity() ): ?>
      ...
      <?php if( !_ENGINE_ADMIN_NEUTER ): ?>
        <?php echo $this->translate('(%1$s)', '<a target="_blank" href="mailto:' .
  ...
  <dt>
    <?php if( !empty($this->actualLevel) ): ?>
      <a target="_blank" href='<?php echo $this->url(array('module' => 'authorization', 'controller' => 'level', 'action' => 'edit', 'id' => $this->actualLevel->level_id)) ?>'>
  ...
  <dt>
    <a target="_blank" href='<?php echo $this->url(array('module' => 'payment', 'controller' => 'package', 'action' => 'edit', 'package_id' => $this->package->package_id)) ?>'>
  ...
  <dt>
    <a target="_blank" href='<?php echo $this->url(array('module' => 'authorization', 'controller' => 'level', 'action' => 'edit', 'id' => $this->level->level_id)) ?>'>
  ...
  <dt>
    <a href='<?php echo $this->url(array('module' => 'sessegpay', 'controller' => 'subscription', 'action' => 'index'), null, true) ?>?user_id=<?php echo $this->subscription->user_id ?>'>
      <?php echo $this->translate('Member Subscription History') ?>
    </a>
    |
    <a href='<?php echo $this->url(array('module' => 'sessegpay', 'controller' => 'transactions', 'action' => 'index'), null, true) ?>?user_id=<?php echo $this->subscription->user_id ?>'>
      <?php echo $this->translate('Member Transaction History') ?>
    </a>
    <br />
    <a href='<?php echo $this->url(array('module' => 'sessegpay', 'controller' => 'subscription', 'action' => 'cancel'), null, true) ?>?subscription_id=<?php echo $this->subscription->subscription_id ?>' class="smoothbox">
      <?php echo $this->translate('Cancel Subscription') ?>
    </a>
    |
    <a class="smoothbox" href='<?php echo $this->url(array('module' => 'sessegpay', 'controller' => 'subscription', 'action' => 'edit'), null, true) ?>?subscription_id=<?php echo $this->subscription->subscription_id ?>'>
