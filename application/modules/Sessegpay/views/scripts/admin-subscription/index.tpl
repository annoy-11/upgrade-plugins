 ...
 * @version    $Id: index.tpl  2019-02-02 00:00:00 SocialEngineSolutions $
    ...
    <?php foreach( $this->paginator as $item ):
      ...
      <tr>
        ...
        <td class='admin_table_centered'>
          <?php if( $package ): ?>
            <a target="_blank" href='<?php echo $this->url(array('module' => 'payment', 'controller' => 'package', 'action' => 'edit', 'package_id' => $package->package_id)) ?>'>
        ...
        <td class='admin_table_centered'>
          <a target="_blank" href='<?php echo $this->url(array('module' => 'authorization', 'controller' => 'level', 'action' => 'edit', 'id' => $level->level_id)) ?>'>
        ...
        <td class='admin_table_options'>
          ...
          |
          <a target="_blank" href='<?php echo $this->url(array('action' => 'detail', 'subscription_id' => $item->subscription_id));?>'>
