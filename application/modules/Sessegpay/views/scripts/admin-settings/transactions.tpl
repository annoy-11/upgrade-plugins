 ...
 * @version    $Id: transactions.tpl  2019-02-02 00:00:00 SocialEngineSolutions $
      ...
      <?php foreach( $this->paginator as $item ):
        ...
        <tr>
          ...
          <td class='admin_table_options'>
            <a class="smoothbox" href='<?php echo $this->url(array('action' => 'detail', 'transaction_id' => $item->transaction_id,'module'=>'payment','controller'=>'index'));?>'>
