 ...
 * @version    $Id: gateway.tpl  2019-02-02 00:00:00 SocialEngineSolutions $
...
<?php else: ?>
  ...
  <form method="get" action="<?php echo $this->escape($this->url(array('action' => 'process','module'=>'sessegpay','controller'=>'subscription'))) ?>"
      ...
      <div>
        ...
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
              ...
              <?php endforeach; ?>
              <?php if($this->segpaygateway){ ?>
                <button type="submit" name="execute" onclick="$('gateway_id').set('value', '<?php echo $this->segpaygateway->getIdentity(); ?>')">
                  <?php echo $this->translate('Pay with %1$s', $this->translate("SegPay")) ?>
                </button>
              <?php } ?>
          </div>
        </div>
