...
<?php } ?>
    <ul style="margin-bottom:10px;">
      ...
      <?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sescontestpackage') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sescontestpackage.enable.package', 0)):?>
        <div class="sescontest_manage_package_btn">
          <a href="<?php echo $this->url(array('action' => 'package'),'sescontest_general',true);?>" class="sesbasic_link_btn"><?php echo $this->translate("My Packages"); ?></a>
        </div>
      <?php endif;?>
      <?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sescontestjoinfees') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sescontestjoinfees.allow.entryfees', 0)):?>
        <div class="sescontest_manage_package_btn">
          <a href="<?php echo $this->url(array('action' => 'view'),'sescontestjoinfees_user_order',true);?>" class="sesbasic_link_btn"><?php echo $this->translate("My Orders"); ?></a>
        </div>
      <?php endif;?>
     </div>
