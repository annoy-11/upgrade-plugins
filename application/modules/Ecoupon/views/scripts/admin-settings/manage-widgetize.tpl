...
<h3><?php echo $this->translate("Courses Widgetized Pages") ?></h3>
<p>
	<?php echo $this->translate('This page lists all the Widgetized Pages of the Courses. From here, you can easily go to particular widgetized page in "Layout Editor" by clicking on "Widgetized Page" link.'); ?>
</p>
<br />
<table class='admin_table'>
  ...
  <tbody>
    <?php foreach ($this->coursesArray as $item):
