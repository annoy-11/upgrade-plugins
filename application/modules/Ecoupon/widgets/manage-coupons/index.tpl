...
<?php if(!$this->is_ajax){ ?>
  ...
  <div class="ecoupon_coupon_main" id="coupon-manage-widget_<?php echo $randonNumber; ?>">
<?php } ?>
    ...
    function viewMore_<?php echo $randonNumber; ?> (){
      ...
      requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
        ...
        onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) { 
          ...
          if(!isSearch) {
            document.getElementById('coupon-manage-widget_<?php echo $randonNumber; ?>').innerHTML = document.getElementById('coupon-manage-widget_<?php echo $randonNumber; ?>').innerHTML + responseHTML;
          }
          else { 
            document.getElementById('coupon-manage-widget_<?php echo $randonNumber; ?>').innerHTML = document.getElementById('coupon-manage-widget_<?php echo $randonNumber; ?>').innerHTML + responseHTML;
            isSearch = false;
          }
          var totalCoupons= sesJqueryObject('#coupon-manage-widget_<?php echo $randonNumber; ?>').find("#paginator_count_ajax_ecoupon_entry"); 
    ...
    function paggingNumber<?php echo $randonNumber; ?>(pageNum){
      ...
      requestViewMore_<?php echo $randonNumber; ?> = (new Request.HTML({
        ...
        onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
          ...
          document.getElementById('coupon-manage-widget_<?php echo $randonNumber; ?>').innerHTML =  responseHTML;
          var totalCoupons= sesJqueryObject('#coupon-manage-widget_<?php echo $randonNumber; ?>').find("#paginator_count_ajax_ecoupon_entry"); 
          sesJqueryObject('.sesbasic_view_type_<?php echo $randonNumber; ?>').find('#paginator_count_ecoupon').html(totalCoupons.html());
          totalCoupons.remove();
