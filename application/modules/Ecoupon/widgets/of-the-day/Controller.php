 ...
 */
class Ecoupon_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $couponId = Engine_Api::_()->getDbTable('coupons', 'ecoupon')->getOfTheDayResults(false,array('coupon_id'));
    $this->view->coupon_id = $couponId->coupon_id;
