 ...
 * @version    $Id: AlbumTabbed.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Eclassroom_Form_Admin_AlbumTabbed extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Select', "show_limited_data", array(
        'label' => 'Show only the number of albums entered in the above setting. [If you choose No, then you can choose how do you want to show more albums in this widget in below setting.]',
        'multiOptions' => array('1' => 'Yes','0' => 'No'),
        'value' => '0',
    ));
