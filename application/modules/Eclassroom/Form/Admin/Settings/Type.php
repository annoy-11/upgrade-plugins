 ...
 * @version    $Id: Type.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Eclassroom_Form_Admin_Settings_Type extends Engine_Form {
  ...
  public function init() {
    ...
    $member_type_result = $db->select('option_id, label')
            ->from('engine4_classroom_fields_options')
            ->where('field_id = ?', 1)
            ->query()
            ->fetchAll();
