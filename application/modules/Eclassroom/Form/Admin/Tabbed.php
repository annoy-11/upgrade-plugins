...
class Eclassroom_Form_Admin_Tabbed extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Select', "openViewType", array(
        'label' => "Choose Default View Type (apply if more than 1 view type is selected.) (Note: In Tabbed widget for Manage Classroom only List View will work.)",
        'multiOptions' => array(
            'list' => 'List View',
            'grid' => 'Grid View',
            'pinboard' => 'Pinboard View',
    ...
    $this->addElement('MultiCheckbox', "show_criteria", array(
        ...
        'multiOptions' => array(
            ...
            'totalClassroom' =>'Total Classroom',
        ),
        'escape' => false,
    ));
    ...
    $this->addElement('Select', "show_limited_data", array(
        'label' => 'Show only the number of classrooms entered in the setting for Count of each view. [If you choose No, then you can choose How do you want to show more classroom in this widget.]',
        'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
