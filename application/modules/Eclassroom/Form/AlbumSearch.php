 ...
 * @version    $Id: AlbumSearch.php 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Eclassroom_Form_AlbumSearch extends Engine_Form {
  ...
  public function init() {
    parent::init();
    $searchFor = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'eclassroom','controller'=>'album','action'=>'browse'));
    ...
    $this->addElement('Button', 'submit', array(
      ...
      'type' => 'submit'
		...
		$this->addElement('Dummy','loading-img-eclassroom', array(
      'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="eclassroom-category-widget-img" alt="Loading" />',
   ));
  }
}
