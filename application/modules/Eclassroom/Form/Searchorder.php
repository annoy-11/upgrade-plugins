 ...
 */
class Eclassroom_Form_Searchorder extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Dummy','#loadingimgeclassroom', array(
        'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="classroom-search-order-img" style = "display:none;" alt="Loading" />',
   ));
  }
