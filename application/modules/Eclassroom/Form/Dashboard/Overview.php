...
class Eclassroom_Form_Dashboard_Overview extends Engine_Form {

  public function init() {
    $this->setTitle('Change Classroom Overview')
    ...
    $this->addElement('TinyMce', 'overview', array(
        ...
        'description' => 'Enter detailed overview about the Classroom.',
