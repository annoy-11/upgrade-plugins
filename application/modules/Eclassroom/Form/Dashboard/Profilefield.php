...
class Eclassroom_Form_Dashboard_Profilefield extends Engine_Form {
  ...
  public function init() {
    ...
    if (Engine_Api::_()->core()->hasSubject('classrooms'))
      $classroom = Engine_Api::_()->core()->getSubject();
    //get current logged in user
    $this->setTitle('Category Based Profile Information')
            ->setDescription('Here, you can add additional information about your Classroom specific to its category to provide information about your Classroom to site members.')
    ...
    if (count($categories) > 0) {
      $categorieEnable = $setting->getSetting('eclassroom.category.required', '1');
