...
class Eclassroom_Bootstrap extends Engine_Application_Bootstrap_Abstract
{
public function __construct($application) {
    ...
    @define('ECLASSROOMSHOWUSERDETAIL', Engine_Api::_()->getApi('settings', 'core')->getSetting('eclassroom.identity.privacy', 1));
    $isCoursesEnable = 0;
