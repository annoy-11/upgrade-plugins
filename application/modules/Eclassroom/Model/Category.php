 ...
 */
class Eclassroom_Model_Category extends Core_Model_Category {
  ...
  public function getTable() {
    if (is_null($this->_table)) {
      $this->_table = Engine_Api::_()->getDbTable('categories', 'eclassroom');
    }
    return $this->_table;
  }
  //Category href
  public function getHref($params = array()) {
    ...
    $params = array_merge(array(
        'route' => 'eclassroom_category_view',
        'reset' => true,
  ...
  public function getPhotoUrl($type = NULL) {
    if (!$this)
      return 'application/modules/Eclassroom/externals/images/nophoto_classroom_thumb_profile.png';
