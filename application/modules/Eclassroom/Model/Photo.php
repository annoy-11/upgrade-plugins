 ...
 */
class Eclassroom_Model_Photo extends Core_Model_Item_Collectible {
  protected $_parent_type = 'eclassroom_album';
  protected $_owner_type = 'user';
  protected $_collection_type = 'eclassroom_album';
  public function getHref($params = array()) {
    $params = array_merge(array(
        'route' => 'eclassroom_photo_view',
        'reset' => true,
        'controller' => 'photo',
        'action' => 'view',
  ...
  */
  ...
  public function getAlbum() {
      return Engine_Api::_()->getItem('eclassroom_album', $this->album_id);
  }
