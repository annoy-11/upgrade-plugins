...
class Eclassroom_Model_DbTable_Metas extends Engine_Db_Table {

    protected $_name = 'classroom_fields_meta';
    protected $_rowClass = 'Eclassroom_Model_Meta';

	public function getMetaData($options_id = null){
		if(!$options_id)
			return null;
		$tableName = $this->info('name');
		$mapTableName = Engine_Api::_()->getDbTable('maps','eclassroom')->info('name');
