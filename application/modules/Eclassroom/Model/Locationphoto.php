 ...
 */
class Eclassroom_Model_Locationphoto extends Core_Model_Item_Abstract {
  ...
  public function setPhoto($photo, $isShareContent = false) {
    ...
    $params = array(
        'parent_type' => 'eclassroom_locationphoto',
        'parent_id' => $this->getIdentity()
    );

    $core_settings = Engine_Api::_()->getApi('settings', 'core');
    $main_height = $core_settings->getSetting('classroom.mainheight', 1600);
    $main_width = $core_settings->getSetting('classroom.mainwidth', 1600);
    $normal_height = $core_settings->getSetting('classroom.normalheight', 500);
    $normal_width = $core_settings->getSetting('classroom.normalwidth', 500);
  ...
  public function getPhotoUrl($type = NULL) {
    ...
    $defaultPhoto = 'application/modules/Eclassroom/externals/images/nophoto_classroom_thumb_profile.png';
    return $defaultPhoto;
  }
