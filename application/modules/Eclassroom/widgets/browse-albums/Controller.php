 ...
 */
class Eclassroom_Widget_BrowseAlbumsController extends Engine_Content_Widget_Abstract {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('albums', 'eclassroom')->getAlbumSelect($value,array('*'));
