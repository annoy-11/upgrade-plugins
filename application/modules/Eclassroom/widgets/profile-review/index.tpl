...
<div class="eclassroom_review_view eclassroom_profile_review sesbasic_bxs sesbasic_clearfix">
  <div class="eclassroom_review_view_top sesbasic_clearfix">
    <?php if(in_array('title', $this->stats)): ?>
    	<div class="eclassroom_review_view_title"><?php echo $this->review->getTitle() ?></div>
    <?php endif; ?>
    <div class="eclassroom_review_view_item_info sesbasic_clearfix">
      <div class="eclassroom_review_view_info_img">
        <?php if(in_array('postedin', $this->stats)): ?>
        <?php echo $this->htmlLink($this->item->getHref(), $this->itemPhoto($this->item, 'thumb.icon')); ?>
        <?php endif; ?>
      </div>
      <div class="eclassroom_review_view_info_cont sesbasic_clearfix">
        <p class='eclassroom_review_view_stats sesbasic_text_light sesbasic_clearfix'>
          <?php if(in_array('postedin', $this->stats)): ?>
        ...
        <p class="eclassroom_review_view_stats sesbasic_text_light">
    ...
    <div class="eclassroom_review_show_rating review_ratings_listing">
      <?php if(in_array('rating', $this->stats)){ ?>
        <div class="sesbasic_rating_star eclassroom_review_listing_star">
      ...
      <?php $reviewParameters = Engine_Api::_()->getDbtable('parametervalues', 'eclassroom')->getParameters(array('content_id'=>$this->review->getIdentity(),'user_id'=>$this->review->owner_id)); ?>
  ...
  <div class="eclassroom_review_contant_disc">
    <?php if(in_array('pros', $this->stats) && $this->review->pros): ?>
    	<div class="eclassroom_review_view_cont_row"> <b class="label"><?php echo $this->translate("Pros"); ?></b> <?php echo $this->review->pros;  ?> </div>
    <?php endif; ?>
    <?php if(in_array('cons', $this->stats) && $this->review->cons): ?>
    	<div class="eclassroom_review_view_cont_row"> <b class="label"><?php echo $this->translate("Cons"); ?></b> <?php echo $this->review->cons;  ?> </div>
    <?php endif; ?>
    <?php if(in_array('description', $this->stats)): ?>
    	<div class='eclassroom_review_view_cont_row'> <b class="label"><?php echo $this->translate("Summary"); ?></b>
      	<div class="sesbasic_html_block"><?php echo $this->review->description;  ?></div>
      </div>
    <?php endif; ?>
    <?php if(in_array('recommended', $this->stats)): ?>
      <div class="eclassroom_review_view_cont_row eclassroom_review_view_recommended"> <b><?php echo $this->translate("Recommended"); ?>
  ...
  <?php  echo $this->partial('_reviewOptions.tpl','eclassroom',array('subject'=>$this->review,'viewer'=> Engine_Api::_()->user()->getViewer(),'stats'=>$this->stats)); ?>  
</div>
