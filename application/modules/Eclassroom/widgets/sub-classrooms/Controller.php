...
class Eclassroom_Widget_SubClassroomsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'sub-classrooms';
    ...
    $value['search'] = 1;
    $value['draft'] = "1";
    $value['parent_id'] = $subject->classroom_id;
