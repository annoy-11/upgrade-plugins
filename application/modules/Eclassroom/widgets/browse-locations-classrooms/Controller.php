 ...
 */
class Eclassroom_Widget_BrowseLocationsClassroomsController extends Engine_Content_Widget_Abstract {
  public function indexAction() { 
    ...
    if (!$is_ajax) {
      $defaultSearchParams = Engine_Api::_()->eclassroom()->getSearchWidgetParams($this->view->identity);
...
//       $defaultOrder = Engine_Api::_()->eclassroom()->getColumnName($orderKey);
//     }else
    unset($value['sort']);
    $params['actionname'] = 'locationclassroom';
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('classrooms', 'eclassroom')->getClassroomPaginator($value, true);
    $paginator->setItemCountPerPage($limit);
    $paginator->setCurrentPageNumber(1);
    $this->view->widgetName = 'browse-locations-classrooms';
  }
}
