...
<div class="eclassroom_sidebar_button">
 <a href="javascript:;" class="eclassroom_link_btn sesbasic_popup_slide_open fa-share sesbasic_bxs sesbasic_share_btn">
...
<div id="sesbasic_popup_slide" class="well" style="display:none">
  <div class="sesbasic_popup sesbasic_bxs">
    <div class="sesbasic_popup_title">
       <?php echo $this->translate("Share This ".ucfirst(str_replace(array('eclassroom_',''),'',$this->subject()->getType()))); ?>
...
<?php if(isset($_SESSION['newClassroom']) && $_SESSION['newClassroom']){ ?>
	var autoOpen = true;
<?php }else{ ?>
	var autoOpen = false;
<?php } ?>
...
<?php unset($_SESSION['newClassroom']); ?>
});
</script>
