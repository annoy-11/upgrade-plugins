...
<?php $route = 'eclassroom_general';?>
<?php if($widgetParams['viewType'] == 'list') { ?>
  <div class="eclassroom_home_category_list_view sesbasic_clearfix sesbasic_bxs <?php if(($widgetParams['showsubcategory'])) { ?>is_subcat<?php } ?>">
    <?php foreach($this->resultcategories as $resultcategorie): ?>
      <div class="eclassroom_home_category_list_item">
      	<section class="sesbasic_clearfix">
          <?php //if(empty($widgetParams['showsubcategory'])) { ?>
            <a href="<?php echo $this->url(array('action' => 'browse'), $route, true).'?category_id='.urlencode($resultcategorie->category_id); ?>" class="eclassroom_home_category_list_item_icon" style="width:<?php echo $widgetParams['categoryiconwidth'] ?>px;height:<?php echo $widgetParams['categoryiconheight'] ?>px;" ><?php if(@in_array('caticon', $widgetParams['showinformation'])) { ?><img src="<?php echo $resultcategorie->getPhotoUrl(); ?>" /><?php } ?></a>
          <?php //} ?>
          <div class="eclassroom_home_category_list_item_cont">
          ...
          <?php if($widgetParams['showsubcategory']) { ?>
            <?php $subCategories = Engine_Api::_()->getDbTable('categories', 'eclassroom')->getModuleSubcategory(array('category_id' => $resultcategorie->getIdentity(), 'column_name' => '*', 'limit' => $widgetParams['limitsubcat'])); ?>
            <div class="eclassroom_home_category_list_sub">
              <?php foreach($subCategories as $subCategory) { ?>
              	<div class="eclassroom_home_category_list_sub_item sesbasic_clearfix">
                  <a class="eclassroom_home_category_list_sub_item_icon" href="<?php echo $this->url(array('action' => 'browse'), $route, true).'?category_id='.urlencode($resultcategorie->category_id) . '&subcat_id='.urlencode($subCategory->category_id) ; ?>"><?php if(@in_array('subcaticon', $widgetParams['showinformation'])) { ?><img style="width:<?php echo $widgetParams['subcaticonwidth'] ?>px;height:<?php echo $widgetParams['subcaticonheight'] ?>px;" src="<?php echo $subCategory->getPhotoUrl(); ?>" /><?php } ?></a>
                  <div class="eclassroom_home_category_list_sub_item_cont">
...
<?php } elseif($widgetParams['viewType'] == 'grid') { ?>
  <div class="eclassroom_home_category_content sesbasic_clearfix sesbasic_bxs">
    <?php foreach($this->resultcategories as $resultcategorie): ?>
      <div class="eclassroom_home_category_section" style="width:<?php echo $widgetParams['mainblockwidth'] ?>px;height:<?php echo $widgetParams['mainblockheight'] ?>px;">
        <?php if(@in_array('socialshare', $widgetParams['showinformation'])) { ?>
          <div class="eclassroom_list_btns">
        ...
        <a href="<?php echo $this->url(array('action' => 'browse'), $route, true).'?category_id='.urlencode($resultcategorie->category_id); ?>">	
          <?php if(@in_array('caticon', $widgetParams['showinformation'])): ?>
            ...
            <div class="eclassroom_home_category_section_img" style="width:<?php echo $widgetParams['categoryiconwidth'] ?>px;height:<?php echo $widgetParams['categoryiconheight'] ?>px;">
                <img src="<?php echo $resultcategorie->getPhotoUrl(); ?>" />
            </div>
          <?php endif; ?>
          <div class="eclassroom_home_category_section_title">
          ...
          <?php if(@in_array('description', $widgetParams['showinformation'])): ?>
            <div class="eclassroom_home_category_section_des">
