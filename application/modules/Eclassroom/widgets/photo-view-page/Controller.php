...
class Eclassroom_Widget_photoViewPageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if(Engine_Api::_()->core()->hasSubject('eclassroom_photo') && !$is_ajax)
      $photo = Engine_Api::_()->core()->getSubject('eclassroom_photo');
    else if(isset($_POST['photo_id'])) {
      $photo = Engine_Api::_()->getItem('eclassroom_photo',$_POST['photo_id']);
      Engine_Api::_()->core()->setSubject($photo);
      $photo = Engine_Api::_()->core()->getSubject();
    } else
      return $this->setNoRender();

    $this->view->classroom =	$classroom = Engine_Api::_()->getItem('classroom', $photo->classroom_id);
