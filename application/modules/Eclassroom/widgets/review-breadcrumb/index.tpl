...
<div class="sesbasic_breadcrumb">
  <?php if($dontShow): ?>
    ...
    <a href="<?php echo $this->url(array('action' => 'browse-review'), 'eclassroom_general'); ?>"><?php echo $this->translate("Classroom Review"); ?></a>&nbsp;&raquo;
  <?php endif; ?> 
  <?php if($this->subject->getType() == 'eclassroom_review' && $isValid):?>
    <?php if($item): ?>
