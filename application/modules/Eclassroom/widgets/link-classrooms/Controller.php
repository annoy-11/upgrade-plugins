...
class Eclassroom_Widget_LinkClassroomsController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    $classroomId = (isset($_POST['classroom_id']) ? $_POST['classroom_id'] : 0);
    if ($classroomId) {
      $subject = Engine_Api::_()->getItem('classroom', $classroomId);
    } else {
    ...
    $this->view->classroom_id = $subject->classroom_id;
    $getParams = '';
    $searchArray = array();
    ...
    $this->view->widgetName = 'link-classrooms';
    ...
    $value['search'] = 1;
    $value['draft'] = "1";
    $value['link_classroom_id'] = $subject->classroom_id;
