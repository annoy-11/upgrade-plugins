...
?>
<div class="sesbasic_clearfix sesbasic_bxs eclassroom_browse_search <?php echo $this->view_type=='horizontal' ? 'eclassroom_browse_search_horizontal' : 'eclassroom_browse_search_vertical'; ?>">
  <?php echo $this->form->render($this) ?>
</div>
<?php $request = Zend_Controller_Front::getInstance()->getRequest();?>
<?php $controllerName = $request->getControllerName();?>
<?php $actionName = $request->getActionName(); ?>
<?php $class = '.eclassroom_listing';?>
<?php if($actionName == 'manage'):?>
  <?php $classroomName = 'eclassroom_index_manage';?>
  <?php $widgetName = 'eclassroom.manage-classrooms';?>
<?php elseif($actionName == 'pinboard'):?>
  <?php $classroomName = 'eclassroom_index_pinboard';?>
  <?php $widgetName = 'eclassroom.browse-classrooms';?>
<?php elseif($actionName == 'featured'):?>
  <?php $classroomName = 'eclassroom_index_featured';?>
  <?php $widgetName = 'eclassroom.browse-classrooms';?>
<?php elseif($actionName == 'sponsored'):?>
  <?php $classroomName = 'eclassroom_index_sponsored';?>
  <?php $widgetName = 'eclassroom.browse-classrooms';?>
<?php elseif($actionName == 'verified'):?>
  <?php $classroomName = 'eclassroom_index_verified';?>
  <?php $widgetName = 'eclassroom.browse-classrooms';?>
<?php elseif($actionName == 'hot'):?>
  <?php $classroomName = 'eclassroom_index_hot';?>
  <?php $widgetName = 'eclassroom.browse-classrooms';?>
<?php elseif($actionName == 'browse-locations'):?>
   <?php $classroomName = 'eclassroom_index_browse-locations';?>
  <?php $widgetName = 'eclassroom.browse-locations-classrooms';?>
<?php else:?>
   <?php $classroomName = 'eclassroom_index_browse';?>
  <?php $widgetName = 'eclassroom.browse-classrooms';?>
<?php endif;?>
<?php $identity = Engine_Api::_()->sesbasic()->getIdentityWidget($widgetName,'widget',$classroomName); ?>
...
<script type="application/javascript">
  function showHideOptions<?php echo $this->identity; ?>(display){
    var elem = sesJqueryObject('.eclassroom_widget_advsearch_hide_<?php echo $this->identity; ?>');
    if(elem.length == 0){
  ...
  var Searchurl = "<?php echo $this->url(array('module' =>'eclassroom','controller' => 'ajax', 'action' => 'get-classroom'),'default',true); ?>";
  ...
  function showSubCategory(cat_id,selected) {
    var url = en4.core.baseUrl + 'eclassroom/ajax/subcategory/category_id/' + cat_id + '/type/'+ 'search';
    new Request.HTML({
      url: url,
      data: {
	'selected':selected
  ...
  function showSubSubCategory(cat_id,selected) {
    ...
    showFields(cat_id,1,categoryId);
    var url = en4.core.baseUrl + 'eclassroom/ajax/subsubcategory/subcategory_id/' + cat_id + '/type/'+ 'search';;
    (new Request.HTML({
      url: url,
      data: {
	'selected':selected
