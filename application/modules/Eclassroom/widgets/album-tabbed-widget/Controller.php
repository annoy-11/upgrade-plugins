 ...
 */
class Eclassroom_Widget_AlbumTabbedWidgetController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        if($is_ajax)
            ...
            if( $paginator->getTotalItemCount() <= 0 ) {
                ...
                $checkAlbumCount = Engine_Api::_()->getDbTable($albumPhotoOption.'s', 'eclassroom')->$nameFunction();
