 ...
 */
class Eclassroom_Widget_ClassroomReviewsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_ajax) {
      ...
      if (!Engine_Api::_()->sesbasic()->getViewerPrivacy('eclass_review', 'view'))
        return $this->setNoRender();
      $this->view->isReview = $hasReview = $reviewTable->isReview(array('classroom_id' => $subject->getIdentity(), 'column_name' => 'review_id'));
      $this->view->cancreate = Engine_Api::_()->sesbasic()->getViewerPrivacy('eclass_review', 'create');
      if ($hasReview && Engine_Api::_()->sesbasic()->getViewerPrivacy('eclass_review', 'edit')) {
        ...
        $this->view->form = $form = new Eclassroom_Form_Review_Create(array( 'reviewId' => $reviewObject->review_id, 'classroomItem' =>$subject,'widgetId'=>$widgetId));
        ...
        $this->view->form = $form = new Eclassroom_Form_Review_Create(array('classroomItem' =>$subject,'widgetId'=>$widgetId));
      }
    }
    ...
    $this->view->classroom_id = $params['classroom_id'] = isset($_POST['classroom_id']) ? $_POST['classroom_id'] : $subject->getIdentity();
