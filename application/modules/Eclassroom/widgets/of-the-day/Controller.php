 ...
 */
class Eclassroom_Widget_OfTheDayController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $classroomId = Engine_Api::_()->getDbTable('classrooms', 'eclassroom')->getOfTheDayResults(false,array('classroom_id'));
    $this->view->classroom_id = $classroomId->classroom_id;
