...
?>
  ...
  <div class="classroom_browse_search eclassroom_browse_search_horizontal eclassroom_dashboard_search_form">
  	<?php echo $this->form->render($this); ?>
	</div>
<div class="classroom_dashboard_table_right_links">
	<a href="javascript:;"  class="eclassroom_report_download sesbasic_button" data-rel="csv"><i class="fa fa-download sesbasic_text_light"></i><?php echo $this->translate("Download Report in CSV"); ?></a>
  <a href="javascript:;" class="eclassroom_report_download sesbasic_button" data-rel="excel"><i class="fa fa-download sesbasic_text_light"></i><?php echo $this->translate("Download Report in Excel"); ?></a>
</div>
<?php if( isset($this->classroomSaleData) && count($this->classroomSaleData) > 0): ?>
  ...
  <form method="post" >
    <table>
      ...
      <tbody>
        <?php 
        	$counter = 1;
          foreach ($this->classroomSaleData as $item): ?>
        <tr>
...
sesJqueryObject(document).on('click','.eclassroom_report_download',function(){
	...
	sesJqueryObject('#eclassroom_search_form_sale_report').trigger('submit');
