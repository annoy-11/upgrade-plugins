 ...
 * @version    $Id: editservice.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
...
<script type="application/javascript">
  ...
  function submitService(formObject) {
    ...
    sesJqueryObject.ajax({
      url: "eclassroom/dashboard/editservice/",
      type: "POST",
      contentType:false,
      processData: false,
      cache: false,
      ...
      success: function(response) {
        ...
        if(result.status == 1) {
          ...
          sesJqueryObject('#sessmoothbox_container').html("<div id='servicesuccess_message' class='classroomservice_success_message servicesuccess_message'><i class='fa-check-circle-o'></i><span><?php echo $this->translate("Your service is successfully added."); ?></span></div>");
