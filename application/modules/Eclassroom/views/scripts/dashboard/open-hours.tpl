 ...
 * @version    $Id: open-hours.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
 
?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Eclassroom/externals/styles/jquery.timepicker.min.css'); ?>
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Eclassroom/externals/scripts/jquery-timepicker.js'); ?>
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Courses/externals/scripts/jquery.timepicker.min.js'); ?>
<?php if(!$this->is_ajax){ 
...
?><?php $hoursData = $this->hoursData; ?>
  <div class="classroom_db_manage_hours classroom_dashboard_form">
  	<form class="global_form" method="post">
    	<div>
      	<div>
        	<h3><?php echo $this->translate('Edit your details'); ?></h3>
          <div class="form-elements">
            <div class="form-wrapper">
              <div class="form-label"><label><?php echo $this->translate('Hours'); ?></label></div>
              <div class="form-element">
                <ul class="form-options-wrapper">
                  <li><input type="radio" name="hours" <?php echo !empty($hoursData['type']) && $hoursData['type'] == "selected" ? "checked='checked'" : (empty($hoursData['type']) ? "checked='checked'" : "" ); ?>  value="selected"><label><?php echo $this->translate('Open on selected hours'); ?></label></li>
                  <li><input type="radio" name="hours" <?php echo !empty($hoursData['type']) && $hoursData['type'] == "always" ? "checked='checked'" :  "" ?> value="always"><label><?php echo $this->translate('Always open'); ?></label></li>
                  <li><input type="radio" name="hours" <?php echo !empty($hoursData['type']) && $hoursData['type'] == "notavailable" ? "checked='checked'" :  "" ?>  value="notavailable"><label><?php echo $this->translate('No hours available'); ?></label></li>
                  <li><input type="radio" name="hours" <?php echo !empty($hoursData['type']) && $hoursData['type'] == "closed" ? "checked='checked'" :  "" ?>  value="closed"><label><?php echo $this->translate('Permanently closed'); ?></label></li>
                </ul>
              </div>
            </div>
            <div class="form-wrapper classroom_choose_day_wrapper">
              ...
              <div class="form-element">
                ...
                ?>              
                <div> 
                  <label><?php echo $this->translate('Timezone:'); ?></label> 
                ...
                <br>
                  ...
                  <label for="mon"><?php echo $this->translate('Monday'); ?></label>
                ...
                <div class="_day">
                  ...
                  <label for="tue"><?php echo $this->translate('Tuesday'); ?></label>
                ...
                <div class="_day">
                  ...
                  <label for="wed"><?php echo $this->translate('Wednesday'); ?></label>
                ...
                <div class="_day">
                  ...
                  <label for="thur"><?php echo $this->translate('Thursday'); ?></label>
                ...
                <div class="_day">
                  ...
                  <label for="fri"><?php echo $this->translate('Friday'); ?></label>
                ...
                <div class="_day">
                  ...
                  <label for="sun"><?php echo $this->translate('Sunday'); ?></label>
...
sesJqueryObject('input[type=radio][name=hours]').change(function() {
  ...
  if(value != "selected"){
     sesJqueryObject('.classroom_choose_day_wrapper').hide();
  }else{
     sesJqueryObject('.classroom_choose_day_wrapper').show();
  }
});
...
sesJqueryObject(document).on('click','.addbtn',function(e){
  ...
  parent.append(html);
  eclassroomTimePickerJqueryObject('input.timepicker').timepicker();
});
...
})(eclassroomTimePickerJqueryObject);
</script>
