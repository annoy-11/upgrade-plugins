  ...
  function makeEditorRich() {
    ...
    <div class="classroom_dashboard_content_header">
      <h3><?php echo $this->translate('Manage Announcements') ?></h3>
    	<p><?php echo $this->translate('Here, you can create announcements to post them on the Classroom Profile. You can also edit and delete the announcements listed on this classroom.') ?></p>
    </div>
    <br />
    <div class="classroom_dashboard_content_btns">
      <a href="<?php echo $this->url(array('classroom_id' => $this->classroom->custom_url,'action'=>'post-announcement'), 'eclassroom_dashboard', true); ?>" class="sessmoothbox sesbasic_button" style="display:inline-block;"><i class="fa fa-bullhorn"></i><span><?php echo $this->translate("Post New Announcement");?></span></a>
    </div>  
       <br />
  <?php if($this->paginator->getTotalItemCount()!=0): ?>
    <div class="classroom_dashboard_results"><?php echo $this->translate('%d announcements total', $this->paginator->getTotalItemCount()) ?></div>
  <?php endif;?>
  <?php echo $this->paginationControl($this->paginator); ?>
<?php if( count($this->paginator) ): ?>
  <div class="classroom_dashboard_table">
  ...
  <div class='eclassroom_dashboard_content_btns'>
