...
<script type="text/javascript">
  sesJqueryObject(document).on('change','#memberrole_id',function(){
      window.location.href =   en4.core.baseUrl + 'admin/eclassroom/settings/roles/member_roles/'+sesJqueryObject(this).val();
  });
 sesJqueryObject('<div class="sesbasic_search_reasult"><a href="admin/eclassroom/settings/roles-create" class="buttonlink sesbasic_icon_add smoothbox">Create Classroom Role</a></div>').insertAfter('.form-description');
