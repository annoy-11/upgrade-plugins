...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <div class="sesbasic-form-cont">
      ...
      <p class="description">Classroom categories can be managed here. To create new categories, use "Add New Category" form below. Below, you can also choose Slug URL, Title, Description, Profile Type to be associated with the category, Icon and Thumbnail. You can also map Categories with the Profile Types, so that questions belonging to the mapped Profile Type will appear to users while creating / editing Classrooms when they choose the associated Category.<br /><br />To create 2nd-level categories and 3rd-level categories, choose respective 1st-level and 2nd-level category from “Parent Category” dropdown below. Choose this carefully as you will not be able to edit Parent Category later</p>
        ...
        <form id="addcategory" method="post" enctype="multipart/form-data">
            ...
            <div class="sesbasic-form-field-element">
              <select name="parent" id="parent" class="postform">
               ...
               <?php foreach ($this->categories as $category): ?>
                ...
                <?php 
                  $subcategory = Engine_Api::_()->getDbTable('categories', 'eclassroom')->getModuleSubcategory(array('column_name' => "*", 'category_id' => $category->category_id));  foreach ($subcategory as $sub_category):  
                ?>
          ...
          <div class="sesbasic-form-field">
            ...
            <div class="sesbasic-form-field-element">
              ...
              <p>This will be category color & will be used at various places of this plugin.</p>
            </div>
          </div>
          <div class="sesbasic-form-field">
            <div class="sesbasic-form-field-label">
          ...
          <div class="sesbasic-form-field">
            <div class="sesbasic-form-field-label">
              <label>Upload Simple Icon</label><span style="font-size: 11px;"> [Recommended size is: 40px * 40px.]</span>
            </div>
            <div class="sesbasic-form-field-element">
          ...
          <div class="form-wrapper" id="cover_photo_preview-wrapper" style="display: none;">
            ...
            <div class="form-element" id="cover_photo_preview-element">
            	<input width="50" type="image" height="50" alt="Icon" src="" id="cover_photo_preview" name="cover_photo_preview" style="object-fit: contain;">
            </div>
          </div>
          ...
          <div class="sesbasic-form-field">
            <div class="sesbasic-form-field-label">
              <label>Upload Colored Icon</label><span style="font-size: 11px;"> [Recommended size is: 40px * 40px.]</span>
            </div>
            <div class="sesbasic-form-field-element">
          ...
          <div class="form-wrapper" id="colored_icon_preview-wrapper" style="display: none;">
            ...
            <div class="form-element" id="colored_icon_preview-element">
            	<input width="50" type="image" height="50" alt="Icon" src="" id="colored_icon_preview" name="colored_icon_preview">
            </div>
          </div>
          ...
          <div class="sesbasic-form-field">
            <div class="sesbasic-form-field-label">
              <label>Upload Thumbnail Photo</label><span style="font-size: 11px;"> [Recommended size is: 500px * 300px.]</span>
            </div>
            <div class="sesbasic-form-field-element">
           ...
           <div class="form-wrapper" id="thumbnail_photo_preview-wrapper" style="display: none;">
            ...
            <div class="form-element" id="thumbnail_photo_preview-element">
            	<input width="150" type="image" height="100" alt="Thumbnail" src="" id="thumbnail_photo_preview" name="thumbnail_photo_preview"  style="object-fit: cover;"/>
            </div>
          </div>
          ...
          <table class='admin_table' style="width: 100%;">
            ...
            <tbody>
              ...
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-article-id="<?php echo $category->category_id; ?>">
                ...
                if($cat_icon) {
                $cat_icon = $cat_icon->getPhotoUrl('thumb.icon'); ?>
                  <?php if($category->cat_icon && $cat_icon): ?>
                    <img class="sesbasic-category-icon" src="<?php echo $cat_icon; ?>" />
                  <?php else: ?>
                  <?php echo "---"; ?>
                  <?php endif; ?>
                <?php } else { ?>
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'eclassroom', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $category->category_id), $this->translate('Edit'), array()) ?> 
                <?php if($category->category_id != 0){ ?>
              ...
              <tr id="categoryid-<?php echo $sub_category->category_id; ?>" data-article-id="<?php echo $sub_category->category_id; ?>">
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'eclassroom', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $sub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$sub_category->category_id)) ?> 		</td>
              </tr>
              <?php 
                		//SubSubcategory Work
                    $subsubcategory = Engine_Api::_()->getDbTable('categories', 'eclassroom')->getModuleSubsubcategory(array('column_name' => "*", 'category_id' => $sub_category->category_id));
              ...
              <tr id="categoryid-<?php echo $subsub_category->category_id; ?>" data-article-id="<?php echo $subsub_category->category_id; ?>">
                ...
                <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'eclassroom', 'controller' => 'categories', 'action' => 'edit-category', 'id' => $subsub_category->category_id), $this->translate('Edit'), array()) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subsub_category->category_id)) ?>
              </tr>
              <?php endforeach; ?>
              <?php endforeach; ?>
              <?php endforeach; ?>
...
ajaxurl = en4.core.baseUrl+"admin/eclassroom/categories/change-order";
        ...
        jqueryObjectOfSes .ajax({
            ...
            success:function(data){ console.log(data);
                ...
                parent = jqueryObjectOfSes('#parent').val();
								if ( parent > 0 && jqueryObjectOfSes('#categoryid-' + parent ).length > 0 ){ // If the parent exists on this classroom, insert it below. Else insert it at the top of the list.
								...
								jqueryObjectOfSes('#colored_icon_preview').attr('src', '');
								jqueryObjectOfSes('#colored_icon_preview-wrapper').hide();
            },
            error: function(data){
            	//silence
						}
