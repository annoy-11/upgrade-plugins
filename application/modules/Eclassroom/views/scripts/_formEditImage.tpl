 ...
 * @version    $Id: _formEditImage.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
...
<?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'externals/moolasso/Lasso.js')->appendFile($this->layout()->staticBaseUrl .'externals/moolasso/Lasso.Crop.js')
  ?>
  <div>
