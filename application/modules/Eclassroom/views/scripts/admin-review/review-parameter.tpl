    ...
    <div class="sesbasic-form-cont">
      ...
      <div class="sesbasic-categories-listing" style="width:100%">
		...
		<tr id="profile_type-<?php echo $category->getIdentity(); ?>" data-article-id="<?php echo $category->getIdentity(); ?>">
		  ...
		  <?php $reviewParameter = Engine_Api::_()->getDbtable('parameters', 'eclassroom')->getParameterResult(array('category_id'=>$category->getIdentity())); ?>
		  <td>
		    <?php $titleEAC = 'Add';?>
          ...
          <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'eclassroom', 'controller' => 'review', 'action' => 'add-parameter', 'id' => $category->getIdentity()), $this->translate($titleEAC.' Parameter'), array('class'=> "smoothbox")); ?>
        </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
