 ...
 * @version    $Id: edit-photo.tpl 2019-08-28 00:00:00 socialnetworking.solutions $
...
<script type="text/javascript">
  sesJqueryObject(document).on('click','#execute',function(e){
    ...
    request = new Request.JSON({
      'format' : 'json',
      'url' : '<?php echo $this->url(Array('controller' => 'album', 'action' => 'save-information'), 'eclassroom_extended',true) ?>/photo_id/'+photo_id,
      'data': {
        'photo_id' : photo_id,
