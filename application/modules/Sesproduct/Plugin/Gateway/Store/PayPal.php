...
class Sesproduct_Plugin_Gateway_Store_PayPal extends Engine_Payment_Plugin_Abstract
{
  ...
  public function getGateway()
  {
    if( null === $this->_gateway ) {
      ...
      $gateway = new $class(array(
        ...
        'currency' => Engine_Api::_()->sesproduct()->defaultCurrency(),
      ));
   ...
   *
	*/
  public function createOrderTransaction($order,$store,array $params = array())
  {
  ...
  {
    return new Sesproduct_Form_Admin_Gateway_PayPal();
  }
