...
class Sesproduct_Plugin_Gateway_Store_Stripe extends Engine_Payment_Plugin_Abstract {
    ...
    */
    ...
    public function createOrderTransaction($order,$course,array $params = array()) {
        ...
        $logo = $this->_gatewayInfo->config['sesadvpmnt_stripe_logo'] ?? " ";
        return \Stripe\Checkout\Session::create([
          'payment_method_types' => ['card'],
          'line_items' => [[
            'name' => $course->title,
            'description' => $order->admin_message." ",
            'images' => [$logo],
