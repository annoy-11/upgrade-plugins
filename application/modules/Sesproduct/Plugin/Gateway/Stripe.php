...
class Sesproduct_Plugin_Gateway_Stripe extends Engine_Payment_Plugin_Abstract
{
  ...
  public function createOrderTransactionReturn(Payment_Model_Order $order, array $params = array()) {
    $user = $order->getUser();
