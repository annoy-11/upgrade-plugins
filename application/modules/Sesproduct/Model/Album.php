...
class Sesproduct_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'sesproduct';

  protected $_owner_type = 'sesproduct';

  protected $_children_types = array('sesproduct_photo');

  protected $_collectible_type = 'sesproduct_photo';
 ...
 public function getHref($params = array()) {
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sesproduct/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  public function getAuthorizationItem()
  {
    ...
    return $product; //$this->getParent('sesproduct');
  }
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $sesproductPhoto ) {
      $sesproductPhoto->delete();
    }
