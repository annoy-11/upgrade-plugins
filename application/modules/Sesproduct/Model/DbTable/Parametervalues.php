 ...
 * @version    $Id: Parametervalues.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_Model_DbTable_Parametervalues extends Engine_Db_Table {
  protected $_rowClass = 'Sesproduct_Model_Parametervalue';
	protected $_name  = 'sesproduct_review_parametervalues';
	public function getParameters($params = array()){
		$pTable = Engine_Api::_()->getDbtable('parameters', 'sesproduct');
  ...
  public function getRating($parameter_id) {
    $rating_sum = $this->select()
            ...
            ->fetchColumn(0)
    ;
    $total = $this->ratingCount($parameter_id, $resource_type = 'sesproduct_event');
    if ($total)
