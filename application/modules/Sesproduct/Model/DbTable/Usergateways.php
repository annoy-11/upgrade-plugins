 ...
 * @version    $Id: Usergateways.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesproduct_Model_DbTable_Usergateways extends Engine_Db_Table
{
  protected $_rowClass = 'Sesproduct_Model_Usergateway';
  ...
  public function getEnabledGatewayCount()
  {
	...
	public function getUserGateway($params = array()){
			$select = $this->select()->from($this->info('name'))->where('store_id =?',$params['store_id']);
