...
class Sesproduct_Model_DbTable_Photos extends Engine_Db_Table
{
  protected $_rowClass = 'Sesproduct_Model_Photo';

  	public function getPhotoSelect($params = array())
  {
    $select = $this->select();

    if( !empty($params['album']) && $params['album'] instanceof Sesproduct_Model_Album ) {
