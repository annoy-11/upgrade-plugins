	...
	<?php  if((isset($this->socialSharing)  && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesproduct.enable.sharing', 1)) || isset($this->likeButton)){  ?>
	  <span class="sesproduct_album_list_grid_btns">
        ...
        <?php if(Engine_Api::_()->sesproduct()->checkProductAdmin($this->product)):?>
            ...
            <?php if(!empty($this->widgetId)){ ?>
              <?php echo $this->htmlLink($this->url(array('product_id' => $this->product->custom_url,'action'=>'manage-photos','album_id' => $album->album_id), 'sesproduct_dashboard', true), $this->translate('Manage Photos'), array('class' => 'fa fa-picture-o')); ?>
              <?php echo $this->htmlLink($this->url(array('product_id' => $this->product->custom_url,'action'=>'edit-album','album_id' => $album->album_id), 'sesproduct_dashboard', true), $this->translate('Edit Settings'), array('class' => 'fa fa-pencil')); ?>
