              ...
              <?php if(!empty($cart['products_extra'][$itemCart['cartproduct_id']]['variations'])){ ?>
                ...
                <span style="font-weight: bold;">free </span>
					...
					<div class="sesproduct_cart_action">
						...
						<a data-rel="<?php echo $item->getIdentity(); ?>" title='<?php echo $this->translate('Add to Wishlist'); ?>' href="javascript:;" class="sesproduct_wishlist"><i class="far fa-bookmark"></i><!-- <?php echo $this->translate('Add to Wishlist'); ?> --></a>
						<?php endif; ?>
