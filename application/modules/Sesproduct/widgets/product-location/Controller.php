 ...
 */
class Sesproduct_Widget_ProductLocationController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->is_ajax = $is_ajax = isset($_POST['is_ajax']) ? true : false;
		$value['limit'] = $limit = $this->_getParam('limit_data',200);
    ...
    $value['search'] = 1;
    $value['location'] = isset($searchArray['location']) ? $searchArray['location'] : (isset($_GET['location']) ? $_GET['location'] : (isset($params['location']) ? $params['location'] : $this->_getParam('location', 'world')));
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbtable('sesproducts', 'sesproduct')->getSesproductsPaginator($value, true);
    $paginator->setItemCountPerPage($limit);
    $paginator->setCurrentPageNumber(1);
    $this->view->widgetName = 'product-location';
  }
