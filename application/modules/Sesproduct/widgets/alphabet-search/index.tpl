...
<div class="sesbasic_alphabetic_search">
    <?php if($this->controller != "wishlist"){ ?>
      <?php $URL =  $this->url(array('action' => 'browse'), 'sesproduct_general', true); ?>
    <?php }else{ ?>
      <?php $URL =  $this->url(array('action' => 'browse'), 'sesproduct_wishlist', true); ?>
    <?php } ?>
