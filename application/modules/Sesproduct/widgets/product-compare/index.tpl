          ...
          <td>
            ...
            <a href="<?php echo $product->getHref(); ?>">
                ...
                <?php if(count($this->products) > 2) { ?>
                  <a href="javascript:;" class="" data-rel="<?php echo $product->getIdentity() ?>"><span class="sesproduct_remove_conpare compare_close"><i class="fa fa-times"></i></span></a>
                <?php } ?>
            ...
            <?php if(isset($this->addCartActive)) { ?>
                <div class="product_compare_action sesproduct_add_cart">
                    <?php echo $this->partial('_addToCart.tpl','sesproduct',array('item'=>$product)); ?>
                        ...
                        <a href="javascript:void(0)" data-rel="<?php echo $item->getIdentity(); ?>" class="sesproduct_wishlist" data-rel="<?php echo $item->getIdentity(); ?>" title="<?php echo $this->translate('Add to Wishlist'); ?>"><i class="far fa-bookmark"></i>
                        </a>
                    <?php endif; ?>
                </div>
            <?php } ?>
