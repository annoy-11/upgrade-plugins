 ...
 */
class Sesproduct_Widget_BrowseProductsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $form = new Sesproduct_Form_Search(array('searchTitle' => 'yes','browseBy' => 'yes','categoriesSearch' => 'yes','searchFor'=>'product','FriendsSearch'=>'yes','defaultSearchtype'=>'mostSPliked','locationSearch' => 'yes','kilometerMiles' => 'yes','hasPhoto' => 'yes'));
   ...
   $this->view->height = $this->view->height_list = $defaultHeightList = isset($params['height_list']) ? $params['height_list'] : $this->_getParam('height_list','160');
    ...
    $value['moduleName'] = $request->getModuleName();
    $value['controllerName'] = $request->getControllerName();
    ...
    $this->view->limit_data_pinboard = $limit = $limit_data_pinboard = isset($params['limit_data_pinboard']) ? $params['limit_data_pinboard'] : $this->_getParam('limit_data_pinboard', '10');
    $this->view->limit_data_grid = $limit = $limit_data_grid = isset($params['limit_data_grid']) ? $params['limit_data_grid'] : $this->_getParam('limit_data_grid', '10');
    $this->view->limit_data_list = $limit = $limit_data_list = isset($params['limit_data_list']) ? $params['limit_data_list'] : $this->_getParam('limit_data_list', '10');
    $this->view->limit_data_map = $limit = $limit_data_map = isset($params['limit_data_map']) ? $params['limit_data_map'] : $this->_getParam('limit_data_map', '10');
    ...
    $value['status'] = 1;
    $value['search'] = 1;
    $this->view->widgetName = 'browse-products';
    if($value['moduleName'] == 'core') {
      unset($value['text']);
      $params = array_merge($params, $value, array('tag' => Engine_Api::_()->getDbTable('tags', 'core')->getTagId($text)));
    } else {
    ...
    $value['draft'] = "0";
    $value['visible'] = "1";
    $params['text'] = isset($form->getValues()['search']) ? $form->getValues()['search'] : $params['text'];
    // Get products
    $paginator = Engine_Api::_()->getDbtable('sesproducts', 'sesproduct')->getSesproductsPaginator(array_merge($params, $form->getValues()));
