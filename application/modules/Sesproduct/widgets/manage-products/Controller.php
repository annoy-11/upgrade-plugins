 ...
 */
class Sesproduct_Widget_ManageProductsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (!$is_ajax && is_array($defaultOptionsArray)) {
      foreach ($defaultOptionsArray as $key => $defaultValue) {
				if(!Engine_Api::_()->getApi('settings', 'core')->getSetting('sesproduct.enable.favourite', 1) && $defaultValue == 'mostSPfavourite')
					continue;
    ...
    $this->view->widgetName = 'manage-products';
