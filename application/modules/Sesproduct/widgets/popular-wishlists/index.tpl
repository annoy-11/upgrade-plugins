          ...
          <div>
            ...
            <div class="sesvideo_playlist_grid_stats sesvideo_list_stats sesbasic_text_light">
              ...
              <?php if (!empty($this->information) && in_array('videoCount', $this->information)): ?>
                <span title="<?php echo $this->translate(array('%s product', '%s products', $item->product_count), $this->locale()->toNumber($item->product_count)); ?>"><i class="fa fa-shopping-bag fa-video-camera"></i><?php echo $item->product_count; ?></span>
              <?php endif; ?>
            </div>
          </div>
        </div>
