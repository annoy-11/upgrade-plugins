...
class Sesproduct_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract
{
  public function indexAction() {
    ...
    $this->view->search_for = $search_for = $this-> _getParam('search_for', 'product');
    ...
    $searchForm = $this->view->form = new Sesproduct_Form_Search(array('searchTitle' => $this->_getParam('search_title', 'yes'),'browseBy' => $this->_getParam('browse_by', 'yes'),'categoriesSearch' => $this->_getParam('categories', 'yes'),'searchFor'=>$search_for,'FriendsSearch'=>$this->_getParam('friend_show', 'yes'),'defaultSearchtype'=>$default_search_type,'locationSearch' => $location,'kilometerMiles' => $this->_getParam('kilometer_miles', 'yes'),'price' => $this->_getParam('price', 'yes'),'discount' => $this->_getParam('discount', 'yes'),'hasPhoto' => $this->_getParam('has_photo', 'yes')));
    ...
    $page_id = Engine_Api::_()->sesproduct()->getWidgetPageId($this->view->identity);
    if($page_id) {
