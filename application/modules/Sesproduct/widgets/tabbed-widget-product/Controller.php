 ...
 */
class Sesproduct_Widget_tabbedWidgetProductController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sesproduct_tabbed = Zend_Registry::isRegistered('sesproduct_tabbed') ? Zend_Registry::get('sesproduct_tabbed') : null;
    ...
    $this->view->limit_data_map = $limit_data_map = isset($params['limit_data_map']) ? $params['limit_data_map'] : $this->_getParam('limit_data_map', '10');
    ...
    $this->view->widgetName = 'tabbed-widget-product';
