...
<!--Advance Tabs-->
    ...
    <?php } ?>
    	<ul id="tab-widget-sesproduct-<?php echo $randonNumber; ?>">
       <?php 
...
<?php include APPLICATION_PATH . '/application/modules/Sesproduct/views/scripts/_showProductListGrid.tpl'; ?>
  ...
  <script type="application/javascript"> 
	...
	requestTab_<?php echo $randonNumber; ?> = new Request.HTML({
	  ...
	  onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
	    ...
	    if(document.getElementById('sesproduct_pinboard_view_<?php echo $randonNumber;?>') && sesJqueryObject('.sesbasic_view_type_options_<?php echo $randonNumber; ?>').find('.active').attr('rel') == 'pinboard') {
	      if(document.getElementById('sesproduct_pinboard_view_<?php echo $randonNumber;?>'))
	      document.getElementById('sesproduct_pinboard_view_<?php echo $randonNumber;?>').style.display = 'block';
