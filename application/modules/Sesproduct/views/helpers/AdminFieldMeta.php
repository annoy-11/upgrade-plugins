 ...
 * @version    $Id: AdminFieldMeta.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_View_Helper_AdminFieldMeta extends Zend_View_Helper_Abstract
{
...
EOF;
        foreach( $options as $option ) {
          ...
          $attributeHtml = "";
          if($meta->type != "select")
          $attributeHtml = "&nbsp;&nbsp;&nbsp;&nbsp;".($option->type == 1 ? '+' : '-').Engine_Api::_()->sesproduct()->getCurrencyPrice($option->price,Engine_Api::_()->estore()->getCurrentCurrency(),'');
        ...
        <li id="field_option_select_{$key}_{$optionId}" class="{$optionClass}">
          ...
          <span class="field_extraoptions_choices_label" onclick="void(0);">
            {$optionLabel} {$attributeHtml} {$dependentFieldCountString}
          </span>
        </li>
EOF;
        }
