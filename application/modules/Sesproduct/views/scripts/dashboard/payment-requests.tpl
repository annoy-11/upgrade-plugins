        ...
        <tr>
          ...
          <td class="table_options">
          	<?php if ($item->state == 'pending'){ ?>
                <?php echo $this->htmlLink($this->url(array('event_id' => $this->event->custom_url,'action'=>'payment-request','id'=>$item->userpayrequest_id), 'sesevent_dashboard', true), $this->translate(""), array('class' => 'openSmoothbox fa fa-edit','title'=>$this->translate("Edit Request"))); ?>
