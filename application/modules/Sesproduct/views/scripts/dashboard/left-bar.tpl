      ...
      <ul class="sesbm"> 
        <li class="sesbm">
          ...
          <ul class="sesbm _innersesbm">
            ...
            <li><a href="<?php echo $this->url(array('product_id' => $this->product->custom_url,'action'=>'attributes'), 'sesproduct_cartproducts', true); ?>" class="dashboard_a_link" ><i class="fa fa-file-o"></i> <?php echo $this->translate($attribute->title); ?></a></li>
            <?php endif; ?>
            ...
            <li><a href="<?php echo $this->url(array('product_id' => $this->product->custom_url,'action'=>'edit-photo'), 'sesproduct_dashboard', true); ?>" class="dashboard_a_link" ><i class="fa fa-photo"></i> <?php echo $this->translate($edit_photo->title); ?></a></li>
            <?php endif; ?>
            
            <?php if(!empty($slideshow) && $slideshow->enabled): ?>
            <li><a href="<?php echo $this->url(array('product_id' => $this->product->custom_url,'action'=>'slideshow'), 'sesproduct_dashboard', true); ?>" class="dashboard_a_link" ><i class="fa fa-picture-o"></i> <?php echo $this->translate($slideshow->title); ?></a></li>
            <?php endif; ?>
            ...
            <li><a href="<?php echo $this->url(array('product_id' => $this->product->custom_url,'action'=>'upgrade'), 'sesproduct_dashboard', true); ?>" class="dashboard_a_link" ><i class="fa fa-refresh "></i> <?php echo $this->translate($upgrade->title); ?></a></li>
            <?php endif; ?>
            ...
            <li><a href="<?php echo $this->url(array('product_id' => $this->product->custom_url, 'action'=>'seo'), 'sesproduct_dashboard', true); ?>" class="sesbasic_dashboard_nopropagate_content dashboard_a_link"><i class="fa fa-file-text"></i> <?php echo $this->translate($seo->title); ?></a></li>
            <?php endif; ?>
            
            <?php if(@$style->enabled): ?>
            <li><a  href="<?php echo $this->url(array('product_id' => $this->product->custom_url, 'action'=>'style'), 'sesproduct_dashboard', true); ?>" class="sesbasic_dashboard_nopropagate_content dashboard_a_link"><i class="fa fa-pencil "></i> <?php echo $this->translate($style->title); ?></a></li>
            <?php endif; ?>
