...
<div class="layout_middle">
  <div class="sesevent_ticket_order_page sesbasic_bxs generic_layout_container layout_core_content"> 
    ...
    <div class="sesevent_ticket_order_page_left">
      <h3><?php echo $this->translate("Product Owner Details"); ?></h3>  
      <div class="sesevent_ticket_order_details">
        <div class="sesevent_ticket_order_form_hint_txt"><?php echo $this->translate("Enter Attendee Information for each Tickets. Fields that are marked (*) are mandatory."); ?></div>
       <!-- OWNER INFO -->
          ...
          <div class="sesevent_ticket_order_details_box_fields sesbm sesbasic_clearfix">
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="ownerFname"><?php echo $this->translate("First Name"); ?> <span class="required">*</span></label>
              </div>
            ...
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="ownerLname"><?php echo $this->translate("Last Name"); ?> <span class="required">*</span></label>
              </div>
              <div class="sesevent_ticket_order_ticket_info_element">
            ...
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="ownerMobile"><?php echo $this->translate("Mobile"); ?> <span class="required">*</span></label>
              </div>
              <div class="sesevent_ticket_order_ticket_info_element">
                <input id="ownerMobile" type="text" name="ownerMobile" value="" />
              </div>
            </div>
            
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="ownerEmail"><?php echo $this->translate("Email"); ?> <span class="required">*</span></label>
              </div>
              <div class="sesevent_ticket_order_ticket_info_element">
             ...
             <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label" style="width:100%">
                <label for="allowCdetails"><input id="allowCdetails" name="eventTC" type="checkbox" value="1"><?php echo $this->translate("Do you need invoice"); ?></label>
              </div>
            </div><br />
            <script type="application/javascript">
            	sesJqueryObject('#allowCdetails').click(function(e){
								if(sesJqueryObject('#allowCdetails').prop('checked')) {
										sesJqueryObject("#cdetaIn").show();
								} else {
										sesJqueryObject("#cdetaIn").hide();
										sesJqueryObject("#ownerCdetail").val('');
								}
							});
            </script>
            
            <div class="sesevent_ticket_order_ticket_info" id="cdetaIn" style="display:none">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="ownerCdetail"><?php echo $this->translate("Company Title"); ?></label>
              </div>
              <div class="sesevent_ticket_order_ticket_info_element">
                <input id="ownerCdetail" type="text" name="ownerCdetail" value="" />
              </div>
            </div>
       ...
       <div class="sesevent_ticket_order_page_checkbox">
        <label for="fillDt">
          ...
          <span> <?php echo $this->translate("Fill Ticket detail same as owner"); ?></span>
        </label>
      </div>
      <form name="ticket" id="ticketDtEvn" method="post" action="<?php echo $this->url(array('event_id' => $this->event->custom_url,'controller'=>'order','order_id'=>$this->order->order_id,'action'=>'checkout'), 'sesevent_order', true); ?>">
       <?php foreach($this->ticketDetail->toArray() as $valTicket){ ?>
          ...
          <div class="sesevent_ticket_order_details_box_fields sesbm sesbasic_clearfix">
            ...
            <div class="sesevent_ticket_order_ticket_info">
              ...
              <div class="sesevent_ticket_order_ticket_info_element">
                ...
                <span class="required noDisp errormsg"><?php echo $this->translate("Please enter first name."); ?></span>
              </div>
            </div>
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
            ...
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="<?php echo 'email'.($i+1+$valTicket['ticket_id']); ?>"><?php echo $this->translate("Email"); ?> <span class="required">*</span></label>
              </div>
              <div class="sesevent_ticket_order_ticket_info_element">
                ...
                <span class="required noDisp errormsg"><?php echo $this->translate("Please enter valid email."); ?></span>
              </div>
            </div>
            <div class="sesevent_ticket_order_ticket_info">
              <div class="sesevent_ticket_order_ticket_info_label">
                <label for="<?php echo 'mobile'.($i+1+$valTicket['ticket_id']); ?>"><?php echo $this->translate("Mobile"); ?> <span class="required">*</span></label>
              </div>
              <div class="sesevent_ticket_order_ticket_info_element">
                <input id="<?php echo 'mobile'.($i+1+$valTicket['ticket_id']); ?>" type="text" class="ticket_owner_mobile" name="mobile[<?php echo $valTicket['ticket_id']; ?>][<?php echo $i+1; ?>]" value="" /><br />
                <span class="required noDisp errormsg"><?php echo $this->translate("Please enter valid mobile."); ?></span>
              </div>
            </div>
          </div>
         <?php } ?>
        ...
        <div style="display:none">
         	<input type="hidden" name="fname_owner" id="fname_owner" />
        	<input type="hidden" name="lname_owner" id="lname_owner" />
          <input type="hidden" name="email_owner" id="email_owner" />
          <input type="hidden" name="mobile_owner" id="mobile_owner" />
          <input type="hidden" name="isDetail_owner" id="isDetail_owner" />
          <input type="hidden" name="cdetails_owner" id="cdetails_owner" />
         </div>
