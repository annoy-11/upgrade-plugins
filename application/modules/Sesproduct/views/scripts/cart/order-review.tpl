...
$item = Engine_Api::_()->getItem('sesproduct',$itemCart['product_id']);
    ...
    <div class="sesproduct_cart_item">
      ...
      <div class="sesproduct_cart_action" style="margin-top:20px;display: none;">
        ...
        <?php endif; ?>
        <a href="javascript:;" title='<?php echo $this->translate("Remove"); ?>' onclick="Smoothbox.open('<?php echo $this->url(array('action'=>'delete-cart','id'=>$itemCart["cartproduct_id"]),'sesproduct_cart',true); ?>')"><i class="fa fa-times"></i><?php echo $this->translate("Remove"); ?></a>
      </div>
