 ...
 */
 ...
 ?>
<div class="sesproduct_edit_location_popup">
...
<script type="text/javascript">
  ...
  sesJqueryObject('#ses_location_data_list').html('<?php echo $this->product->location; ?>');
  sesJqueryObject('#ses_location-wrapper').css('display','none');
  <?php if($this->type == 'product_location'){ ?>
