 ...
 * @version    $Id: link-product.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    var id = '<?php echo $this->product_id; ?>';
    
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesproduct/index/link-product/product_id/' + id ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate('Stores in which you can link to product') ?>
...
<?php endif; ?>
    ...
    <?php if (count($this->paginator) > 0) : ?>
      <form id='link_product' name="link_product" method="post" action="<?php echo $this->url();?>">
	...
	<?php endforeach; ?>
        <div class='buttons'>
	  <button type='submit'><?php echo $this->translate("Link Product") ?></button>
        </div>
      </form><br />
    <?php endif; ?>     
