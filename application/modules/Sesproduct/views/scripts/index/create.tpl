...
<?php } ?>
  ...
  function showPreview(value) {
    if(value == 1)
    en4.core.showError('<div class="sesproduct_design_popup"><a class="sesproduct_icon_close"><i class="fa fa-close"></i></a> <p class="popup_design_title">'+en4.core.language.translate("Design 1")+'</p><img class="popup_img" src="./application/modules/Sesproduct/externals/images/layout_1.jpg" alt="" /></div>');
    else if(value == 2)
    en4.core.showError('<div class="sesproduct_design_popup"><a class="sesproduct_icon_close"><i class="fa fa-close"></i></a> <p class="popup_design_title">'+en4.core.language.translate("Design 2")+'</p><img src="./application/modules/Sesproduct/externals/images/layout_2.jpg" alt="" /></div>');
    else if(value == 3)
    en4.core.showError('<div class="sesproduct_design_popup"><a class="sesproduct_icon_close"><i class="fa fa-close"></i></a> <p class="popup_design_title">'+en4.core.language.translate("Design 3")+'</p><img src="./application/modules/Sesproduct/externals/images/layout_3.jpg" alt="" /></div>');
    else if(value == 4)
    en4.core.showError('<div class="sesproduct_design_popup"><a class="sesproduct_icon_close"><i class="fa fa-close"></i></a> <p class="popup_design_title">'+en4.core.language.translate("Design 4")+'</p><img src="./application/modules/Sesproduct/externals/images/layout_4.jpg" alt="" /></div>');
    return;
  }
