	...
	<!--REVIEW SECTION-->
 	...
 	<div class="sesproduct_static_list_group sesbasic_clearfix sesbasic_bxs">
		<div class="sesproduct_desc_stats sesbasic_text_light">
			...
			<span title="<?php echo $this->translate(array('%s comment', '%s comments', $item->comment_count), $this->locale()->toNumber($item->comment_count))?>"><i class="sesbasic_icon_like_o"></i><?php echo $item->comment_count;?></span>
			<?php } ?>
