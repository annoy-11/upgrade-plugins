 ...
 * @version    $Id: add-parameter.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
...
<div class='clear'>
  <div class='settings global_form_popup estore_parameter_popup'>
    <?php echo $this->form->render($this); ?>
  </div>
</div>
<script type="application/javascript">
  var alreadyaddedParameter = sesJqueryObject('.sesproduct_added_parameter');
