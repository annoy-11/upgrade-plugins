 ...
 * @version    $Id: review-parameter.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
    ...
    <div class="sesbasic-form-cont">
      ...
      <div class="sesbasic-categories-listing" style="width:100%">
		...
		<th><?php echo $this->translate("Options") ?></th>
            ...
            <tbody>
              <?php foreach ($this->topLevelOptions as $category):?>
		<tr id="profile_type-<?php echo $category->getIdentity(); ?>" data-article-id="<?php echo $category->getIdentity(); ?>">
		  <td>
		    <?php echo $category->category_name; ?>
		    <div class="hidden" style="display:none" id="inline_<?php echo $category; ?>">
		      <div class="parent">0</div>
		    </div>
		  </td>
		  <?php $reviewParameter = Engine_Api::_()->getDbtable('parameters', 'sesproduct')->getParameterResult(array('category_id'=>$category->getIdentity())); ?>
		  <td>
		    <?php $titleEAC = 'Add';?>
		  ...
		  <td><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesproduct', 'controller' => 'review', 'action' => 'add-parameter', 'id' => $category->getIdentity()), $this->translate($titleEAC.' Parameter'), array('class'=> "smoothbox")); ?>
		</tr>
              <?php endforeach; ?>
            </tbody>
          </table>
