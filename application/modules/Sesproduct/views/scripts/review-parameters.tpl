 ...
 * @version    $Id: review-parameters.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
 
 ?>
<?php $reviewParameters = Engine_Api::_()->getDbtable('parameters', 'sesproduct')->getParameterResult(array('category_id'=>$this->product->category_id));?>
<?php if(count($reviewParameters)):?>
  <?php foreach($reviewParameters as $value):?>
    <div class="form-wrapper sesproduct_form_review_star">
      <div class="form-label"><label><?php echo $this->translate($value['title']); ?></label></div>
      <div id="sesproduct_review_rating" class="sesbasic_rating_parameter sesproduct_rating_star_element" onmouseout="rating_out_review(<?php echo $value['parameter_id'] ?>);">
...
<script type="text/javascript">
  ...
  window.addEvent('domready', function() { 
    var countExistsParam = sesJqueryObject('.sesproduct_review_values');
