...
<li class="sesproduct_list_product_view sesbasic_clearfix sesbasic_bxs">
    ...
    <?php if(isset($this->featuredLabelActive) || isset($this->sponsoredLabelActive)):?>
    	<div class="sesproduct_labels ">
      	<?php  if(isset($this->featuredLabelActive) && $item->featured == 1):?>
      		<span class="sesproduct_label_featured"> <i class="fa fa-star" title="Featured"></i> </span>
      	<?php endif;?>
        <?php if(isset($this->sponsoredLabelActive) && $item->sponsored == 1):?>
        	<span class="sesproduct_label_sponsored"> <i class="fa fa-star" title="Sponsored"></i> </span>
        <?php endif;?>
    	</div>
    <?php endif;?>
  ...
  <?php } ?>
    ...
    <div class="sesproduct_options_buttons sesproduct_list_options sesbasic_clearfix">
      ...
      <a href="<?php echo $this->url(array('action' => 'edit', 'product_id' => $item->product_id), 'sesproduct_specific', true); ?>" class="sesbasic_icon_btn" title="<?php echo $this->translate('Edit Product'); ?>"> <i class="fa fa-pencil"></i> </a>
      <?php } ?>
      <?php if ($this->can_delete){ ?>
      <a href="<?php echo $this->url(array('action' => 'delete', 'product_id' => $item->product_id), 'sesproduct_specific', true); ?>" class="sesbasic_icon_btn" title="<?php echo $this->translate('Delete Product'); ?>" onclick='opensmoothboxurl(this.href);return false;'> <i class="fa fa-trash"></i> </a>
      <?php } ?>
    </div>
    <?php } ?>
  </div>
  <div class="sesproduct_listview_right">
   <?php if(isset($this->stockActive)){ ?>
    ...
    <!-- <div class="sesproduct_product_offers sesbasic_clearfix">
      <span class="offer">Offer</span> <span>No Cost EMI</span>
    </div> -->
    <?php } ?>
  </div>
</li>
