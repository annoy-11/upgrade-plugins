 ...
 * @version    $Id: manage.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
				    ...
				    <table class='admin_table'>
				      ...
				      <tbody>
				        ...
				        <tr>
				          ...
				          <td>
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesproduct', 'controller' => 'admin-manage-review', 'action' => 'view', 'id' => $item->review_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
				            |
				            <?php echo $this->htmlLink($item->getHref(), $this->translate("View"), array('class' => '')); ?>
				            |
				            <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesproduct', 'controller' => 'admin-manage-review', 'action' => 'delete-review', 'id' => $item->review_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
				          </td>
				        </tr>
				        <?php endforeach; ?>
				      </tbody>
