 ...
 * @version    $Id: SesproductFieldValueLoop.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_View_Helper_SesproductFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function sesproductFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'sesproduct' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
