 ...
 * @version    $Id: CategoryMapping.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_Form_Admin_Review_CategoryMapping extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($topStructure) == 1 && $topStructure[0]->getChild()->type == 'profile_type') {
      ...
      $options = $profileTypeField->getElementParams('sesproductreview');
