 ...
 * @version    $Id: Filter.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $filterform = new Engine_Form(array(
        'description' => 'Price',
    ...
    $filterform->addElement('Text', 'price_min', array('placeholder'=>'min'));
    $filterform->addElement('Text', 'price_max', array('placeholder'=>'max'));
    $this->addSubForm($filterform, 'price');

//        $this->addElement('Text', 'product_type', array(
//         'label' => 'Product Type',
//         'placeholder' => 'Enter Brand Name',
//         'decorators' => array(
//             'ViewHelper',
...
//     ));
    ...
    $categories = Engine_Api::_()->getDbTable('categories', 'sesproduct')->getCategory(array('column_name' => array('category_id', 'category_name')));
    ...
    $this->addElement('Select', 'stock', array(
        'label' => "Stock",
        'required' => true,
        'multiOptions' => array("" => 'Select', "1" => "In Stock", "0" => "Out of Stock"),
        'decorators' => array(
            'ViewHelper',
            array('Label', array('tag' => null, 'placement' => 'PREPEND')),
            array('HtmlTag', array('tag' => 'div'))
