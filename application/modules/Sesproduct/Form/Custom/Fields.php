 ...
 */
class Sesproduct_Form_Custom_Fields extends Engine_Form {
  /* Custom */
    ...
    if (!empty($this->_topLevelId))
      $selected[$this->_topLevelId] = $this->_topLevelValue;
		if(isset($_POST['category_id']) && $_POST['category_id'] != 0){
			$category_map_id_data	=  Engine_Api::_()->getDbtable('categories', 'sesproduct')->getMapId($_POST['category_id']);
		...
		if(isset($_POST['subcat_id']) && $_POST['subcat_id'] != 0){
			$subcategory_map_id_data	=  Engine_Api::_()->getDbtable('categories', 'sesproduct')->getSubCatMapId($_POST['subcat_id']);
		...
		if(isset($_POST['subsubcat_id'])  && $_POST['subsubcat_id'] != 0){
			$subsubcategory_map_id_data	=  Engine_Api::_()->getDbtable('categories', 'sesproduct')->getSubSubCatMapId($_POST['subsubcat_id']);
