 ...
 * @version    $Id: Dashboardfields.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesproduct_Form_Custom_Dashboardfields extends Engine_Form {
  /* Custom */
  ...
  public function generate() {
    ...
    $orderIndex = 0;
		$package = Engine_Api::_()->getItem('sesproductpackage_package',$this->getItem()->package_id);
