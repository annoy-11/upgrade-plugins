...
class Sesproduct_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'sesproduct', 'controller' => 'index', 'action' => 'browse'), 'default', true));
    ...
    if ($this->_locationSearch == 'yes' && $this->getSearchFor() == 'product') {
    ...
    if ($this->getPrice() == 'yes') {
       $this->addElement('dummy', 'price_range', array(
       'label' => 'Price Range',
        'decorators' => array(array('ViewScript', array(
                                    'viewScript' => 'application/modules/Sesproduct/views/scripts/_customPriceRang.tpl',
                                    'class' => 'form element',
                            ))),
        ));
