 ...
 * @version    $Id: IpnController.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_IpnController extends Core_Controller_Action_Standard {
  ...
  public function __call($method, array $arguments) {
    ...
    // Log ipn
    $ipnLogFile = APPLICATION_PATH . '/temporary/log/sesproduct-ipn.log';
    ...
    try {
      ...
      //Get gateways
      $gatewayTable = Engine_Api::_()->getDbtable('gateways', 'sesproduct');
