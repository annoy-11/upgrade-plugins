 ...
 * @version    $Id: defaultsettings.php  2019-03-04 00:00:00 SocialEngineSolutions $
...
if( !$page_id ) {
  ...
  $db->insert('engine4_core_pages', array(
    ...
    'displayname' => 'SES - Stores Marketplace - Products - Product Profile Page Design 1',
    'title' => 'Product View',
 ...
 $db->insert('engine4_core_content', array(
    ...
    $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $right_id,
        'order' => $widgetOrder++,
        'params' => '{"title":" Profile Option","name":"sesproduct.gutter-menu"}',
    ));
    ...
    $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $right_id,
        'order' => $widgetOrder++,
        'params' => '{"openViewType":"grid","title_truncation_list":"45","description_truncation_list":"45","width_list":"50","height_list":"50","limit_data_list":"4","title_truncation_grid":"45","description_truncation_grid":"45","width_grid":"389","height_grid":"270","show_criteria":["title","verifiedLabel","likeButton","category","like","comment","favourite","view","favourites"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","showLimitData":"1","height":"180","width":"180","list_title_truncation":"45","limit_data":"2","title":"Similar products","nomobile":"0","name":"sesproduct.similar-products"}',
    ));
    ...
    $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $right_id,
        'order' => $widgetOrder++,
        'params' => '{"viewType":"list","imageType":"rounded","criteria":"5","order":"","info":"recently_created","show_criteria":["like","comment","favourite","view","title","category"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","show_star":"0","showLimitData":"1","title_truncation":"45","description_truncation":"60","height":"50","width":"50","limit_data":"4","title":"New in List","nomobile":"0","name":"sesproduct.featured-sponsored"}',
    ));
  ...
  $db->insert('engine4_core_content', array(
    ...
    'order' => $widgetOrder++,
    'params' => '{"title":"Photos","titleCount":false,"load_content":"auto_load","sort":"recentlySPcreated","insideOutside":"inside","fixHover":"fix","show_criteria":["like","comment","view","favouriteCount","title","socialSharing","photoCount","likeButton","favouriteButton"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","title_truncation":"45","limit_data":"20","height":"200","width":"236","nomobile":"0","name":"sesproduct.profile-photos"}',
  ));
  $db->insert('engine4_core_content', array(
    'type' => 'widget',
...
//Product Profile Page Design 2
$page_id = $db->select()
  ->from('engine4_core_pages', 'page_id')
  ->where('name = ?', 'sesproduct_index_view_2')
  ->limit(1)
  ->query()
  ->fetchColumn();
...
if( !$page_id ) {
  ...
  // Insert page
  $db->insert('engine4_core_pages', array(
    'name' => 'sesproduct_index_view_2',
    'displayname' => 'SES - Stores Marketplace - Products - Product Profile Page Design 2',
    'title' => 'Product View',
    'description' => 'This page displays a product entry.',
    'provides' => 'subject=sesproduct',
    'custom' => 0,
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $left_id,
    'order' => $widgetOrder++,
    'params' => '{"itemCountPerPage":"30","title":"Tags","nomobile":"0","name":"sesproduct.profile-tags"}',
  ));
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $middle_id,
    'order' => $widgetOrder++,
        'params' => '{"design":"2","show_criteria":["availability","title","price","discount","purchaseNote","productDetails","paymentOpt","wishlistButton","socialSharing","location","view","like","comment","favourite","category","storeName","likeButton","commentButton","favouriteButton","rating","label","stock","reviewButton"],"title":"","nomobile":"0","name":"sesproduct.product-information"}',
 ));
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $tab_id,
    'order' => $widgetOrder++,
    'params' => '{"show_criteria":["like","comment","favourite","view","title","by","rating","featuredLabel","sponsoredLabel","verifiedLabel","favouriteButton","likeButton","category","socialSharing"],"showLimitData":"1","height":"207","width":"307","list_title_truncation":"45","limit_data":"3","title":"Products","nomobile":"0","name":"sesproduct.similar-products"}',
  ));
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $tab_id,
    'order' => $widgetOrder++,
    'params' => '{"show_criteria":["price","discount","stock","storeName","addCart","addWishlist","addCompare","brand","featuredLabel","sponsoredLabel","verifiedLabel","favouriteButton","likeButton","socialSharing","like","favourite","comment","ratingStar","rating","view","title","category","creationDate","location","description"],"socialshare_enable_gridview1plusicon":"1","socialshare_icon_gridview1limit":"2","show_item_count":"0","title_truncation_grid":"45","height_grid":"270","width_grid":"389","limit_data_grid":"20","show_sale":"0","title":"Upsell Products","nomobile":"0","name":"sesproduct.upsell-products"}',
  ));
 ...
 $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $tab_id,
    'order' => $widgetOrder++,
    'params' => '{"stats":["likeCount","commentCount","viewCount","title","share","report","pros","cons","description","recommended","postedBy","parameter","creationDate","rating","likeButton","socialSharing"],"pagging":"auto_load","limit_data":"5","title":"Product Profile - Reviews","nomobile":"0","name":"sesproduct.product-reviews"}',
  ));
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $tab_id,
    'order' => $widgetOrder++,
    'params' => '{"title":"Albums","titleCount":false,"load_content":"auto_load","sort":null,"insideOutside":"outside","fixHover":"fix","show_criteria":["like","comment","view","favouriteCount","title","by","socialSharing","photoCount","likeButton","favouriteButton"],"title_truncation":"45","limit_data":"20","height":"200","width":"236","nomobile":"0","name":"sesproduct.profile-photos"}',
  ));
...
//Product Profile Page Design 3
$page_id = $db->select()
  ->from('engine4_core_pages', 'page_id')
  ->where('name = ?', 'sesproduct_index_view_3')
  ->limit(1)
  ->query()
  ->fetchColumn();
...
if( !$page_id ) {
  ...
  // Insert page
  $db->insert('engine4_core_pages', array(
    'name' => 'sesproduct_index_view_3',
    'displayname' => 'SES - Stores Marketplace - Products - Product Profile Page Design 3',
    'title' => 'Product View',
    'description' => 'This page displays a product entry.',
    'provides' => 'subject=sesproduct',
    'custom' => 0,
 ...
 $db->insert('engine4_core_content', array(
  ...
  // Insert content
     $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $middle_id,
        'order' => $widgetOrder++,
        'params'=>'{"design":"1","show_criteria":["title","storeNamePhoto","price","discount","purchaseNote","productDetails","paymentOpt","addWishlist","addCart","addCompare","featuredLabel","sponsoredLabel","verifiedLabel","socialSharing","location","view","like","comment","favourite","category","likeButton","commentButton","favouriteButton","rating","label","stock","reviewButton"],"socialshare_icon_limit":"2","show_sale":"0","title":"Product Information","nomobile":"0","name":"sesproduct.product-information"}',
    ));
    ...
    $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $tab_id,
        'order' => $widgetOrder++,
        'params' => '{"show_criteria":["like","comment","favourite","view","title","by","rating","featuredLabel","sponsoredLabel","verifiedLabel","favouriteButton","likeButton","category","socialSharing"],"showLimitData":"0","height":"200","width":"307","list_title_truncation":"45","limit_data":"3","title":"Similar Products","nomobile":"0","name":"sesproduct.similar-products"}',
    ));
   ...
   $db->insert('engine4_core_content', array(
    ...
    $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $tab_id,
        'order' => $widgetOrder++,
        'params' => '{"title":"Albums","titleCount":false,"load_content":"auto_load","sort":"recentlySPcreated","insideOutside":"inside","fixHover":"fix","show_criteria":["like","comment","view","favouriteCount","title","by","socialSharing","photoCount","likeButton","favouriteButton"],"title_truncation":"45","limit_data":"20","height":"200","width":"236","nomobile":"0","name":"sesproduct.profile-photos"}',
    ));
...
//Product Profile Page Design 4
$page_id = $db->select()
  ->from('engine4_core_pages', 'page_id')
  ->where('name = ?', 'sesproduct_index_view_4')
  ->limit(1)
  ->query()
  ->fetchColumn();
...
if( !$page_id ) {
  ...
  // Insert page
  $db->insert('engine4_core_pages', array(
    'name' => 'sesproduct_index_view_4',
    'displayname' => 'SES - Stores Marketplace - Products - Product Profile Page Design 4',
    'title' => 'Product View',
    'description' => 'This page displays a product entry.',
    'provides' => 'subject=sesproduct',
    'custom' => 0,
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $left_id,
    'order' => $widgetOrder++,
    'params' => '{"advShareOptions":["privateMessage","siteShare","quickShare","addThis"],"title":"","nomobile":"0","name":"sesproduct.advance-share"}',
  ));
  $db->insert('engine4_core_content', array(
    'type' => 'widget',
    'name' => 'sesproduct.gutter-menu',
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $middle_id,
    'order' => $widgetOrder++,
    'params' => '{"design":"4","show_criteria":["availability","title","price","discount","purchaseNote","productDetails","paymentOpt","wishlistButton","socialSharing","location","view","like","comment","favourite","category","storeName","likeButton","commentButton","favouriteButton","rating","label","stock","reviewButton"],"title":"","nomobile":"0","name":"sesproduct.product-information"}',
  ));
...
$product_table_exist = $db->query('SHOW TABLES LIKE \'engine4_sesproduct_products\'')->fetch();
if (!empty($product_table_exist)) {
  $seproduct_id = $db->query('SHOW COLUMNS FROM engine4_sesproduct_products LIKE \'seproduct_id\'')->fetch();
  if (empty($seproduct_id)) {
    $db->query('ALTER TABLE `engine4_sesproduct_products` ADD `seproduct_id` INT(11) NOT NULL DEFAULT "0";');
  }
}

$productcat_table_exist = $db->query('SHOW TABLES LIKE \'engine4_sesproduct_categories\'')->fetch();
if (!empty($productcat_table_exist)) {
  $seproduct_cayegoryid = $db->query('SHOW COLUMNS FROM engine4_sesproduct_categories LIKE \'seproduct_categoryid\'')->fetch();
  if (empty($seproduct_cayegoryid)) {
    $db->query('ALTER TABLE `engine4_sesproduct_categories` ADD `seproduct_categoryid` INT(11) NULL;');
  }
}
...
foreach (Engine_Api::_()->getDbTable('levels', 'authorization')->fetchAll() as $level) {
  $form = new Sesproduct_Form_Admin_Settings_Level(array(
      'public' => ( in_array($level->type, array('public')) ),
      'moderator' => ( in_array($level->type, array('admin', 'moderator')) ),
  ));
  $values = $form->getValues();
  $valuesForm = $permissionsTable->getAllowed('sesproduct', $level->level_id, array_keys($form->getValues()));
  ...
  try {
    ...
    $permissionsTable->setAllowed('sesproduct', $level->level_id, $values, '', $nonBooleanSettings);
    // Commit
    $db->commit();
  } catch (Exception $e) {
    $db->rollBack();
...
$db->query("DELETE FROM `engine4_activity_notificationtypes` WHERE `engine4_activity_notificationtypes`.`type` = 'sesproduct_link_product';");
$db->query("DELETE FROM `engine4_activity_notificationtypes` WHERE `engine4_activity_notificationtypes`.`type` = 'sesproduct_link_event';");
$db->query("DELETE FROM `engine4_activity_notificationtypes` WHERE `engine4_activity_notificationtypes`.`type` = 'sesproduct_reject_product_request';");
$db->query("DELETE FROM `engine4_activity_notificationtypes` WHERE `engine4_activity_notificationtypes`.`type` = 'sesproduct_reject_event_request';");
$db->query("DELETE FROM `engine4_activity_notificationtypes` WHERE `engine4_activity_notificationtypes`.`type` = 'sesuser_claimadmin_product';");

$db->query('INSERT IGNORE INTO `engine4_authorization_permissions`
  SELECT
    level_id as `level_id`,
    "sesproduct" as `type`,
    "product_approve" as `name`,
    1 as `value`,
    NULL as `params`
  FROM `engine4_authorization_levels` WHERE `type` NOT IN("public");');


$db->query('UPDATE `engine4_sesproduct_categories` SET `member_levels` = "1,2,3,4" WHERE `engine4_sesproduct_categories`.`subcat_id` = 0 and  `engine4_sesproduct_categories`.`subsubcat_id` = 0;');
...
$db->query("ALTER TABLE `engine4_sesproduct_transactions` ADD `ordercoupon_id` INT NULL DEFAULT '0';");
$db->query("ALTER TABLE `engine4_sesproduct_orders` ADD `credit_point` INT(11) NOT NULL DEFAULT '0', ADD `credit_value` FLOAT NOT NULL DEFAULT '0';");
