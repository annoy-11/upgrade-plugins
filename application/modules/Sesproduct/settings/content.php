...
$showCustomData = array(
  ...
  array(
    ...
    'multiOptions' => array(
      'price' =>'Price',
      'discount' => 'Discount',
      'stock' =>'Stock (For List View and Map View)',
      ...
      'rating' => 'Rating Stars',
      'title' => 'Product Title',
			'quickView' =>'Quick View (Not Supported in Map View)',
      'category' => 'Category (For List View and Map View)',
      'creationDate' => 'Creation Date (For List View and Map View)',
      'location'=> 'Location (For List View)',
      'description' => 'Description (For List View)',
    ),
    'escape' => false,
  )
);
        ...
        'category',
          ...
          'value' => ''
                ...
                array(
                        ...
                        'show_sale',
                        array(
                            'label' => 'Do you want to display SALE label on Products? (Not Supported in Map View)',
                            'multiOptions' => array(
                                '1' => 'Yes',
                                '0' => 'No',
                            ),
  ...
  array(
    ...
    'adminForm' => array(
      'elements' => array(
		...
		array(
    'title' => 'SES - Products - Product Description',
    'description' => 'This widget displays the description of product on your website.',
    'category' => 'SES - Stores Marketplace - Products',
    'type' => 'widget',
