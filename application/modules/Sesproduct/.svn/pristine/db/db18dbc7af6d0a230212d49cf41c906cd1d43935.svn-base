 ...
 */
 ...
 ?>
  <li class="sesbasic_clearfix sesproduct_reviews">
    ...
    <div class="sesproduct_review_listing_desc sesbasic_clearfix">
      ...
      <?php endif; ?>
      <p class="sesproduct_review_listing_recommended"> <b><?php echo $this->translate('Recommended');?><i class="<?php if($this->review->recommended):?>fa fa-check<?php else:?>fa fa-times<?php endif;?>"></i></b></p>
...
<div class="rating_params">
  ...
  <div id="sesproduct_review_create_form" class="" style="display:none;position:relative;">
