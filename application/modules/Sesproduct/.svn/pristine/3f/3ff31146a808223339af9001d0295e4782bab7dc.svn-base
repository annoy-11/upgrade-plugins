 ...
 * @version    $Id: manage-payment-store-owner.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
        ...
        <table class='admin_table'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="<?php echo $store->getHref(); ?>" target="_blank"><?php echo $store->getTitle(); ?></a></td>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesproduct', 'controller' => 'admin-payment', 'action' => 'view-paymentrequest', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
