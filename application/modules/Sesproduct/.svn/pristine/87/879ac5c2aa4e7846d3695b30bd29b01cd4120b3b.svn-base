 ...
 * @version    $Id: product-request.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
...
<h3><?php echo $this->translate("Manage Product Requests"); ?></h3>
    ...
    <table>
      ...
      <tbody>
	    ...
	    <a href="<?php echo $user->getHref(); ?>"><?php echo $user->getTitle(); ?></a>
           ...
           <td>
	    <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesproduct', 'controller' => 'index', 'action' => 'approved', 'event_id' => $item->event_id, 'product_id' => $item->product_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Mark Approve')))) ?>
          </td>
          <td class="table_options">
	    <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesproduct', 'controller' => 'index', 'action' => 'reject-request', 'event_id' => $item->event_id, 'product_id' => $item->product_id), $this->translate('Reject Request')) ?>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
