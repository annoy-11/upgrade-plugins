 ...
 * @version    $Id: Upsells.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_Model_DbTable_Upsells extends Engine_Db_Table {
...
//
//         $select->joinLeft($upsellTableName, $upsellTableName . '.product_id = ' . $productTableName . '.product_id',null)
//         ->where($productTableName . '.product_id IN SEL',);
//     }
