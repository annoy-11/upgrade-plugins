 ...
 * @version    $Id: _advgridView.tpl  2019-03-04 00:00:00 SocialEngineSolutions $
...
<li class="sesproduct_last_grid_block sesbasic_bxs <?php if((isset($this->my_products) && $this->my_products)){ ?>isoptions<?php } ?>" style="width:<?php echo is_numeric($this->width_advgrid) ? $this->width_advgrid.'px' : $this->width_advgrid ?>;">
  <div class="sesproduct_grid_inner">
    <div class="sesproduct_grid_thumb sesproduct_thumb" style="height:<?php echo is_numeric($this->height_advgrid) ? $this->height_advgrid.'px' : $this->height_advgrid ?>;">
      ...
      <div class="sesproduct_grid_thumb_over"> <a href="<?php echo $href; ?>" data-url = "<?php echo $item->getType() ?>"></a>
    ...
    <div class="sesproduct_grid_info clear clearfix sesbm">
      ...
      <?php echo $this->partial('_productRating.tpl', 'sesproduct', array('rating' => $item->rating, 'class' => 'sesproduct_list_rating sesproduct_list_view_ratting floatR', 'style' => 'margin:0px;'));?>
      <?php endif;?>
      ...
      <div class="sesproduct_product_offers sesbasic_clearfix"> 
        <span class="offer"><?php echo $this->translate('Offer'); ?></span> 
        <span><?php echo $this->translate('No Cost EMI'); ?></span> 
      </div>
