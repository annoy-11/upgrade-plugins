 ...
 * @version    $Id: Gateways.php  2019-03-04 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesproduct_Model_DbTable_Gateways extends Engine_Db_Table
{
  protected $_name = 'payment_gateways';
  protected $_rowClass = 'Sesproduct_Model_Gateway';
