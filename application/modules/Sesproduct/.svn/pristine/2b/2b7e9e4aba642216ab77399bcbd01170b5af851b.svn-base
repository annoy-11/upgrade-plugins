...
class Sesproduct_Form_Admin_Parameter_Add extends Engine_Form {
  ...
  public function init() {
    ...
    if(count($reviewParameters)){
			foreach($reviewParameters as $val){
				$this->addElement('Text', 'sesproduct_review_'.$val['parameter_id'], array(
          'label' => '',
					'class'=>'sesproduct_added_parameter',
          'allowEmpty' => true,
					'value'=>$val['title'],
          'required' => false,
          'maxlength' => "255",
