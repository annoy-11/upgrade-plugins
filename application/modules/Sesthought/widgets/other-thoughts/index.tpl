  ...
  <ul class="sesthoughts_sidebar_listing sesbasic_bxs">
    <?php foreach( $this->thoughts as $item ): ?>
      <li class="sesbasic_clearfix">
        ...
        <?php } ?>
        <?php if(in_array('title', $this->allParams['information']) && !empty($item->thoughttitle)) { ?>
        ...
        <div class="_info">
          ...
          <?php if(in_array('posteddate', $this->allParams['information']) || in_array('postedby', $this->allParams['information'])) { ?>
            <div class="_owner_info">
              ...
              <?php } ?>
              <p class="_social">
                <?php if(in_array('socialSharing', $this->allParams['information']) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesthought.allowshare', 1)):?>
