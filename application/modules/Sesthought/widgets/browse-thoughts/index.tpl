...
<script type="text/javascript">
  ...
  function loadMoreTHOUGHT() {
    ...
    if ($('thought_view_more'))
      $('thought_view_more').style.display = "<?php echo ( $this->paginator->count() == $this->paginator->getCurrentPageNumber() || $this->count == 0 ? 'none' : '' ) ?>";
