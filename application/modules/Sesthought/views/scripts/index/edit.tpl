...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    ...
    formObj = sesJqueryObject('#sesthoughts_create').find('div').find('div').find('div');
  ...
  function submitThought(formObject) {
    ...
    sesJqueryObject('#sesthought_overlay').show();
    ...
    sesJqueryObject.ajax({
      ...
      success: function(response) {
        ...
        if(result.status == 1) {
          ...
          sesJqueryObject('#sesthought_overlay').hide();
          sesJqueryObject('#sessmoothbox_container').html("<div id='sesthought_success_message' class='sesprofilefield_success_message sesthought_success_message'><i class='fa-check-circle-o'></i><span>You have successfully posted discussion.</span></div>");

          sesJqueryObject('#sesthought_success_message').fadeOut("slow", function(){
            setTimeout(function() {
              sessmoothboxclose();
