...
if( !$pageId ) {
  ...
  $db->insert('engine4_core_pages', array(
    ...
    'displayname' => 'SES - Thoughts - Thoughts Browse Page',
...
if( !$pageId ) {
  ...
  $db->insert('engine4_core_pages', array(
    ...
    'displayname' => 'SES - Thoughts - Thoughts Manage Page',
    'title' => 'My Thought',
...
if( !$pageId ) {
  ...
  $db->insert('engine4_core_pages', array(
    ...
    'displayname' => 'SES - Thoughts - Thought View Page',
    'title' => 'Thought View',
...
if (!$page_id) {
  ...
  $db->insert('engine4_core_pages', array(
      ...
      'displayname' => 'SES - Thoughts - Thought Category Browse Page',
  ...
  $db->insert('engine4_core_content', array(
    ...
    'order' => $widgetOrder++,
    'params' => '{"height":"200","width":"175","heighticon":"50px","widthicon":"50px","alignContent":"center","criteria":"most_thought","showStats":["title","countThoughts"],"limit_data":"30","title":"","nomobile":"0","name":"sesthought.category-icons"}',
  ));
