 ...
 * @version    $Id: SesarticleFieldValueLoop.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesarticle_View_Helper_SesarticleFieldValueLoop extends Fields_View_Helper_FieldAbstract {

  public function sesarticleFieldValueLoop($subject, $partialStructure) {
    ...
    if ($module == 'sesarticle' && $controller == 'admin-manage' && $action == 'view')
      $show_hidden = false;
    else
