...
class Sesarticle_Model_Album extends Core_Model_Item_Collection
{
  protected $_parent_type = 'sesarticle';

  protected $_owner_type = 'sesarticle';

  protected $_children_types = array('sesarticle_photo');

  protected $_collectible_type = 'sesarticle_photo';

//   public function getHref($params = array())
//   {
//     return $this->getSesarticle()->getHref($params);
//   }
    ...
    if (empty($this->photo_id)) {
      ...
      if (!empty($photoInfo)) {
        ...
        $file_id = $photoInfo['file_id'];
			 ...
			 if(!$status)
        return 'application/modules/Sesarticle/externals/images/nophoto_album_thumb_normal.png?c=direct';
			 else
			 	return '';
      }
    } else {
  ...
  protected function _delete()
  {
    ...
    foreach( $photoTable->fetchAll($photoSelect) as $sesarticlePhoto ) {
      $sesarticlePhoto->delete();
    }
