...
class Sesarticle_Form_Search extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setAction($view->url(array('module' => 'sesarticle', 'controller' => 'index', 'action' => 'browse'), 'default', true));
    ...
    if ($this->_locationSearch == 'yes' && $this->getSearchFor() == 'article') {
      /*Location Elements*/
    ...
    if ($this->getHasPhoto() != 'no') {
      $this->addElement('Checkbox', 'has_photo', array(
          'label' => 'Only Articles With Photos',
