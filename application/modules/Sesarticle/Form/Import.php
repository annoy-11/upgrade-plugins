...
class Sesarticle_Form_Import extends Engine_Form {
 
  public function init() {
  
    $this->setTitle('Import Articles')->setDescription('')->setAttrib('name', 'article_import')->setAttrib('enctype', 'multipart/form-data');
    ...
    $this->addElement('Text', 'user_name', array(
      ...
      'description' => 'Please put here your tumblr account user name to import articles.',
      'filters' => array(
