 ...
 * @version    $Id: Dashboardfields.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesarticle_Form_Custom_Dashboardfields extends Engine_Form {
  /* Custom */
  ...
  public function generate() {
    ...
    $orderIndex = 0;
		$package = Engine_Api::_()->getItem('sesarticlepackage_package',$this->getItem()->package_id);
