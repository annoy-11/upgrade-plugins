 ...
 * @version    $Id: CategoryMapping.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesarticle_Form_Admin_Review_CategoryMapping extends Engine_Form {
  ...
  public function init() {
    ...
    if (count($topStructure) == 1 && $topStructure[0]->getChild()->type == 'profile_type') {
      ...
      $options = $profileTypeField->getElementParams('sesarticlereview');
