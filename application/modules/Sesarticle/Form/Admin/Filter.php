...
class Sesarticle_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbtable('categories', 'sesarticle')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Select', 'verified', array(
		...
		$isEnablePackage = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesarticlepackage') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesarticlepackage.enable.package', 1);
		if($isEnablePackage){
				$packages = Engine_Api::_()->getDbTable('packages','sesarticlepackage')->getPackage(array('default' => true));
				$packagesArray = array(''=>'');
