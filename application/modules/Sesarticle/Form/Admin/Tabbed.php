 ...
 * @version    $Id: Tabbed.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesarticle_Form_Admin_Tabbed extends Engine_Form {

  public function init() {
  
    $this->addElement('MultiCheckbox', "enableTabs", array(
      'label' => "Choose the View Type for Articles.",
      'multiOptions' => array(
      'list' => 'List view ',
      ...
      'supergrid' => 'Super Advanced Grid View',
      'grid2' => 'Grid View',
   ...
   $categories = array('' => '') + $categories;
    ...
    $this->addElement('Select', "show_limited_data", array(
			'label' => 'Show only the number of articles entered in above setting. [If you choose No, then you can choose how do you want to show more articles in this widget.]',
			 'multiOptions' => array(
            'yes' => 'Yes',
            'no' => 'No',
        ),
    ...
    $this->addElement('Text', "limit_data_grid2", array(
      'label' => 'Count for Grid Views 4 (number of articles to show).',
      'value' => 10,
      'validators' => array(
	array('Int', true),
	array('GreaterThan', true, array(0)),
	...
	array('GreaterThan', true, array(0)),
		...
		$this->addElement('Text', "limit_data_advlist2", array(
