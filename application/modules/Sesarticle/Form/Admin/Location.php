 ...
 * @version    $Id: Location.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesarticle_Form_Admin_Location extends Engine_Form {
  public function init() {    
   ...
   $this->addElement('Text', "limit_data", array(
      ...
      'label' => 'Height of block in px',
      'value' => 300,
    ));
		$this->addElement('Text', "width", array(
      'label' => 'Width of block in px',
      'value' => 300,
    ));
   $this->addElement('dummy', 'location-data', array(
		'decorators' => array(array('ViewScript', array(
				'viewScript' => 'application/modules/Sesarticle/views/scripts/location.tpl',
		)))
  ));
  }
}