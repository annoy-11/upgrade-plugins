...
class Sesarticle_AdminManageReviewController extends Core_Controller_Action_Admin {
  ...
  public function reviewSettingsAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesarticle_admin_main_rvwsetings', array(), 'sesarticle_admin_main_subreviewsettings');
  ...
  public function manageAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesarticle_admin_main_rvwsetings', array(), 'sesarticle_admin_main_submanagereview');
