 ...
 * @version    $Id: AdminFieldsReviewController.php 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesarticle_AdminFieldsReviewController extends Fields_Controller_AdminAbstract {
  ...
  public function indexAction() {
    ...
    $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesarticle_admin_main_rvwsetings', array(), 'sesarticle_admin_main_subreviewparameters');
  ...
  public function fieldEditAction() {
    ...
    // Create form
    $this->view->form = $form = new $adminFormClass();
    $form->setTitle('Edit Article Category Review Profile Question');
    $form->removeElement('show');
    $form->removeElement('search');
    $form->addElement('hidden', 'show', array('value' => 0));
    $form->removeElement('display');
  ...
  public function typeDeleteAction() {
    ...
    if (!empty($option_id)) {
      // Engine_Api::_()->getDbtable('categories', 'sesarticle')->update(array('profile_type' => 0), array('profile_type = ?' => $option_id));
    }
