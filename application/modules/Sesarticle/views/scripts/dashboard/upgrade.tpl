...
<?php 
$information = array('description'=>'Package Description','featured'=>'Featured','sponsored'=>'Sponsored','verified'=>'Verified','location'=>'Location','modules'=>'Modules','editor'=>'Rich Editor','custom_fields'=>'Custom Fields','articlecount'=>'Article Count');
$showinfo = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesarticlepackage.package.information', array_keys($information)); ?>
<?php $currentCurrency =  Engine_Api::_()->sesbasic()->getCurrentCurrency(); ?>
<?php if($this->currentPackage){ 
	$package = Engine_Api::_()->getItem('sesarticlepackage_package',$this->currentPackage->package_id);
  if($package){
?>
<div class="sesarticlepackage_article_list sesbasic_clearfix sesbasic_bxs">
	<div class="sesarticlepackage_slect_plan_article">
  <div class="heading_article">
  	<p class="headding"><?php echo $this->translate("Current Package"); ?></p>
    </div>
    <div class="select">
    	<ul>
      <?php if(in_array('articlecount',$showinfo)){ ?>
        <li><?php echo $this->translate("Article Count"); ?></li>
     	<?php }else{ ?>
      	<li><?php echo $this->translate("Article Left"); ?></li>
      <?php } ?>
  ...
  <div class="package_catogery_list">
    ...
    <?php 
            ...
            $curruncySymbol = str_replace('.','',preg_replace('/\d+/u', '', Engine_Api::_()->sesbasic()->getCurrencyPrice($package->price,$currentCurrency)));
     ?>
    	<li class="<?php ($package->highlight) ? 'active' : '' ?>">
      	<div class="package-ditals_article">
        	<div class="headding_article">
          	<div class="title">
            ...
            <div class="amount">
            	<?php if($package->price > 0){ ?>
            		<span><?php echo $curruncySymbol; ?></span><?php echo $package->price; ?><br />
     ...
     ?>
    	<li class="<?php echo ($package->highlight) ? 'active' : '' ?>">
          ...
          <?php if(in_array('description',$showinfo)){ ?> 
            <p class="footer_discprition"><?php echo $this->translate($package->description); ?> </p>
          <?php } ?>
          <a href="<?php echo $this->url(array('article_id' => $this->article->article_id,'action'=>'confirm-upgrade','package_id'=>$package->package_id), 'sesarticlepackage_general', true); ?>" class="smoothbox">Upgrade Package</a>
          </div>
        </div>
      </li>      
    <?php } ?>
