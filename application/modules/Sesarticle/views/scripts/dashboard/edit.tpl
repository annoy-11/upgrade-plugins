...
<?php if(!$this->is_ajax){ ?>
  <?php
  echo $this->partial('dashboard/left-bar.tpl', 'sesarticle', array(
  'article' => $this->article,
  ));	
  ?>
  <div class="sesbasic_dashboard_content sesbm sesbasic_clearfix">
<?php } ?>
<div class="sesbasic_dashboard_form sesarticle_create_form sesbasic_bxs">
...
<?php echo $this->partial('_customFields.tpl', 'sesarticle', array()); ?>

<script type="text/javascript">
  en4.core.runonce.add(function()
  {
    showHideHeight('<?php echo $this->article->cotinuereading; ?>');
...
//prarticle form submit on enter
...
var counter = 0;
  function validateForm(){
    ...
    jqueryObjectOfSes('#sesarticles_edit input, #sesarticles_edit select,#sesarticles_edit checkbox,#sesarticles_edit textarea,#sesarticles_edit radio').each(
      function(index){
  ...
  jqueryObjectOfSes('#sesarticles_edit').submit(function(e){
    var validationFm = validateForm();
		if(!validationFm && sesJqueryObject('#sesarticle_schedule_time').length > 0 ) {
