...
?>
<li class="sesarticle_list_second_article sesbasic_clearfix clear">
	<div class="sesarticle_list_thumb sesarticle_thumb" style="height:<?php echo is_numeric($this->height_simplelist) ? $this->height_simplelist.'px' : $this->height_simplelist ?>;width:<?php echo is_numeric($this->width_simplelist) ? $this->width_simplelist.'px' : $this->width_simplelist ?>;">
		...
		<?php if(isset($this->creationDateActive)){ ?>
			<div class="sesarticle_list_second_article_date">
    ...
    <div class="sesarticle_admin_list">
			<?php if(isset($this->byActive)){ ?>
				<div class="sesarticle_stats_list admin_img sesbasic_text_dark">
			...
			<?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesarticle.enable.location', 1)){ ?>
				<div class="sesarticle_stats_list  sesbasic_text_dark sesarticle_list_location">
					<span>
			...
			<?php } ?>
		<div class="sesarticle_stats_list sesbasic_text_dark sesarticle_list_stats" style="">
    ...
    <div class="sesarticle_list_contant">
		<?php if(isset($this->descriptionsimplelistActive)){ ?>
			<p class="sesarticle_list_des">
              <?php echo $item->getDescription($this->description_truncation_simplelist);?>
			</p>
		<?php } ?>      
		</div>
		<?php if(isset($this->readmoreActive)):?>
			<div class="sesarticle_list_readmore"><a class="sesarticle_animation" href="<?php echo $item->getHref();?>"><?php echo $this->translate('Read More');?></a></div>
		<?php endif;?>
