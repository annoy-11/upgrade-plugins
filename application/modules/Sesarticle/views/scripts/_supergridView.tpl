...
?>
<li class="sesarticle_new_grid_block sesbasic_bxs <?php if((isset($this->my_articles) && $this->my_articles)){ ?>isoptions<?php } ?>" style="width:<?php echo is_numeric($this->width_supergrid) ? $this->width_supergrid.'px' : $this->width_supergrid ?>;">
		...
		<?php if(isset($this->categoryActive)): ?>
		  <?php if($item->category_id != '' && intval($item->category_id) && !is_null($item->category_id)):?> 
			  <?php $categoryItem = Engine_Api::_()->getItem('sesarticle_category', $item->category_id);?>
				<?php if($categoryItem):?>
			    <div class="sesarticle_grid_info_title"><a href="<?php echo $categoryItem->getHref(); ?>"><?php echo $categoryItem->category_name; ?></a></div>
			  <?php endif;?>
			<?php endif;?>
		<?php endif; ?>
		<div class="sesarticle_grid_thumb sesarticle_thumb" style="height:<?php echo is_numeric($this->height_supergrid) ? $this->height_supergrid.'px' : $this->height_supergrid ?>;">
      ...
      <?php if(isset($this->verifiedLabelActive) && $item->verified == 1):?>
		...
		<div class="sesarticle_grid_info clear clearfix sesbm">
		  <?php if(isset($this->creationDateActive)){ ?>
				<div class="sesarticle_grid_date_article">
			...
			<?php if(isset($this->titleActive)): ?>
				<div class="sesarticle_second_grid_info_title">
			...
			<?php } ?>
			<div class="sesarticle_comment_list sesarticle_list_stats sesbasic_text_dark">
		...
		<?php if(isset($this->readmoreActive)):?>
			<div class="sesarticle_second_readmore_link">
