...
?>
<div class="form-wrapper sesarticle_form_rating_star">
  <div class="form-label"><label><?php echo $this->translate("Overall Rating"); ?></label></div>
  <div id="sesarticle_review_rating" class="sesbasic_rating_star sesarticle_rating_star_element" onmouseout="rating_out();">
...
function validateForm(){
		...
		counter = 0;
		sesJqueryObject('#sesarticle_review_form input, #sesarticle_review_form select,#sesarticle_review_form checkbox,#sesarticle_review_form textarea,#sesarticle_review_form radio').each(
				function(index){
			...
			en4.core.runonce.add(function()
				{
			sesJqueryObject('#sesarticle_review_form').submit(function(e){
					var validationFm = validateForm();
					if(!sesJqueryObject('#rate_value').val()){
						alert('<?php echo $this->translate("Please fill the red mark fields"); ?>');
						 var errorFirstObject = sesJqueryObject('#sesarticle_review_rating').parent();
