...
<li class="sesarticle_list_article_view sesbasic_clearfix clear">
	...
	<div class="sesarticle_list_thumb sesarticle_thumb" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;width:<?php echo is_numeric($this->width_list) ? $this->width_list.'px' : $this->width_list ?>;">
...
<div class="sesarticle_static_list_group">
		...
		<?php if(isset($this->readmoreActive)):?>
			<div class="sesarticle_list_readmore floatR"><a class="sesarticle_animation" href="<?php echo $item->getHref();?>"><?php echo $this->translate('Read More');?></a></div>
		<?php endif;?>
    </div>
