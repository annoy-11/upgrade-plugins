 ...
 * @version    $Id: review-parameter.tpl 2016-07-23 00:00:00 SocialEngineSolutions $
...
<div class='clear'>
  <div class='settings global_form_popup sesarticle_review_parameter_popup'>
    <?php echo $this->form->render($this); ?>
  </div>
</div>

<script type="application/javascript">
var alreadyaddedParameter = sesJqueryObject('.sesarticle_review_added_parameter');
if(alreadyaddedParameter.length > 0){
	for(var i=0;i<alreadyaddedParameter.length;i++){
		var id = sesJqueryObject(alreadyaddedParameter[i]).attr('id').replace('sesarticle_review_','');
