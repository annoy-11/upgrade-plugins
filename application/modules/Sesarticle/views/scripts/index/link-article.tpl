 ...
 * @version    $Id: link-article.tpl 2016-07-23 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    var id = '<?php echo $this->article_id; ?>';
    
    (new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'sesarticle/index/link-article/article_id/' + id ,
      'data': {
        format: 'html',
...
<?php if (empty($this->viewmore)): ?>
  <div class="sesbasic_items_listing_popup">
    <div class="sesbasic_items_listing_header">
         <?php echo $this->translate('Events in which you can link to article') ?>
...
<?php endif; ?>
    ...
    <?php if (count($this->paginator) > 0) : ?>
      <form id='link_article' name="link_article" method="post" action="<?php echo $this->url();?>">
