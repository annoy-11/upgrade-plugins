 ...
 * @version    $Id: location.tpl 2016-07-23 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<div class="sesarticle_edit_location_popup">
...
<script type="text/javascript">
  ...
  sesJqueryObject('#ses_location_data_list').html('<?php echo $this->article->location; ?>');
  sesJqueryObject('#ses_location-wrapper').css('display','none');
  <?php if($this->type == 'article_location'){ ?>
