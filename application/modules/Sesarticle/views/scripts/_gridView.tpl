...
<li class="sesarticle_grid sesbasic_bxs <?php if((isset($this->my_articles) && $this->my_articles)){ ?>isoptions<?php } ?>" style="width:<?php echo is_numeric($this->width_grid) ? $this->width_grid.'px' : $this->width_grid ?>;">
  <div class="sesarticle_grid_inner sesarticle_thumb">
    <div class="sesarticle_grid_thumb" style="height:<?php echo is_numeric($this->height_grid) ? $this->height_grid.'px' : $this->height_grid ?>;">
      ...
      <a href="<?php echo $href; ?>" data-url = "<?php echo $item->getType() ?>" class="sesarticle_thumb_img"> <span style="background-image:url(<?php echo $imageURL; ?>);"></span> </a>
    ...
    <div class="sesarticle_grid_info clear clearfix sesbm">
      ...
      <div class="sesarticle_grid_meta_block">
        ...
        <div class="sesarticle_list_stats sesbasic_text_light"> <span>
        ...
        <div class="sesarticle_list_stats sesbasic_text_light"> <span><i class=" fa fa-clock-o"></i> 						<?php if($item->publish_date): ?>
        ...
        <div class="sesarticle_list_stats sesarticle_list_location sesbasic_text_light"> <span> <i class="fa fa-map-marker"></i> <a href="<?php echo $this->url(array('resource_id' => $item->article_id,'resource_type'=>'sesarticle','action'=>'get-direction'), 'sesbasic_get_direction', true) ;?>" class="opensmoothboxurl" title="<?php echo $item->location;?>"><?php echo $item->location;?></a> </span> </div>
        <?php } ?>
      </div>
    </div>
    <div class="sesarticle_grid_hover_block">
      ...
      <div class="sesarticle_grid_meta_block">
        ...
        <?php } ?>
        <?php if(isset($this->creationDateActive)): ?>
        <div class="sesarticle_list_stats sesbasic_text_light"> <span><i class=" fa fa-clock-o"></i> <?php echo date('M d',strtotime($item->publish_date));?>&nbsp;|</span> </div>
        <?php endif;?>
        <?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesarticle.enable.location', 1)){ ?>
        <div class="sesarticle_list_stats sesarticle_list_location sesbasic_text_light"> <span> <i class="fa fa-map-marker"></i> <a href="<?php echo $this->url(array('resource_id' => $item->article_id,'resource_type'=>'sesarticle','action'=>'get-direction'), 'sesbasic_get_direction', true) ;?>" class="opensmoothboxurl" title="<?php echo $item->location;?>"><?php echo $item->location;?></a> </span> </div>
        <?php } ?>
      ...
      <div class="sesarticle_grid_des clear"><?php echo $item->getDescription($this->description_truncation_grid);?></div>
      <?php } ?>
      <div class="sesarticle_grid_hover_block_footer">
        ...
        <div class="sesarticle_grid_read_btn floatR"><a href="<?php echo $href; ?>"><?php echo $this->translate('Read More...');?></a></div>
        <?php endif;?>
      </div>
    </div>
    ...
    <div class="sesarticle_list_thumb_over"> <a href="<?php echo $href; ?>" data-url = "<?php echo $item->getType() ?>"></a>
