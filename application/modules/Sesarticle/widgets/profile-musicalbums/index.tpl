...
window.addEvent('domready', function() {
  ...
  <?php if($this->canCreate && $this->allow_create){ ?>
    <div class="sesbasic_profile_tabs_top sesbasic_clearfix">
      <?php $url = 'music/album/create/resource_type/sesarticle/resource_id/' . $this->article_id; ?>
  ...
  <div class="clear sesbasic_clearfix sesbasic_bxs" id="scrollHeightDivSes_<?php echo $randonNumber; ?>">
            ...
            <li id="thumbs-photo-<?php echo $photo->album_id ?>" class="sesmusic_item_grid" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
              <div class="sesmusic_item_artwork" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
                ...
                <div class="hover_box">
                  ...
                  <div class="sesarticle_musicalbum_manage_op sesbasic_clearfix">
                  	<span class="sesarticle_musicalbum_manage_op_btn"><i class="fa fa-cog"></i></span>
                  ...
                  if($viewer_id): ?>
                      ...
                      <?php if($this->addfavouriteAlbumSong && !empty($this->informationAlbum) && in_array('favourite', $this->informationAlbum) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesarticle.enable.favourite', 1)): ?>
      ...
      <img src="application/modules/Sesarticle/externals/images/music_icon.png" alt="">    
...
<script type="text/javascript">
  ...
  function viewMore_<?php echo $randonNumber; ?> (){
    ...
    en4.core.request.send(new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'widget/index/mod/sesarticle/name/profile-musicalbums/openTab/' + openTab_<?php echo $randonNumber; ?>,
      'data': {
        format: 'html',
