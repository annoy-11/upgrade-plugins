 ...
 */
class Sesarticle_Widget_ArticlesSlideshowController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->socialshare_icon_limit = $this->_getParam('socialshare_icon_limit', 2);
		...
		$this->view->leftArticle = $this->_getParam('leftArticle', 1);
    ...
    $value['fetchAll'] = true;
		$value['limit'] = 3;
    $this->view->paginatorLeft = $paginatorLeft = Engine_Api::_()->getDbTable('sesarticles', 'sesarticle')->getSesarticlesSelect($value);
    ...
    $this->view->paginatorRight = $paginatorRight = Engine_Api::_()->getDbTable('sesarticles', 'sesarticle')->getSesarticlesSelect($valueRight);
  }
}