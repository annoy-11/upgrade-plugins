...
class Sesarticle_Widget_ArticlePhotoController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->photo_id = Engine_Api::_()->getItem('sesarticle', $article_id)->photo_id;
    else
