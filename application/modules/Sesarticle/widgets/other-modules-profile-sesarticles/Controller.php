 ...
 */
class Sesarticle_Widget_OtherModulesProfileSesarticlesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->widgetName = 'other-modules-profile-sesarticles';			
