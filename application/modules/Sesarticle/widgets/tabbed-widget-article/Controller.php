 ...
 */
class Sesarticle_Widget_tabbedWidgetArticleController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (empty($sesarticle_tabbed))
      return $this->setNoRender();
		...
		$this->view->limit_data_advlist2= $limit_data_advlist2 = isset($params['limit_data_advlist2']) ? $params['limit_data_advlist2'] : $this->_getParam('limit_data_advlist2', '10');
		//advanced grid view
    ...
    $this->view->widgetName = 'tabbed-widget-article';			
    $params = array_merge($params, $value);

    // Get Articles
    $paginator = Engine_Api::_()->getDbtable('sesarticles', 'sesarticle')->getSesarticlesPaginator($params);
