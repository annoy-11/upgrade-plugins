...
?>
<?php if($this->title == ''){ ?>
<h3><?php echo $this->translate('People Like This %s',ucfirst(str_replace('sesarticle_','',$this->subject->getType()))); ?></h3>
<?php } ?>
...
function getLikeData(value,title){
	if(value){
		url = en4.core.staticBaseUrl+'sesarticle/index/like-item/item_id/'+value+'/title/'+title+'/item_type/<?php echo $this->subject()->getType(); ?>';
