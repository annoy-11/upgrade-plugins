...
class Sesarticle_Widget_TopArticlegersController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
		...
		$this->view->widgetName = 'top-articlegers';
    ...
    $this->view->{$show_criteria . 'Active'} = $show_criteria;
		$this->view->paginator = $paginator = Engine_Api::_()->sesarticle()->getArticlegers();
