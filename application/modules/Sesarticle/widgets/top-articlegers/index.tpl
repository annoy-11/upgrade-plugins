...
?>
  ...
  <?php endif;?>
  <div class="sesarticle_top_articleer_list" style="position:relative;">
    <?php if($this->view_type == 'Vertical'):?>
      <ul id="widget_sesarticle_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block  sesbasic_clearfix sesbasic_bxs">
        ...
        <?php foreach( $this->paginator as $articleger ): ?>
          ...
          <li class="sesarticleer_top_sidebar_list">
    ...
    <?php else:?>
      <ul id="widget_sesarticle_<?php echo $randonnumber; ?>" class="sesbasic_sidebar_block  sesbasic_clearfix sesbasic_bxs">
        ...
        <?php foreach( $this->paginator as $articleger ): ?>
          <?php $item = Engine_Api::_()->getItem('user',$articleger->user_id);?>
          <li class="sesarticleer_top_gird_list" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
          <div class="sesarticleer_top_gird_thumb_article" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
