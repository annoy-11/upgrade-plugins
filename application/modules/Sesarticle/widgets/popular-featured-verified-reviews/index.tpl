...
<ul class="sesbasic_sidebar_block sesarticle_review_sidebar_block sesbasic_bxs sesbasic_clearfix"  id="widget_sesarticle_<?php echo $randonnumber; ?>" style="position:relative;">
