  ...
  public function init() {
    ...
    if ($settings->getSetting('sesadvancedcomment.pluginactivated')) {
      ...
      $this->addElement('Radio', 'sesadvancedcomment_enablencommentupdownvote', array(
        ...
        'description' => 'Do you want to enable Up/Down vote in Comment?',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
...
foreach( $files as $file ) {
  $banner_options[$file->storage_path] = $file->name;
      ...
      $this->addElement('Text', 'sesadvancedcomment_stickerstextcolor', array(
        ...
        'class' => 'SEScolor',
        'value' => $settings->getSetting('sesadvancedcomment.stickerstextcolor', '000000'),
      ));
     $sescommentsOptions = array('photos' => 'Attach Photos', 'videos' => 'Attach Videos', 'stickers' => 'Post Stickers', 'gif' => "Post GIF");
     if(Engine_Api::_()->getDbTable('modules', 'core')->isModuleEnabled('sesemoji'))
        $sescommentsOptions['emojis'] = "Post Emojis";
      else
        $sescommentsOptions['emotions'] = "Post Emoticons";
      ...
      $this->addElement('MultiCheckbox', 'sesadvancedcomment_enableattachement', array(
          ...
          'multiOptions' =>$sescommentsOptions,
          'escape' => false,
