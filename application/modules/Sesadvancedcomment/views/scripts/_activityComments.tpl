              ...
              <div class="_form_container sesbasic_clearfix">
                <div class="comment_form sesbasic_clearfix">
                  ...
                  <div class="_sesadvcmt_post_icons sesbasic_clearfix">
                    <span>
                      <?php if($albumenable && Engine_Api::_()->authorization()->isAllowed('album', null, 'create') && in_array('photos', $enableattachementComment)){ ?>
                   ...
                   <?php if($videoenable && Engine_Api::_()->authorization()->isAllowed('video', $viewer, 'create')){ ?>
                    ...
                    <?php } ?>
                    <?php if((in_array('stickers', $enableattachement) && in_array('stickers', $enableattachementComment))) { ?>
                    ...
                    <?php //GIF Work ?>
                    <?php if(defined('SESFEEDGIFENABLED') && (in_array('gif', $enableattachement) && in_array('gif', $enableattachementComment))) {  ?>
                    ...
                    <?php if(Engine_Api::_()->getDbTable('modules', 'core')->isModuleEnabled('sesemoji') && (in_array('emojis', $enableattachement)  && in_array('emojis', $enableattachementComment))) {
