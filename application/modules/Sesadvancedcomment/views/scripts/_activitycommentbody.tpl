        ...
        <div class="_form_container sesbasic_clearfix">
          <div class="comment_form sesbasic_clearfix">
            ...
            <div class="_sesadvcmt_post_icons sesbasic_clearfix">
              ...
              <?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesemoji') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesemoji.pluginactivated') && (in_array('emojis', $enableattachement) && in_array('emojis', $enableattachementComment) )) {
