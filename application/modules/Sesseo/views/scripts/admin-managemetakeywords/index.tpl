...
<p>Here, you can enter the meta title, meta description and meta image for Search Engines for all the widgetized pages on your website.<br />The View pages of all the content and member profile page will have their own meta tags, so these tags will be appended to their tags automatically according to SE standards.</p>
<br class="clear" />
<?php //echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesseo', 'controller' => 'managemetakeywords', 'action' => 'add'), $this->translate("Add New Page"), array('class'=>'buttonlink sesbasic_icon_add'));
?>
<!--<br /><br />-->
    ...
    <tbody>
      <?php foreach ($this->paginator as $item): ?>
        ...
        <tr>
          ...
          <td>
            <?php $page = Engine_Api::_()->getItem('core_page', $item->page_id); ?>
            <?php if( !empty($item->page_id) ) { ?> 
              ...
              <a href="<?php echo $url; ?>" target="_blank"><?php echo $page->displayname; ?></a>
            <?php }else { ?>
            <?php echo '-'; } ?>
          </td>
          ...
          <td>
            <?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesseo', 'controller' => 'managemetakeywords', 'action' => 'enabled', 'managemetatag_id' => $item->managemetatag_id ), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disable'))), array())  : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesseo', 'controller' => 'managemetakeywords', 'action' => 'enabled', 'managemetatag_id' => $item->managemetatag_id ), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enable')))) ) ?>
          </td >
          <td>
            <!--<a href="<?php //echo $this->url(array('action' => 'delete', 'managemetatag_id' => $item->managemetatag_id)) ?>" class="smoothbox"><?php //echo $this->translate("Delete") ?></a> -->
            <a href="<?php echo $this->url(array('action' => 'edit', 'managemetatag_id' => $item->managemetatag_id, 'page_id' => $item->page_id)) ?>"><?php echo $this->translate("Edit") ?>
            </a>
          </td>
        </tr>
      <?php  endforeach; ?>
