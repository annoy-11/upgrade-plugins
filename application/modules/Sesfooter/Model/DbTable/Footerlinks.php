 ...
 * @version    $Id: Footerlinks.php 2015-12-12 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesfooter_Model_DbTable_Footerlinks extends Engine_Db_Table {

  protected $_rowClass = "Sesfooter_Model_Footerlink";

  public function getInfo($params = array()) {

    $socialTable = Engine_Api::_()->getDbTable('footerlinks', 'sesfooter');
