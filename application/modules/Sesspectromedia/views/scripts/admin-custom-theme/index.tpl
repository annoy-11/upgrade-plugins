...
<div class="admin_theme_editor_wrapper">
  <form action="<?php echo $this->url(array('action' => 'save')) ?>" method="post">
    <div class="admin_theme_edit">
      <?php if( $this->writeable['sesspectromedia'] ): ?>
        <div class="admin_theme_editor_edit_wrapper">
          ...
          <?php echo $this->formHidden('file', 'sesspectromedia-custom.css', array()) ?>
          <?php echo $this->formHidden('theme_id', 'sesspectromedia', array()) ?>
        </div>
      <?php else: ?>
        <div class="admin_theme_editor_edit_wrapper">
          <div class="tip">
