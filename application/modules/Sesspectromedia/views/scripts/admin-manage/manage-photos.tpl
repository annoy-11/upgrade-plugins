...
These images will only work with the 5th Header Design.") ?></p>
    <br />
    <div>
    <div class="sesbasic_search_reasult"><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesspectromedia', 'controller' => 'manage', 'action' => 'create-image'), $this->translate("Upload Image"), array('class'=>'buttonlink sesbasic_icon_add')); ?></div>
  </div>
  <?php if( count($this->paginator) ): ?>
  ...
  <?php if(count($this->paginator) > 0):?>
	...
	<?php foreach ($this->paginator as $item) : ?>
	  <li class="item_label" id="slide_<?php echo $item->headerphoto_id ?>">
	    ...
	    <div style="width:15%;">          
	      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesspectromedia', 'controller' => 'manage', 'action' => 'create-image', 'headerphoto_id' => $item->headerphoto_id,'id'=>$this->headerphoto_id), $this->translate("Edit"), array()) ?>
	      |
	      <?php echo $this->htmlLink(
	      array('route' => 'admin_default', 'module' => 'sesspectromedia', 'controller' => 'manage', 'action' => 'delete-image', 'id' => $item->headerphoto_id),
...
<style type="text/css">
  .sesspectromedia_manage_form_head > div,
  .sesspectromedia_manage_form_list li > div{
