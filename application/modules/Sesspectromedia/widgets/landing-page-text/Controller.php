...
class Sesspectromedia_Widget_LandingPageTextController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if(count($languageList) == '1') {
      $this->view->content = Engine_Api::_()->getApi('settings', 'core')->getSetting("sesspectromedia.landinapagetext.en", $contentText);
    } else {
      $this->view->content = Engine_Api::_()->getApi('settings', 'core')->getSetting("sesspectromedia.landinapagetext.$language", $contentText);
    }
  }
