 ...
 */
?>
<?php $showPopup = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesspectromedia.popup.enable', 1);

$popShow = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesspectromedia.popupshow', 1);
    ...
    <?php foreach( $this->navigation as $item ): $class = explode(' ', $item->class); ?>
      <?php if(end($class) == 'core_mini_signup'):  ?>
        <?php if(empty($popShow)): ?>
		      <li class="sm_minimenu_link sm_minimenu_link_signup">
      ...
      <?php elseif(end($class) == 'core_mini_auth' && $this->viewer->getIdentity() == 0): ?>
        ...
        <?php  elseif(end($class) == 'core_mini_friends'): ?>
           <?php $friendRequestIcon = Engine_Api::_()->getApi('menus', 'sesspectromedia')->getIconsMenu('core_mini_friends');?>
           <?php if($this->viewer->getIdentity()):?>
             <li class="sm_minimenu_request sm_minimenu_icon" title="<?php echo $this->translate('Friends Invitation');?>">
            <?php if($this->requestCount):?>
              <span id="request_count_new" class="sm_minimenu_count"><?php echo $this->requestCount ?></span>
            <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'friendrequest');" style="display:block;" class="friends_pulldown">
            <div id="friend_request" class="sm_pulldown_contents_wrapper">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="sm_pulldown_header">
                <?php echo $this->translate('Requests'); ?>
              </div>
              <div id="sm_friend_request_content" class="sm_pulldown_contents">
        ...
        <?php $notificationIcon = Engine_Api::_()->getApi('menus', 'sesspectromedia')->getIconsMenu('core_mini_notification');?>
        <?php if($this->viewer->getIdentity()):?>
          <li id='core_menu_mini_menu_update' class="sm_minimenu_updates sm_minimenu_icon" title="<?php echo $this->translate('Notifications');?>">
              <?php if($this->notificationCount):?>
                <span id="notification_count_new" class="sm_minimenu_count">
            ...
            <span onclick="toggleUpdatesPulldown(event, this, '4', 'notifications');" style="display:block;" class="updates_pulldown">
              <div class="sm_pulldown_contents_wrapper">
                <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
                <div class="sm_pulldown_header">
                  <?php echo $this->translate('Notifications'); ?>
                </div>
                <div class="sm_pulldown_contents pulldown_content_list">
      ...
      <?php elseif(end($class) == 'core_mini_profile'):?>
        <li class="sm_minimenu_profile" title="<?php echo $this->translate('My Profile');?>">
          <?php echo $this->htmlLink($item->getHref(), $this->itemPhoto($this->viewer(), 'thumb.icon')) ?>
        </li>
      <?php elseif(end($class) == 'core_mini_settings'):?>
        <?php $settingIcon = Engine_Api::_()->getApi('menus', 'sesspectromedia')->getIconsMenu('core_mini_settings');?>
        <li class="sm_minimenu_setting sm_minimenu_icon" title="<?php echo $this->translate('Settings');?>">
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'settings');" style="display:block;" class="settings_pulldown">
            <div id="user_settings" class="sm_pulldown_contents_wrapper sm-mini-menu-settings-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="sm_pulldown_header">
                <?php echo $this->translate('Account & Settings');?>
              </div>
              <div id="sm_user_settings_content" class="sm_pulldown_contents">
      ...
      <?php elseif(end($class) == 'core_mini_messages'):?>
        <?php $messageIcon = Engine_Api::_()->getApi('menus', 'sesspectromedia')->getIconsMenu('core_mini_messages');?>
        <li class="sm_minimenu_message sm_minimenu_icon" title="<?php echo $this->translate('Messages');?>">
          <?php if($this->messageCount):?>
            <span id="message_count_new" class="sm_minimenu_count"><?php echo $this->messageCount ?></span>
          <?php else:?>
          ...
          <span onclick="toggleUpdatesPulldown(event, this, '4', 'message');" style="display:block;" class="messages_pulldown">
            <div id="sm_user_messages" class="sm_pulldown_contents_wrapper sm-mini-menu-messages-pulldown">
              <div class="dropdown_caret"><span class="caret_outer"></span><span class="caret_inner"></span></div>
              <div class="sm_pulldown_header">
              ...
              <div id="sm_user_messages_content" class="sm_pulldown_contents">
...
<script type='text/javascript'>
  ...
  if('<?php echo $this->viewer->getIdentity();?>' == 0) {
			jqueryObjectOfSes(document).ready(function() {
				<?php $forcehide =  $settings->getSetting('sesspectromedia.popup.fixed', false); ?>
			...
			jqueryObjectOfSes.magnificPopup.instance.close = function () {
				var day = '<?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sesspectromedia.popup.day', 5);?>';
...
$popUpDesign = Engine_Api::_()->sesspectromedia()->getContantValueXML('sm_popup_design');
