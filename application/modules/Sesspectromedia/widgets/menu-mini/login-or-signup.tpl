...
<?php if($this->viewer->getIdentity() == 0) : ?>
	<link href="<?php echo $baseUrl; ?>application/modules/Sesspectromedia/externals/styles/magnific-popup.css" rel="stylesheet" />
  <script src="<?php echo $baseUrl; ?>application/modules/Sesspectromedia/externals/scripts/jquery.magnific-popup.js"></script>
<?php endif;?>
...
<?php if($this->viewer->getIdentity() == 0):?>
  <div id="small-dialog" class="mfp-zoom-in mfp-hide sm_quick_popup sm_quick_login_popup sesbasic_bxs">
    <div class="sm_popup_header clearfix">
      <ul class="sm_popup_header_tabs clearfix">
        <li class="tab-active">
    ...
    <div class="sm_quick_popup_content clearfix">
      <?php if(Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')):?>
        ...
        <div class="sm_social_login_btns ">
          <?php  echo $this->partial('_socialLoginIcons.tpl','sessociallogin',array()); ?>
        </div>
      <?php else: ?>
        <div class="sm_quick_popup_social_btns">
            ...
            <a href="<?php echo $href;?>" id="fbLogin" class="sm_quick_popup_social_btn_facebook">
          ...
          && $settings->core_twitter_secret):?>
            ...
            <a href="<?php echo $href;?>" id="googleLogin" class="sm_quick_popup_social_btn_twitter"><span><i class="fa fa-twitter"></i><?php echo $this->translate("Sign in with Twitter")?></span></a>
          <?php endif;?>
        </div>
      <?php endif;?>
      ...
      <div class="sm_quick_popup_form">
        <?php echo $this->content()->renderWidget("sesspectromedia.login-or-signup")?>
      </div>
    </div>
  </div>
  ...
  <?php if($controllerName != 'signup') { ?>
    <div id="user_signup_form" class="zoom-anim-dialog mfp-hide sm_quick_popup sm_quick_signup_popup sesbasic_bxs">
        ...
        <?php if(!Engine_Api::_()->getDbTable('modules','core')->isModuleEnabled('sessociallogin')): ?>
          <div class="sm_quick_popup_social_btns">
            <?php if ('none' != $settings->getSetting('core_facebook_enable', 'none') && $settings->core_facebook_secret):?>
              ...
              <?php endif;?>
              <?php $href = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'user', 'controller' => 'auth','action' => 'facebook'), 'default', true);?>
              <a href="<?php echo $href;?>" id="fbLogin" class="sm_quick_popup_social_btn_facebook"><span><i class="fa fa-facebook"></i><?php echo $this->translate("Sign up with Facebook")?></span></a>
            <?php endif;?>
            ...
            && $settings->core_twitter_secret):?>
              ...
              ->assemble(array('module' => 'user', 'controller' => 'auth',
              'action' => 'twitter'), 'default', true);?>
              <a href="<?php echo $href;?>" id="googleLogin" class="sm_quick_popup_social_btn_twitter"><span><i class="fa fa-twitter"></i><?php echo $this->translate("Sign up with Twitter")?></span></a>
            <?php endif;?>
          </div> 
        <?php endif; ?>
        <?php if(!empty($showSeparator)):?>
      ...
      <?php endif; ?>
          <?php echo $this->action("index", "signup", defined('sesquicksignup') ? "quicksignup" :"sesspectromedia", array('disableContent'=>true)) ?>
        </div>
      </div>
    </div>
  <?php } ?>
...
<?php if($this->viewer->getIdentity() == 0):?>
  <div id="small-dialog" class="mfp-zoom-in mfp-hide sm_quick_popup sm_quick_login_popup sesbasic_bxs">
    ...
    <div class="sm_quick_popup_footer sesbasic_clearfix">
    <?php if($controllerName != 'signup') { ?>
      <a class="popup-with-move-anim tab-link" href="#user_signup_form">
        <?php echo $this->translate("Sign Up");?>
      </a>
