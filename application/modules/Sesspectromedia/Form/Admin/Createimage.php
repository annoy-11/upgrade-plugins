...
class Sesspectromedia_Form_Admin_Createimage extends Engine_Form {
  public function init() {
    $this->setTitle('Upload New Image')
	  ->setDescription("Below, upload new image.")
	  ->setAttrib('id', 'form-create-slide')
	  ->setAttrib('name', 'sesspectromedia_create_image')
    ...
    $this->addElement('Cancel', 'cancel', array(
        ...
        'link' => true,
        'prependText' => ' or ',
        'href' => Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'sesspectromedia', 'controller' => 'manage', 'action' => 'manage-photos'), 'admin_default', true),
        'decorators' => array(
            'ViewHelper'
        )
    ));
