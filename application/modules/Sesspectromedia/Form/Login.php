 ...
 * @version    $Id: Login.php 2015-10-28 00:00:00 SocialEngineSolutions $

 * @author     SocialEngineSolutions

 */
class Sesspectromedia_Form_Login extends Engine_Form_Email {
    ...
    public function init() {
        ...
        $this->setAttrib('id', 'sesspectromedia_form_login');
