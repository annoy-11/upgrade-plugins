...
class seswishe_Widget_BrowseSearchController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $seswishe_browsesearch = Zend_Registry::isRegistered('seswishe_browsesearch') ? Zend_Registry::get('seswishe_browsesearch') : null;
    if(empty($seswishe_browsesearch)) {
