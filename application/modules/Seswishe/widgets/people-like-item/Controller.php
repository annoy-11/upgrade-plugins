 ...
 */
class Seswishe_Widget_PeopleLikeItemController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->seswishe()->likeItemCore($param);
