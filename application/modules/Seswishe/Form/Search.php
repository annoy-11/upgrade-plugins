...
class Seswishe_Form_Search extends Engine_Form
{
  public function init()
  {
    ...
    if($getActionName != 'manage') {
      ...
      $this->addElement('Select', 'show', array(
        ...
        'multiOptions' => array(
          '1' => 'Everyone\'s Wishes',
          '2' => 'Only My Friends\' Wishes',
        ),
      ));
    }

    if(Engine_Api::_()->getApi('settings', 'core')->getSetting('seswishe.enablecategory', 1)) {
      $categories =  $categories = Engine_Api::_()->getDbtable('categories', 'seswishe')->getCategoriesAssoc(array('uncategories' => true));
    ...
    $this->addElement('Dummy','loading-img-seswishe', array(
        'content' => '<img src="application/modules/Core/externals/images/loading.gif" id="seswishe-category-widget-img" alt="Loading" />',
        'order' => 10000003,
    ));
