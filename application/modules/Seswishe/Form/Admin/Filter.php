...
class Seswishe_Form_Admin_Filter extends Engine_Form {
  ...
  public function init() {
    ...
    $categories = Engine_Api::_()->getDbtable('categories', 'seswishe')->getCategory(array('column_name' => '*'));
    ...
    $this->addElement('Hidden', 'wishe_id', array(
        'order' => 10003,
    ));
