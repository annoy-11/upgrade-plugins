...
{
  return confirm("<?php echo $this->translate('Are you sure you want to delete the selected wishe entries?');?>");
}
...
<h3>Manage Wishes</h3>
<p>
  <?php echo $this->translate("This page lists all of the wishes your users have created. You can use this page to monitor these wishes and delete offensive material if necessary. Entering criteria into the filter fields will help you find specific wishe. Leaving the filter fields blank will show all the wishes on your social network. ") ?>
</p>
<br />
...
<div class="sesbasic_search_reasult">
  <?php echo $this->translate(array('%s wishe found.', '%s wishes found.', $this->paginator->getTotalItemCount()), $this->locale()->toNumber($this->paginator->getTotalItemCount())) ?>
</div>
    ...
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        ...
        <td class="admin_table_centered">
          ...
          Engine_Api::_()->getDbtable('wishes', 'seswishe')->update(array(
          'offtheday' => 0,
          'starttime' =>'',
          'endtime' =>'',
          ), array(
          "wishe_id = ?" => $item->wishe_id,
          ));
          $itemofftheday = 0;
          } else
          $itemofftheday = $item->offtheday; ?>
          <?php if($itemofftheday == 1):?>  
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seswishe', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->wishe_id, 'type' => 'wishe', 'param' => 0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Edit Video of the Day'))), array('class' => 'smoothbox')); ?>
          <?php else: ?>
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seswishe', 'controller' => 'admin-manage', 'action' => 'oftheday', 'id' => $item->wishe_id, 'type' => 'wishe', 'param' => 1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Make Video of the Day'))), array('class' => 'smoothbox')) ?>
          <?php endif; ?>
        </td>
        ...
        <td>
          ...
          |
          <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'seswishe', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->wishe_id), $this->translate("delete"), array('class' => 'smoothbox')); ?>
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
...
<?php else: ?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no wishe entries posted by your members yet.") ?>
    </span>
  </div>
<?php endif; ?>
