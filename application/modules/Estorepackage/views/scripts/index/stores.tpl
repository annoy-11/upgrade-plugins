 ...
 * @version    $Id: stores.tpl 2019-11-05 00:00:00 socialnetworking.solutions $
...
<?php if(count($this->package)){  ?>
	<div class="estore_packages_main sesbasic_clearfix sesbasic_bxs">
      ...
      <p><?php echo $this->translate('Select a package that suits you most to start creating stores on this website.');?></p>
    </div>
    <div class="estore_packages_table_container">
