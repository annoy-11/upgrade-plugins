 ...
 * @version    $Id: _packagesHorizontal.tpl 2019-11-05 00:00:00 socialnetworking.solutions $
   ...
   <div class="_top sesbasic_clearfix">
    ...
    <div class="_btns sesbasic_clearfix">
      <?php if($existing && !$package->isOneTime()):?>
        <div class="_left">
          <a href="<?php echo $this->url(array('action' => 'cancel','package_id' => $package->package_id),'estorepackage_general',true);?>" class="estore_packages_cancel_btn smoothbox"><?php echo $this->translate("Cancel");?></a>
      ...
      <div class="_right">
        <?php if($existing):?>
          <a class="estore_packages_create_btn sesbasic_animation" href="<?php echo $this->url(array('action' => 'create', 'existing_package_id' => $packageleft->getIdentity()),'estore_general',true); ?>"><?php echo $this->translate('Create Store');?></a>
        <?php else:?>
          <a class="estore_packages_create_btn sesbasic_animation" href="<?php echo $this->url(array('action' => 'create', 'package_id' => $package->package_id),'estore_general',true); ?>"><?php echo $this->translate('Create Store');?></a>
        <?php endif;?>
      </div>
    </div>
  </section>
