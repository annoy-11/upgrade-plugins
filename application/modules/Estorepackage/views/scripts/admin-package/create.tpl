 ...
 * @version    $Id: create.tpl 2019-11-05 00:00:00 socialnetworking.solutions $
...
<div class="sesbasic_search_result">
  <?php echo $this->htmlLink($this->url(array('module' => 'estorepackage', 'controller' => 'package','action'=>'index')), $this->translate("Back to Manage Packages"), array('class' => 'buttonlink sesbasic_icon_back')); ?>
</div><br />
