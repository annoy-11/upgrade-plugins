 ...
 * @version    $Id: _customFields.tpl 2019-11-05 00:00:00 socialnetworking.solutions $
...
<?php $options = Engine_Api::_()->getDbTable('options','estore')->getAllOptions();
	if(count($options)){ ?>
<div id="custom-fields-container" style="display:none;">
  <?php foreach($options as $valueOptions){
      ...
      $metaValues = Engine_Api::_()->getDbTable('metas','estore')->getMetaData($valueOptions['option_id']);
      if(!count($metaValues))
      	continue;
   ?>
   <div>
