 ...
 * @version    $Id: Stripe.php 2019-11-05 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
include_once APPLICATION_PATH . "/application/modules/Sesadvpmnt/Api/Stripe/init.php";
class Estorepackage_Plugin_Gateway_Stripe extends Engine_Payment_Plugin_Abstract
{
  ...
  public function createStoreTransaction(User_Model_User $user,
  ...
  public function onStoreTransactionReturn(
    Payment_Model_Order $order, $params, $bankTransfer = false) {
    ...
    if ($package->isOneTime()) {
      ...
      if (($paymentStatus == 'okay' || $paymentStatus == 'active' ||
        ...
        $transaction->gateway_profile_id = !$bankTransfer ? $response->id : '';
        $transaction->save();
        // Payment success
        if(!$bankTransfer)
