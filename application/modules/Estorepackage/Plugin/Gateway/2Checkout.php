 ...
 * @version    $Id: 2Checkout.php 2019-11-05 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Estorepackage_Plugin_Gateway_2Checkout extends Engine_Payment_Plugin_Abstract {
  ...
  function createStoreTransaction(User_Model_User $user, Zend_Db_Table_Row_Abstract $item, Estorepackage_Model_Package $package, array $params = array()) {
    // Do stuff to params
    $params['fixed'] = true;
  ...
  Payment_Model_Order $order, array $params = array()) {
    ...
    if (!empty($oldOrderPackageId)) {
      $select = $tablePage->select()->from($tableStore->info('name'))->where('orderspackage_id =?', $oldOrderPackageId);
