 ...
 * @version    $Id: myfriendwishes.tpl 2014-11-15 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function viewMore() {
    ...
    en4.core.request.send(new Request.HTML({
      method: 'post',
      'url': en4.core.baseUrl + 'seschristmas/welcome/myfriendwishes/',
      'data': {
        format: 'html',
        page: nextResult(),
        viewmore: 1        
      ...
      onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {      
        ...
        document.getElementById('friends_wishes').innerHTML = document.getElementById('friends_wishes').innerHTML + responseHTML;
...
<?php if (empty($this->viewmore)): ?>
  <div class="seschristmas_wish_board" id="friends_wishes"> 
      <?php if($this->viewer_id && empty($this->has_wish)): ?>
        <div class="seschristmas_button_wrap">
          <?php echo $this->htmlLink(array('route' => 'seschristmas_general', 'module' => 'seschristmas', 'controller' => 'welcome', 'action' => 'create', 'widget' => '1'), $this->translate('Make a Wish'), array('onclick' => 'smoothbox_ajax(this);return false', 'class' => 'seschristmas_button')) ?>
        </div>
      <?php endif; ?>
      <?php if(!empty($this->has_wish) && $this->viewer_id == $this->owner_id): ?>
        <div class="seschristmas_button_wrap">
          <?php echo $this->htmlLink(array('route' => 'seschristmas_general', 'action' => 'edit', 'christmas_id' => $this->has_wish, 'widget' => '1'), $this->translate('Edit your Wish'), array('onclick' => 'smoothbox_ajax(this);return false', 'class' => 'seschristmas_button')) ?>
        </div>
      <?php endif; ?>
    <?php endif; ?>
    <?php if (count($this->paginator) > 0 && $this->friendcount > 0) : ?>
