 ...
 * @version    $Id: currency.tpl  2018-09-05 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

?>
<?php include APPLICATION_PATH .  '/application/modules/Sesmultiplecurrency/views/scripts/dismiss_message.tpl';?>
...
<div>
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmultiplecurrency', 'controller' => 'settings', 'action' => 'update-currency'),'Update Currency Values', array('class' => 'buttonlink sesbasic_icon_edit')) ?>
</div>
<br />
<div class='clear'>
    ...
    <tbody>
        <?php $i =1;
          ...
          <tr>
            ...
            <td class="admin_table_centered"><?php $getSetting = $settings->getSetting('sesmultiplecurrency.'.$key);
            if($getSetting != '')
              echo $getSetting;
            else
              echo "-";
             ...
             <?php if($key != $settings->getSetting('sesmultiplecurrency.defaultcurrency','USD')){ ?>
             	 <?php if($settings->getSetting('sesmultiplecurrency.'.$key.'active','0')): ?>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmultiplecurrency', 'controller' => 'settings', 'action' => 'active', 'id' => $key), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title'=> $this->translate('Disable')))) ?>
              <?php else: ?>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmultiplecurrency', 'controller' => 'settings', 'action' => 'active', 'id' => $key), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/error.png', '', array('title'=> $this->translate('Enable')))) ?>
              <?php endif; ?>
             <?php }else{ ?>
             		-
             <?php } ?>
            ...
            <?php echo $this->htmlLink(
                array('route' => 'admin_default', 'module' => 'sesmultiplecurrency', 'controller' => 'settings', 'action' => 'edit-currency', 'id' => $key),
                $this->translate("edit"),
