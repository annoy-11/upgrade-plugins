 ...
 * @version    $Id: Message.php  2019-04-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sessportz_Api_Message extends Core_Api_Abstract
{
  ...
  public function setUnreadMessage(Core_Model_Item_Abstract $user) {
    $userLastNotification = Engine_Api::_()->getApi('message', 'sessportz')->getUserLastMessage($user);
