 ...
 * @version    $Id: AdminManageNewsletterController.php  2019-04-16 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sessportz_AdminManageNewsletterController extends Core_Controller_Action_Admin {

    public function sendNewsletterAction() {

        $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sessportz_admin_main', array(), 'sessportz_admin_main_mansemail');

        $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sessportz_admin_main_mansemail', array(), 'sessportz_admin_main_managesendnews');

        $this->view->form = $form = new Sessportz_Form_Admin_Mail();
        ...
        $table = Engine_Api::_()->getItemTable('sessportz_newsletteremail');
...
//         }
    ...
    public function indexAction() {
        ...
        $this->view->subnavigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sessportz_admin_main_mansemail', array(), 'sessportz_admin_main_managenewsemails');

        $this->view->formFilter = $formFilter = new Sessportz_Form_Admin_Filter();
        $page = $this->_getParam('page', 1);

        $newletrtable = Engine_Api::_()->getDbTable('newsletteremails', 'sessportz');
    ...
    public function sendnewsletteremailAction() {
        ...
        $newsletteremail = Engine_Api::_()->getItem('sessportz_newsletteremail', $id);

        $this->view->form = $form = new Sessportz_Form_Admin_SendEmail();
    ...
    public function deleteAction() {
        ...
        $db->beginTransaction();
        try {
            $item = Engine_Api::_()->getItem('sessportz_newsletteremail', $id);
            $item->delete();
            $db->commit();
        } catch (Exception $e) {
            $db->rollBack();
