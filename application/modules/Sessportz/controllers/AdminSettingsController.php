    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      if (Engine_Api::_()->getApi('settings', 'core')->getSetting('sessportz.pluginactivated')) {
        ...
        foreach ($values as $key => $value) {
          ...
          if ($key == 'sessportz_popup_design' || $key == 'sessportz_user_photo_round' || $key == 'sessportz_main_width' || $key == 'sessportz_left_columns_width' || $key == 'sessportz_header_fixed_layout' || $key == 'sessportz_right_columns_width' || $key == 'sessportz_responsive_layout' || $key == 'sessportz_body_background_image') {
