...
<?php if(!empty($this->viewer_id)) { ?>
  <style>
    .layout_page_footer{
      background-image:url('<?php echo $this->footerbgimage; ?>');
    ...
    <?php if($settings->getSetting('sessportz.con.location', '') || $settings->getSetting('sessportz.con.phone', '') || $settings->getSetting('sessportz.con.email', '')) { ?>
      ...
      <h3><?php echo $this->translate("Contact us"); ?></h3>
        <div class="contact_info">
          ...
          <div class="cont_block">
            <a href="mailto:<?php echo $settings->getSetting('sessportz.con.email', '') ?>"><i class="fa fa-envelope-o"></i><?php echo $settings->getSetting('sessportz.con.email', '') ?></a>
          </div>
          <?php } ?>
        </div>
      </div>
