 ...
 * @package    Core
 * @copyright  Copyright 2018-2019 Webligo Developments
 * @license    http://www.socialengine.com/license/
 * @version    $Id: index.tpl 10002 2018-11-24 22:30:42Z jung $
 * @author     John
 */
...
<script type="text/javascript">
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'content', 'module' => 'sespwa'), 'admin_default', true)?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'content', 'module' => 'sespwa'), 'admin_default', true)?>';
  ...
  var saveCurrentPageInfo = function(formElement) {
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'content', 'module' => 'sespwa'), 'admin_default', true)?>';
  ...
  var deleteCurrentPage = function() {
    ...
    var url = '<?php echo $this->url(array('action' => 'delete', 'controller' => 'content', 'module' => 'sespwa'), 'admin_default', true)?>';
    var request = new Request.JSON({
      'url' : url,
      'data' : {
        'format' : 'json',
