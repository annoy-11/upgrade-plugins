 ...
 * @version    $Id: inbox.tpl  2018-11-24 00:00:00 SocialEngineSolutions $
...
<?php if( count($this->paginator) ): ?>
  ...
  <div class="pulldown_options">
    <div><a href="<?php echo $this->url(array('action' => 'inbox'), 'messages_general', true) ?>"><?php echo $this->translate("View All Messages") ?></a></div>
    <div><a href="javascript:void(0);" onclick="markallmessage();"><?php echo $this->translate("Mark All Read") ?></a></div>
   </div>
<?php endif; ?>
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sespwa/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sespwa_messages_menu')){
          var message_children = $('sespwa_messages_menu').getChildren('li');
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sespwa/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
