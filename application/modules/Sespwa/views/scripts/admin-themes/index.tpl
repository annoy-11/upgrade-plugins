...
<h2><?php echo $this->translate("Theme Editor") ?></h2>
<br />
...
<div class="admin_theme_editor_wrapper">
            ...
            <div class="admin_theme_header_controls">
                ...
                <div>
                    <?php if (!empty($this->manifest[$this->activeTheme->name]['colorVariants'])): ?>
                        <?php //echo $this->htmlLink(array('route'=>'admin_default', 'controller'=>'themes', 'action'=>'create-color-variant', 'name' => $this->activeTheme->name),$this->translate('Color Variants'), array('class' => 'buttonlink admin_themes_header_customize',));
                        ?>
                    <?php endif; ?>
    ...
    <div class="admin_theme_chooser">
        ...
        <div class="admin_theme_editor_chooser_wrapper sespwa_themes_list">
