...
class Sescontestjoinfees_Form_Admin_Global extends Engine_Form {
  public function init() {
    ...
    $this->addElement('Text', "sescontestjoinfees_licensekey", array(
        'label' => 'Enter License key',
        'description' => $descriptionLicense,
        'allowEmpty' => false,
        'required' => true,
        'value' => $settings->getSetting('sescontestjoinfees.licensekey'),
    ));
    $this->getElement('sescontestjoinfees_licensekey')->getDecorator('Description')->setOptions(array('placement' => 'PREPEND', 'escape' => false));
