 ...
 */
class Sescontestjoinfees_Plugin_Gateway_PayPal extends Engine_Payment_Plugin_Abstract
{
  ...
  public function getGateway()
  {
    if( null === $this->_gateway ) {
      ...
      $gateway = new $class(array(
        ...
        'currency' => Engine_Api::_()->sescontestjoinfees()->getCurrentCurrency(),
      ));
   ...
   * @param Zend_Db_Table_Row_Abstract $contest
   * @param array $params
   * 
	*/
  ...
  public function onIpn(Engine_Payment_Ipn $ipn)
  {
    ...
    if( $order ) {
      $ipnProcessed = false;
      // Subscription IPN
      if( $order->source_type == 'sescontestjoinfees_order' ) {
  ...
  {
    return new Sescontestjoinfees_Form_Admin_Gateway_PayPal();
  }
