...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <?php endif; ?>
    <h3><?php echo $this->translate("Payments Made to Contest Owners") ?></h3>
        ...
        <table class='admin_table'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sescontestjoinfees', 'controller' => 'admin-settings', 'action' => 'view-paymentrequest', 'id' => $item->userpayrequest_id), $this->translate("View Details"), array('class' => 'smoothbox')) ?>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
