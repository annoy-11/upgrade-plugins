...
<?php if( count($this->paginator) ): ?>
  <div class="pulldown_content_list">
    <ul id="sesfbstyle_messages_menu">
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesfbstyle/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sesfbstyle_messages_menu')){
          var message_children = $('sesfbstyle_messages_menu').getChildren('li');
//           console.log(message_children);
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesfbstyle/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
