...
<script>
  ajaxurl = en4.core.baseUrl+"admin/sesfbstyle/manage/change-order";
</script>
...
<div class='settings sesbasic_admin_form'>
  <form class="global_form">
    <div>
      ...
      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'addheading'), $this->translate('Add Category'), array('class' => 'smoothbox sesbasic_icon_add buttonlink')); ?><br /><br />
      <?php if(count($this->paginator)>0):?>
        <div class="sesfbstyle_dashboard_links">
            ...
            <tbody>
              <?php foreach ($this->paginator as $category): ?>
                <tr data-article-id="<?php echo $category->getIdentity(); ?>">
                  ...
                  <td>
                    <?php echo ( $category->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'enabled-link', 'dashboardlink_id' => $category->dashboardlink_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disable'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'enabled-link', 'dashboardlink_id' => $category->dashboardlink_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enable')))) ) ?>
                  </td>
                  <td>
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'editheading', 'dashboardlink_id' => $category->dashboardlink_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?>
                    <?php //if($category->dashboardlink_id != 1): ?> |
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'addsublink', 'dashboardlink_id' => $category->dashboardlink_id), $this->translate('Add New Sub Link'), array('class' => 'smoothbox')); ?><?php //endif; ?>
                    |
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'delete', 'dashboardlink_id' => $category->dashboardlink_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
                  </td>
                </tr>
                <?php $manageSubLinks = Engine_Api::_()->getDbTable('dashboardlinks', 'sesfbstyle')->getInfo(array('sublink' => $category->dashboardlink_id)); ?>
                  ...
                  <tr data-article-id="<?php echo $sub_category->getIdentity(); ?>">
                    ...
                    <td>
                      <?php if(empty($sub_category->icon_type) && !empty($sub_category->file_id)): ?>
                        ...
                        if($photo) {
                        $photo = $photo->map(); ?>
                          <img class="sesfbstyle_manangemenu_icon" alt="" src="<?php echo $photo ?>" />
                        <?php } else { ?>
                          <?php echo "---"; ?>
                        <?php } ?>
                    ...
                    <td>
                      <?php echo ( $sub_category->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'enabled-link', 'dashboardlink_id' => $sub_category->dashboardlink_id, 'sublink' => $sub_category->sublink), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disabled'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'enabled-link', 'dashboardlink_id' => $sub_category->dashboardlink_id, 'sublink' => $sub_category->sublink), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enabled')))) ) ?>
                    </td>
                    <td>
                      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'editlink', 'dashboardlink_id' => $sub_category->dashboardlink_id, 'sublink' => $sub_category->sublink), $this->translate("Edit"), array('class' => 'smoothbox')) ?> |
                      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesfbstyle', 'controller' => 'manage', 'action' => 'deletesublink', 'dashboardlink_id' => $sub_category->dashboardlink_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
                    </td>
                  </tr>
                <?php endforeach; ?>
              <?php endforeach; ?>
