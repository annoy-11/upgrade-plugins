...
class Sesfbstyle_Form_Admin_CustomTheme extends Engine_Form {
  ...
  public function init() {
    ...
    $getCustomThemes = Engine_Api::_()->getDbTable('customthemes', 'sesfbstyle')->getCustomThemes(array('all' => 1));
