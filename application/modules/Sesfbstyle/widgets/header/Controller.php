...
class Sesfbstyle_Widget_headerController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->viewer_id = $viewerId = $viewer->getIdentity();
		...
		$loggedinHeaderCondition = unserialize(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesfbstyle.headerloggedinoptions', 'a:4:{i:0;s:6:"search";i:1;s:8:"miniMenu";i:2;s:8:"mainMenu";i:3;s:4:"logo";} '));
    $nonloggedinHeaderCondition = unserialize(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesfbstyle.headernonloggedinoptions', 'a:3:{i:0;s:8:"miniMenu";i:1;s:8:"mainMenu";i:2;s:4:"logo";}'));
    ...
    $sesfbstyle_header = Zend_Registry::isRegistered('sesfbstyle_header') ? Zend_Registry::get('sesfbstyle_header') : null;
    if(empty($sesfbstyle_header)) {
...
// Languages
    ...
    $this->view->headerlogo = $settings->getSetting('sesfbstyle.headerlogo', '');
    $this->view->siteTitle = $settings->getSetting('core.general.site.title', 'My Community');
    $this->view->sidepaneldesign = $settings->getSetting('sesfbstyle.sidepaneldesign', 1);
    $this->view->footersidepanel = $settings->getSetting('sesfbstyle.footersidepanel', 1);
    ...
    if ($viewer->getIdentity()) {
      ...
      $this->view->messageCount = Engine_Api::_()->getApi('message', 'sesfbstyle')->getMessagesUnreadCount($viewer);
