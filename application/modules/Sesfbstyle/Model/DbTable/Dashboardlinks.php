...
class Sesfbstyle_Model_DbTable_Dashboardlinks extends Engine_Db_Table {

  protected $_rowClass = "Sesfbstyle_Model_Dashboardlink";

  public function getInfo($params = array()) {

    $socialTable = Engine_Api::_()->getDbTable('dashboardlinks', 'sesfbstyle');
