 ...
 * @version    $Id: edit.tpl  2019-01-18 00:00:00 SocialEngineSolutions $
...
<div>
  <?php echo $this->htmlLink(array('module' => 'sescredit','controller' => 'offers'), $this->translate("Back to Manage Offers"),array('class' => 'buttonlink sesbasic_icon_back')) ?>
</div>
<br />
