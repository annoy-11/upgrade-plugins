...
<div>
  <?php echo $this->htmlLink(array('route' => 'admin_default','module' => 'sespagebuilder','controller' => 'popups'), $this->translate("Back to Manage Modal Windows"),array('class' => 'buttonlink sesbasic_icon_back')) ?>
</div>
<br />
