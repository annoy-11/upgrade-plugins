...
<div>
  <?php echo $this->htmlLink(array('route' => 'admin_default','module' => 'sespagebuilder','controller' => 'manage'), $this->translate("Back to Manage Pages"),array('class' => 'buttonlink sesbasic_icon_back')) ?>
</div>
<br />
...
<script type="text/javascript">
  ...
  jqueryObjectOfSes('body').click(function(event) {
	...
	'pagebuilder_id' : '<?php echo $this->pagebuilder_id;?>'
      },
