 ...
 * @version    $Id: duplicate-progressbar.tpl 2015-07-31 00:00:00 SocialEngineSolutions $
...
<form method="post" class="global_form_popup">
  <div>    
    <div class="tip">
      <span>
        <?php echo $this->translate("Are you sure want to duplicate this progress bar value?") ?>
      </span>
    </div>
