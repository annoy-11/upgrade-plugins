 ...
 * @version    $Id: Integrateothersmodules.php  2018-12-07 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Seslike_Model_DbTable_Integrateothersmodules extends Engine_Db_Table {

  protected $_rowClass = 'Seslike_Model_Integrateothersmodule';
  ...
  public function getResults($params = array()) {
    ...
    $select = $this->select()->from($this->info('name'), $columnName);
