...
<br class="clear" />
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslike', 'controller' => 'integrateothermodules', 'action' => 'addmodule'), $this->translate("Add New Plugin"), array('class'=>'buttonlink sesbasic_icon_add'));
?>
<br /><br />
  ...
  <table class='admin_table'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslike', 'controller' => 'integrateothermodules', 'action' => 'enabled', 'integrateothersmodule_id' => $item->integrateothersmodule_id ), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disable'))), array())  : $this->htmlLink(array('route' => 'admin_default', 'module' => 'seslike', 'controller' => 'integrateothermodules', 'action' => 'enabled', 'integrateothersmodule_id' => $item->integrateothersmodule_id ), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enable')))) ) ?></td >
        <td>
