...
<?php if(!$this->is_ajax) { ?>
  <div class="sesbasic_clearfix sesbasic_bxs sesbasic_sidebar_block">
    <div class="seslike_small_tabs sesbasic_filter_tabs sesbasic_clearfix" <?php if(count($this->defaultOptions) ==1){ ?> style="display:none" <?php } ?>> 
		...
		<?php if($this->loadOptionData != 'pagging') { ?>
			...
			function viewMore_<?php echo $randonNumber; ?> (){
				...
				requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
					method: 'post',
					'url': en4.core.baseUrl + "widget/index/mod/seslike/name/tabbed-widget/openTab/" + openTab_<?php echo $randonNumber; ?>,
					'data': {
						format: 'html',
    ...
    function changeTabSes_<?php echo $randonNumber; ?>(valueTab){
      ...
      if(valueTab){
        ...
        requestTab_<?php echo $randonNumber; ?> = new Request.HTML({
          method: 'post',
          'url': en4.core.baseUrl+"widget/index/mod/seslike/name/tabbed-widget/openTab/"+valueTab,
          'data': {
            format: 'html',  
            params : params<?php echo $randonNumber; ?>, 
            is_ajax : 1,
