 ...
 */
class Seslike_Widget_mycontentlikeController extends Engine_Content_Widget_Abstract {

    public function indexAction() {

        $this->view->identityForWidget = isset($_POST['identity']) ? $_POST['identity'] : '';

        $defaultOptionsArray = Engine_Api::_()->seslike()->getModulesEnable();
        unset($defaultOptionsArray['user']);
        ...
        $select = Engine_Api::_()->getDbTable('likes', 'seslike')->getMyContentLikeResults(array('viewer_id' => $viewer_id, 'resource_type' => $resource_type, 'type' => key($defaultOptionsArray), PHP_EOL));
