 ...
 */
class Seslike_Widget_myfriendcontentlikeController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $select = Engine_Api::_()->getDbTable('likes', 'seslike')->getLikeResults(array('viewer_id' => $viewer_id, 'resource_type' => $resource_type, 'type' => key($defaultOptionsArray), PHP_EOL, 'widgetname' => 'myfriendcontentlike'));
