 ...
 * @version    $Id: install.php  2018-09-29 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesavatar_Installer extends Engine_Package_Installer_Module {
...
//   }
  ...
  function onEnable() {
    ...
    $db->query("UPDATE `engine4_user_signup` SET `enable` = '1' WHERE `engine4_user_signup`.`class` = 'Sesavatar_Plugin_Signup_Avatar';");
  ...
  public function onDisable() {
    ...
    $db->query("UPDATE `engine4_user_signup` SET `enable` = '0' WHERE `engine4_user_signup`.`class` = 'Sesavatar_Plugin_Signup_Avatar';");
