 ...
 * @version    $Id: BrowseTeamPageSettings.php 2015-03-10 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesteam_Form_Admin_BrowseTeamPageSettings extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Radio', 'sesteam_template', array(
        ...
        'multiOptions' => array(
            1 => '<a href="' . $tempalte1 . '" class="" target="_blank">Design - 1</a>',
