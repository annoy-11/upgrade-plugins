 ...
 */
class Sesteam_Form_Admin_Addteammembers extends Engine_Form {

  public function init() {

    $type = Zend_Controller_Front::getInstance()->getRequest()->getParam('type');
    $this->setTitle('Add New Team Member')
            ->setMethod('POST');
    ...
    $team = Engine_Api::_()->getItem('sesteam_teams', $team_id);
    $photo_id = 0;
    ...
    $this->addElement('Cancel', 'cancel', array(
        ...
        'link' => true,
        'prependText' => ' or ',
        'href' => Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module' => 'sesteam', 'controller' => 'manage', 'action' => 'index'), 'admin_default', true),
        'onclick' => '',
        'decorators' => array(
            'ViewHelper',
        ),
