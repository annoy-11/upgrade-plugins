...
<div class='clear settings'>
  <form id='multidelete_form' method="post" action="<?php echo $this->url(array('module' => 'sesteam', 'controller' => 'manage', 'action' => 'multi-delete'), 'admin_default'); ?>" onSubmit="return multiDelete()">
    <div>
      <h3><?php echo $this->translate("Manage Site Team Members"); ?></h3>
      <p><?php echo $this->translate('Here, you can choose members of your website to be shown as Team Members. You can choose a new team members by using the "Add New Team Member" link below. To reorder the Team members, click on the desired row and drag them up or down.') ?></p>
      <br />
      <div>
        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesteam', 'controller' => 'manage', 'action' => 'add-team-member'), $this->translate('Add New Team Member'), array('class' => ' buttonlink sesteam_icon_user'))
        ?><br/>
      </div><br />
          ...
          <ul class="sesteam_manage_designations_list" id='menu_list'>
            ...
            $user = $this->item('user', $item->user_id); ?>
              <li class="item_label" id="teams_<?php echo $item->team_id ?>">
                ...
                <div style="width:15%;">          
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesteam', 'controller' => 'manage', 'action' => 'edit', 'team_id' => $item->team_id), $this->translate('Edit'), array('class' => '')) ?> |
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesteam', 'controller' => 'manage', 'action' => 'delete', 'team_id' => $item->team_id), $this->translate('Remove'), array('class' => 'smoothbox')) ?>
                </div>
              </li>
            <?php endforeach; ?>
          </ul>
