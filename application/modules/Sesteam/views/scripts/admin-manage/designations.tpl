 ...
 * @version    $Id: designations.tpl 2015-02-20 00:00:00 SocialEngineSolutions $
...
<div class='clear settings'>
  <form id='multidelete_form' method="post" action="<?php echo $this->url(array('action' => 'multi-delete-designations'));?>" onSubmit="return multiDelete()">
    <div>
      ...
      <br />
      <div>
        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesteam', 'controller' => 'manage', 'action' => 'adddesignation'), $this->translate('Add New Designation'), array('class' => 'buttonlink smoothbox sesbasic_icon_add')); ?>
      </div><br />
      <?php if(count($this->paginator) > 0):?>
        <div class="sesteam_manage_designations" style="width:60%">
              ...
              <li class="item_label" id="designations_<?php echo $item->designation_id ?>">
                ...
                <div style="width:30%;">          
                  <?php echo $this->htmlLink(
                    array('route' => 'default', 'module' => 'sesteam', 'controller' => 'admin-manage', 'action' => 'editdesignation', 'designation_id' => $item->designation_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?> |
                    <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesteam', 'controller' => 'admin-manage', 'action' => 'deletedesignation', 'designation_id' => $item->designation_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
                </div>
              </li>
            <?php endforeach; ?>
          </ul>
