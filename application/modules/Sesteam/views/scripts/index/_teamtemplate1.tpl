 ...
 * @version    $Id: _tematemplate1.tpl 2015-02-20 00:00:00 SocialEngineSolutions $
...
<div class="sesteam_temp1_wrap">
  <?php if(!$this->is_ajax){ ?>
    ...
    <?php endif; ?>
  <?php } ?>
  <div id="browse-team-widget" class="sesteam_temp1_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
<?php } ?>
