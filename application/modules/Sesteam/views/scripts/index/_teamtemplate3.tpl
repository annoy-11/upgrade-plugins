 ...
 * @version    $Id: _tematemplate3.tpl 2015-02-20 00:00:00 SocialEngineSolutions $
...
<div class="sesteam_temp3_wrap">
  <?php if(!$this->is_ajax){ ?>
    ...
    <?php endif; ?>
  <?php } ?>
  <div id="browse-team-widget" class="sesteam_temp3_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
<?php } ?>
