...
<div class="sesteam_member_profile_wrapper clear sesbasic_clearfix">
  ...
  <?php if($user->type != 'teammember'): ?>
    ...
    <div class="sesteam_member_profile_contact_info">
      <?php if($user->email && in_array('email', $this->infoshow)): ?>
        <span class="clear sesbasic_clearfix">
          <a href="mailto:<?php echo $user->email ?>" title="<?php echo $user->email ?>"><i class="fas fa-envelope sesbasic_text_light"></i><?php echo $user->email; ?>
        	</a> 
        </span>
    	<?php endif; ?>
    ...
    <div class="sesteam_member_profile_social_icon sesteam-social-icon">
      <?php if($user->email && in_array('email', $this->infoshow)): ?>
      <a href="mailto:<?php echo $user->email ?>" title="<?php echo $user->email; ?>"><i class="fas fa-envelope sesbasic_text_light"></i>
      </a> 
      <?php endif; ?>
    ...
    <?php if(!empty($this->infoshow)): ?>
      ...
      <?php if($user->type == 'teammember'): ?>
          ...
          <div class="sesteam_member_profile_contact_info">
            <?php if($user->email && in_array('email', $this->infoshow)): ?>
              <span>
                <a href="mailto:<?php echo $user->email ?>" title="<?php echo $user->email ?>"><i class="fas fa-envelope sesbasic_text_light"></i><?php echo $user->email ?></a> 
              </span>
            <?php endif; ?>
