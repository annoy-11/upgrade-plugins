...
array(
  ...
  array(
    ...
    'description' => 'Displays breadcrumb for Blog. This widget should be placed on the Sesblog - View page of the selected content type.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
    ...
    'description' => 'Displays blog custom fields for Blog. This widget should be placed on the Sesblog - View page of blog.',
    'category' => 'SNS - Advanced Blog',
    'type' => 'widget',
				...
				array(
					...
					array(
						...
						'multiOptions' => array(
							...
							'photo' => 'Blog Photo',
							'socialShare' => 'Social Share Buttons <a class="smoothbox" href="admin/sesbasic/settings/faqwidget">[FAQ]</a> (For Blog Profile Page 1)',
							'ownerOptions' => 'Owner Options',
							'postComment' => 'Comment Button (For Blog Profile Page 1)',
							'rating' => 'Rating Star',
							'likeButton' => 'Like Button (For Blog Profile Page 1)',
							'tags' => 'Tags (For Blog Profile Page 1)',
							'category' => "Category ",
							'favouriteButton' => 'Favourite Button (For Blog Profile Page 1)',
							'view' => 'View Count',
							'like' => 'Like Count',
							'comment' => 'Comment Count',
							'review' => 'Review Count',
