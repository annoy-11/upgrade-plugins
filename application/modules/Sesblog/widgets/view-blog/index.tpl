    ...
    <div class="sesblog_layout_contant_header">
	  ...
	  <?php if(isset($this->titleActive)):?>
    	...
    	<p><?php echo $this->translate('By');?> <b><?php echo $this->htmlLink($this->owner->getHref(), $this->owner->getTitle()) ?></b> &nbsp;-&nbsp;</p>
			<p><?php echo $this->timestamp($this->sesblog->creation_date) ?><?php if( $this->category ): ?>&nbsp;-&nbsp;</p>

          <?php   if(isset($this->sesblog->readtime) && !empty($this->sesblog->readtime)) {  ?>
            <p><?php  echo $this->sesblog->readtime; ?>
              <?php  } ?>
       ...
       <?php if(isset($this->ratingActive)):?>
		...
		<div class="sesblog_entrylist_entry_body">
		  <?php if(isset($this->photoActive) && $this->sesblog->photo_id):?>
				<div class="sesblog_blog_image clear" style="height: <?php echo $this->image_height; ?>px;overflow: hidden;">
					<img src="<?php echo Engine_Api::_()->storage()->get($this->sesblog->photo_id)->getPhotoUrl('thumb.main'); ?>" alt="">
          ...
          <?php if(isset($this->featuredLabelActive) && $item->featured == 1):?>
			...
			<?php if(isset($this->descriptionActive)):?>
				...
				<div class="rich_content_body sesbasic_text_light" style="visibility:hidden"><?php echo htmlspecialchars_decode($this->sesblog->body);?></div>
     ...
     <p class="sesblog_profile_tags"><?php if (count($this->sesblogTags )):?>
  ...
  <style>
    ...
    <?php if(isset($this->photoActive) && $this->sesblog->photo_id):?>
      <div class="sesblog_profile_layout_second_image clear" >
          <a href="<?php echo $this->sesblog->getHref(); ?>"><img  src="<?php echo Engine_Api::_()->storage()->get($this->sesblog->photo_id)->getPhotoUrl('thumb.main'); ?>" alt=""></a>
     <div class="sesblog_list_labels">
					<?php if($item->sponsored == 1):?>
						<p class="sesblog_label_sponsored"><?php echo $this->translate('Sponsored');?></p>
					<?php endif;?>
        ...
        <div class="sesblog_second_options"> 
        <a href="javascript:;" class="sesbasic_pulldown_toggle sesblog_profile_options"><i class="fa fa-ellipsis-h"></i></a>
     <div class="sesbasic_pulldown_options">
      				<ul>
					<?php if(isset($this->ownerOptionsActive) && $this->isBlogAdmin):?>
          	<?php if($this->coreSettings->getSetting('sesblog.enable.subblog', 1)){ ?>
   ...
   <?php if(isset($this->ratingActive)):?>
    ...
    <div class="sesblog_entrylist_entry_date">
      <p><?php echo $this->translate('<i class="far fa-calendar"></i>') ?>&nbsp;
			<?php echo $this->timestamp($this->sesblog->publish_date) ?>
			<?php  ?>
      </p>
      ...
      <?php } ?>
			<?php if(isset($this->staticsActive)):?>
				...
				<?php if(isset($this->viewActive)):?>
					...
					<?php echo $this->translate(array('%s view', '%s views', $this->sesblog->view_count), $this->locale()->toNumber($this->sesblog->view_count)) ?></span>
				<?php endif;?>
				<?php if(isset($this->commentActive)):?>
...
<?php elseif($this->sesblog->style == 3):?>
    ...
    <?php if(isset($this->titleActive)):?>
		...
		<?php if(isset($this->staticsActive)):?>
      	...
      	<span><i class=" far fa-user"></i> <?php echo $this->translate('');?> <?php echo $this->htmlLink($this->owner->getHref(), $this->owner->getTitle()) ?></span>
      	<span><?php echo $this->translate('<i class="far fa-calendar"></i>') ?>&nbsp;<?php echo $this->timestamp($this->sesblog->publish_date) ?></span>
        <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesblog.enablereadtime', 1) && isset($this->sesblog->readtime) && !empty($this->sesblog->readtime)) {  ?>
     ...
     <div class="sesbasic_pulldown_options">
      ...
      <?php if(isset($this->titleActive)):?>
        ...
        $this->itemPhoto($this->owner),
				array('class' => 'sesblogs_gutter_photo')) ?> <?php echo $this->htmlLink($this->owner->getHref(), $this->owner->getTitle()) ?> &nbsp;-&nbsp;</span>
				<span>
					<?php echo $this->translate('<i class="far fa-calendar"></i>') ?>
        ...
        <?php  } ?>
				<?php if(isset($this->staticsActive)):?>
				  <?php if(isset($this->viewActive)):?>
						<span><i class="sesbasic_icon_view"></i>
						<?php echo $this->translate(array('%s view', '%s views', $this->sesblog->view_count), $this->locale()->toNumber($this->sesblog->view_count)) ?>
						&nbsp;-&nbsp;
						</span>
          <?php endif;?>
          <?php if(isset($this->commentActive)):?>
    ...
    <div class="sesblog_content_four">
		<div class="sesblog_social_tabs sesbasic_clearfix">
          <?php if($this->viewer_id){  ?>
              ...
              <?php } ?>
              <?php if(isset($this->favouriteButtonActive) && $this->coreSettings->getSetting('sesblog.enable.favourite', 1) &&  Engine_Api::_()->authorization()->getPermission(5, 'sesblog_blog', 'favourite')) {  ?>
                    <a href="javascript:;" onclick="nonlogisession(window.location.href);"  class="sesbasic_icon_btn sesbasic_icon_fav_btn  sesblog_favourite_sesblog_blog_<?php echo $this->sesblog->blog_id ?> sesblog_favourite_sesblog_blog_view <?php echo ($this->favStatus) ? 'button_active' : '' ; ?>"><i class="fa fa-heart"></i><span><?php if($this->favStatus):?><?php echo $this->translate('Un-Favourite');?><?php else:?><?php echo $this->translate('Favourite');?><?php endif;?></span></a>
              <?php } ?>
