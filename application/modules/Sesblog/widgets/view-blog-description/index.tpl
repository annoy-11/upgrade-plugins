...
<?php $enableSharng = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesblog.enable.sharing', 1);?>
   <div class="sesblog_profile_layout_second">
			...
			<?php if($this->sesblog->cotinuereading){
				...
				<?php if($check): ?>
					<div class="sesblog_entrylist_entry_body sesblog_morebtn" style="display:none"><a href="javascript:void(0);" onclick="continuereading();"><?php echo $this->translate("Continue Reading"); ?></a></div>
				<?php endif; ?>
		<?php endif;?>
