...
<ul id="widget_sesblog_<?php echo $randonnumber; ?>" class="sesblog_related_blogs sesbasic_clearfix sesbasic_bxs">
  ...
  <?php foreach($this->paginator as $item):?>
		<li class="sesblog_grid_inside sesbasic_clearfix" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
		  <div class="sesblog_grid_inside_inner">
            	...
            	<?php if(isset($this->featuredLabelActive) && $item->featured == 1):?>
					...
					<?php if(isset($this->verifiedLabelActive) && $item->verified == 1):?>
						<div class="sesblog_verified_label" title="<?php echo $this->translate('VERIFIED');?>"><i class="fa fa-check"></i></div>
					<?php endif;?>
				<?php endif;?>
				...
				<div class="sesblog_grid_inside_info sesbasic_clearfix ">
				  <?php if(isset($this->categoryActive)): ?>
					...
					<?php if(Engine_Api::_()->getApi('core', 'sesblog')->allowReviewRating() && isset($this->ratingStarActive)):?>
						<?php echo $this->partial('_blogRating.tpl', 'sesblog', array('rating' => $item->rating, 'class' => 'sesblog_list_rating sesblog_review_sidebar_list_stat', 'style' => ''));?>
					<?php endif;?>
