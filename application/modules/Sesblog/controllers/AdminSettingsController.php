...
// 				}
  ...
  public function createsettingsAction() {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->_getAllParams())) {
      ...
      if(!empty($values['sesblog_photouploadoptions'])) 
        ...
        $values['sesblog_photouploadoptions'] = array();
  ...
  public function landingpagesetupAction() {
    ...
    $form->setDescription('Are you sure want to set the Welcome Page of this plugin as the Landing page of your website? For old landing page you will have to manually make changes in the Landing page from Layout Editor. Backup page of your current landing page will get created with the name "SES - Advanced Blog - Backup - Landing Page".');
    ...
    try {
      ...
      $pageObject->displayname = "SES - Advanced Blog - Backup - Landing Page";
