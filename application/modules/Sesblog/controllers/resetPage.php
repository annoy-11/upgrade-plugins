...
if($pageName == 'sesblog_index_home') {
  ...
  $db->insert('engine4_core_content', array(
    ...
    'parent_content_id' => $topmiddle_id,
    'order' => $widgetOrder++,
    'params' => '{"category":"0","criteria":"0","order":"","info":"recently_created","isfullwidth":"1","autoplay":"1","speed":"2000","show_criteria":["like","comment","favourite","view","title","by","rating","ratingStar","featuredLabel","sponsoredLabel","verifiedLabel","favouriteButton","likeButton","category","socialSharing","creationDate","readtime"],"socialshare_enable_plusicon":"1","socialshare_icon_limit":"2","title_truncation":"45","height":"300","limit_data":"10","title":"","nomobile":"0","name":"sesblog.featured-sponsored-verified-category-carousel"}',
  ));
