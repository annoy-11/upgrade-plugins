...
<?php if (($this->current_count >= $this->quota) && !empty($this->quota)):?>
  ...
  <br/>
<?php else:?>
<div class="<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesblogcre.crsesblog.type', 1)) { ?> sesblog_default_form <?php } else { ?> sesblog_create <?php } ?> sesbasic_bxs">
