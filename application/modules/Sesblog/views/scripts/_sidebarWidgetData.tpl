...
<?php foreach( $this->results as $item ): ?>
	...
	<?php if($this->view_type == 'list'):?>
			...
			<div class="sesblog_vertical_list_img <?php if($this->image_type == 'rounded'):?>sesblog_sidebar_image_rounded<?php endif;?> sesblog_list_thumb sesblog_thumb" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height_list ?>;width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;">
	...
	<?php else :?>
		<li class="sesblog_sidebar_grid sesblog_grid sesbasic_clearfix sesbasic_bxs sesbm" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?> ; ">
			<div class="sesblog_grid_inner sesblog_list_thumb sesblog_thumb">
				<div class="sesblog_grid_thumb sesblog_thumb" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
					<?php $href = $item->getHref();$imageURL = $item->getPhotoUrl('thumb.profile');?>
