...
class Sescrowdfundingteam_Form_EditSiteTeam extends Sescrowdfundingteam_Form_AddSiteTeam {
  ...
  public function init() {
    ...
    if ($type != 'nonsitemember') {
      ...
      $user_id = Engine_Api::_()->getItem('sescrowdfundingteam_team', $team_id)->user_id;
