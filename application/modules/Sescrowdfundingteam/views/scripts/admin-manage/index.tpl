    ...
    <div class='sesbasic-form-cont'>
	    <div class='clear'>
          ...
          <div class='clear settings'>
            <form id='multidelete_form' method="post" action="<?php echo $this->url(array('module' => 'sescrowdfundingteam', 'controller' => 'manage', 'action' => 'multi-delete'), 'admin_default'); ?>" onSubmit="return multiDelete()">
              <div>
                <h3><?php echo $this->translate("Manage Crowdfunding Team Members"); ?></h3>
                <p><?php echo $this->translate('Here, you can choose members of your website to be shown as Team Members.') ?></p>
                <br />
                <?php if(count($this->paginator) > 0):?>
                  <div class="sescrowdfundingteam_manage_designations">
...
<!--                      <div class="admin_table_centered" style="width:10%">
                    ...
                    <ul class="sescrowdfundingteam_manage_designations_list">
                      <?php foreach ($this->paginator as $item): ?>
                        ...
                        <li class="item_label" id="teams_<?php echo $item->team_id ?>">
                          ...
                          <div style="width:25%;">
                            ...
                            <a href="<?php echo $crowdfunding->getHref(); ?>"><?php echo $this->translate($crowdfunding->getTitle()); ?></a>
                          </div>
                          <div style="width:35%;">
