...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescrowdfundingteam/externals/styles/template3.css');
?>

<div class="sescrowdfundingteam_temp3_wrap">
  <div class="sescrowdfundingteam_temp3_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
