...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescrowdfundingteam/externals/styles/template1.css');
?>

<div class="sescrowdfundingteam_temp1_wrap">
  <div class="sescrowdfundingteam_temp1_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
