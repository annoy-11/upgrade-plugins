...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescrowdfundingteam/externals/styles/template4.css');
?>

<div class="sescrowdfundingteam_temp4_wrap">

  <div class="sescrowdfundingteam_temp4_list sesbasic_clearfix<?php if ($this->center_block): ?> iscenter<?php endif; ?>">
