...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sescrowdfundingteam/externals/styles/template6.css');
?>

<div class="sescrowdfundingteam_temp6_wrap">
  <div class="sescrowdfundingteam_temp6_list">
    <table>
        ...
        <tr>
          ...
          <?php if(!empty($this->content_show)): ?>
            <td class="sescrowdfundingteam-social-icon <?php if(empty($this->sescrowdfundingteam_social_border)): ?>bordernone<?php endif; ?>">
