...
<?php foreach($this->paginator as $item): ?>
  ...
  <?php } ?>
  <div class="sescrowdfundingteam_dashboard_member sesbasic_clearfix" id="sescrowdfundingteam_team_<?php echo $item->team_id; ?>">
    <div>
      <?php if($item->type == 'sitemember'): ?>
    ...
    <div class="_cont">
      <div class="_title sesbasic_clearfix">
        ...
        <span>
          <a href="<?php echo $this->url(array('crowdfunding_id' => $item->crowdfunding_id,'team_id' => $item->team_id,'type' => $item->type, 'action'=>'edit'),'sescrowdfundingteam_dashboard',true);?>" title='<?php echo $this->translate("Edit");?>' class="sessmoothbox fa fa-pencil"></a>
          <a href="<?php echo $this->url(array('crowdfunding_id' => $item->crowdfunding_id,'team_id' => $item->team_id,'action'=>'delete'),'sescrowdfundingteam_dashboard',true);?>" title='<?php echo $this->translate("Delete");?>' class="sessmoothbox fa fa-trash"></a>
        </span>
      </div>
      <div class="_info">
