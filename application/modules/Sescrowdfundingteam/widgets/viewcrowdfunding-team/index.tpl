...
<?php $user = $this->team;  ?>
<div class="sescrowdfundingteam_member_profile_wrapper clear sesbasic_clearfix">
  <?php if($user->type == 'sitemember') { ?>
    <?php $userItem = Engine_Api::_()->getItem('user', $user->user_id); ?>
  <?php } ?>
  <div class="sescrowdfundingteam_member_profile_left">
    <div class="sescrowdfundingteam_member_profile_photo">
      <?php if(!empty($this->infoshow) && in_array('profilePhoto', $this->infoshow)): ?>
        <div class="sescrowdfundingteam_member_profile_photo_inner">
          <?php if($user->type == 'sitemember') { ?>
    ...
    <div class="sescrowdfundingteam_member_profile_contact_info">
    ...
    <div class="sescrowdfundingteam_member_profile_social_icon sescrowdfundingteam-social-icon">
      <?php if($user->email && in_array('email', $this->infoshow)): ?>
  ...
  <div class="sescrowdfundingteam_member_profile_right">
    <?php if(!empty($this->infoshow)): ?>
      <?php if(in_array('displayname', $this->infoshow)): ?>
        <div class='sescrowdfundingteam_member_profile_title'>
          <?php echo $user->name; ?>
        </div>
      <?php endif; ?>
      <?php if($user->designation && in_array('designation', $this->infoshow)): ?>
        <div class='sescrowdfundingteam_member_profile_designation'>
          <?php echo $this->translate($user->designation); ?>
        </div>
      <?php endif; ?>
      <?php if($user->description): ?>
      <div class="sescrowdfundingteam_member_short_desc">
      	<?php echo $user->description; ?>
      </div>
      <?php endif; ?>
			
      <?php if($user->detail_description && in_array('detaildescription', $this->infoshow)): ?>
        <div class="sescrowdfundingteam_member_profile_heading">
