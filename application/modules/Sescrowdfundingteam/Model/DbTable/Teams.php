 ...
 * @version    $Id: Teams.php  2018-11-14 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sescrowdfundingteam_Model_DbTable_Teams extends Engine_Db_Table {

  protected $_rowClass = "Sescrowdfundingteam_Model_Team";
  ...
  public function getTeamMemers($params = array()) {
    ...
    if (!empty($params)) {
      ...
      if (!empty($params['crowdfunding_id']))
        $select->where($this->info('name') . '.crowdfunding_id = ?', $params['crowdfunding_id']);
