 ...
 * @version    $Id: Category.php  2018-10-09 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescommunityads_Model_Category extends Core_Model_Category {
  ...
  public function getTable() {
    if (is_null($this->_table)) {
      $this->_table = Engine_Api::_()->getDbTable('categories', 'sescommunityads');
    }
    return $this->_table;
  }
  ...
  public function getHref($params = array()) {
    ...
    $params = array_merge(array(
        'route' => 'sescommunityads_category_view',
        'reset' => true,
  ...
  public function getPhotoUrl($type = NULL) {
    if (!$this)
      return 'application/modules/Sescommunityads/externals/images/nophoto_ads_thumb_profile.png';
