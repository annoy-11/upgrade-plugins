...
<?php } ?>
    ...
    <div class="sesbasic_load_btn" id="sescommunityads_boost_feed_viewmore" style="display: none;">
      <a href="javascript:void(0);" id="sescommunityads_boost_feed_viewmore_link" class="sesbasic_animation sesbasic_link_btn"><i class="fa fa-repeat"></i><span><?php echo $this->translate('View More');?></span></a>
   </div>
    <div class="sesbasic_load_btn" id="sescommunityads_boost_feed_loading" style="display: none;">
      <span class="sesbasic_link_btn"><i class="fa fa-circle-o-notch fa-spin"></i></span>
    </div>
  </div>
