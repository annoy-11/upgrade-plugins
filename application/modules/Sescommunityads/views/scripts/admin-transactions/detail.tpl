 ...
 * @version    $Id: detail.tpl  2018-10-09 00:00:00 SocialEngineSolutions $
...
<dl class="payment_transaction_details">
  ...
  <dd><?php echo $this->translate('Advertisement Owner') ?></dd>
  <dt><?php echo $this->htmlLink($this->user->getHref(), $this->user->getTitle(), array('target' => '_parent')) ?></dt>
  <dd><?php echo $this->translate('Advertisement Title') ?></dd>
  <dt><a href="<?php echo $this->url(array('action'=>'view','ad_id'=>$this->item->getIdentity()),'sescommunityads_general',true); ?>"  target='_blank' title="<?php echo  ucfirst($this->item->getTitle()) ?>">
