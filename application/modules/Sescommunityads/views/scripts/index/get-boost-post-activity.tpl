...
<?php 
    ...
    if(empty($href)){
      ...
      $href = Engine_Api::_()->getApi('settings', 'core')->getSetting('sescommunityads_boost_default_adult');
    }
?>
    ...
    <div class="_other_options">
      <div class="_reaction_count">
        ...
        <span><?php echo !empty($like_count) ? $like_count : $action->like_count; ?></span> </div>
      	<div class="_comment_count"> <i class="fa fa-comments-o"></i><span><?php echo !empty($this->advComment) ? Engine_Api::_()->sesadvancedcomment()->commentCount($action) : $action->comment_count; ?></span> </div>
