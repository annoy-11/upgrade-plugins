...
if (!$page_id) {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Choose Package Page',
...
if (!$page_id) {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Browse Page',
...
if (!$page_id) {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Manage Ads Page',
...
if (!$page_id) {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Manage Campaign Page',
...
if (!$page_id) {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Create Page',
        'title' => 'Community Advertisements Plugin Create Page',
...
if (!$page_id) {
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Report Page',
...
if(!$page_id){
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - Help And Learn Page',
...
if(!$page_id){
    ...
    $db->insert('engine4_core_pages', array(
        ...
        'displayname' => 'SES - Community Advertisements Plugin - View Page',
