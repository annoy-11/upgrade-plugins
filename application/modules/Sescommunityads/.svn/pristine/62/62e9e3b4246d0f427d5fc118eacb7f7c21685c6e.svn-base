 ...
 * @version    $Id: Gateways.php  2018-10-09 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sescommunityads_Model_DbTable_Gateways extends Engine_Db_Table
{
	protected $_name = 'payment_gateways';
  protected $_rowClass = 'Sescommunityads_Model_Gateway';
