 ...
 * @version    $Id: Transactions.php  2018-10-09 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sescommunityads_Model_DbTable_Transactions extends Engine_Db_Table
{
  protected $_rowClass = 'Sescommunityads_Model_Transaction';
  ...
  {
    // Get benefit setting
    $benefitSetting = Engine_Api::_()->getApi('settings', 'core')->getSetting('sescommunityads.payment.mod.enable');
