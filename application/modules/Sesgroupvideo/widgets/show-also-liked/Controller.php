 ...
 */
class Sesgroupvideo_Widget_ShowAlsoLikedController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->getDbTable('videos', 'sesgroupvideo')->peopleAlsoLiked($subject->getIdentity());
