...
<?php $this->headScript()->appendFile($baseUrl . 'application/modules/Sesbasic/externals/scripts/PeriodicalExecuter.js')
      ...
      $this->headLink()->appendStylesheet($baseUrl . 'application/modules/Sesgroupvideo/externals/styles/carousel.css'); 
      $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Sesgroupvideo/externals/styles/styles.css');
 ?>
<style type="text/css">
.sesgroupvideo_carousel_wrapper_<?php echo $randonNumber; ?>.sesgroupvideo_carousel_h_wrapper{
	background-color:<?php echo '#'.str_replace('#','',$this->bgColor) ?>;
	padding:<?php echo str_replace(array('px','%'),array(''),$this->spacing).'px'; ?> 0;
}
.sesgroupvideo_carousel_wrapper_<?php echo $randonNumber; ?>.sesgroupvideo_carousel_h_wrapper .sesgroupvideo_grid_info *{
	color:<?php echo '#'.str_replace('#','',$this->textColor) ; ?>
}
#sesgroupvideo_slider_<?php echo $randonNumber; ?> {
	position: relative;
	height:<?php echo is_numeric($this->height_main) ? $this->height_main.'px' : $this->height_main ?>;
	overflow: hidden;
}
/*.sesgroupvideo_carousel_wrapper_<?php echo $randonNumber; ?>.sesgroupvideo_carousel_h_wrapper .sesgroupvideo_carousel_nav a{top:<?php echo $this->height/2; ?>px;}*/
</style>
<div class="sesgroupvideo_carousel_wrapper clearfix sesbasic_bxs sesbasic_clearfix sesbm <?php echo $this->align == 'vertical' ? 'sesgroupvideo_carousel_v_wrapper' : 'sesgroupvideo_carousel_h_wrapper'; ?> sesgroupvideo_carousel_wrapper_<?php echo $randonNumber; ?>">
  <div id="sesgroupvideo_slider_<?php echo $randonNumber; ?>">
    <?php 
    ...
    $allowRating = Engine_Api::_()->getApi('settings', 'core')->getSetting('video.chanel.rating',1);
      ...
      $photoURL = $item->getPhotoUrl('thumb.normalmain'); ?>
        <div class="sesgroupvideo_listing_grid" style="width:<?php echo is_numeric($this->width) ? $this->width.'px' : $this->width ?>;height:<?php echo is_numeric($this->height_main) ? $this->height_main.'px' : $this->height_main ?>;">
        	<div class="sesgroupvideo_grid_thumb sesgroupvideo_thumb sesgroupvideo_play_btn_wrap" style="height:<?php echo is_numeric($this->height) ? $this->height.'px' : $this->height ?>;">
          <?php 
          $photoURL=$item->getPhotoUrl(); ?>
          <a class="<?php echo $item->getType() == 'groupvideo' ? 'sesgroupvideo_thumb_img' : 'sesgroupvideo_thumb_nolightbox' ?>" href="<?php echo $item->getHref(); ?>"> 
            ...
            <?php 
              ...
              <span class="sesgroupvideo_thumb_btns">
                <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo.enable.socialshare', 1) && isset($this->socialSharing)){ ?>
                  ...
                  <?php $LikeStatus = Engine_Api::_()->sesgroupvideo()->getLikeStatusVideo($item->$getId,$item->getType()); ?>
                   <a href="javascript:;" data-url="<?php echo $item->$getId ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sesgroupvideo_like_<?php echo $itemtype; ?><?php echo ($LikeStatus) ? ' button_active' : '' ; ?>"> <i class="fa fa-thumbs-up"></i><span><?php echo $item->like_count; ?></span></a>
                    <?php }
                    if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo.enable.favourite', 1) && Engine_Api::_()->user()->getViewer()->getIdentity() !=0 && isset($this->favouriteButton)){
              ...
              <?php if(isset($this->like) || isset($this->comment) || isset($this->view) || isset($this->title) || isset($this->rating) || isset($this->favouriteCount) || isset($this->downloadCount)  || isset($this->by) || isset($this->videoCount)){ ?>
                <div class="sesgroupvideo_grid_info clear">
                  ...
                  <?php } ?>
                  	...
                  	<div class="sesgroupvideo_grid_date sesgroupvideo_list_stats sesbasic_text_light floatL">
                      <span>
                  ...
                  <?php }?>
                  <div class="sesgroupvideo_grid_date sesgroupvideo_list_stats sesbasic_text_light clear floatL">
                 ...
                 <?php } ?>
                 <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo.enable.favourite', 1) && isset($this->favouriteCount)) { ?>
                 ...
                 <?php if($item->getType() == 'sesgroupvideo_chanel'){ 
  ...
  <?php if($this->align == 'horizontal'): ?>
    <div class="tabs_<?php echo $randonNumber; ?> sesgroupvideo_carousel_nav">
      <a class="sesgroupvideo_carousel_nav_pre" href="#page-p"><i class="fa fa-angle-left"></i></a>
      <a class="sesgroupvideo_carousel_nav_nxt" href="#page-p"><i class="fa fa-angle-right"></i></a>
    </div>  
  <?php else: ?>
    <div class="tabs_<?php echo $randonNumber; ?> sesgroupvideo_carousel_nav">
      <a class="sesgroupvideo_carousel_nav_pre" href="#page-p"><i class="fa fa-angle-up"></i></a>
      <a class="sesgroupvideo_carousel_nav_nxt" href="#page-p"><i class="fa fa-angle-down"></i></a>
    </div>  
  <?php endif; ?>
</div>
	...
	window.addEvent('domready', function () {
		var duration = <?php echo $this->durationSlide; ?>,
			...
			carousel = new Carousel.Extra({
				...
				container: 'sesgroupvideo_slider_<?php echo $randonNumber; ?>',
				circular: true,
				current: 1,
