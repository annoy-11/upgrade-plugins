 ...
 * @version    $Id: _showVideoListGrid.tpl  2018-10-16 00:00:00 SocialEngineSolutions $
...
<?php if($this->allowVideo && $this->canUpload && !$this->is_ajax){ ?>
  ...
  <div class="sesbasic_profile_tabs_top sesbasic_clearfix">
    ...
    <a class="sesbasic_button fa fa-plus" href="<?php echo $this->url(array('module' => 'sesgroupvideo', 'action' => 'create', 'parent_id' => $this->parent_id), 'sesgroupvideo_general', true); ?>">
...
<?php if(!$this->is_ajax){ ?>
  ...
  <div class="sesbasic_view_type sesbasic_clearfix clear" style="display:<?php echo $this->bothViewEnable ? 'block' : 'none'; ?>;height:<?php echo $this->bothViewEnable ? '' : '0px'; ?>">
    ...
    <?php if(is_array($this->optionsEnable) && in_array('list',$this->optionsEnable)){ ?>
      ...
      <a href="javascript:;" rel="list" id="sesgroupvideo_list_view_<?php echo $randonNumber; ?>" class="listicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'list') { echo 'active'; } ?>" title="<?php echo $this->translate('List View') ; ?>"></a>

    <?php } ?>

    <?php if(is_array($this->optionsEnable) && in_array('grid',$this->optionsEnable)){ ?>

    	<a href="javascript:;" rel="grid" id="sesgroupvideo_grid_view_<?php echo $randonNumber; ?>" class="gridicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'grid') { echo 'active'; } ?>" title="<?php echo $this->translate('Grid View'); ?>"></a>

    <?php } ?>

    <?php if(is_array($this->optionsEnable) && in_array('pinboard',$this->optionsEnable)){ ?>

     	<a href="javascript:;" rel="pinboard" id="sesgroupvideo_pinboard_view_<?php echo $randonNumber; ?>" class="boardicon selectView_<?php echo $randonNumber; ?> <?php if($this->view_type == 'pinboard') { echo 'active'; } ?>" title="<?php echo $this->translate('Pinboard View'); ?>"></a>
...
<?php if((isset($this->optionsListGrid['tabbed']) || $this->loadJs || isset($this->optionsListGrid['profileTabbed'])) && !$this->is_ajax){ ?>
  ...
  <div id="scrollHeightDivSes_<?php echo $randonNumber; ?>" class="sesbasic_clearfix sesbasic_bxs clear">
    ...
    <ul class="sesgroupvideo_video_listing sesbasic_clearfix clear" id="tabbed-widget_<?php echo $randonNumber; ?>" style="min-height:50px;">
...
<?php } ?>
      ...
      <?php foreach( $this->paginator as $item ):
        ...
        if(isset($this->getVideoItem) && $this->getVideoItem == 'getVideoItem'){
         ...
         $oldItem = $item;
           ...
           $item = Engine_Api::_()->getItem('groupvideo', $item->video_id);

          else if(isset($item->resource_id))

           $item = Engine_Api::_()->getItem('groupvideo', $item->resource_id);

          else

           $item = Engine_Api::_()->getItem('groupvideo', $item->file_id);
      ...
      ?>
        ...
        <li class="sesgroupvideo_listing_in_grid2" style="width:<?php echo is_numeric($this->width_grid) ? $this->width_grid.'px' : $this->width_grid ?>;height:<?php echo is_numeric($this->height_grid) ? $this->height_grid.'px' : $this->height_grid ?>;">

          <div class="sesgroupvideo_listing_in_grid2_thumb sesgroupvideo_thumb sesgroupvideo_play_btn_wrap">
            ...
            <a href="<?php echo $href; ?>" data-url = "<?php echo $item->getType() ?>" class="sesgroupvideo_thumb_img">

              <span style="background-image:url(<?php echo $imageURL; ?>);"></span>

            </a>

            <?php  if($item->getType() == 'groupvideo') { ?>

            <a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sesgroupvideo_play_btn fa fa-play-circle sesgroupvideo_thumb_img">
            ...
            <?php if(isset($this->durationActive) && isset($item->duration) && $item->duration ): ?>
              ...
              <span class="sesgroupvideo_length">
           ...
           ?>
            ...
            <?php $watchLaterId = isset($watchlater_watch_id_exists) ? $watchlater_watch_id : $item->watchlater_id; ?>
              ...
              <a href="javascript:;" class="sesgroupvideo_watch_later_btn sesgroupvideo_watch_later <?php echo !is_null($watchLaterId)  ? 'selectedWatchlater' : '' ?>" title = "<?php echo !is_null($watchLaterId)  ? $this->translate('Remove from Watch Later') : $this->translate('Add to Watch Later') ?>" data-url="<?php echo $item->video_id ; ?>"></a>
            ...
            <?php } ?>
          		...
          		$urlencode = urlencode(((!empty($_SERVER["HTTPS"]) &&  strtolower($_SERVER["HTTPS"]) == 'on') ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . $item->getHref()); ?>
           		...
           		<div class="sesgroupvideo_thumb_btns"> 

              	<?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo.enable.socialshare', 1) && isset($this->socialSharingActive)){ ?>
                ...
                if(Engine_Api::_()->user()->getViewer()->getIdentity() != 0 ){
                  ...
                  <?php $LikeStatus = Engine_Api::_()->sesgroupvideo()->getLikeStatusVideo($item->$getId,$item->getType()); ?>

                    <a href="javascript:;" data-url="<?php echo $item->$getId ; ?>" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_like_btn sesgroupvideo_like_<?php echo $itemtype; ?> <?php echo ($LikeStatus) ? 'button_active' : '' ; ?>"> <i class="fa fa-thumbs-up"></i><span><?php echo $item->like_count; ?></span></a>

                    <?php } ?>

                     <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo.enable.favourite', 1) && isset($this->favouriteButtonActive) && isset($item->favourite_count)){ ?>

                    <?php $favStatus = Engine_Api::_()->getDbtable('favourites', 'sesgroupvideo')->isFavourite(array('resource_type'=>$itemtype,'resource_id'=>$item->$getId)); ?>

                    <a href="javascript:;" class="sesbasic_icon_btn sesbasic_icon_btn_count sesbasic_icon_fav_btn sesgroupvideo_favourite_<?php echo $itemtype; ?> <?php echo ($favStatus)  ? 'button_active' : '' ?>"  data-url="<?php echo $item->$getId ; ?>"><i class="fa fa-heart"></i><span><?php echo $item->favourite_count; ?></span></a>
          ...
          <?php if(isset($this->titleActive) ){ ?>
            ...
            <div class="sesgroupvideo_listing_in_grid2_title_show sesgroupvideo_animation">
          ...
          <div class="sesgroupvideo_listing_in_grid2_info clear sesgroupvideo_animation">

          	<?php if(isset($this->titleActive) ){ ?>

            <div class="sesgroupvideo_listing_in_grid2_title">
            ...
            <?php if(isset($this->byActive)){ ?>
              ...
              <div class="sesgroupvideo_listing_in_grid2_date sesgroupvideo_list_stats sesbasic_text_light">
             ...
             <?php if(isset($this->locationActive) && isset($item->location) && $item->location && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo_enable_location', 1)){ ?>

            	<div class="sesgroupvideo_listing_in_grid2_date sesgroupvideo_list_stats sesgroupvideo_list_location sesbasic_text_light">

                <span>

                  <i class="fa fa-map-marker"></i>

                  <a href="javascript:;" onclick="openURLinSmoothBox('<?php echo $this->url(array("module"=> "sesgroupvideo", "controller" => "index", "action" => "location",  "video_id" => $item->getIdentity(),'type'=>'video_location'),'default',true); ?>');return false;"><?php echo $item->location; ?></a>
            ...
            <div class="sesgroupvideo_listing_in_grid2_date sesgroupvideo_list_stats sesbasic_text_light">
              ...
              <?php } ?>
               ...
               <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo.enable.favourite', 1) && isset($this->favouriteActive) && isset($item->favourite_count)) { ?>
        ...
        <li class="sesgroupvideo_listing_grid" style="width:<?php echo is_numeric($this->width_grid) ? $this->width_grid.'px' : $this->width_grid ?>;">

          <div class="sesgroupvideo_grid_thumb sesgroupvideo_thumb sesgroupvideo_play_btn_wrap" style="height:<?php echo is_numeric($this->height_grid) ? $this->height_grid.'px' : $this->height_grid ?>;">
          ...
          <div class="sesgroupvideo_grid_info clear">

          	<?php if(isset($this->titleActive) ){ ?>

            <div class="sesgroupvideo_grid_title">
            ...
            <?php if(isset($this->byActive)){ ?>
              ...
              <div class="sesgroupvideo_grid_date sesgroupvideo_list_stats sesbasic_text_light">
             ...
             <?php } ?>
              ...
              <?php if(isset($this->locationActive) && isset($item->location) && $item->location  && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo_enable_location', 1)){ ?>
            	...
            	<div class="sesgroupvideo_grid_date sesgroupvideo_list_stats sesbasic_text_light sesgroupvideo_list_location">
           ...
           <?php  if(isset($this->descriptiongridActive)){ ?>
                ...
                <div class="sesgroupvideo_list_des">
        ...
        <?php }else if($this->view_type == 'list'){ ?>
        		...
        		<li class="sesgroupvideo_listing_list sesbasic_clearfix clear">

              <div class="sesgroupvideo_list_thumb sesgroupvideo_thumb sesgroupvideo_play_btn_wrap" style="height:<?php echo is_numeric($this->height_list) ? $this->height_list.'px' : $this->height_list ?>;width:<?php echo is_numeric($this->width_list) ? $this->width_list.'px' : $this->width_list ?>;">
            ...
            <div class="sesgroupvideo_list_info">

            	<?php  if(isset($this->titleActive)){ ?>

                <div class="sesgroupvideo_list_title">
              ...
              <?php if(isset($this->byActive)){ ?>
               ...
               <?php } ?>
            	...
            	<div class="sesgroupvideo_list_date sesgroupvideo_list_stats sesbasic_text_light sesgroupvideo_list_location">
            ...
            <?php } ?>
                ...
                <div class="sesgroupvideo_list_date sesgroupvideo_list_stats sesbasic_text_light">
        ...
        <?php }else if(isset($this->view_type) && $this->view_type == 'pinboard'){ ?>
              	...
              	<div class="sesbasic_pinboard_list_item sesbm">
                	...
                	<div class="sesbasic_pinboard_list_item_top sesgroupvideo_play_btn_wrap">

                  	<div class="sesbasic_pinboard_list_item_thumb">

                  		<a href="<?php echo $item->getHref()?>" data-url = "<?php echo $item->getType() ?>" class="sesgroupvideo_thumb_img">
            ...
            <?php } ?>
                 ...
                 <?php if(isset($this->enableCommentPinboardActive)){ ?>
                    ...
                    <?php //if((@$itemType != '')){  ?>
                    	...
                    	<?php echo Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sesadvancedcomment') ? $this->action('list', 'comment', 'sesadvancedcomment', array('type' => 'groupvideo', 'id' => $item->getIdentity(),'page'=>'')) : $this->action("list", "comment", "sesbasic", array("item_type" => 'groupvideo', "item_id" =>  $item->video_id,"widget_identity"=>$randonNumber)); ?>
   ...
   if((isset($this->optionsListGrid['paggindData']) || $this->loadJs) && $this->loadOptionData == 'pagging' && !isset($this->show_limited_data)){ ?>
 		 ...
 		 <?php echo $this->paginationControl($this->paginator, null, array("_pagging.tpl", "sesgroupvideo"),array('identityWidget'=>$randonNumber)); ?>
...
sesJqueryObject(document).on('click','.selectView_<?php echo $randonNumber; ?>',function(){
		...
		sesJqueryObject('#sesgroupvideo_grid_view_<?php echo $randonNumber; ?>').removeClass('active');

		sesJqueryObject('#sesgroupvideo_list_view_<?php echo $randonNumber; ?>').removeClass('active');

		sesJqueryObject('#sesgroupvideo_pinboard_view_<?php echo $randonNumber; ?>').removeClass('active');
      ...
      'url': en4.core.baseUrl + "widget/index/mod/sesgroupvideo/name/<?php echo $this->widgetName; ?>/openTab/" + defaultOpenTab,
		...
		if(valueTab){
			...
			if($('ses_pagging'))
			 ...
			 requestTab_<?php echo $randonNumber; ?> = new Request.HTML({
				...
				'url': en4.core.baseUrl+"widget/index/mod/sesgroupvideo/name/<?php echo $this->widgetName; ?>/openTab/"+valueTab,
 ...
 var searchParams<?php echo $randonNumber; ?> ;
  ...
  function viewMore_<?php echo $randonNumber; ?> (){
    ...
    requestViewMore_<?php echo $randonNumber; ?> = new Request.HTML({
      ...
      'url': en4.core.baseUrl + "widget/index/mod/sesgroupvideo/name/<?php echo $this->widgetName; ?>/openTab/" + openTab_<?php echo $randonNumber; ?>,
      ...
      onSuccess: function(responseTree, responseElements, responseHTML, responseJavaScript) {
        ...
        if($('loading_images_browse_<?php echo $randonNumber; ?>'))
				...
				if($('loadingimgsesgroupvideo-wrapper'))
...
sesJqueryObject(document).on('click',function(){
	...
	sesJqueryObject('.sesgroupvideo_list_option_toggle').removeClass('open');
