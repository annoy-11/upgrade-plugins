  ...
  <table>
    ...
    <td><?php if(!is_null($this->item->getTitle()) && $this->item->getTitle() != '') {
  	...
  	<tr>
    	...
    	<td>
    		<?php
        	$event = Engine_Api::_()->getItem('sesgroup_group',$this->item->parent_id); ?>
   ...
   <?php if(isset($this->item->ip_address)){ ?>
    ...
    <?php } ?>
    <?php if(isset($this->item->location) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgroupvideo_enable_location', 1)){ ?>
    <tr>
