...
<script type="text/javascript">
  en4.core.runonce.add(function() {
	...
	up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
      ...
      url: "<?php  echo $this->url(array('module' => 'sesgroupvideo', 'controller' => 'index', 'action' => 'create'), 'default', true); ?>?ul=1",
...
<div id="demo-status" class="hide">
  ...
  <div>
    <a class="buttonlink sesgroupvideo_icon_video_add" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Video');?></a>
  </div>
...
<div><br/>
  <a class="buttonlink" href="javascript:startUpload();" id="demo-upload" style='display:none; background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sesgroupvideo/externals/images/new.png);'><?php echo $this->translate('Post Video');?></a>
</div>
