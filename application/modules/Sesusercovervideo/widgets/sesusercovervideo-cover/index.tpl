...
?>
<?php include APPLICATION_PATH . '/application/modules/Sesusercovervideo/widgets/sesusercovervideo-cover/_type'.$type.'.tpl'; ?>
<?php if($this->is_fullwidth){ ?>
<script type="application/javascript">
sesJqueryObject(document).ready(function(){
	var htmlElement = document.getElementsByTagName("body")[0];
  htmlElement.addClass('sesusercovervideo_cover_full');
...
<script type="application/javascript">
  function finishVideoNext() {
    sesJqueryObject('#sesusercovervideo_cover_video_id').get(0).play();
  }
</script>
<script type="application/javascript">
  sesJqueryObject(document).ready(function() {
