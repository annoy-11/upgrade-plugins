 ...
 * @version    $Id: create.tpl  2018-11-02 00:00:00 SocialEngineSolutions $
...
<?php 
  ...
  <?php  $viewUrl = Engine_Api::_()->getApi('settings', 'core')->getSetting('sesgrouppoll.poll.manifest', 'grouppoll'); ?>
...
<?php }	?>
	...
	function append(){
      var optionsDiv =  '<div class= "pollOptionInput">' +
		...
		optionsDiv +='</div>' +
		'<span class="sesgrouppoll_upload_img"><a href="javascript:void(0)" style = "display:none;" id="remove-image'+counter+'" class="fa fa-close ' +
        'remove-image"></a><img src="#" ' +
        'class="uploadPreviewImage" style="display:none;" id="'+text+counter+'" ></span>' +
        '<span class="sesgrouppoll_upload_img"><a href="javascript:void(0)" style = "display:none;" id="remove-gif'+counter+'" class="fa fa-close remove-gif"></a>' +
