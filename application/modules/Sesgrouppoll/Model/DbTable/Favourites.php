 ...
 * @version    $Id: Favourites.php  2018-11-02 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesgrouppoll_Model_DbTable_Favourites extends Engine_Db_Table {

  protected $_rowClass = "Sesgrouppoll_Model_Favourite";
  ...
  public function getItemfav($resource_type, $itemId) {
    $tableFav = Engine_Api::_()->getDbTable('favourites', 'sesgrouppoll');
