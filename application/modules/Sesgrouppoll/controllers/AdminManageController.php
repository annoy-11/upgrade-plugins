 ...
 */
class Sesgrouppoll_AdminManageController extends Core_Controller_Action_Admin
{
  public function indexAction(){
      ...
      $this->view->subNavigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sesgrouppoll_admin_main', array(), 'sesgrouppoll_admin_main_manage');
    if ($this->getRequest()->isPost())
    {
      ...
      foreach ($values as $key=>$value) {
        ...
        {
          $poll = Engine_Api::_()->getItem('sesgrouppoll_poll', $value);
          $poll->delete();
        }
      }
    }
    $page = $this->_getParam('page',1);
    $this->view->paginator = Engine_Api::_()->getItemTable('sesgrouppoll_poll')->getPollsPaginator(array(
      'orderby' => 'admin_id',
    ));
  ...
  public function deleteAction()
  {
    ...
    if( $this->getRequest()->isPost())
    {
      ...
      try
      {
        $poll = Engine_Api::_()->getItem('sesgrouppoll_poll', $id);
        $poll->delete();
        $db->commit();
      }
