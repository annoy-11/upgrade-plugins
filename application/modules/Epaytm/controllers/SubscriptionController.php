 ...
 * @version    $Id: SubscriptionController.php 2019-11-05 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
include_once APPLICATION_PATH . "/application/modules/Epaytm/Api/PaytmKit/lib/encdec_paytm.php";
class Epaytm_SubscriptionController extends Core_Controller_Action_Standard
{
  /**
   * @var User_Model_User
   */
  ...
  protected $_session;
  /**
   * @var Epaytm_Model_Order
   */
  protected $_order;
  /**
   * @var Epaytm_Model_Gateway
   */
  protected $_gateway;
  /**
   * @var Epaytm_Model_Subscription
   */
  protected $_subscription;
  /**
   * @var Epaytm_Model_Package
   */
  protected $_package;
  ...
  public function processAction()
  {
    ...
    $params['return_url'] = $schema . $host
      . $this->view->url(array('action' => 'return','module'=>'epaytm'))
      . '?order_id=' . $order_id;
    ...
    // Process transaction
    $paytmParams = $plugin->createSubscriptionTransaction($this->_user,
