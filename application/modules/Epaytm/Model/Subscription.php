 ...
 */
class Epaytm_Model_Subscription extends Core_Model_Item_Abstract
{
  ...
  {
    if( empty($this->gateway_id) || empty($this->gateway_source_type)) {
      return null;
    }
    if( null === $this->_gateway ) {
      switch($this->source_type){
        case "sespagepackage_transaction":
          $gatewaySourceType = "sespagepackage_gateway";
          break;
        case "":
          break;
        default:
      ...
      $this->_gateway = Engine_Api::_()->getItem($gatewaySourceType, $this->gateway_id);
    }
  ...
  {
    if( empty($this->package_id) || empty($this->source_type)) {
      return null;
    }
    if( null === $this->_package ) {
      $this->_package = Engine_Api::_()->getItem($this->source_type, $this->package_id);
    }
