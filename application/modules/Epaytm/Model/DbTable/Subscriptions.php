 ...
 * @version    $Id: Subscriptions.php 2019-11-05 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Epaytm_Model_DbTable_Subscriptions extends Engine_Db_Table
{
  protected $_rowClass = 'Epaytm_Model_Subscription';
  ...
  public function cancelAll(User_Model_User $user, $note = null,
      Epaytm_Model_Subscription $except = null)
  {
    $select = $this->select()
