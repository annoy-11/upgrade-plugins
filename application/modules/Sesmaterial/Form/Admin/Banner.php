 ...
 * @version    $Id: Banner.php 2018-07-28 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sesmaterial_Form_Admin_Banner extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Select', 'is_full', array(
				'label' => 'Show image in full width',
        'description' => 'Do you want to show banner image in full width?',
        'multiOptions' => array(0=>'No,Don\'t want to show banner image in full width',1=>'Yes,want to show banner image in full width'),
				'value'=>1
    ));
		$this->addElement('Select', 'is_pattern', array(
				'label' => 'Show pattern image over the image?',
        'description' => 'Do you want to show pattern image over the image?',
        'multiOptions' => array(0=>'No,Don\'t want to show pattern image over the image',1=>'Yes,want to show pattern image over the image'),
				'value'=>1,
    ));
