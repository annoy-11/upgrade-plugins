 ...
 * @version    $Id: HeaderTemplate.php 2018-07-28 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */
class Sesmaterial_Form_Admin_HeaderTemplate extends Engine_Form {
  ...
  public function init() {
    ...
    $headerLink = $view->baseUrl() . '/admin/sesmaterial/manage/manage-photos';
    ...
    $this->addElement('Select', 'sesmaterial_logo', array(
        'label' => 'Choose Logo',
        ...
        'escape' => false,
        'value' => $settings->getSetting('sesmaterial.logo', ''),
    ));
    $this->sesmaterial_logo->addDecorator('Description', array('placement' => Zend_Form_Decorator_Abstract::PREPEND, 'escape' => false));

    $this->addElement('Text', "sesmaterial_menu_logo_top_space", array(
        'label' => 'Logo Top Margin',
        'description' => 'Enter the top margin for the logo of your website to be displayed in this header.',
        'allowEmpty' => false,
        'required' => true,
        'value' => Engine_Api::_()->sesmaterial()->getContantValueXML('sesmaterial_menu_logo_top_space'),
    ));

    $this->addElement('Text', "sesmaterial_header_height", array(
	'label' => 'Header Height',
    ...
    $this->addElement('Radio', 'sesmaterial_navigation_position', array(
    ...
    $this->addElement('Text', 'sesmaterial_limit', array(
        'label' => 'Menu Count',
        'description' => 'Choose number of menu items to be displayed before â€œMoreâ€? dropdown menu occurs?',
        'value' => $settings->getSetting('sesmaterial.limit', 4),
    ));

    $this->addElement('Text', 'sesmaterial_moretext', array(
        'label' => '"More" Button Text',
        'description' => 'Enter "More" Button Text',
        'value' => $settings->getSetting('sesmaterial.moretext', 'More'),
    ));

// 		$this->addElement('Radio', 'sesmaterial_popup_design', array(
...
// 		    2 => 'Design - 2'
// 		),
// 		'value' => Engine_Api::_()->sesmaterial()->getContantValueXML('sesmaterial_popup_design'),
// 		));

    $this->addElement('Select', 'sesmaterial_searchleftoption', array(
        ...
        'value' => $settings->getSetting('sesmaterial.searchleftoption', 1),
    ));

    $this->addElement('Text', 'sesmaterial_search_limit', array(
        'label' => 'Module Options Limit',
        'description' => 'Enter the number of various modules to be shown with Search field.',
        'value' => $settings->getSetting('sesmaterial.search.limit', '8'),
    ));
