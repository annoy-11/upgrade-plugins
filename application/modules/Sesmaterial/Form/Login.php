 ...
 * @version    $Id: Login.php 2018-07-28 00:00:00 SocialEngineSolutions $

 * @author     SocialEngineSolutions

 */
class Sesmaterial_Form_Login extends Engine_Form_Email {
    ...
    public function init() {
        ...
        $this->setAttrib('id', 'sesmaterial_form_login');
