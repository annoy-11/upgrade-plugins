...
class Sesmaterial_NotificationsController extends Core_Controller_Action_Standard {
  ...
  public function pulldownAction() {
    ...
    $this->view->notifications = $notifications = Engine_Api::_()->getDbtable('notifications', 'sesmaterial')->getNotificationsPaginator($viewer);
    ...
    Engine_Api::_()->getApi('message', 'sesmaterial')->setUnreadNotification($viewer);
