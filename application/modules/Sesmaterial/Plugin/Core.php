...
class Sesmaterial_Plugin_Core  extends Zend_Controller_Plugin_Abstract {
  ...
  public function onRenderLayoutDefault($event) {
    ...
    $usegoogleFont = $settings->getSetting('sesmaterial.googlefonts', 0);
    ...
    $enable_responseive_leyout = Engine_Api::_()->sesmaterial()->getContantValueXML('sesmaterial_responsive_layout');
    if ($theme_name == 'sesmaterial' && $enable_responseive_leyout == '1') {
      include APPLICATION_PATH . '/application/modules/Sesmaterial/views/scripts/responsive_layout.tpl';
