...
class Sesmaterial_Model_DbTable_Dashboardlinks extends Engine_Db_Table {

  protected $_rowClass = "Sesmaterial_Model_Dashboardlink";

  public function getInfo($params = array()) {

    $socialTable = Engine_Api::_()->getDbTable('dashboardlinks', 'sesmaterial');
