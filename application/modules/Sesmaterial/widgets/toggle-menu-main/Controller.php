 ...
 */
class Sesmaterial_Widget_ToggleMenuMainController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $header_teamplate = Engine_Api::_()->sesmaterial()->getContantValueXML('sesmaterial_header_design');
    if($header_teamplate == 3) {
	    $this->view->max = 0;
    } else {
	    $this->view->max = $settings->getSetting('sesmaterial.limit', 4);
    }
    $this->view->moreText = $settings->getSetting('sesmaterial.moretext', 'More');
