...
class Sesmaterial_Widget_DeshboardLinksController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->dashboardlinks = Engine_Api::_()->getDbTable('dashboardlinks', 'sesmaterial')->getInfo(array('sublink' => 0, 'enabled' => 1));
  }
