 ...
 * @version    $Id: footer-links.tpl 2018-07-28 00:00:00 SocialEngineSolutions $
...
<div class='tabs'>
  <ul class="navigation">
      <li>
      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'footer-settings'), $this->translate('Footer Settings')) ?>
    </li>
        <li class="active">
      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'footer-links'), $this->translate('Footer Links')) ?>
    </li>
    <li>
      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'footer-social-icons'), $this->translate('Social Site Links')) ?>
    </li>
          ...
          <ul class="sesbasic_manage_table_list" id='menu_list'>
            <?php foreach ($this->paginator as $item) : ?>
              <li class="item_label" style="cursor:default;">
                ...
                <div style="width:10%;" class="admin_table_centered">
                  <?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'enabled-link', 'footerlink_id' => $item->footerlink_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disable'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'enabled-link', 'footerlink_id' => $item->footerlink_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enable')))) ) ?>
                </div>
                <div style="width:40%;">          
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'editlink', 'footerlink_id' => $item->footerlink_id), $this->translate("Edit"), array('class' => 'smoothbox')) ?>
                  <?php if($item->footerlink_id != 1): ?> |
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'addsublink', 'footerlink_id' => $item->footerlink_id), $this->translate('Add New Footer Link'), array('class' => 'smoothbox')); ?><?php endif; ?>
                </div>
              </li>
	              <?php $manageSubLinks = Engine_Api::_()->getDbTable('footerlinks', 'sesmaterial')->getInfo(array('sublink' => $item->footerlink_id)); ?>
	              ...
	              <li class="item_label" style="cursor:default;">
	                ...
	                <div style="width:40%;">          
	                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'editlink', 'footerlink_id' => $item->footerlink_id, 'sublink' => $item
	                  ->sublink), $this->translate("Edit"), array('class' => 'smoothbox')) ?> |
	                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesmaterial', 'controller' => 'manage', 'action' => 'deletesublink', 'footerlink_id' => $item->footerlink_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
	                </div>
	              </li>
	            <?php endforeach; ?>
            <?php endforeach; ?>
