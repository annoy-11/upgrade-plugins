...
class Seshtmlbackground_Widget_SlideshowController extends Engine_Content_Widget_Abstract {
  public function indexAction() {
    ...
    $this->view->inside_ouside = $this->_getParam('inside_ouside',1);
    ...
    if(!$sesspectromedia){
      ...
      if(!$sesspectromedia){
        ...
        if(!$sesspectromedia){
          $this->view->moduleEnable = "sessportz";
          $this->view->sesspectromedia = $sesspectromedia = Engine_Api::_()->getApi('core', 'sesbasic')->isModuleEnable(array('sessportz'));
        }
      }
    }
