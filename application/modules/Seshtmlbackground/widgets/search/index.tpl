...
<div class="slideshow_searchbox">
	<div class="slideshow_searchbox_input">
  	...
  	<input placeholder="<?php echo $this->translate('Search');?>" id="seshtmlbackground_title" type="text" name="name" />
  </div>
  <div class="slideshow_searchbox_button">
  	<button onclick="javascript:showAllSearchResults();"><?php echo $this->translate('Search');?></button>
  </div>
</div>
