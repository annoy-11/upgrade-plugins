...
<?php if($this->bannerimage): ?>
  <?php 
    $photoUrl = Engine_Api::_()->seshtmlbackground()->getFileUrl($this->bannerimage);
    $bannerimage = $photoUrl;
    ?>
  <?php else: ?>
	<?php 
    $photoUrl = $this->baseUrl() . '/application/modules/Seshtmlbackground/externals/images/paralex-background.jpg';
    $bannerimage = $photoUrl;
	?>
  <?php endif; ?>
  <div class="seshtmlbackground_parallax_block_wraper sesbasic_bxs sesbasic_clearfix" style="height:<?php echo $this->height ?>px;">
    <div class="seshtmlbackground_parallax_block">
      <div class="seshtmlbackground_parallax_background_container">
        <div class="seshtmlbackground_parallax_background" style="background-image:url(<?php echo $photoUrl?>);"></div>
      </div>
