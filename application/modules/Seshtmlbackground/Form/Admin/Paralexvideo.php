...
class Seshtmlbackground_Form_Admin_Paralexvideo extends Engine_Form {

  public function init() {

    //New File System Code
    $banner_options = array('' => '');
    $files = Engine_Api::_()->getDbTable('files', 'core')->getFiles(array('fetchAll' => 1, 'extension' => array('mp4', 'flv', 'ogg')));
