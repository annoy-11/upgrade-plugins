...
//window.addEvent('domready', function() {
	var htmlElement<?php echo "_".$identity ?> = document.getElementsByTagName("body")[0];
  htmlElement<?php echo "_".$identity ?>.addClass('seshtmlbackground_slide_full_width');
//});
<?php endif; ?>
</script>
<?php
...
<div class="seshtmlbackground_slideshow_wrapper sesbasic_clearfix" id="seshtmlbackground_slideshow_wrapper_<?php echo $identity; ?>" style="height:<?php echo $this->height.'px'; ?>;">
    ...
    <!--Header Template 1-->
    <?php } else if($this->templateDesign == 1 && $headerPluginEnabled) { ?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesheader/views/scripts/header-outside/design1.tpl'; ?> 
    <?php } else if($this->templateDesign == 2 && $headerPluginEnabled) { ?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesheader/views/scripts/header-outside/design2.tpl'; ?>
    <?php } else if($this->templateDesign == 3 && $headerPluginEnabled) { ?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesheader/views/scripts/header-outside/design3.tpl'; ?>
    <?php } else if($this->templateDesign == 4 && $headerPluginEnabled) { ?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesheader/views/scripts/header-outside/design4.tpl'; ?>
    <?php } else if($this->templateDesign == 5 && $headerPluginEnabled) { ?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesheader/views/scripts/header-outside/design5.tpl'; ?>
    <?php } else if($this->templateDesign == 6 && $headerPluginEnabled) { ?>
      <?php include APPLICATION_PATH .  '/application/modules/Sesheader/views/scripts/header-outside/design6.tpl'; ?>
    <?php } ?>
   ...
   <?php } ?>
    <?php 
     ...
     <?php } ?>-->
      ...
      <div class="cd-slider-nav cd-slider-nav<?php echo "_".$identity ?>" style="display:<?php echo ($this->paginator->getTotalItemCount()>1 && $this->thumbnail) ? 'block' : 'none' ; ?>">
        <nav>
		...
		container.find('.cd-bg-video-wrapper').each(function(){
			...
			if( videoWrapper.is(':visible') ) {
				...
				videoImage = videoWrapper.data('image');
					video = $('<video onended="finishVideoNext<?php echo "_".$identity ?>()" <?php if($this->mute_video){ ?> muted="muted"; <?php } ?> ><source src="'+videoUrl+'" type="video/mp4" /></video><div class="cd-hero-slider-video-img" style="background-image:url('+videoImage+');"></div>');
...
<?php } ?>
	<?php if($this->logo): ?>
		<?php if($this->logo_url){ ?>
			sesJqueryObject('#cd-logo<?php echo "_".$identity ?>').html('<div id="cd-logo" class="logo"><div><a href="/"><img src="<?php echo $this->logo_url; ?>"></a></div></div>');
		<?php }else{ ?>
...
<script src="application/modules/Seshtmlbackground/externals/scripts/jquery-1.3.2.min.js" type="text/javascript"></script>
<script src="application/modules/Seshtmlbackground/externals/scripts/jquery.backgroundPosition.js" type="text/javascript"></script>
<script type="text/javascript">
	$(function(){
	
	  $('.selected').css({backgroundPosition: '0px 0px'});
