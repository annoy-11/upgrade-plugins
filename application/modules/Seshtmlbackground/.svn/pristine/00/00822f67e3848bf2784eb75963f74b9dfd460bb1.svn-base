 ...
 */
?>
<?php $this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/modules/Seshtmlbackground/externals/styles/design4.css'); ?>
          ...
          <?php if(Engine_Api::_()->user()->getViewer()->getIdentity() == 0){ ?>
            <?php  if((isset($item->show_login_form) && $item->show_login_form) || $item->show_register_form){ ?>
             ...
             <?php if(isset($item->show_login_form) && $item->show_login_form){ ?>
                ...
                <div class="cd-signupform-tabs form_tp_tabs sesbasic_clearfix">
                ...
                <?php } ?>
                <div class="seshtmlbackground_form form_tp_custom sesbasic_clearfix cd-loginbox cd-loginbox-<?php echo $itemdata->slide_id; ?>">
             ...
             <?php 
          	...
          	<?php  if($item->show_register_form){ ?>
                <div class="seshtmlbackground_form form_tp_custom sesbasic_clearfix cd-signupform cd-signupform-<?php echo $itemdata->slide_id; ?>">
                  <?php if(!$isLogin){ ?>
