  ...
  public function createSlideAction() {
    ...
    if ($this->getRequest()->isPost()) {
      ...
      try {
        ...
        if(isset($values['youtube_video_link']) && !empty($values['youtube_video_link'])){
                $iframeUrl = $this->handleIframelyInformation($values['youtube_video_link']);
                $values['youtube_video_code'] = $iframeUrl['code'];
        }
        if (!isset($slide))
        ...
        if (isset($_FILES['file']['name']) && $_FILES['file']['name'] != '') {
          ...
          $slide->file_type = $filename->extension;
					...
					if(strtolower($slide->file_type) != 'mp4' && strtolower($slide->file_type) != 'jpeg' && strtolower($slide->file_type) != 'jpg' && strtolower($slide->file_type) != 'png' && strtolower($slide->file_type) != 'gif'){
						$slide->status = '2';
