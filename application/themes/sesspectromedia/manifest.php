...
return array(
    'package' => array(
        ...
        'name' => 'Spectro Media',
        'version' => '4.10.5',
        'path' => 'application/themes/sesspectromedia',
        'repository' => 'socialnetworking.solutions',
        'title' => '<span style="color:#DDDDDD">SpectroMedia Theme</span>',
        'thumb' => 'theme.jpg',
        ...
        'directories' => array(
            'application/themes/sesspectromedia',
        ),
    ),
    'files' => array(
        'theme.css',
