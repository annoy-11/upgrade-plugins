...
defined('APPLICATION_NAME') || define('APPLICATION_NAME', 'Restapi');
...
if( _ENGINE_R_INIT ) {
  ...
  $application = new Engine_Application(
    array(
      ...
      'autoloaderNamespaces' => array(
        ...
        'Restapi' => APPLICATION_PATH_COR . DS . 'modules' . DS . 'Restapi',
  ...
  $restApiBootstrap =  new $nameClass($application);
	$restApiBootstrap->bootstrap();
  $restApiBootstrap->run($application);
